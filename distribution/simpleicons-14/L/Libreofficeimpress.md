...
```text
simpleicons-14/L/Libreofficeimpress
```

```text
include('simpleicons-14/L/Libreofficeimpress')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons-14/L/Libreofficeimpress.png) | ![illustration for Libreofficeimpress](../../simpleicons-14/L/Libreofficeimpress.Local.png) |
