...
```text
simpleicons-14/B/Basicattentiontoken
```

```text
include('simpleicons-14/B/Basicattentiontoken')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons-14/B/Basicattentiontoken.png) | ![illustration for Basicattentiontoken](../../simpleicons-14/B/Basicattentiontoken.Local.png) |
