...
```text
simpleicons-14/H/Heroicgameslauncher
```

```text
include('simpleicons-14/H/Heroicgameslauncher')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons-14/H/Heroicgameslauncher.png) | ![illustration for Heroicgameslauncher](../../simpleicons-14/H/Heroicgameslauncher.Local.png) |
