...
```text
simpleicons-14/C/Contributorcovenant
```

```text
include('simpleicons-14/C/Contributorcovenant')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons-14/C/Contributorcovenant.png) | ![illustration for Contributorcovenant](../../simpleicons-14/C/Contributorcovenant.Local.png) |
