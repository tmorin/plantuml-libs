...
```text
simpleicons-14/G/Googlesummerofcode
```

```text
include('simpleicons-14/G/Googlesummerofcode')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons-14/G/Googlesummerofcode.png) | ![illustration for Googlesummerofcode](../../simpleicons-14/G/Googlesummerofcode.Local.png) |
