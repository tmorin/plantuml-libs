...
```text
simpleicons-14/R/Rockwellautomation
```

```text
include('simpleicons-14/R/Rockwellautomation')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons-14/R/Rockwellautomation.png) | ![illustration for Rockwellautomation](../../simpleicons-14/R/Rockwellautomation.Local.png) |
