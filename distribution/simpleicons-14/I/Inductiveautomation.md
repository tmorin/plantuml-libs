...
```text
simpleicons-14/I/Inductiveautomation
```

```text
include('simpleicons-14/I/Inductiveautomation')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons-14/I/Inductiveautomation.png) | ![illustration for Inductiveautomation](../../simpleicons-14/I/Inductiveautomation.Local.png) |
