...
```text
aws-q3-2025/Resource/Compute/AwsElasticBeanstalkDeployment
```

```text
include('aws-q3-2025/Resource/Compute/AwsElasticBeanstalkDeployment')
```
