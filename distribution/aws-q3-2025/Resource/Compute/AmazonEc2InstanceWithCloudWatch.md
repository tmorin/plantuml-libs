...
```text
aws-q3-2025/Resource/Compute/AmazonEc2InstanceWithCloudWatch
```

```text
include('aws-q3-2025/Resource/Compute/AmazonEc2InstanceWithCloudWatch')
```
