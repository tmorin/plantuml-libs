...
```text
aws-q3-2025/Resource/Compute/AmazonEc2ElasticIpAddress
```

```text
include('aws-q3-2025/Resource/Compute/AmazonEc2ElasticIpAddress')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/Compute/AmazonEc2ElasticIpAddress.png) | ![illustration for AmazonEc2ElasticIpAddress](../../../aws-q3-2025/Resource/Compute/AmazonEc2ElasticIpAddress.Local.png) | ![illustration for AmazonEc2ElasticIpAddressCard](../../../aws-q3-2025/Resource/Compute/AmazonEc2ElasticIpAddressCard.Local.png) | ![illustration for AmazonEc2ElasticIpAddressGroup](../../../aws-q3-2025/Resource/Compute/AmazonEc2ElasticIpAddressGroup.Local.png) |
