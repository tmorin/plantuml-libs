...
```text
aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketEmbeddedSimulator
```

```text
include('aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketEmbeddedSimulator')
```
