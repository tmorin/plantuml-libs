...
```text
aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketSimulator3
```

```text
include('aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketSimulator3')
```
