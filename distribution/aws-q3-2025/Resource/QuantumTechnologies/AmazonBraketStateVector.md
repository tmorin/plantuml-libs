...
```text
aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketStateVector
```

```text
include('aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketStateVector')
```
