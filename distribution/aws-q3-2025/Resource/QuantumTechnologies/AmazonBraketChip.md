...
```text
aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketChip
```

```text
include('aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketChip')
```
