...
```text
aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketManagedSimulator
```

```text
include('aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketManagedSimulator')
```
