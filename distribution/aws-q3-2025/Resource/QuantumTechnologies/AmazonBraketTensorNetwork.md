...
```text
aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketTensorNetwork
```

```text
include('aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketTensorNetwork')
```
