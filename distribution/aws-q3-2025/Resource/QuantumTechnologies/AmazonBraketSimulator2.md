...
```text
aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketSimulator2
```

```text
include('aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketSimulator2')
```
