...
```text
aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketQpu
```

```text
include('aws-q3-2025/Resource/QuantumTechnologies/AmazonBraketQpu')
```
