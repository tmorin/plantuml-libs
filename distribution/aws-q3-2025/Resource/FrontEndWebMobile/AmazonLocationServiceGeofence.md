...
```text
aws-q3-2025/Resource/FrontEndWebMobile/AmazonLocationServiceGeofence
```

```text
include('aws-q3-2025/Resource/FrontEndWebMobile/AmazonLocationServiceGeofence')
```
