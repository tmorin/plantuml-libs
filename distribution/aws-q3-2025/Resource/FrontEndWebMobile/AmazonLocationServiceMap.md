...
```text
aws-q3-2025/Resource/FrontEndWebMobile/AmazonLocationServiceMap
```

```text
include('aws-q3-2025/Resource/FrontEndWebMobile/AmazonLocationServiceMap')
```
