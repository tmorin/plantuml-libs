...
```text
aws-q3-2025/Resource/IoT/AwsIoTGreengrassStreamManager
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTGreengrassStreamManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassStreamManager.png) | ![illustration for AwsIoTGreengrassStreamManager](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassStreamManager.Local.png) | ![illustration for AwsIoTGreengrassStreamManagerCard](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassStreamManagerCard.Local.png) | ![illustration for AwsIoTGreengrassStreamManagerGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassStreamManagerGroup.Local.png) |
