...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingIndustrialPc
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingIndustrialPc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTThingIndustrialPc.png) | ![illustration for AwsIoTThingIndustrialPc](../../../aws-q3-2025/Resource/IoT/AwsIoTThingIndustrialPc.Local.png) | ![illustration for AwsIoTThingIndustrialPcCard](../../../aws-q3-2025/Resource/IoT/AwsIoTThingIndustrialPcCard.Local.png) | ![illustration for AwsIoTThingIndustrialPcGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTThingIndustrialPcGroup.Local.png) |
