...
```text
aws-q3-2025/Resource/IoT/AwsIoTGreengrassComponentMachineLearning
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTGreengrassComponentMachineLearning')
```
