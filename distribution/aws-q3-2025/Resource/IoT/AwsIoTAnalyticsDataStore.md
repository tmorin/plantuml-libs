...
```text
aws-q3-2025/Resource/IoT/AwsIoTAnalyticsDataStore
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTAnalyticsDataStore')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTAnalyticsDataStore.png) | ![illustration for AwsIoTAnalyticsDataStore](../../../aws-q3-2025/Resource/IoT/AwsIoTAnalyticsDataStore.Local.png) | ![illustration for AwsIoTAnalyticsDataStoreCard](../../../aws-q3-2025/Resource/IoT/AwsIoTAnalyticsDataStoreCard.Local.png) | ![illustration for AwsIoTAnalyticsDataStoreGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTAnalyticsDataStoreGroup.Local.png) |
