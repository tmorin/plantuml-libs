...
```text
aws-q3-2025/Resource/IoT/AwsIoTGreengrassArtifact
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTGreengrassArtifact')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassArtifact.png) | ![illustration for AwsIoTGreengrassArtifact](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassArtifact.Local.png) | ![illustration for AwsIoTGreengrassArtifactCard](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassArtifactCard.Local.png) | ![illustration for AwsIoTGreengrassArtifactGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassArtifactGroup.Local.png) |
