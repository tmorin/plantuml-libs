...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingVibrationSensor
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingVibrationSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTThingVibrationSensor.png) | ![illustration for AwsIoTThingVibrationSensor](../../../aws-q3-2025/Resource/IoT/AwsIoTThingVibrationSensor.Local.png) | ![illustration for AwsIoTThingVibrationSensorCard](../../../aws-q3-2025/Resource/IoT/AwsIoTThingVibrationSensorCard.Local.png) | ![illustration for AwsIoTThingVibrationSensorGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTThingVibrationSensorGroup.Local.png) |
