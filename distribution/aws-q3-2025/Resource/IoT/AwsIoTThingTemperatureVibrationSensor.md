...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingTemperatureVibrationSensor
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingTemperatureVibrationSensor')
```
