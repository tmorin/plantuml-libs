...
```text
aws-q3-2025/Resource/IoT/AwsIoTPolicy
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTPolicy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTPolicy.png) | ![illustration for AwsIoTPolicy](../../../aws-q3-2025/Resource/IoT/AwsIoTPolicy.Local.png) | ![illustration for AwsIoTPolicyCard](../../../aws-q3-2025/Resource/IoT/AwsIoTPolicyCard.Local.png) | ![illustration for AwsIoTPolicyGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTPolicyGroup.Local.png) |
