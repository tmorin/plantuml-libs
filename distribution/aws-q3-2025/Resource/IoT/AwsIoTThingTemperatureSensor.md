...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingTemperatureSensor
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingTemperatureSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTThingTemperatureSensor.png) | ![illustration for AwsIoTThingTemperatureSensor](../../../aws-q3-2025/Resource/IoT/AwsIoTThingTemperatureSensor.Local.png) | ![illustration for AwsIoTThingTemperatureSensorCard](../../../aws-q3-2025/Resource/IoT/AwsIoTThingTemperatureSensorCard.Local.png) | ![illustration for AwsIoTThingTemperatureSensorGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTThingTemperatureSensorGroup.Local.png) |
