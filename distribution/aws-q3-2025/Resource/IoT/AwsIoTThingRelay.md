...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingRelay
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingRelay')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTThingRelay.png) | ![illustration for AwsIoTThingRelay](../../../aws-q3-2025/Resource/IoT/AwsIoTThingRelay.Local.png) | ![illustration for AwsIoTThingRelayCard](../../../aws-q3-2025/Resource/IoT/AwsIoTThingRelayCard.Local.png) | ![illustration for AwsIoTThingRelayGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTThingRelayGroup.Local.png) |
