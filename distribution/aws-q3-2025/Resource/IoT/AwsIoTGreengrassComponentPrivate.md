...
```text
aws-q3-2025/Resource/IoT/AwsIoTGreengrassComponentPrivate
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTGreengrassComponentPrivate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassComponentPrivate.png) | ![illustration for AwsIoTGreengrassComponentPrivate](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassComponentPrivate.Local.png) | ![illustration for AwsIoTGreengrassComponentPrivateCard](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassComponentPrivateCard.Local.png) | ![illustration for AwsIoTGreengrassComponentPrivateGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassComponentPrivateGroup.Local.png) |
