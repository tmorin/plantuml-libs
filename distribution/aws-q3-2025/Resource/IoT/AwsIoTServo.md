...
```text
aws-q3-2025/Resource/IoT/AwsIoTServo
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTServo')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTServo.png) | ![illustration for AwsIoTServo](../../../aws-q3-2025/Resource/IoT/AwsIoTServo.Local.png) | ![illustration for AwsIoTServoCard](../../../aws-q3-2025/Resource/IoT/AwsIoTServoCard.Local.png) | ![illustration for AwsIoTServoGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTServoGroup.Local.png) |
