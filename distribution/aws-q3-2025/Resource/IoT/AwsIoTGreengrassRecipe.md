...
```text
aws-q3-2025/Resource/IoT/AwsIoTGreengrassRecipe
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTGreengrassRecipe')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassRecipe.png) | ![illustration for AwsIoTGreengrassRecipe](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassRecipe.Local.png) | ![illustration for AwsIoTGreengrassRecipeCard](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassRecipeCard.Local.png) | ![illustration for AwsIoTGreengrassRecipeGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassRecipeGroup.Local.png) |
