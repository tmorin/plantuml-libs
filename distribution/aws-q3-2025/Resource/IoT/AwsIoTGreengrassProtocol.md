...
```text
aws-q3-2025/Resource/IoT/AwsIoTGreengrassProtocol
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTGreengrassProtocol')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassProtocol.png) | ![illustration for AwsIoTGreengrassProtocol](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassProtocol.Local.png) | ![illustration for AwsIoTGreengrassProtocolCard](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassProtocolCard.Local.png) | ![illustration for AwsIoTGreengrassProtocolGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTGreengrassProtocolGroup.Local.png) |
