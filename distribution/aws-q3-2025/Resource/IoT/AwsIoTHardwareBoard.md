...
```text
aws-q3-2025/Resource/IoT/AwsIoTHardwareBoard
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTHardwareBoard')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTHardwareBoard.png) | ![illustration for AwsIoTHardwareBoard](../../../aws-q3-2025/Resource/IoT/AwsIoTHardwareBoard.Local.png) | ![illustration for AwsIoTHardwareBoardCard](../../../aws-q3-2025/Resource/IoT/AwsIoTHardwareBoardCard.Local.png) | ![illustration for AwsIoTHardwareBoardGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTHardwareBoardGroup.Local.png) |
