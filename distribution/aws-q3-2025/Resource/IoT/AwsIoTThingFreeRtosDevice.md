...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingFreeRtosDevice
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingFreeRtosDevice')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTThingFreeRtosDevice.png) | ![illustration for AwsIoTThingFreeRtosDevice](../../../aws-q3-2025/Resource/IoT/AwsIoTThingFreeRtosDevice.Local.png) | ![illustration for AwsIoTThingFreeRtosDeviceCard](../../../aws-q3-2025/Resource/IoT/AwsIoTThingFreeRtosDeviceCard.Local.png) | ![illustration for AwsIoTThingFreeRtosDeviceGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTThingFreeRtosDeviceGroup.Local.png) |
