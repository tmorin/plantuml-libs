...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingCoffeePot
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingCoffeePot')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTThingCoffeePot.png) | ![illustration for AwsIoTThingCoffeePot](../../../aws-q3-2025/Resource/IoT/AwsIoTThingCoffeePot.Local.png) | ![illustration for AwsIoTThingCoffeePotCard](../../../aws-q3-2025/Resource/IoT/AwsIoTThingCoffeePotCard.Local.png) | ![illustration for AwsIoTThingCoffeePotGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTThingCoffeePotGroup.Local.png) |
