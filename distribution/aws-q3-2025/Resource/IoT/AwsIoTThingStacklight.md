...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingStacklight
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingStacklight')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTThingStacklight.png) | ![illustration for AwsIoTThingStacklight](../../../aws-q3-2025/Resource/IoT/AwsIoTThingStacklight.Local.png) | ![illustration for AwsIoTThingStacklightCard](../../../aws-q3-2025/Resource/IoT/AwsIoTThingStacklightCard.Local.png) | ![illustration for AwsIoTThingStacklightGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTThingStacklightGroup.Local.png) |
