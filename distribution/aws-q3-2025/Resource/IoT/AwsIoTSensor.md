...
```text
aws-q3-2025/Resource/IoT/AwsIoTSensor
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTSensor.png) | ![illustration for AwsIoTSensor](../../../aws-q3-2025/Resource/IoT/AwsIoTSensor.Local.png) | ![illustration for AwsIoTSensorCard](../../../aws-q3-2025/Resource/IoT/AwsIoTSensorCard.Local.png) | ![illustration for AwsIoTSensorGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTSensorGroup.Local.png) |
