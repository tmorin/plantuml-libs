...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingHumiditySensor
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingHumiditySensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTThingHumiditySensor.png) | ![illustration for AwsIoTThingHumiditySensor](../../../aws-q3-2025/Resource/IoT/AwsIoTThingHumiditySensor.Local.png) | ![illustration for AwsIoTThingHumiditySensorCard](../../../aws-q3-2025/Resource/IoT/AwsIoTThingHumiditySensorCard.Local.png) | ![illustration for AwsIoTThingHumiditySensorGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTThingHumiditySensorGroup.Local.png) |
