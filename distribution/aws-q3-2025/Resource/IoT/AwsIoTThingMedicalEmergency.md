...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingMedicalEmergency
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingMedicalEmergency')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTThingMedicalEmergency.png) | ![illustration for AwsIoTThingMedicalEmergency](../../../aws-q3-2025/Resource/IoT/AwsIoTThingMedicalEmergency.Local.png) | ![illustration for AwsIoTThingMedicalEmergencyCard](../../../aws-q3-2025/Resource/IoT/AwsIoTThingMedicalEmergencyCard.Local.png) | ![illustration for AwsIoTThingMedicalEmergencyGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTThingMedicalEmergencyGroup.Local.png) |
