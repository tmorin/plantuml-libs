...
```text
aws-q3-2025/Resource/IoT/AwsIoTDeviceGateway
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTDeviceGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTDeviceGateway.png) | ![illustration for AwsIoTDeviceGateway](../../../aws-q3-2025/Resource/IoT/AwsIoTDeviceGateway.Local.png) | ![illustration for AwsIoTDeviceGatewayCard](../../../aws-q3-2025/Resource/IoT/AwsIoTDeviceGatewayCard.Local.png) | ![illustration for AwsIoTDeviceGatewayGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTDeviceGatewayGroup.Local.png) |
