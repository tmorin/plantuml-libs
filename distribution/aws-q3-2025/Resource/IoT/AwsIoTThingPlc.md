...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingPlc
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingPlc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTThingPlc.png) | ![illustration for AwsIoTThingPlc](../../../aws-q3-2025/Resource/IoT/AwsIoTThingPlc.Local.png) | ![illustration for AwsIoTThingPlcCard](../../../aws-q3-2025/Resource/IoT/AwsIoTThingPlcCard.Local.png) | ![illustration for AwsIoTThingPlcGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTThingPlcGroup.Local.png) |
