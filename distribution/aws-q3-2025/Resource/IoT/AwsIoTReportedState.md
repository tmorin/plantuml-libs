...
```text
aws-q3-2025/Resource/IoT/AwsIoTReportedState
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTReportedState')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTReportedState.png) | ![illustration for AwsIoTReportedState](../../../aws-q3-2025/Resource/IoT/AwsIoTReportedState.Local.png) | ![illustration for AwsIoTReportedStateCard](../../../aws-q3-2025/Resource/IoT/AwsIoTReportedStateCard.Local.png) | ![illustration for AwsIoTReportedStateGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTReportedStateGroup.Local.png) |
