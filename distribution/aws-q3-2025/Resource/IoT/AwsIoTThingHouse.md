...
```text
aws-q3-2025/Resource/IoT/AwsIoTThingHouse
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTThingHouse')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTThingHouse.png) | ![illustration for AwsIoTThingHouse](../../../aws-q3-2025/Resource/IoT/AwsIoTThingHouse.Local.png) | ![illustration for AwsIoTThingHouseCard](../../../aws-q3-2025/Resource/IoT/AwsIoTThingHouseCard.Local.png) | ![illustration for AwsIoTThingHouseGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTThingHouseGroup.Local.png) |
