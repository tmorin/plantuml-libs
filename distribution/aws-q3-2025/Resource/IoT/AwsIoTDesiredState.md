...
```text
aws-q3-2025/Resource/IoT/AwsIoTDesiredState
```

```text
include('aws-q3-2025/Resource/IoT/AwsIoTDesiredState')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/IoT/AwsIoTDesiredState.png) | ![illustration for AwsIoTDesiredState](../../../aws-q3-2025/Resource/IoT/AwsIoTDesiredState.Local.png) | ![illustration for AwsIoTDesiredStateCard](../../../aws-q3-2025/Resource/IoT/AwsIoTDesiredStateCard.Local.png) | ![illustration for AwsIoTDesiredStateGroup](../../../aws-q3-2025/Resource/IoT/AwsIoTDesiredStateGroup.Local.png) |
