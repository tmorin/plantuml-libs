...
```text
aws-q3-2025/Resource/GeneralIcons/Gear
```

```text
include('aws-q3-2025/Resource/GeneralIcons/Gear')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GeneralIcons/Gear.png) | ![illustration for Gear](../../../aws-q3-2025/Resource/GeneralIcons/Gear.Local.png) | ![illustration for GearCard](../../../aws-q3-2025/Resource/GeneralIcons/GearCard.Local.png) | ![illustration for GearGroup](../../../aws-q3-2025/Resource/GeneralIcons/GearGroup.Local.png) |
