...
```text
aws-q3-2025/Resource/GeneralIcons/Disk
```

```text
include('aws-q3-2025/Resource/GeneralIcons/Disk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GeneralIcons/Disk.png) | ![illustration for Disk](../../../aws-q3-2025/Resource/GeneralIcons/Disk.Local.png) | ![illustration for DiskCard](../../../aws-q3-2025/Resource/GeneralIcons/DiskCard.Local.png) | ![illustration for DiskGroup](../../../aws-q3-2025/Resource/GeneralIcons/DiskGroup.Local.png) |
