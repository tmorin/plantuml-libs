...
```text
aws-q3-2025/Resource/GeneralIcons/MobileClient
```

```text
include('aws-q3-2025/Resource/GeneralIcons/MobileClient')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GeneralIcons/MobileClient.png) | ![illustration for MobileClient](../../../aws-q3-2025/Resource/GeneralIcons/MobileClient.Local.png) | ![illustration for MobileClientCard](../../../aws-q3-2025/Resource/GeneralIcons/MobileClientCard.Local.png) | ![illustration for MobileClientGroup](../../../aws-q3-2025/Resource/GeneralIcons/MobileClientGroup.Local.png) |
