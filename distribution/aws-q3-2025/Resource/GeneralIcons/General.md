...
```text
aws-q3-2025/Resource/GeneralIcons/General
```

```text
include('aws-q3-2025/Resource/GeneralIcons/General')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GeneralIcons/General.png) | ![illustration for General](../../../aws-q3-2025/Resource/GeneralIcons/General.Local.png) | ![illustration for GeneralCard](../../../aws-q3-2025/Resource/GeneralIcons/GeneralCard.Local.png) | ![illustration for GeneralGroup](../../../aws-q3-2025/Resource/GeneralIcons/GeneralGroup.Local.png) |
