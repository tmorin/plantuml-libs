...
```text
aws-q3-2025/Resource/GeneralIcons/Firewall
```

```text
include('aws-q3-2025/Resource/GeneralIcons/Firewall')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GeneralIcons/Firewall.png) | ![illustration for Firewall](../../../aws-q3-2025/Resource/GeneralIcons/Firewall.Local.png) | ![illustration for FirewallCard](../../../aws-q3-2025/Resource/GeneralIcons/FirewallCard.Local.png) | ![illustration for FirewallGroup](../../../aws-q3-2025/Resource/GeneralIcons/FirewallGroup.Local.png) |
