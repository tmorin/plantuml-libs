...
```text
aws-q3-2025/Resource/GeneralIcons/Internet
```

```text
include('aws-q3-2025/Resource/GeneralIcons/Internet')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GeneralIcons/Internet.png) | ![illustration for Internet](../../../aws-q3-2025/Resource/GeneralIcons/Internet.Local.png) | ![illustration for InternetCard](../../../aws-q3-2025/Resource/GeneralIcons/InternetCard.Local.png) | ![illustration for InternetGroup](../../../aws-q3-2025/Resource/GeneralIcons/InternetGroup.Local.png) |
