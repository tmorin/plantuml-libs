...
```text
aws-q3-2025/Resource/GeneralIcons/Email
```

```text
include('aws-q3-2025/Resource/GeneralIcons/Email')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GeneralIcons/Email.png) | ![illustration for Email](../../../aws-q3-2025/Resource/GeneralIcons/Email.Local.png) | ![illustration for EmailCard](../../../aws-q3-2025/Resource/GeneralIcons/EmailCard.Local.png) | ![illustration for EmailGroup](../../../aws-q3-2025/Resource/GeneralIcons/EmailGroup.Local.png) |
