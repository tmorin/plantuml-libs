...
```text
aws-q3-2025/Resource/GeneralIcons/Database
```

```text
include('aws-q3-2025/Resource/GeneralIcons/Database')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GeneralIcons/Database.png) | ![illustration for Database](../../../aws-q3-2025/Resource/GeneralIcons/Database.Local.png) | ![illustration for DatabaseCard](../../../aws-q3-2025/Resource/GeneralIcons/DatabaseCard.Local.png) | ![illustration for DatabaseGroup](../../../aws-q3-2025/Resource/GeneralIcons/DatabaseGroup.Local.png) |
