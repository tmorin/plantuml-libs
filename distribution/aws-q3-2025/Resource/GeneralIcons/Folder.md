...
```text
aws-q3-2025/Resource/GeneralIcons/Folder
```

```text
include('aws-q3-2025/Resource/GeneralIcons/Folder')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GeneralIcons/Folder.png) | ![illustration for Folder](../../../aws-q3-2025/Resource/GeneralIcons/Folder.Local.png) | ![illustration for FolderCard](../../../aws-q3-2025/Resource/GeneralIcons/FolderCard.Local.png) | ![illustration for FolderGroup](../../../aws-q3-2025/Resource/GeneralIcons/FolderGroup.Local.png) |
