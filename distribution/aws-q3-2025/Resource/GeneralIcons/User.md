...
```text
aws-q3-2025/Resource/GeneralIcons/User
```

```text
include('aws-q3-2025/Resource/GeneralIcons/User')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GeneralIcons/User.png) | ![illustration for User](../../../aws-q3-2025/Resource/GeneralIcons/User.Local.png) | ![illustration for UserCard](../../../aws-q3-2025/Resource/GeneralIcons/UserCard.Local.png) | ![illustration for UserGroup](../../../aws-q3-2025/Resource/GeneralIcons/UserGroup.Local.png) |
