...
```text
aws-q3-2025/Resource/GroupIcons/AwsCloud
```

```text
include('aws-q3-2025/Resource/GroupIcons/AwsCloud')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GroupIcons/AwsCloud.png) | ![illustration for AwsCloud](../../../aws-q3-2025/Resource/GroupIcons/AwsCloud.Local.png) | ![illustration for AwsCloudCard](../../../aws-q3-2025/Resource/GroupIcons/AwsCloudCard.Local.png) | ![illustration for AwsCloudGroup](../../../aws-q3-2025/Resource/GroupIcons/AwsCloudGroup.Local.png) |
