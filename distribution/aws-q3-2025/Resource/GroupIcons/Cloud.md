...
```text
aws-q3-2025/Resource/GroupIcons/Cloud
```

```text
include('aws-q3-2025/Resource/GroupIcons/Cloud')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GroupIcons/Cloud.png) | ![illustration for Cloud](../../../aws-q3-2025/Resource/GroupIcons/Cloud.Local.png) | ![illustration for CloudCard](../../../aws-q3-2025/Resource/GroupIcons/CloudCard.Local.png) | ![illustration for CloudGroup](../../../aws-q3-2025/Resource/GroupIcons/CloudGroup.Local.png) |
