...
```text
aws-q3-2025/Resource/GroupIcons/ElasticBeanstalkContainer
```

```text
include('aws-q3-2025/Resource/GroupIcons/ElasticBeanstalkContainer')
```
