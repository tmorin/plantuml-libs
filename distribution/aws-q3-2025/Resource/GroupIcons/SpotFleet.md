...
```text
aws-q3-2025/Resource/GroupIcons/SpotFleet
```

```text
include('aws-q3-2025/Resource/GroupIcons/SpotFleet')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GroupIcons/SpotFleet.png) | ![illustration for SpotFleet](../../../aws-q3-2025/Resource/GroupIcons/SpotFleet.Local.png) | ![illustration for SpotFleetCard](../../../aws-q3-2025/Resource/GroupIcons/SpotFleetCard.Local.png) | ![illustration for SpotFleetGroup](../../../aws-q3-2025/Resource/GroupIcons/SpotFleetGroup.Local.png) |
