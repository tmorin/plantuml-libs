...
```text
aws-q3-2025/Resource/GroupIcons/AwsIoTGreengrassDeployment
```

```text
include('aws-q3-2025/Resource/GroupIcons/AwsIoTGreengrassDeployment')
```
