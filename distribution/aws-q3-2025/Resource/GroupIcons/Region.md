...
```text
aws-q3-2025/Resource/GroupIcons/Region
```

```text
include('aws-q3-2025/Resource/GroupIcons/Region')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/GroupIcons/Region.png) | ![illustration for Region](../../../aws-q3-2025/Resource/GroupIcons/Region.Local.png) | ![illustration for RegionCard](../../../aws-q3-2025/Resource/GroupIcons/RegionCard.Local.png) | ![illustration for RegionGroup](../../../aws-q3-2025/Resource/GroupIcons/RegionGroup.Local.png) |
