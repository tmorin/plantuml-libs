...
```text
aws-q3-2025/Resource/MigrationModernization/AwsTransferFamilyAwsAs2
```

```text
include('aws-q3-2025/Resource/MigrationModernization/AwsTransferFamilyAwsAs2')
```
