...
```text
aws-q3-2025/Resource/MigrationModernization/AwsApplicationDiscoveryServiceAwsDiscoveryAgent
```

```text
include('aws-q3-2025/Resource/MigrationModernization/AwsApplicationDiscoveryServiceAwsDiscoveryAgent')
```
