...
```text
aws-q3-2025/Resource/MigrationModernization/AwsApplicationDiscoveryServiceMigrationEvaluatorCollector
```

```text
include('aws-q3-2025/Resource/MigrationModernization/AwsApplicationDiscoveryServiceMigrationEvaluatorCollector')
```
