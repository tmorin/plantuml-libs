...
```text
aws-q3-2025/Resource/MigrationModernization/AwsApplicationDiscoveryServiceAwsAgentlessCollector
```

```text
include('aws-q3-2025/Resource/MigrationModernization/AwsApplicationDiscoveryServiceAwsAgentlessCollector')
```
