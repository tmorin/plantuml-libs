...
```text
aws-q3-2025/Resource/MigrationModernization/AwsMainframeModernizationConverter
```

```text
include('aws-q3-2025/Resource/MigrationModernization/AwsMainframeModernizationConverter')
```
