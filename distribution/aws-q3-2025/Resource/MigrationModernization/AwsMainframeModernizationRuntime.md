...
```text
aws-q3-2025/Resource/MigrationModernization/AwsMainframeModernizationRuntime
```

```text
include('aws-q3-2025/Resource/MigrationModernization/AwsMainframeModernizationRuntime')
```
