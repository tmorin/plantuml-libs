...
```text
aws-q3-2025/Resource/MigrationModernization/AwsDataSyncDiscovery
```

```text
include('aws-q3-2025/Resource/MigrationModernization/AwsDataSyncDiscovery')
```
