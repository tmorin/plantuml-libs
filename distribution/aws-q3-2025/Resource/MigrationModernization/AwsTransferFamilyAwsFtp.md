...
```text
aws-q3-2025/Resource/MigrationModernization/AwsTransferFamilyAwsFtp
```

```text
include('aws-q3-2025/Resource/MigrationModernization/AwsTransferFamilyAwsFtp')
```
