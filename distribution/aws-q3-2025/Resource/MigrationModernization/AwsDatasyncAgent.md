...
```text
aws-q3-2025/Resource/MigrationModernization/AwsDatasyncAgent
```

```text
include('aws-q3-2025/Resource/MigrationModernization/AwsDatasyncAgent')
```
