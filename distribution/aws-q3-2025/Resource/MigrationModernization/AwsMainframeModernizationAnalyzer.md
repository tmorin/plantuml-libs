...
```text
aws-q3-2025/Resource/MigrationModernization/AwsMainframeModernizationAnalyzer
```

```text
include('aws-q3-2025/Resource/MigrationModernization/AwsMainframeModernizationAnalyzer')
```
