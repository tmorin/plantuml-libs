...
```text
aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceClusterAdministratorNode
```

```text
include('aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceClusterAdministratorNode')
```
