...
```text
aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceTraces
```

```text
include('aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceTraces')
```
