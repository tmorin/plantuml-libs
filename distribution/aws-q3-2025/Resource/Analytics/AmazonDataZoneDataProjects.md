...
```text
aws-q3-2025/Resource/Analytics/AmazonDataZoneDataProjects
```

```text
include('aws-q3-2025/Resource/Analytics/AmazonDataZoneDataProjects')
```
