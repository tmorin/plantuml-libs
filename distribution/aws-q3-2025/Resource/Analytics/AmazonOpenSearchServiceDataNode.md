...
```text
aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceDataNode
```

```text
include('aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceDataNode')
```
