...
```text
aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceIndex
```

```text
include('aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceIndex')
```
