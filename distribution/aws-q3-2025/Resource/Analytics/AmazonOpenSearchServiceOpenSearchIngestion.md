...
```text
aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceOpenSearchIngestion
```

```text
include('aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceOpenSearchIngestion')
```
