...
```text
aws-q3-2025/Resource/Analytics/AmazonAthenaDataSourceConnectors
```

```text
include('aws-q3-2025/Resource/Analytics/AmazonAthenaDataSourceConnectors')
```
