...
```text
aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceObservability
```

```text
include('aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceObservability')
```
