...
```text
aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceOpenSearchDashboards
```

```text
include('aws-q3-2025/Resource/Analytics/AmazonOpenSearchServiceOpenSearchDashboards')
```
