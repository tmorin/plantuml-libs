...
```text
aws-q3-2025/Resource/Analytics/AmazonDataZoneBusinessDataCatalog
```

```text
include('aws-q3-2025/Resource/Analytics/AmazonDataZoneBusinessDataCatalog')
```
