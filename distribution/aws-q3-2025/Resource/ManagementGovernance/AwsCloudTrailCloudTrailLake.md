...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsCloudTrailCloudTrailLake
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsCloudTrailCloudTrailLake')
```
