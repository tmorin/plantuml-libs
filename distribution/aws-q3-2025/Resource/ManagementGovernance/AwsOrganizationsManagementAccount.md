...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsOrganizationsManagementAccount
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsOrganizationsManagementAccount')
```
