...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerCompliance
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerCompliance')
```
