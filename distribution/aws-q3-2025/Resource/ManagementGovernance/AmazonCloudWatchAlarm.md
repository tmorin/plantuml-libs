...
```text
aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchAlarm
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchAlarm')
```
