...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistCost
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistCost')
```
