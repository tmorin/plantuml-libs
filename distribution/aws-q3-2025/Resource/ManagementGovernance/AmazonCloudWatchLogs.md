...
```text
aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchLogs
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchLogs')
```
