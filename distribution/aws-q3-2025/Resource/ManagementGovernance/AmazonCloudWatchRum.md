...
```text
aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchRum
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchRum')
```
