...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerDocuments
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerDocuments')
```
