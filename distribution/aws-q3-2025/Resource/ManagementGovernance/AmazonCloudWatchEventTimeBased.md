...
```text
aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchEventTimeBased
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchEventTimeBased')
```
