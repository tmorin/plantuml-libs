...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerStateManager
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerStateManager')
```
