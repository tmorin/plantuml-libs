...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerDistributor
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerDistributor')
```
