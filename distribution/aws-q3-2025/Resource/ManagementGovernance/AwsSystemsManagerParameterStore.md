...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerParameterStore
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerParameterStore')
```
