...
```text
aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchSynthetics
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchSynthetics')
```
