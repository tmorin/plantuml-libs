...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerOpsCenter
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerOpsCenter')
```
