...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerInventory
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerInventory')
```
