...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsCloudFormationStack
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsCloudFormationStack')
```
