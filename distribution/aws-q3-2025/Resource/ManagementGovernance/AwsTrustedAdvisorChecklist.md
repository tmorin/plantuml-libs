...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsTrustedAdvisorChecklist
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsTrustedAdvisorChecklist')
```
