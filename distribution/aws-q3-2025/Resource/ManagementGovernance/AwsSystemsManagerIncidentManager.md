...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerIncidentManager
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerIncidentManager')
```
