...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsCloudFormationTemplate
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsCloudFormationTemplate')
```
