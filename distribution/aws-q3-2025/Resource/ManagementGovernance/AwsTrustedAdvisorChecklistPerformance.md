...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistPerformance
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistPerformance')
```
