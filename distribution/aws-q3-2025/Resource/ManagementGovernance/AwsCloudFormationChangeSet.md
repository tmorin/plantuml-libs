...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsCloudFormationChangeSet
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsCloudFormationChangeSet')
```
