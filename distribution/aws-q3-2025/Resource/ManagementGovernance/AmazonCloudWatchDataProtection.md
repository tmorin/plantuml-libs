...
```text
aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchDataProtection
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchDataProtection')
```
