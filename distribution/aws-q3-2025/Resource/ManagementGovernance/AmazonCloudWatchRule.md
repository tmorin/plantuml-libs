...
```text
aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchRule
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchRule')
```
