...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistSecurity
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistSecurity')
```
