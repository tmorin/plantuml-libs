...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsLicenseManagerApplicationDiscovery
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsLicenseManagerApplicationDiscovery')
```
