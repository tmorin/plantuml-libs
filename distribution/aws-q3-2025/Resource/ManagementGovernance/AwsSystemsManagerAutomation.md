...
```text
aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerAutomation
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AwsSystemsManagerAutomation')
```
