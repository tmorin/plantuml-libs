...
```text
aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchCrossAccountObservability
```

```text
include('aws-q3-2025/Resource/ManagementGovernance/AmazonCloudWatchCrossAccountObservability')
```
