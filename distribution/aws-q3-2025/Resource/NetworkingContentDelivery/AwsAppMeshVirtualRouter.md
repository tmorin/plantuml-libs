...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AwsAppMeshVirtualRouter
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AwsAppMeshVirtualRouter')
```
