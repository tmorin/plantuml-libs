...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/ElasticLoadBalancingNetworkLoadBalancer
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/ElasticLoadBalancingNetworkLoadBalancer')
```
