...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonCloudFrontFunctions
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonCloudFrontFunctions')
```
