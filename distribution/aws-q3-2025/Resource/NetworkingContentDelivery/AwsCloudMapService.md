...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AwsCloudMapService
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AwsCloudMapService')
```
