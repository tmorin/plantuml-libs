...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcFlowLogs
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcFlowLogs')
```
