...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkInterface
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkInterface')
```
