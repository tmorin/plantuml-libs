...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AwsCloudMapNamespace
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AwsCloudMapNamespace')
```
