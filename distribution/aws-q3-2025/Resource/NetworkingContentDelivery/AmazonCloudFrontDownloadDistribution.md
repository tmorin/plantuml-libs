...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonCloudFrontDownloadDistribution
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonCloudFrontDownloadDistribution')
```
