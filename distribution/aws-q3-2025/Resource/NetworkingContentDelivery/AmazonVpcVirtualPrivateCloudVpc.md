...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcVirtualPrivateCloudVpc
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcVirtualPrivateCloudVpc')
```
