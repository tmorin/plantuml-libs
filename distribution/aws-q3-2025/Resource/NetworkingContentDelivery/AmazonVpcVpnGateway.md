...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcVpnGateway
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcVpnGateway')
```
