...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AwsAppMeshVirtualNode
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AwsAppMeshVirtualNode')
```
