...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AwsAppMeshVirtualGateway
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AwsAppMeshVirtualGateway')
```
