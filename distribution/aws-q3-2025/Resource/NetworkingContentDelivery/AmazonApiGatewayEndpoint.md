...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonApiGatewayEndpoint
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonApiGatewayEndpoint')
```
