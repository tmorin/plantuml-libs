...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonRoute53Resolver
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonRoute53Resolver')
```
