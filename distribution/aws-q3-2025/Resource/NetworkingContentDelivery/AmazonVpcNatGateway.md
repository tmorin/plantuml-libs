...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcNatGateway
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcNatGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcNatGateway.png) | ![illustration for AmazonVpcNatGateway](../../../aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcNatGateway.Local.png) | ![illustration for AmazonVpcNatGatewayCard](../../../aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcNatGatewayCard.Local.png) | ![illustration for AmazonVpcNatGatewayGroup](../../../aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcNatGatewayGroup.Local.png) |
