...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AwsCloudWanCoreNetworkEdge
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AwsCloudWanCoreNetworkEdge')
```
