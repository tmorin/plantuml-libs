...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcPeeringConnection
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcPeeringConnection')
```
