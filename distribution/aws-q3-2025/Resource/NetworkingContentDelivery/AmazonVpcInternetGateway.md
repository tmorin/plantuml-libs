...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcInternetGateway
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcInternetGateway')
```
