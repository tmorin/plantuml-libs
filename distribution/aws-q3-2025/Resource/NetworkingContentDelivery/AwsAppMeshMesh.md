...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AwsAppMeshMesh
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AwsAppMeshMesh')
```
