...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcVpnConnection
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonVpcVpnConnection')
```
