...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonCloudFrontStreamingDistribution
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonCloudFrontStreamingDistribution')
```
