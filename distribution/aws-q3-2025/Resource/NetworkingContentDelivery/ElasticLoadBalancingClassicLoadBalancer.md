...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/ElasticLoadBalancingClassicLoadBalancer
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/ElasticLoadBalancingClassicLoadBalancer')
```
