...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonCloudFrontEdgeLocation
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonCloudFrontEdgeLocation')
```
