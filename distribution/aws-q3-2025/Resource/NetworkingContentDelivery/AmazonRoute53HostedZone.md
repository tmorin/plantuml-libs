...
```text
aws-q3-2025/Resource/NetworkingContentDelivery/AmazonRoute53HostedZone
```

```text
include('aws-q3-2025/Resource/NetworkingContentDelivery/AmazonRoute53HostedZone')
```
