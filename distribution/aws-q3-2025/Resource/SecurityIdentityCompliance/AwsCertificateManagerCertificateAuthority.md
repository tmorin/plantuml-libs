...
```text
aws-q3-2025/Resource/SecurityIdentityCompliance/AwsCertificateManagerCertificateAuthority
```

```text
include('aws-q3-2025/Resource/SecurityIdentityCompliance/AwsCertificateManagerCertificateAuthority')
```
