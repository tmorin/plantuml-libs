...
```text
aws-q3-2025/Resource/SecurityIdentityCompliance/AwsWafBot
```

```text
include('aws-q3-2025/Resource/SecurityIdentityCompliance/AwsWafBot')
```
