...
```text
aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementMfaToken
```

```text
include('aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementMfaToken')
```
