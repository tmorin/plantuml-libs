...
```text
aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementTemporarySecurityCredential
```

```text
include('aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementTemporarySecurityCredential')
```
