...
```text
aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementIamRolesAnywhere
```

```text
include('aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementIamRolesAnywhere')
```
