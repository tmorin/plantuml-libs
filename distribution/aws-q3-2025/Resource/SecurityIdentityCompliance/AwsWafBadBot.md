...
```text
aws-q3-2025/Resource/SecurityIdentityCompliance/AwsWafBadBot
```

```text
include('aws-q3-2025/Resource/SecurityIdentityCompliance/AwsWafBadBot')
```
