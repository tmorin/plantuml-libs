...
```text
aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementEncryptedData
```

```text
include('aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementEncryptedData')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementEncryptedData.png) | ![illustration for AwsIdentityAccessManagementEncryptedData](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementEncryptedData.Local.png) | ![illustration for AwsIdentityAccessManagementEncryptedDataCard](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementEncryptedDataCard.Local.png) | ![illustration for AwsIdentityAccessManagementEncryptedDataGroup](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementEncryptedDataGroup.Local.png) |
