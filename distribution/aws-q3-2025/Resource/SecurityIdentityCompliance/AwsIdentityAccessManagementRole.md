...
```text
aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementRole
```

```text
include('aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementRole')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementRole.png) | ![illustration for AwsIdentityAccessManagementRole](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementRole.Local.png) | ![illustration for AwsIdentityAccessManagementRoleCard](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementRoleCard.Local.png) | ![illustration for AwsIdentityAccessManagementRoleGroup](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementRoleGroup.Local.png) |
