...
```text
aws-q3-2025/Resource/SecurityIdentityCompliance/AmazonInspectorAgent
```

```text
include('aws-q3-2025/Resource/SecurityIdentityCompliance/AmazonInspectorAgent')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AmazonInspectorAgent.png) | ![illustration for AmazonInspectorAgent](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AmazonInspectorAgent.Local.png) | ![illustration for AmazonInspectorAgentCard](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AmazonInspectorAgentCard.Local.png) | ![illustration for AmazonInspectorAgentGroup](../../../aws-q3-2025/Resource/SecurityIdentityCompliance/AmazonInspectorAgentGroup.Local.png) |
