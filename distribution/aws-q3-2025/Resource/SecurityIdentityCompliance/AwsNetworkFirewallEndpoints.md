...
```text
aws-q3-2025/Resource/SecurityIdentityCompliance/AwsNetworkFirewallEndpoints
```

```text
include('aws-q3-2025/Resource/SecurityIdentityCompliance/AwsNetworkFirewallEndpoints')
```
