...
```text
aws-q3-2025/Resource/SecurityIdentityCompliance/AwsSecurityHubFinding
```

```text
include('aws-q3-2025/Resource/SecurityIdentityCompliance/AwsSecurityHubFinding')
```
