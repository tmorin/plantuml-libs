...
```text
aws-q3-2025/Resource/MediaServices/AwsElementalMediaConnectMediaConnectGateway
```

```text
include('aws-q3-2025/Resource/MediaServices/AwsElementalMediaConnectMediaConnectGateway')
```
