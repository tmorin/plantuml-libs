...
```text
aws-q3-2025/Resource/ApplicationIntegration/AmazonSimpleNotificationServiceHttpNotification
```

```text
include('aws-q3-2025/Resource/ApplicationIntegration/AmazonSimpleNotificationServiceHttpNotification')
```
