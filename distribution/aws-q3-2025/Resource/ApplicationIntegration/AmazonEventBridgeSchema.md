...
```text
aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeSchema
```

```text
include('aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeSchema')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeSchema.png) | ![illustration for AmazonEventBridgeSchema](../../../aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeSchema.Local.png) | ![illustration for AmazonEventBridgeSchemaCard](../../../aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeSchemaCard.Local.png) | ![illustration for AmazonEventBridgeSchemaGroup](../../../aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeSchemaGroup.Local.png) |
