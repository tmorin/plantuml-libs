...
```text
aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeSaasPartnerEvent
```

```text
include('aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeSaasPartnerEvent')
```
