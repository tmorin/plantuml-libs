...
```text
aws-q3-2025/Resource/ApplicationIntegration/AmazonMqBroker
```

```text
include('aws-q3-2025/Resource/ApplicationIntegration/AmazonMqBroker')
```
