...
```text
aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeEvent
```

```text
include('aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeEvent')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeEvent.png) | ![illustration for AmazonEventBridgeEvent](../../../aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeEvent.Local.png) | ![illustration for AmazonEventBridgeEventCard](../../../aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeEventCard.Local.png) | ![illustration for AmazonEventBridgeEventGroup](../../../aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgeEventGroup.Local.png) |
