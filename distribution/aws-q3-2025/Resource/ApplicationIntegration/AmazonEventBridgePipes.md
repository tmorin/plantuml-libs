...
```text
aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgePipes
```

```text
include('aws-q3-2025/Resource/ApplicationIntegration/AmazonEventBridgePipes')
```
