...
```text
aws-q3-2025/Resource/EndUserComputing/AmazonWorkSpacesFamilyAmazonWorkSpaces
```

```text
include('aws-q3-2025/Resource/EndUserComputing/AmazonWorkSpacesFamilyAmazonWorkSpaces')
```
