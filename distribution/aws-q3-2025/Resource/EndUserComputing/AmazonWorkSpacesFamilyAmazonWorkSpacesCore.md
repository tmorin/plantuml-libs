...
```text
aws-q3-2025/Resource/EndUserComputing/AmazonWorkSpacesFamilyAmazonWorkSpacesCore
```

```text
include('aws-q3-2025/Resource/EndUserComputing/AmazonWorkSpacesFamilyAmazonWorkSpacesCore')
```
