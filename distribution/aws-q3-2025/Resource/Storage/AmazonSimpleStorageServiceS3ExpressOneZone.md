...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3ExpressOneZone
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3ExpressOneZone')
```
