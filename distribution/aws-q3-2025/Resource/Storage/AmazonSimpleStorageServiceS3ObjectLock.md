...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3ObjectLock
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3ObjectLock')
```
