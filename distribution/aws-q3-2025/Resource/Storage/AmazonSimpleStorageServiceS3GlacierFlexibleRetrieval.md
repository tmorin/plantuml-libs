...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3GlacierFlexibleRetrieval
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3GlacierFlexibleRetrieval')
```
