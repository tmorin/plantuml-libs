...
```text
aws-q3-2025/Resource/Storage/AmazonElasticFileSystemEfsStandardInfrequentAccess
```

```text
include('aws-q3-2025/Resource/Storage/AmazonElasticFileSystemEfsStandardInfrequentAccess')
```
