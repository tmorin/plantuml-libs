...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceBucket
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceBucket')
```
