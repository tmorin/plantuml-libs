...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceGlacierArchive
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceGlacierArchive')
```
