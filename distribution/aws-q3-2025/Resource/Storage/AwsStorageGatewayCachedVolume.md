...
```text
aws-q3-2025/Resource/Storage/AwsStorageGatewayCachedVolume
```

```text
include('aws-q3-2025/Resource/Storage/AwsStorageGatewayCachedVolume')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/Storage/AwsStorageGatewayCachedVolume.png) | ![illustration for AwsStorageGatewayCachedVolume](../../../aws-q3-2025/Resource/Storage/AwsStorageGatewayCachedVolume.Local.png) | ![illustration for AwsStorageGatewayCachedVolumeCard](../../../aws-q3-2025/Resource/Storage/AwsStorageGatewayCachedVolumeCard.Local.png) | ![illustration for AwsStorageGatewayCachedVolumeGroup](../../../aws-q3-2025/Resource/Storage/AwsStorageGatewayCachedVolumeGroup.Local.png) |
