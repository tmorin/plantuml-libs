...
```text
aws-q3-2025/Resource/Storage/AmazonElasticFileSystemEfsIntelligentTiering
```

```text
include('aws-q3-2025/Resource/Storage/AmazonElasticFileSystemEfsIntelligentTiering')
```
