...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceGeneralAccessPoints
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceGeneralAccessPoints')
```
