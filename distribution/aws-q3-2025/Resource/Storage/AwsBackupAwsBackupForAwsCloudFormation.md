...
```text
aws-q3-2025/Resource/Storage/AwsBackupAwsBackupForAwsCloudFormation
```

```text
include('aws-q3-2025/Resource/Storage/AwsBackupAwsBackupForAwsCloudFormation')
```
