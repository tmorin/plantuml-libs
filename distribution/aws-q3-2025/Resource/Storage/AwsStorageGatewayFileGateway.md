...
```text
aws-q3-2025/Resource/Storage/AwsStorageGatewayFileGateway
```

```text
include('aws-q3-2025/Resource/Storage/AwsStorageGatewayFileGateway')
```
