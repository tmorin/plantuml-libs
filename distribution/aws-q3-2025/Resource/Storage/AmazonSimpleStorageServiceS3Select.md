...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3Select
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3Select')
```
