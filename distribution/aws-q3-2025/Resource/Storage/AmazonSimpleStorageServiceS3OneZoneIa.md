...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3OneZoneIa
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3OneZoneIa')
```
