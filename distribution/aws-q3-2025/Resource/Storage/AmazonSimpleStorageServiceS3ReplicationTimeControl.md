...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3ReplicationTimeControl
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3ReplicationTimeControl')
```
