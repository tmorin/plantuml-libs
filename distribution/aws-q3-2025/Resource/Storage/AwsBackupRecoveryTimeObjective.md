...
```text
aws-q3-2025/Resource/Storage/AwsBackupRecoveryTimeObjective
```

```text
include('aws-q3-2025/Resource/Storage/AwsBackupRecoveryTimeObjective')
```
