...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3GlacierDeepArchive
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3GlacierDeepArchive')
```
