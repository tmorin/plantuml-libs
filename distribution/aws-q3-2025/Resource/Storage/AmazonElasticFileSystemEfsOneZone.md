...
```text
aws-q3-2025/Resource/Storage/AmazonElasticFileSystemEfsOneZone
```

```text
include('aws-q3-2025/Resource/Storage/AmazonElasticFileSystemEfsOneZone')
```
