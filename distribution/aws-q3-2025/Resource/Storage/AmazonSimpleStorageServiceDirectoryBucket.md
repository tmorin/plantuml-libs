...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceDirectoryBucket
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceDirectoryBucket')
```
