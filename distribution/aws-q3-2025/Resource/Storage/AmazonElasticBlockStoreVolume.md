...
```text
aws-q3-2025/Resource/Storage/AmazonElasticBlockStoreVolume
```

```text
include('aws-q3-2025/Resource/Storage/AmazonElasticBlockStoreVolume')
```
