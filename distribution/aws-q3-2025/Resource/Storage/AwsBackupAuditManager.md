...
```text
aws-q3-2025/Resource/Storage/AwsBackupAuditManager
```

```text
include('aws-q3-2025/Resource/Storage/AwsBackupAuditManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/Storage/AwsBackupAuditManager.png) | ![illustration for AwsBackupAuditManager](../../../aws-q3-2025/Resource/Storage/AwsBackupAuditManager.Local.png) | ![illustration for AwsBackupAuditManagerCard](../../../aws-q3-2025/Resource/Storage/AwsBackupAuditManagerCard.Local.png) | ![illustration for AwsBackupAuditManagerGroup](../../../aws-q3-2025/Resource/Storage/AwsBackupAuditManagerGroup.Local.png) |
