...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3Tables
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3Tables')
```
