...
```text
aws-q3-2025/Resource/Storage/AmazonElasticFileSystemElasticThroughput
```

```text
include('aws-q3-2025/Resource/Storage/AmazonElasticFileSystemElasticThroughput')
```
