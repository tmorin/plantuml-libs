...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3ObjectLambdaAccessPoints
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3ObjectLambdaAccessPoints')
```
