...
```text
aws-q3-2025/Resource/Storage/AmazonElasticBlockStoreSnapshot
```

```text
include('aws-q3-2025/Resource/Storage/AmazonElasticBlockStoreSnapshot')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/Storage/AmazonElasticBlockStoreSnapshot.png) | ![illustration for AmazonElasticBlockStoreSnapshot](../../../aws-q3-2025/Resource/Storage/AmazonElasticBlockStoreSnapshot.Local.png) | ![illustration for AmazonElasticBlockStoreSnapshotCard](../../../aws-q3-2025/Resource/Storage/AmazonElasticBlockStoreSnapshotCard.Local.png) | ![illustration for AmazonElasticBlockStoreSnapshotGroup](../../../aws-q3-2025/Resource/Storage/AmazonElasticBlockStoreSnapshotGroup.Local.png) |
