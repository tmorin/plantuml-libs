...
```text
aws-q3-2025/Resource/Storage/AmazonElasticBlockStoreAmazonDataLifecycleManager
```

```text
include('aws-q3-2025/Resource/Storage/AmazonElasticBlockStoreAmazonDataLifecycleManager')
```
