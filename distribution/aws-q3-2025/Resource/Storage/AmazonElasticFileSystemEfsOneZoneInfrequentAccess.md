...
```text
aws-q3-2025/Resource/Storage/AmazonElasticFileSystemEfsOneZoneInfrequentAccess
```

```text
include('aws-q3-2025/Resource/Storage/AmazonElasticFileSystemEfsOneZoneInfrequentAccess')
```
