...
```text
aws-q3-2025/Resource/Storage/AwsStorageGatewayVirtualTapeLibrary
```

```text
include('aws-q3-2025/Resource/Storage/AwsStorageGatewayVirtualTapeLibrary')
```
