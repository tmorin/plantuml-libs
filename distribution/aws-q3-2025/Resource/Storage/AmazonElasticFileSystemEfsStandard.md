...
```text
aws-q3-2025/Resource/Storage/AmazonElasticFileSystemEfsStandard
```

```text
include('aws-q3-2025/Resource/Storage/AmazonElasticFileSystemEfsStandard')
```
