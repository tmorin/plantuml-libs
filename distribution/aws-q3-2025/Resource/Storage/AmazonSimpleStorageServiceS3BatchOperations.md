...
```text
aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3BatchOperations
```

```text
include('aws-q3-2025/Resource/Storage/AmazonSimpleStorageServiceS3BatchOperations')
```
