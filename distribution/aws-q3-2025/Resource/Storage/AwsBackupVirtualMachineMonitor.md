...
```text
aws-q3-2025/Resource/Storage/AwsBackupVirtualMachineMonitor
```

```text
include('aws-q3-2025/Resource/Storage/AwsBackupVirtualMachineMonitor')
```
