...
```text
aws-q3-2025/Resource/ArtificialIntelligence/AmazonTextractAnalyzeLending
```

```text
include('aws-q3-2025/Resource/ArtificialIntelligence/AmazonTextractAnalyzeLending')
```
