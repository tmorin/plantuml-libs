...
```text
aws-q3-2025/Resource/ArtificialIntelligence/AmazonRekognitionImage
```

```text
include('aws-q3-2025/Resource/ArtificialIntelligence/AmazonRekognitionImage')
```
