...
```text
aws-q3-2025/Resource/ArtificialIntelligence/AmazonRekognitionVideo
```

```text
include('aws-q3-2025/Resource/ArtificialIntelligence/AmazonRekognitionVideo')
```
