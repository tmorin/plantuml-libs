...
```text
aws-q3-2025/Resource/Database/AmazonDocumentDbElasticClusters
```

```text
include('aws-q3-2025/Resource/Database/AmazonDocumentDbElasticClusters')
```
