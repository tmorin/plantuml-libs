...
```text
aws-q3-2025/Resource/Database/AmazonAuroraMariaDbInstance
```

```text
include('aws-q3-2025/Resource/Database/AmazonAuroraMariaDbInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/Database/AmazonAuroraMariaDbInstance.png) | ![illustration for AmazonAuroraMariaDbInstance](../../../aws-q3-2025/Resource/Database/AmazonAuroraMariaDbInstance.Local.png) | ![illustration for AmazonAuroraMariaDbInstanceCard](../../../aws-q3-2025/Resource/Database/AmazonAuroraMariaDbInstanceCard.Local.png) | ![illustration for AmazonAuroraMariaDbInstanceGroup](../../../aws-q3-2025/Resource/Database/AmazonAuroraMariaDbInstanceGroup.Local.png) |
