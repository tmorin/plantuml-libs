...
```text
aws-q3-2025/Resource/Database/AmazonRdsTrustedLanguageExtensionsForPostgreSql
```

```text
include('aws-q3-2025/Resource/Database/AmazonRdsTrustedLanguageExtensionsForPostgreSql')
```
