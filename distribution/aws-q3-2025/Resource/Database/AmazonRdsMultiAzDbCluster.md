...
```text
aws-q3-2025/Resource/Database/AmazonRdsMultiAzDbCluster
```

```text
include('aws-q3-2025/Resource/Database/AmazonRdsMultiAzDbCluster')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/Database/AmazonRdsMultiAzDbCluster.png) | ![illustration for AmazonRdsMultiAzDbCluster](../../../aws-q3-2025/Resource/Database/AmazonRdsMultiAzDbCluster.Local.png) | ![illustration for AmazonRdsMultiAzDbClusterCard](../../../aws-q3-2025/Resource/Database/AmazonRdsMultiAzDbClusterCard.Local.png) | ![illustration for AmazonRdsMultiAzDbClusterGroup](../../../aws-q3-2025/Resource/Database/AmazonRdsMultiAzDbClusterGroup.Local.png) |
