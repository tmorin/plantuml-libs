...
```text
aws-q3-2025/Resource/Database/AmazonAuroraSqlServerInstance
```

```text
include('aws-q3-2025/Resource/Database/AmazonAuroraSqlServerInstance')
```
