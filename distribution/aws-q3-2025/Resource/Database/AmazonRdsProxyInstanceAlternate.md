...
```text
aws-q3-2025/Resource/Database/AmazonRdsProxyInstanceAlternate
```

```text
include('aws-q3-2025/Resource/Database/AmazonRdsProxyInstanceAlternate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/Database/AmazonRdsProxyInstanceAlternate.png) | ![illustration for AmazonRdsProxyInstanceAlternate](../../../aws-q3-2025/Resource/Database/AmazonRdsProxyInstanceAlternate.Local.png) | ![illustration for AmazonRdsProxyInstanceAlternateCard](../../../aws-q3-2025/Resource/Database/AmazonRdsProxyInstanceAlternateCard.Local.png) | ![illustration for AmazonRdsProxyInstanceAlternateGroup](../../../aws-q3-2025/Resource/Database/AmazonRdsProxyInstanceAlternateGroup.Local.png) |
