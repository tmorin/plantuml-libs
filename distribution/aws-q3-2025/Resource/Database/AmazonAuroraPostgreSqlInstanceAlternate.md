...
```text
aws-q3-2025/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate
```

```text
include('aws-q3-2025/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate.png) | ![illustration for AmazonAuroraPostgreSqlInstanceAlternate](../../../aws-q3-2025/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate.Local.png) | ![illustration for AmazonAuroraPostgreSqlInstanceAlternateCard](../../../aws-q3-2025/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternateCard.Local.png) | ![illustration for AmazonAuroraPostgreSqlInstanceAlternateGroup](../../../aws-q3-2025/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternateGroup.Local.png) |
