...
```text
aws-q3-2025/Resource/Database/AmazonElastiCacheElastiCacheForValkey
```

```text
include('aws-q3-2025/Resource/Database/AmazonElastiCacheElastiCacheForValkey')
```
