...
```text
aws-q3-2025/Resource/Database/AmazonAuroraTrustedLanguageExtensionsForPostgreSql
```

```text
include('aws-q3-2025/Resource/Database/AmazonAuroraTrustedLanguageExtensionsForPostgreSql')
```
