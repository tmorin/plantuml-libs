...
```text
aws-q3-2025/Resource/Database/AmazonAuroraAmazonRdsInstance
```

```text
include('aws-q3-2025/Resource/Database/AmazonAuroraAmazonRdsInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/Database/AmazonAuroraAmazonRdsInstance.png) | ![illustration for AmazonAuroraAmazonRdsInstance](../../../aws-q3-2025/Resource/Database/AmazonAuroraAmazonRdsInstance.Local.png) | ![illustration for AmazonAuroraAmazonRdsInstanceCard](../../../aws-q3-2025/Resource/Database/AmazonAuroraAmazonRdsInstanceCard.Local.png) | ![illustration for AmazonAuroraAmazonRdsInstanceGroup](../../../aws-q3-2025/Resource/Database/AmazonAuroraAmazonRdsInstanceGroup.Local.png) |
