...
```text
aws-q3-2025/Resource/Database/AmazonElastiCacheElastiCacheForRedis
```

```text
include('aws-q3-2025/Resource/Database/AmazonElastiCacheElastiCacheForRedis')
```
