...
```text
aws-q3-2025/Resource/Database/AmazonDynamoDbStandardAccessTableClass
```

```text
include('aws-q3-2025/Resource/Database/AmazonDynamoDbStandardAccessTableClass')
```
