...
```text
aws-q3-2025/Resource/Database/AmazonDynamoDbItems
```

```text
include('aws-q3-2025/Resource/Database/AmazonDynamoDbItems')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Resource/Database/AmazonDynamoDbItems.png) | ![illustration for AmazonDynamoDbItems](../../../aws-q3-2025/Resource/Database/AmazonDynamoDbItems.Local.png) | ![illustration for AmazonDynamoDbItemsCard](../../../aws-q3-2025/Resource/Database/AmazonDynamoDbItemsCard.Local.png) | ![illustration for AmazonDynamoDbItemsGroup](../../../aws-q3-2025/Resource/Database/AmazonDynamoDbItemsGroup.Local.png) |
