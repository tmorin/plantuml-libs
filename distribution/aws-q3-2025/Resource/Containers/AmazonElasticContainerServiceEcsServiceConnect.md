...
```text
aws-q3-2025/Resource/Containers/AmazonElasticContainerServiceEcsServiceConnect
```

```text
include('aws-q3-2025/Resource/Containers/AmazonElasticContainerServiceEcsServiceConnect')
```
