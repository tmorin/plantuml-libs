...
```text
aws-q3-2025/Resource/Containers/AmazonElasticContainerServiceCopiIoTCli
```

```text
include('aws-q3-2025/Resource/Containers/AmazonElasticContainerServiceCopiIoTCli')
```
