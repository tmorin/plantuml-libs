...
```text
aws-q3-2025/Resource/Containers/AmazonElasticContainerServiceContainer2
```

```text
include('aws-q3-2025/Resource/Containers/AmazonElasticContainerServiceContainer2')
```
