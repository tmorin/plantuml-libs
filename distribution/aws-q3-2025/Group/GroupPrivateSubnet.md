...
```text
aws-q3-2025/Group/GroupPrivateSubnet
```

```text
include('aws-q3-2025/Group/GroupPrivateSubnet')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../aws-q3-2025/Resource/GroupIcons/PrivateSubnet.png) | ![illustration for GroupPrivateSubnet](../../aws-q3-2025/Group/GroupPrivateSubnet.Local.png) |
