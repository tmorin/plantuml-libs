...
```text
aws-q3-2025/Group/GroupCorporateDataCenter
```

```text
include('aws-q3-2025/Group/GroupCorporateDataCenter')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../aws-q3-2025/Resource/GroupIcons/CorporateDataCenter.png) | ![illustration for GroupCorporateDataCenter](../../aws-q3-2025/Group/GroupCorporateDataCenter.Local.png) |
