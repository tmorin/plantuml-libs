...
```text
aws-q3-2025/Group/GroupElasticBeanstalkContainer
```

```text
include('aws-q3-2025/Group/GroupElasticBeanstalkContainer')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../aws-q3-2025/Resource/GroupIcons/ElasticBeanstalkContainer.png) | ![illustration for GroupElasticBeanstalkContainer](../../aws-q3-2025/Group/GroupElasticBeanstalkContainer.Local.png) |
