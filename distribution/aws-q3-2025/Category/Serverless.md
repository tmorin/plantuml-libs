...
```text
aws-q3-2025/Category/Serverless
```

```text
include('aws-q3-2025/Category/Serverless')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q3-2025/Category/Serverless.png) | ![illustration for Serverless](../../aws-q3-2025/Category/Serverless.Local.png) | ![illustration for ServerlessCard](../../aws-q3-2025/Category/ServerlessCard.Local.png) | ![illustration for ServerlessGroup](../../aws-q3-2025/Category/ServerlessGroup.Local.png) |
