...
```text
aws-q3-2025/Category/MigrationModernization
```

```text
include('aws-q3-2025/Category/MigrationModernization')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q3-2025/Category/MigrationModernization.png) | ![illustration for MigrationModernization](../../aws-q3-2025/Category/MigrationModernization.Local.png) | ![illustration for MigrationModernizationCard](../../aws-q3-2025/Category/MigrationModernizationCard.Local.png) | ![illustration for MigrationModernizationGroup](../../aws-q3-2025/Category/MigrationModernizationGroup.Local.png) |
