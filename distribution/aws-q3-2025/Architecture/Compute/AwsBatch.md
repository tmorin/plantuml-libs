...
```text
aws-q3-2025/Architecture/Compute/AwsBatch
```

```text
include('aws-q3-2025/Architecture/Compute/AwsBatch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Compute/AwsBatch.png) | ![illustration for AwsBatch](../../../aws-q3-2025/Architecture/Compute/AwsBatch.Local.png) | ![illustration for AwsBatchCard](../../../aws-q3-2025/Architecture/Compute/AwsBatchCard.Local.png) | ![illustration for AwsBatchGroup](../../../aws-q3-2025/Architecture/Compute/AwsBatchGroup.Local.png) |
