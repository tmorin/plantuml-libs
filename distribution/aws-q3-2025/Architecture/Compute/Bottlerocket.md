...
```text
aws-q3-2025/Architecture/Compute/Bottlerocket
```

```text
include('aws-q3-2025/Architecture/Compute/Bottlerocket')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Compute/Bottlerocket.png) | ![illustration for Bottlerocket](../../../aws-q3-2025/Architecture/Compute/Bottlerocket.Local.png) | ![illustration for BottlerocketCard](../../../aws-q3-2025/Architecture/Compute/BottlerocketCard.Local.png) | ![illustration for BottlerocketGroup](../../../aws-q3-2025/Architecture/Compute/BottlerocketGroup.Local.png) |
