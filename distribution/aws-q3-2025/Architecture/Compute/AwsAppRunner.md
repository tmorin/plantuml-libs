...
```text
aws-q3-2025/Architecture/Compute/AwsAppRunner
```

```text
include('aws-q3-2025/Architecture/Compute/AwsAppRunner')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Compute/AwsAppRunner.png) | ![illustration for AwsAppRunner](../../../aws-q3-2025/Architecture/Compute/AwsAppRunner.Local.png) | ![illustration for AwsAppRunnerCard](../../../aws-q3-2025/Architecture/Compute/AwsAppRunnerCard.Local.png) | ![illustration for AwsAppRunnerGroup](../../../aws-q3-2025/Architecture/Compute/AwsAppRunnerGroup.Local.png) |
