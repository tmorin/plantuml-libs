...
```text
aws-q3-2025/Architecture/Compute/AwsNitroEnclaves
```

```text
include('aws-q3-2025/Architecture/Compute/AwsNitroEnclaves')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Compute/AwsNitroEnclaves.png) | ![illustration for AwsNitroEnclaves](../../../aws-q3-2025/Architecture/Compute/AwsNitroEnclaves.Local.png) | ![illustration for AwsNitroEnclavesCard](../../../aws-q3-2025/Architecture/Compute/AwsNitroEnclavesCard.Local.png) | ![illustration for AwsNitroEnclavesGroup](../../../aws-q3-2025/Architecture/Compute/AwsNitroEnclavesGroup.Local.png) |
