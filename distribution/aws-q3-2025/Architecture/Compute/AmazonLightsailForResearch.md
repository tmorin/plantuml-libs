...
```text
aws-q3-2025/Architecture/Compute/AmazonLightsailForResearch
```

```text
include('aws-q3-2025/Architecture/Compute/AmazonLightsailForResearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Compute/AmazonLightsailForResearch.png) | ![illustration for AmazonLightsailForResearch](../../../aws-q3-2025/Architecture/Compute/AmazonLightsailForResearch.Local.png) | ![illustration for AmazonLightsailForResearchCard](../../../aws-q3-2025/Architecture/Compute/AmazonLightsailForResearchCard.Local.png) | ![illustration for AmazonLightsailForResearchGroup](../../../aws-q3-2025/Architecture/Compute/AmazonLightsailForResearchGroup.Local.png) |
