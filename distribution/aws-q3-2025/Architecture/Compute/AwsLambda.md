...
```text
aws-q3-2025/Architecture/Compute/AwsLambda
```

```text
include('aws-q3-2025/Architecture/Compute/AwsLambda')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Compute/AwsLambda.png) | ![illustration for AwsLambda](../../../aws-q3-2025/Architecture/Compute/AwsLambda.Local.png) | ![illustration for AwsLambdaCard](../../../aws-q3-2025/Architecture/Compute/AwsLambdaCard.Local.png) | ![illustration for AwsLambdaGroup](../../../aws-q3-2025/Architecture/Compute/AwsLambdaGroup.Local.png) |
