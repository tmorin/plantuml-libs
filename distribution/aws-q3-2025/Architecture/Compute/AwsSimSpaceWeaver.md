...
```text
aws-q3-2025/Architecture/Compute/AwsSimSpaceWeaver
```

```text
include('aws-q3-2025/Architecture/Compute/AwsSimSpaceWeaver')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Compute/AwsSimSpaceWeaver.png) | ![illustration for AwsSimSpaceWeaver](../../../aws-q3-2025/Architecture/Compute/AwsSimSpaceWeaver.Local.png) | ![illustration for AwsSimSpaceWeaverCard](../../../aws-q3-2025/Architecture/Compute/AwsSimSpaceWeaverCard.Local.png) | ![illustration for AwsSimSpaceWeaverGroup](../../../aws-q3-2025/Architecture/Compute/AwsSimSpaceWeaverGroup.Local.png) |
