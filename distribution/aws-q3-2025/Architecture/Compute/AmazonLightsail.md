...
```text
aws-q3-2025/Architecture/Compute/AmazonLightsail
```

```text
include('aws-q3-2025/Architecture/Compute/AmazonLightsail')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Compute/AmazonLightsail.png) | ![illustration for AmazonLightsail](../../../aws-q3-2025/Architecture/Compute/AmazonLightsail.Local.png) | ![illustration for AmazonLightsailCard](../../../aws-q3-2025/Architecture/Compute/AmazonLightsailCard.Local.png) | ![illustration for AmazonLightsailGroup](../../../aws-q3-2025/Architecture/Compute/AmazonLightsailGroup.Local.png) |
