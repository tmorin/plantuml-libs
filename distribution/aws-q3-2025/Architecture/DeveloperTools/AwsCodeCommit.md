...
```text
aws-q3-2025/Architecture/DeveloperTools/AwsCodeCommit
```

```text
include('aws-q3-2025/Architecture/DeveloperTools/AwsCodeCommit')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodeCommit.png) | ![illustration for AwsCodeCommit](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodeCommit.Local.png) | ![illustration for AwsCodeCommitCard](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodeCommitCard.Local.png) | ![illustration for AwsCodeCommitGroup](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodeCommitGroup.Local.png) |
