...
```text
aws-q3-2025/Architecture/DeveloperTools/AwsXRay
```

```text
include('aws-q3-2025/Architecture/DeveloperTools/AwsXRay')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/DeveloperTools/AwsXRay.png) | ![illustration for AwsXRay](../../../aws-q3-2025/Architecture/DeveloperTools/AwsXRay.Local.png) | ![illustration for AwsXRayCard](../../../aws-q3-2025/Architecture/DeveloperTools/AwsXRayCard.Local.png) | ![illustration for AwsXRayGroup](../../../aws-q3-2025/Architecture/DeveloperTools/AwsXRayGroup.Local.png) |
