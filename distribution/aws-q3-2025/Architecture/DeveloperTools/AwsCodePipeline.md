...
```text
aws-q3-2025/Architecture/DeveloperTools/AwsCodePipeline
```

```text
include('aws-q3-2025/Architecture/DeveloperTools/AwsCodePipeline')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodePipeline.png) | ![illustration for AwsCodePipeline](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodePipeline.Local.png) | ![illustration for AwsCodePipelineCard](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodePipelineCard.Local.png) | ![illustration for AwsCodePipelineGroup](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodePipelineGroup.Local.png) |
