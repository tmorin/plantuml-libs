...
```text
aws-q3-2025/Architecture/DeveloperTools/AwsCodeBuild
```

```text
include('aws-q3-2025/Architecture/DeveloperTools/AwsCodeBuild')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodeBuild.png) | ![illustration for AwsCodeBuild](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodeBuild.Local.png) | ![illustration for AwsCodeBuildCard](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodeBuildCard.Local.png) | ![illustration for AwsCodeBuildGroup](../../../aws-q3-2025/Architecture/DeveloperTools/AwsCodeBuildGroup.Local.png) |
