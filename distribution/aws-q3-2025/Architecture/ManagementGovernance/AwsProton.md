...
```text
aws-q3-2025/Architecture/ManagementGovernance/AwsProton
```

```text
include('aws-q3-2025/Architecture/ManagementGovernance/AwsProton')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/ManagementGovernance/AwsProton.png) | ![illustration for AwsProton](../../../aws-q3-2025/Architecture/ManagementGovernance/AwsProton.Local.png) | ![illustration for AwsProtonCard](../../../aws-q3-2025/Architecture/ManagementGovernance/AwsProtonCard.Local.png) | ![illustration for AwsProtonGroup](../../../aws-q3-2025/Architecture/ManagementGovernance/AwsProtonGroup.Local.png) |
