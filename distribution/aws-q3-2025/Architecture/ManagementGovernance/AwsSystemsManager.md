...
```text
aws-q3-2025/Architecture/ManagementGovernance/AwsSystemsManager
```

```text
include('aws-q3-2025/Architecture/ManagementGovernance/AwsSystemsManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/ManagementGovernance/AwsSystemsManager.png) | ![illustration for AwsSystemsManager](../../../aws-q3-2025/Architecture/ManagementGovernance/AwsSystemsManager.Local.png) | ![illustration for AwsSystemsManagerCard](../../../aws-q3-2025/Architecture/ManagementGovernance/AwsSystemsManagerCard.Local.png) | ![illustration for AwsSystemsManagerGroup](../../../aws-q3-2025/Architecture/ManagementGovernance/AwsSystemsManagerGroup.Local.png) |
