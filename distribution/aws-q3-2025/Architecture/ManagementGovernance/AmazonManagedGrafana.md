...
```text
aws-q3-2025/Architecture/ManagementGovernance/AmazonManagedGrafana
```

```text
include('aws-q3-2025/Architecture/ManagementGovernance/AmazonManagedGrafana')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/ManagementGovernance/AmazonManagedGrafana.png) | ![illustration for AmazonManagedGrafana](../../../aws-q3-2025/Architecture/ManagementGovernance/AmazonManagedGrafana.Local.png) | ![illustration for AmazonManagedGrafanaCard](../../../aws-q3-2025/Architecture/ManagementGovernance/AmazonManagedGrafanaCard.Local.png) | ![illustration for AmazonManagedGrafanaGroup](../../../aws-q3-2025/Architecture/ManagementGovernance/AmazonManagedGrafanaGroup.Local.png) |
