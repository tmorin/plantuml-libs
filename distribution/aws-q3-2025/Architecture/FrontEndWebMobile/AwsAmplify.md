...
```text
aws-q3-2025/Architecture/FrontEndWebMobile/AwsAmplify
```

```text
include('aws-q3-2025/Architecture/FrontEndWebMobile/AwsAmplify')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/FrontEndWebMobile/AwsAmplify.png) | ![illustration for AwsAmplify](../../../aws-q3-2025/Architecture/FrontEndWebMobile/AwsAmplify.Local.png) | ![illustration for AwsAmplifyCard](../../../aws-q3-2025/Architecture/FrontEndWebMobile/AwsAmplifyCard.Local.png) | ![illustration for AwsAmplifyGroup](../../../aws-q3-2025/Architecture/FrontEndWebMobile/AwsAmplifyGroup.Local.png) |
