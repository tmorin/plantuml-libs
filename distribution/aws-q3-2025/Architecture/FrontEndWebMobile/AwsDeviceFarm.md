...
```text
aws-q3-2025/Architecture/FrontEndWebMobile/AwsDeviceFarm
```

```text
include('aws-q3-2025/Architecture/FrontEndWebMobile/AwsDeviceFarm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/FrontEndWebMobile/AwsDeviceFarm.png) | ![illustration for AwsDeviceFarm](../../../aws-q3-2025/Architecture/FrontEndWebMobile/AwsDeviceFarm.Local.png) | ![illustration for AwsDeviceFarmCard](../../../aws-q3-2025/Architecture/FrontEndWebMobile/AwsDeviceFarmCard.Local.png) | ![illustration for AwsDeviceFarmGroup](../../../aws-q3-2025/Architecture/FrontEndWebMobile/AwsDeviceFarmGroup.Local.png) |
