...
```text
aws-q3-2025/Architecture/Containers/RedHatOpenShiftServiceOnAws
```

```text
include('aws-q3-2025/Architecture/Containers/RedHatOpenShiftServiceOnAws')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Containers/RedHatOpenShiftServiceOnAws.png) | ![illustration for RedHatOpenShiftServiceOnAws](../../../aws-q3-2025/Architecture/Containers/RedHatOpenShiftServiceOnAws.Local.png) | ![illustration for RedHatOpenShiftServiceOnAwsCard](../../../aws-q3-2025/Architecture/Containers/RedHatOpenShiftServiceOnAwsCard.Local.png) | ![illustration for RedHatOpenShiftServiceOnAwsGroup](../../../aws-q3-2025/Architecture/Containers/RedHatOpenShiftServiceOnAwsGroup.Local.png) |
