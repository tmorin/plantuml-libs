...
```text
aws-q3-2025/Architecture/BusinessApplications/AmazonConnect
```

```text
include('aws-q3-2025/Architecture/BusinessApplications/AmazonConnect')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/BusinessApplications/AmazonConnect.png) | ![illustration for AmazonConnect](../../../aws-q3-2025/Architecture/BusinessApplications/AmazonConnect.Local.png) | ![illustration for AmazonConnectCard](../../../aws-q3-2025/Architecture/BusinessApplications/AmazonConnectCard.Local.png) | ![illustration for AmazonConnectGroup](../../../aws-q3-2025/Architecture/BusinessApplications/AmazonConnectGroup.Local.png) |
