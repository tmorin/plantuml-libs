...
```text
aws-q3-2025/Architecture/BusinessApplications/AwsAppFabric
```

```text
include('aws-q3-2025/Architecture/BusinessApplications/AwsAppFabric')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/BusinessApplications/AwsAppFabric.png) | ![illustration for AwsAppFabric](../../../aws-q3-2025/Architecture/BusinessApplications/AwsAppFabric.Local.png) | ![illustration for AwsAppFabricCard](../../../aws-q3-2025/Architecture/BusinessApplications/AwsAppFabricCard.Local.png) | ![illustration for AwsAppFabricGroup](../../../aws-q3-2025/Architecture/BusinessApplications/AwsAppFabricGroup.Local.png) |
