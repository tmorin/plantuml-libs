...
```text
aws-q3-2025/Architecture/NetworkingContentDelivery/AmazonApiGateway
```

```text
include('aws-q3-2025/Architecture/NetworkingContentDelivery/AmazonApiGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/NetworkingContentDelivery/AmazonApiGateway.png) | ![illustration for AmazonApiGateway](../../../aws-q3-2025/Architecture/NetworkingContentDelivery/AmazonApiGateway.Local.png) | ![illustration for AmazonApiGatewayCard](../../../aws-q3-2025/Architecture/NetworkingContentDelivery/AmazonApiGatewayCard.Local.png) | ![illustration for AmazonApiGatewayGroup](../../../aws-q3-2025/Architecture/NetworkingContentDelivery/AmazonApiGatewayGroup.Local.png) |
