...
```text
aws-q3-2025/Architecture/NetworkingContentDelivery/AwsTransitGateway
```

```text
include('aws-q3-2025/Architecture/NetworkingContentDelivery/AwsTransitGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/NetworkingContentDelivery/AwsTransitGateway.png) | ![illustration for AwsTransitGateway](../../../aws-q3-2025/Architecture/NetworkingContentDelivery/AwsTransitGateway.Local.png) | ![illustration for AwsTransitGatewayCard](../../../aws-q3-2025/Architecture/NetworkingContentDelivery/AwsTransitGatewayCard.Local.png) | ![illustration for AwsTransitGatewayGroup](../../../aws-q3-2025/Architecture/NetworkingContentDelivery/AwsTransitGatewayGroup.Local.png) |
