...
```text
aws-q3-2025/Architecture/MigrationModernization/AwsTransferFamily
```

```text
include('aws-q3-2025/Architecture/MigrationModernization/AwsTransferFamily')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/MigrationModernization/AwsTransferFamily.png) | ![illustration for AwsTransferFamily](../../../aws-q3-2025/Architecture/MigrationModernization/AwsTransferFamily.Local.png) | ![illustration for AwsTransferFamilyCard](../../../aws-q3-2025/Architecture/MigrationModernization/AwsTransferFamilyCard.Local.png) | ![illustration for AwsTransferFamilyGroup](../../../aws-q3-2025/Architecture/MigrationModernization/AwsTransferFamilyGroup.Local.png) |
