...
```text
aws-q3-2025/Architecture/MigrationModernization/AwsMigrationEvaluator
```

```text
include('aws-q3-2025/Architecture/MigrationModernization/AwsMigrationEvaluator')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/MigrationModernization/AwsMigrationEvaluator.png) | ![illustration for AwsMigrationEvaluator](../../../aws-q3-2025/Architecture/MigrationModernization/AwsMigrationEvaluator.Local.png) | ![illustration for AwsMigrationEvaluatorCard](../../../aws-q3-2025/Architecture/MigrationModernization/AwsMigrationEvaluatorCard.Local.png) | ![illustration for AwsMigrationEvaluatorGroup](../../../aws-q3-2025/Architecture/MigrationModernization/AwsMigrationEvaluatorGroup.Local.png) |
