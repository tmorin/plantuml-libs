...
```text
aws-q3-2025/Architecture/MigrationModernization/AwsDataSync
```

```text
include('aws-q3-2025/Architecture/MigrationModernization/AwsDataSync')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/MigrationModernization/AwsDataSync.png) | ![illustration for AwsDataSync](../../../aws-q3-2025/Architecture/MigrationModernization/AwsDataSync.Local.png) | ![illustration for AwsDataSyncCard](../../../aws-q3-2025/Architecture/MigrationModernization/AwsDataSyncCard.Local.png) | ![illustration for AwsDataSyncGroup](../../../aws-q3-2025/Architecture/MigrationModernization/AwsDataSyncGroup.Local.png) |
