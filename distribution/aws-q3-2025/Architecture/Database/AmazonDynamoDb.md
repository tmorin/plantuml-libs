...
```text
aws-q3-2025/Architecture/Database/AmazonDynamoDb
```

```text
include('aws-q3-2025/Architecture/Database/AmazonDynamoDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Database/AmazonDynamoDb.png) | ![illustration for AmazonDynamoDb](../../../aws-q3-2025/Architecture/Database/AmazonDynamoDb.Local.png) | ![illustration for AmazonDynamoDbCard](../../../aws-q3-2025/Architecture/Database/AmazonDynamoDbCard.Local.png) | ![illustration for AmazonDynamoDbGroup](../../../aws-q3-2025/Architecture/Database/AmazonDynamoDbGroup.Local.png) |
