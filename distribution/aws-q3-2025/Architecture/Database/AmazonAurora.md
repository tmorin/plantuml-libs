...
```text
aws-q3-2025/Architecture/Database/AmazonAurora
```

```text
include('aws-q3-2025/Architecture/Database/AmazonAurora')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Database/AmazonAurora.png) | ![illustration for AmazonAurora](../../../aws-q3-2025/Architecture/Database/AmazonAurora.Local.png) | ![illustration for AmazonAuroraCard](../../../aws-q3-2025/Architecture/Database/AmazonAuroraCard.Local.png) | ![illustration for AmazonAuroraGroup](../../../aws-q3-2025/Architecture/Database/AmazonAuroraGroup.Local.png) |
