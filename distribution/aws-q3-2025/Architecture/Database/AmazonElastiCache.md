...
```text
aws-q3-2025/Architecture/Database/AmazonElastiCache
```

```text
include('aws-q3-2025/Architecture/Database/AmazonElastiCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Database/AmazonElastiCache.png) | ![illustration for AmazonElastiCache](../../../aws-q3-2025/Architecture/Database/AmazonElastiCache.Local.png) | ![illustration for AmazonElastiCacheCard](../../../aws-q3-2025/Architecture/Database/AmazonElastiCacheCard.Local.png) | ![illustration for AmazonElastiCacheGroup](../../../aws-q3-2025/Architecture/Database/AmazonElastiCacheGroup.Local.png) |
