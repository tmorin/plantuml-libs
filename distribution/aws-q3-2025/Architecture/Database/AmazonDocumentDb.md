...
```text
aws-q3-2025/Architecture/Database/AmazonDocumentDb
```

```text
include('aws-q3-2025/Architecture/Database/AmazonDocumentDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Database/AmazonDocumentDb.png) | ![illustration for AmazonDocumentDb](../../../aws-q3-2025/Architecture/Database/AmazonDocumentDb.Local.png) | ![illustration for AmazonDocumentDbCard](../../../aws-q3-2025/Architecture/Database/AmazonDocumentDbCard.Local.png) | ![illustration for AmazonDocumentDbGroup](../../../aws-q3-2025/Architecture/Database/AmazonDocumentDbGroup.Local.png) |
