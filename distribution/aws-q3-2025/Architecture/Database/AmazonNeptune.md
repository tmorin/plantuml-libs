...
```text
aws-q3-2025/Architecture/Database/AmazonNeptune
```

```text
include('aws-q3-2025/Architecture/Database/AmazonNeptune')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Database/AmazonNeptune.png) | ![illustration for AmazonNeptune](../../../aws-q3-2025/Architecture/Database/AmazonNeptune.Local.png) | ![illustration for AmazonNeptuneCard](../../../aws-q3-2025/Architecture/Database/AmazonNeptuneCard.Local.png) | ![illustration for AmazonNeptuneGroup](../../../aws-q3-2025/Architecture/Database/AmazonNeptuneGroup.Local.png) |
