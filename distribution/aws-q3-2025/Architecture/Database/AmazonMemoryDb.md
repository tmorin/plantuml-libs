...
```text
aws-q3-2025/Architecture/Database/AmazonMemoryDb
```

```text
include('aws-q3-2025/Architecture/Database/AmazonMemoryDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Database/AmazonMemoryDb.png) | ![illustration for AmazonMemoryDb](../../../aws-q3-2025/Architecture/Database/AmazonMemoryDb.Local.png) | ![illustration for AmazonMemoryDbCard](../../../aws-q3-2025/Architecture/Database/AmazonMemoryDbCard.Local.png) | ![illustration for AmazonMemoryDbGroup](../../../aws-q3-2025/Architecture/Database/AmazonMemoryDbGroup.Local.png) |
