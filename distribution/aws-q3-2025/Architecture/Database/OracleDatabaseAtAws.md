...
```text
aws-q3-2025/Architecture/Database/OracleDatabaseAtAws
```

```text
include('aws-q3-2025/Architecture/Database/OracleDatabaseAtAws')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Database/OracleDatabaseAtAws.png) | ![illustration for OracleDatabaseAtAws](../../../aws-q3-2025/Architecture/Database/OracleDatabaseAtAws.Local.png) | ![illustration for OracleDatabaseAtAwsCard](../../../aws-q3-2025/Architecture/Database/OracleDatabaseAtAwsCard.Local.png) | ![illustration for OracleDatabaseAtAwsGroup](../../../aws-q3-2025/Architecture/Database/OracleDatabaseAtAwsGroup.Local.png) |
