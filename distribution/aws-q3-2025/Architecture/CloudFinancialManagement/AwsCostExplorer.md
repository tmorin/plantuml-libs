...
```text
aws-q3-2025/Architecture/CloudFinancialManagement/AwsCostExplorer
```

```text
include('aws-q3-2025/Architecture/CloudFinancialManagement/AwsCostExplorer')
```
