...
```text
aws-q3-2025/Architecture/Analytics/AmazonOpenSearchService
```

```text
include('aws-q3-2025/Architecture/Analytics/AmazonOpenSearchService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Analytics/AmazonOpenSearchService.png) | ![illustration for AmazonOpenSearchService](../../../aws-q3-2025/Architecture/Analytics/AmazonOpenSearchService.Local.png) | ![illustration for AmazonOpenSearchServiceCard](../../../aws-q3-2025/Architecture/Analytics/AmazonOpenSearchServiceCard.Local.png) | ![illustration for AmazonOpenSearchServiceGroup](../../../aws-q3-2025/Architecture/Analytics/AmazonOpenSearchServiceGroup.Local.png) |
