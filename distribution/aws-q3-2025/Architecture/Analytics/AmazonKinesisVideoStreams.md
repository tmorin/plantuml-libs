...
```text
aws-q3-2025/Architecture/Analytics/AmazonKinesisVideoStreams
```

```text
include('aws-q3-2025/Architecture/Analytics/AmazonKinesisVideoStreams')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Analytics/AmazonKinesisVideoStreams.png) | ![illustration for AmazonKinesisVideoStreams](../../../aws-q3-2025/Architecture/Analytics/AmazonKinesisVideoStreams.Local.png) | ![illustration for AmazonKinesisVideoStreamsCard](../../../aws-q3-2025/Architecture/Analytics/AmazonKinesisVideoStreamsCard.Local.png) | ![illustration for AmazonKinesisVideoStreamsGroup](../../../aws-q3-2025/Architecture/Analytics/AmazonKinesisVideoStreamsGroup.Local.png) |
