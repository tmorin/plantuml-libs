...
```text
aws-q3-2025/Architecture/Analytics/AmazonSageMaker
```

```text
include('aws-q3-2025/Architecture/Analytics/AmazonSageMaker')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Analytics/AmazonSageMaker.png) | ![illustration for AmazonSageMaker](../../../aws-q3-2025/Architecture/Analytics/AmazonSageMaker.Local.png) | ![illustration for AmazonSageMakerCard](../../../aws-q3-2025/Architecture/Analytics/AmazonSageMakerCard.Local.png) | ![illustration for AmazonSageMakerGroup](../../../aws-q3-2025/Architecture/Analytics/AmazonSageMakerGroup.Local.png) |
