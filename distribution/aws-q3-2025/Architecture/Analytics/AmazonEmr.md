...
```text
aws-q3-2025/Architecture/Analytics/AmazonEmr
```

```text
include('aws-q3-2025/Architecture/Analytics/AmazonEmr')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Analytics/AmazonEmr.png) | ![illustration for AmazonEmr](../../../aws-q3-2025/Architecture/Analytics/AmazonEmr.Local.png) | ![illustration for AmazonEmrCard](../../../aws-q3-2025/Architecture/Analytics/AmazonEmrCard.Local.png) | ![illustration for AmazonEmrGroup](../../../aws-q3-2025/Architecture/Analytics/AmazonEmrGroup.Local.png) |
