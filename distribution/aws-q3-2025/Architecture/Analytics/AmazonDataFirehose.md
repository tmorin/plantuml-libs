...
```text
aws-q3-2025/Architecture/Analytics/AmazonDataFirehose
```

```text
include('aws-q3-2025/Architecture/Analytics/AmazonDataFirehose')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Analytics/AmazonDataFirehose.png) | ![illustration for AmazonDataFirehose](../../../aws-q3-2025/Architecture/Analytics/AmazonDataFirehose.Local.png) | ![illustration for AmazonDataFirehoseCard](../../../aws-q3-2025/Architecture/Analytics/AmazonDataFirehoseCard.Local.png) | ![illustration for AmazonDataFirehoseGroup](../../../aws-q3-2025/Architecture/Analytics/AmazonDataFirehoseGroup.Local.png) |
