...
```text
aws-q3-2025/Architecture/Analytics/AmazonAthena
```

```text
include('aws-q3-2025/Architecture/Analytics/AmazonAthena')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Analytics/AmazonAthena.png) | ![illustration for AmazonAthena](../../../aws-q3-2025/Architecture/Analytics/AmazonAthena.Local.png) | ![illustration for AmazonAthenaCard](../../../aws-q3-2025/Architecture/Analytics/AmazonAthenaCard.Local.png) | ![illustration for AmazonAthenaGroup](../../../aws-q3-2025/Architecture/Analytics/AmazonAthenaGroup.Local.png) |
