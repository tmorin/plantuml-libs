...
```text
aws-q3-2025/Architecture/Analytics/AmazonCloudSearch
```

```text
include('aws-q3-2025/Architecture/Analytics/AmazonCloudSearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Analytics/AmazonCloudSearch.png) | ![illustration for AmazonCloudSearch](../../../aws-q3-2025/Architecture/Analytics/AmazonCloudSearch.Local.png) | ![illustration for AmazonCloudSearchCard](../../../aws-q3-2025/Architecture/Analytics/AmazonCloudSearchCard.Local.png) | ![illustration for AmazonCloudSearchGroup](../../../aws-q3-2025/Architecture/Analytics/AmazonCloudSearchGroup.Local.png) |
