...
```text
aws-q3-2025/Architecture/Analytics/AwsGlue
```

```text
include('aws-q3-2025/Architecture/Analytics/AwsGlue')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Analytics/AwsGlue.png) | ![illustration for AwsGlue](../../../aws-q3-2025/Architecture/Analytics/AwsGlue.Local.png) | ![illustration for AwsGlueCard](../../../aws-q3-2025/Architecture/Analytics/AwsGlueCard.Local.png) | ![illustration for AwsGlueGroup](../../../aws-q3-2025/Architecture/Analytics/AwsGlueGroup.Local.png) |
