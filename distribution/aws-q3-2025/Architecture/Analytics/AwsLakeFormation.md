...
```text
aws-q3-2025/Architecture/Analytics/AwsLakeFormation
```

```text
include('aws-q3-2025/Architecture/Analytics/AwsLakeFormation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Analytics/AwsLakeFormation.png) | ![illustration for AwsLakeFormation](../../../aws-q3-2025/Architecture/Analytics/AwsLakeFormation.Local.png) | ![illustration for AwsLakeFormationCard](../../../aws-q3-2025/Architecture/Analytics/AwsLakeFormationCard.Local.png) | ![illustration for AwsLakeFormationGroup](../../../aws-q3-2025/Architecture/Analytics/AwsLakeFormationGroup.Local.png) |
