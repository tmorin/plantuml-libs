...
```text
aws-q3-2025/Architecture/InternetOfThings/AwsIoTButton
```

```text
include('aws-q3-2025/Architecture/InternetOfThings/AwsIoTButton')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTButton.png) | ![illustration for AwsIoTButton](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTButton.Local.png) | ![illustration for AwsIoTButtonCard](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTButtonCard.Local.png) | ![illustration for AwsIoTButtonGroup](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTButtonGroup.Local.png) |
