...
```text
aws-q3-2025/Architecture/InternetOfThings/AwsIoTSiteWise
```

```text
include('aws-q3-2025/Architecture/InternetOfThings/AwsIoTSiteWise')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTSiteWise.png) | ![illustration for AwsIoTSiteWise](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTSiteWise.Local.png) | ![illustration for AwsIoTSiteWiseCard](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTSiteWiseCard.Local.png) | ![illustration for AwsIoTSiteWiseGroup](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTSiteWiseGroup.Local.png) |
