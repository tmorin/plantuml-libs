...
```text
aws-q3-2025/Architecture/InternetOfThings/AwsIoTEvents
```

```text
include('aws-q3-2025/Architecture/InternetOfThings/AwsIoTEvents')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTEvents.png) | ![illustration for AwsIoTEvents](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTEvents.Local.png) | ![illustration for AwsIoTEventsCard](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTEventsCard.Local.png) | ![illustration for AwsIoTEventsGroup](../../../aws-q3-2025/Architecture/InternetOfThings/AwsIoTEventsGroup.Local.png) |
