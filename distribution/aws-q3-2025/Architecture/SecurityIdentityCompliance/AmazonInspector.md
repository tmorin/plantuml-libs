...
```text
aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonInspector
```

```text
include('aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonInspector')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonInspector.png) | ![illustration for AmazonInspector](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonInspector.Local.png) | ![illustration for AmazonInspectorCard](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonInspectorCard.Local.png) | ![illustration for AmazonInspectorGroup](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonInspectorGroup.Local.png) |
