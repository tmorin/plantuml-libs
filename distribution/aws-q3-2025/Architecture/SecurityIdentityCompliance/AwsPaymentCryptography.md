...
```text
aws-q3-2025/Architecture/SecurityIdentityCompliance/AwsPaymentCryptography
```

```text
include('aws-q3-2025/Architecture/SecurityIdentityCompliance/AwsPaymentCryptography')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AwsPaymentCryptography.png) | ![illustration for AwsPaymentCryptography](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AwsPaymentCryptography.Local.png) | ![illustration for AwsPaymentCryptographyCard](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AwsPaymentCryptographyCard.Local.png) | ![illustration for AwsPaymentCryptographyGroup](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AwsPaymentCryptographyGroup.Local.png) |
