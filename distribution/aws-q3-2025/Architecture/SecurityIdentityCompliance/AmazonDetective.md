...
```text
aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonDetective
```

```text
include('aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonDetective')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonDetective.png) | ![illustration for AmazonDetective](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonDetective.Local.png) | ![illustration for AmazonDetectiveCard](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonDetectiveCard.Local.png) | ![illustration for AmazonDetectiveGroup](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonDetectiveGroup.Local.png) |
