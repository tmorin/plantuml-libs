...
```text
aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonGuardDuty
```

```text
include('aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonGuardDuty')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonGuardDuty.png) | ![illustration for AmazonGuardDuty](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonGuardDuty.Local.png) | ![illustration for AmazonGuardDutyCard](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonGuardDutyCard.Local.png) | ![illustration for AmazonGuardDutyGroup](../../../aws-q3-2025/Architecture/SecurityIdentityCompliance/AmazonGuardDutyGroup.Local.png) |
