...
```text
aws-q3-2025/Architecture/Storage/AwsElasticDisasterRecovery
```

```text
include('aws-q3-2025/Architecture/Storage/AwsElasticDisasterRecovery')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Storage/AwsElasticDisasterRecovery.png) | ![illustration for AwsElasticDisasterRecovery](../../../aws-q3-2025/Architecture/Storage/AwsElasticDisasterRecovery.Local.png) | ![illustration for AwsElasticDisasterRecoveryCard](../../../aws-q3-2025/Architecture/Storage/AwsElasticDisasterRecoveryCard.Local.png) | ![illustration for AwsElasticDisasterRecoveryGroup](../../../aws-q3-2025/Architecture/Storage/AwsElasticDisasterRecoveryGroup.Local.png) |
