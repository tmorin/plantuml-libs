...
```text
aws-q3-2025/Architecture/Storage/AwsSnowball
```

```text
include('aws-q3-2025/Architecture/Storage/AwsSnowball')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Storage/AwsSnowball.png) | ![illustration for AwsSnowball](../../../aws-q3-2025/Architecture/Storage/AwsSnowball.Local.png) | ![illustration for AwsSnowballCard](../../../aws-q3-2025/Architecture/Storage/AwsSnowballCard.Local.png) | ![illustration for AwsSnowballGroup](../../../aws-q3-2025/Architecture/Storage/AwsSnowballGroup.Local.png) |
