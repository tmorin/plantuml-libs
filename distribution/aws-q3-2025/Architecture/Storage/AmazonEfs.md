...
```text
aws-q3-2025/Architecture/Storage/AmazonEfs
```

```text
include('aws-q3-2025/Architecture/Storage/AmazonEfs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Storage/AmazonEfs.png) | ![illustration for AmazonEfs](../../../aws-q3-2025/Architecture/Storage/AmazonEfs.Local.png) | ![illustration for AmazonEfsCard](../../../aws-q3-2025/Architecture/Storage/AmazonEfsCard.Local.png) | ![illustration for AmazonEfsGroup](../../../aws-q3-2025/Architecture/Storage/AmazonEfsGroup.Local.png) |
