...
```text
aws-q3-2025/Architecture/Storage/AmazonFSxForOpenZfs
```

```text
include('aws-q3-2025/Architecture/Storage/AmazonFSxForOpenZfs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Storage/AmazonFSxForOpenZfs.png) | ![illustration for AmazonFSxForOpenZfs](../../../aws-q3-2025/Architecture/Storage/AmazonFSxForOpenZfs.Local.png) | ![illustration for AmazonFSxForOpenZfsCard](../../../aws-q3-2025/Architecture/Storage/AmazonFSxForOpenZfsCard.Local.png) | ![illustration for AmazonFSxForOpenZfsGroup](../../../aws-q3-2025/Architecture/Storage/AmazonFSxForOpenZfsGroup.Local.png) |
