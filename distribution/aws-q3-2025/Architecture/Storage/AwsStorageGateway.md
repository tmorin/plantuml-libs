...
```text
aws-q3-2025/Architecture/Storage/AwsStorageGateway
```

```text
include('aws-q3-2025/Architecture/Storage/AwsStorageGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Storage/AwsStorageGateway.png) | ![illustration for AwsStorageGateway](../../../aws-q3-2025/Architecture/Storage/AwsStorageGateway.Local.png) | ![illustration for AwsStorageGatewayCard](../../../aws-q3-2025/Architecture/Storage/AwsStorageGatewayCard.Local.png) | ![illustration for AwsStorageGatewayGroup](../../../aws-q3-2025/Architecture/Storage/AwsStorageGatewayGroup.Local.png) |
