...
```text
aws-q3-2025/Architecture/Storage/AmazonFSxForLustre
```

```text
include('aws-q3-2025/Architecture/Storage/AmazonFSxForLustre')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Storage/AmazonFSxForLustre.png) | ![illustration for AmazonFSxForLustre](../../../aws-q3-2025/Architecture/Storage/AmazonFSxForLustre.Local.png) | ![illustration for AmazonFSxForLustreCard](../../../aws-q3-2025/Architecture/Storage/AmazonFSxForLustreCard.Local.png) | ![illustration for AmazonFSxForLustreGroup](../../../aws-q3-2025/Architecture/Storage/AmazonFSxForLustreGroup.Local.png) |
