...
```text
aws-q3-2025/Architecture/CustomerEnablement/AwsProfessionalServices
```

```text
include('aws-q3-2025/Architecture/CustomerEnablement/AwsProfessionalServices')
```
