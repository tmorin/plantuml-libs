...
```text
aws-q3-2025/Architecture/CustomerEnablement/AwsManagedServices
```

```text
include('aws-q3-2025/Architecture/CustomerEnablement/AwsManagedServices')
```
