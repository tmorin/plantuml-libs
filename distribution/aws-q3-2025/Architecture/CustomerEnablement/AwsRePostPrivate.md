...
```text
aws-q3-2025/Architecture/CustomerEnablement/AwsRePostPrivate
```

```text
include('aws-q3-2025/Architecture/CustomerEnablement/AwsRePostPrivate')
```
