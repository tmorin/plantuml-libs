...
```text
aws-q3-2025/Architecture/MediaServices/AwsElementalServer
```

```text
include('aws-q3-2025/Architecture/MediaServices/AwsElementalServer')
```
