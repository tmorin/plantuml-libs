...
```text
aws-q3-2025/Architecture/MediaServices/AwsElementalMediaConnect
```

```text
include('aws-q3-2025/Architecture/MediaServices/AwsElementalMediaConnect')
```
