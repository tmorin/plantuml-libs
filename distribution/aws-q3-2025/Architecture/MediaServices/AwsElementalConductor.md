...
```text
aws-q3-2025/Architecture/MediaServices/AwsElementalConductor
```

```text
include('aws-q3-2025/Architecture/MediaServices/AwsElementalConductor')
```
