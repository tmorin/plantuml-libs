...
```text
aws-q3-2025/Architecture/MediaServices/AwsThinkboxSequoia
```

```text
include('aws-q3-2025/Architecture/MediaServices/AwsThinkboxSequoia')
```
