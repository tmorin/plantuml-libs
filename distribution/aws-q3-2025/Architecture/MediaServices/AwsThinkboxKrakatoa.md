...
```text
aws-q3-2025/Architecture/MediaServices/AwsThinkboxKrakatoa
```

```text
include('aws-q3-2025/Architecture/MediaServices/AwsThinkboxKrakatoa')
```
