...
```text
aws-q3-2025/Architecture/MediaServices/AwsThinkboxStoke
```

```text
include('aws-q3-2025/Architecture/MediaServices/AwsThinkboxStoke')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/MediaServices/AwsThinkboxStoke.png) | ![illustration for AwsThinkboxStoke](../../../aws-q3-2025/Architecture/MediaServices/AwsThinkboxStoke.Local.png) | ![illustration for AwsThinkboxStokeCard](../../../aws-q3-2025/Architecture/MediaServices/AwsThinkboxStokeCard.Local.png) | ![illustration for AwsThinkboxStokeGroup](../../../aws-q3-2025/Architecture/MediaServices/AwsThinkboxStokeGroup.Local.png) |
