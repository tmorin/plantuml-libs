...
```text
aws-q3-2025/Architecture/MediaServices/AwsElementalMediaStore
```

```text
include('aws-q3-2025/Architecture/MediaServices/AwsElementalMediaStore')
```
