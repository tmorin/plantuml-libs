...
```text
aws-q3-2025/Architecture/MediaServices/AmazonKinesisVideoStreams
```

```text
include('aws-q3-2025/Architecture/MediaServices/AmazonKinesisVideoStreams')
```
