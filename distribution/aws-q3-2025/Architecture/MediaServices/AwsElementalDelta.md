...
```text
aws-q3-2025/Architecture/MediaServices/AwsElementalDelta
```

```text
include('aws-q3-2025/Architecture/MediaServices/AwsElementalDelta')
```
