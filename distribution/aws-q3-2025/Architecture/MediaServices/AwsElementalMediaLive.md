...
```text
aws-q3-2025/Architecture/MediaServices/AwsElementalMediaLive
```

```text
include('aws-q3-2025/Architecture/MediaServices/AwsElementalMediaLive')
```
