...
```text
aws-q3-2025/Architecture/MediaServices/AwsElementalAppliancesSoftware
```

```text
include('aws-q3-2025/Architecture/MediaServices/AwsElementalAppliancesSoftware')
```
