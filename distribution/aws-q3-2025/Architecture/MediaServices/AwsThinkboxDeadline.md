...
```text
aws-q3-2025/Architecture/MediaServices/AwsThinkboxDeadline
```

```text
include('aws-q3-2025/Architecture/MediaServices/AwsThinkboxDeadline')
```
