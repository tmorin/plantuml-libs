...
```text
aws-q3-2025/Architecture/AppIntegration/AmazonSimpleNotificationService
```

```text
include('aws-q3-2025/Architecture/AppIntegration/AmazonSimpleNotificationService')
```
