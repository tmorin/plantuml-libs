...
```text
aws-q3-2025/Architecture/AppIntegration/AmazonSimpleQueueService
```

```text
include('aws-q3-2025/Architecture/AppIntegration/AmazonSimpleQueueService')
```
