...
```text
aws-q3-2025/Architecture/AppIntegration/AmazonEventBridge
```

```text
include('aws-q3-2025/Architecture/AppIntegration/AmazonEventBridge')
```
