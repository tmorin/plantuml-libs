...
```text
aws-q3-2025/Architecture/AppIntegration/AwsExpressWorkflows
```

```text
include('aws-q3-2025/Architecture/AppIntegration/AwsExpressWorkflows')
```
