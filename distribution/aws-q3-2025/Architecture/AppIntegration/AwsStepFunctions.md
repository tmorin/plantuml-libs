...
```text
aws-q3-2025/Architecture/AppIntegration/AwsStepFunctions
```

```text
include('aws-q3-2025/Architecture/AppIntegration/AwsStepFunctions')
```
