...
```text
aws-q3-2025/Architecture/AppIntegration/AwsB2BDataInterchange
```

```text
include('aws-q3-2025/Architecture/AppIntegration/AwsB2BDataInterchange')
```
