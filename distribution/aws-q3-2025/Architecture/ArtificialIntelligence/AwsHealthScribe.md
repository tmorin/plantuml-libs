...
```text
aws-q3-2025/Architecture/ArtificialIntelligence/AwsHealthScribe
```

```text
include('aws-q3-2025/Architecture/ArtificialIntelligence/AwsHealthScribe')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AwsHealthScribe.png) | ![illustration for AwsHealthScribe](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AwsHealthScribe.Local.png) | ![illustration for AwsHealthScribeCard](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AwsHealthScribeCard.Local.png) | ![illustration for AwsHealthScribeGroup](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AwsHealthScribeGroup.Local.png) |
