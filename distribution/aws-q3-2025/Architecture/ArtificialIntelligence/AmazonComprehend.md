...
```text
aws-q3-2025/Architecture/ArtificialIntelligence/AmazonComprehend
```

```text
include('aws-q3-2025/Architecture/ArtificialIntelligence/AmazonComprehend')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonComprehend.png) | ![illustration for AmazonComprehend](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonComprehend.Local.png) | ![illustration for AmazonComprehendCard](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonComprehendCard.Local.png) | ![illustration for AmazonComprehendGroup](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonComprehendGroup.Local.png) |
