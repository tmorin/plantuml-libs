...
```text
aws-q3-2025/Architecture/ArtificialIntelligence/TensorFlowOnAws
```

```text
include('aws-q3-2025/Architecture/ArtificialIntelligence/TensorFlowOnAws')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/ArtificialIntelligence/TensorFlowOnAws.png) | ![illustration for TensorFlowOnAws](../../../aws-q3-2025/Architecture/ArtificialIntelligence/TensorFlowOnAws.Local.png) | ![illustration for TensorFlowOnAwsCard](../../../aws-q3-2025/Architecture/ArtificialIntelligence/TensorFlowOnAwsCard.Local.png) | ![illustration for TensorFlowOnAwsGroup](../../../aws-q3-2025/Architecture/ArtificialIntelligence/TensorFlowOnAwsGroup.Local.png) |
