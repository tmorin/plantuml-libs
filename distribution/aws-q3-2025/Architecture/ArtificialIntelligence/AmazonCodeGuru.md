...
```text
aws-q3-2025/Architecture/ArtificialIntelligence/AmazonCodeGuru
```

```text
include('aws-q3-2025/Architecture/ArtificialIntelligence/AmazonCodeGuru')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonCodeGuru.png) | ![illustration for AmazonCodeGuru](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonCodeGuru.Local.png) | ![illustration for AmazonCodeGuruCard](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonCodeGuruCard.Local.png) | ![illustration for AmazonCodeGuruGroup](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonCodeGuruGroup.Local.png) |
