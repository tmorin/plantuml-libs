...
```text
aws-q3-2025/Architecture/ArtificialIntelligence/AmazonTextract
```

```text
include('aws-q3-2025/Architecture/ArtificialIntelligence/AmazonTextract')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonTextract.png) | ![illustration for AmazonTextract](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonTextract.Local.png) | ![illustration for AmazonTextractCard](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonTextractCard.Local.png) | ![illustration for AmazonTextractGroup](../../../aws-q3-2025/Architecture/ArtificialIntelligence/AmazonTextractGroup.Local.png) |
