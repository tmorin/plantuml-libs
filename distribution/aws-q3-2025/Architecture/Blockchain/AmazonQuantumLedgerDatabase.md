...
```text
aws-q3-2025/Architecture/Blockchain/AmazonQuantumLedgerDatabase
```

```text
include('aws-q3-2025/Architecture/Blockchain/AmazonQuantumLedgerDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2025/Architecture/Blockchain/AmazonQuantumLedgerDatabase.png) | ![illustration for AmazonQuantumLedgerDatabase](../../../aws-q3-2025/Architecture/Blockchain/AmazonQuantumLedgerDatabase.Local.png) | ![illustration for AmazonQuantumLedgerDatabaseCard](../../../aws-q3-2025/Architecture/Blockchain/AmazonQuantumLedgerDatabaseCard.Local.png) | ![illustration for AmazonQuantumLedgerDatabaseGroup](../../../aws-q3-2025/Architecture/Blockchain/AmazonQuantumLedgerDatabaseGroup.Local.png) |
