...
```text
simpleicons/F/Fraunhofergesellschaft
```

```text
include('simpleicons/F/Fraunhofergesellschaft')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/F/Fraunhofergesellschaft.png) | ![illustration for Fraunhofergesellschaft](../../simpleicons/F/Fraunhofergesellschaft.Local.png) |
