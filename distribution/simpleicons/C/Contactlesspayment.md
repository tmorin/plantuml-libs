...
```text
simpleicons/C/Contactlesspayment
```

```text
include('simpleicons/C/Contactlesspayment')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/C/Contactlesspayment.png) | ![illustration for Contactlesspayment](../../simpleicons/C/Contactlesspayment.Local.png) |
