...
```text
simpleicons/C/Creativetechnology
```

```text
include('simpleicons/C/Creativetechnology')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/C/Creativetechnology.png) | ![illustration for Creativetechnology](../../simpleicons/C/Creativetechnology.Local.png) |
