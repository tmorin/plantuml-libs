...
```text
simpleicons/C/Commonworkflowlanguage
```

```text
include('simpleicons/C/Commonworkflowlanguage')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/C/Commonworkflowlanguage.png) | ![illustration for Commonworkflowlanguage](../../simpleicons/C/Commonworkflowlanguage.Local.png) |
