...
```text
simpleicons/P/Processingfoundation
```

```text
include('simpleicons/P/Processingfoundation')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/P/Processingfoundation.png) | ![illustration for Processingfoundation](../../simpleicons/P/Processingfoundation.Local.png) |
