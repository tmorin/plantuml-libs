...
```text
simpleicons/P/Plausibleanalytics
```

```text
include('simpleicons/P/Plausibleanalytics')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/P/Plausibleanalytics.png) | ![illustration for Plausibleanalytics](../../simpleicons/P/Plausibleanalytics.Local.png) |
