...
```text
simpleicons/P/Privateinternetaccess
```

```text
include('simpleicons/P/Privateinternetaccess')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/P/Privateinternetaccess.png) | ![illustration for Privateinternetaccess](../../simpleicons/P/Privateinternetaccess.Local.png) |
