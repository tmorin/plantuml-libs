...
```text
simpleicons/O/Opensourcehardware
```

```text
include('simpleicons/O/Opensourcehardware')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/O/Opensourcehardware.png) | ![illustration for Opensourcehardware](../../simpleicons/O/Opensourcehardware.Local.png) |
