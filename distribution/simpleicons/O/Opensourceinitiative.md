...
```text
simpleicons/O/Opensourceinitiative
```

```text
include('simpleicons/O/Opensourceinitiative')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/O/Opensourceinitiative.png) | ![illustration for Opensourceinitiative](../../simpleicons/O/Opensourceinitiative.Local.png) |
