...
```text
simpleicons/K/Kingstontechnology
```

```text
include('simpleicons/K/Kingstontechnology')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/K/Kingstontechnology.png) | ![illustration for Kingstontechnology](../../simpleicons/K/Kingstontechnology.Local.png) |
