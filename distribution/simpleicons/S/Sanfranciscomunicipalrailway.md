...
```text
simpleicons/S/Sanfranciscomunicipalrailway
```

```text
include('simpleicons/S/Sanfranciscomunicipalrailway')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/S/Sanfranciscomunicipalrailway.png) | ![illustration for Sanfranciscomunicipalrailway](../../simpleicons/S/Sanfranciscomunicipalrailway.Local.png) |
