...
```text
simpleicons/T/Thespritersresource
```

```text
include('simpleicons/T/Thespritersresource')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/T/Thespritersresource.png) | ![illustration for Thespritersresource](../../simpleicons/T/Thespritersresource.Local.png) |
