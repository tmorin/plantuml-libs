...
```text
simpleicons/M/Metrodelaciudaddemexico
```

```text
include('simpleicons/M/Metrodelaciudaddemexico')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/M/Metrodelaciudaddemexico.png) | ![illustration for Metrodelaciudaddemexico](../../simpleicons/M/Metrodelaciudaddemexico.Local.png) |
