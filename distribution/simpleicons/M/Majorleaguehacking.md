...
```text
simpleicons/M/Majorleaguehacking
```

```text
include('simpleicons/M/Majorleaguehacking')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/M/Majorleaguehacking.png) | ![illustration for Majorleaguehacking](../../simpleicons/M/Majorleaguehacking.Local.png) |
