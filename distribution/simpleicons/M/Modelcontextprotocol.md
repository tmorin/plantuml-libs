...
```text
simpleicons/M/Modelcontextprotocol
```

```text
include('simpleicons/M/Modelcontextprotocol')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/M/Modelcontextprotocol.png) | ![illustration for Modelcontextprotocol](../../simpleicons/M/Modelcontextprotocol.Local.png) |
