...
```text
simpleicons/W/Wolframmathematica
```

```text
include('simpleicons/W/Wolframmathematica')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/W/Wolframmathematica.png) | ![illustration for Wolframmathematica](../../simpleicons/W/Wolframmathematica.Local.png) |
