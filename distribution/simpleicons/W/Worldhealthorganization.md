...
```text
simpleicons/W/Worldhealthorganization
```

```text
include('simpleicons/W/Worldhealthorganization')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/W/Worldhealthorganization.png) | ![illustration for Worldhealthorganization](../../simpleicons/W/Worldhealthorganization.Local.png) |
