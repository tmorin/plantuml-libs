...
```text
simpleicons/R/Remedyentertainment
```

```text
include('simpleicons/R/Remedyentertainment')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/R/Remedyentertainment.png) | ![illustration for Remedyentertainment](../../simpleicons/R/Remedyentertainment.Local.png) |
