...
```text
simpleicons/R/Relianceindustrieslimited
```

```text
include('simpleicons/R/Relianceindustrieslimited')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/R/Relianceindustrieslimited.png) | ![illustration for Relianceindustrieslimited](../../simpleicons/R/Relianceindustrieslimited.Local.png) |
