...
```text
simpleicons/R/Rotaryinternational
```

```text
include('simpleicons/R/Rotaryinternational')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/R/Rotaryinternational.png) | ![illustration for Rotaryinternational](../../simpleicons/R/Rotaryinternational.Local.png) |
