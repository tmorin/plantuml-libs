...
```text
simpleicons/R/Resurrectionremixos
```

```text
include('simpleicons/R/Resurrectionremixos')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../simpleicons/R/Resurrectionremixos.png) | ![illustration for Resurrectionremixos](../../simpleicons/R/Resurrectionremixos.Local.png) |
