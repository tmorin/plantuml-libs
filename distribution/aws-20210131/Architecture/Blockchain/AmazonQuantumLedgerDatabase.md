...
```text
aws-20210131/Architecture/Blockchain/AmazonQuantumLedgerDatabase
```

```text
include('aws-20210131/Architecture/Blockchain/AmazonQuantumLedgerDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210131/Architecture/Blockchain/AmazonQuantumLedgerDatabase.png) | ![illustration for AmazonQuantumLedgerDatabase](../../../aws-20210131/Architecture/Blockchain/AmazonQuantumLedgerDatabase.Local.png) | ![illustration for AmazonQuantumLedgerDatabaseCard](../../../aws-20210131/Architecture/Blockchain/AmazonQuantumLedgerDatabaseCard.Local.png) | ![illustration for AmazonQuantumLedgerDatabaseGroup](../../../aws-20210131/Architecture/Blockchain/AmazonQuantumLedgerDatabaseGroup.Local.png) |
