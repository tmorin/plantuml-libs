...
```text
aws-20210131/Architecture/Database/AmazonNeptune
```

```text
include('aws-20210131/Architecture/Database/AmazonNeptune')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210131/Architecture/Database/AmazonNeptune.png) | ![illustration for AmazonNeptune](../../../aws-20210131/Architecture/Database/AmazonNeptune.Local.png) | ![illustration for AmazonNeptuneCard](../../../aws-20210131/Architecture/Database/AmazonNeptuneCard.Local.png) | ![illustration for AmazonNeptuneGroup](../../../aws-20210131/Architecture/Database/AmazonNeptuneGroup.Local.png) |
