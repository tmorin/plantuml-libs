...
```text
aws-20210131/Category/Serverless
```

```text
include('aws-20210131/Category/Serverless')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-20210131/Category/Serverless.png) | ![illustration for Serverless](../../aws-20210131/Category/Serverless.Local.png) | ![illustration for ServerlessCard](../../aws-20210131/Category/ServerlessCard.Local.png) | ![illustration for ServerlessGroup](../../aws-20210131/Category/ServerlessGroup.Local.png) |
