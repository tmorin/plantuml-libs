...
```text
aws-20210131/Category/Compute
```

```text
include('aws-20210131/Category/Compute')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-20210131/Category/Compute.png) | ![illustration for Compute](../../aws-20210131/Category/Compute.Local.png) | ![illustration for ComputeCard](../../aws-20210131/Category/ComputeCard.Local.png) | ![illustration for ComputeGroup](../../aws-20210131/Category/ComputeGroup.Local.png) |
