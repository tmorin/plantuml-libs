...
```text
azure/Item/Other/ServiceDefenderHistorian
```

```text
include('azure/Item/Other/ServiceDefenderHistorian')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDefenderHistorian.png) | ![illustration for ServiceDefenderHistorian](../../../azure/Item/Other/ServiceDefenderHistorian.Local.png) | ![illustration for ServiceDefenderHistorianCard](../../../azure/Item/Other/ServiceDefenderHistorianCard.Local.png) | ![illustration for ServiceDefenderHistorianGroup](../../../azure/Item/Other/ServiceDefenderHistorianGroup.Local.png) |
