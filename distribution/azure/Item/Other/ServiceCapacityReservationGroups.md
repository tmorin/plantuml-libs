...
```text
azure/Item/Other/ServiceCapacityReservationGroups
```

```text
include('azure/Item/Other/ServiceCapacityReservationGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceCapacityReservationGroups.png) | ![illustration for ServiceCapacityReservationGroups](../../../azure/Item/Other/ServiceCapacityReservationGroups.Local.png) | ![illustration for ServiceCapacityReservationGroupsCard](../../../azure/Item/Other/ServiceCapacityReservationGroupsCard.Local.png) | ![illustration for ServiceCapacityReservationGroupsGroup](../../../azure/Item/Other/ServiceCapacityReservationGroupsGroup.Local.png) |
