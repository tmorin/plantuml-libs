...
```text
azure/Item/Other/ServiceDefenderCmLocalManager
```

```text
include('azure/Item/Other/ServiceDefenderCmLocalManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDefenderCmLocalManager.png) | ![illustration for ServiceDefenderCmLocalManager](../../../azure/Item/Other/ServiceDefenderCmLocalManager.Local.png) | ![illustration for ServiceDefenderCmLocalManagerCard](../../../azure/Item/Other/ServiceDefenderCmLocalManagerCard.Local.png) | ![illustration for ServiceDefenderCmLocalManagerGroup](../../../azure/Item/Other/ServiceDefenderCmLocalManagerGroup.Local.png) |
