...
```text
azure/Item/Other/ServiceAzureAttestation
```

```text
include('azure/Item/Other/ServiceAzureAttestation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAzureAttestation.png) | ![illustration for ServiceAzureAttestation](../../../azure/Item/Other/ServiceAzureAttestation.Local.png) | ![illustration for ServiceAzureAttestationCard](../../../azure/Item/Other/ServiceAzureAttestationCard.Local.png) | ![illustration for ServiceAzureAttestationGroup](../../../azure/Item/Other/ServiceAzureAttestationGroup.Local.png) |
