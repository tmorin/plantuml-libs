...
```text
azure/Item/Other/ServiceNetworkSecurityPerimeters
```

```text
include('azure/Item/Other/ServiceNetworkSecurityPerimeters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceNetworkSecurityPerimeters.png) | ![illustration for ServiceNetworkSecurityPerimeters](../../../azure/Item/Other/ServiceNetworkSecurityPerimeters.Local.png) | ![illustration for ServiceNetworkSecurityPerimetersCard](../../../azure/Item/Other/ServiceNetworkSecurityPerimetersCard.Local.png) | ![illustration for ServiceNetworkSecurityPerimetersGroup](../../../azure/Item/Other/ServiceNetworkSecurityPerimetersGroup.Local.png) |
