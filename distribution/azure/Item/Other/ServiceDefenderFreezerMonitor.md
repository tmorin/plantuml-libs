...
```text
azure/Item/Other/ServiceDefenderFreezerMonitor
```

```text
include('azure/Item/Other/ServiceDefenderFreezerMonitor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDefenderFreezerMonitor.png) | ![illustration for ServiceDefenderFreezerMonitor](../../../azure/Item/Other/ServiceDefenderFreezerMonitor.Local.png) | ![illustration for ServiceDefenderFreezerMonitorCard](../../../azure/Item/Other/ServiceDefenderFreezerMonitorCard.Local.png) | ![illustration for ServiceDefenderFreezerMonitorGroup](../../../azure/Item/Other/ServiceDefenderFreezerMonitorGroup.Local.png) |
