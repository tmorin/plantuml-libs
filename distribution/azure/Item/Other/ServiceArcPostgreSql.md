...
```text
azure/Item/Other/ServiceArcPostgreSql
```

```text
include('azure/Item/Other/ServiceArcPostgreSql')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceArcPostgreSql.png) | ![illustration for ServiceArcPostgreSql](../../../azure/Item/Other/ServiceArcPostgreSql.Local.png) | ![illustration for ServiceArcPostgreSqlCard](../../../azure/Item/Other/ServiceArcPostgreSqlCard.Local.png) | ![illustration for ServiceArcPostgreSqlGroup](../../../azure/Item/Other/ServiceArcPostgreSqlGroup.Local.png) |
