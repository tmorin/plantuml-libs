...
```text
azure/Item/Other/ServiceInstancePools
```

```text
include('azure/Item/Other/ServiceInstancePools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceInstancePools.png) | ![illustration for ServiceInstancePools](../../../azure/Item/Other/ServiceInstancePools.Local.png) | ![illustration for ServiceInstancePoolsCard](../../../azure/Item/Other/ServiceInstancePoolsCard.Local.png) | ![illustration for ServiceInstancePoolsGroup](../../../azure/Item/Other/ServiceInstancePoolsGroup.Local.png) |
