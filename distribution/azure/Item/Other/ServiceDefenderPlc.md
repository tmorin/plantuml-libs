...
```text
azure/Item/Other/ServiceDefenderPlc
```

```text
include('azure/Item/Other/ServiceDefenderPlc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDefenderPlc.png) | ![illustration for ServiceDefenderPlc](../../../azure/Item/Other/ServiceDefenderPlc.Local.png) | ![illustration for ServiceDefenderPlcCard](../../../azure/Item/Other/ServiceDefenderPlcCard.Local.png) | ![illustration for ServiceDefenderPlcGroup](../../../azure/Item/Other/ServiceDefenderPlcGroup.Local.png) |
