...
```text
azure/Item/Other/ServiceDefenderSensor
```

```text
include('azure/Item/Other/ServiceDefenderSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDefenderSensor.png) | ![illustration for ServiceDefenderSensor](../../../azure/Item/Other/ServiceDefenderSensor.Local.png) | ![illustration for ServiceDefenderSensorCard](../../../azure/Item/Other/ServiceDefenderSensorCard.Local.png) | ![illustration for ServiceDefenderSensorGroup](../../../azure/Item/Other/ServiceDefenderSensorGroup.Local.png) |
