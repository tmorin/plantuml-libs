...
```text
azure/Item/Other/ServiceDefenderSlot
```

```text
include('azure/Item/Other/ServiceDefenderSlot')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDefenderSlot.png) | ![illustration for ServiceDefenderSlot](../../../azure/Item/Other/ServiceDefenderSlot.Local.png) | ![illustration for ServiceDefenderSlotCard](../../../azure/Item/Other/ServiceDefenderSlotCard.Local.png) | ![illustration for ServiceDefenderSlotGroup](../../../azure/Item/Other/ServiceDefenderSlotGroup.Local.png) |
