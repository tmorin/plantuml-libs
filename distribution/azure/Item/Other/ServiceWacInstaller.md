...
```text
azure/Item/Other/ServiceWacInstaller
```

```text
include('azure/Item/Other/ServiceWacInstaller')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceWacInstaller.png) | ![illustration for ServiceWacInstaller](../../../azure/Item/Other/ServiceWacInstaller.Local.png) | ![illustration for ServiceWacInstallerCard](../../../azure/Item/Other/ServiceWacInstallerCard.Local.png) | ![illustration for ServiceWacInstallerGroup](../../../azure/Item/Other/ServiceWacInstallerGroup.Local.png) |
