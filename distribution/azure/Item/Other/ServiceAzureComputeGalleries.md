...
```text
azure/Item/Other/ServiceAzureComputeGalleries
```

```text
include('azure/Item/Other/ServiceAzureComputeGalleries')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAzureComputeGalleries.png) | ![illustration for ServiceAzureComputeGalleries](../../../azure/Item/Other/ServiceAzureComputeGalleries.Local.png) | ![illustration for ServiceAzureComputeGalleriesCard](../../../azure/Item/Other/ServiceAzureComputeGalleriesCard.Local.png) | ![illustration for ServiceAzureComputeGalleriesGroup](../../../azure/Item/Other/ServiceAzureComputeGalleriesGroup.Local.png) |
