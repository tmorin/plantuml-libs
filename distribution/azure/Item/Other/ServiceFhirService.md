...
```text
azure/Item/Other/ServiceFhirService
```

```text
include('azure/Item/Other/ServiceFhirService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceFhirService.png) | ![illustration for ServiceFhirService](../../../azure/Item/Other/ServiceFhirService.Local.png) | ![illustration for ServiceFhirServiceCard](../../../azure/Item/Other/ServiceFhirServiceCard.Local.png) | ![illustration for ServiceFhirServiceGroup](../../../azure/Item/Other/ServiceFhirServiceGroup.Local.png) |
