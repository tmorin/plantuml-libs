...
```text
azure/Item/Other/ServiceDefenderMarquee
```

```text
include('azure/Item/Other/ServiceDefenderMarquee')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDefenderMarquee.png) | ![illustration for ServiceDefenderMarquee](../../../azure/Item/Other/ServiceDefenderMarquee.Local.png) | ![illustration for ServiceDefenderMarqueeCard](../../../azure/Item/Other/ServiceDefenderMarqueeCard.Local.png) | ![illustration for ServiceDefenderMarqueeGroup](../../../azure/Item/Other/ServiceDefenderMarqueeGroup.Local.png) |
