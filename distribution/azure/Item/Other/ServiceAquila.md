...
```text
azure/Item/Other/ServiceAquila
```

```text
include('azure/Item/Other/ServiceAquila')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAquila.png) | ![illustration for ServiceAquila](../../../azure/Item/Other/ServiceAquila.Local.png) | ![illustration for ServiceAquilaCard](../../../azure/Item/Other/ServiceAquilaCard.Local.png) | ![illustration for ServiceAquilaGroup](../../../azure/Item/Other/ServiceAquilaGroup.Local.png) |
