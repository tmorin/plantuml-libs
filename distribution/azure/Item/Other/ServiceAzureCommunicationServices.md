...
```text
azure/Item/Other/ServiceAzureCommunicationServices
```

```text
include('azure/Item/Other/ServiceAzureCommunicationServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAzureCommunicationServices.png) | ![illustration for ServiceAzureCommunicationServices](../../../azure/Item/Other/ServiceAzureCommunicationServices.Local.png) | ![illustration for ServiceAzureCommunicationServicesCard](../../../azure/Item/Other/ServiceAzureCommunicationServicesCard.Local.png) | ![illustration for ServiceAzureCommunicationServicesGroup](../../../azure/Item/Other/ServiceAzureCommunicationServicesGroup.Local.png) |
