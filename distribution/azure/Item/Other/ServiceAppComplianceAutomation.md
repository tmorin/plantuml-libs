...
```text
azure/Item/Other/ServiceAppComplianceAutomation
```

```text
include('azure/Item/Other/ServiceAppComplianceAutomation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAppComplianceAutomation.png) | ![illustration for ServiceAppComplianceAutomation](../../../azure/Item/Other/ServiceAppComplianceAutomation.Local.png) | ![illustration for ServiceAppComplianceAutomationCard](../../../azure/Item/Other/ServiceAppComplianceAutomationCard.Local.png) | ![illustration for ServiceAppComplianceAutomationGroup](../../../azure/Item/Other/ServiceAppComplianceAutomationGroup.Local.png) |
