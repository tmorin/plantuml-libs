...
```text
azure/Item/Other/ServiceExchangeOnPremisesAccess
```

```text
include('azure/Item/Other/ServiceExchangeOnPremisesAccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceExchangeOnPremisesAccess.png) | ![illustration for ServiceExchangeOnPremisesAccess](../../../azure/Item/Other/ServiceExchangeOnPremisesAccess.Local.png) | ![illustration for ServiceExchangeOnPremisesAccessCard](../../../azure/Item/Other/ServiceExchangeOnPremisesAccessCard.Local.png) | ![illustration for ServiceExchangeOnPremisesAccessGroup](../../../azure/Item/Other/ServiceExchangeOnPremisesAccessGroup.Local.png) |
