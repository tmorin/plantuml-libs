...
```text
azure/Item/Other/ServiceAzureOrbital
```

```text
include('azure/Item/Other/ServiceAzureOrbital')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAzureOrbital.png) | ![illustration for ServiceAzureOrbital](../../../azure/Item/Other/ServiceAzureOrbital.Local.png) | ![illustration for ServiceAzureOrbitalCard](../../../azure/Item/Other/ServiceAzureOrbitalCard.Local.png) | ![illustration for ServiceAzureOrbitalGroup](../../../azure/Item/Other/ServiceAzureOrbitalGroup.Local.png) |
