...
```text
azure/Item/Other/ServiceAzureBackupCenter
```

```text
include('azure/Item/Other/ServiceAzureBackupCenter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAzureBackupCenter.png) | ![illustration for ServiceAzureBackupCenter](../../../azure/Item/Other/ServiceAzureBackupCenter.Local.png) | ![illustration for ServiceAzureBackupCenterCard](../../../azure/Item/Other/ServiceAzureBackupCenterCard.Local.png) | ![illustration for ServiceAzureBackupCenterGroup](../../../azure/Item/Other/ServiceAzureBackupCenterGroup.Local.png) |
