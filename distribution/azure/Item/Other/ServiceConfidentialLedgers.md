...
```text
azure/Item/Other/ServiceConfidentialLedgers
```

```text
include('azure/Item/Other/ServiceConfidentialLedgers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceConfidentialLedgers.png) | ![illustration for ServiceConfidentialLedgers](../../../azure/Item/Other/ServiceConfidentialLedgers.Local.png) | ![illustration for ServiceConfidentialLedgersCard](../../../azure/Item/Other/ServiceConfidentialLedgersCard.Local.png) | ![illustration for ServiceConfidentialLedgersGroup](../../../azure/Item/Other/ServiceConfidentialLedgersGroup.Local.png) |
