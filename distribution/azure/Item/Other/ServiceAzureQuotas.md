...
```text
azure/Item/Other/ServiceAzureQuotas
```

```text
include('azure/Item/Other/ServiceAzureQuotas')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAzureQuotas.png) | ![illustration for ServiceAzureQuotas](../../../azure/Item/Other/ServiceAzureQuotas.Local.png) | ![illustration for ServiceAzureQuotasCard](../../../azure/Item/Other/ServiceAzureQuotasCard.Local.png) | ![illustration for ServiceAzureQuotasGroup](../../../azure/Item/Other/ServiceAzureQuotasGroup.Local.png) |
