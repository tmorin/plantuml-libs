...
```text
azure/Item/Other/ServiceVideoAnalyzers
```

```text
include('azure/Item/Other/ServiceVideoAnalyzers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceVideoAnalyzers.png) | ![illustration for ServiceVideoAnalyzers](../../../azure/Item/Other/ServiceVideoAnalyzers.Local.png) | ![illustration for ServiceVideoAnalyzersCard](../../../azure/Item/Other/ServiceVideoAnalyzersCard.Local.png) | ![illustration for ServiceVideoAnalyzersGroup](../../../azure/Item/Other/ServiceVideoAnalyzersGroup.Local.png) |
