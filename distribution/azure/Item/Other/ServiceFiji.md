...
```text
azure/Item/Other/ServiceFiji
```

```text
include('azure/Item/Other/ServiceFiji')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceFiji.png) | ![illustration for ServiceFiji](../../../azure/Item/Other/ServiceFiji.Local.png) | ![illustration for ServiceFijiCard](../../../azure/Item/Other/ServiceFijiCard.Local.png) | ![illustration for ServiceFijiGroup](../../../azure/Item/Other/ServiceFijiGroup.Local.png) |
