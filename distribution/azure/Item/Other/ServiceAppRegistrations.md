...
```text
azure/Item/Other/ServiceAppRegistrations
```

```text
include('azure/Item/Other/ServiceAppRegistrations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAppRegistrations.png) | ![illustration for ServiceAppRegistrations](../../../azure/Item/Other/ServiceAppRegistrations.Local.png) | ![illustration for ServiceAppRegistrationsCard](../../../azure/Item/Other/ServiceAppRegistrationsCard.Local.png) | ![illustration for ServiceAppRegistrationsGroup](../../../azure/Item/Other/ServiceAppRegistrationsGroup.Local.png) |
