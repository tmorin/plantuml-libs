...
```text
azure/Item/Other/ServiceEntraIdentityLicenses
```

```text
include('azure/Item/Other/ServiceEntraIdentityLicenses')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceEntraIdentityLicenses.png) | ![illustration for ServiceEntraIdentityLicenses](../../../azure/Item/Other/ServiceEntraIdentityLicenses.Local.png) | ![illustration for ServiceEntraIdentityLicensesCard](../../../azure/Item/Other/ServiceEntraIdentityLicensesCard.Local.png) | ![illustration for ServiceEntraIdentityLicensesGroup](../../../azure/Item/Other/ServiceEntraIdentityLicensesGroup.Local.png) |
