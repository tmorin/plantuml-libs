...
```text
azure/Item/Other/ServiceDiskPool
```

```text
include('azure/Item/Other/ServiceDiskPool')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDiskPool.png) | ![illustration for ServiceDiskPool](../../../azure/Item/Other/ServiceDiskPool.Local.png) | ![illustration for ServiceDiskPoolCard](../../../azure/Item/Other/ServiceDiskPoolCard.Local.png) | ![illustration for ServiceDiskPoolGroup](../../../azure/Item/Other/ServiceDiskPoolGroup.Local.png) |
