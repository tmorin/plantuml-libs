...
```text
azure/Item/Other/ServiceStorageFunctions
```

```text
include('azure/Item/Other/ServiceStorageFunctions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceStorageFunctions.png) | ![illustration for ServiceStorageFunctions](../../../azure/Item/Other/ServiceStorageFunctions.Local.png) | ![illustration for ServiceStorageFunctionsCard](../../../azure/Item/Other/ServiceStorageFunctionsCard.Local.png) | ![illustration for ServiceStorageFunctionsGroup](../../../azure/Item/Other/ServiceStorageFunctionsGroup.Local.png) |
