...
```text
azure/Item/Other/ServiceModularDataCenter
```

```text
include('azure/Item/Other/ServiceModularDataCenter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceModularDataCenter.png) | ![illustration for ServiceModularDataCenter](../../../azure/Item/Other/ServiceModularDataCenter.Local.png) | ![illustration for ServiceModularDataCenterCard](../../../azure/Item/Other/ServiceModularDataCenterCard.Local.png) | ![illustration for ServiceModularDataCenterGroup](../../../azure/Item/Other/ServiceModularDataCenterGroup.Local.png) |
