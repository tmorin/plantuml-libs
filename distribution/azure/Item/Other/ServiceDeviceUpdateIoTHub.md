...
```text
azure/Item/Other/ServiceDeviceUpdateIoTHub
```

```text
include('azure/Item/Other/ServiceDeviceUpdateIoTHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDeviceUpdateIoTHub.png) | ![illustration for ServiceDeviceUpdateIoTHub](../../../azure/Item/Other/ServiceDeviceUpdateIoTHub.Local.png) | ![illustration for ServiceDeviceUpdateIoTHubCard](../../../azure/Item/Other/ServiceDeviceUpdateIoTHubCard.Local.png) | ![illustration for ServiceDeviceUpdateIoTHubGroup](../../../azure/Item/Other/ServiceDeviceUpdateIoTHubGroup.Local.png) |
