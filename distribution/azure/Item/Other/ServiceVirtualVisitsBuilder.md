...
```text
azure/Item/Other/ServiceVirtualVisitsBuilder
```

```text
include('azure/Item/Other/ServiceVirtualVisitsBuilder')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceVirtualVisitsBuilder.png) | ![illustration for ServiceVirtualVisitsBuilder](../../../azure/Item/Other/ServiceVirtualVisitsBuilder.Local.png) | ![illustration for ServiceVirtualVisitsBuilderCard](../../../azure/Item/Other/ServiceVirtualVisitsBuilderCard.Local.png) | ![illustration for ServiceVirtualVisitsBuilderGroup](../../../azure/Item/Other/ServiceVirtualVisitsBuilderGroup.Local.png) |
