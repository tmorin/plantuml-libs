...
```text
azure/Item/Other/ServiceExpressRouteTrafficCollector
```

```text
include('azure/Item/Other/ServiceExpressRouteTrafficCollector')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceExpressRouteTrafficCollector.png) | ![illustration for ServiceExpressRouteTrafficCollector](../../../azure/Item/Other/ServiceExpressRouteTrafficCollector.Local.png) | ![illustration for ServiceExpressRouteTrafficCollectorCard](../../../azure/Item/Other/ServiceExpressRouteTrafficCollectorCard.Local.png) | ![illustration for ServiceExpressRouteTrafficCollectorGroup](../../../azure/Item/Other/ServiceExpressRouteTrafficCollectorGroup.Local.png) |
