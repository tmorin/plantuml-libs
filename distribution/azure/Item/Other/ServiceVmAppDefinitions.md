...
```text
azure/Item/Other/ServiceVmAppDefinitions
```

```text
include('azure/Item/Other/ServiceVmAppDefinitions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceVmAppDefinitions.png) | ![illustration for ServiceVmAppDefinitions](../../../azure/Item/Other/ServiceVmAppDefinitions.Local.png) | ![illustration for ServiceVmAppDefinitionsCard](../../../azure/Item/Other/ServiceVmAppDefinitionsCard.Local.png) | ![illustration for ServiceVmAppDefinitionsGroup](../../../azure/Item/Other/ServiceVmAppDefinitionsGroup.Local.png) |
