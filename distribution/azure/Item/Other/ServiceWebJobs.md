...
```text
azure/Item/Other/ServiceWebJobs
```

```text
include('azure/Item/Other/ServiceWebJobs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceWebJobs.png) | ![illustration for ServiceWebJobs](../../../azure/Item/Other/ServiceWebJobs.Local.png) | ![illustration for ServiceWebJobsCard](../../../azure/Item/Other/ServiceWebJobsCard.Local.png) | ![illustration for ServiceWebJobsGroup](../../../azure/Item/Other/ServiceWebJobsGroup.Local.png) |
