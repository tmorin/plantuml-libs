...
```text
azure/Item/Other/ServiceVmAppVersions
```

```text
include('azure/Item/Other/ServiceVmAppVersions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceVmAppVersions.png) | ![illustration for ServiceVmAppVersions](../../../azure/Item/Other/ServiceVmAppVersions.Local.png) | ![illustration for ServiceVmAppVersionsCard](../../../azure/Item/Other/ServiceVmAppVersionsCard.Local.png) | ![illustration for ServiceVmAppVersionsGroup](../../../azure/Item/Other/ServiceVmAppVersionsGroup.Local.png) |
