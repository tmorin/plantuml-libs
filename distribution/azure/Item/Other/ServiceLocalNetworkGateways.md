...
```text
azure/Item/Other/ServiceLocalNetworkGateways
```

```text
include('azure/Item/Other/ServiceLocalNetworkGateways')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceLocalNetworkGateways.png) | ![illustration for ServiceLocalNetworkGateways](../../../azure/Item/Other/ServiceLocalNetworkGateways.Local.png) | ![illustration for ServiceLocalNetworkGatewaysCard](../../../azure/Item/Other/ServiceLocalNetworkGatewaysCard.Local.png) | ![illustration for ServiceLocalNetworkGatewaysGroup](../../../azure/Item/Other/ServiceLocalNetworkGatewaysGroup.Local.png) |
