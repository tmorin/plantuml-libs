...
```text
azure/Item/Other/ServiceDefenderRtu
```

```text
include('azure/Item/Other/ServiceDefenderRtu')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDefenderRtu.png) | ![illustration for ServiceDefenderRtu](../../../azure/Item/Other/ServiceDefenderRtu.Local.png) | ![illustration for ServiceDefenderRtuCard](../../../azure/Item/Other/ServiceDefenderRtuCard.Local.png) | ![illustration for ServiceDefenderRtuGroup](../../../azure/Item/Other/ServiceDefenderRtuGroup.Local.png) |
