...
```text
azure/Item/Other/ServiceAzureCloudShell
```

```text
include('azure/Item/Other/ServiceAzureCloudShell')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAzureCloudShell.png) | ![illustration for ServiceAzureCloudShell](../../../azure/Item/Other/ServiceAzureCloudShell.Local.png) | ![illustration for ServiceAzureCloudShellCard](../../../azure/Item/Other/ServiceAzureCloudShellCard.Local.png) | ![illustration for ServiceAzureCloudShellGroup](../../../azure/Item/Other/ServiceAzureCloudShellGroup.Local.png) |
