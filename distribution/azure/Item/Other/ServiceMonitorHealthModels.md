...
```text
azure/Item/Other/ServiceMonitorHealthModels
```

```text
include('azure/Item/Other/ServiceMonitorHealthModels')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceMonitorHealthModels.png) | ![illustration for ServiceMonitorHealthModels](../../../azure/Item/Other/ServiceMonitorHealthModels.Local.png) | ![illustration for ServiceMonitorHealthModelsCard](../../../azure/Item/Other/ServiceMonitorHealthModelsCard.Local.png) | ![illustration for ServiceMonitorHealthModelsGroup](../../../azure/Item/Other/ServiceMonitorHealthModelsGroup.Local.png) |
