...
```text
azure/Item/Other/ServiceVirtualEnclaves
```

```text
include('azure/Item/Other/ServiceVirtualEnclaves')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceVirtualEnclaves.png) | ![illustration for ServiceVirtualEnclaves](../../../azure/Item/Other/ServiceVirtualEnclaves.Local.png) | ![illustration for ServiceVirtualEnclavesCard](../../../azure/Item/Other/ServiceVirtualEnclavesCard.Local.png) | ![illustration for ServiceVirtualEnclavesGroup](../../../azure/Item/Other/ServiceVirtualEnclavesGroup.Local.png) |
