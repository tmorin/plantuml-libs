...
```text
azure/Item/Other/ServiceExpressRouteDirect
```

```text
include('azure/Item/Other/ServiceExpressRouteDirect')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceExpressRouteDirect.png) | ![illustration for ServiceExpressRouteDirect](../../../azure/Item/Other/ServiceExpressRouteDirect.Local.png) | ![illustration for ServiceExpressRouteDirectCard](../../../azure/Item/Other/ServiceExpressRouteDirectCard.Local.png) | ![illustration for ServiceExpressRouteDirectGroup](../../../azure/Item/Other/ServiceExpressRouteDirectGroup.Local.png) |
