...
```text
azure/Item/Other/ServiceResourceGuard
```

```text
include('azure/Item/Other/ServiceResourceGuard')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceResourceGuard.png) | ![illustration for ServiceResourceGuard](../../../azure/Item/Other/ServiceResourceGuard.Local.png) | ![illustration for ServiceResourceGuardCard](../../../azure/Item/Other/ServiceResourceGuardCard.Local.png) | ![illustration for ServiceResourceGuardGroup](../../../azure/Item/Other/ServiceResourceGuardGroup.Local.png) |
