...
```text
azure/Item/Other/ServiceDefenderIndustrialRobot
```

```text
include('azure/Item/Other/ServiceDefenderIndustrialRobot')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDefenderIndustrialRobot.png) | ![illustration for ServiceDefenderIndustrialRobot](../../../azure/Item/Other/ServiceDefenderIndustrialRobot.Local.png) | ![illustration for ServiceDefenderIndustrialRobotCard](../../../azure/Item/Other/ServiceDefenderIndustrialRobotCard.Local.png) | ![illustration for ServiceDefenderIndustrialRobotGroup](../../../azure/Item/Other/ServiceDefenderIndustrialRobotGroup.Local.png) |
