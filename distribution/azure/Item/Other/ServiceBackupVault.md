...
```text
azure/Item/Other/ServiceBackupVault
```

```text
include('azure/Item/Other/ServiceBackupVault')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceBackupVault.png) | ![illustration for ServiceBackupVault](../../../azure/Item/Other/ServiceBackupVault.Local.png) | ![illustration for ServiceBackupVaultCard](../../../azure/Item/Other/ServiceBackupVaultCard.Local.png) | ![illustration for ServiceBackupVaultGroup](../../../azure/Item/Other/ServiceBackupVaultGroup.Local.png) |
