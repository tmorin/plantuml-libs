...
```text
azure/Item/Other/ServiceAzureStorageMover
```

```text
include('azure/Item/Other/ServiceAzureStorageMover')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAzureStorageMover.png) | ![illustration for ServiceAzureStorageMover](../../../azure/Item/Other/ServiceAzureStorageMover.Local.png) | ![illustration for ServiceAzureStorageMoverCard](../../../azure/Item/Other/ServiceAzureStorageMoverCard.Local.png) | ![illustration for ServiceAzureStorageMoverGroup](../../../azure/Item/Other/ServiceAzureStorageMoverGroup.Local.png) |
