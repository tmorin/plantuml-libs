...
```text
azure/Item/Other/ServiceMicrosoftDevBox
```

```text
include('azure/Item/Other/ServiceMicrosoftDevBox')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceMicrosoftDevBox.png) | ![illustration for ServiceMicrosoftDevBox](../../../azure/Item/Other/ServiceMicrosoftDevBox.Local.png) | ![illustration for ServiceMicrosoftDevBoxCard](../../../azure/Item/Other/ServiceMicrosoftDevBoxCard.Local.png) | ![illustration for ServiceMicrosoftDevBoxGroup](../../../azure/Item/Other/ServiceMicrosoftDevBoxGroup.Local.png) |
