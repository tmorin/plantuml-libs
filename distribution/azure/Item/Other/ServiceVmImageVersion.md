...
```text
azure/Item/Other/ServiceVmImageVersion
```

```text
include('azure/Item/Other/ServiceVmImageVersion')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceVmImageVersion.png) | ![illustration for ServiceVmImageVersion](../../../azure/Item/Other/ServiceVmImageVersion.Local.png) | ![illustration for ServiceVmImageVersionCard](../../../azure/Item/Other/ServiceVmImageVersionCard.Local.png) | ![illustration for ServiceVmImageVersionGroup](../../../azure/Item/Other/ServiceVmImageVersionGroup.Local.png) |
