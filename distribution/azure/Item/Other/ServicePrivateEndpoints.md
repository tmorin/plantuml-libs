...
```text
azure/Item/Other/ServicePrivateEndpoints
```

```text
include('azure/Item/Other/ServicePrivateEndpoints')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServicePrivateEndpoints.png) | ![illustration for ServicePrivateEndpoints](../../../azure/Item/Other/ServicePrivateEndpoints.Local.png) | ![illustration for ServicePrivateEndpointsCard](../../../azure/Item/Other/ServicePrivateEndpointsCard.Local.png) | ![illustration for ServicePrivateEndpointsGroup](../../../azure/Item/Other/ServicePrivateEndpointsGroup.Local.png) |
