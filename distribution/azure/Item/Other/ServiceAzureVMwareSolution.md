...
```text
azure/Item/Other/ServiceAzureVMwareSolution
```

```text
include('azure/Item/Other/ServiceAzureVMwareSolution')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceAzureVMwareSolution.png) | ![illustration for ServiceAzureVMwareSolution](../../../azure/Item/Other/ServiceAzureVMwareSolution.Local.png) | ![illustration for ServiceAzureVMwareSolutionCard](../../../azure/Item/Other/ServiceAzureVMwareSolutionCard.Local.png) | ![illustration for ServiceAzureVMwareSolutionGroup](../../../azure/Item/Other/ServiceAzureVMwareSolutionGroup.Local.png) |
