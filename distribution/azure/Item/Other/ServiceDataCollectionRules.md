...
```text
azure/Item/Other/ServiceDataCollectionRules
```

```text
include('azure/Item/Other/ServiceDataCollectionRules')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceDataCollectionRules.png) | ![illustration for ServiceDataCollectionRules](../../../azure/Item/Other/ServiceDataCollectionRules.Local.png) | ![illustration for ServiceDataCollectionRulesCard](../../../azure/Item/Other/ServiceDataCollectionRulesCard.Local.png) | ![illustration for ServiceDataCollectionRulesGroup](../../../azure/Item/Other/ServiceDataCollectionRulesGroup.Local.png) |
