...
```text
azure/Item/Other/ServiceResourceMover
```

```text
include('azure/Item/Other/ServiceResourceMover')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceResourceMover.png) | ![illustration for ServiceResourceMover](../../../azure/Item/Other/ServiceResourceMover.Local.png) | ![illustration for ServiceResourceMoverCard](../../../azure/Item/Other/ServiceResourceMoverCard.Local.png) | ![illustration for ServiceResourceMoverGroup](../../../azure/Item/Other/ServiceResourceMoverGroup.Local.png) |
