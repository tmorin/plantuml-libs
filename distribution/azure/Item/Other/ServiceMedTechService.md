...
```text
azure/Item/Other/ServiceMedTechService
```

```text
include('azure/Item/Other/ServiceMedTechService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Other/ServiceMedTechService.png) | ![illustration for ServiceMedTechService](../../../azure/Item/Other/ServiceMedTechService.Local.png) | ![illustration for ServiceMedTechServiceCard](../../../azure/Item/Other/ServiceMedTechServiceCard.Local.png) | ![illustration for ServiceMedTechServiceGroup](../../../azure/Item/Other/ServiceMedTechServiceGroup.Local.png) |
