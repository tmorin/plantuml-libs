...
```text
azure/Item/Menu/ServiceKeys
```

```text
include('azure/Item/Menu/ServiceKeys')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Menu/ServiceKeys.png) | ![illustration for ServiceKeys](../../../azure/Item/Menu/ServiceKeys.Local.png) | ![illustration for ServiceKeysCard](../../../azure/Item/Menu/ServiceKeysCard.Local.png) | ![illustration for ServiceKeysGroup](../../../azure/Item/Menu/ServiceKeysGroup.Local.png) |
