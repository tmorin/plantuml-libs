...
```text
azure/Item/Devops/ServiceCodeOptimization
```

```text
include('azure/Item/Devops/ServiceCodeOptimization')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Devops/ServiceCodeOptimization.png) | ![illustration for ServiceCodeOptimization](../../../azure/Item/Devops/ServiceCodeOptimization.Local.png) | ![illustration for ServiceCodeOptimizationCard](../../../azure/Item/Devops/ServiceCodeOptimizationCard.Local.png) | ![illustration for ServiceCodeOptimizationGroup](../../../azure/Item/Devops/ServiceCodeOptimizationGroup.Local.png) |
