...
```text
azure/Item/Devops/ServiceDevOpsStarter
```

```text
include('azure/Item/Devops/ServiceDevOpsStarter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Devops/ServiceDevOpsStarter.png) | ![illustration for ServiceDevOpsStarter](../../../azure/Item/Devops/ServiceDevOpsStarter.Local.png) | ![illustration for ServiceDevOpsStarterCard](../../../azure/Item/Devops/ServiceDevOpsStarterCard.Local.png) | ![illustration for ServiceDevOpsStarterGroup](../../../azure/Item/Devops/ServiceDevOpsStarterGroup.Local.png) |
