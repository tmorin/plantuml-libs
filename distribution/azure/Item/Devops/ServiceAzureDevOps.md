...
```text
azure/Item/Devops/ServiceAzureDevOps
```

```text
include('azure/Item/Devops/ServiceAzureDevOps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Devops/ServiceAzureDevOps.png) | ![illustration for ServiceAzureDevOps](../../../azure/Item/Devops/ServiceAzureDevOps.Local.png) | ![illustration for ServiceAzureDevOpsCard](../../../azure/Item/Devops/ServiceAzureDevOpsCard.Local.png) | ![illustration for ServiceAzureDevOpsGroup](../../../azure/Item/Devops/ServiceAzureDevOpsGroup.Local.png) |
