...
```text
azure/Item/Devops/ServiceManagedDevOpsPools
```

```text
include('azure/Item/Devops/ServiceManagedDevOpsPools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Devops/ServiceManagedDevOpsPools.png) | ![illustration for ServiceManagedDevOpsPools](../../../azure/Item/Devops/ServiceManagedDevOpsPools.Local.png) | ![illustration for ServiceManagedDevOpsPoolsCard](../../../azure/Item/Devops/ServiceManagedDevOpsPoolsCard.Local.png) | ![illustration for ServiceManagedDevOpsPoolsGroup](../../../azure/Item/Devops/ServiceManagedDevOpsPoolsGroup.Local.png) |
