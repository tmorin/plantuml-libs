...
```text
azure/Item/Devops/ServiceApiManagementServices
```

```text
include('azure/Item/Devops/ServiceApiManagementServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Devops/ServiceApiManagementServices.png) | ![illustration for ServiceApiManagementServices](../../../azure/Item/Devops/ServiceApiManagementServices.Local.png) | ![illustration for ServiceApiManagementServicesCard](../../../azure/Item/Devops/ServiceApiManagementServicesCard.Local.png) | ![illustration for ServiceApiManagementServicesGroup](../../../azure/Item/Devops/ServiceApiManagementServicesGroup.Local.png) |
