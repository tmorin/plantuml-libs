...
```text
azure/Item/Devops/ServiceApplicationInsights
```

```text
include('azure/Item/Devops/ServiceApplicationInsights')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Devops/ServiceApplicationInsights.png) | ![illustration for ServiceApplicationInsights](../../../azure/Item/Devops/ServiceApplicationInsights.Local.png) | ![illustration for ServiceApplicationInsightsCard](../../../azure/Item/Devops/ServiceApplicationInsightsCard.Local.png) | ![illustration for ServiceApplicationInsightsGroup](../../../azure/Item/Devops/ServiceApplicationInsightsGroup.Local.png) |
