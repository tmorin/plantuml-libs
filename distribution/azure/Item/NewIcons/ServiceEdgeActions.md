...
```text
azure/Item/NewIcons/ServiceEdgeActions
```

```text
include('azure/Item/NewIcons/ServiceEdgeActions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/NewIcons/ServiceEdgeActions.png) | ![illustration for ServiceEdgeActions](../../../azure/Item/NewIcons/ServiceEdgeActions.Local.png) | ![illustration for ServiceEdgeActionsCard](../../../azure/Item/NewIcons/ServiceEdgeActionsCard.Local.png) | ![illustration for ServiceEdgeActionsGroup](../../../azure/Item/NewIcons/ServiceEdgeActionsGroup.Local.png) |
