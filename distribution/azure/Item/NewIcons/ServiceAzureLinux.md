...
```text
azure/Item/NewIcons/ServiceAzureLinux
```

```text
include('azure/Item/NewIcons/ServiceAzureLinux')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/NewIcons/ServiceAzureLinux.png) | ![illustration for ServiceAzureLinux](../../../azure/Item/NewIcons/ServiceAzureLinux.Local.png) | ![illustration for ServiceAzureLinuxCard](../../../azure/Item/NewIcons/ServiceAzureLinuxCard.Local.png) | ![illustration for ServiceAzureLinuxGroup](../../../azure/Item/NewIcons/ServiceAzureLinuxGroup.Local.png) |
