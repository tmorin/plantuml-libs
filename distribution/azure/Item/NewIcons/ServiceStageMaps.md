...
```text
azure/Item/NewIcons/ServiceStageMaps
```

```text
include('azure/Item/NewIcons/ServiceStageMaps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/NewIcons/ServiceStageMaps.png) | ![illustration for ServiceStageMaps](../../../azure/Item/NewIcons/ServiceStageMaps.Local.png) | ![illustration for ServiceStageMapsCard](../../../azure/Item/NewIcons/ServiceStageMapsCard.Local.png) | ![illustration for ServiceStageMapsGroup](../../../azure/Item/NewIcons/ServiceStageMapsGroup.Local.png) |
