...
```text
azure/Item/NewIcons/ServiceLoadBalancerHub
```

```text
include('azure/Item/NewIcons/ServiceLoadBalancerHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/NewIcons/ServiceLoadBalancerHub.png) | ![illustration for ServiceLoadBalancerHub](../../../azure/Item/NewIcons/ServiceLoadBalancerHub.Local.png) | ![illustration for ServiceLoadBalancerHubCard](../../../azure/Item/NewIcons/ServiceLoadBalancerHubCard.Local.png) | ![illustration for ServiceLoadBalancerHubGroup](../../../azure/Item/NewIcons/ServiceLoadBalancerHubGroup.Local.png) |
