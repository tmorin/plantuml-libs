...
```text
azure/Item/NewIcons/ServiceScheduledActions
```

```text
include('azure/Item/NewIcons/ServiceScheduledActions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/NewIcons/ServiceScheduledActions.png) | ![illustration for ServiceScheduledActions](../../../azure/Item/NewIcons/ServiceScheduledActions.Local.png) | ![illustration for ServiceScheduledActionsCard](../../../azure/Item/NewIcons/ServiceScheduledActionsCard.Local.png) | ![illustration for ServiceScheduledActionsGroup](../../../azure/Item/NewIcons/ServiceScheduledActionsGroup.Local.png) |
