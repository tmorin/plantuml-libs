...
```text
azure/Item/NewIcons/ServiceServiceGroups
```

```text
include('azure/Item/NewIcons/ServiceServiceGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/NewIcons/ServiceServiceGroups.png) | ![illustration for ServiceServiceGroups](../../../azure/Item/NewIcons/ServiceServiceGroups.Local.png) | ![illustration for ServiceServiceGroupsCard](../../../azure/Item/NewIcons/ServiceServiceGroupsCard.Local.png) | ![illustration for ServiceServiceGroupsGroup](../../../azure/Item/NewIcons/ServiceServiceGroupsGroup.Local.png) |
