...
```text
azure/Item/NewIcons/ServiceMonitorIssues
```

```text
include('azure/Item/NewIcons/ServiceMonitorIssues')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/NewIcons/ServiceMonitorIssues.png) | ![illustration for ServiceMonitorIssues](../../../azure/Item/NewIcons/ServiceMonitorIssues.Local.png) | ![illustration for ServiceMonitorIssuesCard](../../../azure/Item/NewIcons/ServiceMonitorIssuesCard.Local.png) | ![illustration for ServiceMonitorIssuesGroup](../../../azure/Item/NewIcons/ServiceMonitorIssuesGroup.Local.png) |
