...
```text
azure/Item/NewIcons/ServiceAzureAppTesting
```

```text
include('azure/Item/NewIcons/ServiceAzureAppTesting')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/NewIcons/ServiceAzureAppTesting.png) | ![illustration for ServiceAzureAppTesting](../../../azure/Item/NewIcons/ServiceAzureAppTesting.Local.png) | ![illustration for ServiceAzureAppTestingCard](../../../azure/Item/NewIcons/ServiceAzureAppTestingCard.Local.png) | ![illustration for ServiceAzureAppTestingGroup](../../../azure/Item/NewIcons/ServiceAzureAppTestingGroup.Local.png) |
