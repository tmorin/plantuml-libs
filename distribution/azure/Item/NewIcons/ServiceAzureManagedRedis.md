...
```text
azure/Item/NewIcons/ServiceAzureManagedRedis
```

```text
include('azure/Item/NewIcons/ServiceAzureManagedRedis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/NewIcons/ServiceAzureManagedRedis.png) | ![illustration for ServiceAzureManagedRedis](../../../azure/Item/NewIcons/ServiceAzureManagedRedis.Local.png) | ![illustration for ServiceAzureManagedRedisCard](../../../azure/Item/NewIcons/ServiceAzureManagedRedisCard.Local.png) | ![illustration for ServiceAzureManagedRedisGroup](../../../azure/Item/NewIcons/ServiceAzureManagedRedisGroup.Local.png) |
