...
```text
azure/Item/NewIcons/ServiceExternalId
```

```text
include('azure/Item/NewIcons/ServiceExternalId')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/NewIcons/ServiceExternalId.png) | ![illustration for ServiceExternalId](../../../azure/Item/NewIcons/ServiceExternalId.Local.png) | ![illustration for ServiceExternalIdCard](../../../azure/Item/NewIcons/ServiceExternalIdCard.Local.png) | ![illustration for ServiceExternalIdGroup](../../../azure/Item/NewIcons/ServiceExternalIdGroup.Local.png) |
