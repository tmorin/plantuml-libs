...
```text
azure/Item/NewIcons/ServiceKubernetesHub
```

```text
include('azure/Item/NewIcons/ServiceKubernetesHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/NewIcons/ServiceKubernetesHub.png) | ![illustration for ServiceKubernetesHub](../../../azure/Item/NewIcons/ServiceKubernetesHub.Local.png) | ![illustration for ServiceKubernetesHubCard](../../../azure/Item/NewIcons/ServiceKubernetesHubCard.Local.png) | ![illustration for ServiceKubernetesHubGroup](../../../azure/Item/NewIcons/ServiceKubernetesHubGroup.Local.png) |
