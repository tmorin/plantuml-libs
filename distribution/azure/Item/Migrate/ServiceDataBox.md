...
```text
azure/Item/Migrate/ServiceDataBox
```

```text
include('azure/Item/Migrate/ServiceDataBox')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Migrate/ServiceDataBox.png) | ![illustration for ServiceDataBox](../../../azure/Item/Migrate/ServiceDataBox.Local.png) | ![illustration for ServiceDataBoxCard](../../../azure/Item/Migrate/ServiceDataBoxCard.Local.png) | ![illustration for ServiceDataBoxGroup](../../../azure/Item/Migrate/ServiceDataBoxGroup.Local.png) |
