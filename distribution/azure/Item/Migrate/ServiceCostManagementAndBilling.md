...
```text
azure/Item/Migrate/ServiceCostManagementAndBilling
```

```text
include('azure/Item/Migrate/ServiceCostManagementAndBilling')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Migrate/ServiceCostManagementAndBilling.png) | ![illustration for ServiceCostManagementAndBilling](../../../azure/Item/Migrate/ServiceCostManagementAndBilling.Local.png) | ![illustration for ServiceCostManagementAndBillingCard](../../../azure/Item/Migrate/ServiceCostManagementAndBillingCard.Local.png) | ![illustration for ServiceCostManagementAndBillingGroup](../../../azure/Item/Migrate/ServiceCostManagementAndBillingGroup.Local.png) |
