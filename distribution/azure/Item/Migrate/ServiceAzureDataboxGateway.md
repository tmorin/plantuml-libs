...
```text
azure/Item/Migrate/ServiceAzureDataboxGateway
```

```text
include('azure/Item/Migrate/ServiceAzureDataboxGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Migrate/ServiceAzureDataboxGateway.png) | ![illustration for ServiceAzureDataboxGateway](../../../azure/Item/Migrate/ServiceAzureDataboxGateway.Local.png) | ![illustration for ServiceAzureDataboxGatewayCard](../../../azure/Item/Migrate/ServiceAzureDataboxGatewayCard.Local.png) | ![illustration for ServiceAzureDataboxGatewayGroup](../../../azure/Item/Migrate/ServiceAzureDataboxGatewayGroup.Local.png) |
