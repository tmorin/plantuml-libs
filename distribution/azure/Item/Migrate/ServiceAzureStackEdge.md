...
```text
azure/Item/Migrate/ServiceAzureStackEdge
```

```text
include('azure/Item/Migrate/ServiceAzureStackEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Migrate/ServiceAzureStackEdge.png) | ![illustration for ServiceAzureStackEdge](../../../azure/Item/Migrate/ServiceAzureStackEdge.Local.png) | ![illustration for ServiceAzureStackEdgeCard](../../../azure/Item/Migrate/ServiceAzureStackEdgeCard.Local.png) | ![illustration for ServiceAzureStackEdgeGroup](../../../azure/Item/Migrate/ServiceAzureStackEdgeGroup.Local.png) |
