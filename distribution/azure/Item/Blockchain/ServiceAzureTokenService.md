...
```text
azure/Item/Blockchain/ServiceAzureTokenService
```

```text
include('azure/Item/Blockchain/ServiceAzureTokenService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Blockchain/ServiceAzureTokenService.png) | ![illustration for ServiceAzureTokenService](../../../azure/Item/Blockchain/ServiceAzureTokenService.Local.png) | ![illustration for ServiceAzureTokenServiceCard](../../../azure/Item/Blockchain/ServiceAzureTokenServiceCard.Local.png) | ![illustration for ServiceAzureTokenServiceGroup](../../../azure/Item/Blockchain/ServiceAzureTokenServiceGroup.Local.png) |
