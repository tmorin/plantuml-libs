...
```text
azure/Item/Blockchain/ServiceAbsMember
```

```text
include('azure/Item/Blockchain/ServiceAbsMember')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Blockchain/ServiceAbsMember.png) | ![illustration for ServiceAbsMember](../../../azure/Item/Blockchain/ServiceAbsMember.Local.png) | ![illustration for ServiceAbsMemberCard](../../../azure/Item/Blockchain/ServiceAbsMemberCard.Local.png) | ![illustration for ServiceAbsMemberGroup](../../../azure/Item/Blockchain/ServiceAbsMemberGroup.Local.png) |
