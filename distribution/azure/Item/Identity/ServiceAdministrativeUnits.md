...
```text
azure/Item/Identity/ServiceAdministrativeUnits
```

```text
include('azure/Item/Identity/ServiceAdministrativeUnits')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Identity/ServiceAdministrativeUnits.png) | ![illustration for ServiceAdministrativeUnits](../../../azure/Item/Identity/ServiceAdministrativeUnits.Local.png) | ![illustration for ServiceAdministrativeUnitsCard](../../../azure/Item/Identity/ServiceAdministrativeUnitsCard.Local.png) | ![illustration for ServiceAdministrativeUnitsGroup](../../../azure/Item/Identity/ServiceAdministrativeUnitsGroup.Local.png) |
