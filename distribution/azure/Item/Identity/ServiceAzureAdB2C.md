...
```text
azure/Item/Identity/ServiceAzureAdB2C
```

```text
include('azure/Item/Identity/ServiceAzureAdB2C')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Identity/ServiceAzureAdB2C.png) | ![illustration for ServiceAzureAdB2C](../../../azure/Item/Identity/ServiceAzureAdB2C.Local.png) | ![illustration for ServiceAzureAdB2CCard](../../../azure/Item/Identity/ServiceAzureAdB2CCard.Local.png) | ![illustration for ServiceAzureAdB2CGroup](../../../azure/Item/Identity/ServiceAzureAdB2CGroup.Local.png) |
