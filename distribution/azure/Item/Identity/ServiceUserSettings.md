...
```text
azure/Item/Identity/ServiceUserSettings
```

```text
include('azure/Item/Identity/ServiceUserSettings')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Identity/ServiceUserSettings.png) | ![illustration for ServiceUserSettings](../../../azure/Item/Identity/ServiceUserSettings.Local.png) | ![illustration for ServiceUserSettingsCard](../../../azure/Item/Identity/ServiceUserSettingsCard.Local.png) | ![illustration for ServiceUserSettingsGroup](../../../azure/Item/Identity/ServiceUserSettingsGroup.Local.png) |
