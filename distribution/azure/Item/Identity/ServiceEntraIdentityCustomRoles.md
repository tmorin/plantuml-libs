...
```text
azure/Item/Identity/ServiceEntraIdentityCustomRoles
```

```text
include('azure/Item/Identity/ServiceEntraIdentityCustomRoles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Identity/ServiceEntraIdentityCustomRoles.png) | ![illustration for ServiceEntraIdentityCustomRoles](../../../azure/Item/Identity/ServiceEntraIdentityCustomRoles.Local.png) | ![illustration for ServiceEntraIdentityCustomRolesCard](../../../azure/Item/Identity/ServiceEntraIdentityCustomRolesCard.Local.png) | ![illustration for ServiceEntraIdentityCustomRolesGroup](../../../azure/Item/Identity/ServiceEntraIdentityCustomRolesGroup.Local.png) |
