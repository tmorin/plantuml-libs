...
```text
azure/Item/Identity/ServiceAppRegistrations
```

```text
include('azure/Item/Identity/ServiceAppRegistrations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Identity/ServiceAppRegistrations.png) | ![illustration for ServiceAppRegistrations](../../../azure/Item/Identity/ServiceAppRegistrations.Local.png) | ![illustration for ServiceAppRegistrationsCard](../../../azure/Item/Identity/ServiceAppRegistrationsCard.Local.png) | ![illustration for ServiceAppRegistrationsGroup](../../../azure/Item/Identity/ServiceAppRegistrationsGroup.Local.png) |
