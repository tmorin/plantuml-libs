...
```text
azure/Item/Identity/ServiceEntraPrivateAccess
```

```text
include('azure/Item/Identity/ServiceEntraPrivateAccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Identity/ServiceEntraPrivateAccess.png) | ![illustration for ServiceEntraPrivateAccess](../../../azure/Item/Identity/ServiceEntraPrivateAccess.Local.png) | ![illustration for ServiceEntraPrivateAccessCard](../../../azure/Item/Identity/ServiceEntraPrivateAccessCard.Local.png) | ![illustration for ServiceEntraPrivateAccessGroup](../../../azure/Item/Identity/ServiceEntraPrivateAccessGroup.Local.png) |
