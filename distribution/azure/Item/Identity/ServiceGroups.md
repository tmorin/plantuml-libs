...
```text
azure/Item/Identity/ServiceGroups
```

```text
include('azure/Item/Identity/ServiceGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Identity/ServiceGroups.png) | ![illustration for ServiceGroups](../../../azure/Item/Identity/ServiceGroups.Local.png) | ![illustration for ServiceGroupsCard](../../../azure/Item/Identity/ServiceGroupsCard.Local.png) | ![illustration for ServiceGroupsGroup](../../../azure/Item/Identity/ServiceGroupsGroup.Local.png) |
