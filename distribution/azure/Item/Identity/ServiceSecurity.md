...
```text
azure/Item/Identity/ServiceSecurity
```

```text
include('azure/Item/Identity/ServiceSecurity')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Identity/ServiceSecurity.png) | ![illustration for ServiceSecurity](../../../azure/Item/Identity/ServiceSecurity.Local.png) | ![illustration for ServiceSecurityCard](../../../azure/Item/Identity/ServiceSecurityCard.Local.png) | ![illustration for ServiceSecurityGroup](../../../azure/Item/Identity/ServiceSecurityGroup.Local.png) |
