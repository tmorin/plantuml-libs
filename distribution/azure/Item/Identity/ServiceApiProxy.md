...
```text
azure/Item/Identity/ServiceApiProxy
```

```text
include('azure/Item/Identity/ServiceApiProxy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Identity/ServiceApiProxy.png) | ![illustration for ServiceApiProxy](../../../azure/Item/Identity/ServiceApiProxy.Local.png) | ![illustration for ServiceApiProxyCard](../../../azure/Item/Identity/ServiceApiProxyCard.Local.png) | ![illustration for ServiceApiProxyGroup](../../../azure/Item/Identity/ServiceApiProxyGroup.Local.png) |
