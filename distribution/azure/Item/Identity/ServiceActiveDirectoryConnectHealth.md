...
```text
azure/Item/Identity/ServiceActiveDirectoryConnectHealth
```

```text
include('azure/Item/Identity/ServiceActiveDirectoryConnectHealth')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Identity/ServiceActiveDirectoryConnectHealth.png) | ![illustration for ServiceActiveDirectoryConnectHealth](../../../azure/Item/Identity/ServiceActiveDirectoryConnectHealth.Local.png) | ![illustration for ServiceActiveDirectoryConnectHealthCard](../../../azure/Item/Identity/ServiceActiveDirectoryConnectHealthCard.Local.png) | ![illustration for ServiceActiveDirectoryConnectHealthGroup](../../../azure/Item/Identity/ServiceActiveDirectoryConnectHealthGroup.Local.png) |
