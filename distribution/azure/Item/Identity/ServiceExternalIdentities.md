...
```text
azure/Item/Identity/ServiceExternalIdentities
```

```text
include('azure/Item/Identity/ServiceExternalIdentities')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Identity/ServiceExternalIdentities.png) | ![illustration for ServiceExternalIdentities](../../../azure/Item/Identity/ServiceExternalIdentities.Local.png) | ![illustration for ServiceExternalIdentitiesCard](../../../azure/Item/Identity/ServiceExternalIdentitiesCard.Local.png) | ![illustration for ServiceExternalIdentitiesGroup](../../../azure/Item/Identity/ServiceExternalIdentitiesGroup.Local.png) |
