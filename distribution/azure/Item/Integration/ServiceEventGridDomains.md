...
```text
azure/Item/Integration/ServiceEventGridDomains
```

```text
include('azure/Item/Integration/ServiceEventGridDomains')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Integration/ServiceEventGridDomains.png) | ![illustration for ServiceEventGridDomains](../../../azure/Item/Integration/ServiceEventGridDomains.Local.png) | ![illustration for ServiceEventGridDomainsCard](../../../azure/Item/Integration/ServiceEventGridDomainsCard.Local.png) | ![illustration for ServiceEventGridDomainsGroup](../../../azure/Item/Integration/ServiceEventGridDomainsGroup.Local.png) |
