...
```text
azure/Item/Integration/ServicePartnerRegistration
```

```text
include('azure/Item/Integration/ServicePartnerRegistration')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Integration/ServicePartnerRegistration.png) | ![illustration for ServicePartnerRegistration](../../../azure/Item/Integration/ServicePartnerRegistration.Local.png) | ![illustration for ServicePartnerRegistrationCard](../../../azure/Item/Integration/ServicePartnerRegistrationCard.Local.png) | ![illustration for ServicePartnerRegistrationGroup](../../../azure/Item/Integration/ServicePartnerRegistrationGroup.Local.png) |
