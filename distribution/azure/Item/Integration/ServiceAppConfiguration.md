...
```text
azure/Item/Integration/ServiceAppConfiguration
```

```text
include('azure/Item/Integration/ServiceAppConfiguration')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Integration/ServiceAppConfiguration.png) | ![illustration for ServiceAppConfiguration](../../../azure/Item/Integration/ServiceAppConfiguration.Local.png) | ![illustration for ServiceAppConfigurationCard](../../../azure/Item/Integration/ServiceAppConfigurationCard.Local.png) | ![illustration for ServiceAppConfigurationGroup](../../../azure/Item/Integration/ServiceAppConfigurationGroup.Local.png) |
