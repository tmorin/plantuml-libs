...
```text
azure/Item/Integration/ServiceAzureDataboxGateway
```

```text
include('azure/Item/Integration/ServiceAzureDataboxGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Integration/ServiceAzureDataboxGateway.png) | ![illustration for ServiceAzureDataboxGateway](../../../azure/Item/Integration/ServiceAzureDataboxGateway.Local.png) | ![illustration for ServiceAzureDataboxGatewayCard](../../../azure/Item/Integration/ServiceAzureDataboxGatewayCard.Local.png) | ![illustration for ServiceAzureDataboxGatewayGroup](../../../azure/Item/Integration/ServiceAzureDataboxGatewayGroup.Local.png) |
