...
```text
azure/Item/Integration/ServiceSendGridAccounts
```

```text
include('azure/Item/Integration/ServiceSendGridAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Integration/ServiceSendGridAccounts.png) | ![illustration for ServiceSendGridAccounts](../../../azure/Item/Integration/ServiceSendGridAccounts.Local.png) | ![illustration for ServiceSendGridAccountsCard](../../../azure/Item/Integration/ServiceSendGridAccountsCard.Local.png) | ![illustration for ServiceSendGridAccountsGroup](../../../azure/Item/Integration/ServiceSendGridAccountsGroup.Local.png) |
