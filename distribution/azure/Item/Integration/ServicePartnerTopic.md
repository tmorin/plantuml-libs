...
```text
azure/Item/Integration/ServicePartnerTopic
```

```text
include('azure/Item/Integration/ServicePartnerTopic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Integration/ServicePartnerTopic.png) | ![illustration for ServicePartnerTopic](../../../azure/Item/Integration/ServicePartnerTopic.Local.png) | ![illustration for ServicePartnerTopicCard](../../../azure/Item/Integration/ServicePartnerTopicCard.Local.png) | ![illustration for ServicePartnerTopicGroup](../../../azure/Item/Integration/ServicePartnerTopicGroup.Local.png) |
