...
```text
azure/Item/Integration/ServiceRelays
```

```text
include('azure/Item/Integration/ServiceRelays')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Integration/ServiceRelays.png) | ![illustration for ServiceRelays](../../../azure/Item/Integration/ServiceRelays.Local.png) | ![illustration for ServiceRelaysCard](../../../azure/Item/Integration/ServiceRelaysCard.Local.png) | ![illustration for ServiceRelaysGroup](../../../azure/Item/Integration/ServiceRelaysGroup.Local.png) |
