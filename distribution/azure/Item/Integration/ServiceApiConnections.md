...
```text
azure/Item/Integration/ServiceApiConnections
```

```text
include('azure/Item/Integration/ServiceApiConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Integration/ServiceApiConnections.png) | ![illustration for ServiceApiConnections](../../../azure/Item/Integration/ServiceApiConnections.Local.png) | ![illustration for ServiceApiConnectionsCard](../../../azure/Item/Integration/ServiceApiConnectionsCard.Local.png) | ![illustration for ServiceApiConnectionsGroup](../../../azure/Item/Integration/ServiceApiConnectionsGroup.Local.png) |
