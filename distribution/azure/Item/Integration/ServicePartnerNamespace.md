...
```text
azure/Item/Integration/ServicePartnerNamespace
```

```text
include('azure/Item/Integration/ServicePartnerNamespace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Integration/ServicePartnerNamespace.png) | ![illustration for ServicePartnerNamespace](../../../azure/Item/Integration/ServicePartnerNamespace.Local.png) | ![illustration for ServicePartnerNamespaceCard](../../../azure/Item/Integration/ServicePartnerNamespaceCard.Local.png) | ![illustration for ServicePartnerNamespaceGroup](../../../azure/Item/Integration/ServicePartnerNamespaceGroup.Local.png) |
