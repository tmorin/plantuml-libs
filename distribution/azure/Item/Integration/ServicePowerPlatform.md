...
```text
azure/Item/Integration/ServicePowerPlatform
```

```text
include('azure/Item/Integration/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Integration/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure/Item/Integration/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure/Item/Integration/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure/Item/Integration/ServicePowerPlatformGroup.Local.png) |
