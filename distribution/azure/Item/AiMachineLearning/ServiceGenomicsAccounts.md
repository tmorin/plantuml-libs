...
```text
azure/Item/AiMachineLearning/ServiceGenomicsAccounts
```

```text
include('azure/Item/AiMachineLearning/ServiceGenomicsAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceGenomicsAccounts.png) | ![illustration for ServiceGenomicsAccounts](../../../azure/Item/AiMachineLearning/ServiceGenomicsAccounts.Local.png) | ![illustration for ServiceGenomicsAccountsCard](../../../azure/Item/AiMachineLearning/ServiceGenomicsAccountsCard.Local.png) | ![illustration for ServiceGenomicsAccountsGroup](../../../azure/Item/AiMachineLearning/ServiceGenomicsAccountsGroup.Local.png) |
