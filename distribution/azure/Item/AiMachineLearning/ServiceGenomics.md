...
```text
azure/Item/AiMachineLearning/ServiceGenomics
```

```text
include('azure/Item/AiMachineLearning/ServiceGenomics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceGenomics.png) | ![illustration for ServiceGenomics](../../../azure/Item/AiMachineLearning/ServiceGenomics.Local.png) | ![illustration for ServiceGenomicsCard](../../../azure/Item/AiMachineLearning/ServiceGenomicsCard.Local.png) | ![illustration for ServiceGenomicsGroup](../../../azure/Item/AiMachineLearning/ServiceGenomicsGroup.Local.png) |
