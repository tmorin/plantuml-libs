...
```text
azure/Item/AiMachineLearning/ServiceMetricsAdvisor
```

```text
include('azure/Item/AiMachineLearning/ServiceMetricsAdvisor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceMetricsAdvisor.png) | ![illustration for ServiceMetricsAdvisor](../../../azure/Item/AiMachineLearning/ServiceMetricsAdvisor.Local.png) | ![illustration for ServiceMetricsAdvisorCard](../../../azure/Item/AiMachineLearning/ServiceMetricsAdvisorCard.Local.png) | ![illustration for ServiceMetricsAdvisorGroup](../../../azure/Item/AiMachineLearning/ServiceMetricsAdvisorGroup.Local.png) |
