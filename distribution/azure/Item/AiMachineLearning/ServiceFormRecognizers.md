...
```text
azure/Item/AiMachineLearning/ServiceFormRecognizers
```

```text
include('azure/Item/AiMachineLearning/ServiceFormRecognizers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceFormRecognizers.png) | ![illustration for ServiceFormRecognizers](../../../azure/Item/AiMachineLearning/ServiceFormRecognizers.Local.png) | ![illustration for ServiceFormRecognizersCard](../../../azure/Item/AiMachineLearning/ServiceFormRecognizersCard.Local.png) | ![illustration for ServiceFormRecognizersGroup](../../../azure/Item/AiMachineLearning/ServiceFormRecognizersGroup.Local.png) |
