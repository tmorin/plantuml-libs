...
```text
azure/Item/AiMachineLearning/ServiceAzureOpenAi
```

```text
include('azure/Item/AiMachineLearning/ServiceAzureOpenAi')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceAzureOpenAi.png) | ![illustration for ServiceAzureOpenAi](../../../azure/Item/AiMachineLearning/ServiceAzureOpenAi.Local.png) | ![illustration for ServiceAzureOpenAiCard](../../../azure/Item/AiMachineLearning/ServiceAzureOpenAiCard.Local.png) | ![illustration for ServiceAzureOpenAiGroup](../../../azure/Item/AiMachineLearning/ServiceAzureOpenAiGroup.Local.png) |
