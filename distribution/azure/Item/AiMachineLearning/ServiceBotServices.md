...
```text
azure/Item/AiMachineLearning/ServiceBotServices
```

```text
include('azure/Item/AiMachineLearning/ServiceBotServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceBotServices.png) | ![illustration for ServiceBotServices](../../../azure/Item/AiMachineLearning/ServiceBotServices.Local.png) | ![illustration for ServiceBotServicesCard](../../../azure/Item/AiMachineLearning/ServiceBotServicesCard.Local.png) | ![illustration for ServiceBotServicesGroup](../../../azure/Item/AiMachineLearning/ServiceBotServicesGroup.Local.png) |
