...
```text
azure/Item/AiMachineLearning/ServiceBatchAi
```

```text
include('azure/Item/AiMachineLearning/ServiceBatchAi')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceBatchAi.png) | ![illustration for ServiceBatchAi](../../../azure/Item/AiMachineLearning/ServiceBatchAi.Local.png) | ![illustration for ServiceBatchAiCard](../../../azure/Item/AiMachineLearning/ServiceBatchAiCard.Local.png) | ![illustration for ServiceBatchAiGroup](../../../azure/Item/AiMachineLearning/ServiceBatchAiGroup.Local.png) |
