...
```text
azure/Item/AiMachineLearning/ServiceMachineLearning
```

```text
include('azure/Item/AiMachineLearning/ServiceMachineLearning')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceMachineLearning.png) | ![illustration for ServiceMachineLearning](../../../azure/Item/AiMachineLearning/ServiceMachineLearning.Local.png) | ![illustration for ServiceMachineLearningCard](../../../azure/Item/AiMachineLearning/ServiceMachineLearningCard.Local.png) | ![illustration for ServiceMachineLearningGroup](../../../azure/Item/AiMachineLearning/ServiceMachineLearningGroup.Local.png) |
