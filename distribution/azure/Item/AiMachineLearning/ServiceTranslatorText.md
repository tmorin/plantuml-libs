...
```text
azure/Item/AiMachineLearning/ServiceTranslatorText
```

```text
include('azure/Item/AiMachineLearning/ServiceTranslatorText')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceTranslatorText.png) | ![illustration for ServiceTranslatorText](../../../azure/Item/AiMachineLearning/ServiceTranslatorText.Local.png) | ![illustration for ServiceTranslatorTextCard](../../../azure/Item/AiMachineLearning/ServiceTranslatorTextCard.Local.png) | ![illustration for ServiceTranslatorTextGroup](../../../azure/Item/AiMachineLearning/ServiceTranslatorTextGroup.Local.png) |
