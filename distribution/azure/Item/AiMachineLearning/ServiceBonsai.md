...
```text
azure/Item/AiMachineLearning/ServiceBonsai
```

```text
include('azure/Item/AiMachineLearning/ServiceBonsai')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceBonsai.png) | ![illustration for ServiceBonsai](../../../azure/Item/AiMachineLearning/ServiceBonsai.Local.png) | ![illustration for ServiceBonsaiCard](../../../azure/Item/AiMachineLearning/ServiceBonsaiCard.Local.png) | ![illustration for ServiceBonsaiGroup](../../../azure/Item/AiMachineLearning/ServiceBonsaiGroup.Local.png) |
