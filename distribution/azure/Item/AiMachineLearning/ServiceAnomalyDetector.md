...
```text
azure/Item/AiMachineLearning/ServiceAnomalyDetector
```

```text
include('azure/Item/AiMachineLearning/ServiceAnomalyDetector')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceAnomalyDetector.png) | ![illustration for ServiceAnomalyDetector](../../../azure/Item/AiMachineLearning/ServiceAnomalyDetector.Local.png) | ![illustration for ServiceAnomalyDetectorCard](../../../azure/Item/AiMachineLearning/ServiceAnomalyDetectorCard.Local.png) | ![illustration for ServiceAnomalyDetectorGroup](../../../azure/Item/AiMachineLearning/ServiceAnomalyDetectorGroup.Local.png) |
