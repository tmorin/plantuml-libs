...
```text
azure/Item/AiMachineLearning/ServiceContentModerators
```

```text
include('azure/Item/AiMachineLearning/ServiceContentModerators')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceContentModerators.png) | ![illustration for ServiceContentModerators](../../../azure/Item/AiMachineLearning/ServiceContentModerators.Local.png) | ![illustration for ServiceContentModeratorsCard](../../../azure/Item/AiMachineLearning/ServiceContentModeratorsCard.Local.png) | ![illustration for ServiceContentModeratorsGroup](../../../azure/Item/AiMachineLearning/ServiceContentModeratorsGroup.Local.png) |
