...
```text
azure/Item/AiMachineLearning/ServiceAiStudio
```

```text
include('azure/Item/AiMachineLearning/ServiceAiStudio')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AiMachineLearning/ServiceAiStudio.png) | ![illustration for ServiceAiStudio](../../../azure/Item/AiMachineLearning/ServiceAiStudio.Local.png) | ![illustration for ServiceAiStudioCard](../../../azure/Item/AiMachineLearning/ServiceAiStudioCard.Local.png) | ![illustration for ServiceAiStudioGroup](../../../azure/Item/AiMachineLearning/ServiceAiStudioGroup.Local.png) |
