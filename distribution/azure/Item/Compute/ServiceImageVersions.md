...
```text
azure/Item/Compute/ServiceImageVersions
```

```text
include('azure/Item/Compute/ServiceImageVersions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceImageVersions.png) | ![illustration for ServiceImageVersions](../../../azure/Item/Compute/ServiceImageVersions.Local.png) | ![illustration for ServiceImageVersionsCard](../../../azure/Item/Compute/ServiceImageVersionsCard.Local.png) | ![illustration for ServiceImageVersionsGroup](../../../azure/Item/Compute/ServiceImageVersionsGroup.Local.png) |
