...
```text
azure/Item/Compute/ServiceVirtualMachine
```

```text
include('azure/Item/Compute/ServiceVirtualMachine')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceVirtualMachine.png) | ![illustration for ServiceVirtualMachine](../../../azure/Item/Compute/ServiceVirtualMachine.Local.png) | ![illustration for ServiceVirtualMachineCard](../../../azure/Item/Compute/ServiceVirtualMachineCard.Local.png) | ![illustration for ServiceVirtualMachineGroup](../../../azure/Item/Compute/ServiceVirtualMachineGroup.Local.png) |
