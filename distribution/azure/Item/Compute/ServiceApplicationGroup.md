...
```text
azure/Item/Compute/ServiceApplicationGroup
```

```text
include('azure/Item/Compute/ServiceApplicationGroup')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceApplicationGroup.png) | ![illustration for ServiceApplicationGroup](../../../azure/Item/Compute/ServiceApplicationGroup.Local.png) | ![illustration for ServiceApplicationGroupCard](../../../azure/Item/Compute/ServiceApplicationGroupCard.Local.png) | ![illustration for ServiceApplicationGroupGroup](../../../azure/Item/Compute/ServiceApplicationGroupGroup.Local.png) |
