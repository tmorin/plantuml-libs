...
```text
azure/Item/Compute/ServiceDisksSnapshots
```

```text
include('azure/Item/Compute/ServiceDisksSnapshots')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceDisksSnapshots.png) | ![illustration for ServiceDisksSnapshots](../../../azure/Item/Compute/ServiceDisksSnapshots.Local.png) | ![illustration for ServiceDisksSnapshotsCard](../../../azure/Item/Compute/ServiceDisksSnapshotsCard.Local.png) | ![illustration for ServiceDisksSnapshotsGroup](../../../azure/Item/Compute/ServiceDisksSnapshotsGroup.Local.png) |
