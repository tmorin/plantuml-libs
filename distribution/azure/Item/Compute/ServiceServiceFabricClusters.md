...
```text
azure/Item/Compute/ServiceServiceFabricClusters
```

```text
include('azure/Item/Compute/ServiceServiceFabricClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceServiceFabricClusters.png) | ![illustration for ServiceServiceFabricClusters](../../../azure/Item/Compute/ServiceServiceFabricClusters.Local.png) | ![illustration for ServiceServiceFabricClustersCard](../../../azure/Item/Compute/ServiceServiceFabricClustersCard.Local.png) | ![illustration for ServiceServiceFabricClustersGroup](../../../azure/Item/Compute/ServiceServiceFabricClustersGroup.Local.png) |
