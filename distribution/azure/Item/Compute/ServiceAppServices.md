...
```text
azure/Item/Compute/ServiceAppServices
```

```text
include('azure/Item/Compute/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure/Item/Compute/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure/Item/Compute/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure/Item/Compute/ServiceAppServicesGroup.Local.png) |
