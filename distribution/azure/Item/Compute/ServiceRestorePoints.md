...
```text
azure/Item/Compute/ServiceRestorePoints
```

```text
include('azure/Item/Compute/ServiceRestorePoints')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceRestorePoints.png) | ![illustration for ServiceRestorePoints](../../../azure/Item/Compute/ServiceRestorePoints.Local.png) | ![illustration for ServiceRestorePointsCard](../../../azure/Item/Compute/ServiceRestorePointsCard.Local.png) | ![illustration for ServiceRestorePointsGroup](../../../azure/Item/Compute/ServiceRestorePointsGroup.Local.png) |
