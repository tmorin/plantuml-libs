...
```text
azure/Item/Compute/ServiceKubernetesServices
```

```text
include('azure/Item/Compute/ServiceKubernetesServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceKubernetesServices.png) | ![illustration for ServiceKubernetesServices](../../../azure/Item/Compute/ServiceKubernetesServices.Local.png) | ![illustration for ServiceKubernetesServicesCard](../../../azure/Item/Compute/ServiceKubernetesServicesCard.Local.png) | ![illustration for ServiceKubernetesServicesGroup](../../../azure/Item/Compute/ServiceKubernetesServicesGroup.Local.png) |
