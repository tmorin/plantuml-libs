...
```text
azure/Item/Compute/ServiceBatchAccounts
```

```text
include('azure/Item/Compute/ServiceBatchAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceBatchAccounts.png) | ![illustration for ServiceBatchAccounts](../../../azure/Item/Compute/ServiceBatchAccounts.Local.png) | ![illustration for ServiceBatchAccountsCard](../../../azure/Item/Compute/ServiceBatchAccountsCard.Local.png) | ![illustration for ServiceBatchAccountsGroup](../../../azure/Item/Compute/ServiceBatchAccountsGroup.Local.png) |
