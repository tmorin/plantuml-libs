...
```text
azure/Item/Compute/ServiceMeshApplications
```

```text
include('azure/Item/Compute/ServiceMeshApplications')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceMeshApplications.png) | ![illustration for ServiceMeshApplications](../../../azure/Item/Compute/ServiceMeshApplications.Local.png) | ![illustration for ServiceMeshApplicationsCard](../../../azure/Item/Compute/ServiceMeshApplicationsCard.Local.png) | ![illustration for ServiceMeshApplicationsGroup](../../../azure/Item/Compute/ServiceMeshApplicationsGroup.Local.png) |
