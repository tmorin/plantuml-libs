...
```text
azure/Item/Compute/ServiceComputeFleet
```

```text
include('azure/Item/Compute/ServiceComputeFleet')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceComputeFleet.png) | ![illustration for ServiceComputeFleet](../../../azure/Item/Compute/ServiceComputeFleet.Local.png) | ![illustration for ServiceComputeFleetCard](../../../azure/Item/Compute/ServiceComputeFleetCard.Local.png) | ![illustration for ServiceComputeFleetGroup](../../../azure/Item/Compute/ServiceComputeFleetGroup.Local.png) |
