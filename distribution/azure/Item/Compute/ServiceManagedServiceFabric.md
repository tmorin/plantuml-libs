...
```text
azure/Item/Compute/ServiceManagedServiceFabric
```

```text
include('azure/Item/Compute/ServiceManagedServiceFabric')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceManagedServiceFabric.png) | ![illustration for ServiceManagedServiceFabric](../../../azure/Item/Compute/ServiceManagedServiceFabric.Local.png) | ![illustration for ServiceManagedServiceFabricCard](../../../azure/Item/Compute/ServiceManagedServiceFabricCard.Local.png) | ![illustration for ServiceManagedServiceFabricGroup](../../../azure/Item/Compute/ServiceManagedServiceFabricGroup.Local.png) |
