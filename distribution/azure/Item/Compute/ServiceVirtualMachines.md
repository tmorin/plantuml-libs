...
```text
azure/Item/Compute/ServiceVirtualMachines
```

```text
include('azure/Item/Compute/ServiceVirtualMachines')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceVirtualMachines.png) | ![illustration for ServiceVirtualMachines](../../../azure/Item/Compute/ServiceVirtualMachines.Local.png) | ![illustration for ServiceVirtualMachinesCard](../../../azure/Item/Compute/ServiceVirtualMachinesCard.Local.png) | ![illustration for ServiceVirtualMachinesGroup](../../../azure/Item/Compute/ServiceVirtualMachinesGroup.Local.png) |
