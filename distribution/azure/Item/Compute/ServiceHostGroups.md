...
```text
azure/Item/Compute/ServiceHostGroups
```

```text
include('azure/Item/Compute/ServiceHostGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceHostGroups.png) | ![illustration for ServiceHostGroups](../../../azure/Item/Compute/ServiceHostGroups.Local.png) | ![illustration for ServiceHostGroupsCard](../../../azure/Item/Compute/ServiceHostGroupsCard.Local.png) | ![illustration for ServiceHostGroupsGroup](../../../azure/Item/Compute/ServiceHostGroupsGroup.Local.png) |
