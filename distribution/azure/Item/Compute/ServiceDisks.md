...
```text
azure/Item/Compute/ServiceDisks
```

```text
include('azure/Item/Compute/ServiceDisks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceDisks.png) | ![illustration for ServiceDisks](../../../azure/Item/Compute/ServiceDisks.Local.png) | ![illustration for ServiceDisksCard](../../../azure/Item/Compute/ServiceDisksCard.Local.png) | ![illustration for ServiceDisksGroup](../../../azure/Item/Compute/ServiceDisksGroup.Local.png) |
