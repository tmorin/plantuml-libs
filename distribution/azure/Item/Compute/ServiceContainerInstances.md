...
```text
azure/Item/Compute/ServiceContainerInstances
```

```text
include('azure/Item/Compute/ServiceContainerInstances')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceContainerInstances.png) | ![illustration for ServiceContainerInstances](../../../azure/Item/Compute/ServiceContainerInstances.Local.png) | ![illustration for ServiceContainerInstancesCard](../../../azure/Item/Compute/ServiceContainerInstancesCard.Local.png) | ![illustration for ServiceContainerInstancesGroup](../../../azure/Item/Compute/ServiceContainerInstancesGroup.Local.png) |
