...
```text
azure/Item/Compute/ServiceFunctionApps
```

```text
include('azure/Item/Compute/ServiceFunctionApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceFunctionApps.png) | ![illustration for ServiceFunctionApps](../../../azure/Item/Compute/ServiceFunctionApps.Local.png) | ![illustration for ServiceFunctionAppsCard](../../../azure/Item/Compute/ServiceFunctionAppsCard.Local.png) | ![illustration for ServiceFunctionAppsGroup](../../../azure/Item/Compute/ServiceFunctionAppsGroup.Local.png) |
