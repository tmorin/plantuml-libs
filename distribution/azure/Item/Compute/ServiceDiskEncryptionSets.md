...
```text
azure/Item/Compute/ServiceDiskEncryptionSets
```

```text
include('azure/Item/Compute/ServiceDiskEncryptionSets')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Compute/ServiceDiskEncryptionSets.png) | ![illustration for ServiceDiskEncryptionSets](../../../azure/Item/Compute/ServiceDiskEncryptionSets.Local.png) | ![illustration for ServiceDiskEncryptionSetsCard](../../../azure/Item/Compute/ServiceDiskEncryptionSetsCard.Local.png) | ![illustration for ServiceDiskEncryptionSetsGroup](../../../azure/Item/Compute/ServiceDiskEncryptionSetsGroup.Local.png) |
