...
```text
azure/Item/Web/ServiceAppServices
```

```text
include('azure/Item/Web/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Web/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure/Item/Web/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure/Item/Web/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure/Item/Web/ServiceAppServicesGroup.Local.png) |
