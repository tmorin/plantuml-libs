...
```text
azure/Item/Web/ServiceApiConnections
```

```text
include('azure/Item/Web/ServiceApiConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Web/ServiceApiConnections.png) | ![illustration for ServiceApiConnections](../../../azure/Item/Web/ServiceApiConnections.Local.png) | ![illustration for ServiceApiConnectionsCard](../../../azure/Item/Web/ServiceApiConnectionsCard.Local.png) | ![illustration for ServiceApiConnectionsGroup](../../../azure/Item/Web/ServiceApiConnectionsGroup.Local.png) |
