...
```text
azure/Item/Web/ServiceNotificationHubNamespaces
```

```text
include('azure/Item/Web/ServiceNotificationHubNamespaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Web/ServiceNotificationHubNamespaces.png) | ![illustration for ServiceNotificationHubNamespaces](../../../azure/Item/Web/ServiceNotificationHubNamespaces.Local.png) | ![illustration for ServiceNotificationHubNamespacesCard](../../../azure/Item/Web/ServiceNotificationHubNamespacesCard.Local.png) | ![illustration for ServiceNotificationHubNamespacesGroup](../../../azure/Item/Web/ServiceNotificationHubNamespacesGroup.Local.png) |
