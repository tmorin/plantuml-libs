...
```text
azure/Item/Web/ServiceAppSpaceComponent
```

```text
include('azure/Item/Web/ServiceAppSpaceComponent')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Web/ServiceAppSpaceComponent.png) | ![illustration for ServiceAppSpaceComponent](../../../azure/Item/Web/ServiceAppSpaceComponent.Local.png) | ![illustration for ServiceAppSpaceComponentCard](../../../azure/Item/Web/ServiceAppSpaceComponentCard.Local.png) | ![illustration for ServiceAppSpaceComponentGroup](../../../azure/Item/Web/ServiceAppSpaceComponentGroup.Local.png) |
