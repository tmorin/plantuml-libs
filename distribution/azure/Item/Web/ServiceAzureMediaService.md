...
```text
azure/Item/Web/ServiceAzureMediaService
```

```text
include('azure/Item/Web/ServiceAzureMediaService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Web/ServiceAzureMediaService.png) | ![illustration for ServiceAzureMediaService](../../../azure/Item/Web/ServiceAzureMediaService.Local.png) | ![illustration for ServiceAzureMediaServiceCard](../../../azure/Item/Web/ServiceAzureMediaServiceCard.Local.png) | ![illustration for ServiceAzureMediaServiceGroup](../../../azure/Item/Web/ServiceAzureMediaServiceGroup.Local.png) |
