...
```text
azure/Item/Web/ServiceAppServicePlans
```

```text
include('azure/Item/Web/ServiceAppServicePlans')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Web/ServiceAppServicePlans.png) | ![illustration for ServiceAppServicePlans](../../../azure/Item/Web/ServiceAppServicePlans.Local.png) | ![illustration for ServiceAppServicePlansCard](../../../azure/Item/Web/ServiceAppServicePlansCard.Local.png) | ![illustration for ServiceAppServicePlansGroup](../../../azure/Item/Web/ServiceAppServicePlansGroup.Local.png) |
