...
```text
azure/Item/Mobile/ServicePowerPlatform
```

```text
include('azure/Item/Mobile/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Mobile/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure/Item/Mobile/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure/Item/Mobile/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure/Item/Mobile/ServicePowerPlatformGroup.Local.png) |
