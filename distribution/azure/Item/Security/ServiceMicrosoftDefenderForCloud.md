...
```text
azure/Item/Security/ServiceMicrosoftDefenderForCloud
```

```text
include('azure/Item/Security/ServiceMicrosoftDefenderForCloud')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Security/ServiceMicrosoftDefenderForCloud.png) | ![illustration for ServiceMicrosoftDefenderForCloud](../../../azure/Item/Security/ServiceMicrosoftDefenderForCloud.Local.png) | ![illustration for ServiceMicrosoftDefenderForCloudCard](../../../azure/Item/Security/ServiceMicrosoftDefenderForCloudCard.Local.png) | ![illustration for ServiceMicrosoftDefenderForCloudGroup](../../../azure/Item/Security/ServiceMicrosoftDefenderForCloudGroup.Local.png) |
