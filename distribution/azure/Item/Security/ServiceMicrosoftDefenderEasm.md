...
```text
azure/Item/Security/ServiceMicrosoftDefenderEasm
```

```text
include('azure/Item/Security/ServiceMicrosoftDefenderEasm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Security/ServiceMicrosoftDefenderEasm.png) | ![illustration for ServiceMicrosoftDefenderEasm](../../../azure/Item/Security/ServiceMicrosoftDefenderEasm.Local.png) | ![illustration for ServiceMicrosoftDefenderEasmCard](../../../azure/Item/Security/ServiceMicrosoftDefenderEasmCard.Local.png) | ![illustration for ServiceMicrosoftDefenderEasmGroup](../../../azure/Item/Security/ServiceMicrosoftDefenderEasmGroup.Local.png) |
