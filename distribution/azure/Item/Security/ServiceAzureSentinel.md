...
```text
azure/Item/Security/ServiceAzureSentinel
```

```text
include('azure/Item/Security/ServiceAzureSentinel')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Security/ServiceAzureSentinel.png) | ![illustration for ServiceAzureSentinel](../../../azure/Item/Security/ServiceAzureSentinel.Local.png) | ![illustration for ServiceAzureSentinelCard](../../../azure/Item/Security/ServiceAzureSentinelCard.Local.png) | ![illustration for ServiceAzureSentinelGroup](../../../azure/Item/Security/ServiceAzureSentinelGroup.Local.png) |
