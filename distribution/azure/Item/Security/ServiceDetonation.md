...
```text
azure/Item/Security/ServiceDetonation
```

```text
include('azure/Item/Security/ServiceDetonation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Security/ServiceDetonation.png) | ![illustration for ServiceDetonation](../../../azure/Item/Security/ServiceDetonation.Local.png) | ![illustration for ServiceDetonationCard](../../../azure/Item/Security/ServiceDetonationCard.Local.png) | ![illustration for ServiceDetonationGroup](../../../azure/Item/Security/ServiceDetonationGroup.Local.png) |
