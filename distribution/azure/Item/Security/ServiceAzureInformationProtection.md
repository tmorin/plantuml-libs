...
```text
azure/Item/Security/ServiceAzureInformationProtection
```

```text
include('azure/Item/Security/ServiceAzureInformationProtection')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Security/ServiceAzureInformationProtection.png) | ![illustration for ServiceAzureInformationProtection](../../../azure/Item/Security/ServiceAzureInformationProtection.Local.png) | ![illustration for ServiceAzureInformationProtectionCard](../../../azure/Item/Security/ServiceAzureInformationProtectionCard.Local.png) | ![illustration for ServiceAzureInformationProtectionGroup](../../../azure/Item/Security/ServiceAzureInformationProtectionGroup.Local.png) |
