...
```text
azure/Item/Databases/ServiceAzureDatabaseMySqlServer
```

```text
include('azure/Item/Databases/ServiceAzureDatabaseMySqlServer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceAzureDatabaseMySqlServer.png) | ![illustration for ServiceAzureDatabaseMySqlServer](../../../azure/Item/Databases/ServiceAzureDatabaseMySqlServer.Local.png) | ![illustration for ServiceAzureDatabaseMySqlServerCard](../../../azure/Item/Databases/ServiceAzureDatabaseMySqlServerCard.Local.png) | ![illustration for ServiceAzureDatabaseMySqlServerGroup](../../../azure/Item/Databases/ServiceAzureDatabaseMySqlServerGroup.Local.png) |
