...
```text
azure/Item/Databases/ServiceAzureSql
```

```text
include('azure/Item/Databases/ServiceAzureSql')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceAzureSql.png) | ![illustration for ServiceAzureSql](../../../azure/Item/Databases/ServiceAzureSql.Local.png) | ![illustration for ServiceAzureSqlCard](../../../azure/Item/Databases/ServiceAzureSqlCard.Local.png) | ![illustration for ServiceAzureSqlGroup](../../../azure/Item/Databases/ServiceAzureSqlGroup.Local.png) |
