...
```text
azure/Item/Databases/ServiceAzureSqlVm
```

```text
include('azure/Item/Databases/ServiceAzureSqlVm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceAzureSqlVm.png) | ![illustration for ServiceAzureSqlVm](../../../azure/Item/Databases/ServiceAzureSqlVm.Local.png) | ![illustration for ServiceAzureSqlVmCard](../../../azure/Item/Databases/ServiceAzureSqlVmCard.Local.png) | ![illustration for ServiceAzureSqlVmGroup](../../../azure/Item/Databases/ServiceAzureSqlVmGroup.Local.png) |
