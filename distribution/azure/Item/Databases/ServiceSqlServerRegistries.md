...
```text
azure/Item/Databases/ServiceSqlServerRegistries
```

```text
include('azure/Item/Databases/ServiceSqlServerRegistries')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceSqlServerRegistries.png) | ![illustration for ServiceSqlServerRegistries](../../../azure/Item/Databases/ServiceSqlServerRegistries.Local.png) | ![illustration for ServiceSqlServerRegistriesCard](../../../azure/Item/Databases/ServiceSqlServerRegistriesCard.Local.png) | ![illustration for ServiceSqlServerRegistriesGroup](../../../azure/Item/Databases/ServiceSqlServerRegistriesGroup.Local.png) |
