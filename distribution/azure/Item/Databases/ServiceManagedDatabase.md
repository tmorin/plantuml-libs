...
```text
azure/Item/Databases/ServiceManagedDatabase
```

```text
include('azure/Item/Databases/ServiceManagedDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceManagedDatabase.png) | ![illustration for ServiceManagedDatabase](../../../azure/Item/Databases/ServiceManagedDatabase.Local.png) | ![illustration for ServiceManagedDatabaseCard](../../../azure/Item/Databases/ServiceManagedDatabaseCard.Local.png) | ![illustration for ServiceManagedDatabaseGroup](../../../azure/Item/Databases/ServiceManagedDatabaseGroup.Local.png) |
