...
```text
azure/Item/Databases/ServiceElasticJobAgents
```

```text
include('azure/Item/Databases/ServiceElasticJobAgents')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceElasticJobAgents.png) | ![illustration for ServiceElasticJobAgents](../../../azure/Item/Databases/ServiceElasticJobAgents.Local.png) | ![illustration for ServiceElasticJobAgentsCard](../../../azure/Item/Databases/ServiceElasticJobAgentsCard.Local.png) | ![illustration for ServiceElasticJobAgentsGroup](../../../azure/Item/Databases/ServiceElasticJobAgentsGroup.Local.png) |
