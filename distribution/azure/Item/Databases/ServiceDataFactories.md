...
```text
azure/Item/Databases/ServiceDataFactories
```

```text
include('azure/Item/Databases/ServiceDataFactories')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceDataFactories.png) | ![illustration for ServiceDataFactories](../../../azure/Item/Databases/ServiceDataFactories.Local.png) | ![illustration for ServiceDataFactoriesCard](../../../azure/Item/Databases/ServiceDataFactoriesCard.Local.png) | ![illustration for ServiceDataFactoriesGroup](../../../azure/Item/Databases/ServiceDataFactoriesGroup.Local.png) |
