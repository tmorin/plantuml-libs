...
```text
azure/Item/Databases/ServiceCacheRedis
```

```text
include('azure/Item/Databases/ServiceCacheRedis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceCacheRedis.png) | ![illustration for ServiceCacheRedis](../../../azure/Item/Databases/ServiceCacheRedis.Local.png) | ![illustration for ServiceCacheRedisCard](../../../azure/Item/Databases/ServiceCacheRedisCard.Local.png) | ![illustration for ServiceCacheRedisGroup](../../../azure/Item/Databases/ServiceCacheRedisGroup.Local.png) |
