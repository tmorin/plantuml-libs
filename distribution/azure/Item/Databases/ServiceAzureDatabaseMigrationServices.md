...
```text
azure/Item/Databases/ServiceAzureDatabaseMigrationServices
```

```text
include('azure/Item/Databases/ServiceAzureDatabaseMigrationServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceAzureDatabaseMigrationServices.png) | ![illustration for ServiceAzureDatabaseMigrationServices](../../../azure/Item/Databases/ServiceAzureDatabaseMigrationServices.Local.png) | ![illustration for ServiceAzureDatabaseMigrationServicesCard](../../../azure/Item/Databases/ServiceAzureDatabaseMigrationServicesCard.Local.png) | ![illustration for ServiceAzureDatabaseMigrationServicesGroup](../../../azure/Item/Databases/ServiceAzureDatabaseMigrationServicesGroup.Local.png) |
