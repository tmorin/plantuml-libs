...
```text
azure/Item/Databases/ServiceSqlElasticPools
```

```text
include('azure/Item/Databases/ServiceSqlElasticPools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceSqlElasticPools.png) | ![illustration for ServiceSqlElasticPools](../../../azure/Item/Databases/ServiceSqlElasticPools.Local.png) | ![illustration for ServiceSqlElasticPoolsCard](../../../azure/Item/Databases/ServiceSqlElasticPoolsCard.Local.png) | ![illustration for ServiceSqlElasticPoolsGroup](../../../azure/Item/Databases/ServiceSqlElasticPoolsGroup.Local.png) |
