...
```text
azure/Item/Databases/ServiceSqlManagedInstance
```

```text
include('azure/Item/Databases/ServiceSqlManagedInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceSqlManagedInstance.png) | ![illustration for ServiceSqlManagedInstance](../../../azure/Item/Databases/ServiceSqlManagedInstance.Local.png) | ![illustration for ServiceSqlManagedInstanceCard](../../../azure/Item/Databases/ServiceSqlManagedInstanceCard.Local.png) | ![illustration for ServiceSqlManagedInstanceGroup](../../../azure/Item/Databases/ServiceSqlManagedInstanceGroup.Local.png) |
