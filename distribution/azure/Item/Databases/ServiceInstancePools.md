...
```text
azure/Item/Databases/ServiceInstancePools
```

```text
include('azure/Item/Databases/ServiceInstancePools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Databases/ServiceInstancePools.png) | ![illustration for ServiceInstancePools](../../../azure/Item/Databases/ServiceInstancePools.Local.png) | ![illustration for ServiceInstancePoolsCard](../../../azure/Item/Databases/ServiceInstancePoolsCard.Local.png) | ![illustration for ServiceInstancePoolsGroup](../../../azure/Item/Databases/ServiceInstancePoolsGroup.Local.png) |
