...
```text
azure/Item/ManagementGovernance/ServiceMachinesAzureArc
```

```text
include('azure/Item/ManagementGovernance/ServiceMachinesAzureArc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/ManagementGovernance/ServiceMachinesAzureArc.png) | ![illustration for ServiceMachinesAzureArc](../../../azure/Item/ManagementGovernance/ServiceMachinesAzureArc.Local.png) | ![illustration for ServiceMachinesAzureArcCard](../../../azure/Item/ManagementGovernance/ServiceMachinesAzureArcCard.Local.png) | ![illustration for ServiceMachinesAzureArcGroup](../../../azure/Item/ManagementGovernance/ServiceMachinesAzureArcGroup.Local.png) |
