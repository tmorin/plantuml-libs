...
```text
azure/Item/ManagementGovernance/ServiceAlerts
```

```text
include('azure/Item/ManagementGovernance/ServiceAlerts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/ManagementGovernance/ServiceAlerts.png) | ![illustration for ServiceAlerts](../../../azure/Item/ManagementGovernance/ServiceAlerts.Local.png) | ![illustration for ServiceAlertsCard](../../../azure/Item/ManagementGovernance/ServiceAlertsCard.Local.png) | ![illustration for ServiceAlertsGroup](../../../azure/Item/ManagementGovernance/ServiceAlertsGroup.Local.png) |
