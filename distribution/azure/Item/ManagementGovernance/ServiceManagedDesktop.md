...
```text
azure/Item/ManagementGovernance/ServiceManagedDesktop
```

```text
include('azure/Item/ManagementGovernance/ServiceManagedDesktop')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/ManagementGovernance/ServiceManagedDesktop.png) | ![illustration for ServiceManagedDesktop](../../../azure/Item/ManagementGovernance/ServiceManagedDesktop.Local.png) | ![illustration for ServiceManagedDesktopCard](../../../azure/Item/ManagementGovernance/ServiceManagedDesktopCard.Local.png) | ![illustration for ServiceManagedDesktopGroup](../../../azure/Item/ManagementGovernance/ServiceManagedDesktopGroup.Local.png) |
