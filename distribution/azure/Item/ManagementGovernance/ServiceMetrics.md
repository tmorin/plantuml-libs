...
```text
azure/Item/ManagementGovernance/ServiceMetrics
```

```text
include('azure/Item/ManagementGovernance/ServiceMetrics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/ManagementGovernance/ServiceMetrics.png) | ![illustration for ServiceMetrics](../../../azure/Item/ManagementGovernance/ServiceMetrics.Local.png) | ![illustration for ServiceMetricsCard](../../../azure/Item/ManagementGovernance/ServiceMetricsCard.Local.png) | ![illustration for ServiceMetricsGroup](../../../azure/Item/ManagementGovernance/ServiceMetricsGroup.Local.png) |
