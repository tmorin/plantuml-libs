...
```text
azure/Item/ManagementGovernance/ServiceIntuneTrends
```

```text
include('azure/Item/ManagementGovernance/ServiceIntuneTrends')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/ManagementGovernance/ServiceIntuneTrends.png) | ![illustration for ServiceIntuneTrends](../../../azure/Item/ManagementGovernance/ServiceIntuneTrends.Local.png) | ![illustration for ServiceIntuneTrendsCard](../../../azure/Item/ManagementGovernance/ServiceIntuneTrendsCard.Local.png) | ![illustration for ServiceIntuneTrendsGroup](../../../azure/Item/ManagementGovernance/ServiceIntuneTrendsGroup.Local.png) |
