...
```text
azure/Item/ManagementGovernance/ServiceLogAnalyticsWorkspaces
```

```text
include('azure/Item/ManagementGovernance/ServiceLogAnalyticsWorkspaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/ManagementGovernance/ServiceLogAnalyticsWorkspaces.png) | ![illustration for ServiceLogAnalyticsWorkspaces](../../../azure/Item/ManagementGovernance/ServiceLogAnalyticsWorkspaces.Local.png) | ![illustration for ServiceLogAnalyticsWorkspacesCard](../../../azure/Item/ManagementGovernance/ServiceLogAnalyticsWorkspacesCard.Local.png) | ![illustration for ServiceLogAnalyticsWorkspacesGroup](../../../azure/Item/ManagementGovernance/ServiceLogAnalyticsWorkspacesGroup.Local.png) |
