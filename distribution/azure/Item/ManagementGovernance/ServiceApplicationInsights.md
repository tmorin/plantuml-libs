...
```text
azure/Item/ManagementGovernance/ServiceApplicationInsights
```

```text
include('azure/Item/ManagementGovernance/ServiceApplicationInsights')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/ManagementGovernance/ServiceApplicationInsights.png) | ![illustration for ServiceApplicationInsights](../../../azure/Item/ManagementGovernance/ServiceApplicationInsights.Local.png) | ![illustration for ServiceApplicationInsightsCard](../../../azure/Item/ManagementGovernance/ServiceApplicationInsightsCard.Local.png) | ![illustration for ServiceApplicationInsightsGroup](../../../azure/Item/ManagementGovernance/ServiceApplicationInsightsGroup.Local.png) |
