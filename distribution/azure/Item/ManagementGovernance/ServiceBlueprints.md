...
```text
azure/Item/ManagementGovernance/ServiceBlueprints
```

```text
include('azure/Item/ManagementGovernance/ServiceBlueprints')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/ManagementGovernance/ServiceBlueprints.png) | ![illustration for ServiceBlueprints](../../../azure/Item/ManagementGovernance/ServiceBlueprints.Local.png) | ![illustration for ServiceBlueprintsCard](../../../azure/Item/ManagementGovernance/ServiceBlueprintsCard.Local.png) | ![illustration for ServiceBlueprintsGroup](../../../azure/Item/ManagementGovernance/ServiceBlueprintsGroup.Local.png) |
