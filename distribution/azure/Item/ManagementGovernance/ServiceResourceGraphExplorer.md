...
```text
azure/Item/ManagementGovernance/ServiceResourceGraphExplorer
```

```text
include('azure/Item/ManagementGovernance/ServiceResourceGraphExplorer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/ManagementGovernance/ServiceResourceGraphExplorer.png) | ![illustration for ServiceResourceGraphExplorer](../../../azure/Item/ManagementGovernance/ServiceResourceGraphExplorer.Local.png) | ![illustration for ServiceResourceGraphExplorerCard](../../../azure/Item/ManagementGovernance/ServiceResourceGraphExplorerCard.Local.png) | ![illustration for ServiceResourceGraphExplorerGroup](../../../azure/Item/ManagementGovernance/ServiceResourceGraphExplorerGroup.Local.png) |
