...
```text
azure/Item/ManagementGovernance/ServiceActivityLog
```

```text
include('azure/Item/ManagementGovernance/ServiceActivityLog')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/ManagementGovernance/ServiceActivityLog.png) | ![illustration for ServiceActivityLog](../../../azure/Item/ManagementGovernance/ServiceActivityLog.Local.png) | ![illustration for ServiceActivityLogCard](../../../azure/Item/ManagementGovernance/ServiceActivityLogCard.Local.png) | ![illustration for ServiceActivityLogGroup](../../../azure/Item/ManagementGovernance/ServiceActivityLogGroup.Local.png) |
