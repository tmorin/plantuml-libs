...
```text
azure/Item/Containers/ServiceKubernetesServices
```

```text
include('azure/Item/Containers/ServiceKubernetesServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Containers/ServiceKubernetesServices.png) | ![illustration for ServiceKubernetesServices](../../../azure/Item/Containers/ServiceKubernetesServices.Local.png) | ![illustration for ServiceKubernetesServicesCard](../../../azure/Item/Containers/ServiceKubernetesServicesCard.Local.png) | ![illustration for ServiceKubernetesServicesGroup](../../../azure/Item/Containers/ServiceKubernetesServicesGroup.Local.png) |
