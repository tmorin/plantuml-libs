...
```text
azure/Item/Containers/ServiceAppServices
```

```text
include('azure/Item/Containers/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Containers/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure/Item/Containers/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure/Item/Containers/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure/Item/Containers/ServiceAppServicesGroup.Local.png) |
