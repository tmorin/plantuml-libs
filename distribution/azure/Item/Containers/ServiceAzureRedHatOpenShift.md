...
```text
azure/Item/Containers/ServiceAzureRedHatOpenShift
```

```text
include('azure/Item/Containers/ServiceAzureRedHatOpenShift')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Containers/ServiceAzureRedHatOpenShift.png) | ![illustration for ServiceAzureRedHatOpenShift](../../../azure/Item/Containers/ServiceAzureRedHatOpenShift.Local.png) | ![illustration for ServiceAzureRedHatOpenShiftCard](../../../azure/Item/Containers/ServiceAzureRedHatOpenShiftCard.Local.png) | ![illustration for ServiceAzureRedHatOpenShiftGroup](../../../azure/Item/Containers/ServiceAzureRedHatOpenShiftGroup.Local.png) |
