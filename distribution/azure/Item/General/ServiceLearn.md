...
```text
azure/Item/General/ServiceLearn
```

```text
include('azure/Item/General/ServiceLearn')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceLearn.png) | ![illustration for ServiceLearn](../../../azure/Item/General/ServiceLearn.Local.png) | ![illustration for ServiceLearnCard](../../../azure/Item/General/ServiceLearnCard.Local.png) | ![illustration for ServiceLearnGroup](../../../azure/Item/General/ServiceLearnGroup.Local.png) |
