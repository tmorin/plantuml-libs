...
```text
azure/Item/General/ServiceTable
```

```text
include('azure/Item/General/ServiceTable')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceTable.png) | ![illustration for ServiceTable](../../../azure/Item/General/ServiceTable.Local.png) | ![illustration for ServiceTableCard](../../../azure/Item/General/ServiceTableCard.Local.png) | ![illustration for ServiceTableGroup](../../../azure/Item/General/ServiceTableGroup.Local.png) |
