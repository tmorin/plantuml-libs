...
```text
azure/Item/General/ServiceCode
```

```text
include('azure/Item/General/ServiceCode')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceCode.png) | ![illustration for ServiceCode](../../../azure/Item/General/ServiceCode.Local.png) | ![illustration for ServiceCodeCard](../../../azure/Item/General/ServiceCodeCard.Local.png) | ![illustration for ServiceCodeGroup](../../../azure/Item/General/ServiceCodeGroup.Local.png) |
