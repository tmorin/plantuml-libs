...
```text
azure/Item/General/ServiceFolderBlank
```

```text
include('azure/Item/General/ServiceFolderBlank')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceFolderBlank.png) | ![illustration for ServiceFolderBlank](../../../azure/Item/General/ServiceFolderBlank.Local.png) | ![illustration for ServiceFolderBlankCard](../../../azure/Item/General/ServiceFolderBlankCard.Local.png) | ![illustration for ServiceFolderBlankGroup](../../../azure/Item/General/ServiceFolderBlankGroup.Local.png) |
