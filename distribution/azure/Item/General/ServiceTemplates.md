...
```text
azure/Item/General/ServiceTemplates
```

```text
include('azure/Item/General/ServiceTemplates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceTemplates.png) | ![illustration for ServiceTemplates](../../../azure/Item/General/ServiceTemplates.Local.png) | ![illustration for ServiceTemplatesCard](../../../azure/Item/General/ServiceTemplatesCard.Local.png) | ![illustration for ServiceTemplatesGroup](../../../azure/Item/General/ServiceTemplatesGroup.Local.png) |
