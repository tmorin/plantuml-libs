...
```text
azure/Item/General/ServiceSearch
```

```text
include('azure/Item/General/ServiceSearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceSearch.png) | ![illustration for ServiceSearch](../../../azure/Item/General/ServiceSearch.Local.png) | ![illustration for ServiceSearchCard](../../../azure/Item/General/ServiceSearchCard.Local.png) | ![illustration for ServiceSearchGroup](../../../azure/Item/General/ServiceSearchGroup.Local.png) |
