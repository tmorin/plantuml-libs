...
```text
azure/Item/General/ServiceCache
```

```text
include('azure/Item/General/ServiceCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceCache.png) | ![illustration for ServiceCache](../../../azure/Item/General/ServiceCache.Local.png) | ![illustration for ServiceCacheCard](../../../azure/Item/General/ServiceCacheCard.Local.png) | ![illustration for ServiceCacheGroup](../../../azure/Item/General/ServiceCacheGroup.Local.png) |
