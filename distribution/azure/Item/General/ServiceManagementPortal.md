...
```text
azure/Item/General/ServiceManagementPortal
```

```text
include('azure/Item/General/ServiceManagementPortal')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceManagementPortal.png) | ![illustration for ServiceManagementPortal](../../../azure/Item/General/ServiceManagementPortal.Local.png) | ![illustration for ServiceManagementPortalCard](../../../azure/Item/General/ServiceManagementPortalCard.Local.png) | ![illustration for ServiceManagementPortalGroup](../../../azure/Item/General/ServiceManagementPortalGroup.Local.png) |
