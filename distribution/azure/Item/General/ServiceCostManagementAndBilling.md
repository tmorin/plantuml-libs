...
```text
azure/Item/General/ServiceCostManagementAndBilling
```

```text
include('azure/Item/General/ServiceCostManagementAndBilling')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceCostManagementAndBilling.png) | ![illustration for ServiceCostManagementAndBilling](../../../azure/Item/General/ServiceCostManagementAndBilling.Local.png) | ![illustration for ServiceCostManagementAndBillingCard](../../../azure/Item/General/ServiceCostManagementAndBillingCard.Local.png) | ![illustration for ServiceCostManagementAndBillingGroup](../../../azure/Item/General/ServiceCostManagementAndBillingGroup.Local.png) |
