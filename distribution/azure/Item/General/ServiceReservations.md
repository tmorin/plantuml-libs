...
```text
azure/Item/General/ServiceReservations
```

```text
include('azure/Item/General/ServiceReservations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceReservations.png) | ![illustration for ServiceReservations](../../../azure/Item/General/ServiceReservations.Local.png) | ![illustration for ServiceReservationsCard](../../../azure/Item/General/ServiceReservationsCard.Local.png) | ![illustration for ServiceReservationsGroup](../../../azure/Item/General/ServiceReservationsGroup.Local.png) |
