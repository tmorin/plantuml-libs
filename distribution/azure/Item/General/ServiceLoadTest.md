...
```text
azure/Item/General/ServiceLoadTest
```

```text
include('azure/Item/General/ServiceLoadTest')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceLoadTest.png) | ![illustration for ServiceLoadTest](../../../azure/Item/General/ServiceLoadTest.Local.png) | ![illustration for ServiceLoadTestCard](../../../azure/Item/General/ServiceLoadTestCard.Local.png) | ![illustration for ServiceLoadTestGroup](../../../azure/Item/General/ServiceLoadTestGroup.Local.png) |
