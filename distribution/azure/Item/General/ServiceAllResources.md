...
```text
azure/Item/General/ServiceAllResources
```

```text
include('azure/Item/General/ServiceAllResources')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceAllResources.png) | ![illustration for ServiceAllResources](../../../azure/Item/General/ServiceAllResources.Local.png) | ![illustration for ServiceAllResourcesCard](../../../azure/Item/General/ServiceAllResourcesCard.Local.png) | ![illustration for ServiceAllResourcesGroup](../../../azure/Item/General/ServiceAllResourcesGroup.Local.png) |
