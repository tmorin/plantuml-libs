...
```text
azure/Item/General/ServiceCostAnalysis
```

```text
include('azure/Item/General/ServiceCostAnalysis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceCostAnalysis.png) | ![illustration for ServiceCostAnalysis](../../../azure/Item/General/ServiceCostAnalysis.Local.png) | ![illustration for ServiceCostAnalysisCard](../../../azure/Item/General/ServiceCostAnalysisCard.Local.png) | ![illustration for ServiceCostAnalysisGroup](../../../azure/Item/General/ServiceCostAnalysisGroup.Local.png) |
