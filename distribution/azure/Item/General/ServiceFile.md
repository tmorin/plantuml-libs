...
```text
azure/Item/General/ServiceFile
```

```text
include('azure/Item/General/ServiceFile')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceFile.png) | ![illustration for ServiceFile](../../../azure/Item/General/ServiceFile.Local.png) | ![illustration for ServiceFileCard](../../../azure/Item/General/ServiceFileCard.Local.png) | ![illustration for ServiceFileGroup](../../../azure/Item/General/ServiceFileGroup.Local.png) |
