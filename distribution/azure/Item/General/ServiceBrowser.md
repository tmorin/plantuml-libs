...
```text
azure/Item/General/ServiceBrowser
```

```text
include('azure/Item/General/ServiceBrowser')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceBrowser.png) | ![illustration for ServiceBrowser](../../../azure/Item/General/ServiceBrowser.Local.png) | ![illustration for ServiceBrowserCard](../../../azure/Item/General/ServiceBrowserCard.Local.png) | ![illustration for ServiceBrowserGroup](../../../azure/Item/General/ServiceBrowserGroup.Local.png) |
