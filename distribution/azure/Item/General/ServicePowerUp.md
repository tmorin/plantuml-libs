...
```text
azure/Item/General/ServicePowerUp
```

```text
include('azure/Item/General/ServicePowerUp')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServicePowerUp.png) | ![illustration for ServicePowerUp](../../../azure/Item/General/ServicePowerUp.Local.png) | ![illustration for ServicePowerUpCard](../../../azure/Item/General/ServicePowerUpCard.Local.png) | ![illustration for ServicePowerUpGroup](../../../azure/Item/General/ServicePowerUpGroup.Local.png) |
