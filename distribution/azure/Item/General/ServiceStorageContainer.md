...
```text
azure/Item/General/ServiceStorageContainer
```

```text
include('azure/Item/General/ServiceStorageContainer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceStorageContainer.png) | ![illustration for ServiceStorageContainer](../../../azure/Item/General/ServiceStorageContainer.Local.png) | ![illustration for ServiceStorageContainerCard](../../../azure/Item/General/ServiceStorageContainerCard.Local.png) | ![illustration for ServiceStorageContainerGroup](../../../azure/Item/General/ServiceStorageContainerGroup.Local.png) |
