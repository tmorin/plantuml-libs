...
```text
azure/Item/General/ServiceGear
```

```text
include('azure/Item/General/ServiceGear')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceGear.png) | ![illustration for ServiceGear](../../../azure/Item/General/ServiceGear.Local.png) | ![illustration for ServiceGearCard](../../../azure/Item/General/ServiceGearCard.Local.png) | ![illustration for ServiceGearGroup](../../../azure/Item/General/ServiceGearGroup.Local.png) |
