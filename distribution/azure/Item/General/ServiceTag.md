...
```text
azure/Item/General/ServiceTag
```

```text
include('azure/Item/General/ServiceTag')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceTag.png) | ![illustration for ServiceTag](../../../azure/Item/General/ServiceTag.Local.png) | ![illustration for ServiceTagCard](../../../azure/Item/General/ServiceTagCard.Local.png) | ![illustration for ServiceTagGroup](../../../azure/Item/General/ServiceTagGroup.Local.png) |
