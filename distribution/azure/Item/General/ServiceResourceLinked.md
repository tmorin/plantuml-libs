...
```text
azure/Item/General/ServiceResourceLinked
```

```text
include('azure/Item/General/ServiceResourceLinked')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceResourceLinked.png) | ![illustration for ServiceResourceLinked](../../../azure/Item/General/ServiceResourceLinked.Local.png) | ![illustration for ServiceResourceLinkedCard](../../../azure/Item/General/ServiceResourceLinkedCard.Local.png) | ![illustration for ServiceResourceLinkedGroup](../../../azure/Item/General/ServiceResourceLinkedGroup.Local.png) |
