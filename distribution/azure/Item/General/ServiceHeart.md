...
```text
azure/Item/General/ServiceHeart
```

```text
include('azure/Item/General/ServiceHeart')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceHeart.png) | ![illustration for ServiceHeart](../../../azure/Item/General/ServiceHeart.Local.png) | ![illustration for ServiceHeartCard](../../../azure/Item/General/ServiceHeartCard.Local.png) | ![illustration for ServiceHeartGroup](../../../azure/Item/General/ServiceHeartGroup.Local.png) |
