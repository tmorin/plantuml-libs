...
```text
azure/Item/General/ServiceBlobBlock
```

```text
include('azure/Item/General/ServiceBlobBlock')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceBlobBlock.png) | ![illustration for ServiceBlobBlock](../../../azure/Item/General/ServiceBlobBlock.Local.png) | ![illustration for ServiceBlobBlockCard](../../../azure/Item/General/ServiceBlobBlockCard.Local.png) | ![illustration for ServiceBlobBlockGroup](../../../azure/Item/General/ServiceBlobBlockGroup.Local.png) |
