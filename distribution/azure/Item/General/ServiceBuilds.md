...
```text
azure/Item/General/ServiceBuilds
```

```text
include('azure/Item/General/ServiceBuilds')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceBuilds.png) | ![illustration for ServiceBuilds](../../../azure/Item/General/ServiceBuilds.Local.png) | ![illustration for ServiceBuildsCard](../../../azure/Item/General/ServiceBuildsCard.Local.png) | ![illustration for ServiceBuildsGroup](../../../azure/Item/General/ServiceBuildsGroup.Local.png) |
