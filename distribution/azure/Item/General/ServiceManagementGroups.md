...
```text
azure/Item/General/ServiceManagementGroups
```

```text
include('azure/Item/General/ServiceManagementGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceManagementGroups.png) | ![illustration for ServiceManagementGroups](../../../azure/Item/General/ServiceManagementGroups.Local.png) | ![illustration for ServiceManagementGroupsCard](../../../azure/Item/General/ServiceManagementGroupsCard.Local.png) | ![illustration for ServiceManagementGroupsGroup](../../../azure/Item/General/ServiceManagementGroupsGroup.Local.png) |
