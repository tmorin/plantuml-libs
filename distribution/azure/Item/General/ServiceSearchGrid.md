...
```text
azure/Item/General/ServiceSearchGrid
```

```text
include('azure/Item/General/ServiceSearchGrid')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceSearchGrid.png) | ![illustration for ServiceSearchGrid](../../../azure/Item/General/ServiceSearchGrid.Local.png) | ![illustration for ServiceSearchGridCard](../../../azure/Item/General/ServiceSearchGridCard.Local.png) | ![illustration for ServiceSearchGridGroup](../../../azure/Item/General/ServiceSearchGridGroup.Local.png) |
