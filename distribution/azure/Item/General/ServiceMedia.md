...
```text
azure/Item/General/ServiceMedia
```

```text
include('azure/Item/General/ServiceMedia')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceMedia.png) | ![illustration for ServiceMedia](../../../azure/Item/General/ServiceMedia.Local.png) | ![illustration for ServiceMediaCard](../../../azure/Item/General/ServiceMediaCard.Local.png) | ![illustration for ServiceMediaGroup](../../../azure/Item/General/ServiceMediaGroup.Local.png) |
