...
```text
azure/Item/General/ServiceDevConsole
```

```text
include('azure/Item/General/ServiceDevConsole')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceDevConsole.png) | ![illustration for ServiceDevConsole](../../../azure/Item/General/ServiceDevConsole.Local.png) | ![illustration for ServiceDevConsoleCard](../../../azure/Item/General/ServiceDevConsoleCard.Local.png) | ![illustration for ServiceDevConsoleGroup](../../../azure/Item/General/ServiceDevConsoleGroup.Local.png) |
