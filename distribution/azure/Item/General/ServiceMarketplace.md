...
```text
azure/Item/General/ServiceMarketplace
```

```text
include('azure/Item/General/ServiceMarketplace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceMarketplace.png) | ![illustration for ServiceMarketplace](../../../azure/Item/General/ServiceMarketplace.Local.png) | ![illustration for ServiceMarketplaceCard](../../../azure/Item/General/ServiceMarketplaceCard.Local.png) | ![illustration for ServiceMarketplaceGroup](../../../azure/Item/General/ServiceMarketplaceGroup.Local.png) |
