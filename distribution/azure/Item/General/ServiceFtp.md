...
```text
azure/Item/General/ServiceFtp
```

```text
include('azure/Item/General/ServiceFtp')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceFtp.png) | ![illustration for ServiceFtp](../../../azure/Item/General/ServiceFtp.Local.png) | ![illustration for ServiceFtpCard](../../../azure/Item/General/ServiceFtpCard.Local.png) | ![illustration for ServiceFtpGroup](../../../azure/Item/General/ServiceFtpGroup.Local.png) |
