...
```text
azure/Item/General/ServiceGuide
```

```text
include('azure/Item/General/ServiceGuide')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceGuide.png) | ![illustration for ServiceGuide](../../../azure/Item/General/ServiceGuide.Local.png) | ![illustration for ServiceGuideCard](../../../azure/Item/General/ServiceGuideCard.Local.png) | ![illustration for ServiceGuideGroup](../../../azure/Item/General/ServiceGuideGroup.Local.png) |
