...
```text
azure/Item/General/ServicePower
```

```text
include('azure/Item/General/ServicePower')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServicePower.png) | ![illustration for ServicePower](../../../azure/Item/General/ServicePower.Local.png) | ![illustration for ServicePowerCard](../../../azure/Item/General/ServicePowerCard.Local.png) | ![illustration for ServicePowerGroup](../../../azure/Item/General/ServicePowerGroup.Local.png) |
