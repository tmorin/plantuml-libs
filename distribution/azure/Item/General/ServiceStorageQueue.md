...
```text
azure/Item/General/ServiceStorageQueue
```

```text
include('azure/Item/General/ServiceStorageQueue')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceStorageQueue.png) | ![illustration for ServiceStorageQueue](../../../azure/Item/General/ServiceStorageQueue.Local.png) | ![illustration for ServiceStorageQueueCard](../../../azure/Item/General/ServiceStorageQueueCard.Local.png) | ![illustration for ServiceStorageQueueGroup](../../../azure/Item/General/ServiceStorageQueueGroup.Local.png) |
