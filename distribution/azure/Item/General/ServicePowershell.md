...
```text
azure/Item/General/ServicePowershell
```

```text
include('azure/Item/General/ServicePowershell')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServicePowershell.png) | ![illustration for ServicePowershell](../../../azure/Item/General/ServicePowershell.Local.png) | ![illustration for ServicePowershellCard](../../../azure/Item/General/ServicePowershellCard.Local.png) | ![illustration for ServicePowershellGroup](../../../azure/Item/General/ServicePowershellGroup.Local.png) |
