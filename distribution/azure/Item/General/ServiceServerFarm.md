...
```text
azure/Item/General/ServiceServerFarm
```

```text
include('azure/Item/General/ServiceServerFarm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceServerFarm.png) | ![illustration for ServiceServerFarm](../../../azure/Item/General/ServiceServerFarm.Local.png) | ![illustration for ServiceServerFarmCard](../../../azure/Item/General/ServiceServerFarmCard.Local.png) | ![illustration for ServiceServerFarmGroup](../../../azure/Item/General/ServiceServerFarmGroup.Local.png) |
