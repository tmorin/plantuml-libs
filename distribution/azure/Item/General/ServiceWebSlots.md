...
```text
azure/Item/General/ServiceWebSlots
```

```text
include('azure/Item/General/ServiceWebSlots')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceWebSlots.png) | ![illustration for ServiceWebSlots](../../../azure/Item/General/ServiceWebSlots.Local.png) | ![illustration for ServiceWebSlotsCard](../../../azure/Item/General/ServiceWebSlotsCard.Local.png) | ![illustration for ServiceWebSlotsGroup](../../../azure/Item/General/ServiceWebSlotsGroup.Local.png) |
