...
```text
azure/Item/General/ServiceMarketplaceManagement
```

```text
include('azure/Item/General/ServiceMarketplaceManagement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceMarketplaceManagement.png) | ![illustration for ServiceMarketplaceManagement](../../../azure/Item/General/ServiceMarketplaceManagement.Local.png) | ![illustration for ServiceMarketplaceManagementCard](../../../azure/Item/General/ServiceMarketplaceManagementCard.Local.png) | ![illustration for ServiceMarketplaceManagementGroup](../../../azure/Item/General/ServiceMarketplaceManagementGroup.Local.png) |
