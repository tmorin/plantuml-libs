...
```text
azure/Item/General/ServiceMobileEngagement
```

```text
include('azure/Item/General/ServiceMobileEngagement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceMobileEngagement.png) | ![illustration for ServiceMobileEngagement](../../../azure/Item/General/ServiceMobileEngagement.Local.png) | ![illustration for ServiceMobileEngagementCard](../../../azure/Item/General/ServiceMobileEngagementCard.Local.png) | ![illustration for ServiceMobileEngagementGroup](../../../azure/Item/General/ServiceMobileEngagementGroup.Local.png) |
