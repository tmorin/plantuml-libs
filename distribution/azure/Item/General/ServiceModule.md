...
```text
azure/Item/General/ServiceModule
```

```text
include('azure/Item/General/ServiceModule')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceModule.png) | ![illustration for ServiceModule](../../../azure/Item/General/ServiceModule.Local.png) | ![illustration for ServiceModuleCard](../../../azure/Item/General/ServiceModuleCard.Local.png) | ![illustration for ServiceModuleGroup](../../../azure/Item/General/ServiceModuleGroup.Local.png) |
