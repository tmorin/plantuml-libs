...
```text
azure/Item/General/ServiceBlobPage
```

```text
include('azure/Item/General/ServiceBlobPage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceBlobPage.png) | ![illustration for ServiceBlobPage](../../../azure/Item/General/ServiceBlobPage.Local.png) | ![illustration for ServiceBlobPageCard](../../../azure/Item/General/ServiceBlobPageCard.Local.png) | ![illustration for ServiceBlobPageGroup](../../../azure/Item/General/ServiceBlobPageGroup.Local.png) |
