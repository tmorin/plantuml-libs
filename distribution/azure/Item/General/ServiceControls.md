...
```text
azure/Item/General/ServiceControls
```

```text
include('azure/Item/General/ServiceControls')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceControls.png) | ![illustration for ServiceControls](../../../azure/Item/General/ServiceControls.Local.png) | ![illustration for ServiceControlsCard](../../../azure/Item/General/ServiceControlsCard.Local.png) | ![illustration for ServiceControlsGroup](../../../azure/Item/General/ServiceControlsGroup.Local.png) |
