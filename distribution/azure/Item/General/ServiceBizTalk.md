...
```text
azure/Item/General/ServiceBizTalk
```

```text
include('azure/Item/General/ServiceBizTalk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceBizTalk.png) | ![illustration for ServiceBizTalk](../../../azure/Item/General/ServiceBizTalk.Local.png) | ![illustration for ServiceBizTalkCard](../../../azure/Item/General/ServiceBizTalkCard.Local.png) | ![illustration for ServiceBizTalkGroup](../../../azure/Item/General/ServiceBizTalkGroup.Local.png) |
