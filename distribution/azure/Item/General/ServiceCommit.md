...
```text
azure/Item/General/ServiceCommit
```

```text
include('azure/Item/General/ServiceCommit')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceCommit.png) | ![illustration for ServiceCommit](../../../azure/Item/General/ServiceCommit.Local.png) | ![illustration for ServiceCommitCard](../../../azure/Item/General/ServiceCommitCard.Local.png) | ![illustration for ServiceCommitGroup](../../../azure/Item/General/ServiceCommitGroup.Local.png) |
