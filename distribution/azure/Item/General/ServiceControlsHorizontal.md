...
```text
azure/Item/General/ServiceControlsHorizontal
```

```text
include('azure/Item/General/ServiceControlsHorizontal')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/General/ServiceControlsHorizontal.png) | ![illustration for ServiceControlsHorizontal](../../../azure/Item/General/ServiceControlsHorizontal.Local.png) | ![illustration for ServiceControlsHorizontalCard](../../../azure/Item/General/ServiceControlsHorizontalCard.Local.png) | ![illustration for ServiceControlsHorizontalGroup](../../../azure/Item/General/ServiceControlsHorizontalGroup.Local.png) |
