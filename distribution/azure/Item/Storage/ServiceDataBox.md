...
```text
azure/Item/Storage/ServiceDataBox
```

```text
include('azure/Item/Storage/ServiceDataBox')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Storage/ServiceDataBox.png) | ![illustration for ServiceDataBox](../../../azure/Item/Storage/ServiceDataBox.Local.png) | ![illustration for ServiceDataBoxCard](../../../azure/Item/Storage/ServiceDataBoxCard.Local.png) | ![illustration for ServiceDataBoxGroup](../../../azure/Item/Storage/ServiceDataBoxGroup.Local.png) |
