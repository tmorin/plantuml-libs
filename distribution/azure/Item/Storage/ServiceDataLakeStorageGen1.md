...
```text
azure/Item/Storage/ServiceDataLakeStorageGen1
```

```text
include('azure/Item/Storage/ServiceDataLakeStorageGen1')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Storage/ServiceDataLakeStorageGen1.png) | ![illustration for ServiceDataLakeStorageGen1](../../../azure/Item/Storage/ServiceDataLakeStorageGen1.Local.png) | ![illustration for ServiceDataLakeStorageGen1Card](../../../azure/Item/Storage/ServiceDataLakeStorageGen1Card.Local.png) | ![illustration for ServiceDataLakeStorageGen1Group](../../../azure/Item/Storage/ServiceDataLakeStorageGen1Group.Local.png) |
