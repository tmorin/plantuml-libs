...
```text
azure/Item/Storage/ServiceAzureFileshares
```

```text
include('azure/Item/Storage/ServiceAzureFileshares')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Storage/ServiceAzureFileshares.png) | ![illustration for ServiceAzureFileshares](../../../azure/Item/Storage/ServiceAzureFileshares.Local.png) | ![illustration for ServiceAzureFilesharesCard](../../../azure/Item/Storage/ServiceAzureFilesharesCard.Local.png) | ![illustration for ServiceAzureFilesharesGroup](../../../azure/Item/Storage/ServiceAzureFilesharesGroup.Local.png) |
