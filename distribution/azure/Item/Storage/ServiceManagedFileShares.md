...
```text
azure/Item/Storage/ServiceManagedFileShares
```

```text
include('azure/Item/Storage/ServiceManagedFileShares')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Storage/ServiceManagedFileShares.png) | ![illustration for ServiceManagedFileShares](../../../azure/Item/Storage/ServiceManagedFileShares.Local.png) | ![illustration for ServiceManagedFileSharesCard](../../../azure/Item/Storage/ServiceManagedFileSharesCard.Local.png) | ![illustration for ServiceManagedFileSharesGroup](../../../azure/Item/Storage/ServiceManagedFileSharesGroup.Local.png) |
