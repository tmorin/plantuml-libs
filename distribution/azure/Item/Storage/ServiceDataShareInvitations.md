...
```text
azure/Item/Storage/ServiceDataShareInvitations
```

```text
include('azure/Item/Storage/ServiceDataShareInvitations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Storage/ServiceDataShareInvitations.png) | ![illustration for ServiceDataShareInvitations](../../../azure/Item/Storage/ServiceDataShareInvitations.Local.png) | ![illustration for ServiceDataShareInvitationsCard](../../../azure/Item/Storage/ServiceDataShareInvitationsCard.Local.png) | ![illustration for ServiceDataShareInvitationsGroup](../../../azure/Item/Storage/ServiceDataShareInvitationsGroup.Local.png) |
