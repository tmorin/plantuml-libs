...
```text
azure/Item/HybridMulticloud/ServiceAzureMonitorPipeline
```

```text
include('azure/Item/HybridMulticloud/ServiceAzureMonitorPipeline')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/HybridMulticloud/ServiceAzureMonitorPipeline.png) | ![illustration for ServiceAzureMonitorPipeline](../../../azure/Item/HybridMulticloud/ServiceAzureMonitorPipeline.Local.png) | ![illustration for ServiceAzureMonitorPipelineCard](../../../azure/Item/HybridMulticloud/ServiceAzureMonitorPipelineCard.Local.png) | ![illustration for ServiceAzureMonitorPipelineGroup](../../../azure/Item/HybridMulticloud/ServiceAzureMonitorPipelineGroup.Local.png) |
