...
```text
azure/Item/HybridMulticloud/ServiceAzureOperatorInsights
```

```text
include('azure/Item/HybridMulticloud/ServiceAzureOperatorInsights')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/HybridMulticloud/ServiceAzureOperatorInsights.png) | ![illustration for ServiceAzureOperatorInsights](../../../azure/Item/HybridMulticloud/ServiceAzureOperatorInsights.Local.png) | ![illustration for ServiceAzureOperatorInsightsCard](../../../azure/Item/HybridMulticloud/ServiceAzureOperatorInsightsCard.Local.png) | ![illustration for ServiceAzureOperatorInsightsGroup](../../../azure/Item/HybridMulticloud/ServiceAzureOperatorInsightsGroup.Local.png) |
