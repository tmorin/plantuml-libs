...
```text
azure/Item/Iot/ServiceAzureStack
```

```text
include('azure/Item/Iot/ServiceAzureStack')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceAzureStack.png) | ![illustration for ServiceAzureStack](../../../azure/Item/Iot/ServiceAzureStack.Local.png) | ![illustration for ServiceAzureStackCard](../../../azure/Item/Iot/ServiceAzureStackCard.Local.png) | ![illustration for ServiceAzureStackGroup](../../../azure/Item/Iot/ServiceAzureStackGroup.Local.png) |
