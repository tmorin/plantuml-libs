...
```text
azure/Item/Iot/ServiceIoTCentralApplications
```

```text
include('azure/Item/Iot/ServiceIoTCentralApplications')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceIoTCentralApplications.png) | ![illustration for ServiceIoTCentralApplications](../../../azure/Item/Iot/ServiceIoTCentralApplications.Local.png) | ![illustration for ServiceIoTCentralApplicationsCard](../../../azure/Item/Iot/ServiceIoTCentralApplicationsCard.Local.png) | ![illustration for ServiceIoTCentralApplicationsGroup](../../../azure/Item/Iot/ServiceIoTCentralApplicationsGroup.Local.png) |
