...
```text
azure/Item/Iot/ServiceIndustrialIoT
```

```text
include('azure/Item/Iot/ServiceIndustrialIoT')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceIndustrialIoT.png) | ![illustration for ServiceIndustrialIoT](../../../azure/Item/Iot/ServiceIndustrialIoT.Local.png) | ![illustration for ServiceIndustrialIoTCard](../../../azure/Item/Iot/ServiceIndustrialIoTCard.Local.png) | ![illustration for ServiceIndustrialIoTGroup](../../../azure/Item/Iot/ServiceIndustrialIoTGroup.Local.png) |
