...
```text
azure/Item/Iot/ServiceNotificationHubNamespaces
```

```text
include('azure/Item/Iot/ServiceNotificationHubNamespaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceNotificationHubNamespaces.png) | ![illustration for ServiceNotificationHubNamespaces](../../../azure/Item/Iot/ServiceNotificationHubNamespaces.Local.png) | ![illustration for ServiceNotificationHubNamespacesCard](../../../azure/Item/Iot/ServiceNotificationHubNamespacesCard.Local.png) | ![illustration for ServiceNotificationHubNamespacesGroup](../../../azure/Item/Iot/ServiceNotificationHubNamespacesGroup.Local.png) |
