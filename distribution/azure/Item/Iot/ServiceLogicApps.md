...
```text
azure/Item/Iot/ServiceLogicApps
```

```text
include('azure/Item/Iot/ServiceLogicApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceLogicApps.png) | ![illustration for ServiceLogicApps](../../../azure/Item/Iot/ServiceLogicApps.Local.png) | ![illustration for ServiceLogicAppsCard](../../../azure/Item/Iot/ServiceLogicAppsCard.Local.png) | ![illustration for ServiceLogicAppsGroup](../../../azure/Item/Iot/ServiceLogicAppsGroup.Local.png) |
