...
```text
azure/Item/Iot/ServiceEventHubs
```

```text
include('azure/Item/Iot/ServiceEventHubs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceEventHubs.png) | ![illustration for ServiceEventHubs](../../../azure/Item/Iot/ServiceEventHubs.Local.png) | ![illustration for ServiceEventHubsCard](../../../azure/Item/Iot/ServiceEventHubsCard.Local.png) | ![illustration for ServiceEventHubsGroup](../../../azure/Item/Iot/ServiceEventHubsGroup.Local.png) |
