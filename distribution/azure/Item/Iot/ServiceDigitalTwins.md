...
```text
azure/Item/Iot/ServiceDigitalTwins
```

```text
include('azure/Item/Iot/ServiceDigitalTwins')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceDigitalTwins.png) | ![illustration for ServiceDigitalTwins](../../../azure/Item/Iot/ServiceDigitalTwins.Local.png) | ![illustration for ServiceDigitalTwinsCard](../../../azure/Item/Iot/ServiceDigitalTwinsCard.Local.png) | ![illustration for ServiceDigitalTwinsGroup](../../../azure/Item/Iot/ServiceDigitalTwinsGroup.Local.png) |
