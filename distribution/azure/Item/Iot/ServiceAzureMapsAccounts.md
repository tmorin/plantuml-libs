...
```text
azure/Item/Iot/ServiceAzureMapsAccounts
```

```text
include('azure/Item/Iot/ServiceAzureMapsAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceAzureMapsAccounts.png) | ![illustration for ServiceAzureMapsAccounts](../../../azure/Item/Iot/ServiceAzureMapsAccounts.Local.png) | ![illustration for ServiceAzureMapsAccountsCard](../../../azure/Item/Iot/ServiceAzureMapsAccountsCard.Local.png) | ![illustration for ServiceAzureMapsAccountsGroup](../../../azure/Item/Iot/ServiceAzureMapsAccountsGroup.Local.png) |
