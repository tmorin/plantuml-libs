...
```text
azure/Item/Iot/ServiceEventHubClusters
```

```text
include('azure/Item/Iot/ServiceEventHubClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceEventHubClusters.png) | ![illustration for ServiceEventHubClusters](../../../azure/Item/Iot/ServiceEventHubClusters.Local.png) | ![illustration for ServiceEventHubClustersCard](../../../azure/Item/Iot/ServiceEventHubClustersCard.Local.png) | ![illustration for ServiceEventHubClustersGroup](../../../azure/Item/Iot/ServiceEventHubClustersGroup.Local.png) |
