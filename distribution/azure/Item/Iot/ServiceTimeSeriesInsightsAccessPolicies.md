...
```text
azure/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies
```

```text
include('azure/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies.png) | ![illustration for ServiceTimeSeriesInsightsAccessPolicies](../../../azure/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies.Local.png) | ![illustration for ServiceTimeSeriesInsightsAccessPoliciesCard](../../../azure/Item/Iot/ServiceTimeSeriesInsightsAccessPoliciesCard.Local.png) | ![illustration for ServiceTimeSeriesInsightsAccessPoliciesGroup](../../../azure/Item/Iot/ServiceTimeSeriesInsightsAccessPoliciesGroup.Local.png) |
