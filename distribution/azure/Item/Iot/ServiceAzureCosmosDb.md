...
```text
azure/Item/Iot/ServiceAzureCosmosDb
```

```text
include('azure/Item/Iot/ServiceAzureCosmosDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceAzureCosmosDb.png) | ![illustration for ServiceAzureCosmosDb](../../../azure/Item/Iot/ServiceAzureCosmosDb.Local.png) | ![illustration for ServiceAzureCosmosDbCard](../../../azure/Item/Iot/ServiceAzureCosmosDbCard.Local.png) | ![illustration for ServiceAzureCosmosDbGroup](../../../azure/Item/Iot/ServiceAzureCosmosDbGroup.Local.png) |
