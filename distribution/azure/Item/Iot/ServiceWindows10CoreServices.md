...
```text
azure/Item/Iot/ServiceWindows10CoreServices
```

```text
include('azure/Item/Iot/ServiceWindows10CoreServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceWindows10CoreServices.png) | ![illustration for ServiceWindows10CoreServices](../../../azure/Item/Iot/ServiceWindows10CoreServices.Local.png) | ![illustration for ServiceWindows10CoreServicesCard](../../../azure/Item/Iot/ServiceWindows10CoreServicesCard.Local.png) | ![illustration for ServiceWindows10CoreServicesGroup](../../../azure/Item/Iot/ServiceWindows10CoreServicesGroup.Local.png) |
