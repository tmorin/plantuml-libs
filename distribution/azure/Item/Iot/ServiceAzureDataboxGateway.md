...
```text
azure/Item/Iot/ServiceAzureDataboxGateway
```

```text
include('azure/Item/Iot/ServiceAzureDataboxGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceAzureDataboxGateway.png) | ![illustration for ServiceAzureDataboxGateway](../../../azure/Item/Iot/ServiceAzureDataboxGateway.Local.png) | ![illustration for ServiceAzureDataboxGatewayCard](../../../azure/Item/Iot/ServiceAzureDataboxGatewayCard.Local.png) | ![illustration for ServiceAzureDataboxGatewayGroup](../../../azure/Item/Iot/ServiceAzureDataboxGatewayGroup.Local.png) |
