...
```text
azure/Item/Iot/ServiceAzureIoTOperations
```

```text
include('azure/Item/Iot/ServiceAzureIoTOperations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Iot/ServiceAzureIoTOperations.png) | ![illustration for ServiceAzureIoTOperations](../../../azure/Item/Iot/ServiceAzureIoTOperations.Local.png) | ![illustration for ServiceAzureIoTOperationsCard](../../../azure/Item/Iot/ServiceAzureIoTOperationsCard.Local.png) | ![illustration for ServiceAzureIoTOperationsGroup](../../../azure/Item/Iot/ServiceAzureIoTOperationsGroup.Local.png) |
