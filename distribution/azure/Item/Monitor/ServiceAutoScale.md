...
```text
azure/Item/Monitor/ServiceAutoScale
```

```text
include('azure/Item/Monitor/ServiceAutoScale')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Monitor/ServiceAutoScale.png) | ![illustration for ServiceAutoScale](../../../azure/Item/Monitor/ServiceAutoScale.Local.png) | ![illustration for ServiceAutoScaleCard](../../../azure/Item/Monitor/ServiceAutoScaleCard.Local.png) | ![illustration for ServiceAutoScaleGroup](../../../azure/Item/Monitor/ServiceAutoScaleGroup.Local.png) |
