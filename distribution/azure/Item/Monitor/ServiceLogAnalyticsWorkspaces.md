...
```text
azure/Item/Monitor/ServiceLogAnalyticsWorkspaces
```

```text
include('azure/Item/Monitor/ServiceLogAnalyticsWorkspaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Monitor/ServiceLogAnalyticsWorkspaces.png) | ![illustration for ServiceLogAnalyticsWorkspaces](../../../azure/Item/Monitor/ServiceLogAnalyticsWorkspaces.Local.png) | ![illustration for ServiceLogAnalyticsWorkspacesCard](../../../azure/Item/Monitor/ServiceLogAnalyticsWorkspacesCard.Local.png) | ![illustration for ServiceLogAnalyticsWorkspacesGroup](../../../azure/Item/Monitor/ServiceLogAnalyticsWorkspacesGroup.Local.png) |
