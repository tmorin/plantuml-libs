...
```text
azure/Item/Monitor/ServiceMonitor
```

```text
include('azure/Item/Monitor/ServiceMonitor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Monitor/ServiceMonitor.png) | ![illustration for ServiceMonitor](../../../azure/Item/Monitor/ServiceMonitor.Local.png) | ![illustration for ServiceMonitorCard](../../../azure/Item/Monitor/ServiceMonitorCard.Local.png) | ![illustration for ServiceMonitorGroup](../../../azure/Item/Monitor/ServiceMonitorGroup.Local.png) |
