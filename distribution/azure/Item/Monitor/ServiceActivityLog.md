...
```text
azure/Item/Monitor/ServiceActivityLog
```

```text
include('azure/Item/Monitor/ServiceActivityLog')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Monitor/ServiceActivityLog.png) | ![illustration for ServiceActivityLog](../../../azure/Item/Monitor/ServiceActivityLog.Local.png) | ![illustration for ServiceActivityLogCard](../../../azure/Item/Monitor/ServiceActivityLogCard.Local.png) | ![illustration for ServiceActivityLogGroup](../../../azure/Item/Monitor/ServiceActivityLogGroup.Local.png) |
