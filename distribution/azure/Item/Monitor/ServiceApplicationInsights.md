...
```text
azure/Item/Monitor/ServiceApplicationInsights
```

```text
include('azure/Item/Monitor/ServiceApplicationInsights')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Monitor/ServiceApplicationInsights.png) | ![illustration for ServiceApplicationInsights](../../../azure/Item/Monitor/ServiceApplicationInsights.Local.png) | ![illustration for ServiceApplicationInsightsCard](../../../azure/Item/Monitor/ServiceApplicationInsightsCard.Local.png) | ![illustration for ServiceApplicationInsightsGroup](../../../azure/Item/Monitor/ServiceApplicationInsightsGroup.Local.png) |
