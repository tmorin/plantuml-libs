...
```text
azure/Item/AzureStack/ServiceUserSubscriptions
```

```text
include('azure/Item/AzureStack/ServiceUserSubscriptions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AzureStack/ServiceUserSubscriptions.png) | ![illustration for ServiceUserSubscriptions](../../../azure/Item/AzureStack/ServiceUserSubscriptions.Local.png) | ![illustration for ServiceUserSubscriptionsCard](../../../azure/Item/AzureStack/ServiceUserSubscriptionsCard.Local.png) | ![illustration for ServiceUserSubscriptionsGroup](../../../azure/Item/AzureStack/ServiceUserSubscriptionsGroup.Local.png) |
