...
```text
azure/Item/AzureStack/ServiceUpdates
```

```text
include('azure/Item/AzureStack/ServiceUpdates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AzureStack/ServiceUpdates.png) | ![illustration for ServiceUpdates](../../../azure/Item/AzureStack/ServiceUpdates.Local.png) | ![illustration for ServiceUpdatesCard](../../../azure/Item/AzureStack/ServiceUpdatesCard.Local.png) | ![illustration for ServiceUpdatesGroup](../../../azure/Item/AzureStack/ServiceUpdatesGroup.Local.png) |
