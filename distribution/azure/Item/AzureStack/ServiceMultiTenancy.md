...
```text
azure/Item/AzureStack/ServiceMultiTenancy
```

```text
include('azure/Item/AzureStack/ServiceMultiTenancy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AzureStack/ServiceMultiTenancy.png) | ![illustration for ServiceMultiTenancy](../../../azure/Item/AzureStack/ServiceMultiTenancy.Local.png) | ![illustration for ServiceMultiTenancyCard](../../../azure/Item/AzureStack/ServiceMultiTenancyCard.Local.png) | ![illustration for ServiceMultiTenancyGroup](../../../azure/Item/AzureStack/ServiceMultiTenancyGroup.Local.png) |
