...
```text
azure/Item/AppServices/ServiceCdnProfiles
```

```text
include('azure/Item/AppServices/ServiceCdnProfiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AppServices/ServiceCdnProfiles.png) | ![illustration for ServiceCdnProfiles](../../../azure/Item/AppServices/ServiceCdnProfiles.Local.png) | ![illustration for ServiceCdnProfilesCard](../../../azure/Item/AppServices/ServiceCdnProfilesCard.Local.png) | ![illustration for ServiceCdnProfilesGroup](../../../azure/Item/AppServices/ServiceCdnProfilesGroup.Local.png) |
