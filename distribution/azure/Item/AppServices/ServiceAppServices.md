...
```text
azure/Item/AppServices/ServiceAppServices
```

```text
include('azure/Item/AppServices/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AppServices/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure/Item/AppServices/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure/Item/AppServices/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure/Item/AppServices/ServiceAppServicesGroup.Local.png) |
