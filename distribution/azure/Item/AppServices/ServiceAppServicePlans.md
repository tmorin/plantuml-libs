...
```text
azure/Item/AppServices/ServiceAppServicePlans
```

```text
include('azure/Item/AppServices/ServiceAppServicePlans')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AppServices/ServiceAppServicePlans.png) | ![illustration for ServiceAppServicePlans](../../../azure/Item/AppServices/ServiceAppServicePlans.Local.png) | ![illustration for ServiceAppServicePlansCard](../../../azure/Item/AppServices/ServiceAppServicePlansCard.Local.png) | ![illustration for ServiceAppServicePlansGroup](../../../azure/Item/AppServices/ServiceAppServicePlansGroup.Local.png) |
