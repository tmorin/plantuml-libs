...
```text
azure/Item/AppServices/ServiceAppServiceDomains
```

```text
include('azure/Item/AppServices/ServiceAppServiceDomains')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/AppServices/ServiceAppServiceDomains.png) | ![illustration for ServiceAppServiceDomains](../../../azure/Item/AppServices/ServiceAppServiceDomains.Local.png) | ![illustration for ServiceAppServiceDomainsCard](../../../azure/Item/AppServices/ServiceAppServiceDomainsCard.Local.png) | ![illustration for ServiceAppServiceDomainsGroup](../../../azure/Item/AppServices/ServiceAppServiceDomainsGroup.Local.png) |
