...
```text
azure/Item/Networking/ServiceApplicationGatewayContainers
```

```text
include('azure/Item/Networking/ServiceApplicationGatewayContainers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceApplicationGatewayContainers.png) | ![illustration for ServiceApplicationGatewayContainers](../../../azure/Item/Networking/ServiceApplicationGatewayContainers.Local.png) | ![illustration for ServiceApplicationGatewayContainersCard](../../../azure/Item/Networking/ServiceApplicationGatewayContainersCard.Local.png) | ![illustration for ServiceApplicationGatewayContainersGroup](../../../azure/Item/Networking/ServiceApplicationGatewayContainersGroup.Local.png) |
