...
```text
azure/Item/Networking/ServiceTrafficManagerProfiles
```

```text
include('azure/Item/Networking/ServiceTrafficManagerProfiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceTrafficManagerProfiles.png) | ![illustration for ServiceTrafficManagerProfiles](../../../azure/Item/Networking/ServiceTrafficManagerProfiles.Local.png) | ![illustration for ServiceTrafficManagerProfilesCard](../../../azure/Item/Networking/ServiceTrafficManagerProfilesCard.Local.png) | ![illustration for ServiceTrafficManagerProfilesGroup](../../../azure/Item/Networking/ServiceTrafficManagerProfilesGroup.Local.png) |
