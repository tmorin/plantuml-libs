...
```text
azure/Item/Networking/ServiceDnsMultistack
```

```text
include('azure/Item/Networking/ServiceDnsMultistack')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceDnsMultistack.png) | ![illustration for ServiceDnsMultistack](../../../azure/Item/Networking/ServiceDnsMultistack.Local.png) | ![illustration for ServiceDnsMultistackCard](../../../azure/Item/Networking/ServiceDnsMultistackCard.Local.png) | ![illustration for ServiceDnsMultistackGroup](../../../azure/Item/Networking/ServiceDnsMultistackGroup.Local.png) |
