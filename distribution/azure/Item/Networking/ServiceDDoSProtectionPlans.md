...
```text
azure/Item/Networking/ServiceDDoSProtectionPlans
```

```text
include('azure/Item/Networking/ServiceDDoSProtectionPlans')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceDDoSProtectionPlans.png) | ![illustration for ServiceDDoSProtectionPlans](../../../azure/Item/Networking/ServiceDDoSProtectionPlans.Local.png) | ![illustration for ServiceDDoSProtectionPlansCard](../../../azure/Item/Networking/ServiceDDoSProtectionPlansCard.Local.png) | ![illustration for ServiceDDoSProtectionPlansGroup](../../../azure/Item/Networking/ServiceDDoSProtectionPlansGroup.Local.png) |
