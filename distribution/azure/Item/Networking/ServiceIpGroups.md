...
```text
azure/Item/Networking/ServiceIpGroups
```

```text
include('azure/Item/Networking/ServiceIpGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceIpGroups.png) | ![illustration for ServiceIpGroups](../../../azure/Item/Networking/ServiceIpGroups.Local.png) | ![illustration for ServiceIpGroupsCard](../../../azure/Item/Networking/ServiceIpGroupsCard.Local.png) | ![illustration for ServiceIpGroupsGroup](../../../azure/Item/Networking/ServiceIpGroupsGroup.Local.png) |
