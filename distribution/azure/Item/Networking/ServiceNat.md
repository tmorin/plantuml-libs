...
```text
azure/Item/Networking/ServiceNat
```

```text
include('azure/Item/Networking/ServiceNat')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceNat.png) | ![illustration for ServiceNat](../../../azure/Item/Networking/ServiceNat.Local.png) | ![illustration for ServiceNatCard](../../../azure/Item/Networking/ServiceNatCard.Local.png) | ![illustration for ServiceNatGroup](../../../azure/Item/Networking/ServiceNatGroup.Local.png) |
