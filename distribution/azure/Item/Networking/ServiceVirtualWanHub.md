...
```text
azure/Item/Networking/ServiceVirtualWanHub
```

```text
include('azure/Item/Networking/ServiceVirtualWanHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceVirtualWanHub.png) | ![illustration for ServiceVirtualWanHub](../../../azure/Item/Networking/ServiceVirtualWanHub.Local.png) | ![illustration for ServiceVirtualWanHubCard](../../../azure/Item/Networking/ServiceVirtualWanHubCard.Local.png) | ![illustration for ServiceVirtualWanHubGroup](../../../azure/Item/Networking/ServiceVirtualWanHubGroup.Local.png) |
