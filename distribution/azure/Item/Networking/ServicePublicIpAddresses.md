...
```text
azure/Item/Networking/ServicePublicIpAddresses
```

```text
include('azure/Item/Networking/ServicePublicIpAddresses')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServicePublicIpAddresses.png) | ![illustration for ServicePublicIpAddresses](../../../azure/Item/Networking/ServicePublicIpAddresses.Local.png) | ![illustration for ServicePublicIpAddressesCard](../../../azure/Item/Networking/ServicePublicIpAddressesCard.Local.png) | ![illustration for ServicePublicIpAddressesGroup](../../../azure/Item/Networking/ServicePublicIpAddressesGroup.Local.png) |
