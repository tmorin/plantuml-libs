...
```text
azure/Item/Networking/ServiceSpotVmss
```

```text
include('azure/Item/Networking/ServiceSpotVmss')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceSpotVmss.png) | ![illustration for ServiceSpotVmss](../../../azure/Item/Networking/ServiceSpotVmss.Local.png) | ![illustration for ServiceSpotVmssCard](../../../azure/Item/Networking/ServiceSpotVmssCard.Local.png) | ![illustration for ServiceSpotVmssGroup](../../../azure/Item/Networking/ServiceSpotVmssGroup.Local.png) |
