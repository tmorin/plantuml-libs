...
```text
azure/Item/Networking/ServiceResourceManagementPrivateLink
```

```text
include('azure/Item/Networking/ServiceResourceManagementPrivateLink')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceResourceManagementPrivateLink.png) | ![illustration for ServiceResourceManagementPrivateLink](../../../azure/Item/Networking/ServiceResourceManagementPrivateLink.Local.png) | ![illustration for ServiceResourceManagementPrivateLinkCard](../../../azure/Item/Networking/ServiceResourceManagementPrivateLinkCard.Local.png) | ![illustration for ServiceResourceManagementPrivateLinkGroup](../../../azure/Item/Networking/ServiceResourceManagementPrivateLinkGroup.Local.png) |
