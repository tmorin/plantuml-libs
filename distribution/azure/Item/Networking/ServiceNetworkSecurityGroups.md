...
```text
azure/Item/Networking/ServiceNetworkSecurityGroups
```

```text
include('azure/Item/Networking/ServiceNetworkSecurityGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceNetworkSecurityGroups.png) | ![illustration for ServiceNetworkSecurityGroups](../../../azure/Item/Networking/ServiceNetworkSecurityGroups.Local.png) | ![illustration for ServiceNetworkSecurityGroupsCard](../../../azure/Item/Networking/ServiceNetworkSecurityGroupsCard.Local.png) | ![illustration for ServiceNetworkSecurityGroupsGroup](../../../azure/Item/Networking/ServiceNetworkSecurityGroupsGroup.Local.png) |
