...
```text
azure/Item/Networking/ServiceVirtualNetworks
```

```text
include('azure/Item/Networking/ServiceVirtualNetworks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceVirtualNetworks.png) | ![illustration for ServiceVirtualNetworks](../../../azure/Item/Networking/ServiceVirtualNetworks.Local.png) | ![illustration for ServiceVirtualNetworksCard](../../../azure/Item/Networking/ServiceVirtualNetworksCard.Local.png) | ![illustration for ServiceVirtualNetworksGroup](../../../azure/Item/Networking/ServiceVirtualNetworksGroup.Local.png) |
