...
```text
azure/Item/Networking/ServiceConnections
```

```text
include('azure/Item/Networking/ServiceConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceConnections.png) | ![illustration for ServiceConnections](../../../azure/Item/Networking/ServiceConnections.Local.png) | ![illustration for ServiceConnectionsCard](../../../azure/Item/Networking/ServiceConnectionsCard.Local.png) | ![illustration for ServiceConnectionsGroup](../../../azure/Item/Networking/ServiceConnectionsGroup.Local.png) |
