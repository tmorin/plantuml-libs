...
```text
azure/Item/Networking/ServiceDnsPrivateResolver
```

```text
include('azure/Item/Networking/ServiceDnsPrivateResolver')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceDnsPrivateResolver.png) | ![illustration for ServiceDnsPrivateResolver](../../../azure/Item/Networking/ServiceDnsPrivateResolver.Local.png) | ![illustration for ServiceDnsPrivateResolverCard](../../../azure/Item/Networking/ServiceDnsPrivateResolverCard.Local.png) | ![illustration for ServiceDnsPrivateResolverGroup](../../../azure/Item/Networking/ServiceDnsPrivateResolverGroup.Local.png) |
