...
```text
azure/Item/Networking/ServicePrivateLinkService
```

```text
include('azure/Item/Networking/ServicePrivateLinkService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServicePrivateLinkService.png) | ![illustration for ServicePrivateLinkService](../../../azure/Item/Networking/ServicePrivateLinkService.Local.png) | ![illustration for ServicePrivateLinkServiceCard](../../../azure/Item/Networking/ServicePrivateLinkServiceCard.Local.png) | ![illustration for ServicePrivateLinkServiceGroup](../../../azure/Item/Networking/ServicePrivateLinkServiceGroup.Local.png) |
