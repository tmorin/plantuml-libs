...
```text
azure/Item/Networking/ServiceVirtualRouter
```

```text
include('azure/Item/Networking/ServiceVirtualRouter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceVirtualRouter.png) | ![illustration for ServiceVirtualRouter](../../../azure/Item/Networking/ServiceVirtualRouter.Local.png) | ![illustration for ServiceVirtualRouterCard](../../../azure/Item/Networking/ServiceVirtualRouterCard.Local.png) | ![illustration for ServiceVirtualRouterGroup](../../../azure/Item/Networking/ServiceVirtualRouterGroup.Local.png) |
