...
```text
azure/Item/Networking/ServiceNetworkInterfaces
```

```text
include('azure/Item/Networking/ServiceNetworkInterfaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceNetworkInterfaces.png) | ![illustration for ServiceNetworkInterfaces](../../../azure/Item/Networking/ServiceNetworkInterfaces.Local.png) | ![illustration for ServiceNetworkInterfacesCard](../../../azure/Item/Networking/ServiceNetworkInterfacesCard.Local.png) | ![illustration for ServiceNetworkInterfacesGroup](../../../azure/Item/Networking/ServiceNetworkInterfacesGroup.Local.png) |
