...
```text
azure/Item/Networking/ServiceNetworkWatcher
```

```text
include('azure/Item/Networking/ServiceNetworkWatcher')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceNetworkWatcher.png) | ![illustration for ServiceNetworkWatcher](../../../azure/Item/Networking/ServiceNetworkWatcher.Local.png) | ![illustration for ServiceNetworkWatcherCard](../../../azure/Item/Networking/ServiceNetworkWatcherCard.Local.png) | ![illustration for ServiceNetworkWatcherGroup](../../../azure/Item/Networking/ServiceNetworkWatcherGroup.Local.png) |
