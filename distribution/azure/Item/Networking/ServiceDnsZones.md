...
```text
azure/Item/Networking/ServiceDnsZones
```

```text
include('azure/Item/Networking/ServiceDnsZones')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceDnsZones.png) | ![illustration for ServiceDnsZones](../../../azure/Item/Networking/ServiceDnsZones.Local.png) | ![illustration for ServiceDnsZonesCard](../../../azure/Item/Networking/ServiceDnsZonesCard.Local.png) | ![illustration for ServiceDnsZonesGroup](../../../azure/Item/Networking/ServiceDnsZonesGroup.Local.png) |
