...
```text
azure/Item/Networking/ServiceAzureFirewallPolicy
```

```text
include('azure/Item/Networking/ServiceAzureFirewallPolicy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceAzureFirewallPolicy.png) | ![illustration for ServiceAzureFirewallPolicy](../../../azure/Item/Networking/ServiceAzureFirewallPolicy.Local.png) | ![illustration for ServiceAzureFirewallPolicyCard](../../../azure/Item/Networking/ServiceAzureFirewallPolicyCard.Local.png) | ![illustration for ServiceAzureFirewallPolicyGroup](../../../azure/Item/Networking/ServiceAzureFirewallPolicyGroup.Local.png) |
