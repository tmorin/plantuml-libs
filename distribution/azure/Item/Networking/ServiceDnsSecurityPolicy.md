...
```text
azure/Item/Networking/ServiceDnsSecurityPolicy
```

```text
include('azure/Item/Networking/ServiceDnsSecurityPolicy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceDnsSecurityPolicy.png) | ![illustration for ServiceDnsSecurityPolicy](../../../azure/Item/Networking/ServiceDnsSecurityPolicy.Local.png) | ![illustration for ServiceDnsSecurityPolicyCard](../../../azure/Item/Networking/ServiceDnsSecurityPolicyCard.Local.png) | ![illustration for ServiceDnsSecurityPolicyGroup](../../../azure/Item/Networking/ServiceDnsSecurityPolicyGroup.Local.png) |
