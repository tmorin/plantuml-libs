...
```text
azure/Item/Networking/ServiceConnectedCache
```

```text
include('azure/Item/Networking/ServiceConnectedCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Networking/ServiceConnectedCache.png) | ![illustration for ServiceConnectedCache](../../../azure/Item/Networking/ServiceConnectedCache.Local.png) | ![illustration for ServiceConnectedCacheCard](../../../azure/Item/Networking/ServiceConnectedCacheCard.Local.png) | ![illustration for ServiceConnectedCacheGroup](../../../azure/Item/Networking/ServiceConnectedCacheGroup.Local.png) |
