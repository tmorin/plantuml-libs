...
```text
azure/Item/Intune/ServiceEBooks
```

```text
include('azure/Item/Intune/ServiceEBooks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Intune/ServiceEBooks.png) | ![illustration for ServiceEBooks](../../../azure/Item/Intune/ServiceEBooks.Local.png) | ![illustration for ServiceEBooksCard](../../../azure/Item/Intune/ServiceEBooksCard.Local.png) | ![illustration for ServiceEBooksGroup](../../../azure/Item/Intune/ServiceEBooksGroup.Local.png) |
