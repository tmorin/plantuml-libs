...
```text
azure/Item/Intune/ServiceTenantStatus
```

```text
include('azure/Item/Intune/ServiceTenantStatus')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Intune/ServiceTenantStatus.png) | ![illustration for ServiceTenantStatus](../../../azure/Item/Intune/ServiceTenantStatus.Local.png) | ![illustration for ServiceTenantStatusCard](../../../azure/Item/Intune/ServiceTenantStatusCard.Local.png) | ![illustration for ServiceTenantStatusGroup](../../../azure/Item/Intune/ServiceTenantStatusGroup.Local.png) |
