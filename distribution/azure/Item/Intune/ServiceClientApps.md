...
```text
azure/Item/Intune/ServiceClientApps
```

```text
include('azure/Item/Intune/ServiceClientApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Intune/ServiceClientApps.png) | ![illustration for ServiceClientApps](../../../azure/Item/Intune/ServiceClientApps.Local.png) | ![illustration for ServiceClientAppsCard](../../../azure/Item/Intune/ServiceClientAppsCard.Local.png) | ![illustration for ServiceClientAppsGroup](../../../azure/Item/Intune/ServiceClientAppsGroup.Local.png) |
