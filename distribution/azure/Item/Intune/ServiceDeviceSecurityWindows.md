...
```text
azure/Item/Intune/ServiceDeviceSecurityWindows
```

```text
include('azure/Item/Intune/ServiceDeviceSecurityWindows')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Intune/ServiceDeviceSecurityWindows.png) | ![illustration for ServiceDeviceSecurityWindows](../../../azure/Item/Intune/ServiceDeviceSecurityWindows.Local.png) | ![illustration for ServiceDeviceSecurityWindowsCard](../../../azure/Item/Intune/ServiceDeviceSecurityWindowsCard.Local.png) | ![illustration for ServiceDeviceSecurityWindowsGroup](../../../azure/Item/Intune/ServiceDeviceSecurityWindowsGroup.Local.png) |
