...
```text
azure/Item/Intune/ServiceMindaro
```

```text
include('azure/Item/Intune/ServiceMindaro')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Intune/ServiceMindaro.png) | ![illustration for ServiceMindaro](../../../azure/Item/Intune/ServiceMindaro.Local.png) | ![illustration for ServiceMindaroCard](../../../azure/Item/Intune/ServiceMindaroCard.Local.png) | ![illustration for ServiceMindaroGroup](../../../azure/Item/Intune/ServiceMindaroGroup.Local.png) |
