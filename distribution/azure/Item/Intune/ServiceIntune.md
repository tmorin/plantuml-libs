...
```text
azure/Item/Intune/ServiceIntune
```

```text
include('azure/Item/Intune/ServiceIntune')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Intune/ServiceIntune.png) | ![illustration for ServiceIntune](../../../azure/Item/Intune/ServiceIntune.Local.png) | ![illustration for ServiceIntuneCard](../../../azure/Item/Intune/ServiceIntuneCard.Local.png) | ![illustration for ServiceIntuneGroup](../../../azure/Item/Intune/ServiceIntuneGroup.Local.png) |
