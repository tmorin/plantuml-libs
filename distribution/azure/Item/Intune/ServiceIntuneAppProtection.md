...
```text
azure/Item/Intune/ServiceIntuneAppProtection
```

```text
include('azure/Item/Intune/ServiceIntuneAppProtection')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Intune/ServiceIntuneAppProtection.png) | ![illustration for ServiceIntuneAppProtection](../../../azure/Item/Intune/ServiceIntuneAppProtection.Local.png) | ![illustration for ServiceIntuneAppProtectionCard](../../../azure/Item/Intune/ServiceIntuneAppProtectionCard.Local.png) | ![illustration for ServiceIntuneAppProtectionGroup](../../../azure/Item/Intune/ServiceIntuneAppProtectionGroup.Local.png) |
