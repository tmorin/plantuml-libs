...
```text
azure/Item/Intune/ServiceDeviceSecurityApple
```

```text
include('azure/Item/Intune/ServiceDeviceSecurityApple')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Intune/ServiceDeviceSecurityApple.png) | ![illustration for ServiceDeviceSecurityApple](../../../azure/Item/Intune/ServiceDeviceSecurityApple.Local.png) | ![illustration for ServiceDeviceSecurityAppleCard](../../../azure/Item/Intune/ServiceDeviceSecurityAppleCard.Local.png) | ![illustration for ServiceDeviceSecurityAppleGroup](../../../azure/Item/Intune/ServiceDeviceSecurityAppleGroup.Local.png) |
