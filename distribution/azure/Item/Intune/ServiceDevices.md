...
```text
azure/Item/Intune/ServiceDevices
```

```text
include('azure/Item/Intune/ServiceDevices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Intune/ServiceDevices.png) | ![illustration for ServiceDevices](../../../azure/Item/Intune/ServiceDevices.Local.png) | ![illustration for ServiceDevicesCard](../../../azure/Item/Intune/ServiceDevicesCard.Local.png) | ![illustration for ServiceDevicesGroup](../../../azure/Item/Intune/ServiceDevicesGroup.Local.png) |
