...
```text
azure/Item/Analytics/ServicePowerPlatform
```

```text
include('azure/Item/Analytics/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Analytics/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure/Item/Analytics/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure/Item/Analytics/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure/Item/Analytics/ServicePowerPlatformGroup.Local.png) |
