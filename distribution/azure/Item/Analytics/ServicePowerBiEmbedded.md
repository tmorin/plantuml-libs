...
```text
azure/Item/Analytics/ServicePowerBiEmbedded
```

```text
include('azure/Item/Analytics/ServicePowerBiEmbedded')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Analytics/ServicePowerBiEmbedded.png) | ![illustration for ServicePowerBiEmbedded](../../../azure/Item/Analytics/ServicePowerBiEmbedded.Local.png) | ![illustration for ServicePowerBiEmbeddedCard](../../../azure/Item/Analytics/ServicePowerBiEmbeddedCard.Local.png) | ![illustration for ServicePowerBiEmbeddedGroup](../../../azure/Item/Analytics/ServicePowerBiEmbeddedGroup.Local.png) |
