...
```text
azure/Item/Analytics/ServiceDataFactories
```

```text
include('azure/Item/Analytics/ServiceDataFactories')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Analytics/ServiceDataFactories.png) | ![illustration for ServiceDataFactories](../../../azure/Item/Analytics/ServiceDataFactories.Local.png) | ![illustration for ServiceDataFactoriesCard](../../../azure/Item/Analytics/ServiceDataFactoriesCard.Local.png) | ![illustration for ServiceDataFactoriesGroup](../../../azure/Item/Analytics/ServiceDataFactoriesGroup.Local.png) |
