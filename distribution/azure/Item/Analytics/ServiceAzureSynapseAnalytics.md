...
```text
azure/Item/Analytics/ServiceAzureSynapseAnalytics
```

```text
include('azure/Item/Analytics/ServiceAzureSynapseAnalytics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Analytics/ServiceAzureSynapseAnalytics.png) | ![illustration for ServiceAzureSynapseAnalytics](../../../azure/Item/Analytics/ServiceAzureSynapseAnalytics.Local.png) | ![illustration for ServiceAzureSynapseAnalyticsCard](../../../azure/Item/Analytics/ServiceAzureSynapseAnalyticsCard.Local.png) | ![illustration for ServiceAzureSynapseAnalyticsGroup](../../../azure/Item/Analytics/ServiceAzureSynapseAnalyticsGroup.Local.png) |
