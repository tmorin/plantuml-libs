...
```text
azure/Item/Analytics/ServiceDataLakeStoreGen1
```

```text
include('azure/Item/Analytics/ServiceDataLakeStoreGen1')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Analytics/ServiceDataLakeStoreGen1.png) | ![illustration for ServiceDataLakeStoreGen1](../../../azure/Item/Analytics/ServiceDataLakeStoreGen1.Local.png) | ![illustration for ServiceDataLakeStoreGen1Card](../../../azure/Item/Analytics/ServiceDataLakeStoreGen1Card.Local.png) | ![illustration for ServiceDataLakeStoreGen1Group](../../../azure/Item/Analytics/ServiceDataLakeStoreGen1Group.Local.png) |
