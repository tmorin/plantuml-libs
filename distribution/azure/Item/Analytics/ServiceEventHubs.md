...
```text
azure/Item/Analytics/ServiceEventHubs
```

```text
include('azure/Item/Analytics/ServiceEventHubs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Analytics/ServiceEventHubs.png) | ![illustration for ServiceEventHubs](../../../azure/Item/Analytics/ServiceEventHubs.Local.png) | ![illustration for ServiceEventHubsCard](../../../azure/Item/Analytics/ServiceEventHubsCard.Local.png) | ![illustration for ServiceEventHubsGroup](../../../azure/Item/Analytics/ServiceEventHubsGroup.Local.png) |
