...
```text
azure/Item/Analytics/ServiceHdInsightClusters
```

```text
include('azure/Item/Analytics/ServiceHdInsightClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Analytics/ServiceHdInsightClusters.png) | ![illustration for ServiceHdInsightClusters](../../../azure/Item/Analytics/ServiceHdInsightClusters.Local.png) | ![illustration for ServiceHdInsightClustersCard](../../../azure/Item/Analytics/ServiceHdInsightClustersCard.Local.png) | ![illustration for ServiceHdInsightClustersGroup](../../../azure/Item/Analytics/ServiceHdInsightClustersGroup.Local.png) |
