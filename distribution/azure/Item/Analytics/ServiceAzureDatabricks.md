...
```text
azure/Item/Analytics/ServiceAzureDatabricks
```

```text
include('azure/Item/Analytics/ServiceAzureDatabricks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Analytics/ServiceAzureDatabricks.png) | ![illustration for ServiceAzureDatabricks](../../../azure/Item/Analytics/ServiceAzureDatabricks.Local.png) | ![illustration for ServiceAzureDatabricksCard](../../../azure/Item/Analytics/ServiceAzureDatabricksCard.Local.png) | ![illustration for ServiceAzureDatabricksGroup](../../../azure/Item/Analytics/ServiceAzureDatabricksGroup.Local.png) |
