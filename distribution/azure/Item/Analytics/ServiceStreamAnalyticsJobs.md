...
```text
azure/Item/Analytics/ServiceStreamAnalyticsJobs
```

```text
include('azure/Item/Analytics/ServiceStreamAnalyticsJobs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure/Item/Analytics/ServiceStreamAnalyticsJobs.png) | ![illustration for ServiceStreamAnalyticsJobs](../../../azure/Item/Analytics/ServiceStreamAnalyticsJobs.Local.png) | ![illustration for ServiceStreamAnalyticsJobsCard](../../../azure/Item/Analytics/ServiceStreamAnalyticsJobsCard.Local.png) | ![illustration for ServiceStreamAnalyticsJobsGroup](../../../azure/Item/Analytics/ServiceStreamAnalyticsJobsGroup.Local.png) |
