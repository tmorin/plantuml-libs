...
```text
aws-q1-2023/Architecture/Satellite/AwsGroundStation
```

```text
include('aws-q1-2023/Architecture/Satellite/AwsGroundStation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Satellite/AwsGroundStation.png) | ![illustration for AwsGroundStation](../../../aws-q1-2023/Architecture/Satellite/AwsGroundStation.Local.png) | ![illustration for AwsGroundStationCard](../../../aws-q1-2023/Architecture/Satellite/AwsGroundStationCard.Local.png) | ![illustration for AwsGroundStationGroup](../../../aws-q1-2023/Architecture/Satellite/AwsGroundStationGroup.Local.png) |
