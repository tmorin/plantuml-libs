...
```text
aws-q1-2023/Architecture/MigrationTransfer/AwsMigrationHub
```

```text
include('aws-q1-2023/Architecture/MigrationTransfer/AwsMigrationHub')
```
