...
```text
aws-q1-2023/Architecture/MigrationTransfer/AwsServerMigrationService
```

```text
include('aws-q1-2023/Architecture/MigrationTransfer/AwsServerMigrationService')
```
...
- `<$AwsServerMigrationServiceXs>`
- `<$AwsServerMigrationServiceSm>`
- `<$AwsServerMigrationServiceMd>`
- `<$AwsServerMigrationServiceLg>`
