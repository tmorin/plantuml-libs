...
```text
aws-q1-2023/Architecture/Compute/AwsElasticBeanstalk
```

```text
include('aws-q1-2023/Architecture/Compute/AwsElasticBeanstalk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Compute/AwsElasticBeanstalk.png) | ![illustration for AwsElasticBeanstalk](../../../aws-q1-2023/Architecture/Compute/AwsElasticBeanstalk.Local.png) | ![illustration for AwsElasticBeanstalkCard](../../../aws-q1-2023/Architecture/Compute/AwsElasticBeanstalkCard.Local.png) | ![illustration for AwsElasticBeanstalkGroup](../../../aws-q1-2023/Architecture/Compute/AwsElasticBeanstalkGroup.Local.png) |
