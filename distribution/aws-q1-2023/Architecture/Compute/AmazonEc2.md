...
```text
aws-q1-2023/Architecture/Compute/AmazonEc2
```

```text
include('aws-q1-2023/Architecture/Compute/AmazonEc2')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Compute/AmazonEc2.png) | ![illustration for AmazonEc2](../../../aws-q1-2023/Architecture/Compute/AmazonEc2.Local.png) | ![illustration for AmazonEc2Card](../../../aws-q1-2023/Architecture/Compute/AmazonEc2Card.Local.png) | ![illustration for AmazonEc2Group](../../../aws-q1-2023/Architecture/Compute/AmazonEc2Group.Local.png) |
