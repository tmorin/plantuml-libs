...
```text
aws-q1-2023/Architecture/Compute/AwsFargate
```

```text
include('aws-q1-2023/Architecture/Compute/AwsFargate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Compute/AwsFargate.png) | ![illustration for AwsFargate](../../../aws-q1-2023/Architecture/Compute/AwsFargate.Local.png) | ![illustration for AwsFargateCard](../../../aws-q1-2023/Architecture/Compute/AwsFargateCard.Local.png) | ![illustration for AwsFargateGroup](../../../aws-q1-2023/Architecture/Compute/AwsFargateGroup.Local.png) |
