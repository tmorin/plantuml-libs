...
```text
aws-q1-2023/Architecture/Compute/AwsWavelength
```

```text
include('aws-q1-2023/Architecture/Compute/AwsWavelength')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Compute/AwsWavelength.png) | ![illustration for AwsWavelength](../../../aws-q1-2023/Architecture/Compute/AwsWavelength.Local.png) | ![illustration for AwsWavelengthCard](../../../aws-q1-2023/Architecture/Compute/AwsWavelengthCard.Local.png) | ![illustration for AwsWavelengthGroup](../../../aws-q1-2023/Architecture/Compute/AwsWavelengthGroup.Local.png) |
