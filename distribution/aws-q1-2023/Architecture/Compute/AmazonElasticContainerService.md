...
```text
aws-q1-2023/Architecture/Compute/AmazonElasticContainerService
```

```text
include('aws-q1-2023/Architecture/Compute/AmazonElasticContainerService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Compute/AmazonElasticContainerService.png) | ![illustration for AmazonElasticContainerService](../../../aws-q1-2023/Architecture/Compute/AmazonElasticContainerService.Local.png) | ![illustration for AmazonElasticContainerServiceCard](../../../aws-q1-2023/Architecture/Compute/AmazonElasticContainerServiceCard.Local.png) | ![illustration for AmazonElasticContainerServiceGroup](../../../aws-q1-2023/Architecture/Compute/AmazonElasticContainerServiceGroup.Local.png) |
