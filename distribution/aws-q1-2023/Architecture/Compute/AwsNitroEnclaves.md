...
```text
aws-q1-2023/Architecture/Compute/AwsNitroEnclaves
```

```text
include('aws-q1-2023/Architecture/Compute/AwsNitroEnclaves')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Compute/AwsNitroEnclaves.png) | ![illustration for AwsNitroEnclaves](../../../aws-q1-2023/Architecture/Compute/AwsNitroEnclaves.Local.png) | ![illustration for AwsNitroEnclavesCard](../../../aws-q1-2023/Architecture/Compute/AwsNitroEnclavesCard.Local.png) | ![illustration for AwsNitroEnclavesGroup](../../../aws-q1-2023/Architecture/Compute/AwsNitroEnclavesGroup.Local.png) |
