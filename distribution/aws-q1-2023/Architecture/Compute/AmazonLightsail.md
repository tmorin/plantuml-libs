...
```text
aws-q1-2023/Architecture/Compute/AmazonLightsail
```

```text
include('aws-q1-2023/Architecture/Compute/AmazonLightsail')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Compute/AmazonLightsail.png) | ![illustration for AmazonLightsail](../../../aws-q1-2023/Architecture/Compute/AmazonLightsail.Local.png) | ![illustration for AmazonLightsailCard](../../../aws-q1-2023/Architecture/Compute/AmazonLightsailCard.Local.png) | ![illustration for AmazonLightsailGroup](../../../aws-q1-2023/Architecture/Compute/AmazonLightsailGroup.Local.png) |
