...
```text
aws-q1-2023/Architecture/Containers/AmazonEksCloud
```

```text
include('aws-q1-2023/Architecture/Containers/AmazonEksCloud')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Containers/AmazonEksCloud.png) | ![illustration for AmazonEksCloud](../../../aws-q1-2023/Architecture/Containers/AmazonEksCloud.Local.png) | ![illustration for AmazonEksCloudCard](../../../aws-q1-2023/Architecture/Containers/AmazonEksCloudCard.Local.png) | ![illustration for AmazonEksCloudGroup](../../../aws-q1-2023/Architecture/Containers/AmazonEksCloudGroup.Local.png) |
