...
```text
aws-q1-2023/Architecture/ManagementGovernance/AwsPersonalHealthDashboard
```

```text
include('aws-q1-2023/Architecture/ManagementGovernance/AwsPersonalHealthDashboard')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsPersonalHealthDashboard.png) | ![illustration for AwsPersonalHealthDashboard](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsPersonalHealthDashboard.Local.png) | ![illustration for AwsPersonalHealthDashboardCard](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsPersonalHealthDashboardCard.Local.png) | ![illustration for AwsPersonalHealthDashboardGroup](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsPersonalHealthDashboardGroup.Local.png) |
...
- `<$AwsPersonalHealthDashboardXs>`
- `<$AwsPersonalHealthDashboardSm>`
- `<$AwsPersonalHealthDashboardMd>`
- `<$AwsPersonalHealthDashboardLg>`
