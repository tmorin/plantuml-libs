...
```text
aws-q1-2023/Architecture/ManagementGovernance/AwsTrustedAdvisor
```

```text
include('aws-q1-2023/Architecture/ManagementGovernance/AwsTrustedAdvisor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsTrustedAdvisor.png) | ![illustration for AwsTrustedAdvisor](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsTrustedAdvisor.Local.png) | ![illustration for AwsTrustedAdvisorCard](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsTrustedAdvisorCard.Local.png) | ![illustration for AwsTrustedAdvisorGroup](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsTrustedAdvisorGroup.Local.png) |
