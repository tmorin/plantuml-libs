...
```text
aws-q1-2023/Architecture/ManagementGovernance/AwsServiceCatalog
```

```text
include('aws-q1-2023/Architecture/ManagementGovernance/AwsServiceCatalog')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsServiceCatalog.png) | ![illustration for AwsServiceCatalog](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsServiceCatalog.Local.png) | ![illustration for AwsServiceCatalogCard](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsServiceCatalogCard.Local.png) | ![illustration for AwsServiceCatalogGroup](../../../aws-q1-2023/Architecture/ManagementGovernance/AwsServiceCatalogGroup.Local.png) |
