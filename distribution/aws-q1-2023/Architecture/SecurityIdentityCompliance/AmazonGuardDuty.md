...
```text
aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonGuardDuty
```

```text
include('aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonGuardDuty')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonGuardDuty.png) | ![illustration for AmazonGuardDuty](../../../aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonGuardDuty.Local.png) | ![illustration for AmazonGuardDutyCard](../../../aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonGuardDutyCard.Local.png) | ![illustration for AmazonGuardDutyGroup](../../../aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonGuardDutyGroup.Local.png) |
