...
```text
aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonDetective
```

```text
include('aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonDetective')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonDetective.png) | ![illustration for AmazonDetective](../../../aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonDetective.Local.png) | ![illustration for AmazonDetectiveCard](../../../aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonDetectiveCard.Local.png) | ![illustration for AmazonDetectiveGroup](../../../aws-q1-2023/Architecture/SecurityIdentityCompliance/AmazonDetectiveGroup.Local.png) |
