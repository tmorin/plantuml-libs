...
```text
aws-q1-2023/Architecture/VrAr/AmazonSumerian
```

```text
include('aws-q1-2023/Architecture/VrAr/AmazonSumerian')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/VrAr/AmazonSumerian.png) | ![illustration for AmazonSumerian](../../../aws-q1-2023/Architecture/VrAr/AmazonSumerian.Local.png) | ![illustration for AmazonSumerianCard](../../../aws-q1-2023/Architecture/VrAr/AmazonSumerianCard.Local.png) | ![illustration for AmazonSumerianGroup](../../../aws-q1-2023/Architecture/VrAr/AmazonSumerianGroup.Local.png) |
