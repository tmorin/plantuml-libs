...
```text
aws-q1-2023/Architecture/MediaServices/AmazonNimbleStudio
```

```text
include('aws-q1-2023/Architecture/MediaServices/AmazonNimbleStudio')
```
