...
```text
aws-q1-2023/Architecture/MediaServices/AwsElementalMediaConvert
```

```text
include('aws-q1-2023/Architecture/MediaServices/AwsElementalMediaConvert')
```
