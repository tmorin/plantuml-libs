...
```text
aws-q1-2023/Architecture/MediaServices/AwsElementalMediaStore
```

```text
include('aws-q1-2023/Architecture/MediaServices/AwsElementalMediaStore')
```
