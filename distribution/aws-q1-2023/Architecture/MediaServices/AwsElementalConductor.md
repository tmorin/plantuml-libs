...
```text
aws-q1-2023/Architecture/MediaServices/AwsElementalConductor
```

```text
include('aws-q1-2023/Architecture/MediaServices/AwsElementalConductor')
```
