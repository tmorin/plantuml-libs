...
```text
aws-q1-2023/Architecture/MediaServices/AmazonInteractiveVideoService
```

```text
include('aws-q1-2023/Architecture/MediaServices/AmazonInteractiveVideoService')
```
