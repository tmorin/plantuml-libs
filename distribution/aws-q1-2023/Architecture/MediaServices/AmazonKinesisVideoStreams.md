...
```text
aws-q1-2023/Architecture/MediaServices/AmazonKinesisVideoStreams
```

```text
include('aws-q1-2023/Architecture/MediaServices/AmazonKinesisVideoStreams')
```
