...
```text
aws-q1-2023/Architecture/MediaServices/AwsElementalAppliancesSoftware
```

```text
include('aws-q1-2023/Architecture/MediaServices/AwsElementalAppliancesSoftware')
```
