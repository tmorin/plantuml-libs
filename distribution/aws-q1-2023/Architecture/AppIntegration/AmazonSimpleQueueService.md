...
```text
aws-q1-2023/Architecture/AppIntegration/AmazonSimpleQueueService
```

```text
include('aws-q1-2023/Architecture/AppIntegration/AmazonSimpleQueueService')
```
