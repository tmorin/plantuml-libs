...
```text
aws-q1-2023/Architecture/AppIntegration/AmazonApiGateway
```

```text
include('aws-q1-2023/Architecture/AppIntegration/AmazonApiGateway')
```
