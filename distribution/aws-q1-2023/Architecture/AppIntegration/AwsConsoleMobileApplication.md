...
```text
aws-q1-2023/Architecture/AppIntegration/AwsConsoleMobileApplication
```

```text
include('aws-q1-2023/Architecture/AppIntegration/AwsConsoleMobileApplication')
```
