...
```text
aws-q1-2023/Architecture/MachineLearning/AmazonKendra
```

```text
include('aws-q1-2023/Architecture/MachineLearning/AmazonKendra')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/MachineLearning/AmazonKendra.png) | ![illustration for AmazonKendra](../../../aws-q1-2023/Architecture/MachineLearning/AmazonKendra.Local.png) | ![illustration for AmazonKendraCard](../../../aws-q1-2023/Architecture/MachineLearning/AmazonKendraCard.Local.png) | ![illustration for AmazonKendraGroup](../../../aws-q1-2023/Architecture/MachineLearning/AmazonKendraGroup.Local.png) |
