...
```text
aws-q1-2023/Architecture/MachineLearning/AmazonTranscribe
```

```text
include('aws-q1-2023/Architecture/MachineLearning/AmazonTranscribe')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/MachineLearning/AmazonTranscribe.png) | ![illustration for AmazonTranscribe](../../../aws-q1-2023/Architecture/MachineLearning/AmazonTranscribe.Local.png) | ![illustration for AmazonTranscribeCard](../../../aws-q1-2023/Architecture/MachineLearning/AmazonTranscribeCard.Local.png) | ![illustration for AmazonTranscribeGroup](../../../aws-q1-2023/Architecture/MachineLearning/AmazonTranscribeGroup.Local.png) |
