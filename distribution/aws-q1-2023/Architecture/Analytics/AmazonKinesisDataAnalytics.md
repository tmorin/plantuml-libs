...
```text
aws-q1-2023/Architecture/Analytics/AmazonKinesisDataAnalytics
```

```text
include('aws-q1-2023/Architecture/Analytics/AmazonKinesisDataAnalytics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Analytics/AmazonKinesisDataAnalytics.png) | ![illustration for AmazonKinesisDataAnalytics](../../../aws-q1-2023/Architecture/Analytics/AmazonKinesisDataAnalytics.Local.png) | ![illustration for AmazonKinesisDataAnalyticsCard](../../../aws-q1-2023/Architecture/Analytics/AmazonKinesisDataAnalyticsCard.Local.png) | ![illustration for AmazonKinesisDataAnalyticsGroup](../../../aws-q1-2023/Architecture/Analytics/AmazonKinesisDataAnalyticsGroup.Local.png) |
