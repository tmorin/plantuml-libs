...
```text
aws-q1-2023/Architecture/Analytics/AwsGlueDataBrew
```

```text
include('aws-q1-2023/Architecture/Analytics/AwsGlueDataBrew')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Analytics/AwsGlueDataBrew.png) | ![illustration for AwsGlueDataBrew](../../../aws-q1-2023/Architecture/Analytics/AwsGlueDataBrew.Local.png) | ![illustration for AwsGlueDataBrewCard](../../../aws-q1-2023/Architecture/Analytics/AwsGlueDataBrewCard.Local.png) | ![illustration for AwsGlueDataBrewGroup](../../../aws-q1-2023/Architecture/Analytics/AwsGlueDataBrewGroup.Local.png) |
