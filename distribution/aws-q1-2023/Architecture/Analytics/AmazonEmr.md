...
```text
aws-q1-2023/Architecture/Analytics/AmazonEmr
```

```text
include('aws-q1-2023/Architecture/Analytics/AmazonEmr')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Analytics/AmazonEmr.png) | ![illustration for AmazonEmr](../../../aws-q1-2023/Architecture/Analytics/AmazonEmr.Local.png) | ![illustration for AmazonEmrCard](../../../aws-q1-2023/Architecture/Analytics/AmazonEmrCard.Local.png) | ![illustration for AmazonEmrGroup](../../../aws-q1-2023/Architecture/Analytics/AmazonEmrGroup.Local.png) |
