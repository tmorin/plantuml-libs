...
```text
aws-q1-2023/Architecture/Analytics/AwsGlueElasticViews
```

```text
include('aws-q1-2023/Architecture/Analytics/AwsGlueElasticViews')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Analytics/AwsGlueElasticViews.png) | ![illustration for AwsGlueElasticViews](../../../aws-q1-2023/Architecture/Analytics/AwsGlueElasticViews.Local.png) | ![illustration for AwsGlueElasticViewsCard](../../../aws-q1-2023/Architecture/Analytics/AwsGlueElasticViewsCard.Local.png) | ![illustration for AwsGlueElasticViewsGroup](../../../aws-q1-2023/Architecture/Analytics/AwsGlueElasticViewsGroup.Local.png) |
