...
```text
aws-q1-2023/Architecture/CloudFinancialManagement/AwsCostExplorer
```

```text
include('aws-q1-2023/Architecture/CloudFinancialManagement/AwsCostExplorer')
```
