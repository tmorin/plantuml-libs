...
```text
aws-q1-2023/Architecture/CustomerEnablement/AwsTrainingCertification
```

```text
include('aws-q1-2023/Architecture/CustomerEnablement/AwsTrainingCertification')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/CustomerEnablement/AwsTrainingCertification.png) | ![illustration for AwsTrainingCertification](../../../aws-q1-2023/Architecture/CustomerEnablement/AwsTrainingCertification.Local.png) | ![illustration for AwsTrainingCertificationCard](../../../aws-q1-2023/Architecture/CustomerEnablement/AwsTrainingCertificationCard.Local.png) | ![illustration for AwsTrainingCertificationGroup](../../../aws-q1-2023/Architecture/CustomerEnablement/AwsTrainingCertificationGroup.Local.png) |
