...
```text
aws-q1-2023/Architecture/CustomerEnablement/AwsSupport
```

```text
include('aws-q1-2023/Architecture/CustomerEnablement/AwsSupport')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/CustomerEnablement/AwsSupport.png) | ![illustration for AwsSupport](../../../aws-q1-2023/Architecture/CustomerEnablement/AwsSupport.Local.png) | ![illustration for AwsSupportCard](../../../aws-q1-2023/Architecture/CustomerEnablement/AwsSupportCard.Local.png) | ![illustration for AwsSupportGroup](../../../aws-q1-2023/Architecture/CustomerEnablement/AwsSupportGroup.Local.png) |
