...
```text
aws-q1-2023/Architecture/CustomerEnablement/AwsManagedServices
```

```text
include('aws-q1-2023/Architecture/CustomerEnablement/AwsManagedServices')
```
