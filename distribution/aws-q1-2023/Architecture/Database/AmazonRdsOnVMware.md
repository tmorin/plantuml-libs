...
```text
aws-q1-2023/Architecture/Database/AmazonRdsOnVMware
```

```text
include('aws-q1-2023/Architecture/Database/AmazonRdsOnVMware')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Database/AmazonRdsOnVMware.png) | ![illustration for AmazonRdsOnVMware](../../../aws-q1-2023/Architecture/Database/AmazonRdsOnVMware.Local.png) | ![illustration for AmazonRdsOnVMwareCard](../../../aws-q1-2023/Architecture/Database/AmazonRdsOnVMwareCard.Local.png) | ![illustration for AmazonRdsOnVMwareGroup](../../../aws-q1-2023/Architecture/Database/AmazonRdsOnVMwareGroup.Local.png) |
