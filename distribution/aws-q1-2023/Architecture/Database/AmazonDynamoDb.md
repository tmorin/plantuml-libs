...
```text
aws-q1-2023/Architecture/Database/AmazonDynamoDb
```

```text
include('aws-q1-2023/Architecture/Database/AmazonDynamoDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Database/AmazonDynamoDb.png) | ![illustration for AmazonDynamoDb](../../../aws-q1-2023/Architecture/Database/AmazonDynamoDb.Local.png) | ![illustration for AmazonDynamoDbCard](../../../aws-q1-2023/Architecture/Database/AmazonDynamoDbCard.Local.png) | ![illustration for AmazonDynamoDbGroup](../../../aws-q1-2023/Architecture/Database/AmazonDynamoDbGroup.Local.png) |
