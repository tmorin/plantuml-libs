...
```text
aws-q1-2023/Architecture/Database/AmazonNeptune
```

```text
include('aws-q1-2023/Architecture/Database/AmazonNeptune')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/Database/AmazonNeptune.png) | ![illustration for AmazonNeptune](../../../aws-q1-2023/Architecture/Database/AmazonNeptune.Local.png) | ![illustration for AmazonNeptuneCard](../../../aws-q1-2023/Architecture/Database/AmazonNeptuneCard.Local.png) | ![illustration for AmazonNeptuneGroup](../../../aws-q1-2023/Architecture/Database/AmazonNeptuneGroup.Local.png) |
