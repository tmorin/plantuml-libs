...
```text
aws-q1-2023/Architecture/DeveloperTools/AwsToolsAndSdKs
```

```text
include('aws-q1-2023/Architecture/DeveloperTools/AwsToolsAndSdKs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/DeveloperTools/AwsToolsAndSdKs.png) | ![illustration for AwsToolsAndSdKs](../../../aws-q1-2023/Architecture/DeveloperTools/AwsToolsAndSdKs.Local.png) | ![illustration for AwsToolsAndSdKsCard](../../../aws-q1-2023/Architecture/DeveloperTools/AwsToolsAndSdKsCard.Local.png) | ![illustration for AwsToolsAndSdKsGroup](../../../aws-q1-2023/Architecture/DeveloperTools/AwsToolsAndSdKsGroup.Local.png) |
