...
```text
aws-q1-2023/Architecture/DeveloperTools/AwsCodeStar
```

```text
include('aws-q1-2023/Architecture/DeveloperTools/AwsCodeStar')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/DeveloperTools/AwsCodeStar.png) | ![illustration for AwsCodeStar](../../../aws-q1-2023/Architecture/DeveloperTools/AwsCodeStar.Local.png) | ![illustration for AwsCodeStarCard](../../../aws-q1-2023/Architecture/DeveloperTools/AwsCodeStarCard.Local.png) | ![illustration for AwsCodeStarGroup](../../../aws-q1-2023/Architecture/DeveloperTools/AwsCodeStarGroup.Local.png) |
