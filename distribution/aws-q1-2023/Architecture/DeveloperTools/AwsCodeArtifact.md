...
```text
aws-q1-2023/Architecture/DeveloperTools/AwsCodeArtifact
```

```text
include('aws-q1-2023/Architecture/DeveloperTools/AwsCodeArtifact')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Architecture/DeveloperTools/AwsCodeArtifact.png) | ![illustration for AwsCodeArtifact](../../../aws-q1-2023/Architecture/DeveloperTools/AwsCodeArtifact.Local.png) | ![illustration for AwsCodeArtifactCard](../../../aws-q1-2023/Architecture/DeveloperTools/AwsCodeArtifactCard.Local.png) | ![illustration for AwsCodeArtifactGroup](../../../aws-q1-2023/Architecture/DeveloperTools/AwsCodeArtifactGroup.Local.png) |
