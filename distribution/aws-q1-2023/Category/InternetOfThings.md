...
```text
aws-q1-2023/Category/InternetOfThings
```

```text
include('aws-q1-2023/Category/InternetOfThings')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q1-2023/Category/InternetOfThings.png) | ![illustration for InternetOfThings](../../aws-q1-2023/Category/InternetOfThings.Local.png) | ![illustration for InternetOfThingsCard](../../aws-q1-2023/Category/InternetOfThingsCard.Local.png) | ![illustration for InternetOfThingsGroup](../../aws-q1-2023/Category/InternetOfThingsGroup.Local.png) |
