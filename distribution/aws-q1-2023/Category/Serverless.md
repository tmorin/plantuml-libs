...
```text
aws-q1-2023/Category/Serverless
```

```text
include('aws-q1-2023/Category/Serverless')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q1-2023/Category/Serverless.png) | ![illustration for Serverless](../../aws-q1-2023/Category/Serverless.Local.png) | ![illustration for ServerlessCard](../../aws-q1-2023/Category/ServerlessCard.Local.png) | ![illustration for ServerlessGroup](../../aws-q1-2023/Category/ServerlessGroup.Local.png) |
