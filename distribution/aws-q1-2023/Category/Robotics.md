...
```text
aws-q1-2023/Category/Robotics
```

```text
include('aws-q1-2023/Category/Robotics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q1-2023/Category/Robotics.png) | ![illustration for Robotics](../../aws-q1-2023/Category/Robotics.Local.png) | ![illustration for RoboticsCard](../../aws-q1-2023/Category/RoboticsCard.Local.png) | ![illustration for RoboticsGroup](../../aws-q1-2023/Category/RoboticsGroup.Local.png) |
