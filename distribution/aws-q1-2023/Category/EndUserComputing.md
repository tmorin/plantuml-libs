...
```text
aws-q1-2023/Category/EndUserComputing
```

```text
include('aws-q1-2023/Category/EndUserComputing')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q1-2023/Category/EndUserComputing.png) | ![illustration for EndUserComputing](../../aws-q1-2023/Category/EndUserComputing.Local.png) | ![illustration for EndUserComputingCard](../../aws-q1-2023/Category/EndUserComputingCard.Local.png) | ![illustration for EndUserComputingGroup](../../aws-q1-2023/Category/EndUserComputingGroup.Local.png) |
