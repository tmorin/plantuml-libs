...
```text
aws-q1-2023/Category/Compute
```

```text
include('aws-q1-2023/Category/Compute')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q1-2023/Category/Compute.png) | ![illustration for Compute](../../aws-q1-2023/Category/Compute.Local.png) | ![illustration for ComputeCard](../../aws-q1-2023/Category/ComputeCard.Local.png) | ![illustration for ComputeGroup](../../aws-q1-2023/Category/ComputeGroup.Local.png) |
