...
```text
aws-q1-2023/Resource/BusinessApplications/AmazonPinpointJourney
```

```text
include('aws-q1-2023/Resource/BusinessApplications/AmazonPinpointJourney')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/BusinessApplications/AmazonPinpointJourney.png) | ![illustration for AmazonPinpointJourney](../../../aws-q1-2023/Resource/BusinessApplications/AmazonPinpointJourney.Local.png) | ![illustration for AmazonPinpointJourneyCard](../../../aws-q1-2023/Resource/BusinessApplications/AmazonPinpointJourneyCard.Local.png) | ![illustration for AmazonPinpointJourneyGroup](../../../aws-q1-2023/Resource/BusinessApplications/AmazonPinpointJourneyGroup.Local.png) |
