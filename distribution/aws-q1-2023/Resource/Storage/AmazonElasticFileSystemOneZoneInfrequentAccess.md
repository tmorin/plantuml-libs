...
```text
aws-q1-2023/Resource/Storage/AmazonElasticFileSystemOneZoneInfrequentAccess
```

```text
include('aws-q1-2023/Resource/Storage/AmazonElasticFileSystemOneZoneInfrequentAccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/Storage/AmazonElasticFileSystemOneZoneInfrequentAccess.png) | ![illustration for AmazonElasticFileSystemOneZoneInfrequentAccess](../../../aws-q1-2023/Resource/Storage/AmazonElasticFileSystemOneZoneInfrequentAccess.Local.png) | ![illustration for AmazonElasticFileSystemOneZoneInfrequentAccessCard](../../../aws-q1-2023/Resource/Storage/AmazonElasticFileSystemOneZoneInfrequentAccessCard.Local.png) | ![illustration for AmazonElasticFileSystemOneZoneInfrequentAccessGroup](../../../aws-q1-2023/Resource/Storage/AmazonElasticFileSystemOneZoneInfrequentAccessGroup.Local.png) |
...
' renders the element
AmazonElasticFileSystemOneZoneInfrequentAccess('AmazonElasticFileSystemOneZoneInfrequentAccess', 'Amazon Elastic File System One Zone Infrequent Access', 'an optional tech label', 'an optional description')
@enduml
```
