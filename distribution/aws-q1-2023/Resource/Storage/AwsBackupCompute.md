...
```text
aws-q1-2023/Resource/Storage/AwsBackupCompute
```

```text
include('aws-q1-2023/Resource/Storage/AwsBackupCompute')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/Storage/AwsBackupCompute.png) | ![illustration for AwsBackupCompute](../../../aws-q1-2023/Resource/Storage/AwsBackupCompute.Local.png) | ![illustration for AwsBackupComputeCard](../../../aws-q1-2023/Resource/Storage/AwsBackupComputeCard.Local.png) | ![illustration for AwsBackupComputeGroup](../../../aws-q1-2023/Resource/Storage/AwsBackupComputeGroup.Local.png) |
