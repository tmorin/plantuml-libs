...
```text
aws-q1-2023/Resource/MigrationAndTransfer/AwsTransferFamilyAwsFtps
```

```text
include('aws-q1-2023/Resource/MigrationAndTransfer/AwsTransferFamilyAwsFtps')
```
