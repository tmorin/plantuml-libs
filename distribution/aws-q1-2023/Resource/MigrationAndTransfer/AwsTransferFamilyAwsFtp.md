...
```text
aws-q1-2023/Resource/MigrationAndTransfer/AwsTransferFamilyAwsFtp
```

```text
include('aws-q1-2023/Resource/MigrationAndTransfer/AwsTransferFamilyAwsFtp')
```
