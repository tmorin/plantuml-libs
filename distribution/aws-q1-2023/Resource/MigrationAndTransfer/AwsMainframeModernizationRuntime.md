...
```text
aws-q1-2023/Resource/MigrationAndTransfer/AwsMainframeModernizationRuntime
```

```text
include('aws-q1-2023/Resource/MigrationAndTransfer/AwsMainframeModernizationRuntime')
```
