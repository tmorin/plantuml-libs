...
```text
aws-q1-2023/Resource/ApplicationIntegration/AmazonEventBridgeSchema
```

```text
include('aws-q1-2023/Resource/ApplicationIntegration/AmazonEventBridgeSchema')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/ApplicationIntegration/AmazonEventBridgeSchema.png) | ![illustration for AmazonEventBridgeSchema](../../../aws-q1-2023/Resource/ApplicationIntegration/AmazonEventBridgeSchema.Local.png) | ![illustration for AmazonEventBridgeSchemaCard](../../../aws-q1-2023/Resource/ApplicationIntegration/AmazonEventBridgeSchemaCard.Local.png) | ![illustration for AmazonEventBridgeSchemaGroup](../../../aws-q1-2023/Resource/ApplicationIntegration/AmazonEventBridgeSchemaGroup.Local.png) |
