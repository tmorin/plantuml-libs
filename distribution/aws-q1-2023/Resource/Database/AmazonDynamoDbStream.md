...
```text
aws-q1-2023/Resource/Database/AmazonDynamoDbStream
```

```text
include('aws-q1-2023/Resource/Database/AmazonDynamoDbStream')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbStream.png) | ![illustration for AmazonDynamoDbStream](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbStream.Local.png) | ![illustration for AmazonDynamoDbStreamCard](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbStreamCard.Local.png) | ![illustration for AmazonDynamoDbStreamGroup](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbStreamGroup.Local.png) |
