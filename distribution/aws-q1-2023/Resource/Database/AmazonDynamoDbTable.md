...
```text
aws-q1-2023/Resource/Database/AmazonDynamoDbTable
```

```text
include('aws-q1-2023/Resource/Database/AmazonDynamoDbTable')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbTable.png) | ![illustration for AmazonDynamoDbTable](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbTable.Local.png) | ![illustration for AmazonDynamoDbTableCard](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbTableCard.Local.png) | ![illustration for AmazonDynamoDbTableGroup](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbTableGroup.Local.png) |
