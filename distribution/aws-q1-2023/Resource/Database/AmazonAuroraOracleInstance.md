...
```text
aws-q1-2023/Resource/Database/AmazonAuroraOracleInstance
```

```text
include('aws-q1-2023/Resource/Database/AmazonAuroraOracleInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/Database/AmazonAuroraOracleInstance.png) | ![illustration for AmazonAuroraOracleInstance](../../../aws-q1-2023/Resource/Database/AmazonAuroraOracleInstance.Local.png) | ![illustration for AmazonAuroraOracleInstanceCard](../../../aws-q1-2023/Resource/Database/AmazonAuroraOracleInstanceCard.Local.png) | ![illustration for AmazonAuroraOracleInstanceGroup](../../../aws-q1-2023/Resource/Database/AmazonAuroraOracleInstanceGroup.Local.png) |
