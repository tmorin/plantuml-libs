...
```text
aws-q1-2023/Resource/Database/AmazonDynamoDbItems
```

```text
include('aws-q1-2023/Resource/Database/AmazonDynamoDbItems')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbItems.png) | ![illustration for AmazonDynamoDbItems](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbItems.Local.png) | ![illustration for AmazonDynamoDbItemsCard](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbItemsCard.Local.png) | ![illustration for AmazonDynamoDbItemsGroup](../../../aws-q1-2023/Resource/Database/AmazonDynamoDbItemsGroup.Local.png) |
