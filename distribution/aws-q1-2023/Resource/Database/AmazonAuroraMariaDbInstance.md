...
```text
aws-q1-2023/Resource/Database/AmazonAuroraMariaDbInstance
```

```text
include('aws-q1-2023/Resource/Database/AmazonAuroraMariaDbInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/Database/AmazonAuroraMariaDbInstance.png) | ![illustration for AmazonAuroraMariaDbInstance](../../../aws-q1-2023/Resource/Database/AmazonAuroraMariaDbInstance.Local.png) | ![illustration for AmazonAuroraMariaDbInstanceCard](../../../aws-q1-2023/Resource/Database/AmazonAuroraMariaDbInstanceCard.Local.png) | ![illustration for AmazonAuroraMariaDbInstanceGroup](../../../aws-q1-2023/Resource/Database/AmazonAuroraMariaDbInstanceGroup.Local.png) |
