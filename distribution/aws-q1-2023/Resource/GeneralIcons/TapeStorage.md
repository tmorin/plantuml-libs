...
```text
aws-q1-2023/Resource/GeneralIcons/TapeStorage
```

```text
include('aws-q1-2023/Resource/GeneralIcons/TapeStorage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/GeneralIcons/TapeStorage.png) | ![illustration for TapeStorage](../../../aws-q1-2023/Resource/GeneralIcons/TapeStorage.Local.png) | ![illustration for TapeStorageCard](../../../aws-q1-2023/Resource/GeneralIcons/TapeStorageCard.Local.png) | ![illustration for TapeStorageGroup](../../../aws-q1-2023/Resource/GeneralIcons/TapeStorageGroup.Local.png) |
