...
```text
aws-q1-2023/Resource/GeneralIcons/Camera
```

```text
include('aws-q1-2023/Resource/GeneralIcons/Camera')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/GeneralIcons/Camera.png) | ![illustration for Camera](../../../aws-q1-2023/Resource/GeneralIcons/Camera.Local.png) | ![illustration for CameraCard](../../../aws-q1-2023/Resource/GeneralIcons/CameraCard.Local.png) | ![illustration for CameraGroup](../../../aws-q1-2023/Resource/GeneralIcons/CameraGroup.Local.png) |
