...
```text
aws-q1-2023/Resource/GeneralIcons/Document
```

```text
include('aws-q1-2023/Resource/GeneralIcons/Document')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/GeneralIcons/Document.png) | ![illustration for Document](../../../aws-q1-2023/Resource/GeneralIcons/Document.Local.png) | ![illustration for DocumentCard](../../../aws-q1-2023/Resource/GeneralIcons/DocumentCard.Local.png) | ![illustration for DocumentGroup](../../../aws-q1-2023/Resource/GeneralIcons/DocumentGroup.Local.png) |
