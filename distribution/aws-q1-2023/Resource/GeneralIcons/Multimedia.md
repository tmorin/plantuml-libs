...
```text
aws-q1-2023/Resource/GeneralIcons/Multimedia
```

```text
include('aws-q1-2023/Resource/GeneralIcons/Multimedia')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/GeneralIcons/Multimedia.png) | ![illustration for Multimedia](../../../aws-q1-2023/Resource/GeneralIcons/Multimedia.Local.png) | ![illustration for MultimediaCard](../../../aws-q1-2023/Resource/GeneralIcons/MultimediaCard.Local.png) | ![illustration for MultimediaGroup](../../../aws-q1-2023/Resource/GeneralIcons/MultimediaGroup.Local.png) |
