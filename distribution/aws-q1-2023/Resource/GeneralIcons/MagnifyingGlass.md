...
```text
aws-q1-2023/Resource/GeneralIcons/MagnifyingGlass
```

```text
include('aws-q1-2023/Resource/GeneralIcons/MagnifyingGlass')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/GeneralIcons/MagnifyingGlass.png) | ![illustration for MagnifyingGlass](../../../aws-q1-2023/Resource/GeneralIcons/MagnifyingGlass.Local.png) | ![illustration for MagnifyingGlassCard](../../../aws-q1-2023/Resource/GeneralIcons/MagnifyingGlassCard.Local.png) | ![illustration for MagnifyingGlassGroup](../../../aws-q1-2023/Resource/GeneralIcons/MagnifyingGlassGroup.Local.png) |
