...
```text
aws-q1-2023/Resource/GeneralIcons/Disk
```

```text
include('aws-q1-2023/Resource/GeneralIcons/Disk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/GeneralIcons/Disk.png) | ![illustration for Disk](../../../aws-q1-2023/Resource/GeneralIcons/Disk.Local.png) | ![illustration for DiskCard](../../../aws-q1-2023/Resource/GeneralIcons/DiskCard.Local.png) | ![illustration for DiskGroup](../../../aws-q1-2023/Resource/GeneralIcons/DiskGroup.Local.png) |
