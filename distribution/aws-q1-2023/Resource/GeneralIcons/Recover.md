...
```text
aws-q1-2023/Resource/GeneralIcons/Recover
```

```text
include('aws-q1-2023/Resource/GeneralIcons/Recover')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/GeneralIcons/Recover.png) | ![illustration for Recover](../../../aws-q1-2023/Resource/GeneralIcons/Recover.Local.png) | ![illustration for RecoverCard](../../../aws-q1-2023/Resource/GeneralIcons/RecoverCard.Local.png) | ![illustration for RecoverGroup](../../../aws-q1-2023/Resource/GeneralIcons/RecoverGroup.Local.png) |
