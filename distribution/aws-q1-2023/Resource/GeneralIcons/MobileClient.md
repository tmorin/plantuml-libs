...
```text
aws-q1-2023/Resource/GeneralIcons/MobileClient
```

```text
include('aws-q1-2023/Resource/GeneralIcons/MobileClient')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/GeneralIcons/MobileClient.png) | ![illustration for MobileClient](../../../aws-q1-2023/Resource/GeneralIcons/MobileClient.Local.png) | ![illustration for MobileClientCard](../../../aws-q1-2023/Resource/GeneralIcons/MobileClientCard.Local.png) | ![illustration for MobileClientGroup](../../../aws-q1-2023/Resource/GeneralIcons/MobileClientGroup.Local.png) |
