...
```text
aws-q1-2023/Resource/GroupIcons/Cloud
```

```text
include('aws-q1-2023/Resource/GroupIcons/Cloud')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/GroupIcons/Cloud.png) | ![illustration for Cloud](../../../aws-q1-2023/Resource/GroupIcons/Cloud.Local.png) | ![illustration for CloudCard](../../../aws-q1-2023/Resource/GroupIcons/CloudCard.Local.png) | ![illustration for CloudGroup](../../../aws-q1-2023/Resource/GroupIcons/CloudGroup.Local.png) |
