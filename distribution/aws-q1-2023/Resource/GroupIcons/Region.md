...
```text
aws-q1-2023/Resource/GroupIcons/Region
```

```text
include('aws-q1-2023/Resource/GroupIcons/Region')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/GroupIcons/Region.png) | ![illustration for Region](../../../aws-q1-2023/Resource/GroupIcons/Region.Local.png) | ![illustration for RegionCard](../../../aws-q1-2023/Resource/GroupIcons/RegionCard.Local.png) | ![illustration for RegionGroup](../../../aws-q1-2023/Resource/GroupIcons/RegionGroup.Local.png) |
