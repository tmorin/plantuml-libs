...
```text
aws-q1-2023/Resource/GroupIcons/AutoScaling
```

```text
include('aws-q1-2023/Resource/GroupIcons/AutoScaling')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/GroupIcons/AutoScaling.png) | ![illustration for AutoScaling](../../../aws-q1-2023/Resource/GroupIcons/AutoScaling.Local.png) | ![illustration for AutoScalingCard](../../../aws-q1-2023/Resource/GroupIcons/AutoScalingCard.Local.png) | ![illustration for AutoScalingGroup](../../../aws-q1-2023/Resource/GroupIcons/AutoScalingGroup.Local.png) |
