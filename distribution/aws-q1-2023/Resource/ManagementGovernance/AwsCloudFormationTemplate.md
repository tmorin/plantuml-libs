...
```text
aws-q1-2023/Resource/ManagementGovernance/AwsCloudFormationTemplate
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AwsCloudFormationTemplate')
```
