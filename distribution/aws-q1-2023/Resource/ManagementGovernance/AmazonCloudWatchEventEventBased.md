...
```text
aws-q1-2023/Resource/ManagementGovernance/AmazonCloudWatchEventEventBased
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AmazonCloudWatchEventEventBased')
```
