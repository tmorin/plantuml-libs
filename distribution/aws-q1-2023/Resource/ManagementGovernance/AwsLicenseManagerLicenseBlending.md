...
```text
aws-q1-2023/Resource/ManagementGovernance/AwsLicenseManagerLicenseBlending
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AwsLicenseManagerLicenseBlending')
```
