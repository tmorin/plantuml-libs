...
```text
aws-q1-2023/Resource/ManagementGovernance/AmazonCloudWatchAlarm
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AmazonCloudWatchAlarm')
```
