...
```text
aws-q1-2023/Resource/ManagementGovernance/AwsOpsWorksResources
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AwsOpsWorksResources')
```
