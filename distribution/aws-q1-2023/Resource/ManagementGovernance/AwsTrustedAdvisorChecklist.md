...
```text
aws-q1-2023/Resource/ManagementGovernance/AwsTrustedAdvisorChecklist
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AwsTrustedAdvisorChecklist')
```
