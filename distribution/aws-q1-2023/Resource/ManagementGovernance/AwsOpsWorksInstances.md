...
```text
aws-q1-2023/Resource/ManagementGovernance/AwsOpsWorksInstances
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AwsOpsWorksInstances')
```
