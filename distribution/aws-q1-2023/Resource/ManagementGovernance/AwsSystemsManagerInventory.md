...
```text
aws-q1-2023/Resource/ManagementGovernance/AwsSystemsManagerInventory
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AwsSystemsManagerInventory')
```
