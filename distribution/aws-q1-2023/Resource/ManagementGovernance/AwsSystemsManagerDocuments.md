...
```text
aws-q1-2023/Resource/ManagementGovernance/AwsSystemsManagerDocuments
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AwsSystemsManagerDocuments')
```
