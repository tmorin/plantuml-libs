...
```text
aws-q1-2023/Resource/ManagementGovernance/AmazonCloudWatchLogs
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AmazonCloudWatchLogs')
```
