...
```text
aws-q1-2023/Resource/ManagementGovernance/AwsOpsWorksPermissions
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AwsOpsWorksPermissions')
```
