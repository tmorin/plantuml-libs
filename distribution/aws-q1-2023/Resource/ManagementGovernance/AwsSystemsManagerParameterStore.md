...
```text
aws-q1-2023/Resource/ManagementGovernance/AwsSystemsManagerParameterStore
```

```text
include('aws-q1-2023/Resource/ManagementGovernance/AwsSystemsManagerParameterStore')
```
