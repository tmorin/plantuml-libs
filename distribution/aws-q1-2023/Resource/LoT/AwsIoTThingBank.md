...
```text
aws-q1-2023/Resource/LoT/AwsIoTThingBank
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTThingBank')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTThingBank.png) | ![illustration for AwsIoTThingBank](../../../aws-q1-2023/Resource/LoT/AwsIoTThingBank.Local.png) | ![illustration for AwsIoTThingBankCard](../../../aws-q1-2023/Resource/LoT/AwsIoTThingBankCard.Local.png) | ![illustration for AwsIoTThingBankGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTThingBankGroup.Local.png) |
