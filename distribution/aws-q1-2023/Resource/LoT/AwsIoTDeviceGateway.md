...
```text
aws-q1-2023/Resource/LoT/AwsIoTDeviceGateway
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTDeviceGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTDeviceGateway.png) | ![illustration for AwsIoTDeviceGateway](../../../aws-q1-2023/Resource/LoT/AwsIoTDeviceGateway.Local.png) | ![illustration for AwsIoTDeviceGatewayCard](../../../aws-q1-2023/Resource/LoT/AwsIoTDeviceGatewayCard.Local.png) | ![illustration for AwsIoTDeviceGatewayGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTDeviceGatewayGroup.Local.png) |
