...
```text
aws-q1-2023/Resource/LoT/AwsIoTThingFactory
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTThingFactory')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTThingFactory.png) | ![illustration for AwsIoTThingFactory](../../../aws-q1-2023/Resource/LoT/AwsIoTThingFactory.Local.png) | ![illustration for AwsIoTThingFactoryCard](../../../aws-q1-2023/Resource/LoT/AwsIoTThingFactoryCard.Local.png) | ![illustration for AwsIoTThingFactoryGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTThingFactoryGroup.Local.png) |
