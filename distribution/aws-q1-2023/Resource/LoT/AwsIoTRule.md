...
```text
aws-q1-2023/Resource/LoT/AwsIoTRule
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTRule')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTRule.png) | ![illustration for AwsIoTRule](../../../aws-q1-2023/Resource/LoT/AwsIoTRule.Local.png) | ![illustration for AwsIoTRuleCard](../../../aws-q1-2023/Resource/LoT/AwsIoTRuleCard.Local.png) | ![illustration for AwsIoTRuleGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTRuleGroup.Local.png) |
