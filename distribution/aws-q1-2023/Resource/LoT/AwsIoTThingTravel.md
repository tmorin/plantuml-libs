...
```text
aws-q1-2023/Resource/LoT/AwsIoTThingTravel
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTThingTravel')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTThingTravel.png) | ![illustration for AwsIoTThingTravel](../../../aws-q1-2023/Resource/LoT/AwsIoTThingTravel.Local.png) | ![illustration for AwsIoTThingTravelCard](../../../aws-q1-2023/Resource/LoT/AwsIoTThingTravelCard.Local.png) | ![illustration for AwsIoTThingTravelGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTThingTravelGroup.Local.png) |
