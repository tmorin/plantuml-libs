...
```text
aws-q1-2023/Resource/LoT/AwsIoTThingStacklight
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTThingStacklight')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTThingStacklight.png) | ![illustration for AwsIoTThingStacklight](../../../aws-q1-2023/Resource/LoT/AwsIoTThingStacklight.Local.png) | ![illustration for AwsIoTThingStacklightCard](../../../aws-q1-2023/Resource/LoT/AwsIoTThingStacklightCard.Local.png) | ![illustration for AwsIoTThingStacklightGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTThingStacklightGroup.Local.png) |
