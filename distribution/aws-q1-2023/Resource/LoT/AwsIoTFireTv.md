...
```text
aws-q1-2023/Resource/LoT/AwsIoTFireTv
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTFireTv')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTFireTv.png) | ![illustration for AwsIoTFireTv](../../../aws-q1-2023/Resource/LoT/AwsIoTFireTv.Local.png) | ![illustration for AwsIoTFireTvCard](../../../aws-q1-2023/Resource/LoT/AwsIoTFireTvCard.Local.png) | ![illustration for AwsIoTFireTvGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTFireTvGroup.Local.png) |
