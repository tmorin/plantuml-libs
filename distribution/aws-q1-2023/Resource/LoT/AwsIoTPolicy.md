...
```text
aws-q1-2023/Resource/LoT/AwsIoTPolicy
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTPolicy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTPolicy.png) | ![illustration for AwsIoTPolicy](../../../aws-q1-2023/Resource/LoT/AwsIoTPolicy.Local.png) | ![illustration for AwsIoTPolicyCard](../../../aws-q1-2023/Resource/LoT/AwsIoTPolicyCard.Local.png) | ![illustration for AwsIoTPolicyGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTPolicyGroup.Local.png) |
