...
```text
aws-q1-2023/Resource/LoT/AwsIoTSensor
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTSensor.png) | ![illustration for AwsIoTSensor](../../../aws-q1-2023/Resource/LoT/AwsIoTSensor.Local.png) | ![illustration for AwsIoTSensorCard](../../../aws-q1-2023/Resource/LoT/AwsIoTSensorCard.Local.png) | ![illustration for AwsIoTSensorGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTSensorGroup.Local.png) |
