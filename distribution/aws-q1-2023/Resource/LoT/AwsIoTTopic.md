...
```text
aws-q1-2023/Resource/LoT/AwsIoTTopic
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTTopic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTTopic.png) | ![illustration for AwsIoTTopic](../../../aws-q1-2023/Resource/LoT/AwsIoTTopic.Local.png) | ![illustration for AwsIoTTopicCard](../../../aws-q1-2023/Resource/LoT/AwsIoTTopicCard.Local.png) | ![illustration for AwsIoTTopicGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTTopicGroup.Local.png) |
