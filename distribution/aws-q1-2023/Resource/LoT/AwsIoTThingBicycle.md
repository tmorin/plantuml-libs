...
```text
aws-q1-2023/Resource/LoT/AwsIoTThingBicycle
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTThingBicycle')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTThingBicycle.png) | ![illustration for AwsIoTThingBicycle](../../../aws-q1-2023/Resource/LoT/AwsIoTThingBicycle.Local.png) | ![illustration for AwsIoTThingBicycleCard](../../../aws-q1-2023/Resource/LoT/AwsIoTThingBicycleCard.Local.png) | ![illustration for AwsIoTThingBicycleGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTThingBicycleGroup.Local.png) |
