...
```text
aws-q1-2023/Resource/LoT/AwsIoTThingThermostat
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTThingThermostat')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTThingThermostat.png) | ![illustration for AwsIoTThingThermostat](../../../aws-q1-2023/Resource/LoT/AwsIoTThingThermostat.Local.png) | ![illustration for AwsIoTThingThermostatCard](../../../aws-q1-2023/Resource/LoT/AwsIoTThingThermostatCard.Local.png) | ![illustration for AwsIoTThingThermostatGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTThingThermostatGroup.Local.png) |
