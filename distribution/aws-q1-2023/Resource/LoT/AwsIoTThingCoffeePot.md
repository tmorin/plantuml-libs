...
```text
aws-q1-2023/Resource/LoT/AwsIoTThingCoffeePot
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTThingCoffeePot')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTThingCoffeePot.png) | ![illustration for AwsIoTThingCoffeePot](../../../aws-q1-2023/Resource/LoT/AwsIoTThingCoffeePot.Local.png) | ![illustration for AwsIoTThingCoffeePotCard](../../../aws-q1-2023/Resource/LoT/AwsIoTThingCoffeePotCard.Local.png) | ![illustration for AwsIoTThingCoffeePotGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTThingCoffeePotGroup.Local.png) |
