...
```text
aws-q1-2023/Resource/LoT/AwsIoTThingRelay
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTThingRelay')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTThingRelay.png) | ![illustration for AwsIoTThingRelay](../../../aws-q1-2023/Resource/LoT/AwsIoTThingRelay.Local.png) | ![illustration for AwsIoTThingRelayCard](../../../aws-q1-2023/Resource/LoT/AwsIoTThingRelayCard.Local.png) | ![illustration for AwsIoTThingRelayGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTThingRelayGroup.Local.png) |
