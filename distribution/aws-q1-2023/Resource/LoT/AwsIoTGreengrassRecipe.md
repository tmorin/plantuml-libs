...
```text
aws-q1-2023/Resource/LoT/AwsIoTGreengrassRecipe
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTGreengrassRecipe')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTGreengrassRecipe.png) | ![illustration for AwsIoTGreengrassRecipe](../../../aws-q1-2023/Resource/LoT/AwsIoTGreengrassRecipe.Local.png) | ![illustration for AwsIoTGreengrassRecipeCard](../../../aws-q1-2023/Resource/LoT/AwsIoTGreengrassRecipeCard.Local.png) | ![illustration for AwsIoTGreengrassRecipeGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTGreengrassRecipeGroup.Local.png) |
