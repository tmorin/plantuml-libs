...
```text
aws-q1-2023/Resource/LoT/AwsIoTAction
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTAction')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTAction.png) | ![illustration for AwsIoTAction](../../../aws-q1-2023/Resource/LoT/AwsIoTAction.Local.png) | ![illustration for AwsIoTActionCard](../../../aws-q1-2023/Resource/LoT/AwsIoTActionCard.Local.png) | ![illustration for AwsIoTActionGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTActionGroup.Local.png) |
