...
```text
aws-q1-2023/Resource/LoT/AwsIoTServo
```

```text
include('aws-q1-2023/Resource/LoT/AwsIoTServo')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2023/Resource/LoT/AwsIoTServo.png) | ![illustration for AwsIoTServo](../../../aws-q1-2023/Resource/LoT/AwsIoTServo.Local.png) | ![illustration for AwsIoTServoCard](../../../aws-q1-2023/Resource/LoT/AwsIoTServoCard.Local.png) | ![illustration for AwsIoTServoGroup](../../../aws-q1-2023/Resource/LoT/AwsIoTServoGroup.Local.png) |
