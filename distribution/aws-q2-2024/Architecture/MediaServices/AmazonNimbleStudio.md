...
```text
aws-q2-2024/Architecture/MediaServices/AmazonNimbleStudio
```

```text
include('aws-q2-2024/Architecture/MediaServices/AmazonNimbleStudio')
```
