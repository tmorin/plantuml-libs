...
```text
aws-q2-2024/Architecture/MediaServices/AwsElementalMediaLive
```

```text
include('aws-q2-2024/Architecture/MediaServices/AwsElementalMediaLive')
```
