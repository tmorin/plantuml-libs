...
```text
aws-q2-2024/Architecture/MediaServices/AwsElementalDelta
```

```text
include('aws-q2-2024/Architecture/MediaServices/AwsElementalDelta')
```
