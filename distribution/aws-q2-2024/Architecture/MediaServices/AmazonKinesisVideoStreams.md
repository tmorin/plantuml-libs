...
```text
aws-q2-2024/Architecture/MediaServices/AmazonKinesisVideoStreams
```

```text
include('aws-q2-2024/Architecture/MediaServices/AmazonKinesisVideoStreams')
```
