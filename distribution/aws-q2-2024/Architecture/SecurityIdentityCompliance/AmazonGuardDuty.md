...
```text
aws-q2-2024/Architecture/SecurityIdentityCompliance/AmazonGuardDuty
```

```text
include('aws-q2-2024/Architecture/SecurityIdentityCompliance/AmazonGuardDuty')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/SecurityIdentityCompliance/AmazonGuardDuty.png) | ![illustration for AmazonGuardDuty](../../../aws-q2-2024/Architecture/SecurityIdentityCompliance/AmazonGuardDuty.Local.png) | ![illustration for AmazonGuardDutyCard](../../../aws-q2-2024/Architecture/SecurityIdentityCompliance/AmazonGuardDutyCard.Local.png) | ![illustration for AmazonGuardDutyGroup](../../../aws-q2-2024/Architecture/SecurityIdentityCompliance/AmazonGuardDutyGroup.Local.png) |
