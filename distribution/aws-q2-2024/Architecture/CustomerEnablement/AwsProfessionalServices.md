...
```text
aws-q2-2024/Architecture/CustomerEnablement/AwsProfessionalServices
```

```text
include('aws-q2-2024/Architecture/CustomerEnablement/AwsProfessionalServices')
```
