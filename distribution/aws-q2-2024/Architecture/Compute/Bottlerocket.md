...
```text
aws-q2-2024/Architecture/Compute/Bottlerocket
```

```text
include('aws-q2-2024/Architecture/Compute/Bottlerocket')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Compute/Bottlerocket.png) | ![illustration for Bottlerocket](../../../aws-q2-2024/Architecture/Compute/Bottlerocket.Local.png) | ![illustration for BottlerocketCard](../../../aws-q2-2024/Architecture/Compute/BottlerocketCard.Local.png) | ![illustration for BottlerocketGroup](../../../aws-q2-2024/Architecture/Compute/BottlerocketGroup.Local.png) |
