...
```text
aws-q2-2024/Architecture/Compute/AwsLocalZones
```

```text
include('aws-q2-2024/Architecture/Compute/AwsLocalZones')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Compute/AwsLocalZones.png) | ![illustration for AwsLocalZones](../../../aws-q2-2024/Architecture/Compute/AwsLocalZones.Local.png) | ![illustration for AwsLocalZonesCard](../../../aws-q2-2024/Architecture/Compute/AwsLocalZonesCard.Local.png) | ![illustration for AwsLocalZonesGroup](../../../aws-q2-2024/Architecture/Compute/AwsLocalZonesGroup.Local.png) |
