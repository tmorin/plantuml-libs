...
```text
aws-q2-2024/Architecture/Compute/AwsBatch
```

```text
include('aws-q2-2024/Architecture/Compute/AwsBatch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Compute/AwsBatch.png) | ![illustration for AwsBatch](../../../aws-q2-2024/Architecture/Compute/AwsBatch.Local.png) | ![illustration for AwsBatchCard](../../../aws-q2-2024/Architecture/Compute/AwsBatchCard.Local.png) | ![illustration for AwsBatchGroup](../../../aws-q2-2024/Architecture/Compute/AwsBatchGroup.Local.png) |
