...
```text
aws-q2-2024/Architecture/Compute/AwsOutpostsFamily
```

```text
include('aws-q2-2024/Architecture/Compute/AwsOutpostsFamily')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Compute/AwsOutpostsFamily.png) | ![illustration for AwsOutpostsFamily](../../../aws-q2-2024/Architecture/Compute/AwsOutpostsFamily.Local.png) | ![illustration for AwsOutpostsFamilyCard](../../../aws-q2-2024/Architecture/Compute/AwsOutpostsFamilyCard.Local.png) | ![illustration for AwsOutpostsFamilyGroup](../../../aws-q2-2024/Architecture/Compute/AwsOutpostsFamilyGroup.Local.png) |
