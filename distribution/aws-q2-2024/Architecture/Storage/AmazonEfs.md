...
```text
aws-q2-2024/Architecture/Storage/AmazonEfs
```

```text
include('aws-q2-2024/Architecture/Storage/AmazonEfs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Storage/AmazonEfs.png) | ![illustration for AmazonEfs](../../../aws-q2-2024/Architecture/Storage/AmazonEfs.Local.png) | ![illustration for AmazonEfsCard](../../../aws-q2-2024/Architecture/Storage/AmazonEfsCard.Local.png) | ![illustration for AmazonEfsGroup](../../../aws-q2-2024/Architecture/Storage/AmazonEfsGroup.Local.png) |
