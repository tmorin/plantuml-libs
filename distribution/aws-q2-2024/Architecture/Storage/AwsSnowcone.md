...
```text
aws-q2-2024/Architecture/Storage/AwsSnowcone
```

```text
include('aws-q2-2024/Architecture/Storage/AwsSnowcone')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Storage/AwsSnowcone.png) | ![illustration for AwsSnowcone](../../../aws-q2-2024/Architecture/Storage/AwsSnowcone.Local.png) | ![illustration for AwsSnowconeCard](../../../aws-q2-2024/Architecture/Storage/AwsSnowconeCard.Local.png) | ![illustration for AwsSnowconeGroup](../../../aws-q2-2024/Architecture/Storage/AwsSnowconeGroup.Local.png) |
