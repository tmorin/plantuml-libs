...
```text
aws-q2-2024/Architecture/EndUserComputing/AmazonWorkSpacesFamily
```

```text
include('aws-q2-2024/Architecture/EndUserComputing/AmazonWorkSpacesFamily')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/EndUserComputing/AmazonWorkSpacesFamily.png) | ![illustration for AmazonWorkSpacesFamily](../../../aws-q2-2024/Architecture/EndUserComputing/AmazonWorkSpacesFamily.Local.png) | ![illustration for AmazonWorkSpacesFamilyCard](../../../aws-q2-2024/Architecture/EndUserComputing/AmazonWorkSpacesFamilyCard.Local.png) | ![illustration for AmazonWorkSpacesFamilyGroup](../../../aws-q2-2024/Architecture/EndUserComputing/AmazonWorkSpacesFamilyGroup.Local.png) |
