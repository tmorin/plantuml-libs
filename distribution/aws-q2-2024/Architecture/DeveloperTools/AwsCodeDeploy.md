...
```text
aws-q2-2024/Architecture/DeveloperTools/AwsCodeDeploy
```

```text
include('aws-q2-2024/Architecture/DeveloperTools/AwsCodeDeploy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/DeveloperTools/AwsCodeDeploy.png) | ![illustration for AwsCodeDeploy](../../../aws-q2-2024/Architecture/DeveloperTools/AwsCodeDeploy.Local.png) | ![illustration for AwsCodeDeployCard](../../../aws-q2-2024/Architecture/DeveloperTools/AwsCodeDeployCard.Local.png) | ![illustration for AwsCodeDeployGroup](../../../aws-q2-2024/Architecture/DeveloperTools/AwsCodeDeployGroup.Local.png) |
