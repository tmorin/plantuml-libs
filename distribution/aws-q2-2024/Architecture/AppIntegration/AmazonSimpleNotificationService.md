...
```text
aws-q2-2024/Architecture/AppIntegration/AmazonSimpleNotificationService
```

```text
include('aws-q2-2024/Architecture/AppIntegration/AmazonSimpleNotificationService')
```
