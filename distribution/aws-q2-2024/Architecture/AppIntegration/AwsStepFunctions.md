...
```text
aws-q2-2024/Architecture/AppIntegration/AwsStepFunctions
```

```text
include('aws-q2-2024/Architecture/AppIntegration/AwsStepFunctions')
```
