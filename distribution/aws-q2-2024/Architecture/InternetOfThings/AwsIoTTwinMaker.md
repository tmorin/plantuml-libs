...
```text
aws-q2-2024/Architecture/InternetOfThings/AwsIoTTwinMaker
```

```text
include('aws-q2-2024/Architecture/InternetOfThings/AwsIoTTwinMaker')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/InternetOfThings/AwsIoTTwinMaker.png) | ![illustration for AwsIoTTwinMaker](../../../aws-q2-2024/Architecture/InternetOfThings/AwsIoTTwinMaker.Local.png) | ![illustration for AwsIoTTwinMakerCard](../../../aws-q2-2024/Architecture/InternetOfThings/AwsIoTTwinMakerCard.Local.png) | ![illustration for AwsIoTTwinMakerGroup](../../../aws-q2-2024/Architecture/InternetOfThings/AwsIoTTwinMakerGroup.Local.png) |
