...
```text
aws-q2-2024/Architecture/Containers/AmazonEcsAnywhere
```

```text
include('aws-q2-2024/Architecture/Containers/AmazonEcsAnywhere')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Containers/AmazonEcsAnywhere.png) | ![illustration for AmazonEcsAnywhere](../../../aws-q2-2024/Architecture/Containers/AmazonEcsAnywhere.Local.png) | ![illustration for AmazonEcsAnywhereCard](../../../aws-q2-2024/Architecture/Containers/AmazonEcsAnywhereCard.Local.png) | ![illustration for AmazonEcsAnywhereGroup](../../../aws-q2-2024/Architecture/Containers/AmazonEcsAnywhereGroup.Local.png) |
