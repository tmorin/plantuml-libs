...
```text
aws-q2-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabase
```

```text
include('aws-q2-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabase.png) | ![illustration for AmazonQuantumLedgerDatabase](../../../aws-q2-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabase.Local.png) | ![illustration for AmazonQuantumLedgerDatabaseCard](../../../aws-q2-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabaseCard.Local.png) | ![illustration for AmazonQuantumLedgerDatabaseGroup](../../../aws-q2-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabaseGroup.Local.png) |
