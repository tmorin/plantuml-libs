...
```text
aws-q2-2024/Architecture/CloudFinancialManagement/AwsApplicationCostProfiler
```

```text
include('aws-q2-2024/Architecture/CloudFinancialManagement/AwsApplicationCostProfiler')
```
