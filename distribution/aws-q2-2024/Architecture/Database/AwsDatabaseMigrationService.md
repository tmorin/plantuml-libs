...
```text
aws-q2-2024/Architecture/Database/AwsDatabaseMigrationService
```

```text
include('aws-q2-2024/Architecture/Database/AwsDatabaseMigrationService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Database/AwsDatabaseMigrationService.png) | ![illustration for AwsDatabaseMigrationService](../../../aws-q2-2024/Architecture/Database/AwsDatabaseMigrationService.Local.png) | ![illustration for AwsDatabaseMigrationServiceCard](../../../aws-q2-2024/Architecture/Database/AwsDatabaseMigrationServiceCard.Local.png) | ![illustration for AwsDatabaseMigrationServiceGroup](../../../aws-q2-2024/Architecture/Database/AwsDatabaseMigrationServiceGroup.Local.png) |
