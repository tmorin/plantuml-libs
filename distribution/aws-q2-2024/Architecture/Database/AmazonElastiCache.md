...
```text
aws-q2-2024/Architecture/Database/AmazonElastiCache
```

```text
include('aws-q2-2024/Architecture/Database/AmazonElastiCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Database/AmazonElastiCache.png) | ![illustration for AmazonElastiCache](../../../aws-q2-2024/Architecture/Database/AmazonElastiCache.Local.png) | ![illustration for AmazonElastiCacheCard](../../../aws-q2-2024/Architecture/Database/AmazonElastiCacheCard.Local.png) | ![illustration for AmazonElastiCacheGroup](../../../aws-q2-2024/Architecture/Database/AmazonElastiCacheGroup.Local.png) |
