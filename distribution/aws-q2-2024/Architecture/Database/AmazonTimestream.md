...
```text
aws-q2-2024/Architecture/Database/AmazonTimestream
```

```text
include('aws-q2-2024/Architecture/Database/AmazonTimestream')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Database/AmazonTimestream.png) | ![illustration for AmazonTimestream](../../../aws-q2-2024/Architecture/Database/AmazonTimestream.Local.png) | ![illustration for AmazonTimestreamCard](../../../aws-q2-2024/Architecture/Database/AmazonTimestreamCard.Local.png) | ![illustration for AmazonTimestreamGroup](../../../aws-q2-2024/Architecture/Database/AmazonTimestreamGroup.Local.png) |
