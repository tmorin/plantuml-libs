...
```text
aws-q2-2024/Architecture/Analytics/AmazonAthena
```

```text
include('aws-q2-2024/Architecture/Analytics/AmazonAthena')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Analytics/AmazonAthena.png) | ![illustration for AmazonAthena](../../../aws-q2-2024/Architecture/Analytics/AmazonAthena.Local.png) | ![illustration for AmazonAthenaCard](../../../aws-q2-2024/Architecture/Analytics/AmazonAthenaCard.Local.png) | ![illustration for AmazonAthenaGroup](../../../aws-q2-2024/Architecture/Analytics/AmazonAthenaGroup.Local.png) |
