...
```text
aws-q2-2024/Architecture/Analytics/AmazonFinSpace
```

```text
include('aws-q2-2024/Architecture/Analytics/AmazonFinSpace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Architecture/Analytics/AmazonFinSpace.png) | ![illustration for AmazonFinSpace](../../../aws-q2-2024/Architecture/Analytics/AmazonFinSpace.Local.png) | ![illustration for AmazonFinSpaceCard](../../../aws-q2-2024/Architecture/Analytics/AmazonFinSpaceCard.Local.png) | ![illustration for AmazonFinSpaceGroup](../../../aws-q2-2024/Architecture/Analytics/AmazonFinSpaceGroup.Local.png) |
