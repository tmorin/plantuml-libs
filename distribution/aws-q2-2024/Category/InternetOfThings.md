...
```text
aws-q2-2024/Category/InternetOfThings
```

```text
include('aws-q2-2024/Category/InternetOfThings')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q2-2024/Category/InternetOfThings.png) | ![illustration for InternetOfThings](../../aws-q2-2024/Category/InternetOfThings.Local.png) | ![illustration for InternetOfThingsCard](../../aws-q2-2024/Category/InternetOfThingsCard.Local.png) | ![illustration for InternetOfThingsGroup](../../aws-q2-2024/Category/InternetOfThingsGroup.Local.png) |
