...
```text
aws-q2-2024/Category/Serverless
```

```text
include('aws-q2-2024/Category/Serverless')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q2-2024/Category/Serverless.png) | ![illustration for Serverless](../../aws-q2-2024/Category/Serverless.Local.png) | ![illustration for ServerlessCard](../../aws-q2-2024/Category/ServerlessCard.Local.png) | ![illustration for ServerlessGroup](../../aws-q2-2024/Category/ServerlessGroup.Local.png) |
