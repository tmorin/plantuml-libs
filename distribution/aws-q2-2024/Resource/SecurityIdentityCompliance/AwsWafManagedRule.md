...
```text
aws-q2-2024/Resource/SecurityIdentityCompliance/AwsWafManagedRule
```

```text
include('aws-q2-2024/Resource/SecurityIdentityCompliance/AwsWafManagedRule')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/SecurityIdentityCompliance/AwsWafManagedRule.png) | ![illustration for AwsWafManagedRule](../../../aws-q2-2024/Resource/SecurityIdentityCompliance/AwsWafManagedRule.Local.png) | ![illustration for AwsWafManagedRuleCard](../../../aws-q2-2024/Resource/SecurityIdentityCompliance/AwsWafManagedRuleCard.Local.png) | ![illustration for AwsWafManagedRuleGroup](../../../aws-q2-2024/Resource/SecurityIdentityCompliance/AwsWafManagedRuleGroup.Local.png) |
