...
```text
aws-q2-2024/Resource/IoT/AwsIoTSiteWiseAssetModel
```

```text
include('aws-q2-2024/Resource/IoT/AwsIoTSiteWiseAssetModel')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/IoT/AwsIoTSiteWiseAssetModel.png) | ![illustration for AwsIoTSiteWiseAssetModel](../../../aws-q2-2024/Resource/IoT/AwsIoTSiteWiseAssetModel.Local.png) | ![illustration for AwsIoTSiteWiseAssetModelCard](../../../aws-q2-2024/Resource/IoT/AwsIoTSiteWiseAssetModelCard.Local.png) | ![illustration for AwsIoTSiteWiseAssetModelGroup](../../../aws-q2-2024/Resource/IoT/AwsIoTSiteWiseAssetModelGroup.Local.png) |
