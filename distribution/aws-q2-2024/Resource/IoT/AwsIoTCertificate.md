...
```text
aws-q2-2024/Resource/IoT/AwsIoTCertificate
```

```text
include('aws-q2-2024/Resource/IoT/AwsIoTCertificate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/IoT/AwsIoTCertificate.png) | ![illustration for AwsIoTCertificate](../../../aws-q2-2024/Resource/IoT/AwsIoTCertificate.Local.png) | ![illustration for AwsIoTCertificateCard](../../../aws-q2-2024/Resource/IoT/AwsIoTCertificateCard.Local.png) | ![illustration for AwsIoTCertificateGroup](../../../aws-q2-2024/Resource/IoT/AwsIoTCertificateGroup.Local.png) |
