...
```text
aws-q2-2024/Resource/IoT/AwsIoTThingIndustrialPc
```

```text
include('aws-q2-2024/Resource/IoT/AwsIoTThingIndustrialPc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/IoT/AwsIoTThingIndustrialPc.png) | ![illustration for AwsIoTThingIndustrialPc](../../../aws-q2-2024/Resource/IoT/AwsIoTThingIndustrialPc.Local.png) | ![illustration for AwsIoTThingIndustrialPcCard](../../../aws-q2-2024/Resource/IoT/AwsIoTThingIndustrialPcCard.Local.png) | ![illustration for AwsIoTThingIndustrialPcGroup](../../../aws-q2-2024/Resource/IoT/AwsIoTThingIndustrialPcGroup.Local.png) |
