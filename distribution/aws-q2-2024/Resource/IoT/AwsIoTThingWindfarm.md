...
```text
aws-q2-2024/Resource/IoT/AwsIoTThingWindfarm
```

```text
include('aws-q2-2024/Resource/IoT/AwsIoTThingWindfarm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/IoT/AwsIoTThingWindfarm.png) | ![illustration for AwsIoTThingWindfarm](../../../aws-q2-2024/Resource/IoT/AwsIoTThingWindfarm.Local.png) | ![illustration for AwsIoTThingWindfarmCard](../../../aws-q2-2024/Resource/IoT/AwsIoTThingWindfarmCard.Local.png) | ![illustration for AwsIoTThingWindfarmGroup](../../../aws-q2-2024/Resource/IoT/AwsIoTThingWindfarmGroup.Local.png) |
