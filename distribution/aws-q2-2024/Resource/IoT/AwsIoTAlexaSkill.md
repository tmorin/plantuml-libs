...
```text
aws-q2-2024/Resource/IoT/AwsIoTAlexaSkill
```

```text
include('aws-q2-2024/Resource/IoT/AwsIoTAlexaSkill')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/IoT/AwsIoTAlexaSkill.png) | ![illustration for AwsIoTAlexaSkill](../../../aws-q2-2024/Resource/IoT/AwsIoTAlexaSkill.Local.png) | ![illustration for AwsIoTAlexaSkillCard](../../../aws-q2-2024/Resource/IoT/AwsIoTAlexaSkillCard.Local.png) | ![illustration for AwsIoTAlexaSkillGroup](../../../aws-q2-2024/Resource/IoT/AwsIoTAlexaSkillGroup.Local.png) |
