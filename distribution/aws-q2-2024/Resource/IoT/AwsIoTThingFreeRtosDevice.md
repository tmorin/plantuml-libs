...
```text
aws-q2-2024/Resource/IoT/AwsIoTThingFreeRtosDevice
```

```text
include('aws-q2-2024/Resource/IoT/AwsIoTThingFreeRtosDevice')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/IoT/AwsIoTThingFreeRtosDevice.png) | ![illustration for AwsIoTThingFreeRtosDevice](../../../aws-q2-2024/Resource/IoT/AwsIoTThingFreeRtosDevice.Local.png) | ![illustration for AwsIoTThingFreeRtosDeviceCard](../../../aws-q2-2024/Resource/IoT/AwsIoTThingFreeRtosDeviceCard.Local.png) | ![illustration for AwsIoTThingFreeRtosDeviceGroup](../../../aws-q2-2024/Resource/IoT/AwsIoTThingFreeRtosDeviceGroup.Local.png) |
