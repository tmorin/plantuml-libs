...
```text
aws-q2-2024/Resource/GroupIcons/PublicSubnet
```

```text
include('aws-q2-2024/Resource/GroupIcons/PublicSubnet')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/GroupIcons/PublicSubnet.png) | ![illustration for PublicSubnet](../../../aws-q2-2024/Resource/GroupIcons/PublicSubnet.Local.png) | ![illustration for PublicSubnetCard](../../../aws-q2-2024/Resource/GroupIcons/PublicSubnetCard.Local.png) | ![illustration for PublicSubnetGroup](../../../aws-q2-2024/Resource/GroupIcons/PublicSubnetGroup.Local.png) |
