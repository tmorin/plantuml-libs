...
```text
aws-q2-2024/Resource/GroupIcons/Cloud
```

```text
include('aws-q2-2024/Resource/GroupIcons/Cloud')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/GroupIcons/Cloud.png) | ![illustration for Cloud](../../../aws-q2-2024/Resource/GroupIcons/Cloud.Local.png) | ![illustration for CloudCard](../../../aws-q2-2024/Resource/GroupIcons/CloudCard.Local.png) | ![illustration for CloudGroup](../../../aws-q2-2024/Resource/GroupIcons/CloudGroup.Local.png) |
