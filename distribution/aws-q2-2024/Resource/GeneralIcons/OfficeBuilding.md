...
```text
aws-q2-2024/Resource/GeneralIcons/OfficeBuilding
```

```text
include('aws-q2-2024/Resource/GeneralIcons/OfficeBuilding')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/GeneralIcons/OfficeBuilding.png) | ![illustration for OfficeBuilding](../../../aws-q2-2024/Resource/GeneralIcons/OfficeBuilding.Local.png) | ![illustration for OfficeBuildingCard](../../../aws-q2-2024/Resource/GeneralIcons/OfficeBuildingCard.Local.png) | ![illustration for OfficeBuildingGroup](../../../aws-q2-2024/Resource/GeneralIcons/OfficeBuildingGroup.Local.png) |
