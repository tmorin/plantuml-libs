...
```text
aws-q2-2024/Resource/GeneralIcons/Document
```

```text
include('aws-q2-2024/Resource/GeneralIcons/Document')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/GeneralIcons/Document.png) | ![illustration for Document](../../../aws-q2-2024/Resource/GeneralIcons/Document.Local.png) | ![illustration for DocumentCard](../../../aws-q2-2024/Resource/GeneralIcons/DocumentCard.Local.png) | ![illustration for DocumentGroup](../../../aws-q2-2024/Resource/GeneralIcons/DocumentGroup.Local.png) |
