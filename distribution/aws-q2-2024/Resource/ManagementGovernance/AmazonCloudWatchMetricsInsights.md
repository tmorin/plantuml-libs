...
```text
aws-q2-2024/Resource/ManagementGovernance/AmazonCloudWatchMetricsInsights
```

```text
include('aws-q2-2024/Resource/ManagementGovernance/AmazonCloudWatchMetricsInsights')
```
