...
```text
aws-q2-2024/Resource/ManagementGovernance/AwsOrganizationsAccount
```

```text
include('aws-q2-2024/Resource/ManagementGovernance/AwsOrganizationsAccount')
```
