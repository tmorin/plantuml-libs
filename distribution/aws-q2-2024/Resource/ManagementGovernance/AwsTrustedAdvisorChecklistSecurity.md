...
```text
aws-q2-2024/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistSecurity
```

```text
include('aws-q2-2024/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistSecurity')
```
