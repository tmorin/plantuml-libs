...
```text
aws-q2-2024/Resource/ManagementGovernance/AwsSystemsManagerParameterStore
```

```text
include('aws-q2-2024/Resource/ManagementGovernance/AwsSystemsManagerParameterStore')
```
