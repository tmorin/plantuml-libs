...
```text
aws-q2-2024/Resource/ManagementGovernance/AwsOpsWorksInstances
```

```text
include('aws-q2-2024/Resource/ManagementGovernance/AwsOpsWorksInstances')
```
