...
```text
aws-q2-2024/Resource/ManagementGovernance/AmazonCloudWatchEventEventBased
```

```text
include('aws-q2-2024/Resource/ManagementGovernance/AmazonCloudWatchEventEventBased')
```
