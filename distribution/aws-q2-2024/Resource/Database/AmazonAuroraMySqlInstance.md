...
```text
aws-q2-2024/Resource/Database/AmazonAuroraMySqlInstance
```

```text
include('aws-q2-2024/Resource/Database/AmazonAuroraMySqlInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/Database/AmazonAuroraMySqlInstance.png) | ![illustration for AmazonAuroraMySqlInstance](../../../aws-q2-2024/Resource/Database/AmazonAuroraMySqlInstance.Local.png) | ![illustration for AmazonAuroraMySqlInstanceCard](../../../aws-q2-2024/Resource/Database/AmazonAuroraMySqlInstanceCard.Local.png) | ![illustration for AmazonAuroraMySqlInstanceGroup](../../../aws-q2-2024/Resource/Database/AmazonAuroraMySqlInstanceGroup.Local.png) |
