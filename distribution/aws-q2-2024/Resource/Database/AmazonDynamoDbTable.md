...
```text
aws-q2-2024/Resource/Database/AmazonDynamoDbTable
```

```text
include('aws-q2-2024/Resource/Database/AmazonDynamoDbTable')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/Database/AmazonDynamoDbTable.png) | ![illustration for AmazonDynamoDbTable](../../../aws-q2-2024/Resource/Database/AmazonDynamoDbTable.Local.png) | ![illustration for AmazonDynamoDbTableCard](../../../aws-q2-2024/Resource/Database/AmazonDynamoDbTableCard.Local.png) | ![illustration for AmazonDynamoDbTableGroup](../../../aws-q2-2024/Resource/Database/AmazonDynamoDbTableGroup.Local.png) |
