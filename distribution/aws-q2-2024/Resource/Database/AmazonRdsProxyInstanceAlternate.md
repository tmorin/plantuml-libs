...
```text
aws-q2-2024/Resource/Database/AmazonRdsProxyInstanceAlternate
```

```text
include('aws-q2-2024/Resource/Database/AmazonRdsProxyInstanceAlternate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/Database/AmazonRdsProxyInstanceAlternate.png) | ![illustration for AmazonRdsProxyInstanceAlternate](../../../aws-q2-2024/Resource/Database/AmazonRdsProxyInstanceAlternate.Local.png) | ![illustration for AmazonRdsProxyInstanceAlternateCard](../../../aws-q2-2024/Resource/Database/AmazonRdsProxyInstanceAlternateCard.Local.png) | ![illustration for AmazonRdsProxyInstanceAlternateGroup](../../../aws-q2-2024/Resource/Database/AmazonRdsProxyInstanceAlternateGroup.Local.png) |
