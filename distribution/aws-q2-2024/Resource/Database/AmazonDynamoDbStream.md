...
```text
aws-q2-2024/Resource/Database/AmazonDynamoDbStream
```

```text
include('aws-q2-2024/Resource/Database/AmazonDynamoDbStream')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/Database/AmazonDynamoDbStream.png) | ![illustration for AmazonDynamoDbStream](../../../aws-q2-2024/Resource/Database/AmazonDynamoDbStream.Local.png) | ![illustration for AmazonDynamoDbStreamCard](../../../aws-q2-2024/Resource/Database/AmazonDynamoDbStreamCard.Local.png) | ![illustration for AmazonDynamoDbStreamGroup](../../../aws-q2-2024/Resource/Database/AmazonDynamoDbStreamGroup.Local.png) |
