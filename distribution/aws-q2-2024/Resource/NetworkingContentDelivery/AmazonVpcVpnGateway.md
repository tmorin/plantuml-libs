...
```text
aws-q2-2024/Resource/NetworkingContentDelivery/AmazonVpcVpnGateway
```

```text
include('aws-q2-2024/Resource/NetworkingContentDelivery/AmazonVpcVpnGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2024/Resource/NetworkingContentDelivery/AmazonVpcVpnGateway.png) | ![illustration for AmazonVpcVpnGateway](../../../aws-q2-2024/Resource/NetworkingContentDelivery/AmazonVpcVpnGateway.Local.png) | ![illustration for AmazonVpcVpnGatewayCard](../../../aws-q2-2024/Resource/NetworkingContentDelivery/AmazonVpcVpnGatewayCard.Local.png) | ![illustration for AmazonVpcVpnGatewayGroup](../../../aws-q2-2024/Resource/NetworkingContentDelivery/AmazonVpcVpnGatewayGroup.Local.png) |
