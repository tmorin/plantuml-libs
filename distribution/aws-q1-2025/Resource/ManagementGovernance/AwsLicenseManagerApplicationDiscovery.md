...
```text
aws-q1-2025/Resource/ManagementGovernance/AwsLicenseManagerApplicationDiscovery
```

```text
include('aws-q1-2025/Resource/ManagementGovernance/AwsLicenseManagerApplicationDiscovery')
```
