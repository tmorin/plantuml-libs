...
```text
aws-q1-2025/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistFaultTolerant
```

```text
include('aws-q1-2025/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistFaultTolerant')
```
