...
```text
aws-q1-2025/Resource/ManagementGovernance/AwsOrganizationsAccount
```

```text
include('aws-q1-2025/Resource/ManagementGovernance/AwsOrganizationsAccount')
```
