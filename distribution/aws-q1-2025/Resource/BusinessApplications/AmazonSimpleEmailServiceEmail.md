...
```text
aws-q1-2025/Resource/BusinessApplications/AmazonSimpleEmailServiceEmail
```

```text
include('aws-q1-2025/Resource/BusinessApplications/AmazonSimpleEmailServiceEmail')
```
