...
```text
aws-q1-2025/Resource/Storage/AmazonElasticFileSystemFileSystem
```

```text
include('aws-q1-2025/Resource/Storage/AmazonElasticFileSystemFileSystem')
```
