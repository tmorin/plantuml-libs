...
```text
aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3IntelligentTiering
```

```text
include('aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3IntelligentTiering')
```
