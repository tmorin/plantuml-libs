...
```text
aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3GlacierInstantRetrieval
```

```text
include('aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3GlacierInstantRetrieval')
```
