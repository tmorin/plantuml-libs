...
```text
aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3StandardIa
```

```text
include('aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3StandardIa')
```
