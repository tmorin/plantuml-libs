...
```text
aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3MultiRegionAccessPoints
```

```text
include('aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3MultiRegionAccessPoints')
```
