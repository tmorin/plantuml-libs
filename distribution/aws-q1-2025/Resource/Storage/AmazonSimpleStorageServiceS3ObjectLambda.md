...
```text
aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3ObjectLambda
```

```text
include('aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3ObjectLambda')
```
