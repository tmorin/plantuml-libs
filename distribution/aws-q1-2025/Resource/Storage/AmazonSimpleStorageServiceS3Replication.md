...
```text
aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3Replication
```

```text
include('aws-q1-2025/Resource/Storage/AmazonSimpleStorageServiceS3Replication')
```
