...
```text
aws-q1-2025/Resource/Storage/AwsBackupRecoveryPointObjective
```

```text
include('aws-q1-2025/Resource/Storage/AwsBackupRecoveryPointObjective')
```
