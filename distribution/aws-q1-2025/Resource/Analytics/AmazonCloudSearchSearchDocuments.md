...
```text
aws-q1-2025/Resource/Analytics/AmazonCloudSearchSearchDocuments
```

```text
include('aws-q1-2025/Resource/Analytics/AmazonCloudSearchSearchDocuments')
```
