...
```text
aws-q1-2025/Resource/IoT/AwsIoTDeviceDefenderIoTDeviceJobs
```

```text
include('aws-q1-2025/Resource/IoT/AwsIoTDeviceDefenderIoTDeviceJobs')
```
