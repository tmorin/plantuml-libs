...
```text
aws-q1-2025/Resource/IoT/AwsIoTThingFreeRtosDevice
```

```text
include('aws-q1-2025/Resource/IoT/AwsIoTThingFreeRtosDevice')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2025/Resource/IoT/AwsIoTThingFreeRtosDevice.png) | ![illustration for AwsIoTThingFreeRtosDevice](../../../aws-q1-2025/Resource/IoT/AwsIoTThingFreeRtosDevice.Local.png) | ![illustration for AwsIoTThingFreeRtosDeviceCard](../../../aws-q1-2025/Resource/IoT/AwsIoTThingFreeRtosDeviceCard.Local.png) | ![illustration for AwsIoTThingFreeRtosDeviceGroup](../../../aws-q1-2025/Resource/IoT/AwsIoTThingFreeRtosDeviceGroup.Local.png) |
