...
```text
aws-q1-2025/Resource/IoT/AwsIoTThingTemperatureHumiditySensor
```

```text
include('aws-q1-2025/Resource/IoT/AwsIoTThingTemperatureHumiditySensor')
```
