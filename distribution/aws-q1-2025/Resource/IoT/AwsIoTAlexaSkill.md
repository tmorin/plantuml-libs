...
```text
aws-q1-2025/Resource/IoT/AwsIoTAlexaSkill
```

```text
include('aws-q1-2025/Resource/IoT/AwsIoTAlexaSkill')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2025/Resource/IoT/AwsIoTAlexaSkill.png) | ![illustration for AwsIoTAlexaSkill](../../../aws-q1-2025/Resource/IoT/AwsIoTAlexaSkill.Local.png) | ![illustration for AwsIoTAlexaSkillCard](../../../aws-q1-2025/Resource/IoT/AwsIoTAlexaSkillCard.Local.png) | ![illustration for AwsIoTAlexaSkillGroup](../../../aws-q1-2025/Resource/IoT/AwsIoTAlexaSkillGroup.Local.png) |
