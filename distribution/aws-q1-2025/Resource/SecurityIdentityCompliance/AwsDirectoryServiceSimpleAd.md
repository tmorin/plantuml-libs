...
```text
aws-q1-2025/Resource/SecurityIdentityCompliance/AwsDirectoryServiceSimpleAd
```

```text
include('aws-q1-2025/Resource/SecurityIdentityCompliance/AwsDirectoryServiceSimpleAd')
```
