...
```text
aws-q1-2025/Resource/SecurityIdentityCompliance/AwsShieldAwsShieldAdvanced
```

```text
include('aws-q1-2025/Resource/SecurityIdentityCompliance/AwsShieldAwsShieldAdvanced')
```
