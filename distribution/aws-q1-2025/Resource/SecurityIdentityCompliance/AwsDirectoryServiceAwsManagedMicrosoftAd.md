...
```text
aws-q1-2025/Resource/SecurityIdentityCompliance/AwsDirectoryServiceAwsManagedMicrosoftAd
```

```text
include('aws-q1-2025/Resource/SecurityIdentityCompliance/AwsDirectoryServiceAwsManagedMicrosoftAd')
```
