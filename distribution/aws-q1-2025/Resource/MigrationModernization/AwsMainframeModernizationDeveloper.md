...
```text
aws-q1-2025/Resource/MigrationModernization/AwsMainframeModernizationDeveloper
```

```text
include('aws-q1-2025/Resource/MigrationModernization/AwsMainframeModernizationDeveloper')
```
