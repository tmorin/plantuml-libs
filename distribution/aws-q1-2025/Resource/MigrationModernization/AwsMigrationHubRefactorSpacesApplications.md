...
```text
aws-q1-2025/Resource/MigrationModernization/AwsMigrationHubRefactorSpacesApplications
```

```text
include('aws-q1-2025/Resource/MigrationModernization/AwsMigrationHubRefactorSpacesApplications')
```
