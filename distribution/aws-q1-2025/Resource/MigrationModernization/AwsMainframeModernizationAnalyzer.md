...
```text
aws-q1-2025/Resource/MigrationModernization/AwsMainframeModernizationAnalyzer
```

```text
include('aws-q1-2025/Resource/MigrationModernization/AwsMainframeModernizationAnalyzer')
```
