...
```text
aws-q1-2025/Resource/MigrationModernization/AwsMainframeModernizationCompiler
```

```text
include('aws-q1-2025/Resource/MigrationModernization/AwsMainframeModernizationCompiler')
```
