...
```text
aws-q1-2025/Resource/ApplicationIntegration/AmazonEventBridgeSchema
```

```text
include('aws-q1-2025/Resource/ApplicationIntegration/AmazonEventBridgeSchema')
```
