...
```text
aws-q1-2025/Resource/ApplicationIntegration/AmazonEventBridgeRule
```

```text
include('aws-q1-2025/Resource/ApplicationIntegration/AmazonEventBridgeRule')
```
