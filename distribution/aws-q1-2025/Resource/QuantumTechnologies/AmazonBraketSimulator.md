...
```text
aws-q1-2025/Resource/QuantumTechnologies/AmazonBraketSimulator
```

```text
include('aws-q1-2025/Resource/QuantumTechnologies/AmazonBraketSimulator')
```
