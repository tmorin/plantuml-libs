...
```text
aws-q1-2025/Resource/QuantumTechnologies/AmazonBraketNoiseSimulator
```

```text
include('aws-q1-2025/Resource/QuantumTechnologies/AmazonBraketNoiseSimulator')
```
