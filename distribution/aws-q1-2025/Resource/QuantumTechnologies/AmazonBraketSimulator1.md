...
```text
aws-q1-2025/Resource/QuantumTechnologies/AmazonBraketSimulator1
```

```text
include('aws-q1-2025/Resource/QuantumTechnologies/AmazonBraketSimulator1')
```
