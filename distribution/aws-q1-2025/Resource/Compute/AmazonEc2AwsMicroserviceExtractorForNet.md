...
```text
aws-q1-2025/Resource/Compute/AmazonEc2AwsMicroserviceExtractorForNet
```

```text
include('aws-q1-2025/Resource/Compute/AmazonEc2AwsMicroserviceExtractorForNet')
```
