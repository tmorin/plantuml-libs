...
```text
aws-q1-2025/Resource/Blockchain/AmazonManagedBlockchainBlockchain
```

```text
include('aws-q1-2025/Resource/Blockchain/AmazonManagedBlockchainBlockchain')
```
