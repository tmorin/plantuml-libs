...
```text
aws-q1-2025/Resource/Containers/AmazonElasticContainerRegistryImage
```

```text
include('aws-q1-2025/Resource/Containers/AmazonElasticContainerRegistryImage')
```
