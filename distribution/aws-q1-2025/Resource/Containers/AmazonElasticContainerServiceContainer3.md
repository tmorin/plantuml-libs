...
```text
aws-q1-2025/Resource/Containers/AmazonElasticContainerServiceContainer3
```

```text
include('aws-q1-2025/Resource/Containers/AmazonElasticContainerServiceContainer3')
```
