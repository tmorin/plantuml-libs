...
```text
aws-q1-2025/Resource/Database/AmazonAuroraOracleInstanceAlternate
```

```text
include('aws-q1-2025/Resource/Database/AmazonAuroraOracleInstanceAlternate')
```
