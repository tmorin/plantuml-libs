...
```text
aws-q1-2025/Resource/Database/AmazonAuroraAmazonRdsInstanceAternate
```

```text
include('aws-q1-2025/Resource/Database/AmazonAuroraAmazonRdsInstanceAternate')
```
