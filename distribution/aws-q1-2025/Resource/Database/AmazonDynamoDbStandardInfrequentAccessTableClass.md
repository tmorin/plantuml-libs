...
```text
aws-q1-2025/Resource/Database/AmazonDynamoDbStandardInfrequentAccessTableClass
```

```text
include('aws-q1-2025/Resource/Database/AmazonDynamoDbStandardInfrequentAccessTableClass')
```
