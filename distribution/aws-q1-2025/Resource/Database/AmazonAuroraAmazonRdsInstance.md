...
```text
aws-q1-2025/Resource/Database/AmazonAuroraAmazonRdsInstance
```

```text
include('aws-q1-2025/Resource/Database/AmazonAuroraAmazonRdsInstance')
```
