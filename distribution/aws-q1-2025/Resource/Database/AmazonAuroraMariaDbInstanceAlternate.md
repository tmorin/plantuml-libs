...
```text
aws-q1-2025/Resource/Database/AmazonAuroraMariaDbInstanceAlternate
```

```text
include('aws-q1-2025/Resource/Database/AmazonAuroraMariaDbInstanceAlternate')
```
