...
```text
aws-q1-2025/Resource/Database/AmazonDynamoDbAmazonDynamoDbAccelerator
```

```text
include('aws-q1-2025/Resource/Database/AmazonDynamoDbAmazonDynamoDbAccelerator')
```
