...
```text
aws-q1-2025/Resource/NetworkingContentDelivery/AmazonRoute53ResolverQueryLogging
```

```text
include('aws-q1-2025/Resource/NetworkingContentDelivery/AmazonRoute53ResolverQueryLogging')
```
