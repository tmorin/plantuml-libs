...
```text
aws-q1-2025/Resource/NetworkingContentDelivery/AwsDirectConnectGateway
```

```text
include('aws-q1-2025/Resource/NetworkingContentDelivery/AwsDirectConnectGateway')
```
