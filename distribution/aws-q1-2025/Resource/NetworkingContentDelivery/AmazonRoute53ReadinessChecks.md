...
```text
aws-q1-2025/Resource/NetworkingContentDelivery/AmazonRoute53ReadinessChecks
```

```text
include('aws-q1-2025/Resource/NetworkingContentDelivery/AmazonRoute53ReadinessChecks')
```
