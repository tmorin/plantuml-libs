...
```text
aws-q1-2025/Resource/NetworkingContentDelivery/AwsTransitGatewayAttachment
```

```text
include('aws-q1-2025/Resource/NetworkingContentDelivery/AwsTransitGatewayAttachment')
```
