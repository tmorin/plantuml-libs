...
```text
aws-q1-2025/Architecture/InternetOfThings/AwsIoTDeviceDefender
```

```text
include('aws-q1-2025/Architecture/InternetOfThings/AwsIoTDeviceDefender')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2025/Architecture/InternetOfThings/AwsIoTDeviceDefender.png) | ![illustration for AwsIoTDeviceDefender](../../../aws-q1-2025/Architecture/InternetOfThings/AwsIoTDeviceDefender.Local.png) | ![illustration for AwsIoTDeviceDefenderCard](../../../aws-q1-2025/Architecture/InternetOfThings/AwsIoTDeviceDefenderCard.Local.png) | ![illustration for AwsIoTDeviceDefenderGroup](../../../aws-q1-2025/Architecture/InternetOfThings/AwsIoTDeviceDefenderGroup.Local.png) |
