...
```text
aws-q1-2025/Architecture/Compute/NiceEnginFrame
```

```text
include('aws-q1-2025/Architecture/Compute/NiceEnginFrame')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2025/Architecture/Compute/NiceEnginFrame.png) | ![illustration for NiceEnginFrame](../../../aws-q1-2025/Architecture/Compute/NiceEnginFrame.Local.png) | ![illustration for NiceEnginFrameCard](../../../aws-q1-2025/Architecture/Compute/NiceEnginFrameCard.Local.png) | ![illustration for NiceEnginFrameGroup](../../../aws-q1-2025/Architecture/Compute/NiceEnginFrameGroup.Local.png) |
