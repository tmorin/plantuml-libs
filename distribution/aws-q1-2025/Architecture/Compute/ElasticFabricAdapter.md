...
```text
aws-q1-2025/Architecture/Compute/ElasticFabricAdapter
```

```text
include('aws-q1-2025/Architecture/Compute/ElasticFabricAdapter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2025/Architecture/Compute/ElasticFabricAdapter.png) | ![illustration for ElasticFabricAdapter](../../../aws-q1-2025/Architecture/Compute/ElasticFabricAdapter.Local.png) | ![illustration for ElasticFabricAdapterCard](../../../aws-q1-2025/Architecture/Compute/ElasticFabricAdapterCard.Local.png) | ![illustration for ElasticFabricAdapterGroup](../../../aws-q1-2025/Architecture/Compute/ElasticFabricAdapterGroup.Local.png) |
