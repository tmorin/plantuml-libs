...
```text
aws-q1-2025/Architecture/ManagementGovernance/AwsProton
```

```text
include('aws-q1-2025/Architecture/ManagementGovernance/AwsProton')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2025/Architecture/ManagementGovernance/AwsProton.png) | ![illustration for AwsProton](../../../aws-q1-2025/Architecture/ManagementGovernance/AwsProton.Local.png) | ![illustration for AwsProtonCard](../../../aws-q1-2025/Architecture/ManagementGovernance/AwsProtonCard.Local.png) | ![illustration for AwsProtonGroup](../../../aws-q1-2025/Architecture/ManagementGovernance/AwsProtonGroup.Local.png) |
