...
```text
aws-q1-2025/Architecture/Storage/AmazonFSxForLustre
```

```text
include('aws-q1-2025/Architecture/Storage/AmazonFSxForLustre')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2025/Architecture/Storage/AmazonFSxForLustre.png) | ![illustration for AmazonFSxForLustre](../../../aws-q1-2025/Architecture/Storage/AmazonFSxForLustre.Local.png) | ![illustration for AmazonFSxForLustreCard](../../../aws-q1-2025/Architecture/Storage/AmazonFSxForLustreCard.Local.png) | ![illustration for AmazonFSxForLustreGroup](../../../aws-q1-2025/Architecture/Storage/AmazonFSxForLustreGroup.Local.png) |
