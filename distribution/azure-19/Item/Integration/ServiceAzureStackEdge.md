...
```text
azure-19/Item/Integration/ServiceAzureStackEdge
```

```text
include('azure-19/Item/Integration/ServiceAzureStackEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Integration/ServiceAzureStackEdge.png) | ![illustration for ServiceAzureStackEdge](../../../azure-19/Item/Integration/ServiceAzureStackEdge.Local.png) | ![illustration for ServiceAzureStackEdgeCard](../../../azure-19/Item/Integration/ServiceAzureStackEdgeCard.Local.png) | ![illustration for ServiceAzureStackEdgeGroup](../../../azure-19/Item/Integration/ServiceAzureStackEdgeGroup.Local.png) |
