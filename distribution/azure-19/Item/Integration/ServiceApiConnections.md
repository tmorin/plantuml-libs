...
```text
azure-19/Item/Integration/ServiceApiConnections
```

```text
include('azure-19/Item/Integration/ServiceApiConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Integration/ServiceApiConnections.png) | ![illustration for ServiceApiConnections](../../../azure-19/Item/Integration/ServiceApiConnections.Local.png) | ![illustration for ServiceApiConnectionsCard](../../../azure-19/Item/Integration/ServiceApiConnectionsCard.Local.png) | ![illustration for ServiceApiConnectionsGroup](../../../azure-19/Item/Integration/ServiceApiConnectionsGroup.Local.png) |
