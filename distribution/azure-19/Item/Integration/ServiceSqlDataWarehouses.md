...
```text
azure-19/Item/Integration/ServiceSqlDataWarehouses
```

```text
include('azure-19/Item/Integration/ServiceSqlDataWarehouses')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Integration/ServiceSqlDataWarehouses.png) | ![illustration for ServiceSqlDataWarehouses](../../../azure-19/Item/Integration/ServiceSqlDataWarehouses.Local.png) | ![illustration for ServiceSqlDataWarehousesCard](../../../azure-19/Item/Integration/ServiceSqlDataWarehousesCard.Local.png) | ![illustration for ServiceSqlDataWarehousesGroup](../../../azure-19/Item/Integration/ServiceSqlDataWarehousesGroup.Local.png) |
