...
```text
azure-19/Item/Integration/ServiceDataFactories
```

```text
include('azure-19/Item/Integration/ServiceDataFactories')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Integration/ServiceDataFactories.png) | ![illustration for ServiceDataFactories](../../../azure-19/Item/Integration/ServiceDataFactories.Local.png) | ![illustration for ServiceDataFactoriesCard](../../../azure-19/Item/Integration/ServiceDataFactoriesCard.Local.png) | ![illustration for ServiceDataFactoriesGroup](../../../azure-19/Item/Integration/ServiceDataFactoriesGroup.Local.png) |
