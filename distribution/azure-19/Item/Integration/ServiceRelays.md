...
```text
azure-19/Item/Integration/ServiceRelays
```

```text
include('azure-19/Item/Integration/ServiceRelays')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Integration/ServiceRelays.png) | ![illustration for ServiceRelays](../../../azure-19/Item/Integration/ServiceRelays.Local.png) | ![illustration for ServiceRelaysCard](../../../azure-19/Item/Integration/ServiceRelaysCard.Local.png) | ![illustration for ServiceRelaysGroup](../../../azure-19/Item/Integration/ServiceRelaysGroup.Local.png) |
