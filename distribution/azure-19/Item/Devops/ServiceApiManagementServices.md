...
```text
azure-19/Item/Devops/ServiceApiManagementServices
```

```text
include('azure-19/Item/Devops/ServiceApiManagementServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Devops/ServiceApiManagementServices.png) | ![illustration for ServiceApiManagementServices](../../../azure-19/Item/Devops/ServiceApiManagementServices.Local.png) | ![illustration for ServiceApiManagementServicesCard](../../../azure-19/Item/Devops/ServiceApiManagementServicesCard.Local.png) | ![illustration for ServiceApiManagementServicesGroup](../../../azure-19/Item/Devops/ServiceApiManagementServicesGroup.Local.png) |
