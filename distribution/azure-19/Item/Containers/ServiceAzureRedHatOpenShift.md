...
```text
azure-19/Item/Containers/ServiceAzureRedHatOpenShift
```

```text
include('azure-19/Item/Containers/ServiceAzureRedHatOpenShift')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Containers/ServiceAzureRedHatOpenShift.png) | ![illustration for ServiceAzureRedHatOpenShift](../../../azure-19/Item/Containers/ServiceAzureRedHatOpenShift.Local.png) | ![illustration for ServiceAzureRedHatOpenShiftCard](../../../azure-19/Item/Containers/ServiceAzureRedHatOpenShiftCard.Local.png) | ![illustration for ServiceAzureRedHatOpenShiftGroup](../../../azure-19/Item/Containers/ServiceAzureRedHatOpenShiftGroup.Local.png) |
