...
```text
azure-19/Item/Iot/ServiceFunctionApps
```

```text
include('azure-19/Item/Iot/ServiceFunctionApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Iot/ServiceFunctionApps.png) | ![illustration for ServiceFunctionApps](../../../azure-19/Item/Iot/ServiceFunctionApps.Local.png) | ![illustration for ServiceFunctionAppsCard](../../../azure-19/Item/Iot/ServiceFunctionAppsCard.Local.png) | ![illustration for ServiceFunctionAppsGroup](../../../azure-19/Item/Iot/ServiceFunctionAppsGroup.Local.png) |
