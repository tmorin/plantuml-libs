...
```text
azure-19/Item/Iot/ServiceEventGridSubscriptions
```

```text
include('azure-19/Item/Iot/ServiceEventGridSubscriptions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Iot/ServiceEventGridSubscriptions.png) | ![illustration for ServiceEventGridSubscriptions](../../../azure-19/Item/Iot/ServiceEventGridSubscriptions.Local.png) | ![illustration for ServiceEventGridSubscriptionsCard](../../../azure-19/Item/Iot/ServiceEventGridSubscriptionsCard.Local.png) | ![illustration for ServiceEventGridSubscriptionsGroup](../../../azure-19/Item/Iot/ServiceEventGridSubscriptionsGroup.Local.png) |
