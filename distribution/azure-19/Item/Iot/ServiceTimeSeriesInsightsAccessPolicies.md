...
```text
azure-19/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies
```

```text
include('azure-19/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies.png) | ![illustration for ServiceTimeSeriesInsightsAccessPolicies](../../../azure-19/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies.Local.png) | ![illustration for ServiceTimeSeriesInsightsAccessPoliciesCard](../../../azure-19/Item/Iot/ServiceTimeSeriesInsightsAccessPoliciesCard.Local.png) | ![illustration for ServiceTimeSeriesInsightsAccessPoliciesGroup](../../../azure-19/Item/Iot/ServiceTimeSeriesInsightsAccessPoliciesGroup.Local.png) |
