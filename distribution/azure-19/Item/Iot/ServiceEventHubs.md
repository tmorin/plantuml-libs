...
```text
azure-19/Item/Iot/ServiceEventHubs
```

```text
include('azure-19/Item/Iot/ServiceEventHubs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Iot/ServiceEventHubs.png) | ![illustration for ServiceEventHubs](../../../azure-19/Item/Iot/ServiceEventHubs.Local.png) | ![illustration for ServiceEventHubsCard](../../../azure-19/Item/Iot/ServiceEventHubsCard.Local.png) | ![illustration for ServiceEventHubsGroup](../../../azure-19/Item/Iot/ServiceEventHubsGroup.Local.png) |
