...
```text
azure-19/Item/Iot/ServiceLogicApps
```

```text
include('azure-19/Item/Iot/ServiceLogicApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Iot/ServiceLogicApps.png) | ![illustration for ServiceLogicApps](../../../azure-19/Item/Iot/ServiceLogicApps.Local.png) | ![illustration for ServiceLogicAppsCard](../../../azure-19/Item/Iot/ServiceLogicAppsCard.Local.png) | ![illustration for ServiceLogicAppsGroup](../../../azure-19/Item/Iot/ServiceLogicAppsGroup.Local.png) |
