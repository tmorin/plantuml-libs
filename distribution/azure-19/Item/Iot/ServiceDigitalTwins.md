...
```text
azure-19/Item/Iot/ServiceDigitalTwins
```

```text
include('azure-19/Item/Iot/ServiceDigitalTwins')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Iot/ServiceDigitalTwins.png) | ![illustration for ServiceDigitalTwins](../../../azure-19/Item/Iot/ServiceDigitalTwins.Local.png) | ![illustration for ServiceDigitalTwinsCard](../../../azure-19/Item/Iot/ServiceDigitalTwinsCard.Local.png) | ![illustration for ServiceDigitalTwinsGroup](../../../azure-19/Item/Iot/ServiceDigitalTwinsGroup.Local.png) |
