...
```text
azure-19/Item/Intune/ServiceDeviceSecurityGoogle
```

```text
include('azure-19/Item/Intune/ServiceDeviceSecurityGoogle')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Intune/ServiceDeviceSecurityGoogle.png) | ![illustration for ServiceDeviceSecurityGoogle](../../../azure-19/Item/Intune/ServiceDeviceSecurityGoogle.Local.png) | ![illustration for ServiceDeviceSecurityGoogleCard](../../../azure-19/Item/Intune/ServiceDeviceSecurityGoogleCard.Local.png) | ![illustration for ServiceDeviceSecurityGoogleGroup](../../../azure-19/Item/Intune/ServiceDeviceSecurityGoogleGroup.Local.png) |
