...
```text
azure-19/Item/Intune/ServiceIntuneForEducation
```

```text
include('azure-19/Item/Intune/ServiceIntuneForEducation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Intune/ServiceIntuneForEducation.png) | ![illustration for ServiceIntuneForEducation](../../../azure-19/Item/Intune/ServiceIntuneForEducation.Local.png) | ![illustration for ServiceIntuneForEducationCard](../../../azure-19/Item/Intune/ServiceIntuneForEducationCard.Local.png) | ![illustration for ServiceIntuneForEducationGroup](../../../azure-19/Item/Intune/ServiceIntuneForEducationGroup.Local.png) |
