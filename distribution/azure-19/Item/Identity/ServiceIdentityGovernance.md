...
```text
azure-19/Item/Identity/ServiceIdentityGovernance
```

```text
include('azure-19/Item/Identity/ServiceIdentityGovernance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Identity/ServiceIdentityGovernance.png) | ![illustration for ServiceIdentityGovernance](../../../azure-19/Item/Identity/ServiceIdentityGovernance.Local.png) | ![illustration for ServiceIdentityGovernanceCard](../../../azure-19/Item/Identity/ServiceIdentityGovernanceCard.Local.png) | ![illustration for ServiceIdentityGovernanceGroup](../../../azure-19/Item/Identity/ServiceIdentityGovernanceGroup.Local.png) |
