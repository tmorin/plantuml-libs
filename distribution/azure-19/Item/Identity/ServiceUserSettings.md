...
```text
azure-19/Item/Identity/ServiceUserSettings
```

```text
include('azure-19/Item/Identity/ServiceUserSettings')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Identity/ServiceUserSettings.png) | ![illustration for ServiceUserSettings](../../../azure-19/Item/Identity/ServiceUserSettings.Local.png) | ![illustration for ServiceUserSettingsCard](../../../azure-19/Item/Identity/ServiceUserSettingsCard.Local.png) | ![illustration for ServiceUserSettingsGroup](../../../azure-19/Item/Identity/ServiceUserSettingsGroup.Local.png) |
