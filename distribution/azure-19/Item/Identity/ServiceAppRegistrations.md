...
```text
azure-19/Item/Identity/ServiceAppRegistrations
```

```text
include('azure-19/Item/Identity/ServiceAppRegistrations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Identity/ServiceAppRegistrations.png) | ![illustration for ServiceAppRegistrations](../../../azure-19/Item/Identity/ServiceAppRegistrations.Local.png) | ![illustration for ServiceAppRegistrationsCard](../../../azure-19/Item/Identity/ServiceAppRegistrationsCard.Local.png) | ![illustration for ServiceAppRegistrationsGroup](../../../azure-19/Item/Identity/ServiceAppRegistrationsGroup.Local.png) |
