...
```text
azure-19/Item/Identity/ServiceAzureAdB2C
```

```text
include('azure-19/Item/Identity/ServiceAzureAdB2C')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Identity/ServiceAzureAdB2C.png) | ![illustration for ServiceAzureAdB2C](../../../azure-19/Item/Identity/ServiceAzureAdB2C.Local.png) | ![illustration for ServiceAzureAdB2CCard](../../../azure-19/Item/Identity/ServiceAzureAdB2CCard.Local.png) | ![illustration for ServiceAzureAdB2CGroup](../../../azure-19/Item/Identity/ServiceAzureAdB2CGroup.Local.png) |
