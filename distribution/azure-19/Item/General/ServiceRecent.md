...
```text
azure-19/Item/General/ServiceRecent
```

```text
include('azure-19/Item/General/ServiceRecent')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/General/ServiceRecent.png) | ![illustration for ServiceRecent](../../../azure-19/Item/General/ServiceRecent.Local.png) | ![illustration for ServiceRecentCard](../../../azure-19/Item/General/ServiceRecentCard.Local.png) | ![illustration for ServiceRecentGroup](../../../azure-19/Item/General/ServiceRecentGroup.Local.png) |
