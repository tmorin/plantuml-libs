...
```text
azure-19/Item/General/ServiceSearch
```

```text
include('azure-19/Item/General/ServiceSearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/General/ServiceSearch.png) | ![illustration for ServiceSearch](../../../azure-19/Item/General/ServiceSearch.Local.png) | ![illustration for ServiceSearchCard](../../../azure-19/Item/General/ServiceSearchCard.Local.png) | ![illustration for ServiceSearchGroup](../../../azure-19/Item/General/ServiceSearchGroup.Local.png) |
