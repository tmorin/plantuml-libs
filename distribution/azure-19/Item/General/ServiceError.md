...
```text
azure-19/Item/General/ServiceError
```

```text
include('azure-19/Item/General/ServiceError')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/General/ServiceError.png) | ![illustration for ServiceError](../../../azure-19/Item/General/ServiceError.Local.png) | ![illustration for ServiceErrorCard](../../../azure-19/Item/General/ServiceErrorCard.Local.png) | ![illustration for ServiceErrorGroup](../../../azure-19/Item/General/ServiceErrorGroup.Local.png) |
