...
```text
azure-19/Item/General/ServiceFolderBlank
```

```text
include('azure-19/Item/General/ServiceFolderBlank')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/General/ServiceFolderBlank.png) | ![illustration for ServiceFolderBlank](../../../azure-19/Item/General/ServiceFolderBlank.Local.png) | ![illustration for ServiceFolderBlankCard](../../../azure-19/Item/General/ServiceFolderBlankCard.Local.png) | ![illustration for ServiceFolderBlankGroup](../../../azure-19/Item/General/ServiceFolderBlankGroup.Local.png) |
