...
```text
azure-19/Item/General/ServiceLoadTest
```

```text
include('azure-19/Item/General/ServiceLoadTest')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/General/ServiceLoadTest.png) | ![illustration for ServiceLoadTest](../../../azure-19/Item/General/ServiceLoadTest.Local.png) | ![illustration for ServiceLoadTestCard](../../../azure-19/Item/General/ServiceLoadTestCard.Local.png) | ![illustration for ServiceLoadTestGroup](../../../azure-19/Item/General/ServiceLoadTestGroup.Local.png) |
