...
```text
azure-19/Item/General/ServiceMedia
```

```text
include('azure-19/Item/General/ServiceMedia')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/General/ServiceMedia.png) | ![illustration for ServiceMedia](../../../azure-19/Item/General/ServiceMedia.Local.png) | ![illustration for ServiceMediaCard](../../../azure-19/Item/General/ServiceMediaCard.Local.png) | ![illustration for ServiceMediaGroup](../../../azure-19/Item/General/ServiceMediaGroup.Local.png) |
