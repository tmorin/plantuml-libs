...
```text
azure-19/Item/General/ServicePower
```

```text
include('azure-19/Item/General/ServicePower')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/General/ServicePower.png) | ![illustration for ServicePower](../../../azure-19/Item/General/ServicePower.Local.png) | ![illustration for ServicePowerCard](../../../azure-19/Item/General/ServicePowerCard.Local.png) | ![illustration for ServicePowerGroup](../../../azure-19/Item/General/ServicePowerGroup.Local.png) |
