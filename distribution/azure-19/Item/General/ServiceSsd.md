...
```text
azure-19/Item/General/ServiceSsd
```

```text
include('azure-19/Item/General/ServiceSsd')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/General/ServiceSsd.png) | ![illustration for ServiceSsd](../../../azure-19/Item/General/ServiceSsd.Local.png) | ![illustration for ServiceSsdCard](../../../azure-19/Item/General/ServiceSsdCard.Local.png) | ![illustration for ServiceSsdGroup](../../../azure-19/Item/General/ServiceSsdGroup.Local.png) |
