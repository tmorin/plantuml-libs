...
```text
azure-19/Item/General/ServiceMediaFile
```

```text
include('azure-19/Item/General/ServiceMediaFile')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/General/ServiceMediaFile.png) | ![illustration for ServiceMediaFile](../../../azure-19/Item/General/ServiceMediaFile.Local.png) | ![illustration for ServiceMediaFileCard](../../../azure-19/Item/General/ServiceMediaFileCard.Local.png) | ![illustration for ServiceMediaFileGroup](../../../azure-19/Item/General/ServiceMediaFileGroup.Local.png) |
