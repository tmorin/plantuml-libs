...
```text
azure-19/Item/General/ServiceFile
```

```text
include('azure-19/Item/General/ServiceFile')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/General/ServiceFile.png) | ![illustration for ServiceFile](../../../azure-19/Item/General/ServiceFile.Local.png) | ![illustration for ServiceFileCard](../../../azure-19/Item/General/ServiceFileCard.Local.png) | ![illustration for ServiceFileGroup](../../../azure-19/Item/General/ServiceFileGroup.Local.png) |
