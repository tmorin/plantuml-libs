...
```text
azure-19/Item/General/ServiceCubes
```

```text
include('azure-19/Item/General/ServiceCubes')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/General/ServiceCubes.png) | ![illustration for ServiceCubes](../../../azure-19/Item/General/ServiceCubes.Local.png) | ![illustration for ServiceCubesCard](../../../azure-19/Item/General/ServiceCubesCard.Local.png) | ![illustration for ServiceCubesGroup](../../../azure-19/Item/General/ServiceCubesGroup.Local.png) |
