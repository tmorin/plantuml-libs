...
```text
azure-19/Item/Databases/ServiceAzureCosmosDb
```

```text
include('azure-19/Item/Databases/ServiceAzureCosmosDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Databases/ServiceAzureCosmosDb.png) | ![illustration for ServiceAzureCosmosDb](../../../azure-19/Item/Databases/ServiceAzureCosmosDb.Local.png) | ![illustration for ServiceAzureCosmosDbCard](../../../azure-19/Item/Databases/ServiceAzureCosmosDbCard.Local.png) | ![illustration for ServiceAzureCosmosDbGroup](../../../azure-19/Item/Databases/ServiceAzureCosmosDbGroup.Local.png) |
