...
```text
azure-19/Item/Databases/ServiceInstancePools
```

```text
include('azure-19/Item/Databases/ServiceInstancePools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Databases/ServiceInstancePools.png) | ![illustration for ServiceInstancePools](../../../azure-19/Item/Databases/ServiceInstancePools.Local.png) | ![illustration for ServiceInstancePoolsCard](../../../azure-19/Item/Databases/ServiceInstancePoolsCard.Local.png) | ![illustration for ServiceInstancePoolsGroup](../../../azure-19/Item/Databases/ServiceInstancePoolsGroup.Local.png) |
