...
```text
azure-19/Item/Databases/ServiceSqlDataWarehouses
```

```text
include('azure-19/Item/Databases/ServiceSqlDataWarehouses')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Databases/ServiceSqlDataWarehouses.png) | ![illustration for ServiceSqlDataWarehouses](../../../azure-19/Item/Databases/ServiceSqlDataWarehouses.Local.png) | ![illustration for ServiceSqlDataWarehousesCard](../../../azure-19/Item/Databases/ServiceSqlDataWarehousesCard.Local.png) | ![illustration for ServiceSqlDataWarehousesGroup](../../../azure-19/Item/Databases/ServiceSqlDataWarehousesGroup.Local.png) |
