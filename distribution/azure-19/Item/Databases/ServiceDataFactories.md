...
```text
azure-19/Item/Databases/ServiceDataFactories
```

```text
include('azure-19/Item/Databases/ServiceDataFactories')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Databases/ServiceDataFactories.png) | ![illustration for ServiceDataFactories](../../../azure-19/Item/Databases/ServiceDataFactories.Local.png) | ![illustration for ServiceDataFactoriesCard](../../../azure-19/Item/Databases/ServiceDataFactoriesCard.Local.png) | ![illustration for ServiceDataFactoriesGroup](../../../azure-19/Item/Databases/ServiceDataFactoriesGroup.Local.png) |
