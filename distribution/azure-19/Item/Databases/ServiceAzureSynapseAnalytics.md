...
```text
azure-19/Item/Databases/ServiceAzureSynapseAnalytics
```

```text
include('azure-19/Item/Databases/ServiceAzureSynapseAnalytics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Databases/ServiceAzureSynapseAnalytics.png) | ![illustration for ServiceAzureSynapseAnalytics](../../../azure-19/Item/Databases/ServiceAzureSynapseAnalytics.Local.png) | ![illustration for ServiceAzureSynapseAnalyticsCard](../../../azure-19/Item/Databases/ServiceAzureSynapseAnalyticsCard.Local.png) | ![illustration for ServiceAzureSynapseAnalyticsGroup](../../../azure-19/Item/Databases/ServiceAzureSynapseAnalyticsGroup.Local.png) |
