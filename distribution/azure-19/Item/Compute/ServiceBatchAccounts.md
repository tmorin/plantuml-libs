...
```text
azure-19/Item/Compute/ServiceBatchAccounts
```

```text
include('azure-19/Item/Compute/ServiceBatchAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Compute/ServiceBatchAccounts.png) | ![illustration for ServiceBatchAccounts](../../../azure-19/Item/Compute/ServiceBatchAccounts.Local.png) | ![illustration for ServiceBatchAccountsCard](../../../azure-19/Item/Compute/ServiceBatchAccountsCard.Local.png) | ![illustration for ServiceBatchAccountsGroup](../../../azure-19/Item/Compute/ServiceBatchAccountsGroup.Local.png) |
