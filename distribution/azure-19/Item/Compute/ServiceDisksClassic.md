...
```text
azure-19/Item/Compute/ServiceDisksClassic
```

```text
include('azure-19/Item/Compute/ServiceDisksClassic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Compute/ServiceDisksClassic.png) | ![illustration for ServiceDisksClassic](../../../azure-19/Item/Compute/ServiceDisksClassic.Local.png) | ![illustration for ServiceDisksClassicCard](../../../azure-19/Item/Compute/ServiceDisksClassicCard.Local.png) | ![illustration for ServiceDisksClassicGroup](../../../azure-19/Item/Compute/ServiceDisksClassicGroup.Local.png) |
