...
```text
azure-19/Item/Compute/ServiceContainerInstances
```

```text
include('azure-19/Item/Compute/ServiceContainerInstances')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Compute/ServiceContainerInstances.png) | ![illustration for ServiceContainerInstances](../../../azure-19/Item/Compute/ServiceContainerInstances.Local.png) | ![illustration for ServiceContainerInstancesCard](../../../azure-19/Item/Compute/ServiceContainerInstancesCard.Local.png) | ![illustration for ServiceContainerInstancesGroup](../../../azure-19/Item/Compute/ServiceContainerInstancesGroup.Local.png) |
