...
```text
azure-19/Item/Compute/ServiceImages
```

```text
include('azure-19/Item/Compute/ServiceImages')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Compute/ServiceImages.png) | ![illustration for ServiceImages](../../../azure-19/Item/Compute/ServiceImages.Local.png) | ![illustration for ServiceImagesCard](../../../azure-19/Item/Compute/ServiceImagesCard.Local.png) | ![illustration for ServiceImagesGroup](../../../azure-19/Item/Compute/ServiceImagesGroup.Local.png) |
