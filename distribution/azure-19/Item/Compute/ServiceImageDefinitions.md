...
```text
azure-19/Item/Compute/ServiceImageDefinitions
```

```text
include('azure-19/Item/Compute/ServiceImageDefinitions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Compute/ServiceImageDefinitions.png) | ![illustration for ServiceImageDefinitions](../../../azure-19/Item/Compute/ServiceImageDefinitions.Local.png) | ![illustration for ServiceImageDefinitionsCard](../../../azure-19/Item/Compute/ServiceImageDefinitionsCard.Local.png) | ![illustration for ServiceImageDefinitionsGroup](../../../azure-19/Item/Compute/ServiceImageDefinitionsGroup.Local.png) |
