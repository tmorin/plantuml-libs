...
```text
azure-19/Item/Compute/ServiceAppServices
```

```text
include('azure-19/Item/Compute/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Compute/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-19/Item/Compute/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-19/Item/Compute/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-19/Item/Compute/ServiceAppServicesGroup.Local.png) |
