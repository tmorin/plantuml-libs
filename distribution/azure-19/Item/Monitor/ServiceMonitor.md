...
```text
azure-19/Item/Monitor/ServiceMonitor
```

```text
include('azure-19/Item/Monitor/ServiceMonitor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Monitor/ServiceMonitor.png) | ![illustration for ServiceMonitor](../../../azure-19/Item/Monitor/ServiceMonitor.Local.png) | ![illustration for ServiceMonitorCard](../../../azure-19/Item/Monitor/ServiceMonitorCard.Local.png) | ![illustration for ServiceMonitorGroup](../../../azure-19/Item/Monitor/ServiceMonitorGroup.Local.png) |
