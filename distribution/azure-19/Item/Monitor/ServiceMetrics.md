...
```text
azure-19/Item/Monitor/ServiceMetrics
```

```text
include('azure-19/Item/Monitor/ServiceMetrics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Monitor/ServiceMetrics.png) | ![illustration for ServiceMetrics](../../../azure-19/Item/Monitor/ServiceMetrics.Local.png) | ![illustration for ServiceMetricsCard](../../../azure-19/Item/Monitor/ServiceMetricsCard.Local.png) | ![illustration for ServiceMetricsGroup](../../../azure-19/Item/Monitor/ServiceMetricsGroup.Local.png) |
