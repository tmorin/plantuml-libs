...
```text
azure-19/Item/Monitor/ServiceLogAnalyticsWorkspaces
```

```text
include('azure-19/Item/Monitor/ServiceLogAnalyticsWorkspaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Monitor/ServiceLogAnalyticsWorkspaces.png) | ![illustration for ServiceLogAnalyticsWorkspaces](../../../azure-19/Item/Monitor/ServiceLogAnalyticsWorkspaces.Local.png) | ![illustration for ServiceLogAnalyticsWorkspacesCard](../../../azure-19/Item/Monitor/ServiceLogAnalyticsWorkspacesCard.Local.png) | ![illustration for ServiceLogAnalyticsWorkspacesGroup](../../../azure-19/Item/Monitor/ServiceLogAnalyticsWorkspacesGroup.Local.png) |
