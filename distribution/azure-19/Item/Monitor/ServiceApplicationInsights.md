...
```text
azure-19/Item/Monitor/ServiceApplicationInsights
```

```text
include('azure-19/Item/Monitor/ServiceApplicationInsights')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Monitor/ServiceApplicationInsights.png) | ![illustration for ServiceApplicationInsights](../../../azure-19/Item/Monitor/ServiceApplicationInsights.Local.png) | ![illustration for ServiceApplicationInsightsCard](../../../azure-19/Item/Monitor/ServiceApplicationInsightsCard.Local.png) | ![illustration for ServiceApplicationInsightsGroup](../../../azure-19/Item/Monitor/ServiceApplicationInsightsGroup.Local.png) |
