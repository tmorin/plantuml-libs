...
```text
azure-19/Item/Web/ServiceCognitiveSearch
```

```text
include('azure-19/Item/Web/ServiceCognitiveSearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Web/ServiceCognitiveSearch.png) | ![illustration for ServiceCognitiveSearch](../../../azure-19/Item/Web/ServiceCognitiveSearch.Local.png) | ![illustration for ServiceCognitiveSearchCard](../../../azure-19/Item/Web/ServiceCognitiveSearchCard.Local.png) | ![illustration for ServiceCognitiveSearchGroup](../../../azure-19/Item/Web/ServiceCognitiveSearchGroup.Local.png) |
