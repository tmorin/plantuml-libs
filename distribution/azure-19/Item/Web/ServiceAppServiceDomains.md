...
```text
azure-19/Item/Web/ServiceAppServiceDomains
```

```text
include('azure-19/Item/Web/ServiceAppServiceDomains')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Web/ServiceAppServiceDomains.png) | ![illustration for ServiceAppServiceDomains](../../../azure-19/Item/Web/ServiceAppServiceDomains.Local.png) | ![illustration for ServiceAppServiceDomainsCard](../../../azure-19/Item/Web/ServiceAppServiceDomainsCard.Local.png) | ![illustration for ServiceAppServiceDomainsGroup](../../../azure-19/Item/Web/ServiceAppServiceDomainsGroup.Local.png) |
