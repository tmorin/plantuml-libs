...
```text
azure-19/Item/Web/ServiceAzureSpringApps
```

```text
include('azure-19/Item/Web/ServiceAzureSpringApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Web/ServiceAzureSpringApps.png) | ![illustration for ServiceAzureSpringApps](../../../azure-19/Item/Web/ServiceAzureSpringApps.Local.png) | ![illustration for ServiceAzureSpringAppsCard](../../../azure-19/Item/Web/ServiceAzureSpringAppsCard.Local.png) | ![illustration for ServiceAzureSpringAppsGroup](../../../azure-19/Item/Web/ServiceAzureSpringAppsGroup.Local.png) |
