...
```text
azure-19/Item/Web/ServicePowerPlatform
```

```text
include('azure-19/Item/Web/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Web/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure-19/Item/Web/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure-19/Item/Web/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure-19/Item/Web/ServicePowerPlatformGroup.Local.png) |
