...
```text
azure-19/Item/Web/ServiceAzureMediaService
```

```text
include('azure-19/Item/Web/ServiceAzureMediaService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Web/ServiceAzureMediaService.png) | ![illustration for ServiceAzureMediaService](../../../azure-19/Item/Web/ServiceAzureMediaService.Local.png) | ![illustration for ServiceAzureMediaServiceCard](../../../azure-19/Item/Web/ServiceAzureMediaServiceCard.Local.png) | ![illustration for ServiceAzureMediaServiceGroup](../../../azure-19/Item/Web/ServiceAzureMediaServiceGroup.Local.png) |
