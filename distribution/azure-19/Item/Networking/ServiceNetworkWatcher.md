...
```text
azure-19/Item/Networking/ServiceNetworkWatcher
```

```text
include('azure-19/Item/Networking/ServiceNetworkWatcher')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Networking/ServiceNetworkWatcher.png) | ![illustration for ServiceNetworkWatcher](../../../azure-19/Item/Networking/ServiceNetworkWatcher.Local.png) | ![illustration for ServiceNetworkWatcherCard](../../../azure-19/Item/Networking/ServiceNetworkWatcherCard.Local.png) | ![illustration for ServiceNetworkWatcherGroup](../../../azure-19/Item/Networking/ServiceNetworkWatcherGroup.Local.png) |
