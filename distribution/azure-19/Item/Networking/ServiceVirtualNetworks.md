...
```text
azure-19/Item/Networking/ServiceVirtualNetworks
```

```text
include('azure-19/Item/Networking/ServiceVirtualNetworks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Networking/ServiceVirtualNetworks.png) | ![illustration for ServiceVirtualNetworks](../../../azure-19/Item/Networking/ServiceVirtualNetworks.Local.png) | ![illustration for ServiceVirtualNetworksCard](../../../azure-19/Item/Networking/ServiceVirtualNetworksCard.Local.png) | ![illustration for ServiceVirtualNetworksGroup](../../../azure-19/Item/Networking/ServiceVirtualNetworksGroup.Local.png) |
