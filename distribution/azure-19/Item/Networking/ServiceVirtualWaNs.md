...
```text
azure-19/Item/Networking/ServiceVirtualWaNs
```

```text
include('azure-19/Item/Networking/ServiceVirtualWaNs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Networking/ServiceVirtualWaNs.png) | ![illustration for ServiceVirtualWaNs](../../../azure-19/Item/Networking/ServiceVirtualWaNs.Local.png) | ![illustration for ServiceVirtualWaNsCard](../../../azure-19/Item/Networking/ServiceVirtualWaNsCard.Local.png) | ![illustration for ServiceVirtualWaNsGroup](../../../azure-19/Item/Networking/ServiceVirtualWaNsGroup.Local.png) |
