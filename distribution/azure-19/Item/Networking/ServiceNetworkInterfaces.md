...
```text
azure-19/Item/Networking/ServiceNetworkInterfaces
```

```text
include('azure-19/Item/Networking/ServiceNetworkInterfaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Networking/ServiceNetworkInterfaces.png) | ![illustration for ServiceNetworkInterfaces](../../../azure-19/Item/Networking/ServiceNetworkInterfaces.Local.png) | ![illustration for ServiceNetworkInterfacesCard](../../../azure-19/Item/Networking/ServiceNetworkInterfacesCard.Local.png) | ![illustration for ServiceNetworkInterfacesGroup](../../../azure-19/Item/Networking/ServiceNetworkInterfacesGroup.Local.png) |
