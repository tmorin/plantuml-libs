...
```text
azure-19/Item/Networking/ServicePublicIpAddresses
```

```text
include('azure-19/Item/Networking/ServicePublicIpAddresses')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Networking/ServicePublicIpAddresses.png) | ![illustration for ServicePublicIpAddresses](../../../azure-19/Item/Networking/ServicePublicIpAddresses.Local.png) | ![illustration for ServicePublicIpAddressesCard](../../../azure-19/Item/Networking/ServicePublicIpAddressesCard.Local.png) | ![illustration for ServicePublicIpAddressesGroup](../../../azure-19/Item/Networking/ServicePublicIpAddressesGroup.Local.png) |
