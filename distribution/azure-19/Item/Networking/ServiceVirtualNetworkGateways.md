...
```text
azure-19/Item/Networking/ServiceVirtualNetworkGateways
```

```text
include('azure-19/Item/Networking/ServiceVirtualNetworkGateways')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Networking/ServiceVirtualNetworkGateways.png) | ![illustration for ServiceVirtualNetworkGateways](../../../azure-19/Item/Networking/ServiceVirtualNetworkGateways.Local.png) | ![illustration for ServiceVirtualNetworkGatewaysCard](../../../azure-19/Item/Networking/ServiceVirtualNetworkGatewaysCard.Local.png) | ![illustration for ServiceVirtualNetworkGatewaysGroup](../../../azure-19/Item/Networking/ServiceVirtualNetworkGatewaysGroup.Local.png) |
