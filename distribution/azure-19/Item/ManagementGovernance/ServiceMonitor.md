...
```text
azure-19/Item/ManagementGovernance/ServiceMonitor
```

```text
include('azure-19/Item/ManagementGovernance/ServiceMonitor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/ManagementGovernance/ServiceMonitor.png) | ![illustration for ServiceMonitor](../../../azure-19/Item/ManagementGovernance/ServiceMonitor.Local.png) | ![illustration for ServiceMonitorCard](../../../azure-19/Item/ManagementGovernance/ServiceMonitorCard.Local.png) | ![illustration for ServiceMonitorGroup](../../../azure-19/Item/ManagementGovernance/ServiceMonitorGroup.Local.png) |
