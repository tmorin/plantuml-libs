...
```text
azure-19/Item/ManagementGovernance/ServiceManagedDesktop
```

```text
include('azure-19/Item/ManagementGovernance/ServiceManagedDesktop')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/ManagementGovernance/ServiceManagedDesktop.png) | ![illustration for ServiceManagedDesktop](../../../azure-19/Item/ManagementGovernance/ServiceManagedDesktop.Local.png) | ![illustration for ServiceManagedDesktopCard](../../../azure-19/Item/ManagementGovernance/ServiceManagedDesktopCard.Local.png) | ![illustration for ServiceManagedDesktopGroup](../../../azure-19/Item/ManagementGovernance/ServiceManagedDesktopGroup.Local.png) |
