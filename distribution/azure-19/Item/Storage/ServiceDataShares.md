...
```text
azure-19/Item/Storage/ServiceDataShares
```

```text
include('azure-19/Item/Storage/ServiceDataShares')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Storage/ServiceDataShares.png) | ![illustration for ServiceDataShares](../../../azure-19/Item/Storage/ServiceDataShares.Local.png) | ![illustration for ServiceDataSharesCard](../../../azure-19/Item/Storage/ServiceDataSharesCard.Local.png) | ![illustration for ServiceDataSharesGroup](../../../azure-19/Item/Storage/ServiceDataSharesGroup.Local.png) |
