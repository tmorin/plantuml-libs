...
```text
azure-19/Item/Storage/ServiceStorSimpleDeviceManagers
```

```text
include('azure-19/Item/Storage/ServiceStorSimpleDeviceManagers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Storage/ServiceStorSimpleDeviceManagers.png) | ![illustration for ServiceStorSimpleDeviceManagers](../../../azure-19/Item/Storage/ServiceStorSimpleDeviceManagers.Local.png) | ![illustration for ServiceStorSimpleDeviceManagersCard](../../../azure-19/Item/Storage/ServiceStorSimpleDeviceManagersCard.Local.png) | ![illustration for ServiceStorSimpleDeviceManagersGroup](../../../azure-19/Item/Storage/ServiceStorSimpleDeviceManagersGroup.Local.png) |
