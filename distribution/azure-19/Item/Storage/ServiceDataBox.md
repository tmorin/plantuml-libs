...
```text
azure-19/Item/Storage/ServiceDataBox
```

```text
include('azure-19/Item/Storage/ServiceDataBox')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Storage/ServiceDataBox.png) | ![illustration for ServiceDataBox](../../../azure-19/Item/Storage/ServiceDataBox.Local.png) | ![illustration for ServiceDataBoxCard](../../../azure-19/Item/Storage/ServiceDataBoxCard.Local.png) | ![illustration for ServiceDataBoxGroup](../../../azure-19/Item/Storage/ServiceDataBoxGroup.Local.png) |
