...
```text
azure-19/Item/Storage/ServiceAzureStackEdge
```

```text
include('azure-19/Item/Storage/ServiceAzureStackEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Storage/ServiceAzureStackEdge.png) | ![illustration for ServiceAzureStackEdge](../../../azure-19/Item/Storage/ServiceAzureStackEdge.Local.png) | ![illustration for ServiceAzureStackEdgeCard](../../../azure-19/Item/Storage/ServiceAzureStackEdgeCard.Local.png) | ![illustration for ServiceAzureStackEdgeGroup](../../../azure-19/Item/Storage/ServiceAzureStackEdgeGroup.Local.png) |
