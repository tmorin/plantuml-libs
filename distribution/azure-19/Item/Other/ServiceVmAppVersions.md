...
```text
azure-19/Item/Other/ServiceVmAppVersions
```

```text
include('azure-19/Item/Other/ServiceVmAppVersions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Other/ServiceVmAppVersions.png) | ![illustration for ServiceVmAppVersions](../../../azure-19/Item/Other/ServiceVmAppVersions.Local.png) | ![illustration for ServiceVmAppVersionsCard](../../../azure-19/Item/Other/ServiceVmAppVersionsCard.Local.png) | ![illustration for ServiceVmAppVersionsGroup](../../../azure-19/Item/Other/ServiceVmAppVersionsGroup.Local.png) |
