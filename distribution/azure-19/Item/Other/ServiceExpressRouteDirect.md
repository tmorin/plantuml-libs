...
```text
azure-19/Item/Other/ServiceExpressRouteDirect
```

```text
include('azure-19/Item/Other/ServiceExpressRouteDirect')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Other/ServiceExpressRouteDirect.png) | ![illustration for ServiceExpressRouteDirect](../../../azure-19/Item/Other/ServiceExpressRouteDirect.Local.png) | ![illustration for ServiceExpressRouteDirectCard](../../../azure-19/Item/Other/ServiceExpressRouteDirectCard.Local.png) | ![illustration for ServiceExpressRouteDirectGroup](../../../azure-19/Item/Other/ServiceExpressRouteDirectGroup.Local.png) |
