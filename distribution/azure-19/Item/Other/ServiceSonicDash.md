...
```text
azure-19/Item/Other/ServiceSonicDash
```

```text
include('azure-19/Item/Other/ServiceSonicDash')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Other/ServiceSonicDash.png) | ![illustration for ServiceSonicDash](../../../azure-19/Item/Other/ServiceSonicDash.Local.png) | ![illustration for ServiceSonicDashCard](../../../azure-19/Item/Other/ServiceSonicDashCard.Local.png) | ![illustration for ServiceSonicDashGroup](../../../azure-19/Item/Other/ServiceSonicDashGroup.Local.png) |
