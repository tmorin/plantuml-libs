...
```text
azure-19/Item/Other/ServiceTemplateSpecs
```

```text
include('azure-19/Item/Other/ServiceTemplateSpecs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Other/ServiceTemplateSpecs.png) | ![illustration for ServiceTemplateSpecs](../../../azure-19/Item/Other/ServiceTemplateSpecs.Local.png) | ![illustration for ServiceTemplateSpecsCard](../../../azure-19/Item/Other/ServiceTemplateSpecsCard.Local.png) | ![illustration for ServiceTemplateSpecsGroup](../../../azure-19/Item/Other/ServiceTemplateSpecsGroup.Local.png) |
