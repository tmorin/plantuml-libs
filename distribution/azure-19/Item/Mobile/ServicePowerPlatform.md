...
```text
azure-19/Item/Mobile/ServicePowerPlatform
```

```text
include('azure-19/Item/Mobile/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Mobile/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure-19/Item/Mobile/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure-19/Item/Mobile/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure-19/Item/Mobile/ServicePowerPlatformGroup.Local.png) |
