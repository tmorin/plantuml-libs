...
```text
azure-19/Item/Mobile/ServiceAppServices
```

```text
include('azure-19/Item/Mobile/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-19/Item/Mobile/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-19/Item/Mobile/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-19/Item/Mobile/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-19/Item/Mobile/ServiceAppServicesGroup.Local.png) |
