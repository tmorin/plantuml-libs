...
```text
azure-20/Item/ManagementGovernance/ServiceMonitor
```

```text
include('azure-20/Item/ManagementGovernance/ServiceMonitor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/ManagementGovernance/ServiceMonitor.png) | ![illustration for ServiceMonitor](../../../azure-20/Item/ManagementGovernance/ServiceMonitor.Local.png) | ![illustration for ServiceMonitorCard](../../../azure-20/Item/ManagementGovernance/ServiceMonitorCard.Local.png) | ![illustration for ServiceMonitorGroup](../../../azure-20/Item/ManagementGovernance/ServiceMonitorGroup.Local.png) |
