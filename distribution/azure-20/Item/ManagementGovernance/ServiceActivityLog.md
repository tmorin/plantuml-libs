...
```text
azure-20/Item/ManagementGovernance/ServiceActivityLog
```

```text
include('azure-20/Item/ManagementGovernance/ServiceActivityLog')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/ManagementGovernance/ServiceActivityLog.png) | ![illustration for ServiceActivityLog](../../../azure-20/Item/ManagementGovernance/ServiceActivityLog.Local.png) | ![illustration for ServiceActivityLogCard](../../../azure-20/Item/ManagementGovernance/ServiceActivityLogCard.Local.png) | ![illustration for ServiceActivityLogGroup](../../../azure-20/Item/ManagementGovernance/ServiceActivityLogGroup.Local.png) |
