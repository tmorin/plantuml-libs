...
```text
azure-20/Item/Migrate/ServiceCostManagementAndBilling
```

```text
include('azure-20/Item/Migrate/ServiceCostManagementAndBilling')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Migrate/ServiceCostManagementAndBilling.png) | ![illustration for ServiceCostManagementAndBilling](../../../azure-20/Item/Migrate/ServiceCostManagementAndBilling.Local.png) | ![illustration for ServiceCostManagementAndBillingCard](../../../azure-20/Item/Migrate/ServiceCostManagementAndBillingCard.Local.png) | ![illustration for ServiceCostManagementAndBillingGroup](../../../azure-20/Item/Migrate/ServiceCostManagementAndBillingGroup.Local.png) |
