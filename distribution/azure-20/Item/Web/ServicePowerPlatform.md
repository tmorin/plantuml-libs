...
```text
azure-20/Item/Web/ServicePowerPlatform
```

```text
include('azure-20/Item/Web/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Web/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure-20/Item/Web/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure-20/Item/Web/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure-20/Item/Web/ServicePowerPlatformGroup.Local.png) |
