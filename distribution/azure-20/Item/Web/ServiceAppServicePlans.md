...
```text
azure-20/Item/Web/ServiceAppServicePlans
```

```text
include('azure-20/Item/Web/ServiceAppServicePlans')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Web/ServiceAppServicePlans.png) | ![illustration for ServiceAppServicePlans](../../../azure-20/Item/Web/ServiceAppServicePlans.Local.png) | ![illustration for ServiceAppServicePlansCard](../../../azure-20/Item/Web/ServiceAppServicePlansCard.Local.png) | ![illustration for ServiceAppServicePlansGroup](../../../azure-20/Item/Web/ServiceAppServicePlansGroup.Local.png) |
