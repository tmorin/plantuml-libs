...
```text
azure-20/Item/Storage/ServiceAzureStackEdge
```

```text
include('azure-20/Item/Storage/ServiceAzureStackEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Storage/ServiceAzureStackEdge.png) | ![illustration for ServiceAzureStackEdge](../../../azure-20/Item/Storage/ServiceAzureStackEdge.Local.png) | ![illustration for ServiceAzureStackEdgeCard](../../../azure-20/Item/Storage/ServiceAzureStackEdgeCard.Local.png) | ![illustration for ServiceAzureStackEdgeGroup](../../../azure-20/Item/Storage/ServiceAzureStackEdgeGroup.Local.png) |
