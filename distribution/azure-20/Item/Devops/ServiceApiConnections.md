...
```text
azure-20/Item/Devops/ServiceApiConnections
```

```text
include('azure-20/Item/Devops/ServiceApiConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Devops/ServiceApiConnections.png) | ![illustration for ServiceApiConnections](../../../azure-20/Item/Devops/ServiceApiConnections.Local.png) | ![illustration for ServiceApiConnectionsCard](../../../azure-20/Item/Devops/ServiceApiConnectionsCard.Local.png) | ![illustration for ServiceApiConnectionsGroup](../../../azure-20/Item/Devops/ServiceApiConnectionsGroup.Local.png) |
