...
```text
azure-20/Item/Intune/ServiceMindaro
```

```text
include('azure-20/Item/Intune/ServiceMindaro')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Intune/ServiceMindaro.png) | ![illustration for ServiceMindaro](../../../azure-20/Item/Intune/ServiceMindaro.Local.png) | ![illustration for ServiceMindaroCard](../../../azure-20/Item/Intune/ServiceMindaroCard.Local.png) | ![illustration for ServiceMindaroGroup](../../../azure-20/Item/Intune/ServiceMindaroGroup.Local.png) |
