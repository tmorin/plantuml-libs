...
```text
azure-20/Item/Mobile/ServicePowerPlatform
```

```text
include('azure-20/Item/Mobile/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Mobile/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure-20/Item/Mobile/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure-20/Item/Mobile/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure-20/Item/Mobile/ServicePowerPlatformGroup.Local.png) |
