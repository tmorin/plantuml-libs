...
```text
azure-20/Item/General/ServiceExtensions
```

```text
include('azure-20/Item/General/ServiceExtensions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/General/ServiceExtensions.png) | ![illustration for ServiceExtensions](../../../azure-20/Item/General/ServiceExtensions.Local.png) | ![illustration for ServiceExtensionsCard](../../../azure-20/Item/General/ServiceExtensionsCard.Local.png) | ![illustration for ServiceExtensionsGroup](../../../azure-20/Item/General/ServiceExtensionsGroup.Local.png) |
