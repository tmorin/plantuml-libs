...
```text
azure-20/Item/Analytics/ServicePowerPlatform
```

```text
include('azure-20/Item/Analytics/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Analytics/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure-20/Item/Analytics/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure-20/Item/Analytics/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure-20/Item/Analytics/ServicePowerPlatformGroup.Local.png) |
