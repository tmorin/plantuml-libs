...
```text
azure-20/Item/Networking/ServiceVirtualRouter
```

```text
include('azure-20/Item/Networking/ServiceVirtualRouter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Networking/ServiceVirtualRouter.png) | ![illustration for ServiceVirtualRouter](../../../azure-20/Item/Networking/ServiceVirtualRouter.Local.png) | ![illustration for ServiceVirtualRouterCard](../../../azure-20/Item/Networking/ServiceVirtualRouterCard.Local.png) | ![illustration for ServiceVirtualRouterGroup](../../../azure-20/Item/Networking/ServiceVirtualRouterGroup.Local.png) |
