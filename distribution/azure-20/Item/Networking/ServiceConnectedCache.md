...
```text
azure-20/Item/Networking/ServiceConnectedCache
```

```text
include('azure-20/Item/Networking/ServiceConnectedCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Networking/ServiceConnectedCache.png) | ![illustration for ServiceConnectedCache](../../../azure-20/Item/Networking/ServiceConnectedCache.Local.png) | ![illustration for ServiceConnectedCacheCard](../../../azure-20/Item/Networking/ServiceConnectedCacheCard.Local.png) | ![illustration for ServiceConnectedCacheGroup](../../../azure-20/Item/Networking/ServiceConnectedCacheGroup.Local.png) |
