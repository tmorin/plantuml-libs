...
```text
azure-20/Item/Iot/ServiceAzureCosmosDb
```

```text
include('azure-20/Item/Iot/ServiceAzureCosmosDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Iot/ServiceAzureCosmosDb.png) | ![illustration for ServiceAzureCosmosDb](../../../azure-20/Item/Iot/ServiceAzureCosmosDb.Local.png) | ![illustration for ServiceAzureCosmosDbCard](../../../azure-20/Item/Iot/ServiceAzureCosmosDbCard.Local.png) | ![illustration for ServiceAzureCosmosDbGroup](../../../azure-20/Item/Iot/ServiceAzureCosmosDbGroup.Local.png) |
