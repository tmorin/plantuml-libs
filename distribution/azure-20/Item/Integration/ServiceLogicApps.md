...
```text
azure-20/Item/Integration/ServiceLogicApps
```

```text
include('azure-20/Item/Integration/ServiceLogicApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Integration/ServiceLogicApps.png) | ![illustration for ServiceLogicApps](../../../azure-20/Item/Integration/ServiceLogicApps.Local.png) | ![illustration for ServiceLogicAppsCard](../../../azure-20/Item/Integration/ServiceLogicAppsCard.Local.png) | ![illustration for ServiceLogicAppsGroup](../../../azure-20/Item/Integration/ServiceLogicAppsGroup.Local.png) |
