...
```text
azure-20/Item/Integration/ServiceSqlDataWarehouses
```

```text
include('azure-20/Item/Integration/ServiceSqlDataWarehouses')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Integration/ServiceSqlDataWarehouses.png) | ![illustration for ServiceSqlDataWarehouses](../../../azure-20/Item/Integration/ServiceSqlDataWarehouses.Local.png) | ![illustration for ServiceSqlDataWarehousesCard](../../../azure-20/Item/Integration/ServiceSqlDataWarehousesCard.Local.png) | ![illustration for ServiceSqlDataWarehousesGroup](../../../azure-20/Item/Integration/ServiceSqlDataWarehousesGroup.Local.png) |
