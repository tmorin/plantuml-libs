...
```text
azure-20/Item/Integration/ServiceAzureDataboxGateway
```

```text
include('azure-20/Item/Integration/ServiceAzureDataboxGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Integration/ServiceAzureDataboxGateway.png) | ![illustration for ServiceAzureDataboxGateway](../../../azure-20/Item/Integration/ServiceAzureDataboxGateway.Local.png) | ![illustration for ServiceAzureDataboxGatewayCard](../../../azure-20/Item/Integration/ServiceAzureDataboxGatewayCard.Local.png) | ![illustration for ServiceAzureDataboxGatewayGroup](../../../azure-20/Item/Integration/ServiceAzureDataboxGatewayGroup.Local.png) |
