...
```text
azure-20/Item/Monitor/ServiceApplicationInsights
```

```text
include('azure-20/Item/Monitor/ServiceApplicationInsights')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-20/Item/Monitor/ServiceApplicationInsights.png) | ![illustration for ServiceApplicationInsights](../../../azure-20/Item/Monitor/ServiceApplicationInsights.Local.png) | ![illustration for ServiceApplicationInsightsCard](../../../azure-20/Item/Monitor/ServiceApplicationInsightsCard.Local.png) | ![illustration for ServiceApplicationInsightsGroup](../../../azure-20/Item/Monitor/ServiceApplicationInsightsGroup.Local.png) |
