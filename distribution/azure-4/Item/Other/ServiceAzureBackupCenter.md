...
```text
azure-4/Item/Other/ServiceAzureBackupCenter
```

```text
include('azure-4/Item/Other/ServiceAzureBackupCenter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-4/Item/Other/ServiceAzureBackupCenter.png) | ![illustration for ServiceAzureBackupCenter](../../../azure-4/Item/Other/ServiceAzureBackupCenter.Local.png) | ![illustration for ServiceAzureBackupCenterCard](../../../azure-4/Item/Other/ServiceAzureBackupCenterCard.Local.png) | ![illustration for ServiceAzureBackupCenterGroup](../../../azure-4/Item/Other/ServiceAzureBackupCenterGroup.Local.png) |
...
' renders the element
ServiceAzureBackupCenter('ServiceAzureBackupCenter', 'Service Azure Backup Center', 'an optional tech label')
@enduml
```
