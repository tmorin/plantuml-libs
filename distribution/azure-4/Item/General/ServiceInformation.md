...
```text
azure-4/Item/General/ServiceInformation
```

```text
include('azure-4/Item/General/ServiceInformation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-4/Item/General/ServiceInformation.png) | ![illustration for ServiceInformation](../../../azure-4/Item/General/ServiceInformation.Local.png) | ![illustration for ServiceInformationCard](../../../azure-4/Item/General/ServiceInformationCard.Local.png) | ![illustration for ServiceInformationGroup](../../../azure-4/Item/General/ServiceInformationGroup.Local.png) |
...
' renders the element
ServiceInformation('ServiceInformation', 'Service Information', 'an optional tech label')
@enduml
```
