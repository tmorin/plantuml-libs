...
```text
azure-4/Item/General/ServiceManagementPortal
```

```text
include('azure-4/Item/General/ServiceManagementPortal')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-4/Item/General/ServiceManagementPortal.png) | ![illustration for ServiceManagementPortal](../../../azure-4/Item/General/ServiceManagementPortal.Local.png) | ![illustration for ServiceManagementPortalCard](../../../azure-4/Item/General/ServiceManagementPortalCard.Local.png) | ![illustration for ServiceManagementPortalGroup](../../../azure-4/Item/General/ServiceManagementPortalGroup.Local.png) |
...
' renders the element
ServiceManagementPortal('ServiceManagementPortal', 'Service Management Portal', 'an optional tech label')
@enduml
```
