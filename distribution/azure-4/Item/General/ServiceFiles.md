...
```text
azure-4/Item/General/ServiceFiles
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-4/Item/General/ServiceFiles.png) | ![illustration for ServiceFiles](../../../azure-4/Item/General/ServiceFiles.Local.png) | ![illustration for ServiceFilesCard](../../../azure-4/Item/General/ServiceFilesCard.Local.png) | ![illustration for ServiceFilesGroup](../../../azure-4/Item/General/ServiceFilesGroup.Local.png) |
...
' renders the element
ServiceFiles('ServiceFiles', 'Service Files', 'an optional tech label')
@enduml
```
