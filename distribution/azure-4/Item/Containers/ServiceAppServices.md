...
```text
azure-4/Item/Containers/ServiceAppServices
```

```text
include('azure-4/Item/Containers/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-4/Item/Containers/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-4/Item/Containers/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-4/Item/Containers/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-4/Item/Containers/ServiceAppServicesGroup.Local.png) |
