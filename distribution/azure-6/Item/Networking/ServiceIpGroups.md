...
```text
azure-6/Item/Networking/ServiceIpGroups
```

```text
include('azure-6/Item/Networking/ServiceIpGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Networking/ServiceIpGroups.png) | ![illustration for ServiceIpGroups](../../../azure-6/Item/Networking/ServiceIpGroups.Local.png) | ![illustration for ServiceIpGroupsCard](../../../azure-6/Item/Networking/ServiceIpGroupsCard.Local.png) | ![illustration for ServiceIpGroupsGroup](../../../azure-6/Item/Networking/ServiceIpGroupsGroup.Local.png) |
