...
```text
azure-6/Item/Networking/ServicePublicIpPrefixes
```

```text
include('azure-6/Item/Networking/ServicePublicIpPrefixes')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Networking/ServicePublicIpPrefixes.png) | ![illustration for ServicePublicIpPrefixes](../../../azure-6/Item/Networking/ServicePublicIpPrefixes.Local.png) | ![illustration for ServicePublicIpPrefixesCard](../../../azure-6/Item/Networking/ServicePublicIpPrefixesCard.Local.png) | ![illustration for ServicePublicIpPrefixesGroup](../../../azure-6/Item/Networking/ServicePublicIpPrefixesGroup.Local.png) |
