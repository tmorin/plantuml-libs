...
```text
azure-6/Item/Networking/ServiceRouteTables
```

```text
include('azure-6/Item/Networking/ServiceRouteTables')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Networking/ServiceRouteTables.png) | ![illustration for ServiceRouteTables](../../../azure-6/Item/Networking/ServiceRouteTables.Local.png) | ![illustration for ServiceRouteTablesCard](../../../azure-6/Item/Networking/ServiceRouteTablesCard.Local.png) | ![illustration for ServiceRouteTablesGroup](../../../azure-6/Item/Networking/ServiceRouteTablesGroup.Local.png) |
