...
```text
azure-6/Item/Networking/ServiceDnsZones
```

```text
include('azure-6/Item/Networking/ServiceDnsZones')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Networking/ServiceDnsZones.png) | ![illustration for ServiceDnsZones](../../../azure-6/Item/Networking/ServiceDnsZones.Local.png) | ![illustration for ServiceDnsZonesCard](../../../azure-6/Item/Networking/ServiceDnsZonesCard.Local.png) | ![illustration for ServiceDnsZonesGroup](../../../azure-6/Item/Networking/ServiceDnsZonesGroup.Local.png) |
