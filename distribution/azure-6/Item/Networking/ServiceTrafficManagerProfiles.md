...
```text
azure-6/Item/Networking/ServiceTrafficManagerProfiles
```

```text
include('azure-6/Item/Networking/ServiceTrafficManagerProfiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Networking/ServiceTrafficManagerProfiles.png) | ![illustration for ServiceTrafficManagerProfiles](../../../azure-6/Item/Networking/ServiceTrafficManagerProfiles.Local.png) | ![illustration for ServiceTrafficManagerProfilesCard](../../../azure-6/Item/Networking/ServiceTrafficManagerProfilesCard.Local.png) | ![illustration for ServiceTrafficManagerProfilesGroup](../../../azure-6/Item/Networking/ServiceTrafficManagerProfilesGroup.Local.png) |
