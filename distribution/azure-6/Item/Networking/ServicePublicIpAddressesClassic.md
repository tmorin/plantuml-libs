...
```text
azure-6/Item/Networking/ServicePublicIpAddressesClassic
```

```text
include('azure-6/Item/Networking/ServicePublicIpAddressesClassic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Networking/ServicePublicIpAddressesClassic.png) | ![illustration for ServicePublicIpAddressesClassic](../../../azure-6/Item/Networking/ServicePublicIpAddressesClassic.Local.png) | ![illustration for ServicePublicIpAddressesClassicCard](../../../azure-6/Item/Networking/ServicePublicIpAddressesClassicCard.Local.png) | ![illustration for ServicePublicIpAddressesClassicGroup](../../../azure-6/Item/Networking/ServicePublicIpAddressesClassicGroup.Local.png) |
