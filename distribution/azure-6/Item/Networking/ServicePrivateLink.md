...
```text
azure-6/Item/Networking/ServicePrivateLink
```

```text
include('azure-6/Item/Networking/ServicePrivateLink')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Networking/ServicePrivateLink.png) | ![illustration for ServicePrivateLink](../../../azure-6/Item/Networking/ServicePrivateLink.Local.png) | ![illustration for ServicePrivateLinkCard](../../../azure-6/Item/Networking/ServicePrivateLinkCard.Local.png) | ![illustration for ServicePrivateLinkGroup](../../../azure-6/Item/Networking/ServicePrivateLinkGroup.Local.png) |
