...
```text
azure-6/Item/ManagementGovernance/ServicePolicy
```

```text
include('azure-6/Item/ManagementGovernance/ServicePolicy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/ManagementGovernance/ServicePolicy.png) | ![illustration for ServicePolicy](../../../azure-6/Item/ManagementGovernance/ServicePolicy.Local.png) | ![illustration for ServicePolicyCard](../../../azure-6/Item/ManagementGovernance/ServicePolicyCard.Local.png) | ![illustration for ServicePolicyGroup](../../../azure-6/Item/ManagementGovernance/ServicePolicyGroup.Local.png) |
