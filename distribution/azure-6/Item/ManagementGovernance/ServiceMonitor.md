...
```text
azure-6/Item/ManagementGovernance/ServiceMonitor
```

```text
include('azure-6/Item/ManagementGovernance/ServiceMonitor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/ManagementGovernance/ServiceMonitor.png) | ![illustration for ServiceMonitor](../../../azure-6/Item/ManagementGovernance/ServiceMonitor.Local.png) | ![illustration for ServiceMonitorCard](../../../azure-6/Item/ManagementGovernance/ServiceMonitorCard.Local.png) | ![illustration for ServiceMonitorGroup](../../../azure-6/Item/ManagementGovernance/ServiceMonitorGroup.Local.png) |
