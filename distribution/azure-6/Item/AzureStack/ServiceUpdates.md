...
```text
azure-6/Item/AzureStack/ServiceUpdates
```

```text
include('azure-6/Item/AzureStack/ServiceUpdates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/AzureStack/ServiceUpdates.png) | ![illustration for ServiceUpdates](../../../azure-6/Item/AzureStack/ServiceUpdates.Local.png) | ![illustration for ServiceUpdatesCard](../../../azure-6/Item/AzureStack/ServiceUpdatesCard.Local.png) | ![illustration for ServiceUpdatesGroup](../../../azure-6/Item/AzureStack/ServiceUpdatesGroup.Local.png) |
