...
```text
azure-6/Item/AzureStack/ServicePlans
```

```text
include('azure-6/Item/AzureStack/ServicePlans')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/AzureStack/ServicePlans.png) | ![illustration for ServicePlans](../../../azure-6/Item/AzureStack/ServicePlans.Local.png) | ![illustration for ServicePlansCard](../../../azure-6/Item/AzureStack/ServicePlansCard.Local.png) | ![illustration for ServicePlansGroup](../../../azure-6/Item/AzureStack/ServicePlansGroup.Local.png) |
