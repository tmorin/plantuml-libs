...
```text
azure-6/Item/AzureStack/ServiceOffers
```

```text
include('azure-6/Item/AzureStack/ServiceOffers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/AzureStack/ServiceOffers.png) | ![illustration for ServiceOffers](../../../azure-6/Item/AzureStack/ServiceOffers.Local.png) | ![illustration for ServiceOffersCard](../../../azure-6/Item/AzureStack/ServiceOffersCard.Local.png) | ![illustration for ServiceOffersGroup](../../../azure-6/Item/AzureStack/ServiceOffersGroup.Local.png) |
