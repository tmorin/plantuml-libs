...
```text
azure-6/Item/General/ServiceBizTalk
```

```text
include('azure-6/Item/General/ServiceBizTalk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceBizTalk.png) | ![illustration for ServiceBizTalk](../../../azure-6/Item/General/ServiceBizTalk.Local.png) | ![illustration for ServiceBizTalkCard](../../../azure-6/Item/General/ServiceBizTalkCard.Local.png) | ![illustration for ServiceBizTalkGroup](../../../azure-6/Item/General/ServiceBizTalkGroup.Local.png) |
