...
```text
azure-6/Item/General/ServiceCostAlerts
```

```text
include('azure-6/Item/General/ServiceCostAlerts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceCostAlerts.png) | ![illustration for ServiceCostAlerts](../../../azure-6/Item/General/ServiceCostAlerts.Local.png) | ![illustration for ServiceCostAlertsCard](../../../azure-6/Item/General/ServiceCostAlertsCard.Local.png) | ![illustration for ServiceCostAlertsGroup](../../../azure-6/Item/General/ServiceCostAlertsGroup.Local.png) |
