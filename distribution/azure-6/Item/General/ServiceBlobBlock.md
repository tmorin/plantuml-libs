...
```text
azure-6/Item/General/ServiceBlobBlock
```

```text
include('azure-6/Item/General/ServiceBlobBlock')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceBlobBlock.png) | ![illustration for ServiceBlobBlock](../../../azure-6/Item/General/ServiceBlobBlock.Local.png) | ![illustration for ServiceBlobBlockCard](../../../azure-6/Item/General/ServiceBlobBlockCard.Local.png) | ![illustration for ServiceBlobBlockGroup](../../../azure-6/Item/General/ServiceBlobBlockGroup.Local.png) |
