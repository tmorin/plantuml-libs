...
```text
azure-6/Item/General/ServiceFtp
```

```text
include('azure-6/Item/General/ServiceFtp')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceFtp.png) | ![illustration for ServiceFtp](../../../azure-6/Item/General/ServiceFtp.Local.png) | ![illustration for ServiceFtpCard](../../../azure-6/Item/General/ServiceFtpCard.Local.png) | ![illustration for ServiceFtpGroup](../../../azure-6/Item/General/ServiceFtpGroup.Local.png) |
