...
```text
azure-6/Item/General/ServiceCostManagement
```

```text
include('azure-6/Item/General/ServiceCostManagement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceCostManagement.png) | ![illustration for ServiceCostManagement](../../../azure-6/Item/General/ServiceCostManagement.Local.png) | ![illustration for ServiceCostManagementCard](../../../azure-6/Item/General/ServiceCostManagementCard.Local.png) | ![illustration for ServiceCostManagementGroup](../../../azure-6/Item/General/ServiceCostManagementGroup.Local.png) |
