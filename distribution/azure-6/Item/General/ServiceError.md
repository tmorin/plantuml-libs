...
```text
azure-6/Item/General/ServiceError
```

```text
include('azure-6/Item/General/ServiceError')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceError.png) | ![illustration for ServiceError](../../../azure-6/Item/General/ServiceError.Local.png) | ![illustration for ServiceErrorCard](../../../azure-6/Item/General/ServiceErrorCard.Local.png) | ![illustration for ServiceErrorGroup](../../../azure-6/Item/General/ServiceErrorGroup.Local.png) |
