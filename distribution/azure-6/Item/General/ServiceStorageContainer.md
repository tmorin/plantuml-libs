...
```text
azure-6/Item/General/ServiceStorageContainer
```

```text
include('azure-6/Item/General/ServiceStorageContainer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceStorageContainer.png) | ![illustration for ServiceStorageContainer](../../../azure-6/Item/General/ServiceStorageContainer.Local.png) | ![illustration for ServiceStorageContainerCard](../../../azure-6/Item/General/ServiceStorageContainerCard.Local.png) | ![illustration for ServiceStorageContainerGroup](../../../azure-6/Item/General/ServiceStorageContainerGroup.Local.png) |
