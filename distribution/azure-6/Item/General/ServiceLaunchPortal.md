...
```text
azure-6/Item/General/ServiceLaunchPortal
```

```text
include('azure-6/Item/General/ServiceLaunchPortal')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceLaunchPortal.png) | ![illustration for ServiceLaunchPortal](../../../azure-6/Item/General/ServiceLaunchPortal.Local.png) | ![illustration for ServiceLaunchPortalCard](../../../azure-6/Item/General/ServiceLaunchPortalCard.Local.png) | ![illustration for ServiceLaunchPortalGroup](../../../azure-6/Item/General/ServiceLaunchPortalGroup.Local.png) |
