...
```text
azure-6/Item/General/ServiceFolderBlank
```

```text
include('azure-6/Item/General/ServiceFolderBlank')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceFolderBlank.png) | ![illustration for ServiceFolderBlank](../../../azure-6/Item/General/ServiceFolderBlank.Local.png) | ![illustration for ServiceFolderBlankCard](../../../azure-6/Item/General/ServiceFolderBlankCard.Local.png) | ![illustration for ServiceFolderBlankGroup](../../../azure-6/Item/General/ServiceFolderBlankGroup.Local.png) |
