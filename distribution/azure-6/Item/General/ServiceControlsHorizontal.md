...
```text
azure-6/Item/General/ServiceControlsHorizontal
```

```text
include('azure-6/Item/General/ServiceControlsHorizontal')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceControlsHorizontal.png) | ![illustration for ServiceControlsHorizontal](../../../azure-6/Item/General/ServiceControlsHorizontal.Local.png) | ![illustration for ServiceControlsHorizontalCard](../../../azure-6/Item/General/ServiceControlsHorizontalCard.Local.png) | ![illustration for ServiceControlsHorizontalGroup](../../../azure-6/Item/General/ServiceControlsHorizontalGroup.Local.png) |
