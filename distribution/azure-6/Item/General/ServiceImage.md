...
```text
azure-6/Item/General/ServiceImage
```

```text
include('azure-6/Item/General/ServiceImage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceImage.png) | ![illustration for ServiceImage](../../../azure-6/Item/General/ServiceImage.Local.png) | ![illustration for ServiceImageCard](../../../azure-6/Item/General/ServiceImageCard.Local.png) | ![illustration for ServiceImageGroup](../../../azure-6/Item/General/ServiceImageGroup.Local.png) |
