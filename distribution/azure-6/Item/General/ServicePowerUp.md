...
```text
azure-6/Item/General/ServicePowerUp
```

```text
include('azure-6/Item/General/ServicePowerUp')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServicePowerUp.png) | ![illustration for ServicePowerUp](../../../azure-6/Item/General/ServicePowerUp.Local.png) | ![illustration for ServicePowerUpCard](../../../azure-6/Item/General/ServicePowerUpCard.Local.png) | ![illustration for ServicePowerUpGroup](../../../azure-6/Item/General/ServicePowerUpGroup.Local.png) |
