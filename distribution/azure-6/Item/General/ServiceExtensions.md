...
```text
azure-6/Item/General/ServiceExtensions
```

```text
include('azure-6/Item/General/ServiceExtensions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceExtensions.png) | ![illustration for ServiceExtensions](../../../azure-6/Item/General/ServiceExtensions.Local.png) | ![illustration for ServiceExtensionsCard](../../../azure-6/Item/General/ServiceExtensionsCard.Local.png) | ![illustration for ServiceExtensionsGroup](../../../azure-6/Item/General/ServiceExtensionsGroup.Local.png) |
