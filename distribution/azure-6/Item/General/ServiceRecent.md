...
```text
azure-6/Item/General/ServiceRecent
```

```text
include('azure-6/Item/General/ServiceRecent')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceRecent.png) | ![illustration for ServiceRecent](../../../azure-6/Item/General/ServiceRecent.Local.png) | ![illustration for ServiceRecentCard](../../../azure-6/Item/General/ServiceRecentCard.Local.png) | ![illustration for ServiceRecentGroup](../../../azure-6/Item/General/ServiceRecentGroup.Local.png) |
