...
```text
azure-6/Item/General/ServiceBlobPage
```

```text
include('azure-6/Item/General/ServiceBlobPage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceBlobPage.png) | ![illustration for ServiceBlobPage](../../../azure-6/Item/General/ServiceBlobPage.Local.png) | ![illustration for ServiceBlobPageCard](../../../azure-6/Item/General/ServiceBlobPageCard.Local.png) | ![illustration for ServiceBlobPageGroup](../../../azure-6/Item/General/ServiceBlobPageGroup.Local.png) |
