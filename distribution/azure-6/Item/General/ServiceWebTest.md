...
```text
azure-6/Item/General/ServiceWebTest
```

```text
include('azure-6/Item/General/ServiceWebTest')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceWebTest.png) | ![illustration for ServiceWebTest](../../../azure-6/Item/General/ServiceWebTest.Local.png) | ![illustration for ServiceWebTestCard](../../../azure-6/Item/General/ServiceWebTestCard.Local.png) | ![illustration for ServiceWebTestGroup](../../../azure-6/Item/General/ServiceWebTestGroup.Local.png) |
