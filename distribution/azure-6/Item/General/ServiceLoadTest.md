...
```text
azure-6/Item/General/ServiceLoadTest
```

```text
include('azure-6/Item/General/ServiceLoadTest')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceLoadTest.png) | ![illustration for ServiceLoadTest](../../../azure-6/Item/General/ServiceLoadTest.Local.png) | ![illustration for ServiceLoadTestCard](../../../azure-6/Item/General/ServiceLoadTestCard.Local.png) | ![illustration for ServiceLoadTestGroup](../../../azure-6/Item/General/ServiceLoadTestGroup.Local.png) |
