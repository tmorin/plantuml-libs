...
```text
azure-6/Item/General/ServiceCubes
```

```text
include('azure-6/Item/General/ServiceCubes')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceCubes.png) | ![illustration for ServiceCubes](../../../azure-6/Item/General/ServiceCubes.Local.png) | ![illustration for ServiceCubesCard](../../../azure-6/Item/General/ServiceCubesCard.Local.png) | ![illustration for ServiceCubesGroup](../../../azure-6/Item/General/ServiceCubesGroup.Local.png) |
