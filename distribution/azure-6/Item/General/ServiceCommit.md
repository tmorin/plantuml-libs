...
```text
azure-6/Item/General/ServiceCommit
```

```text
include('azure-6/Item/General/ServiceCommit')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceCommit.png) | ![illustration for ServiceCommit](../../../azure-6/Item/General/ServiceCommit.Local.png) | ![illustration for ServiceCommitCard](../../../azure-6/Item/General/ServiceCommitCard.Local.png) | ![illustration for ServiceCommitGroup](../../../azure-6/Item/General/ServiceCommitGroup.Local.png) |
