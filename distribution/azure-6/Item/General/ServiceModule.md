...
```text
azure-6/Item/General/ServiceModule
```

```text
include('azure-6/Item/General/ServiceModule')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceModule.png) | ![illustration for ServiceModule](../../../azure-6/Item/General/ServiceModule.Local.png) | ![illustration for ServiceModuleCard](../../../azure-6/Item/General/ServiceModuleCard.Local.png) | ![illustration for ServiceModuleGroup](../../../azure-6/Item/General/ServiceModuleGroup.Local.png) |
