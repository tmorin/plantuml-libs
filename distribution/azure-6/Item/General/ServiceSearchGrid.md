...
```text
azure-6/Item/General/ServiceSearchGrid
```

```text
include('azure-6/Item/General/ServiceSearchGrid')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceSearchGrid.png) | ![illustration for ServiceSearchGrid](../../../azure-6/Item/General/ServiceSearchGrid.Local.png) | ![illustration for ServiceSearchGridCard](../../../azure-6/Item/General/ServiceSearchGridCard.Local.png) | ![illustration for ServiceSearchGridGroup](../../../azure-6/Item/General/ServiceSearchGridGroup.Local.png) |
