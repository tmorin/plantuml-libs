...
```text
azure-6/Item/General/ServiceResourceGroupList
```

```text
include('azure-6/Item/General/ServiceResourceGroupList')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceResourceGroupList.png) | ![illustration for ServiceResourceGroupList](../../../azure-6/Item/General/ServiceResourceGroupList.Local.png) | ![illustration for ServiceResourceGroupListCard](../../../azure-6/Item/General/ServiceResourceGroupListCard.Local.png) | ![illustration for ServiceResourceGroupListGroup](../../../azure-6/Item/General/ServiceResourceGroupListGroup.Local.png) |
