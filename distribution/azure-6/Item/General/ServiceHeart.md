...
```text
azure-6/Item/General/ServiceHeart
```

```text
include('azure-6/Item/General/ServiceHeart')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceHeart.png) | ![illustration for ServiceHeart](../../../azure-6/Item/General/ServiceHeart.Local.png) | ![illustration for ServiceHeartCard](../../../azure-6/Item/General/ServiceHeartCard.Local.png) | ![illustration for ServiceHeartGroup](../../../azure-6/Item/General/ServiceHeartGroup.Local.png) |
