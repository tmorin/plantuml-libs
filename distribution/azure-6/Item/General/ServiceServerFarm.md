...
```text
azure-6/Item/General/ServiceServerFarm
```

```text
include('azure-6/Item/General/ServiceServerFarm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceServerFarm.png) | ![illustration for ServiceServerFarm](../../../azure-6/Item/General/ServiceServerFarm.Local.png) | ![illustration for ServiceServerFarmCard](../../../azure-6/Item/General/ServiceServerFarmCard.Local.png) | ![illustration for ServiceServerFarmGroup](../../../azure-6/Item/General/ServiceServerFarmGroup.Local.png) |
