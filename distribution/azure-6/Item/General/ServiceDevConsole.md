...
```text
azure-6/Item/General/ServiceDevConsole
```

```text
include('azure-6/Item/General/ServiceDevConsole')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceDevConsole.png) | ![illustration for ServiceDevConsole](../../../azure-6/Item/General/ServiceDevConsole.Local.png) | ![illustration for ServiceDevConsoleCard](../../../azure-6/Item/General/ServiceDevConsoleCard.Local.png) | ![illustration for ServiceDevConsoleGroup](../../../azure-6/Item/General/ServiceDevConsoleGroup.Local.png) |
