...
```text
azure-6/Item/General/ServiceManagementGroups
```

```text
include('azure-6/Item/General/ServiceManagementGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceManagementGroups.png) | ![illustration for ServiceManagementGroups](../../../azure-6/Item/General/ServiceManagementGroups.Local.png) | ![illustration for ServiceManagementGroupsCard](../../../azure-6/Item/General/ServiceManagementGroupsCard.Local.png) | ![illustration for ServiceManagementGroupsGroup](../../../azure-6/Item/General/ServiceManagementGroupsGroup.Local.png) |
