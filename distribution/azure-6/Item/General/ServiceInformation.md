...
```text
azure-6/Item/General/ServiceInformation
```

```text
include('azure-6/Item/General/ServiceInformation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceInformation.png) | ![illustration for ServiceInformation](../../../azure-6/Item/General/ServiceInformation.Local.png) | ![illustration for ServiceInformationCard](../../../azure-6/Item/General/ServiceInformationCard.Local.png) | ![illustration for ServiceInformationGroup](../../../azure-6/Item/General/ServiceInformationGroup.Local.png) |
