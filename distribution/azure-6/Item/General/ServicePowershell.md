...
```text
azure-6/Item/General/ServicePowershell
```

```text
include('azure-6/Item/General/ServicePowershell')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServicePowershell.png) | ![illustration for ServicePowershell](../../../azure-6/Item/General/ServicePowershell.Local.png) | ![illustration for ServicePowershellCard](../../../azure-6/Item/General/ServicePowershellCard.Local.png) | ![illustration for ServicePowershellGroup](../../../azure-6/Item/General/ServicePowershellGroup.Local.png) |
