...
```text
azure-6/Item/General/ServiceMarketplace
```

```text
include('azure-6/Item/General/ServiceMarketplace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceMarketplace.png) | ![illustration for ServiceMarketplace](../../../azure-6/Item/General/ServiceMarketplace.Local.png) | ![illustration for ServiceMarketplaceCard](../../../azure-6/Item/General/ServiceMarketplaceCard.Local.png) | ![illustration for ServiceMarketplaceGroup](../../../azure-6/Item/General/ServiceMarketplaceGroup.Local.png) |
