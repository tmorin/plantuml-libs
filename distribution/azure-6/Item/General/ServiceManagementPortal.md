...
```text
azure-6/Item/General/ServiceManagementPortal
```

```text
include('azure-6/Item/General/ServiceManagementPortal')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceManagementPortal.png) | ![illustration for ServiceManagementPortal](../../../azure-6/Item/General/ServiceManagementPortal.Local.png) | ![illustration for ServiceManagementPortalCard](../../../azure-6/Item/General/ServiceManagementPortalCard.Local.png) | ![illustration for ServiceManagementPortalGroup](../../../azure-6/Item/General/ServiceManagementPortalGroup.Local.png) |
