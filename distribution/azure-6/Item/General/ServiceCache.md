...
```text
azure-6/Item/General/ServiceCache
```

```text
include('azure-6/Item/General/ServiceCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceCache.png) | ![illustration for ServiceCache](../../../azure-6/Item/General/ServiceCache.Local.png) | ![illustration for ServiceCacheCard](../../../azure-6/Item/General/ServiceCacheCard.Local.png) | ![illustration for ServiceCacheGroup](../../../azure-6/Item/General/ServiceCacheGroup.Local.png) |
