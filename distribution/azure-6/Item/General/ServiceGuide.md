...
```text
azure-6/Item/General/ServiceGuide
```

```text
include('azure-6/Item/General/ServiceGuide')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceGuide.png) | ![illustration for ServiceGuide](../../../azure-6/Item/General/ServiceGuide.Local.png) | ![illustration for ServiceGuideCard](../../../azure-6/Item/General/ServiceGuideCard.Local.png) | ![illustration for ServiceGuideGroup](../../../azure-6/Item/General/ServiceGuideGroup.Local.png) |
