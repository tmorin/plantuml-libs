...
```text
azure-6/Item/General/ServiceTemplates
```

```text
include('azure-6/Item/General/ServiceTemplates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceTemplates.png) | ![illustration for ServiceTemplates](../../../azure-6/Item/General/ServiceTemplates.Local.png) | ![illustration for ServiceTemplatesCard](../../../azure-6/Item/General/ServiceTemplatesCard.Local.png) | ![illustration for ServiceTemplatesGroup](../../../azure-6/Item/General/ServiceTemplatesGroup.Local.png) |
