...
```text
azure-6/Item/General/ServiceMediaFile
```

```text
include('azure-6/Item/General/ServiceMediaFile')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceMediaFile.png) | ![illustration for ServiceMediaFile](../../../azure-6/Item/General/ServiceMediaFile.Local.png) | ![illustration for ServiceMediaFileCard](../../../azure-6/Item/General/ServiceMediaFileCard.Local.png) | ![illustration for ServiceMediaFileGroup](../../../azure-6/Item/General/ServiceMediaFileGroup.Local.png) |
