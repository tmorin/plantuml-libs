...
```text
azure-6/Item/General/ServicePower
```

```text
include('azure-6/Item/General/ServicePower')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServicePower.png) | ![illustration for ServicePower](../../../azure-6/Item/General/ServicePower.Local.png) | ![illustration for ServicePowerCard](../../../azure-6/Item/General/ServicePowerCard.Local.png) | ![illustration for ServicePowerGroup](../../../azure-6/Item/General/ServicePowerGroup.Local.png) |
