...
```text
azure-6/Item/General/ServiceReservations
```

```text
include('azure-6/Item/General/ServiceReservations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceReservations.png) | ![illustration for ServiceReservations](../../../azure-6/Item/General/ServiceReservations.Local.png) | ![illustration for ServiceReservationsCard](../../../azure-6/Item/General/ServiceReservationsCard.Local.png) | ![illustration for ServiceReservationsGroup](../../../azure-6/Item/General/ServiceReservationsGroup.Local.png) |
