...
```text
azure-6/Item/General/ServiceCounter
```

```text
include('azure-6/Item/General/ServiceCounter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceCounter.png) | ![illustration for ServiceCounter](../../../azure-6/Item/General/ServiceCounter.Local.png) | ![illustration for ServiceCounterCard](../../../azure-6/Item/General/ServiceCounterCard.Local.png) | ![illustration for ServiceCounterGroup](../../../azure-6/Item/General/ServiceCounterGroup.Local.png) |
