...
```text
azure-6/Item/General/ServiceBranch
```

```text
include('azure-6/Item/General/ServiceBranch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceBranch.png) | ![illustration for ServiceBranch](../../../azure-6/Item/General/ServiceBranch.Local.png) | ![illustration for ServiceBranchCard](../../../azure-6/Item/General/ServiceBranchCard.Local.png) | ![illustration for ServiceBranchGroup](../../../azure-6/Item/General/ServiceBranchGroup.Local.png) |
