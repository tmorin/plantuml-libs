...
```text
azure-6/Item/General/ServiceLocation
```

```text
include('azure-6/Item/General/ServiceLocation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceLocation.png) | ![illustration for ServiceLocation](../../../azure-6/Item/General/ServiceLocation.Local.png) | ![illustration for ServiceLocationCard](../../../azure-6/Item/General/ServiceLocationCard.Local.png) | ![illustration for ServiceLocationGroup](../../../azure-6/Item/General/ServiceLocationGroup.Local.png) |
