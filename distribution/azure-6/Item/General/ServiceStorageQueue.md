...
```text
azure-6/Item/General/ServiceStorageQueue
```

```text
include('azure-6/Item/General/ServiceStorageQueue')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceStorageQueue.png) | ![illustration for ServiceStorageQueue](../../../azure-6/Item/General/ServiceStorageQueue.Local.png) | ![illustration for ServiceStorageQueueCard](../../../azure-6/Item/General/ServiceStorageQueueCard.Local.png) | ![illustration for ServiceStorageQueueGroup](../../../azure-6/Item/General/ServiceStorageQueueGroup.Local.png) |
