...
```text
azure-6/Item/General/ServiceTfsVcRepository
```

```text
include('azure-6/Item/General/ServiceTfsVcRepository')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceTfsVcRepository.png) | ![illustration for ServiceTfsVcRepository](../../../azure-6/Item/General/ServiceTfsVcRepository.Local.png) | ![illustration for ServiceTfsVcRepositoryCard](../../../azure-6/Item/General/ServiceTfsVcRepositoryCard.Local.png) | ![illustration for ServiceTfsVcRepositoryGroup](../../../azure-6/Item/General/ServiceTfsVcRepositoryGroup.Local.png) |
