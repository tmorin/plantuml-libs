...
```text
azure-6/Item/General/ServiceGlobeError
```

```text
include('azure-6/Item/General/ServiceGlobeError')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceGlobeError.png) | ![illustration for ServiceGlobeError](../../../azure-6/Item/General/ServiceGlobeError.Local.png) | ![illustration for ServiceGlobeErrorCard](../../../azure-6/Item/General/ServiceGlobeErrorCard.Local.png) | ![illustration for ServiceGlobeErrorGroup](../../../azure-6/Item/General/ServiceGlobeErrorGroup.Local.png) |
