...
```text
azure-6/Item/General/ServiceCostAnalysis
```

```text
include('azure-6/Item/General/ServiceCostAnalysis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceCostAnalysis.png) | ![illustration for ServiceCostAnalysis](../../../azure-6/Item/General/ServiceCostAnalysis.Local.png) | ![illustration for ServiceCostAnalysisCard](../../../azure-6/Item/General/ServiceCostAnalysisCard.Local.png) | ![illustration for ServiceCostAnalysisGroup](../../../azure-6/Item/General/ServiceCostAnalysisGroup.Local.png) |
