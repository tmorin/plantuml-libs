...
```text
azure-6/Item/General/ServiceMedia
```

```text
include('azure-6/Item/General/ServiceMedia')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/General/ServiceMedia.png) | ![illustration for ServiceMedia](../../../azure-6/Item/General/ServiceMedia.Local.png) | ![illustration for ServiceMediaCard](../../../azure-6/Item/General/ServiceMediaCard.Local.png) | ![illustration for ServiceMediaGroup](../../../azure-6/Item/General/ServiceMediaGroup.Local.png) |
