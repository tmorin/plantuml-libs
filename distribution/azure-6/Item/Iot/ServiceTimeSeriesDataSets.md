...
```text
azure-6/Item/Iot/ServiceTimeSeriesDataSets
```

```text
include('azure-6/Item/Iot/ServiceTimeSeriesDataSets')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Iot/ServiceTimeSeriesDataSets.png) | ![illustration for ServiceTimeSeriesDataSets](../../../azure-6/Item/Iot/ServiceTimeSeriesDataSets.Local.png) | ![illustration for ServiceTimeSeriesDataSetsCard](../../../azure-6/Item/Iot/ServiceTimeSeriesDataSetsCard.Local.png) | ![illustration for ServiceTimeSeriesDataSetsGroup](../../../azure-6/Item/Iot/ServiceTimeSeriesDataSetsGroup.Local.png) |
