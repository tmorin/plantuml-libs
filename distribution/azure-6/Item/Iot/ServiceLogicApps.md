...
```text
azure-6/Item/Iot/ServiceLogicApps
```

```text
include('azure-6/Item/Iot/ServiceLogicApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Iot/ServiceLogicApps.png) | ![illustration for ServiceLogicApps](../../../azure-6/Item/Iot/ServiceLogicApps.Local.png) | ![illustration for ServiceLogicAppsCard](../../../azure-6/Item/Iot/ServiceLogicAppsCard.Local.png) | ![illustration for ServiceLogicAppsGroup](../../../azure-6/Item/Iot/ServiceLogicAppsGroup.Local.png) |
