...
```text
azure-6/Item/AzureEcosystem/ServiceApplens
```

```text
include('azure-6/Item/AzureEcosystem/ServiceApplens')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/AzureEcosystem/ServiceApplens.png) | ![illustration for ServiceApplens](../../../azure-6/Item/AzureEcosystem/ServiceApplens.Local.png) | ![illustration for ServiceApplensCard](../../../azure-6/Item/AzureEcosystem/ServiceApplensCard.Local.png) | ![illustration for ServiceApplensGroup](../../../azure-6/Item/AzureEcosystem/ServiceApplensGroup.Local.png) |
