...
```text
azure-6/Item/Intune/ServiceClientApps
```

```text
include('azure-6/Item/Intune/ServiceClientApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Intune/ServiceClientApps.png) | ![illustration for ServiceClientApps](../../../azure-6/Item/Intune/ServiceClientApps.Local.png) | ![illustration for ServiceClientAppsCard](../../../azure-6/Item/Intune/ServiceClientAppsCard.Local.png) | ![illustration for ServiceClientAppsGroup](../../../azure-6/Item/Intune/ServiceClientAppsGroup.Local.png) |
