...
```text
azure-6/Item/Intune/ServiceSoftwareUpdates
```

```text
include('azure-6/Item/Intune/ServiceSoftwareUpdates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Intune/ServiceSoftwareUpdates.png) | ![illustration for ServiceSoftwareUpdates](../../../azure-6/Item/Intune/ServiceSoftwareUpdates.Local.png) | ![illustration for ServiceSoftwareUpdatesCard](../../../azure-6/Item/Intune/ServiceSoftwareUpdatesCard.Local.png) | ![illustration for ServiceSoftwareUpdatesGroup](../../../azure-6/Item/Intune/ServiceSoftwareUpdatesGroup.Local.png) |
