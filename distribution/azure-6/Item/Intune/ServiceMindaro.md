...
```text
azure-6/Item/Intune/ServiceMindaro
```

```text
include('azure-6/Item/Intune/ServiceMindaro')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Intune/ServiceMindaro.png) | ![illustration for ServiceMindaro](../../../azure-6/Item/Intune/ServiceMindaro.Local.png) | ![illustration for ServiceMindaroCard](../../../azure-6/Item/Intune/ServiceMindaroCard.Local.png) | ![illustration for ServiceMindaroGroup](../../../azure-6/Item/Intune/ServiceMindaroGroup.Local.png) |
