...
```text
azure-6/Item/Intune/ServiceEBooks
```

```text
include('azure-6/Item/Intune/ServiceEBooks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Intune/ServiceEBooks.png) | ![illustration for ServiceEBooks](../../../azure-6/Item/Intune/ServiceEBooks.Local.png) | ![illustration for ServiceEBooksCard](../../../azure-6/Item/Intune/ServiceEBooksCard.Local.png) | ![illustration for ServiceEBooksGroup](../../../azure-6/Item/Intune/ServiceEBooksGroup.Local.png) |
