...
```text
azure-6/Item/Databases/ServiceManagedDatabase
```

```text
include('azure-6/Item/Databases/ServiceManagedDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Databases/ServiceManagedDatabase.png) | ![illustration for ServiceManagedDatabase](../../../azure-6/Item/Databases/ServiceManagedDatabase.Local.png) | ![illustration for ServiceManagedDatabaseCard](../../../azure-6/Item/Databases/ServiceManagedDatabaseCard.Local.png) | ![illustration for ServiceManagedDatabaseGroup](../../../azure-6/Item/Databases/ServiceManagedDatabaseGroup.Local.png) |
