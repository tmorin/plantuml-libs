...
```text
azure-6/Item/Databases/ServiceSqlServer
```

```text
include('azure-6/Item/Databases/ServiceSqlServer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Databases/ServiceSqlServer.png) | ![illustration for ServiceSqlServer](../../../azure-6/Item/Databases/ServiceSqlServer.Local.png) | ![illustration for ServiceSqlServerCard](../../../azure-6/Item/Databases/ServiceSqlServerCard.Local.png) | ![illustration for ServiceSqlServerGroup](../../../azure-6/Item/Databases/ServiceSqlServerGroup.Local.png) |
