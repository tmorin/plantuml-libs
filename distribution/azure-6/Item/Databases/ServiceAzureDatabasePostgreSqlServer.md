...
```text
azure-6/Item/Databases/ServiceAzureDatabasePostgreSqlServer
```

```text
include('azure-6/Item/Databases/ServiceAzureDatabasePostgreSqlServer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Databases/ServiceAzureDatabasePostgreSqlServer.png) | ![illustration for ServiceAzureDatabasePostgreSqlServer](../../../azure-6/Item/Databases/ServiceAzureDatabasePostgreSqlServer.Local.png) | ![illustration for ServiceAzureDatabasePostgreSqlServerCard](../../../azure-6/Item/Databases/ServiceAzureDatabasePostgreSqlServerCard.Local.png) | ![illustration for ServiceAzureDatabasePostgreSqlServerGroup](../../../azure-6/Item/Databases/ServiceAzureDatabasePostgreSqlServerGroup.Local.png) |
