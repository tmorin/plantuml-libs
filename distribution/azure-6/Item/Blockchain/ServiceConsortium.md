...
```text
azure-6/Item/Blockchain/ServiceConsortium
```

```text
include('azure-6/Item/Blockchain/ServiceConsortium')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Blockchain/ServiceConsortium.png) | ![illustration for ServiceConsortium](../../../azure-6/Item/Blockchain/ServiceConsortium.Local.png) | ![illustration for ServiceConsortiumCard](../../../azure-6/Item/Blockchain/ServiceConsortiumCard.Local.png) | ![illustration for ServiceConsortiumGroup](../../../azure-6/Item/Blockchain/ServiceConsortiumGroup.Local.png) |
