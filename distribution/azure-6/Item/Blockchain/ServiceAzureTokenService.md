...
```text
azure-6/Item/Blockchain/ServiceAzureTokenService
```

```text
include('azure-6/Item/Blockchain/ServiceAzureTokenService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Blockchain/ServiceAzureTokenService.png) | ![illustration for ServiceAzureTokenService](../../../azure-6/Item/Blockchain/ServiceAzureTokenService.Local.png) | ![illustration for ServiceAzureTokenServiceCard](../../../azure-6/Item/Blockchain/ServiceAzureTokenServiceCard.Local.png) | ![illustration for ServiceAzureTokenServiceGroup](../../../azure-6/Item/Blockchain/ServiceAzureTokenServiceGroup.Local.png) |
