...
```text
azure-6/Item/Migrate/ServiceDataBoxEdge
```

```text
include('azure-6/Item/Migrate/ServiceDataBoxEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Migrate/ServiceDataBoxEdge.png) | ![illustration for ServiceDataBoxEdge](../../../azure-6/Item/Migrate/ServiceDataBoxEdge.Local.png) | ![illustration for ServiceDataBoxEdgeCard](../../../azure-6/Item/Migrate/ServiceDataBoxEdgeCard.Local.png) | ![illustration for ServiceDataBoxEdgeGroup](../../../azure-6/Item/Migrate/ServiceDataBoxEdgeGroup.Local.png) |
