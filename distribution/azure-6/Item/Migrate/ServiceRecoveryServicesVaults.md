...
```text
azure-6/Item/Migrate/ServiceRecoveryServicesVaults
```

```text
include('azure-6/Item/Migrate/ServiceRecoveryServicesVaults')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Migrate/ServiceRecoveryServicesVaults.png) | ![illustration for ServiceRecoveryServicesVaults](../../../azure-6/Item/Migrate/ServiceRecoveryServicesVaults.Local.png) | ![illustration for ServiceRecoveryServicesVaultsCard](../../../azure-6/Item/Migrate/ServiceRecoveryServicesVaultsCard.Local.png) | ![illustration for ServiceRecoveryServicesVaultsGroup](../../../azure-6/Item/Migrate/ServiceRecoveryServicesVaultsGroup.Local.png) |
