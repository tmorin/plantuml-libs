...
```text
azure-6/Item/Integration/ServiceEventGridDomains
```

```text
include('azure-6/Item/Integration/ServiceEventGridDomains')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Integration/ServiceEventGridDomains.png) | ![illustration for ServiceEventGridDomains](../../../azure-6/Item/Integration/ServiceEventGridDomains.Local.png) | ![illustration for ServiceEventGridDomainsCard](../../../azure-6/Item/Integration/ServiceEventGridDomainsCard.Local.png) | ![illustration for ServiceEventGridDomainsGroup](../../../azure-6/Item/Integration/ServiceEventGridDomainsGroup.Local.png) |
