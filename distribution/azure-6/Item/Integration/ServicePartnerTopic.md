...
```text
azure-6/Item/Integration/ServicePartnerTopic
```

```text
include('azure-6/Item/Integration/ServicePartnerTopic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Integration/ServicePartnerTopic.png) | ![illustration for ServicePartnerTopic](../../../azure-6/Item/Integration/ServicePartnerTopic.Local.png) | ![illustration for ServicePartnerTopicCard](../../../azure-6/Item/Integration/ServicePartnerTopicCard.Local.png) | ![illustration for ServicePartnerTopicGroup](../../../azure-6/Item/Integration/ServicePartnerTopicGroup.Local.png) |
