...
```text
azure-6/Item/Integration/ServicePartnerNamespace
```

```text
include('azure-6/Item/Integration/ServicePartnerNamespace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Integration/ServicePartnerNamespace.png) | ![illustration for ServicePartnerNamespace](../../../azure-6/Item/Integration/ServicePartnerNamespace.Local.png) | ![illustration for ServicePartnerNamespaceCard](../../../azure-6/Item/Integration/ServicePartnerNamespaceCard.Local.png) | ![illustration for ServicePartnerNamespaceGroup](../../../azure-6/Item/Integration/ServicePartnerNamespaceGroup.Local.png) |
