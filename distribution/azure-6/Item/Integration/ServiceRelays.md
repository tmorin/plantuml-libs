...
```text
azure-6/Item/Integration/ServiceRelays
```

```text
include('azure-6/Item/Integration/ServiceRelays')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Integration/ServiceRelays.png) | ![illustration for ServiceRelays](../../../azure-6/Item/Integration/ServiceRelays.Local.png) | ![illustration for ServiceRelaysCard](../../../azure-6/Item/Integration/ServiceRelaysCard.Local.png) | ![illustration for ServiceRelaysGroup](../../../azure-6/Item/Integration/ServiceRelaysGroup.Local.png) |
