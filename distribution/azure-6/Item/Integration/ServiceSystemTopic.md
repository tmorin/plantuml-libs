...
```text
azure-6/Item/Integration/ServiceSystemTopic
```

```text
include('azure-6/Item/Integration/ServiceSystemTopic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Integration/ServiceSystemTopic.png) | ![illustration for ServiceSystemTopic](../../../azure-6/Item/Integration/ServiceSystemTopic.Local.png) | ![illustration for ServiceSystemTopicCard](../../../azure-6/Item/Integration/ServiceSystemTopicCard.Local.png) | ![illustration for ServiceSystemTopicGroup](../../../azure-6/Item/Integration/ServiceSystemTopicGroup.Local.png) |
