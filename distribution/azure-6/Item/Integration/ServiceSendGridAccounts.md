...
```text
azure-6/Item/Integration/ServiceSendGridAccounts
```

```text
include('azure-6/Item/Integration/ServiceSendGridAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Integration/ServiceSendGridAccounts.png) | ![illustration for ServiceSendGridAccounts](../../../azure-6/Item/Integration/ServiceSendGridAccounts.Local.png) | ![illustration for ServiceSendGridAccountsCard](../../../azure-6/Item/Integration/ServiceSendGridAccountsCard.Local.png) | ![illustration for ServiceSendGridAccountsGroup](../../../azure-6/Item/Integration/ServiceSendGridAccountsGroup.Local.png) |
