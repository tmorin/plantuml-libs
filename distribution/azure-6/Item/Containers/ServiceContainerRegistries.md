...
```text
azure-6/Item/Containers/ServiceContainerRegistries
```

```text
include('azure-6/Item/Containers/ServiceContainerRegistries')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Containers/ServiceContainerRegistries.png) | ![illustration for ServiceContainerRegistries](../../../azure-6/Item/Containers/ServiceContainerRegistries.Local.png) | ![illustration for ServiceContainerRegistriesCard](../../../azure-6/Item/Containers/ServiceContainerRegistriesCard.Local.png) | ![illustration for ServiceContainerRegistriesGroup](../../../azure-6/Item/Containers/ServiceContainerRegistriesGroup.Local.png) |
