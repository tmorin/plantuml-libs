...
```text
azure-6/Item/Containers/ServiceAppServices
```

```text
include('azure-6/Item/Containers/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Containers/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-6/Item/Containers/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-6/Item/Containers/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-6/Item/Containers/ServiceAppServicesGroup.Local.png) |
