...
```text
azure-6/Item/Storage/ServiceAzureHcpCache
```

```text
include('azure-6/Item/Storage/ServiceAzureHcpCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Storage/ServiceAzureHcpCache.png) | ![illustration for ServiceAzureHcpCache](../../../azure-6/Item/Storage/ServiceAzureHcpCache.Local.png) | ![illustration for ServiceAzureHcpCacheCard](../../../azure-6/Item/Storage/ServiceAzureHcpCacheCard.Local.png) | ![illustration for ServiceAzureHcpCacheGroup](../../../azure-6/Item/Storage/ServiceAzureHcpCacheGroup.Local.png) |
