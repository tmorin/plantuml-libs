...
```text
azure-6/Item/Storage/ServiceRecoveryServicesVaults
```

```text
include('azure-6/Item/Storage/ServiceRecoveryServicesVaults')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Storage/ServiceRecoveryServicesVaults.png) | ![illustration for ServiceRecoveryServicesVaults](../../../azure-6/Item/Storage/ServiceRecoveryServicesVaults.Local.png) | ![illustration for ServiceRecoveryServicesVaultsCard](../../../azure-6/Item/Storage/ServiceRecoveryServicesVaultsCard.Local.png) | ![illustration for ServiceRecoveryServicesVaultsGroup](../../../azure-6/Item/Storage/ServiceRecoveryServicesVaultsGroup.Local.png) |
