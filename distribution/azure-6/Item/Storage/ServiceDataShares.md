...
```text
azure-6/Item/Storage/ServiceDataShares
```

```text
include('azure-6/Item/Storage/ServiceDataShares')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Storage/ServiceDataShares.png) | ![illustration for ServiceDataShares](../../../azure-6/Item/Storage/ServiceDataShares.Local.png) | ![illustration for ServiceDataSharesCard](../../../azure-6/Item/Storage/ServiceDataSharesCard.Local.png) | ![illustration for ServiceDataSharesGroup](../../../azure-6/Item/Storage/ServiceDataSharesGroup.Local.png) |
