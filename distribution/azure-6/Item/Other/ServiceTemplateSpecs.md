...
```text
azure-6/Item/Other/ServiceTemplateSpecs
```

```text
include('azure-6/Item/Other/ServiceTemplateSpecs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Other/ServiceTemplateSpecs.png) | ![illustration for ServiceTemplateSpecs](../../../azure-6/Item/Other/ServiceTemplateSpecs.Local.png) | ![illustration for ServiceTemplateSpecsCard](../../../azure-6/Item/Other/ServiceTemplateSpecsCard.Local.png) | ![illustration for ServiceTemplateSpecsGroup](../../../azure-6/Item/Other/ServiceTemplateSpecsGroup.Local.png) |
