...
```text
azure-6/Item/Other/ServiceResourceMover
```

```text
include('azure-6/Item/Other/ServiceResourceMover')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Other/ServiceResourceMover.png) | ![illustration for ServiceResourceMover](../../../azure-6/Item/Other/ServiceResourceMover.Local.png) | ![illustration for ServiceResourceMoverCard](../../../azure-6/Item/Other/ServiceResourceMoverCard.Local.png) | ![illustration for ServiceResourceMoverGroup](../../../azure-6/Item/Other/ServiceResourceMoverGroup.Local.png) |
