...
```text
azure-6/Item/Other/ServiceInstancePools
```

```text
include('azure-6/Item/Other/ServiceInstancePools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Other/ServiceInstancePools.png) | ![illustration for ServiceInstancePools](../../../azure-6/Item/Other/ServiceInstancePools.Local.png) | ![illustration for ServiceInstancePoolsCard](../../../azure-6/Item/Other/ServiceInstancePoolsCard.Local.png) | ![illustration for ServiceInstancePoolsGroup](../../../azure-6/Item/Other/ServiceInstancePoolsGroup.Local.png) |
