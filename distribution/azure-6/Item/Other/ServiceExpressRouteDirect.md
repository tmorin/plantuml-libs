...
```text
azure-6/Item/Other/ServiceExpressRouteDirect
```

```text
include('azure-6/Item/Other/ServiceExpressRouteDirect')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Other/ServiceExpressRouteDirect.png) | ![illustration for ServiceExpressRouteDirect](../../../azure-6/Item/Other/ServiceExpressRouteDirect.Local.png) | ![illustration for ServiceExpressRouteDirectCard](../../../azure-6/Item/Other/ServiceExpressRouteDirectCard.Local.png) | ![illustration for ServiceExpressRouteDirectGroup](../../../azure-6/Item/Other/ServiceExpressRouteDirectGroup.Local.png) |
