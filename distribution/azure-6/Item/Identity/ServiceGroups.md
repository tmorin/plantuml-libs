...
```text
azure-6/Item/Identity/ServiceGroups
```

```text
include('azure-6/Item/Identity/ServiceGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Identity/ServiceGroups.png) | ![illustration for ServiceGroups](../../../azure-6/Item/Identity/ServiceGroups.Local.png) | ![illustration for ServiceGroupsCard](../../../azure-6/Item/Identity/ServiceGroupsCard.Local.png) | ![illustration for ServiceGroupsGroup](../../../azure-6/Item/Identity/ServiceGroupsGroup.Local.png) |
