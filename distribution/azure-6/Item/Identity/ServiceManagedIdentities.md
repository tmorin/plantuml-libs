...
```text
azure-6/Item/Identity/ServiceManagedIdentities
```

```text
include('azure-6/Item/Identity/ServiceManagedIdentities')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Identity/ServiceManagedIdentities.png) | ![illustration for ServiceManagedIdentities](../../../azure-6/Item/Identity/ServiceManagedIdentities.Local.png) | ![illustration for ServiceManagedIdentitiesCard](../../../azure-6/Item/Identity/ServiceManagedIdentitiesCard.Local.png) | ![illustration for ServiceManagedIdentitiesGroup](../../../azure-6/Item/Identity/ServiceManagedIdentitiesGroup.Local.png) |
