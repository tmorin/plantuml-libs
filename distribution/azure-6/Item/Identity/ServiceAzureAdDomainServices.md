...
```text
azure-6/Item/Identity/ServiceAzureAdDomainServices
```

```text
include('azure-6/Item/Identity/ServiceAzureAdDomainServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Identity/ServiceAzureAdDomainServices.png) | ![illustration for ServiceAzureAdDomainServices](../../../azure-6/Item/Identity/ServiceAzureAdDomainServices.Local.png) | ![illustration for ServiceAzureAdDomainServicesCard](../../../azure-6/Item/Identity/ServiceAzureAdDomainServicesCard.Local.png) | ![illustration for ServiceAzureAdDomainServicesGroup](../../../azure-6/Item/Identity/ServiceAzureAdDomainServicesGroup.Local.png) |
