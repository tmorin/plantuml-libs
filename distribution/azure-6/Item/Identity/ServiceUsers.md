...
```text
azure-6/Item/Identity/ServiceUsers
```

```text
include('azure-6/Item/Identity/ServiceUsers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Identity/ServiceUsers.png) | ![illustration for ServiceUsers](../../../azure-6/Item/Identity/ServiceUsers.Local.png) | ![illustration for ServiceUsersCard](../../../azure-6/Item/Identity/ServiceUsersCard.Local.png) | ![illustration for ServiceUsersGroup](../../../azure-6/Item/Identity/ServiceUsersGroup.Local.png) |
