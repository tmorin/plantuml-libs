...
```text
azure-6/Item/Identity/ServiceTenantProperties
```

```text
include('azure-6/Item/Identity/ServiceTenantProperties')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Identity/ServiceTenantProperties.png) | ![illustration for ServiceTenantProperties](../../../azure-6/Item/Identity/ServiceTenantProperties.Local.png) | ![illustration for ServiceTenantPropertiesCard](../../../azure-6/Item/Identity/ServiceTenantPropertiesCard.Local.png) | ![illustration for ServiceTenantPropertiesGroup](../../../azure-6/Item/Identity/ServiceTenantPropertiesGroup.Local.png) |
