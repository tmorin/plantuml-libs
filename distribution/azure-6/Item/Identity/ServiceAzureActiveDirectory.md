...
```text
azure-6/Item/Identity/ServiceAzureActiveDirectory
```

```text
include('azure-6/Item/Identity/ServiceAzureActiveDirectory')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Identity/ServiceAzureActiveDirectory.png) | ![illustration for ServiceAzureActiveDirectory](../../../azure-6/Item/Identity/ServiceAzureActiveDirectory.Local.png) | ![illustration for ServiceAzureActiveDirectoryCard](../../../azure-6/Item/Identity/ServiceAzureActiveDirectoryCard.Local.png) | ![illustration for ServiceAzureActiveDirectoryGroup](../../../azure-6/Item/Identity/ServiceAzureActiveDirectoryGroup.Local.png) |
