...
```text
azure-6/Item/Devops/ServiceApplicationInsights
```

```text
include('azure-6/Item/Devops/ServiceApplicationInsights')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Devops/ServiceApplicationInsights.png) | ![illustration for ServiceApplicationInsights](../../../azure-6/Item/Devops/ServiceApplicationInsights.Local.png) | ![illustration for ServiceApplicationInsightsCard](../../../azure-6/Item/Devops/ServiceApplicationInsightsCard.Local.png) | ![illustration for ServiceApplicationInsightsGroup](../../../azure-6/Item/Devops/ServiceApplicationInsightsGroup.Local.png) |
