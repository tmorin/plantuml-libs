...
```text
azure-6/Item/Analytics/ServiceEventHubClusters
```

```text
include('azure-6/Item/Analytics/ServiceEventHubClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Analytics/ServiceEventHubClusters.png) | ![illustration for ServiceEventHubClusters](../../../azure-6/Item/Analytics/ServiceEventHubClusters.Local.png) | ![illustration for ServiceEventHubClustersCard](../../../azure-6/Item/Analytics/ServiceEventHubClustersCard.Local.png) | ![illustration for ServiceEventHubClustersGroup](../../../azure-6/Item/Analytics/ServiceEventHubClustersGroup.Local.png) |
