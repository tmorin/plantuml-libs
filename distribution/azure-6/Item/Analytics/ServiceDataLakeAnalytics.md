...
```text
azure-6/Item/Analytics/ServiceDataLakeAnalytics
```

```text
include('azure-6/Item/Analytics/ServiceDataLakeAnalytics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Analytics/ServiceDataLakeAnalytics.png) | ![illustration for ServiceDataLakeAnalytics](../../../azure-6/Item/Analytics/ServiceDataLakeAnalytics.Local.png) | ![illustration for ServiceDataLakeAnalyticsCard](../../../azure-6/Item/Analytics/ServiceDataLakeAnalyticsCard.Local.png) | ![illustration for ServiceDataLakeAnalyticsGroup](../../../azure-6/Item/Analytics/ServiceDataLakeAnalyticsGroup.Local.png) |
