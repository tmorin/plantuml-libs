...
```text
azure-6/Item/NewIcons/ServiceDashboardHub
```

```text
include('azure-6/Item/NewIcons/ServiceDashboardHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/NewIcons/ServiceDashboardHub.png) | ![illustration for ServiceDashboardHub](../../../azure-6/Item/NewIcons/ServiceDashboardHub.Local.png) | ![illustration for ServiceDashboardHubCard](../../../azure-6/Item/NewIcons/ServiceDashboardHubCard.Local.png) | ![illustration for ServiceDashboardHubGroup](../../../azure-6/Item/NewIcons/ServiceDashboardHubGroup.Local.png) |
