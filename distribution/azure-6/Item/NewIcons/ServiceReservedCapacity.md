...
```text
azure-6/Item/NewIcons/ServiceReservedCapacity
```

```text
include('azure-6/Item/NewIcons/ServiceReservedCapacity')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/NewIcons/ServiceReservedCapacity.png) | ![illustration for ServiceReservedCapacity](../../../azure-6/Item/NewIcons/ServiceReservedCapacity.Local.png) | ![illustration for ServiceReservedCapacityCard](../../../azure-6/Item/NewIcons/ServiceReservedCapacityCard.Local.png) | ![illustration for ServiceReservedCapacityGroup](../../../azure-6/Item/NewIcons/ServiceReservedCapacityGroup.Local.png) |
