...
```text
azure-6/Item/NewIcons/ServiceConnectedCache
```

```text
include('azure-6/Item/NewIcons/ServiceConnectedCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/NewIcons/ServiceConnectedCache.png) | ![illustration for ServiceConnectedCache](../../../azure-6/Item/NewIcons/ServiceConnectedCache.Local.png) | ![illustration for ServiceConnectedCacheCard](../../../azure-6/Item/NewIcons/ServiceConnectedCacheCard.Local.png) | ![illustration for ServiceConnectedCacheGroup](../../../azure-6/Item/NewIcons/ServiceConnectedCacheGroup.Local.png) |
