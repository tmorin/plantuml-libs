...
```text
azure-6/Item/Security/ServiceConditionalAccess
```

```text
include('azure-6/Item/Security/ServiceConditionalAccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Security/ServiceConditionalAccess.png) | ![illustration for ServiceConditionalAccess](../../../azure-6/Item/Security/ServiceConditionalAccess.Local.png) | ![illustration for ServiceConditionalAccessCard](../../../azure-6/Item/Security/ServiceConditionalAccessCard.Local.png) | ![illustration for ServiceConditionalAccessGroup](../../../azure-6/Item/Security/ServiceConditionalAccessGroup.Local.png) |
