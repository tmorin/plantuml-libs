...
```text
azure-6/Item/Security/ServiceAzureSentinel
```

```text
include('azure-6/Item/Security/ServiceAzureSentinel')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Security/ServiceAzureSentinel.png) | ![illustration for ServiceAzureSentinel](../../../azure-6/Item/Security/ServiceAzureSentinel.Local.png) | ![illustration for ServiceAzureSentinelCard](../../../azure-6/Item/Security/ServiceAzureSentinelCard.Local.png) | ![illustration for ServiceAzureSentinelGroup](../../../azure-6/Item/Security/ServiceAzureSentinelGroup.Local.png) |
