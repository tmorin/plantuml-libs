...
```text
azure-6/Item/Security/ServiceAzureDefender
```

```text
include('azure-6/Item/Security/ServiceAzureDefender')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Security/ServiceAzureDefender.png) | ![illustration for ServiceAzureDefender](../../../azure-6/Item/Security/ServiceAzureDefender.Local.png) | ![illustration for ServiceAzureDefenderCard](../../../azure-6/Item/Security/ServiceAzureDefenderCard.Local.png) | ![illustration for ServiceAzureDefenderGroup](../../../azure-6/Item/Security/ServiceAzureDefenderGroup.Local.png) |
