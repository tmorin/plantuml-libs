...
```text
azure-6/Item/Compute/ServiceMetricsAdvisor
```

```text
include('azure-6/Item/Compute/ServiceMetricsAdvisor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceMetricsAdvisor.png) | ![illustration for ServiceMetricsAdvisor](../../../azure-6/Item/Compute/ServiceMetricsAdvisor.Local.png) | ![illustration for ServiceMetricsAdvisorCard](../../../azure-6/Item/Compute/ServiceMetricsAdvisorCard.Local.png) | ![illustration for ServiceMetricsAdvisorGroup](../../../azure-6/Item/Compute/ServiceMetricsAdvisorGroup.Local.png) |
