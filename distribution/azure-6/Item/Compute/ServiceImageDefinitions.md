...
```text
azure-6/Item/Compute/ServiceImageDefinitions
```

```text
include('azure-6/Item/Compute/ServiceImageDefinitions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceImageDefinitions.png) | ![illustration for ServiceImageDefinitions](../../../azure-6/Item/Compute/ServiceImageDefinitions.Local.png) | ![illustration for ServiceImageDefinitionsCard](../../../azure-6/Item/Compute/ServiceImageDefinitionsCard.Local.png) | ![illustration for ServiceImageDefinitionsGroup](../../../azure-6/Item/Compute/ServiceImageDefinitionsGroup.Local.png) |
