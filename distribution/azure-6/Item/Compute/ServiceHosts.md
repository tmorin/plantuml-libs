...
```text
azure-6/Item/Compute/ServiceHosts
```

```text
include('azure-6/Item/Compute/ServiceHosts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceHosts.png) | ![illustration for ServiceHosts](../../../azure-6/Item/Compute/ServiceHosts.Local.png) | ![illustration for ServiceHostsCard](../../../azure-6/Item/Compute/ServiceHostsCard.Local.png) | ![illustration for ServiceHostsGroup](../../../azure-6/Item/Compute/ServiceHostsGroup.Local.png) |
