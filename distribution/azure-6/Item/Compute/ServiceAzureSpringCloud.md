...
```text
azure-6/Item/Compute/ServiceAzureSpringCloud
```

```text
include('azure-6/Item/Compute/ServiceAzureSpringCloud')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceAzureSpringCloud.png) | ![illustration for ServiceAzureSpringCloud](../../../azure-6/Item/Compute/ServiceAzureSpringCloud.Local.png) | ![illustration for ServiceAzureSpringCloudCard](../../../azure-6/Item/Compute/ServiceAzureSpringCloudCard.Local.png) | ![illustration for ServiceAzureSpringCloudGroup](../../../azure-6/Item/Compute/ServiceAzureSpringCloudGroup.Local.png) |
