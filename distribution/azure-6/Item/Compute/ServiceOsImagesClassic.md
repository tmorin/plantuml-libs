...
```text
azure-6/Item/Compute/ServiceOsImagesClassic
```

```text
include('azure-6/Item/Compute/ServiceOsImagesClassic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceOsImagesClassic.png) | ![illustration for ServiceOsImagesClassic](../../../azure-6/Item/Compute/ServiceOsImagesClassic.Local.png) | ![illustration for ServiceOsImagesClassicCard](../../../azure-6/Item/Compute/ServiceOsImagesClassicCard.Local.png) | ![illustration for ServiceOsImagesClassicGroup](../../../azure-6/Item/Compute/ServiceOsImagesClassicGroup.Local.png) |
