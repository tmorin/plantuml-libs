...
```text
azure-6/Item/Compute/ServiceBatchAccounts
```

```text
include('azure-6/Item/Compute/ServiceBatchAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceBatchAccounts.png) | ![illustration for ServiceBatchAccounts](../../../azure-6/Item/Compute/ServiceBatchAccounts.Local.png) | ![illustration for ServiceBatchAccountsCard](../../../azure-6/Item/Compute/ServiceBatchAccountsCard.Local.png) | ![illustration for ServiceBatchAccountsGroup](../../../azure-6/Item/Compute/ServiceBatchAccountsGroup.Local.png) |
