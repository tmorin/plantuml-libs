...
```text
azure-6/Item/Compute/ServiceAppServices
```

```text
include('azure-6/Item/Compute/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-6/Item/Compute/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-6/Item/Compute/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-6/Item/Compute/ServiceAppServicesGroup.Local.png) |
