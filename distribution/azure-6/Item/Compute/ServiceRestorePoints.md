...
```text
azure-6/Item/Compute/ServiceRestorePoints
```

```text
include('azure-6/Item/Compute/ServiceRestorePoints')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceRestorePoints.png) | ![illustration for ServiceRestorePoints](../../../azure-6/Item/Compute/ServiceRestorePoints.Local.png) | ![illustration for ServiceRestorePointsCard](../../../azure-6/Item/Compute/ServiceRestorePointsCard.Local.png) | ![illustration for ServiceRestorePointsGroup](../../../azure-6/Item/Compute/ServiceRestorePointsGroup.Local.png) |
