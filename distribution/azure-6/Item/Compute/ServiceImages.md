...
```text
azure-6/Item/Compute/ServiceImages
```

```text
include('azure-6/Item/Compute/ServiceImages')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceImages.png) | ![illustration for ServiceImages](../../../azure-6/Item/Compute/ServiceImages.Local.png) | ![illustration for ServiceImagesCard](../../../azure-6/Item/Compute/ServiceImagesCard.Local.png) | ![illustration for ServiceImagesGroup](../../../azure-6/Item/Compute/ServiceImagesGroup.Local.png) |
