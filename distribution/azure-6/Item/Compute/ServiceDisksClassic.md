...
```text
azure-6/Item/Compute/ServiceDisksClassic
```

```text
include('azure-6/Item/Compute/ServiceDisksClassic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceDisksClassic.png) | ![illustration for ServiceDisksClassic](../../../azure-6/Item/Compute/ServiceDisksClassic.Local.png) | ![illustration for ServiceDisksClassicCard](../../../azure-6/Item/Compute/ServiceDisksClassicCard.Local.png) | ![illustration for ServiceDisksClassicGroup](../../../azure-6/Item/Compute/ServiceDisksClassicGroup.Local.png) |
