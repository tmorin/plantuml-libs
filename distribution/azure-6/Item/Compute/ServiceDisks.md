...
```text
azure-6/Item/Compute/ServiceDisks
```

```text
include('azure-6/Item/Compute/ServiceDisks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceDisks.png) | ![illustration for ServiceDisks](../../../azure-6/Item/Compute/ServiceDisks.Local.png) | ![illustration for ServiceDisksCard](../../../azure-6/Item/Compute/ServiceDisksCard.Local.png) | ![illustration for ServiceDisksGroup](../../../azure-6/Item/Compute/ServiceDisksGroup.Local.png) |
