...
```text
azure-6/Item/Compute/ServiceImageTemplates
```

```text
include('azure-6/Item/Compute/ServiceImageTemplates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceImageTemplates.png) | ![illustration for ServiceImageTemplates](../../../azure-6/Item/Compute/ServiceImageTemplates.Local.png) | ![illustration for ServiceImageTemplatesCard](../../../azure-6/Item/Compute/ServiceImageTemplatesCard.Local.png) | ![illustration for ServiceImageTemplatesGroup](../../../azure-6/Item/Compute/ServiceImageTemplatesGroup.Local.png) |
