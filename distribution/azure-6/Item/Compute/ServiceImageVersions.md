...
```text
azure-6/Item/Compute/ServiceImageVersions
```

```text
include('azure-6/Item/Compute/ServiceImageVersions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceImageVersions.png) | ![illustration for ServiceImageVersions](../../../azure-6/Item/Compute/ServiceImageVersions.Local.png) | ![illustration for ServiceImageVersionsCard](../../../azure-6/Item/Compute/ServiceImageVersionsCard.Local.png) | ![illustration for ServiceImageVersionsGroup](../../../azure-6/Item/Compute/ServiceImageVersionsGroup.Local.png) |
