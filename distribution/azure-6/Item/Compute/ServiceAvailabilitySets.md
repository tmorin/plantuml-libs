...
```text
azure-6/Item/Compute/ServiceAvailabilitySets
```

```text
include('azure-6/Item/Compute/ServiceAvailabilitySets')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceAvailabilitySets.png) | ![illustration for ServiceAvailabilitySets](../../../azure-6/Item/Compute/ServiceAvailabilitySets.Local.png) | ![illustration for ServiceAvailabilitySetsCard](../../../azure-6/Item/Compute/ServiceAvailabilitySetsCard.Local.png) | ![illustration for ServiceAvailabilitySetsGroup](../../../azure-6/Item/Compute/ServiceAvailabilitySetsGroup.Local.png) |
