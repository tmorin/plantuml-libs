...
```text
azure-6/Item/Compute/ServiceDisksSnapshots
```

```text
include('azure-6/Item/Compute/ServiceDisksSnapshots')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-6/Item/Compute/ServiceDisksSnapshots.png) | ![illustration for ServiceDisksSnapshots](../../../azure-6/Item/Compute/ServiceDisksSnapshots.Local.png) | ![illustration for ServiceDisksSnapshotsCard](../../../azure-6/Item/Compute/ServiceDisksSnapshotsCard.Local.png) | ![illustration for ServiceDisksSnapshotsGroup](../../../azure-6/Item/Compute/ServiceDisksSnapshotsGroup.Local.png) |
