...
```text
azure-11/Item/Databases/ServiceAzureSql
```

```text
include('azure-11/Item/Databases/ServiceAzureSql')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Databases/ServiceAzureSql.png) | ![illustration for ServiceAzureSql](../../../azure-11/Item/Databases/ServiceAzureSql.Local.png) | ![illustration for ServiceAzureSqlCard](../../../azure-11/Item/Databases/ServiceAzureSqlCard.Local.png) | ![illustration for ServiceAzureSqlGroup](../../../azure-11/Item/Databases/ServiceAzureSqlGroup.Local.png) |
