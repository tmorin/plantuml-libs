...
```text
azure-11/Item/Databases/ServiceAzureDatabaseMigrationServices
```

```text
include('azure-11/Item/Databases/ServiceAzureDatabaseMigrationServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Databases/ServiceAzureDatabaseMigrationServices.png) | ![illustration for ServiceAzureDatabaseMigrationServices](../../../azure-11/Item/Databases/ServiceAzureDatabaseMigrationServices.Local.png) | ![illustration for ServiceAzureDatabaseMigrationServicesCard](../../../azure-11/Item/Databases/ServiceAzureDatabaseMigrationServicesCard.Local.png) | ![illustration for ServiceAzureDatabaseMigrationServicesGroup](../../../azure-11/Item/Databases/ServiceAzureDatabaseMigrationServicesGroup.Local.png) |
