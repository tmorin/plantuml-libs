...
```text
azure-11/Item/Databases/ServiceCacheRedis
```

```text
include('azure-11/Item/Databases/ServiceCacheRedis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Databases/ServiceCacheRedis.png) | ![illustration for ServiceCacheRedis](../../../azure-11/Item/Databases/ServiceCacheRedis.Local.png) | ![illustration for ServiceCacheRedisCard](../../../azure-11/Item/Databases/ServiceCacheRedisCard.Local.png) | ![illustration for ServiceCacheRedisGroup](../../../azure-11/Item/Databases/ServiceCacheRedisGroup.Local.png) |
