...
```text
azure-11/Item/Databases/ServiceInstancePools
```

```text
include('azure-11/Item/Databases/ServiceInstancePools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Databases/ServiceInstancePools.png) | ![illustration for ServiceInstancePools](../../../azure-11/Item/Databases/ServiceInstancePools.Local.png) | ![illustration for ServiceInstancePoolsCard](../../../azure-11/Item/Databases/ServiceInstancePoolsCard.Local.png) | ![illustration for ServiceInstancePoolsGroup](../../../azure-11/Item/Databases/ServiceInstancePoolsGroup.Local.png) |
