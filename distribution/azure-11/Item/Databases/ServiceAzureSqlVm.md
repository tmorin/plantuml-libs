...
```text
azure-11/Item/Databases/ServiceAzureSqlVm
```

```text
include('azure-11/Item/Databases/ServiceAzureSqlVm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Databases/ServiceAzureSqlVm.png) | ![illustration for ServiceAzureSqlVm](../../../azure-11/Item/Databases/ServiceAzureSqlVm.Local.png) | ![illustration for ServiceAzureSqlVmCard](../../../azure-11/Item/Databases/ServiceAzureSqlVmCard.Local.png) | ![illustration for ServiceAzureSqlVmGroup](../../../azure-11/Item/Databases/ServiceAzureSqlVmGroup.Local.png) |
