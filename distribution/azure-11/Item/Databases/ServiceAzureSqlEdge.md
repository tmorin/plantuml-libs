...
```text
azure-11/Item/Databases/ServiceAzureSqlEdge
```

```text
include('azure-11/Item/Databases/ServiceAzureSqlEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Databases/ServiceAzureSqlEdge.png) | ![illustration for ServiceAzureSqlEdge](../../../azure-11/Item/Databases/ServiceAzureSqlEdge.Local.png) | ![illustration for ServiceAzureSqlEdgeCard](../../../azure-11/Item/Databases/ServiceAzureSqlEdgeCard.Local.png) | ![illustration for ServiceAzureSqlEdgeGroup](../../../azure-11/Item/Databases/ServiceAzureSqlEdgeGroup.Local.png) |
