...
```text
azure-11/Item/Databases/ServiceSqlServer
```

```text
include('azure-11/Item/Databases/ServiceSqlServer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Databases/ServiceSqlServer.png) | ![illustration for ServiceSqlServer](../../../azure-11/Item/Databases/ServiceSqlServer.Local.png) | ![illustration for ServiceSqlServerCard](../../../azure-11/Item/Databases/ServiceSqlServerCard.Local.png) | ![illustration for ServiceSqlServerGroup](../../../azure-11/Item/Databases/ServiceSqlServerGroup.Local.png) |
