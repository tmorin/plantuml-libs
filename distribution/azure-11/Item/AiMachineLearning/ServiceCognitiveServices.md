...
```text
azure-11/Item/AiMachineLearning/ServiceCognitiveServices
```

```text
include('azure-11/Item/AiMachineLearning/ServiceCognitiveServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/AiMachineLearning/ServiceCognitiveServices.png) | ![illustration for ServiceCognitiveServices](../../../azure-11/Item/AiMachineLearning/ServiceCognitiveServices.Local.png) | ![illustration for ServiceCognitiveServicesCard](../../../azure-11/Item/AiMachineLearning/ServiceCognitiveServicesCard.Local.png) | ![illustration for ServiceCognitiveServicesGroup](../../../azure-11/Item/AiMachineLearning/ServiceCognitiveServicesGroup.Local.png) |
