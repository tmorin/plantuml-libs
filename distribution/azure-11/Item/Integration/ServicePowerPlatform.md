...
```text
azure-11/Item/Integration/ServicePowerPlatform
```

```text
include('azure-11/Item/Integration/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Integration/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure-11/Item/Integration/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure-11/Item/Integration/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure-11/Item/Integration/ServicePowerPlatformGroup.Local.png) |
