...
```text
azure-11/Item/Integration/ServiceAzureDataboxGateway
```

```text
include('azure-11/Item/Integration/ServiceAzureDataboxGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Integration/ServiceAzureDataboxGateway.png) | ![illustration for ServiceAzureDataboxGateway](../../../azure-11/Item/Integration/ServiceAzureDataboxGateway.Local.png) | ![illustration for ServiceAzureDataboxGatewayCard](../../../azure-11/Item/Integration/ServiceAzureDataboxGatewayCard.Local.png) | ![illustration for ServiceAzureDataboxGatewayGroup](../../../azure-11/Item/Integration/ServiceAzureDataboxGatewayGroup.Local.png) |
