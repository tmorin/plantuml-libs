...
```text
azure-11/Item/Integration/ServiceAppConfiguration
```

```text
include('azure-11/Item/Integration/ServiceAppConfiguration')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Integration/ServiceAppConfiguration.png) | ![illustration for ServiceAppConfiguration](../../../azure-11/Item/Integration/ServiceAppConfiguration.Local.png) | ![illustration for ServiceAppConfigurationCard](../../../azure-11/Item/Integration/ServiceAppConfigurationCard.Local.png) | ![illustration for ServiceAppConfigurationGroup](../../../azure-11/Item/Integration/ServiceAppConfigurationGroup.Local.png) |
