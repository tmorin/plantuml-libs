...
```text
azure-11/Item/Integration/ServiceAzureApiForFhir
```

```text
include('azure-11/Item/Integration/ServiceAzureApiForFhir')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Integration/ServiceAzureApiForFhir.png) | ![illustration for ServiceAzureApiForFhir](../../../azure-11/Item/Integration/ServiceAzureApiForFhir.Local.png) | ![illustration for ServiceAzureApiForFhirCard](../../../azure-11/Item/Integration/ServiceAzureApiForFhirCard.Local.png) | ![illustration for ServiceAzureApiForFhirGroup](../../../azure-11/Item/Integration/ServiceAzureApiForFhirGroup.Local.png) |
