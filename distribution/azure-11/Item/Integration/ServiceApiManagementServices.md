...
```text
azure-11/Item/Integration/ServiceApiManagementServices
```

```text
include('azure-11/Item/Integration/ServiceApiManagementServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Integration/ServiceApiManagementServices.png) | ![illustration for ServiceApiManagementServices](../../../azure-11/Item/Integration/ServiceApiManagementServices.Local.png) | ![illustration for ServiceApiManagementServicesCard](../../../azure-11/Item/Integration/ServiceApiManagementServicesCard.Local.png) | ![illustration for ServiceApiManagementServicesGroup](../../../azure-11/Item/Integration/ServiceApiManagementServicesGroup.Local.png) |
