...
```text
azure-11/Item/Integration/ServiceSendGridAccounts
```

```text
include('azure-11/Item/Integration/ServiceSendGridAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Integration/ServiceSendGridAccounts.png) | ![illustration for ServiceSendGridAccounts](../../../azure-11/Item/Integration/ServiceSendGridAccounts.Local.png) | ![illustration for ServiceSendGridAccountsCard](../../../azure-11/Item/Integration/ServiceSendGridAccountsCard.Local.png) | ![illustration for ServiceSendGridAccountsGroup](../../../azure-11/Item/Integration/ServiceSendGridAccountsGroup.Local.png) |
