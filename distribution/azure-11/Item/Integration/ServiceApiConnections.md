...
```text
azure-11/Item/Integration/ServiceApiConnections
```

```text
include('azure-11/Item/Integration/ServiceApiConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Integration/ServiceApiConnections.png) | ![illustration for ServiceApiConnections](../../../azure-11/Item/Integration/ServiceApiConnections.Local.png) | ![illustration for ServiceApiConnectionsCard](../../../azure-11/Item/Integration/ServiceApiConnectionsCard.Local.png) | ![illustration for ServiceApiConnectionsGroup](../../../azure-11/Item/Integration/ServiceApiConnectionsGroup.Local.png) |
