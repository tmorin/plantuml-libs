...
```text
azure-11/Item/Integration/ServiceLogicApps
```

```text
include('azure-11/Item/Integration/ServiceLogicApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Integration/ServiceLogicApps.png) | ![illustration for ServiceLogicApps](../../../azure-11/Item/Integration/ServiceLogicApps.Local.png) | ![illustration for ServiceLogicAppsCard](../../../azure-11/Item/Integration/ServiceLogicAppsCard.Local.png) | ![illustration for ServiceLogicAppsGroup](../../../azure-11/Item/Integration/ServiceLogicAppsGroup.Local.png) |
