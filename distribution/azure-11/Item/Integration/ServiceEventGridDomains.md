...
```text
azure-11/Item/Integration/ServiceEventGridDomains
```

```text
include('azure-11/Item/Integration/ServiceEventGridDomains')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Integration/ServiceEventGridDomains.png) | ![illustration for ServiceEventGridDomains](../../../azure-11/Item/Integration/ServiceEventGridDomains.Local.png) | ![illustration for ServiceEventGridDomainsCard](../../../azure-11/Item/Integration/ServiceEventGridDomainsCard.Local.png) | ![illustration for ServiceEventGridDomainsGroup](../../../azure-11/Item/Integration/ServiceEventGridDomainsGroup.Local.png) |
