...
```text
azure-11/Item/Web/ServiceAppServicePlans
```

```text
include('azure-11/Item/Web/ServiceAppServicePlans')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Web/ServiceAppServicePlans.png) | ![illustration for ServiceAppServicePlans](../../../azure-11/Item/Web/ServiceAppServicePlans.Local.png) | ![illustration for ServiceAppServicePlansCard](../../../azure-11/Item/Web/ServiceAppServicePlansCard.Local.png) | ![illustration for ServiceAppServicePlansGroup](../../../azure-11/Item/Web/ServiceAppServicePlansGroup.Local.png) |
