...
```text
azure-11/Item/Web/ServiceAppServices
```

```text
include('azure-11/Item/Web/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Web/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-11/Item/Web/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-11/Item/Web/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-11/Item/Web/ServiceAppServicesGroup.Local.png) |
