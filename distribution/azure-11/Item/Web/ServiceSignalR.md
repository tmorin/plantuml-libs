...
```text
azure-11/Item/Web/ServiceSignalR
```

```text
include('azure-11/Item/Web/ServiceSignalR')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Web/ServiceSignalR.png) | ![illustration for ServiceSignalR](../../../azure-11/Item/Web/ServiceSignalR.Local.png) | ![illustration for ServiceSignalRCard](../../../azure-11/Item/Web/ServiceSignalRCard.Local.png) | ![illustration for ServiceSignalRGroup](../../../azure-11/Item/Web/ServiceSignalRGroup.Local.png) |
