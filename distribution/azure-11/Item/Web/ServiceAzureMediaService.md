...
```text
azure-11/Item/Web/ServiceAzureMediaService
```

```text
include('azure-11/Item/Web/ServiceAzureMediaService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Web/ServiceAzureMediaService.png) | ![illustration for ServiceAzureMediaService](../../../azure-11/Item/Web/ServiceAzureMediaService.Local.png) | ![illustration for ServiceAzureMediaServiceCard](../../../azure-11/Item/Web/ServiceAzureMediaServiceCard.Local.png) | ![illustration for ServiceAzureMediaServiceGroup](../../../azure-11/Item/Web/ServiceAzureMediaServiceGroup.Local.png) |
