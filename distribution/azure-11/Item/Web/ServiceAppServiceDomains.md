...
```text
azure-11/Item/Web/ServiceAppServiceDomains
```

```text
include('azure-11/Item/Web/ServiceAppServiceDomains')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Web/ServiceAppServiceDomains.png) | ![illustration for ServiceAppServiceDomains](../../../azure-11/Item/Web/ServiceAppServiceDomains.Local.png) | ![illustration for ServiceAppServiceDomainsCard](../../../azure-11/Item/Web/ServiceAppServiceDomainsCard.Local.png) | ![illustration for ServiceAppServiceDomainsGroup](../../../azure-11/Item/Web/ServiceAppServiceDomainsGroup.Local.png) |
