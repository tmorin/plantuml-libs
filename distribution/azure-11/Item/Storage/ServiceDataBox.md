...
```text
azure-11/Item/Storage/ServiceDataBox
```

```text
include('azure-11/Item/Storage/ServiceDataBox')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Storage/ServiceDataBox.png) | ![illustration for ServiceDataBox](../../../azure-11/Item/Storage/ServiceDataBox.Local.png) | ![illustration for ServiceDataBoxCard](../../../azure-11/Item/Storage/ServiceDataBoxCard.Local.png) | ![illustration for ServiceDataBoxGroup](../../../azure-11/Item/Storage/ServiceDataBoxGroup.Local.png) |
