...
```text
azure-11/Item/Storage/ServiceRecoveryServicesVaults
```

```text
include('azure-11/Item/Storage/ServiceRecoveryServicesVaults')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Storage/ServiceRecoveryServicesVaults.png) | ![illustration for ServiceRecoveryServicesVaults](../../../azure-11/Item/Storage/ServiceRecoveryServicesVaults.Local.png) | ![illustration for ServiceRecoveryServicesVaultsCard](../../../azure-11/Item/Storage/ServiceRecoveryServicesVaultsCard.Local.png) | ![illustration for ServiceRecoveryServicesVaultsGroup](../../../azure-11/Item/Storage/ServiceRecoveryServicesVaultsGroup.Local.png) |
