...
```text
azure-11/Item/Storage/ServiceDataShareInvitations
```

```text
include('azure-11/Item/Storage/ServiceDataShareInvitations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Storage/ServiceDataShareInvitations.png) | ![illustration for ServiceDataShareInvitations](../../../azure-11/Item/Storage/ServiceDataShareInvitations.Local.png) | ![illustration for ServiceDataShareInvitationsCard](../../../azure-11/Item/Storage/ServiceDataShareInvitationsCard.Local.png) | ![illustration for ServiceDataShareInvitationsGroup](../../../azure-11/Item/Storage/ServiceDataShareInvitationsGroup.Local.png) |
