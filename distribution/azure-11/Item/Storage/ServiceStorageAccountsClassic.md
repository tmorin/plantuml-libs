...
```text
azure-11/Item/Storage/ServiceStorageAccountsClassic
```

```text
include('azure-11/Item/Storage/ServiceStorageAccountsClassic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Storage/ServiceStorageAccountsClassic.png) | ![illustration for ServiceStorageAccountsClassic](../../../azure-11/Item/Storage/ServiceStorageAccountsClassic.Local.png) | ![illustration for ServiceStorageAccountsClassicCard](../../../azure-11/Item/Storage/ServiceStorageAccountsClassicCard.Local.png) | ![illustration for ServiceStorageAccountsClassicGroup](../../../azure-11/Item/Storage/ServiceStorageAccountsClassicGroup.Local.png) |
