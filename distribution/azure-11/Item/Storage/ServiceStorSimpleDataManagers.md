...
```text
azure-11/Item/Storage/ServiceStorSimpleDataManagers
```

```text
include('azure-11/Item/Storage/ServiceStorSimpleDataManagers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Storage/ServiceStorSimpleDataManagers.png) | ![illustration for ServiceStorSimpleDataManagers](../../../azure-11/Item/Storage/ServiceStorSimpleDataManagers.Local.png) | ![illustration for ServiceStorSimpleDataManagersCard](../../../azure-11/Item/Storage/ServiceStorSimpleDataManagersCard.Local.png) | ![illustration for ServiceStorSimpleDataManagersGroup](../../../azure-11/Item/Storage/ServiceStorSimpleDataManagersGroup.Local.png) |
