...
```text
azure-11/Item/Storage/ServiceStorageAccounts
```

```text
include('azure-11/Item/Storage/ServiceStorageAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Storage/ServiceStorageAccounts.png) | ![illustration for ServiceStorageAccounts](../../../azure-11/Item/Storage/ServiceStorageAccounts.Local.png) | ![illustration for ServiceStorageAccountsCard](../../../azure-11/Item/Storage/ServiceStorageAccountsCard.Local.png) | ![illustration for ServiceStorageAccountsGroup](../../../azure-11/Item/Storage/ServiceStorageAccountsGroup.Local.png) |
