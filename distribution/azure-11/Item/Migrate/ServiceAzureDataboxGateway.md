...
```text
azure-11/Item/Migrate/ServiceAzureDataboxGateway
```

```text
include('azure-11/Item/Migrate/ServiceAzureDataboxGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Migrate/ServiceAzureDataboxGateway.png) | ![illustration for ServiceAzureDataboxGateway](../../../azure-11/Item/Migrate/ServiceAzureDataboxGateway.Local.png) | ![illustration for ServiceAzureDataboxGatewayCard](../../../azure-11/Item/Migrate/ServiceAzureDataboxGatewayCard.Local.png) | ![illustration for ServiceAzureDataboxGatewayGroup](../../../azure-11/Item/Migrate/ServiceAzureDataboxGatewayGroup.Local.png) |
