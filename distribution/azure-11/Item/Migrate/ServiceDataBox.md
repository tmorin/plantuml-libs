...
```text
azure-11/Item/Migrate/ServiceDataBox
```

```text
include('azure-11/Item/Migrate/ServiceDataBox')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Migrate/ServiceDataBox.png) | ![illustration for ServiceDataBox](../../../azure-11/Item/Migrate/ServiceDataBox.Local.png) | ![illustration for ServiceDataBoxCard](../../../azure-11/Item/Migrate/ServiceDataBoxCard.Local.png) | ![illustration for ServiceDataBoxGroup](../../../azure-11/Item/Migrate/ServiceDataBoxGroup.Local.png) |
