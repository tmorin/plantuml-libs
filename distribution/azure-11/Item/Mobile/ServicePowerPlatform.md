...
```text
azure-11/Item/Mobile/ServicePowerPlatform
```

```text
include('azure-11/Item/Mobile/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Mobile/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure-11/Item/Mobile/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure-11/Item/Mobile/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure-11/Item/Mobile/ServicePowerPlatformGroup.Local.png) |
