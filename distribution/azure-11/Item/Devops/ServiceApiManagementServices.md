...
```text
azure-11/Item/Devops/ServiceApiManagementServices
```

```text
include('azure-11/Item/Devops/ServiceApiManagementServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Devops/ServiceApiManagementServices.png) | ![illustration for ServiceApiManagementServices](../../../azure-11/Item/Devops/ServiceApiManagementServices.Local.png) | ![illustration for ServiceApiManagementServicesCard](../../../azure-11/Item/Devops/ServiceApiManagementServicesCard.Local.png) | ![illustration for ServiceApiManagementServicesGroup](../../../azure-11/Item/Devops/ServiceApiManagementServicesGroup.Local.png) |
