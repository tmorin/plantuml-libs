...
```text
azure-11/Item/Devops/ServiceApiConnections
```

```text
include('azure-11/Item/Devops/ServiceApiConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Devops/ServiceApiConnections.png) | ![illustration for ServiceApiConnections](../../../azure-11/Item/Devops/ServiceApiConnections.Local.png) | ![illustration for ServiceApiConnectionsCard](../../../azure-11/Item/Devops/ServiceApiConnectionsCard.Local.png) | ![illustration for ServiceApiConnectionsGroup](../../../azure-11/Item/Devops/ServiceApiConnectionsGroup.Local.png) |
