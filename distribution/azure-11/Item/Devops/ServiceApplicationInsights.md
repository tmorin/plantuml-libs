...
```text
azure-11/Item/Devops/ServiceApplicationInsights
```

```text
include('azure-11/Item/Devops/ServiceApplicationInsights')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Devops/ServiceApplicationInsights.png) | ![illustration for ServiceApplicationInsights](../../../azure-11/Item/Devops/ServiceApplicationInsights.Local.png) | ![illustration for ServiceApplicationInsightsCard](../../../azure-11/Item/Devops/ServiceApplicationInsightsCard.Local.png) | ![illustration for ServiceApplicationInsightsGroup](../../../azure-11/Item/Devops/ServiceApplicationInsightsGroup.Local.png) |
