...
```text
azure-11/Item/Analytics/ServiceAzureDatabricks
```

```text
include('azure-11/Item/Analytics/ServiceAzureDatabricks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Analytics/ServiceAzureDatabricks.png) | ![illustration for ServiceAzureDatabricks](../../../azure-11/Item/Analytics/ServiceAzureDatabricks.Local.png) | ![illustration for ServiceAzureDatabricksCard](../../../azure-11/Item/Analytics/ServiceAzureDatabricksCard.Local.png) | ![illustration for ServiceAzureDatabricksGroup](../../../azure-11/Item/Analytics/ServiceAzureDatabricksGroup.Local.png) |
