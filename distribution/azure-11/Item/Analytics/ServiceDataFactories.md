...
```text
azure-11/Item/Analytics/ServiceDataFactories
```

```text
include('azure-11/Item/Analytics/ServiceDataFactories')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Analytics/ServiceDataFactories.png) | ![illustration for ServiceDataFactories](../../../azure-11/Item/Analytics/ServiceDataFactories.Local.png) | ![illustration for ServiceDataFactoriesCard](../../../azure-11/Item/Analytics/ServiceDataFactoriesCard.Local.png) | ![illustration for ServiceDataFactoriesGroup](../../../azure-11/Item/Analytics/ServiceDataFactoriesGroup.Local.png) |
