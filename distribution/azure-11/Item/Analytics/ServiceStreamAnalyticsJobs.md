...
```text
azure-11/Item/Analytics/ServiceStreamAnalyticsJobs
```

```text
include('azure-11/Item/Analytics/ServiceStreamAnalyticsJobs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Analytics/ServiceStreamAnalyticsJobs.png) | ![illustration for ServiceStreamAnalyticsJobs](../../../azure-11/Item/Analytics/ServiceStreamAnalyticsJobs.Local.png) | ![illustration for ServiceStreamAnalyticsJobsCard](../../../azure-11/Item/Analytics/ServiceStreamAnalyticsJobsCard.Local.png) | ![illustration for ServiceStreamAnalyticsJobsGroup](../../../azure-11/Item/Analytics/ServiceStreamAnalyticsJobsGroup.Local.png) |
