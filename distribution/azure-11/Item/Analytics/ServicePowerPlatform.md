...
```text
azure-11/Item/Analytics/ServicePowerPlatform
```

```text
include('azure-11/Item/Analytics/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Analytics/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure-11/Item/Analytics/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure-11/Item/Analytics/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure-11/Item/Analytics/ServicePowerPlatformGroup.Local.png) |
