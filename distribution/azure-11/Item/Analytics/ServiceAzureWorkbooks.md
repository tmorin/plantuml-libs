...
```text
azure-11/Item/Analytics/ServiceAzureWorkbooks
```

```text
include('azure-11/Item/Analytics/ServiceAzureWorkbooks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Analytics/ServiceAzureWorkbooks.png) | ![illustration for ServiceAzureWorkbooks](../../../azure-11/Item/Analytics/ServiceAzureWorkbooks.Local.png) | ![illustration for ServiceAzureWorkbooksCard](../../../azure-11/Item/Analytics/ServiceAzureWorkbooksCard.Local.png) | ![illustration for ServiceAzureWorkbooksGroup](../../../azure-11/Item/Analytics/ServiceAzureWorkbooksGroup.Local.png) |
