...
```text
azure-11/Item/Other/ServiceDiskPool
```

```text
include('azure-11/Item/Other/ServiceDiskPool')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Other/ServiceDiskPool.png) | ![illustration for ServiceDiskPool](../../../azure-11/Item/Other/ServiceDiskPool.Local.png) | ![illustration for ServiceDiskPoolCard](../../../azure-11/Item/Other/ServiceDiskPoolCard.Local.png) | ![illustration for ServiceDiskPoolGroup](../../../azure-11/Item/Other/ServiceDiskPoolGroup.Local.png) |
