...
```text
azure-11/Item/Other/ServiceAppRegistrations
```

```text
include('azure-11/Item/Other/ServiceAppRegistrations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Other/ServiceAppRegistrations.png) | ![illustration for ServiceAppRegistrations](../../../azure-11/Item/Other/ServiceAppRegistrations.Local.png) | ![illustration for ServiceAppRegistrationsCard](../../../azure-11/Item/Other/ServiceAppRegistrationsCard.Local.png) | ![illustration for ServiceAppRegistrationsGroup](../../../azure-11/Item/Other/ServiceAppRegistrationsGroup.Local.png) |
