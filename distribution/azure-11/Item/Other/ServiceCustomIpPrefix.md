...
```text
azure-11/Item/Other/ServiceCustomIpPrefix
```

```text
include('azure-11/Item/Other/ServiceCustomIpPrefix')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Other/ServiceCustomIpPrefix.png) | ![illustration for ServiceCustomIpPrefix](../../../azure-11/Item/Other/ServiceCustomIpPrefix.Local.png) | ![illustration for ServiceCustomIpPrefixCard](../../../azure-11/Item/Other/ServiceCustomIpPrefixCard.Local.png) | ![illustration for ServiceCustomIpPrefixGroup](../../../azure-11/Item/Other/ServiceCustomIpPrefixGroup.Local.png) |
