...
```text
azure-11/Item/Other/ServiceTemplateSpecs
```

```text
include('azure-11/Item/Other/ServiceTemplateSpecs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Other/ServiceTemplateSpecs.png) | ![illustration for ServiceTemplateSpecs](../../../azure-11/Item/Other/ServiceTemplateSpecs.Local.png) | ![illustration for ServiceTemplateSpecsCard](../../../azure-11/Item/Other/ServiceTemplateSpecsCard.Local.png) | ![illustration for ServiceTemplateSpecsGroup](../../../azure-11/Item/Other/ServiceTemplateSpecsGroup.Local.png) |
