...
```text
azure-11/Item/Other/ServiceInstancePools
```

```text
include('azure-11/Item/Other/ServiceInstancePools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Other/ServiceInstancePools.png) | ![illustration for ServiceInstancePools](../../../azure-11/Item/Other/ServiceInstancePools.Local.png) | ![illustration for ServiceInstancePoolsCard](../../../azure-11/Item/Other/ServiceInstancePoolsCard.Local.png) | ![illustration for ServiceInstancePoolsGroup](../../../azure-11/Item/Other/ServiceInstancePoolsGroup.Local.png) |
