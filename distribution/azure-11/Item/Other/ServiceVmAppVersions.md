...
```text
azure-11/Item/Other/ServiceVmAppVersions
```

```text
include('azure-11/Item/Other/ServiceVmAppVersions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Other/ServiceVmAppVersions.png) | ![illustration for ServiceVmAppVersions](../../../azure-11/Item/Other/ServiceVmAppVersions.Local.png) | ![illustration for ServiceVmAppVersionsCard](../../../azure-11/Item/Other/ServiceVmAppVersionsCard.Local.png) | ![illustration for ServiceVmAppVersionsGroup](../../../azure-11/Item/Other/ServiceVmAppVersionsGroup.Local.png) |
