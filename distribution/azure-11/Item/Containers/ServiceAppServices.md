...
```text
azure-11/Item/Containers/ServiceAppServices
```

```text
include('azure-11/Item/Containers/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Containers/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-11/Item/Containers/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-11/Item/Containers/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-11/Item/Containers/ServiceAppServicesGroup.Local.png) |
