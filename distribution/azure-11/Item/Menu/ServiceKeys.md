...
```text
azure-11/Item/Menu/ServiceKeys
```

```text
include('azure-11/Item/Menu/ServiceKeys')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Menu/ServiceKeys.png) | ![illustration for ServiceKeys](../../../azure-11/Item/Menu/ServiceKeys.Local.png) | ![illustration for ServiceKeysCard](../../../azure-11/Item/Menu/ServiceKeysCard.Local.png) | ![illustration for ServiceKeysGroup](../../../azure-11/Item/Menu/ServiceKeysGroup.Local.png) |
