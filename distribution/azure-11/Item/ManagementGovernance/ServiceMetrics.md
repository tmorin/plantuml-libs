...
```text
azure-11/Item/ManagementGovernance/ServiceMetrics
```

```text
include('azure-11/Item/ManagementGovernance/ServiceMetrics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/ManagementGovernance/ServiceMetrics.png) | ![illustration for ServiceMetrics](../../../azure-11/Item/ManagementGovernance/ServiceMetrics.Local.png) | ![illustration for ServiceMetricsCard](../../../azure-11/Item/ManagementGovernance/ServiceMetricsCard.Local.png) | ![illustration for ServiceMetricsGroup](../../../azure-11/Item/ManagementGovernance/ServiceMetricsGroup.Local.png) |
