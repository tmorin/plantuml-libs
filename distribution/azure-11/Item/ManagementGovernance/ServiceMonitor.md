...
```text
azure-11/Item/ManagementGovernance/ServiceMonitor
```

```text
include('azure-11/Item/ManagementGovernance/ServiceMonitor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/ManagementGovernance/ServiceMonitor.png) | ![illustration for ServiceMonitor](../../../azure-11/Item/ManagementGovernance/ServiceMonitor.Local.png) | ![illustration for ServiceMonitorCard](../../../azure-11/Item/ManagementGovernance/ServiceMonitorCard.Local.png) | ![illustration for ServiceMonitorGroup](../../../azure-11/Item/ManagementGovernance/ServiceMonitorGroup.Local.png) |
