...
```text
azure-11/Item/ManagementGovernance/ServiceActivityLog
```

```text
include('azure-11/Item/ManagementGovernance/ServiceActivityLog')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/ManagementGovernance/ServiceActivityLog.png) | ![illustration for ServiceActivityLog](../../../azure-11/Item/ManagementGovernance/ServiceActivityLog.Local.png) | ![illustration for ServiceActivityLogCard](../../../azure-11/Item/ManagementGovernance/ServiceActivityLogCard.Local.png) | ![illustration for ServiceActivityLogGroup](../../../azure-11/Item/ManagementGovernance/ServiceActivityLogGroup.Local.png) |
