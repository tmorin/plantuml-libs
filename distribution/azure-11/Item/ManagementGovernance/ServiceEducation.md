...
```text
azure-11/Item/ManagementGovernance/ServiceEducation
```

```text
include('azure-11/Item/ManagementGovernance/ServiceEducation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/ManagementGovernance/ServiceEducation.png) | ![illustration for ServiceEducation](../../../azure-11/Item/ManagementGovernance/ServiceEducation.Local.png) | ![illustration for ServiceEducationCard](../../../azure-11/Item/ManagementGovernance/ServiceEducationCard.Local.png) | ![illustration for ServiceEducationGroup](../../../azure-11/Item/ManagementGovernance/ServiceEducationGroup.Local.png) |
