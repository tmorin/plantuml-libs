...
```text
azure-11/Item/ManagementGovernance/ServiceBlueprints
```

```text
include('azure-11/Item/ManagementGovernance/ServiceBlueprints')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/ManagementGovernance/ServiceBlueprints.png) | ![illustration for ServiceBlueprints](../../../azure-11/Item/ManagementGovernance/ServiceBlueprints.Local.png) | ![illustration for ServiceBlueprintsCard](../../../azure-11/Item/ManagementGovernance/ServiceBlueprintsCard.Local.png) | ![illustration for ServiceBlueprintsGroup](../../../azure-11/Item/ManagementGovernance/ServiceBlueprintsGroup.Local.png) |
