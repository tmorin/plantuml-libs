...
```text
azure-11/Item/AzureStack/ServiceCapacity
```

```text
include('azure-11/Item/AzureStack/ServiceCapacity')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/AzureStack/ServiceCapacity.png) | ![illustration for ServiceCapacity](../../../azure-11/Item/AzureStack/ServiceCapacity.Local.png) | ![illustration for ServiceCapacityCard](../../../azure-11/Item/AzureStack/ServiceCapacityCard.Local.png) | ![illustration for ServiceCapacityGroup](../../../azure-11/Item/AzureStack/ServiceCapacityGroup.Local.png) |
