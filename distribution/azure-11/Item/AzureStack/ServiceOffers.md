...
```text
azure-11/Item/AzureStack/ServiceOffers
```

```text
include('azure-11/Item/AzureStack/ServiceOffers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/AzureStack/ServiceOffers.png) | ![illustration for ServiceOffers](../../../azure-11/Item/AzureStack/ServiceOffers.Local.png) | ![illustration for ServiceOffersCard](../../../azure-11/Item/AzureStack/ServiceOffersCard.Local.png) | ![illustration for ServiceOffersGroup](../../../azure-11/Item/AzureStack/ServiceOffersGroup.Local.png) |
