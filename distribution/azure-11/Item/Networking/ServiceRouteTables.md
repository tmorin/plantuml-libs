...
```text
azure-11/Item/Networking/ServiceRouteTables
```

```text
include('azure-11/Item/Networking/ServiceRouteTables')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Networking/ServiceRouteTables.png) | ![illustration for ServiceRouteTables](../../../azure-11/Item/Networking/ServiceRouteTables.Local.png) | ![illustration for ServiceRouteTablesCard](../../../azure-11/Item/Networking/ServiceRouteTablesCard.Local.png) | ![illustration for ServiceRouteTablesGroup](../../../azure-11/Item/Networking/ServiceRouteTablesGroup.Local.png) |
