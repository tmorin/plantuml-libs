...
```text
azure-11/Item/Networking/ServiceApplicationGateways
```

```text
include('azure-11/Item/Networking/ServiceApplicationGateways')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Networking/ServiceApplicationGateways.png) | ![illustration for ServiceApplicationGateways](../../../azure-11/Item/Networking/ServiceApplicationGateways.Local.png) | ![illustration for ServiceApplicationGatewaysCard](../../../azure-11/Item/Networking/ServiceApplicationGatewaysCard.Local.png) | ![illustration for ServiceApplicationGatewaysGroup](../../../azure-11/Item/Networking/ServiceApplicationGatewaysGroup.Local.png) |
