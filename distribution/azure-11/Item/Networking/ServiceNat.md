...
```text
azure-11/Item/Networking/ServiceNat
```

```text
include('azure-11/Item/Networking/ServiceNat')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Networking/ServiceNat.png) | ![illustration for ServiceNat](../../../azure-11/Item/Networking/ServiceNat.Local.png) | ![illustration for ServiceNatCard](../../../azure-11/Item/Networking/ServiceNatCard.Local.png) | ![illustration for ServiceNatGroup](../../../azure-11/Item/Networking/ServiceNatGroup.Local.png) |
