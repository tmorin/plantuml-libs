...
```text
azure-11/Item/Networking/ServiceDnsZones
```

```text
include('azure-11/Item/Networking/ServiceDnsZones')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Networking/ServiceDnsZones.png) | ![illustration for ServiceDnsZones](../../../azure-11/Item/Networking/ServiceDnsZones.Local.png) | ![illustration for ServiceDnsZonesCard](../../../azure-11/Item/Networking/ServiceDnsZonesCard.Local.png) | ![illustration for ServiceDnsZonesGroup](../../../azure-11/Item/Networking/ServiceDnsZonesGroup.Local.png) |
