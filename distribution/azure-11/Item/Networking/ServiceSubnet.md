...
```text
azure-11/Item/Networking/ServiceSubnet
```

```text
include('azure-11/Item/Networking/ServiceSubnet')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Networking/ServiceSubnet.png) | ![illustration for ServiceSubnet](../../../azure-11/Item/Networking/ServiceSubnet.Local.png) | ![illustration for ServiceSubnetCard](../../../azure-11/Item/Networking/ServiceSubnetCard.Local.png) | ![illustration for ServiceSubnetGroup](../../../azure-11/Item/Networking/ServiceSubnetGroup.Local.png) |
