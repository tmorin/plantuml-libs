...
```text
azure-11/Item/Networking/ServiceLocalNetworkGateways
```

```text
include('azure-11/Item/Networking/ServiceLocalNetworkGateways')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Networking/ServiceLocalNetworkGateways.png) | ![illustration for ServiceLocalNetworkGateways](../../../azure-11/Item/Networking/ServiceLocalNetworkGateways.Local.png) | ![illustration for ServiceLocalNetworkGatewaysCard](../../../azure-11/Item/Networking/ServiceLocalNetworkGatewaysCard.Local.png) | ![illustration for ServiceLocalNetworkGatewaysGroup](../../../azure-11/Item/Networking/ServiceLocalNetworkGatewaysGroup.Local.png) |
