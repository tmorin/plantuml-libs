...
```text
azure-11/Item/Networking/ServicePrivateLink
```

```text
include('azure-11/Item/Networking/ServicePrivateLink')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Networking/ServicePrivateLink.png) | ![illustration for ServicePrivateLink](../../../azure-11/Item/Networking/ServicePrivateLink.Local.png) | ![illustration for ServicePrivateLinkCard](../../../azure-11/Item/Networking/ServicePrivateLinkCard.Local.png) | ![illustration for ServicePrivateLinkGroup](../../../azure-11/Item/Networking/ServicePrivateLinkGroup.Local.png) |
