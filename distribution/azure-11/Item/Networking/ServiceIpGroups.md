...
```text
azure-11/Item/Networking/ServiceIpGroups
```

```text
include('azure-11/Item/Networking/ServiceIpGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Networking/ServiceIpGroups.png) | ![illustration for ServiceIpGroups](../../../azure-11/Item/Networking/ServiceIpGroups.Local.png) | ![illustration for ServiceIpGroupsCard](../../../azure-11/Item/Networking/ServiceIpGroupsCard.Local.png) | ![illustration for ServiceIpGroupsGroup](../../../azure-11/Item/Networking/ServiceIpGroupsGroup.Local.png) |
