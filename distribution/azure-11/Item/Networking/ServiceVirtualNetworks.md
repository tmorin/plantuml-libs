...
```text
azure-11/Item/Networking/ServiceVirtualNetworks
```

```text
include('azure-11/Item/Networking/ServiceVirtualNetworks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Networking/ServiceVirtualNetworks.png) | ![illustration for ServiceVirtualNetworks](../../../azure-11/Item/Networking/ServiceVirtualNetworks.Local.png) | ![illustration for ServiceVirtualNetworksCard](../../../azure-11/Item/Networking/ServiceVirtualNetworksCard.Local.png) | ![illustration for ServiceVirtualNetworksGroup](../../../azure-11/Item/Networking/ServiceVirtualNetworksGroup.Local.png) |
