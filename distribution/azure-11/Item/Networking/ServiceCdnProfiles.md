...
```text
azure-11/Item/Networking/ServiceCdnProfiles
```

```text
include('azure-11/Item/Networking/ServiceCdnProfiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Networking/ServiceCdnProfiles.png) | ![illustration for ServiceCdnProfiles](../../../azure-11/Item/Networking/ServiceCdnProfiles.Local.png) | ![illustration for ServiceCdnProfilesCard](../../../azure-11/Item/Networking/ServiceCdnProfilesCard.Local.png) | ![illustration for ServiceCdnProfilesGroup](../../../azure-11/Item/Networking/ServiceCdnProfilesGroup.Local.png) |
