...
```text
azure-11/Item/General/ServicePowershell
```

```text
include('azure-11/Item/General/ServicePowershell')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServicePowershell.png) | ![illustration for ServicePowershell](../../../azure-11/Item/General/ServicePowershell.Local.png) | ![illustration for ServicePowershellCard](../../../azure-11/Item/General/ServicePowershellCard.Local.png) | ![illustration for ServicePowershellGroup](../../../azure-11/Item/General/ServicePowershellGroup.Local.png) |
