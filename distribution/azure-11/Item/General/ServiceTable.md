...
```text
azure-11/Item/General/ServiceTable
```

```text
include('azure-11/Item/General/ServiceTable')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceTable.png) | ![illustration for ServiceTable](../../../azure-11/Item/General/ServiceTable.Local.png) | ![illustration for ServiceTableCard](../../../azure-11/Item/General/ServiceTableCard.Local.png) | ![illustration for ServiceTableGroup](../../../azure-11/Item/General/ServiceTableGroup.Local.png) |
