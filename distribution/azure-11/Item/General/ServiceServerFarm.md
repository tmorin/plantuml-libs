...
```text
azure-11/Item/General/ServiceServerFarm
```

```text
include('azure-11/Item/General/ServiceServerFarm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceServerFarm.png) | ![illustration for ServiceServerFarm](../../../azure-11/Item/General/ServiceServerFarm.Local.png) | ![illustration for ServiceServerFarmCard](../../../azure-11/Item/General/ServiceServerFarmCard.Local.png) | ![illustration for ServiceServerFarmGroup](../../../azure-11/Item/General/ServiceServerFarmGroup.Local.png) |
