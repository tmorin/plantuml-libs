...
```text
azure-11/Item/General/ServiceWebSlots
```

```text
include('azure-11/Item/General/ServiceWebSlots')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceWebSlots.png) | ![illustration for ServiceWebSlots](../../../azure-11/Item/General/ServiceWebSlots.Local.png) | ![illustration for ServiceWebSlotsCard](../../../azure-11/Item/General/ServiceWebSlotsCard.Local.png) | ![illustration for ServiceWebSlotsGroup](../../../azure-11/Item/General/ServiceWebSlotsGroup.Local.png) |
