...
```text
azure-11/Item/General/ServiceImage
```

```text
include('azure-11/Item/General/ServiceImage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceImage.png) | ![illustration for ServiceImage](../../../azure-11/Item/General/ServiceImage.Local.png) | ![illustration for ServiceImageCard](../../../azure-11/Item/General/ServiceImageCard.Local.png) | ![illustration for ServiceImageGroup](../../../azure-11/Item/General/ServiceImageGroup.Local.png) |
