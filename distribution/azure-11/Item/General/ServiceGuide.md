...
```text
azure-11/Item/General/ServiceGuide
```

```text
include('azure-11/Item/General/ServiceGuide')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceGuide.png) | ![illustration for ServiceGuide](../../../azure-11/Item/General/ServiceGuide.Local.png) | ![illustration for ServiceGuideCard](../../../azure-11/Item/General/ServiceGuideCard.Local.png) | ![illustration for ServiceGuideGroup](../../../azure-11/Item/General/ServiceGuideGroup.Local.png) |
