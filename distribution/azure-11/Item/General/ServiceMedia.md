...
```text
azure-11/Item/General/ServiceMedia
```

```text
include('azure-11/Item/General/ServiceMedia')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceMedia.png) | ![illustration for ServiceMedia](../../../azure-11/Item/General/ServiceMedia.Local.png) | ![illustration for ServiceMediaCard](../../../azure-11/Item/General/ServiceMediaCard.Local.png) | ![illustration for ServiceMediaGroup](../../../azure-11/Item/General/ServiceMediaGroup.Local.png) |
