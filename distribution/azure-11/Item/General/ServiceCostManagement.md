...
```text
azure-11/Item/General/ServiceCostManagement
```

```text
include('azure-11/Item/General/ServiceCostManagement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceCostManagement.png) | ![illustration for ServiceCostManagement](../../../azure-11/Item/General/ServiceCostManagement.Local.png) | ![illustration for ServiceCostManagementCard](../../../azure-11/Item/General/ServiceCostManagementCard.Local.png) | ![illustration for ServiceCostManagementGroup](../../../azure-11/Item/General/ServiceCostManagementGroup.Local.png) |
