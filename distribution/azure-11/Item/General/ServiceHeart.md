...
```text
azure-11/Item/General/ServiceHeart
```

```text
include('azure-11/Item/General/ServiceHeart')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceHeart.png) | ![illustration for ServiceHeart](../../../azure-11/Item/General/ServiceHeart.Local.png) | ![illustration for ServiceHeartCard](../../../azure-11/Item/General/ServiceHeartCard.Local.png) | ![illustration for ServiceHeartGroup](../../../azure-11/Item/General/ServiceHeartGroup.Local.png) |
