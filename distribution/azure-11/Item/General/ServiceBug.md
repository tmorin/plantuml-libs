...
```text
azure-11/Item/General/ServiceBug
```

```text
include('azure-11/Item/General/ServiceBug')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceBug.png) | ![illustration for ServiceBug](../../../azure-11/Item/General/ServiceBug.Local.png) | ![illustration for ServiceBugCard](../../../azure-11/Item/General/ServiceBugCard.Local.png) | ![illustration for ServiceBugGroup](../../../azure-11/Item/General/ServiceBugGroup.Local.png) |
