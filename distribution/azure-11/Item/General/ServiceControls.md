...
```text
azure-11/Item/General/ServiceControls
```

```text
include('azure-11/Item/General/ServiceControls')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceControls.png) | ![illustration for ServiceControls](../../../azure-11/Item/General/ServiceControls.Local.png) | ![illustration for ServiceControlsCard](../../../azure-11/Item/General/ServiceControlsCard.Local.png) | ![illustration for ServiceControlsGroup](../../../azure-11/Item/General/ServiceControlsGroup.Local.png) |
