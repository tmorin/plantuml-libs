...
```text
azure-11/Item/General/ServiceRegionManagement
```

```text
include('azure-11/Item/General/ServiceRegionManagement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceRegionManagement.png) | ![illustration for ServiceRegionManagement](../../../azure-11/Item/General/ServiceRegionManagement.Local.png) | ![illustration for ServiceRegionManagementCard](../../../azure-11/Item/General/ServiceRegionManagementCard.Local.png) | ![illustration for ServiceRegionManagementGroup](../../../azure-11/Item/General/ServiceRegionManagementGroup.Local.png) |
