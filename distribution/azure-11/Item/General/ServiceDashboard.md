...
```text
azure-11/Item/General/ServiceDashboard
```

```text
include('azure-11/Item/General/ServiceDashboard')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceDashboard.png) | ![illustration for ServiceDashboard](../../../azure-11/Item/General/ServiceDashboard.Local.png) | ![illustration for ServiceDashboardCard](../../../azure-11/Item/General/ServiceDashboardCard.Local.png) | ![illustration for ServiceDashboardGroup](../../../azure-11/Item/General/ServiceDashboardGroup.Local.png) |
