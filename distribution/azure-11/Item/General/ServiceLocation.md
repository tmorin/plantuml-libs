...
```text
azure-11/Item/General/ServiceLocation
```

```text
include('azure-11/Item/General/ServiceLocation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceLocation.png) | ![illustration for ServiceLocation](../../../azure-11/Item/General/ServiceLocation.Local.png) | ![illustration for ServiceLocationCard](../../../azure-11/Item/General/ServiceLocationCard.Local.png) | ![illustration for ServiceLocationGroup](../../../azure-11/Item/General/ServiceLocationGroup.Local.png) |
