...
```text
azure-11/Item/General/ServicePower
```

```text
include('azure-11/Item/General/ServicePower')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServicePower.png) | ![illustration for ServicePower](../../../azure-11/Item/General/ServicePower.Local.png) | ![illustration for ServicePowerCard](../../../azure-11/Item/General/ServicePowerCard.Local.png) | ![illustration for ServicePowerGroup](../../../azure-11/Item/General/ServicePowerGroup.Local.png) |
