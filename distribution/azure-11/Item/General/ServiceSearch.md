...
```text
azure-11/Item/General/ServiceSearch
```

```text
include('azure-11/Item/General/ServiceSearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceSearch.png) | ![illustration for ServiceSearch](../../../azure-11/Item/General/ServiceSearch.Local.png) | ![illustration for ServiceSearchCard](../../../azure-11/Item/General/ServiceSearchCard.Local.png) | ![illustration for ServiceSearchGroup](../../../azure-11/Item/General/ServiceSearchGroup.Local.png) |
