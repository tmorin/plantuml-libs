...
```text
azure-11/Item/General/ServiceManagementGroups
```

```text
include('azure-11/Item/General/ServiceManagementGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceManagementGroups.png) | ![illustration for ServiceManagementGroups](../../../azure-11/Item/General/ServiceManagementGroups.Local.png) | ![illustration for ServiceManagementGroupsCard](../../../azure-11/Item/General/ServiceManagementGroupsCard.Local.png) | ![illustration for ServiceManagementGroupsGroup](../../../azure-11/Item/General/ServiceManagementGroupsGroup.Local.png) |
