...
```text
azure-11/Item/General/ServiceFtp
```

```text
include('azure-11/Item/General/ServiceFtp')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceFtp.png) | ![illustration for ServiceFtp](../../../azure-11/Item/General/ServiceFtp.Local.png) | ![illustration for ServiceFtpCard](../../../azure-11/Item/General/ServiceFtpCard.Local.png) | ![illustration for ServiceFtpGroup](../../../azure-11/Item/General/ServiceFtpGroup.Local.png) |
