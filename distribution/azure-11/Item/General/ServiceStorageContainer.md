...
```text
azure-11/Item/General/ServiceStorageContainer
```

```text
include('azure-11/Item/General/ServiceStorageContainer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceStorageContainer.png) | ![illustration for ServiceStorageContainer](../../../azure-11/Item/General/ServiceStorageContainer.Local.png) | ![illustration for ServiceStorageContainerCard](../../../azure-11/Item/General/ServiceStorageContainerCard.Local.png) | ![illustration for ServiceStorageContainerGroup](../../../azure-11/Item/General/ServiceStorageContainerGroup.Local.png) |
