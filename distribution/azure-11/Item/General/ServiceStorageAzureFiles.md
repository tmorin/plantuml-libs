...
```text
azure-11/Item/General/ServiceStorageAzureFiles
```

```text
include('azure-11/Item/General/ServiceStorageAzureFiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceStorageAzureFiles.png) | ![illustration for ServiceStorageAzureFiles](../../../azure-11/Item/General/ServiceStorageAzureFiles.Local.png) | ![illustration for ServiceStorageAzureFilesCard](../../../azure-11/Item/General/ServiceStorageAzureFilesCard.Local.png) | ![illustration for ServiceStorageAzureFilesGroup](../../../azure-11/Item/General/ServiceStorageAzureFilesGroup.Local.png) |
