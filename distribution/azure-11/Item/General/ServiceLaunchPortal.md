...
```text
azure-11/Item/General/ServiceLaunchPortal
```

```text
include('azure-11/Item/General/ServiceLaunchPortal')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceLaunchPortal.png) | ![illustration for ServiceLaunchPortal](../../../azure-11/Item/General/ServiceLaunchPortal.Local.png) | ![illustration for ServiceLaunchPortalCard](../../../azure-11/Item/General/ServiceLaunchPortalCard.Local.png) | ![illustration for ServiceLaunchPortalGroup](../../../azure-11/Item/General/ServiceLaunchPortalGroup.Local.png) |
