...
```text
azure-11/Item/General/ServiceError
```

```text
include('azure-11/Item/General/ServiceError')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceError.png) | ![illustration for ServiceError](../../../azure-11/Item/General/ServiceError.Local.png) | ![illustration for ServiceErrorCard](../../../azure-11/Item/General/ServiceErrorCard.Local.png) | ![illustration for ServiceErrorGroup](../../../azure-11/Item/General/ServiceErrorGroup.Local.png) |
