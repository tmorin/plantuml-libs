...
```text
azure-11/Item/General/ServiceScheduler
```

```text
include('azure-11/Item/General/ServiceScheduler')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceScheduler.png) | ![illustration for ServiceScheduler](../../../azure-11/Item/General/ServiceScheduler.Local.png) | ![illustration for ServiceSchedulerCard](../../../azure-11/Item/General/ServiceSchedulerCard.Local.png) | ![illustration for ServiceSchedulerGroup](../../../azure-11/Item/General/ServiceSchedulerGroup.Local.png) |
