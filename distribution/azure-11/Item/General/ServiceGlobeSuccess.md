...
```text
azure-11/Item/General/ServiceGlobeSuccess
```

```text
include('azure-11/Item/General/ServiceGlobeSuccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceGlobeSuccess.png) | ![illustration for ServiceGlobeSuccess](../../../azure-11/Item/General/ServiceGlobeSuccess.Local.png) | ![illustration for ServiceGlobeSuccessCard](../../../azure-11/Item/General/ServiceGlobeSuccessCard.Local.png) | ![illustration for ServiceGlobeSuccessGroup](../../../azure-11/Item/General/ServiceGlobeSuccessGroup.Local.png) |
