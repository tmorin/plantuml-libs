...
```text
azure-11/Item/General/ServiceSearchGrid
```

```text
include('azure-11/Item/General/ServiceSearchGrid')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceSearchGrid.png) | ![illustration for ServiceSearchGrid](../../../azure-11/Item/General/ServiceSearchGrid.Local.png) | ![illustration for ServiceSearchGridCard](../../../azure-11/Item/General/ServiceSearchGridCard.Local.png) | ![illustration for ServiceSearchGridGroup](../../../azure-11/Item/General/ServiceSearchGridGroup.Local.png) |
