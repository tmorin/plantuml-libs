...
```text
azure-11/Item/General/ServiceModule
```

```text
include('azure-11/Item/General/ServiceModule')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceModule.png) | ![illustration for ServiceModule](../../../azure-11/Item/General/ServiceModule.Local.png) | ![illustration for ServiceModuleCard](../../../azure-11/Item/General/ServiceModuleCard.Local.png) | ![illustration for ServiceModuleGroup](../../../azure-11/Item/General/ServiceModuleGroup.Local.png) |
