...
```text
azure-11/Item/General/ServiceTags
```

```text
include('azure-11/Item/General/ServiceTags')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceTags.png) | ![illustration for ServiceTags](../../../azure-11/Item/General/ServiceTags.Local.png) | ![illustration for ServiceTagsCard](../../../azure-11/Item/General/ServiceTagsCard.Local.png) | ![illustration for ServiceTagsGroup](../../../azure-11/Item/General/ServiceTagsGroup.Local.png) |
