...
```text
azure-11/Item/General/ServiceCommit
```

```text
include('azure-11/Item/General/ServiceCommit')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceCommit.png) | ![illustration for ServiceCommit](../../../azure-11/Item/General/ServiceCommit.Local.png) | ![illustration for ServiceCommitCard](../../../azure-11/Item/General/ServiceCommitCard.Local.png) | ![illustration for ServiceCommitGroup](../../../azure-11/Item/General/ServiceCommitGroup.Local.png) |
