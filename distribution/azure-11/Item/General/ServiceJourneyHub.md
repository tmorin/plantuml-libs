...
```text
azure-11/Item/General/ServiceJourneyHub
```

```text
include('azure-11/Item/General/ServiceJourneyHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceJourneyHub.png) | ![illustration for ServiceJourneyHub](../../../azure-11/Item/General/ServiceJourneyHub.Local.png) | ![illustration for ServiceJourneyHubCard](../../../azure-11/Item/General/ServiceJourneyHubCard.Local.png) | ![illustration for ServiceJourneyHubGroup](../../../azure-11/Item/General/ServiceJourneyHubGroup.Local.png) |
