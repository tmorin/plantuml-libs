...
```text
azure-11/Item/General/ServiceBrowser
```

```text
include('azure-11/Item/General/ServiceBrowser')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceBrowser.png) | ![illustration for ServiceBrowser](../../../azure-11/Item/General/ServiceBrowser.Local.png) | ![illustration for ServiceBrowserCard](../../../azure-11/Item/General/ServiceBrowserCard.Local.png) | ![illustration for ServiceBrowserGroup](../../../azure-11/Item/General/ServiceBrowserGroup.Local.png) |
