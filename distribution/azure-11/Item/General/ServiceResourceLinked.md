...
```text
azure-11/Item/General/ServiceResourceLinked
```

```text
include('azure-11/Item/General/ServiceResourceLinked')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceResourceLinked.png) | ![illustration for ServiceResourceLinked](../../../azure-11/Item/General/ServiceResourceLinked.Local.png) | ![illustration for ServiceResourceLinkedCard](../../../azure-11/Item/General/ServiceResourceLinkedCard.Local.png) | ![illustration for ServiceResourceLinkedGroup](../../../azure-11/Item/General/ServiceResourceLinkedGroup.Local.png) |
