...
```text
azure-11/Item/General/ServiceStorageQueue
```

```text
include('azure-11/Item/General/ServiceStorageQueue')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceStorageQueue.png) | ![illustration for ServiceStorageQueue](../../../azure-11/Item/General/ServiceStorageQueue.Local.png) | ![illustration for ServiceStorageQueueCard](../../../azure-11/Item/General/ServiceStorageQueueCard.Local.png) | ![illustration for ServiceStorageQueueGroup](../../../azure-11/Item/General/ServiceStorageQueueGroup.Local.png) |
