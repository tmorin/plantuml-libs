...
```text
azure-11/Item/General/ServicePowerUp
```

```text
include('azure-11/Item/General/ServicePowerUp')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServicePowerUp.png) | ![illustration for ServicePowerUp](../../../azure-11/Item/General/ServicePowerUp.Local.png) | ![illustration for ServicePowerUpCard](../../../azure-11/Item/General/ServicePowerUpCard.Local.png) | ![illustration for ServicePowerUpGroup](../../../azure-11/Item/General/ServicePowerUpGroup.Local.png) |
