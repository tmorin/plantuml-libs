...
```text
azure-11/Item/General/ServiceMarketplace
```

```text
include('azure-11/Item/General/ServiceMarketplace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceMarketplace.png) | ![illustration for ServiceMarketplace](../../../azure-11/Item/General/ServiceMarketplace.Local.png) | ![illustration for ServiceMarketplaceCard](../../../azure-11/Item/General/ServiceMarketplaceCard.Local.png) | ![illustration for ServiceMarketplaceGroup](../../../azure-11/Item/General/ServiceMarketplaceGroup.Local.png) |
