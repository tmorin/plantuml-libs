...
```text
azure-11/Item/General/ServiceFile
```

```text
include('azure-11/Item/General/ServiceFile')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceFile.png) | ![illustration for ServiceFile](../../../azure-11/Item/General/ServiceFile.Local.png) | ![illustration for ServiceFileCard](../../../azure-11/Item/General/ServiceFileCard.Local.png) | ![illustration for ServiceFileGroup](../../../azure-11/Item/General/ServiceFileGroup.Local.png) |
