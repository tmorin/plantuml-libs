...
```text
azure-11/Item/General/ServiceLoadTest
```

```text
include('azure-11/Item/General/ServiceLoadTest')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceLoadTest.png) | ![illustration for ServiceLoadTest](../../../azure-11/Item/General/ServiceLoadTest.Local.png) | ![illustration for ServiceLoadTestCard](../../../azure-11/Item/General/ServiceLoadTestCard.Local.png) | ![illustration for ServiceLoadTestGroup](../../../azure-11/Item/General/ServiceLoadTestGroup.Local.png) |
