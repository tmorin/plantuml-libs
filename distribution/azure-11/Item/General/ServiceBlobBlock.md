...
```text
azure-11/Item/General/ServiceBlobBlock
```

```text
include('azure-11/Item/General/ServiceBlobBlock')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceBlobBlock.png) | ![illustration for ServiceBlobBlock](../../../azure-11/Item/General/ServiceBlobBlock.Local.png) | ![illustration for ServiceBlobBlockCard](../../../azure-11/Item/General/ServiceBlobBlockCard.Local.png) | ![illustration for ServiceBlobBlockGroup](../../../azure-11/Item/General/ServiceBlobBlockGroup.Local.png) |
