...
```text
azure-11/Item/General/ServiceBranch
```

```text
include('azure-11/Item/General/ServiceBranch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/General/ServiceBranch.png) | ![illustration for ServiceBranch](../../../azure-11/Item/General/ServiceBranch.Local.png) | ![illustration for ServiceBranchCard](../../../azure-11/Item/General/ServiceBranchCard.Local.png) | ![illustration for ServiceBranchGroup](../../../azure-11/Item/General/ServiceBranchGroup.Local.png) |
