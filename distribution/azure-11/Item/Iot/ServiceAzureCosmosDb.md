...
```text
azure-11/Item/Iot/ServiceAzureCosmosDb
```

```text
include('azure-11/Item/Iot/ServiceAzureCosmosDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Iot/ServiceAzureCosmosDb.png) | ![illustration for ServiceAzureCosmosDb](../../../azure-11/Item/Iot/ServiceAzureCosmosDb.Local.png) | ![illustration for ServiceAzureCosmosDbCard](../../../azure-11/Item/Iot/ServiceAzureCosmosDbCard.Local.png) | ![illustration for ServiceAzureCosmosDbGroup](../../../azure-11/Item/Iot/ServiceAzureCosmosDbGroup.Local.png) |
