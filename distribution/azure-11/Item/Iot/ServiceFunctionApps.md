...
```text
azure-11/Item/Iot/ServiceFunctionApps
```

```text
include('azure-11/Item/Iot/ServiceFunctionApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Iot/ServiceFunctionApps.png) | ![illustration for ServiceFunctionApps](../../../azure-11/Item/Iot/ServiceFunctionApps.Local.png) | ![illustration for ServiceFunctionAppsCard](../../../azure-11/Item/Iot/ServiceFunctionAppsCard.Local.png) | ![illustration for ServiceFunctionAppsGroup](../../../azure-11/Item/Iot/ServiceFunctionAppsGroup.Local.png) |
