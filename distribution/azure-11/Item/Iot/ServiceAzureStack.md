...
```text
azure-11/Item/Iot/ServiceAzureStack
```

```text
include('azure-11/Item/Iot/ServiceAzureStack')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Iot/ServiceAzureStack.png) | ![illustration for ServiceAzureStack](../../../azure-11/Item/Iot/ServiceAzureStack.Local.png) | ![illustration for ServiceAzureStackCard](../../../azure-11/Item/Iot/ServiceAzureStackCard.Local.png) | ![illustration for ServiceAzureStackGroup](../../../azure-11/Item/Iot/ServiceAzureStackGroup.Local.png) |
