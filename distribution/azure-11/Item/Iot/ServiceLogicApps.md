...
```text
azure-11/Item/Iot/ServiceLogicApps
```

```text
include('azure-11/Item/Iot/ServiceLogicApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Iot/ServiceLogicApps.png) | ![illustration for ServiceLogicApps](../../../azure-11/Item/Iot/ServiceLogicApps.Local.png) | ![illustration for ServiceLogicAppsCard](../../../azure-11/Item/Iot/ServiceLogicAppsCard.Local.png) | ![illustration for ServiceLogicAppsGroup](../../../azure-11/Item/Iot/ServiceLogicAppsGroup.Local.png) |
