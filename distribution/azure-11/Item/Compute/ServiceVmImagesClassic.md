...
```text
azure-11/Item/Compute/ServiceVmImagesClassic
```

```text
include('azure-11/Item/Compute/ServiceVmImagesClassic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceVmImagesClassic.png) | ![illustration for ServiceVmImagesClassic](../../../azure-11/Item/Compute/ServiceVmImagesClassic.Local.png) | ![illustration for ServiceVmImagesClassicCard](../../../azure-11/Item/Compute/ServiceVmImagesClassicCard.Local.png) | ![illustration for ServiceVmImagesClassicGroup](../../../azure-11/Item/Compute/ServiceVmImagesClassicGroup.Local.png) |
