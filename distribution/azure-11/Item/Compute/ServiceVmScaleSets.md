...
```text
azure-11/Item/Compute/ServiceVmScaleSets
```

```text
include('azure-11/Item/Compute/ServiceVmScaleSets')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceVmScaleSets.png) | ![illustration for ServiceVmScaleSets](../../../azure-11/Item/Compute/ServiceVmScaleSets.Local.png) | ![illustration for ServiceVmScaleSetsCard](../../../azure-11/Item/Compute/ServiceVmScaleSetsCard.Local.png) | ![illustration for ServiceVmScaleSetsGroup](../../../azure-11/Item/Compute/ServiceVmScaleSetsGroup.Local.png) |
