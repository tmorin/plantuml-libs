...
```text
azure-11/Item/Compute/ServiceMetricsAdvisor
```

```text
include('azure-11/Item/Compute/ServiceMetricsAdvisor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceMetricsAdvisor.png) | ![illustration for ServiceMetricsAdvisor](../../../azure-11/Item/Compute/ServiceMetricsAdvisor.Local.png) | ![illustration for ServiceMetricsAdvisorCard](../../../azure-11/Item/Compute/ServiceMetricsAdvisorCard.Local.png) | ![illustration for ServiceMetricsAdvisorGroup](../../../azure-11/Item/Compute/ServiceMetricsAdvisorGroup.Local.png) |
