...
```text
azure-11/Item/Compute/ServiceFunctionApps
```

```text
include('azure-11/Item/Compute/ServiceFunctionApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceFunctionApps.png) | ![illustration for ServiceFunctionApps](../../../azure-11/Item/Compute/ServiceFunctionApps.Local.png) | ![illustration for ServiceFunctionAppsCard](../../../azure-11/Item/Compute/ServiceFunctionAppsCard.Local.png) | ![illustration for ServiceFunctionAppsGroup](../../../azure-11/Item/Compute/ServiceFunctionAppsGroup.Local.png) |
