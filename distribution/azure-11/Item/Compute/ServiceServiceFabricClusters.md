...
```text
azure-11/Item/Compute/ServiceServiceFabricClusters
```

```text
include('azure-11/Item/Compute/ServiceServiceFabricClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceServiceFabricClusters.png) | ![illustration for ServiceServiceFabricClusters](../../../azure-11/Item/Compute/ServiceServiceFabricClusters.Local.png) | ![illustration for ServiceServiceFabricClustersCard](../../../azure-11/Item/Compute/ServiceServiceFabricClustersCard.Local.png) | ![illustration for ServiceServiceFabricClustersGroup](../../../azure-11/Item/Compute/ServiceServiceFabricClustersGroup.Local.png) |
