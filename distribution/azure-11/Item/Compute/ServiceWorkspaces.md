...
```text
azure-11/Item/Compute/ServiceWorkspaces
```

```text
include('azure-11/Item/Compute/ServiceWorkspaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceWorkspaces.png) | ![illustration for ServiceWorkspaces](../../../azure-11/Item/Compute/ServiceWorkspaces.Local.png) | ![illustration for ServiceWorkspacesCard](../../../azure-11/Item/Compute/ServiceWorkspacesCard.Local.png) | ![illustration for ServiceWorkspacesGroup](../../../azure-11/Item/Compute/ServiceWorkspacesGroup.Local.png) |
