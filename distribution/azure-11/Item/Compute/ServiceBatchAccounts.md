...
```text
azure-11/Item/Compute/ServiceBatchAccounts
```

```text
include('azure-11/Item/Compute/ServiceBatchAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceBatchAccounts.png) | ![illustration for ServiceBatchAccounts](../../../azure-11/Item/Compute/ServiceBatchAccounts.Local.png) | ![illustration for ServiceBatchAccountsCard](../../../azure-11/Item/Compute/ServiceBatchAccountsCard.Local.png) | ![illustration for ServiceBatchAccountsGroup](../../../azure-11/Item/Compute/ServiceBatchAccountsGroup.Local.png) |
