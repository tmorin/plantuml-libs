...
```text
azure-11/Item/Compute/ServiceDisks
```

```text
include('azure-11/Item/Compute/ServiceDisks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceDisks.png) | ![illustration for ServiceDisks](../../../azure-11/Item/Compute/ServiceDisks.Local.png) | ![illustration for ServiceDisksCard](../../../azure-11/Item/Compute/ServiceDisksCard.Local.png) | ![illustration for ServiceDisksGroup](../../../azure-11/Item/Compute/ServiceDisksGroup.Local.png) |
