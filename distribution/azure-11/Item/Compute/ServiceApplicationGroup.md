...
```text
azure-11/Item/Compute/ServiceApplicationGroup
```

```text
include('azure-11/Item/Compute/ServiceApplicationGroup')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceApplicationGroup.png) | ![illustration for ServiceApplicationGroup](../../../azure-11/Item/Compute/ServiceApplicationGroup.Local.png) | ![illustration for ServiceApplicationGroupCard](../../../azure-11/Item/Compute/ServiceApplicationGroupCard.Local.png) | ![illustration for ServiceApplicationGroupGroup](../../../azure-11/Item/Compute/ServiceApplicationGroupGroup.Local.png) |
