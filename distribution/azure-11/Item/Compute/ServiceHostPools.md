...
```text
azure-11/Item/Compute/ServiceHostPools
```

```text
include('azure-11/Item/Compute/ServiceHostPools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceHostPools.png) | ![illustration for ServiceHostPools](../../../azure-11/Item/Compute/ServiceHostPools.Local.png) | ![illustration for ServiceHostPoolsCard](../../../azure-11/Item/Compute/ServiceHostPoolsCard.Local.png) | ![illustration for ServiceHostPoolsGroup](../../../azure-11/Item/Compute/ServiceHostPoolsGroup.Local.png) |
