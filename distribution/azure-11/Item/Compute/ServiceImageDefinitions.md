...
```text
azure-11/Item/Compute/ServiceImageDefinitions
```

```text
include('azure-11/Item/Compute/ServiceImageDefinitions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceImageDefinitions.png) | ![illustration for ServiceImageDefinitions](../../../azure-11/Item/Compute/ServiceImageDefinitions.Local.png) | ![illustration for ServiceImageDefinitionsCard](../../../azure-11/Item/Compute/ServiceImageDefinitionsCard.Local.png) | ![illustration for ServiceImageDefinitionsGroup](../../../azure-11/Item/Compute/ServiceImageDefinitionsGroup.Local.png) |
