...
```text
azure-11/Item/Compute/ServiceImageVersions
```

```text
include('azure-11/Item/Compute/ServiceImageVersions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceImageVersions.png) | ![illustration for ServiceImageVersions](../../../azure-11/Item/Compute/ServiceImageVersions.Local.png) | ![illustration for ServiceImageVersionsCard](../../../azure-11/Item/Compute/ServiceImageVersionsCard.Local.png) | ![illustration for ServiceImageVersionsGroup](../../../azure-11/Item/Compute/ServiceImageVersionsGroup.Local.png) |
