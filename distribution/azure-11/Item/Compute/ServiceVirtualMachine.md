...
```text
azure-11/Item/Compute/ServiceVirtualMachine
```

```text
include('azure-11/Item/Compute/ServiceVirtualMachine')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceVirtualMachine.png) | ![illustration for ServiceVirtualMachine](../../../azure-11/Item/Compute/ServiceVirtualMachine.Local.png) | ![illustration for ServiceVirtualMachineCard](../../../azure-11/Item/Compute/ServiceVirtualMachineCard.Local.png) | ![illustration for ServiceVirtualMachineGroup](../../../azure-11/Item/Compute/ServiceVirtualMachineGroup.Local.png) |
