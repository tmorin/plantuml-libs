...
```text
azure-11/Item/Compute/ServiceImageTemplates
```

```text
include('azure-11/Item/Compute/ServiceImageTemplates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceImageTemplates.png) | ![illustration for ServiceImageTemplates](../../../azure-11/Item/Compute/ServiceImageTemplates.Local.png) | ![illustration for ServiceImageTemplatesCard](../../../azure-11/Item/Compute/ServiceImageTemplatesCard.Local.png) | ![illustration for ServiceImageTemplatesGroup](../../../azure-11/Item/Compute/ServiceImageTemplatesGroup.Local.png) |
