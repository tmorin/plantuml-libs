...
```text
azure-11/Item/Compute/ServiceMeshApplications
```

```text
include('azure-11/Item/Compute/ServiceMeshApplications')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceMeshApplications.png) | ![illustration for ServiceMeshApplications](../../../azure-11/Item/Compute/ServiceMeshApplications.Local.png) | ![illustration for ServiceMeshApplicationsCard](../../../azure-11/Item/Compute/ServiceMeshApplicationsCard.Local.png) | ![illustration for ServiceMeshApplicationsGroup](../../../azure-11/Item/Compute/ServiceMeshApplicationsGroup.Local.png) |
