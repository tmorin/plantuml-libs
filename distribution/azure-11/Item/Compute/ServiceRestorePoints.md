...
```text
azure-11/Item/Compute/ServiceRestorePoints
```

```text
include('azure-11/Item/Compute/ServiceRestorePoints')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Compute/ServiceRestorePoints.png) | ![illustration for ServiceRestorePoints](../../../azure-11/Item/Compute/ServiceRestorePoints.Local.png) | ![illustration for ServiceRestorePointsCard](../../../azure-11/Item/Compute/ServiceRestorePointsCard.Local.png) | ![illustration for ServiceRestorePointsGroup](../../../azure-11/Item/Compute/ServiceRestorePointsGroup.Local.png) |
