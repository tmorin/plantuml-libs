...
```text
azure-11/Item/Intune/ServiceIntuneForEducation
```

```text
include('azure-11/Item/Intune/ServiceIntuneForEducation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Intune/ServiceIntuneForEducation.png) | ![illustration for ServiceIntuneForEducation](../../../azure-11/Item/Intune/ServiceIntuneForEducation.Local.png) | ![illustration for ServiceIntuneForEducationCard](../../../azure-11/Item/Intune/ServiceIntuneForEducationCard.Local.png) | ![illustration for ServiceIntuneForEducationGroup](../../../azure-11/Item/Intune/ServiceIntuneForEducationGroup.Local.png) |
