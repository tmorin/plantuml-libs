...
```text
azure-11/Item/Intune/ServiceDeviceSecurityApple
```

```text
include('azure-11/Item/Intune/ServiceDeviceSecurityApple')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Intune/ServiceDeviceSecurityApple.png) | ![illustration for ServiceDeviceSecurityApple](../../../azure-11/Item/Intune/ServiceDeviceSecurityApple.Local.png) | ![illustration for ServiceDeviceSecurityAppleCard](../../../azure-11/Item/Intune/ServiceDeviceSecurityAppleCard.Local.png) | ![illustration for ServiceDeviceSecurityAppleGroup](../../../azure-11/Item/Intune/ServiceDeviceSecurityAppleGroup.Local.png) |
