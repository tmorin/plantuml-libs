...
```text
azure-11/Item/Intune/ServiceIntune
```

```text
include('azure-11/Item/Intune/ServiceIntune')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Intune/ServiceIntune.png) | ![illustration for ServiceIntune](../../../azure-11/Item/Intune/ServiceIntune.Local.png) | ![illustration for ServiceIntuneCard](../../../azure-11/Item/Intune/ServiceIntuneCard.Local.png) | ![illustration for ServiceIntuneGroup](../../../azure-11/Item/Intune/ServiceIntuneGroup.Local.png) |
