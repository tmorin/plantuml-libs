...
```text
azure-11/Item/Intune/ServiceDevices
```

```text
include('azure-11/Item/Intune/ServiceDevices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Intune/ServiceDevices.png) | ![illustration for ServiceDevices](../../../azure-11/Item/Intune/ServiceDevices.Local.png) | ![illustration for ServiceDevicesCard](../../../azure-11/Item/Intune/ServiceDevicesCard.Local.png) | ![illustration for ServiceDevicesGroup](../../../azure-11/Item/Intune/ServiceDevicesGroup.Local.png) |
