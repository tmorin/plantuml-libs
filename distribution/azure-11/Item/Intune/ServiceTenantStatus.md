...
```text
azure-11/Item/Intune/ServiceTenantStatus
```

```text
include('azure-11/Item/Intune/ServiceTenantStatus')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Intune/ServiceTenantStatus.png) | ![illustration for ServiceTenantStatus](../../../azure-11/Item/Intune/ServiceTenantStatus.Local.png) | ![illustration for ServiceTenantStatusCard](../../../azure-11/Item/Intune/ServiceTenantStatusCard.Local.png) | ![illustration for ServiceTenantStatusGroup](../../../azure-11/Item/Intune/ServiceTenantStatusGroup.Local.png) |
