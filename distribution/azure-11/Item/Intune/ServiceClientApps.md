...
```text
azure-11/Item/Intune/ServiceClientApps
```

```text
include('azure-11/Item/Intune/ServiceClientApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Intune/ServiceClientApps.png) | ![illustration for ServiceClientApps](../../../azure-11/Item/Intune/ServiceClientApps.Local.png) | ![illustration for ServiceClientAppsCard](../../../azure-11/Item/Intune/ServiceClientAppsCard.Local.png) | ![illustration for ServiceClientAppsGroup](../../../azure-11/Item/Intune/ServiceClientAppsGroup.Local.png) |
