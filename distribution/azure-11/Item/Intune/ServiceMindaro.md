...
```text
azure-11/Item/Intune/ServiceMindaro
```

```text
include('azure-11/Item/Intune/ServiceMindaro')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Intune/ServiceMindaro.png) | ![illustration for ServiceMindaro](../../../azure-11/Item/Intune/ServiceMindaro.Local.png) | ![illustration for ServiceMindaroCard](../../../azure-11/Item/Intune/ServiceMindaroCard.Local.png) | ![illustration for ServiceMindaroGroup](../../../azure-11/Item/Intune/ServiceMindaroGroup.Local.png) |
