...
```text
azure-11/Item/Security/ServiceKeyVaults
```

```text
include('azure-11/Item/Security/ServiceKeyVaults')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Security/ServiceKeyVaults.png) | ![illustration for ServiceKeyVaults](../../../azure-11/Item/Security/ServiceKeyVaults.Local.png) | ![illustration for ServiceKeyVaultsCard](../../../azure-11/Item/Security/ServiceKeyVaultsCard.Local.png) | ![illustration for ServiceKeyVaultsGroup](../../../azure-11/Item/Security/ServiceKeyVaultsGroup.Local.png) |
