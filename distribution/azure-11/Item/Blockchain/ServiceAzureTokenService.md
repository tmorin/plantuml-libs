...
```text
azure-11/Item/Blockchain/ServiceAzureTokenService
```

```text
include('azure-11/Item/Blockchain/ServiceAzureTokenService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Blockchain/ServiceAzureTokenService.png) | ![illustration for ServiceAzureTokenService](../../../azure-11/Item/Blockchain/ServiceAzureTokenService.Local.png) | ![illustration for ServiceAzureTokenServiceCard](../../../azure-11/Item/Blockchain/ServiceAzureTokenServiceCard.Local.png) | ![illustration for ServiceAzureTokenServiceGroup](../../../azure-11/Item/Blockchain/ServiceAzureTokenServiceGroup.Local.png) |
