...
```text
azure-11/Item/Blockchain/ServiceBlockchainApplications
```

```text
include('azure-11/Item/Blockchain/ServiceBlockchainApplications')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Blockchain/ServiceBlockchainApplications.png) | ![illustration for ServiceBlockchainApplications](../../../azure-11/Item/Blockchain/ServiceBlockchainApplications.Local.png) | ![illustration for ServiceBlockchainApplicationsCard](../../../azure-11/Item/Blockchain/ServiceBlockchainApplicationsCard.Local.png) | ![illustration for ServiceBlockchainApplicationsGroup](../../../azure-11/Item/Blockchain/ServiceBlockchainApplicationsGroup.Local.png) |
