...
```text
azure-11/Item/Blockchain/ServiceAbsMember
```

```text
include('azure-11/Item/Blockchain/ServiceAbsMember')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Blockchain/ServiceAbsMember.png) | ![illustration for ServiceAbsMember](../../../azure-11/Item/Blockchain/ServiceAbsMember.Local.png) | ![illustration for ServiceAbsMemberCard](../../../azure-11/Item/Blockchain/ServiceAbsMemberCard.Local.png) | ![illustration for ServiceAbsMemberGroup](../../../azure-11/Item/Blockchain/ServiceAbsMemberGroup.Local.png) |
