...
```text
azure-11/Item/NewIcons/ServiceWebJobs
```

```text
include('azure-11/Item/NewIcons/ServiceWebJobs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/NewIcons/ServiceWebJobs.png) | ![illustration for ServiceWebJobs](../../../azure-11/Item/NewIcons/ServiceWebJobs.Local.png) | ![illustration for ServiceWebJobsCard](../../../azure-11/Item/NewIcons/ServiceWebJobsCard.Local.png) | ![illustration for ServiceWebJobsGroup](../../../azure-11/Item/NewIcons/ServiceWebJobsGroup.Local.png) |
