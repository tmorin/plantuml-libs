...
```text
azure-11/Item/Identity/ServiceApiProxy
```

```text
include('azure-11/Item/Identity/ServiceApiProxy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Identity/ServiceApiProxy.png) | ![illustration for ServiceApiProxy](../../../azure-11/Item/Identity/ServiceApiProxy.Local.png) | ![illustration for ServiceApiProxyCard](../../../azure-11/Item/Identity/ServiceApiProxyCard.Local.png) | ![illustration for ServiceApiProxyGroup](../../../azure-11/Item/Identity/ServiceApiProxyGroup.Local.png) |
