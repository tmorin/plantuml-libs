...
```text
azure-11/Item/Identity/ServiceUsers
```

```text
include('azure-11/Item/Identity/ServiceUsers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Identity/ServiceUsers.png) | ![illustration for ServiceUsers](../../../azure-11/Item/Identity/ServiceUsers.Local.png) | ![illustration for ServiceUsersCard](../../../azure-11/Item/Identity/ServiceUsersCard.Local.png) | ![illustration for ServiceUsersGroup](../../../azure-11/Item/Identity/ServiceUsersGroup.Local.png) |
