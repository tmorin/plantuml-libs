...
```text
azure-11/Item/Identity/ServiceAppRegistrations
```

```text
include('azure-11/Item/Identity/ServiceAppRegistrations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Identity/ServiceAppRegistrations.png) | ![illustration for ServiceAppRegistrations](../../../azure-11/Item/Identity/ServiceAppRegistrations.Local.png) | ![illustration for ServiceAppRegistrationsCard](../../../azure-11/Item/Identity/ServiceAppRegistrationsCard.Local.png) | ![illustration for ServiceAppRegistrationsGroup](../../../azure-11/Item/Identity/ServiceAppRegistrationsGroup.Local.png) |
