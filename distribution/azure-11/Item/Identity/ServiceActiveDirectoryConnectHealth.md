...
```text
azure-11/Item/Identity/ServiceActiveDirectoryConnectHealth
```

```text
include('azure-11/Item/Identity/ServiceActiveDirectoryConnectHealth')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-11/Item/Identity/ServiceActiveDirectoryConnectHealth.png) | ![illustration for ServiceActiveDirectoryConnectHealth](../../../azure-11/Item/Identity/ServiceActiveDirectoryConnectHealth.Local.png) | ![illustration for ServiceActiveDirectoryConnectHealthCard](../../../azure-11/Item/Identity/ServiceActiveDirectoryConnectHealthCard.Local.png) | ![illustration for ServiceActiveDirectoryConnectHealthGroup](../../../azure-11/Item/Identity/ServiceActiveDirectoryConnectHealthGroup.Local.png) |
