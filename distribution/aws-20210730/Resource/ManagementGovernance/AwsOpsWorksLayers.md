...
```text
aws-20210730/Resource/ManagementGovernance/AwsOpsWorksLayers
```

```text
include('aws-20210730/Resource/ManagementGovernance/AwsOpsWorksLayers')
```
