...
```text
aws-20210730/Resource/ManagementGovernance/AwsOpsWorksInstances
```

```text
include('aws-20210730/Resource/ManagementGovernance/AwsOpsWorksInstances')
```
