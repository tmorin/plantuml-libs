...
```text
aws-20210730/Resource/ManagementGovernance/AwsCloudFormationChangeSet
```

```text
include('aws-20210730/Resource/ManagementGovernance/AwsCloudFormationChangeSet')
```
