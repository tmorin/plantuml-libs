...
```text
aws-20210730/Resource/Compute/AmazonEc2H1Instance
```

```text
include('aws-20210730/Resource/Compute/AmazonEc2H1Instance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Resource/Compute/AmazonEc2H1Instance.png) | ![illustration for AmazonEc2H1Instance](../../../aws-20210730/Resource/Compute/AmazonEc2H1Instance.Local.png) | ![illustration for AmazonEc2H1InstanceCard](../../../aws-20210730/Resource/Compute/AmazonEc2H1InstanceCard.Local.png) | ![illustration for AmazonEc2H1InstanceGroup](../../../aws-20210730/Resource/Compute/AmazonEc2H1InstanceGroup.Local.png) |
