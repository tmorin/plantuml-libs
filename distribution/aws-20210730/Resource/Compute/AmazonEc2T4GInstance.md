...
```text
aws-20210730/Resource/Compute/AmazonEc2T4GInstance
```

```text
include('aws-20210730/Resource/Compute/AmazonEc2T4GInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Resource/Compute/AmazonEc2T4GInstance.png) | ![illustration for AmazonEc2T4GInstance](../../../aws-20210730/Resource/Compute/AmazonEc2T4GInstance.Local.png) | ![illustration for AmazonEc2T4GInstanceCard](../../../aws-20210730/Resource/Compute/AmazonEc2T4GInstanceCard.Local.png) | ![illustration for AmazonEc2T4GInstanceGroup](../../../aws-20210730/Resource/Compute/AmazonEc2T4GInstanceGroup.Local.png) |
