...
```text
aws-20210730/Resource/ApplicationIntegration/AmazonEventBridgeRule
```

```text
include('aws-20210730/Resource/ApplicationIntegration/AmazonEventBridgeRule')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Resource/ApplicationIntegration/AmazonEventBridgeRule.png) | ![illustration for AmazonEventBridgeRule](../../../aws-20210730/Resource/ApplicationIntegration/AmazonEventBridgeRule.Local.png) | ![illustration for AmazonEventBridgeRuleCard](../../../aws-20210730/Resource/ApplicationIntegration/AmazonEventBridgeRuleCard.Local.png) | ![illustration for AmazonEventBridgeRuleGroup](../../../aws-20210730/Resource/ApplicationIntegration/AmazonEventBridgeRuleGroup.Local.png) |
