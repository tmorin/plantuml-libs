...
```text
aws-20210730/Resource/MigrationAndTransfer/AwsTransferFamilyAwsSftp
```

```text
include('aws-20210730/Resource/MigrationAndTransfer/AwsTransferFamilyAwsSftp')
```
