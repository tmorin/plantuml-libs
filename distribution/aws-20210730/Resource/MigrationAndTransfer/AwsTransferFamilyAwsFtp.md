...
```text
aws-20210730/Resource/MigrationAndTransfer/AwsTransferFamilyAwsFtp
```

```text
include('aws-20210730/Resource/MigrationAndTransfer/AwsTransferFamilyAwsFtp')
```
