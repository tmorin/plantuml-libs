...
```text
aws-20210730/Resource/Database/AmazonDynamoDbTable
```

```text
include('aws-20210730/Resource/Database/AmazonDynamoDbTable')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Resource/Database/AmazonDynamoDbTable.png) | ![illustration for AmazonDynamoDbTable](../../../aws-20210730/Resource/Database/AmazonDynamoDbTable.Local.png) | ![illustration for AmazonDynamoDbTableCard](../../../aws-20210730/Resource/Database/AmazonDynamoDbTableCard.Local.png) | ![illustration for AmazonDynamoDbTableGroup](../../../aws-20210730/Resource/Database/AmazonDynamoDbTableGroup.Local.png) |
