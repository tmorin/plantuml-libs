...
```text
aws-20210730/Resource/Database/AmazonAuroraPiopsInstance
```

```text
include('aws-20210730/Resource/Database/AmazonAuroraPiopsInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Resource/Database/AmazonAuroraPiopsInstance.png) | ![illustration for AmazonAuroraPiopsInstance](../../../aws-20210730/Resource/Database/AmazonAuroraPiopsInstance.Local.png) | ![illustration for AmazonAuroraPiopsInstanceCard](../../../aws-20210730/Resource/Database/AmazonAuroraPiopsInstanceCard.Local.png) | ![illustration for AmazonAuroraPiopsInstanceGroup](../../../aws-20210730/Resource/Database/AmazonAuroraPiopsInstanceGroup.Local.png) |
