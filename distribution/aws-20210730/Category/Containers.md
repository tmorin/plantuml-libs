...
```text
aws-20210730/Category/Containers
```

```text
include('aws-20210730/Category/Containers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-20210730/Category/Containers.png) | ![illustration for Containers](../../aws-20210730/Category/Containers.Local.png) | ![illustration for ContainersCard](../../aws-20210730/Category/ContainersCard.Local.png) | ![illustration for ContainersGroup](../../aws-20210730/Category/ContainersGroup.Local.png) |
