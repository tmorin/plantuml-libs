...
```text
aws-20210730/Architecture/MediaServices/AwsElementalServer
```

```text
include('aws-20210730/Architecture/MediaServices/AwsElementalServer')
```
