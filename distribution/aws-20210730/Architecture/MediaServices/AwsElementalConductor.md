...
```text
aws-20210730/Architecture/MediaServices/AwsElementalConductor
```

```text
include('aws-20210730/Architecture/MediaServices/AwsElementalConductor')
```
