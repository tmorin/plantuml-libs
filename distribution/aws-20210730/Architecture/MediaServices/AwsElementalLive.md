...
```text
aws-20210730/Architecture/MediaServices/AwsElementalLive
```

```text
include('aws-20210730/Architecture/MediaServices/AwsElementalLive')
```
