...
```text
aws-20210730/Architecture/MediaServices/AmazonElasticTranscoder
```

```text
include('aws-20210730/Architecture/MediaServices/AmazonElasticTranscoder')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Architecture/MediaServices/AmazonElasticTranscoder.png) | ![illustration for AmazonElasticTranscoder](../../../aws-20210730/Architecture/MediaServices/AmazonElasticTranscoder.Local.png) | ![illustration for AmazonElasticTranscoderCard](../../../aws-20210730/Architecture/MediaServices/AmazonElasticTranscoderCard.Local.png) | ![illustration for AmazonElasticTranscoderGroup](../../../aws-20210730/Architecture/MediaServices/AmazonElasticTranscoderGroup.Local.png) |
