...
```text
aws-20210730/Architecture/CustomerEnablement/AwsSupport
```

```text
include('aws-20210730/Architecture/CustomerEnablement/AwsSupport')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Architecture/CustomerEnablement/AwsSupport.png) | ![illustration for AwsSupport](../../../aws-20210730/Architecture/CustomerEnablement/AwsSupport.Local.png) | ![illustration for AwsSupportCard](../../../aws-20210730/Architecture/CustomerEnablement/AwsSupportCard.Local.png) | ![illustration for AwsSupportGroup](../../../aws-20210730/Architecture/CustomerEnablement/AwsSupportGroup.Local.png) |
