...
```text
aws-20210730/Architecture/EndUserComputing/AmazonWorkSpaces
```

```text
include('aws-20210730/Architecture/EndUserComputing/AmazonWorkSpaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Architecture/EndUserComputing/AmazonWorkSpaces.png) | ![illustration for AmazonWorkSpaces](../../../aws-20210730/Architecture/EndUserComputing/AmazonWorkSpaces.Local.png) | ![illustration for AmazonWorkSpacesCard](../../../aws-20210730/Architecture/EndUserComputing/AmazonWorkSpacesCard.Local.png) | ![illustration for AmazonWorkSpacesGroup](../../../aws-20210730/Architecture/EndUserComputing/AmazonWorkSpacesGroup.Local.png) |
