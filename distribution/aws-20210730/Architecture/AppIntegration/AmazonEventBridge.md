...
```text
aws-20210730/Architecture/AppIntegration/AmazonEventBridge
```

```text
include('aws-20210730/Architecture/AppIntegration/AmazonEventBridge')
```
