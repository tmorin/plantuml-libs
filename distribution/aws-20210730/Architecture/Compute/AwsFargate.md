...
```text
aws-20210730/Architecture/Compute/AwsFargate
```

```text
include('aws-20210730/Architecture/Compute/AwsFargate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Architecture/Compute/AwsFargate.png) | ![illustration for AwsFargate](../../../aws-20210730/Architecture/Compute/AwsFargate.Local.png) | ![illustration for AwsFargateCard](../../../aws-20210730/Architecture/Compute/AwsFargateCard.Local.png) | ![illustration for AwsFargateGroup](../../../aws-20210730/Architecture/Compute/AwsFargateGroup.Local.png) |
