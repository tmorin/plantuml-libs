...
```text
aws-20210730/Architecture/Compute/ElasticFabricAdapter
```

```text
include('aws-20210730/Architecture/Compute/ElasticFabricAdapter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Architecture/Compute/ElasticFabricAdapter.png) | ![illustration for ElasticFabricAdapter](../../../aws-20210730/Architecture/Compute/ElasticFabricAdapter.Local.png) | ![illustration for ElasticFabricAdapterCard](../../../aws-20210730/Architecture/Compute/ElasticFabricAdapterCard.Local.png) | ![illustration for ElasticFabricAdapterGroup](../../../aws-20210730/Architecture/Compute/ElasticFabricAdapterGroup.Local.png) |
