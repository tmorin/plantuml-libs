...
```text
aws-20210730/Architecture/Compute/AwsParallelCluster
```

```text
include('aws-20210730/Architecture/Compute/AwsParallelCluster')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Architecture/Compute/AwsParallelCluster.png) | ![illustration for AwsParallelCluster](../../../aws-20210730/Architecture/Compute/AwsParallelCluster.Local.png) | ![illustration for AwsParallelClusterCard](../../../aws-20210730/Architecture/Compute/AwsParallelClusterCard.Local.png) | ![illustration for AwsParallelClusterGroup](../../../aws-20210730/Architecture/Compute/AwsParallelClusterGroup.Local.png) |
