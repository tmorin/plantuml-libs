...
```text
aws-20210730/Architecture/Analytics/AwsDataPipeline
```

```text
include('aws-20210730/Architecture/Analytics/AwsDataPipeline')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Architecture/Analytics/AwsDataPipeline.png) | ![illustration for AwsDataPipeline](../../../aws-20210730/Architecture/Analytics/AwsDataPipeline.Local.png) | ![illustration for AwsDataPipelineCard](../../../aws-20210730/Architecture/Analytics/AwsDataPipelineCard.Local.png) | ![illustration for AwsDataPipelineGroup](../../../aws-20210730/Architecture/Analytics/AwsDataPipelineGroup.Local.png) |
