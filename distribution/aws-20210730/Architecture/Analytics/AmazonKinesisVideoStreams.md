...
```text
aws-20210730/Architecture/Analytics/AmazonKinesisVideoStreams
```

```text
include('aws-20210730/Architecture/Analytics/AmazonKinesisVideoStreams')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Architecture/Analytics/AmazonKinesisVideoStreams.png) | ![illustration for AmazonKinesisVideoStreams](../../../aws-20210730/Architecture/Analytics/AmazonKinesisVideoStreams.Local.png) | ![illustration for AmazonKinesisVideoStreamsCard](../../../aws-20210730/Architecture/Analytics/AmazonKinesisVideoStreamsCard.Local.png) | ![illustration for AmazonKinesisVideoStreamsGroup](../../../aws-20210730/Architecture/Analytics/AmazonKinesisVideoStreamsGroup.Local.png) |
