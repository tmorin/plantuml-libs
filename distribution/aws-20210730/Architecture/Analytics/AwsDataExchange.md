...
```text
aws-20210730/Architecture/Analytics/AwsDataExchange
```

```text
include('aws-20210730/Architecture/Analytics/AwsDataExchange')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Architecture/Analytics/AwsDataExchange.png) | ![illustration for AwsDataExchange](../../../aws-20210730/Architecture/Analytics/AwsDataExchange.Local.png) | ![illustration for AwsDataExchangeCard](../../../aws-20210730/Architecture/Analytics/AwsDataExchangeCard.Local.png) | ![illustration for AwsDataExchangeGroup](../../../aws-20210730/Architecture/Analytics/AwsDataExchangeGroup.Local.png) |
