...
```text
aws-20210730/Architecture/MigrationTransfer/AwsMigrationHub
```

```text
include('aws-20210730/Architecture/MigrationTransfer/AwsMigrationHub')
```
