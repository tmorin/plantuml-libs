...
```text
aws-20210730/Architecture/MigrationTransfer/AwsApplicationDiscoveryService
```

```text
include('aws-20210730/Architecture/MigrationTransfer/AwsApplicationDiscoveryService')
```
