...
```text
aws-20210730/Architecture/Database/AmazonElastiCache
```

```text
include('aws-20210730/Architecture/Database/AmazonElastiCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Architecture/Database/AmazonElastiCache.png) | ![illustration for AmazonElastiCache](../../../aws-20210730/Architecture/Database/AmazonElastiCache.Local.png) | ![illustration for AmazonElastiCacheCard](../../../aws-20210730/Architecture/Database/AmazonElastiCacheCard.Local.png) | ![illustration for AmazonElastiCacheGroup](../../../aws-20210730/Architecture/Database/AmazonElastiCacheGroup.Local.png) |
