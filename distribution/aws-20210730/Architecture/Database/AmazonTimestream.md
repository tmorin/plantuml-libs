...
```text
aws-20210730/Architecture/Database/AmazonTimestream
```

```text
include('aws-20210730/Architecture/Database/AmazonTimestream')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-20210730/Architecture/Database/AmazonTimestream.png) | ![illustration for AmazonTimestream](../../../aws-20210730/Architecture/Database/AmazonTimestream.Local.png) | ![illustration for AmazonTimestreamCard](../../../aws-20210730/Architecture/Database/AmazonTimestreamCard.Local.png) | ![illustration for AmazonTimestreamGroup](../../../aws-20210730/Architecture/Database/AmazonTimestreamGroup.Local.png) |
