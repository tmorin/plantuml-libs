...
```text
include('fontawesome/Solid/BabyCarriage')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/BabyCarriage.png) | ![illustration for BabyCarriage](../../fontawesome/Solid/BabyCarriage.Local.png) |
