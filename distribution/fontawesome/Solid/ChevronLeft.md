...
```text
include('fontawesome/Solid/ChevronLeft')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/ChevronLeft.png) | ![illustration for ChevronLeft](../../fontawesome/Solid/ChevronLeft.Local.png) |
