...
```text
fontawesome/Solid/FaceGrinTongueWink
```

```text
include('fontawesome/Solid/FaceGrinTongueWink')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/FaceGrinTongueWink.png) | ![illustration for FaceGrinTongueWink](../../fontawesome/Solid/FaceGrinTongueWink.Local.png) |
