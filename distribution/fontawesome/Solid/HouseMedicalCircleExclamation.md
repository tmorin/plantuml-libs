...
```text
fontawesome/Solid/HouseMedicalCircleExclamation
```

```text
include('fontawesome/Solid/HouseMedicalCircleExclamation')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/HouseMedicalCircleExclamation.png) | ![illustration for HouseMedicalCircleExclamation](../../fontawesome/Solid/HouseMedicalCircleExclamation.Local.png) |
