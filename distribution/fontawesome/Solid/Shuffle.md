...
```text
include('fontawesome/Solid/Shuffle')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Shuffle.png) | ![illustration for Shuffle](../../fontawesome/Solid/Shuffle.Local.png) |
