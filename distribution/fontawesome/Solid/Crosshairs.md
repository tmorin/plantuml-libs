...
```text
include('fontawesome/Solid/Crosshairs')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Crosshairs.png) | ![illustration for Crosshairs](../../fontawesome/Solid/Crosshairs.Local.png) |
