...
```text
include('fontawesome/Solid/CaretUp')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/CaretUp.png) | ![illustration for CaretUp](../../fontawesome/Solid/CaretUp.Local.png) |
