...
```text
include('fontawesome/Solid/Football')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Football.png) | ![illustration for Football](../../fontawesome/Solid/Football.Local.png) |
