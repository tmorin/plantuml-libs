...
```text
include('fontawesome/Solid/UserCircle')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/UserCircle.png) | ![illustration for UserCircle](../../fontawesome/Solid/UserCircle.Local.png) |
