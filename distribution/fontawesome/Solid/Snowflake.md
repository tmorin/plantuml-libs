...
```text
include('fontawesome/Solid/Snowflake')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Snowflake.png) | ![illustration for Snowflake](../../fontawesome/Solid/Snowflake.Local.png) |
