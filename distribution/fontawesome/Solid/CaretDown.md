...
```text
include('fontawesome/Solid/CaretDown')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/CaretDown.png) | ![illustration for CaretDown](../../fontawesome/Solid/CaretDown.Local.png) |
