...
```text
fontawesome/Solid/PersonWalkingArrowRight
```

```text
include('fontawesome/Solid/PersonWalkingArrowRight')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/PersonWalkingArrowRight.png) | ![illustration for PersonWalkingArrowRight](../../fontawesome/Solid/PersonWalkingArrowRight.Local.png) |
