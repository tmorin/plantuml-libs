...
```text
include('fontawesome/Solid/Ethernet')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Ethernet.png) | ![illustration for Ethernet](../../fontawesome/Solid/Ethernet.Local.png) |
