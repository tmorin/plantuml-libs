...
```text
fontawesome/Solid/PersonFallingBurst
```

```text
include('fontawesome/Solid/PersonFallingBurst')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/PersonFallingBurst.png) | ![illustration for PersonFallingBurst](../../fontawesome/Solid/PersonFallingBurst.Local.png) |
