...
```text
include('fontawesome/Solid/TrashCan')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/TrashCan.png) | ![illustration for TrashCan](../../fontawesome/Solid/TrashCan.Local.png) |
