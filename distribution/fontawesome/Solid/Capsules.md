...
```text
include('fontawesome/Solid/Capsules')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Capsules.png) | ![illustration for Capsules](../../fontawesome/Solid/Capsules.Local.png) |
