...
```text
fontawesome/Solid/PlugCircleExclamation
```

```text
include('fontawesome/Solid/PlugCircleExclamation')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/PlugCircleExclamation.png) | ![illustration for PlugCircleExclamation](../../fontawesome/Solid/PlugCircleExclamation.Local.png) |
