...
```text
include('fontawesome/Solid/Industry')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Industry.png) | ![illustration for Industry](../../fontawesome/Solid/Industry.Local.png) |
