...
```text
include('fontawesome/Solid/Campground')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Campground.png) | ![illustration for Campground](../../fontawesome/Solid/Campground.Local.png) |
