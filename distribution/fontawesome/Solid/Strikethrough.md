...
```text
include('fontawesome/Solid/Strikethrough')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Strikethrough.png) | ![illustration for Strikethrough](../../fontawesome/Solid/Strikethrough.Local.png) |
