...
```text
include('fontawesome/Solid/Hospital')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Hospital.png) | ![illustration for Hospital](../../fontawesome/Solid/Hospital.Local.png) |
