...
```text
include('fontawesome/Solid/TriangleExclamation')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/TriangleExclamation.png) | ![illustration for TriangleExclamation](../../fontawesome/Solid/TriangleExclamation.Local.png) |
