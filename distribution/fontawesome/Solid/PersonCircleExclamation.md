...
```text
fontawesome/Solid/PersonCircleExclamation
```

```text
include('fontawesome/Solid/PersonCircleExclamation')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/PersonCircleExclamation.png) | ![illustration for PersonCircleExclamation](../../fontawesome/Solid/PersonCircleExclamation.Local.png) |
