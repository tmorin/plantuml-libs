...
```text
fontawesome/Solid/FaceGrinSquintTears
```

```text
include('fontawesome/Solid/FaceGrinSquintTears')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/FaceGrinSquintTears.png) | ![illustration for FaceGrinSquintTears](../../fontawesome/Solid/FaceGrinSquintTears.Local.png) |
