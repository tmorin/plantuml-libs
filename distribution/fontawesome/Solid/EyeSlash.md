...
```text
include('fontawesome/Solid/EyeSlash')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/EyeSlash.png) | ![illustration for EyeSlash](../../fontawesome/Solid/EyeSlash.Local.png) |
