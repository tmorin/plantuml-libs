...
```text
include('fontawesome/Solid/Toolbox')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Toolbox.png) | ![illustration for Toolbox](../../fontawesome/Solid/Toolbox.Local.png) |
