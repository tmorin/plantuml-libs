...
```text
include('fontawesome/Solid/ChessBoard')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/ChessBoard.png) | ![illustration for ChessBoard](../../fontawesome/Solid/ChessBoard.Local.png) |
