...
```text
include('fontawesome/Solid/Comment')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Comment.png) | ![illustration for Comment](../../fontawesome/Solid/Comment.Local.png) |
