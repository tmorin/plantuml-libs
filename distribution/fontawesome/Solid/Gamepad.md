...
```text
include('fontawesome/Solid/Gamepad')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Gamepad.png) | ![illustration for Gamepad](../../fontawesome/Solid/Gamepad.Local.png) |
