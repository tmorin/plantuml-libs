...
```text
include('fontawesome/Solid/Elevator')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Elevator.png) | ![illustration for Elevator](../../fontawesome/Solid/Elevator.Local.png) |
