...
```text
include('fontawesome/Solid/UniversalAccess')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/UniversalAccess.png) | ![illustration for UniversalAccess](../../fontawesome/Solid/UniversalAccess.Local.png) |
