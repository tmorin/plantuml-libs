...
```text
include('fontawesome/Solid/Backspace')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Backspace.png) | ![illustration for Backspace](../../fontawesome/Solid/Backspace.Local.png) |
