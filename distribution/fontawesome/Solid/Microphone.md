...
```text
include('fontawesome/Solid/Microphone')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Microphone.png) | ![illustration for Microphone](../../fontawesome/Solid/Microphone.Local.png) |
