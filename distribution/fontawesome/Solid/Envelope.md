...
```text
include('fontawesome/Solid/Envelope')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Envelope.png) | ![illustration for Envelope](../../fontawesome/Solid/Envelope.Local.png) |
