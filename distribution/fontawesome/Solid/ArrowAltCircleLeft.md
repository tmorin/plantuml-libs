...
```text
include('fontawesome/Solid/ArrowAltCircleLeft')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/ArrowAltCircleLeft.png) | ![illustration for ArrowAltCircleLeft](../../fontawesome/Solid/ArrowAltCircleLeft.Local.png) |
