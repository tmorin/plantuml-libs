...
```text
include('fontawesome/Solid/Viruses')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Viruses.png) | ![illustration for Viruses](../../fontawesome/Solid/Viruses.Local.png) |
