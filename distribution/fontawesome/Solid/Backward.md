...
```text
include('fontawesome/Solid/Backward')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Backward.png) | ![illustration for Backward](../../fontawesome/Solid/Backward.Local.png) |
