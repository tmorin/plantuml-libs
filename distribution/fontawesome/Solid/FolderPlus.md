...
```text
include('fontawesome/Solid/FolderPlus')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/FolderPlus.png) | ![illustration for FolderPlus](../../fontawesome/Solid/FolderPlus.Local.png) |
