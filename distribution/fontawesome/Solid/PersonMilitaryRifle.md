...
```text
fontawesome/Solid/PersonMilitaryRifle
```

```text
include('fontawesome/Solid/PersonMilitaryRifle')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/PersonMilitaryRifle.png) | ![illustration for PersonMilitaryRifle](../../fontawesome/Solid/PersonMilitaryRifle.Local.png) |
