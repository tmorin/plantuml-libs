...
```text
fontawesome/Solid/PersonWalkingLuggage
```

```text
include('fontawesome/Solid/PersonWalkingLuggage')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/PersonWalkingLuggage.png) | ![illustration for PersonWalkingLuggage](../../fontawesome/Solid/PersonWalkingLuggage.Local.png) |
