...
```text
include('fontawesome/Solid/TrashAlt')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/TrashAlt.png) | ![illustration for TrashAlt](../../fontawesome/Solid/TrashAlt.Local.png) |
