...
```text
fontawesome/Solid/ArrowUpFromWaterPump
```

```text
include('fontawesome/Solid/ArrowUpFromWaterPump')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/ArrowUpFromWaterPump.png) | ![illustration for ArrowUpFromWaterPump](../../fontawesome/Solid/ArrowUpFromWaterPump.Local.png) |
