...
```text
include('fontawesome/Solid/Democrat')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Democrat.png) | ![illustration for Democrat](../../fontawesome/Solid/Democrat.Local.png) |
