...
```text
include('fontawesome/Solid/Helicopter')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Helicopter.png) | ![illustration for Helicopter](../../fontawesome/Solid/Helicopter.Local.png) |
