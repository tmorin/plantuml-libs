...
```text
include('fontawesome/Solid/Outdent')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Outdent.png) | ![illustration for Outdent](../../fontawesome/Solid/Outdent.Local.png) |
