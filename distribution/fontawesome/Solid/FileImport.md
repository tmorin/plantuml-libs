...
```text
include('fontawesome/Solid/FileImport')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/FileImport.png) | ![illustration for FileImport](../../fontawesome/Solid/FileImport.Local.png) |
