...
```text
include('fontawesome/Solid/FolderOpen')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/FolderOpen.png) | ![illustration for FolderOpen](../../fontawesome/Solid/FolderOpen.Local.png) |
