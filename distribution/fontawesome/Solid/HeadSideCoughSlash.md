...
```text
include('fontawesome/Solid/HeadSideCoughSlash')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/HeadSideCoughSlash.png) | ![illustration for HeadSideCoughSlash](../../fontawesome/Solid/HeadSideCoughSlash.Local.png) |
