...
```text
include('fontawesome/Solid/Stapler')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Stapler.png) | ![illustration for Stapler](../../fontawesome/Solid/Stapler.Local.png) |
