...
```text
include('fontawesome/Solid/Podcast')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Podcast.png) | ![illustration for Podcast](../../fontawesome/Solid/Podcast.Local.png) |
