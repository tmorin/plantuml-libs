...
```text
fontawesome/Solid/MicrophoneLinesSlash
```

```text
include('fontawesome/Solid/MicrophoneLinesSlash')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/MicrophoneLinesSlash.png) | ![illustration for MicrophoneLinesSlash](../../fontawesome/Solid/MicrophoneLinesSlash.Local.png) |
