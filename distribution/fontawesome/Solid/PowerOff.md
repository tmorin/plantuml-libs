...
```text
include('fontawesome/Solid/PowerOff')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/PowerOff.png) | ![illustration for PowerOff](../../fontawesome/Solid/PowerOff.Local.png) |
