...
```text
include('fontawesome/Solid/Handshake')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Handshake.png) | ![illustration for Handshake](../../fontawesome/Solid/Handshake.Local.png) |
