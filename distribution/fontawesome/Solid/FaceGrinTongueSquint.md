...
```text
fontawesome/Solid/FaceGrinTongueSquint
```

```text
include('fontawesome/Solid/FaceGrinTongueSquint')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/FaceGrinTongueSquint.png) | ![illustration for FaceGrinTongueSquint](../../fontawesome/Solid/FaceGrinTongueSquint.Local.png) |
