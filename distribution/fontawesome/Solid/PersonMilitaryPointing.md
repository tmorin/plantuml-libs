...
```text
fontawesome/Solid/PersonMilitaryPointing
```

```text
include('fontawesome/Solid/PersonMilitaryPointing')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/PersonMilitaryPointing.png) | ![illustration for PersonMilitaryPointing](../../fontawesome/Solid/PersonMilitaryPointing.Local.png) |
