...
```text
include('fontawesome/Solid/Blender')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Blender.png) | ![illustration for Blender](../../fontawesome/Solid/Blender.Local.png) |
