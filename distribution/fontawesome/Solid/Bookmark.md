...
```text
include('fontawesome/Solid/Bookmark')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Bookmark.png) | ![illustration for Bookmark](../../fontawesome/Solid/Bookmark.Local.png) |
