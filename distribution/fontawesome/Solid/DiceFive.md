...
```text
include('fontawesome/Solid/DiceFive')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/DiceFive.png) | ![illustration for DiceFive](../../fontawesome/Solid/DiceFive.Local.png) |
