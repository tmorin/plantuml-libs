...
```text
include('fontawesome/Solid/Forward')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Forward.png) | ![illustration for Forward](../../fontawesome/Solid/Forward.Local.png) |
