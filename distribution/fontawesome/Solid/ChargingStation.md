...
```text
include('fontawesome/Solid/ChargingStation')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/ChargingStation.png) | ![illustration for ChargingStation](../../fontawesome/Solid/ChargingStation.Local.png) |
