...
```text
include('fontawesome/Solid/Newspaper')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Solid/Newspaper.png) | ![illustration for Newspaper](../../fontawesome/Solid/Newspaper.Local.png) |
