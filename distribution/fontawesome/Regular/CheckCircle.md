...
```text
include('fontawesome/Regular/CheckCircle')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Regular/CheckCircle.png) | ![illustration for CheckCircle](../../fontawesome/Regular/CheckCircle.Local.png) |
