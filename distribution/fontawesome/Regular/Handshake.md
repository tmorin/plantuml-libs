...
```text
include('fontawesome/Regular/Handshake')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Regular/Handshake.png) | ![illustration for Handshake](../../fontawesome/Regular/Handshake.Local.png) |
