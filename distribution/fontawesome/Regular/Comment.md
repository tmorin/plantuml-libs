...
```text
include('fontawesome/Regular/Comment')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Regular/Comment.png) | ![illustration for Comment](../../fontawesome/Regular/Comment.Local.png) |
