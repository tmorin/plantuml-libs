...
```text
include('fontawesome/Regular/Envelope')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Regular/Envelope.png) | ![illustration for Envelope](../../fontawesome/Regular/Envelope.Local.png) |
