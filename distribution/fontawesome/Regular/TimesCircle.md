...
```text
include('fontawesome/Regular/TimesCircle')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Regular/TimesCircle.png) | ![illustration for TimesCircle](../../fontawesome/Regular/TimesCircle.Local.png) |
