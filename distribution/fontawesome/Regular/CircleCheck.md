...
```text
include('fontawesome/Regular/CircleCheck')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Regular/CircleCheck.png) | ![illustration for CircleCheck](../../fontawesome/Regular/CircleCheck.Local.png) |
