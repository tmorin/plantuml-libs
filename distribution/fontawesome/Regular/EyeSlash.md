...
```text
include('fontawesome/Regular/EyeSlash')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Regular/EyeSlash.png) | ![illustration for EyeSlash](../../fontawesome/Regular/EyeSlash.Local.png) |
