...
```text
include('fontawesome/Regular/Registered')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Regular/Registered.png) | ![illustration for Registered](../../fontawesome/Regular/Registered.Local.png) |
