...
```text
include('fontawesome/Regular/ThumbsUp')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Regular/ThumbsUp.png) | ![illustration for ThumbsUp](../../fontawesome/Regular/ThumbsUp.Local.png) |
