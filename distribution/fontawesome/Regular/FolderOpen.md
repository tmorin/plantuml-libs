...
```text
include('fontawesome/Regular/FolderOpen')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Regular/FolderOpen.png) | ![illustration for FolderOpen](../../fontawesome/Regular/FolderOpen.Local.png) |
