...
```text
include('fontawesome/Regular/Keyboard')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Regular/Keyboard.png) | ![illustration for Keyboard](../../fontawesome/Regular/Keyboard.Local.png) |
