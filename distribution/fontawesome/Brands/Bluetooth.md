...
```text
include('fontawesome/Brands/Bluetooth')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Bluetooth.png) | ![illustration for Bluetooth](../../fontawesome/Brands/Bluetooth.Local.png) |
