...
```text
include('fontawesome/Brands/Phabricator')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Phabricator.png) | ![illustration for Phabricator](../../fontawesome/Brands/Phabricator.Local.png) |
