...
```text
include('fontawesome/Brands/Themeisle')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Themeisle.png) | ![illustration for Themeisle](../../fontawesome/Brands/Themeisle.Local.png) |
