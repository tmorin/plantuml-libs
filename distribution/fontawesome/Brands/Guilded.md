...
```text
include('fontawesome/Brands/Guilded')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Guilded.png) | ![illustration for Guilded](../../fontawesome/Brands/Guilded.Local.png) |
