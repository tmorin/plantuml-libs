...
```text
include('fontawesome/Brands/Rockrms')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Rockrms.png) | ![illustration for Rockrms](../../fontawesome/Brands/Rockrms.Local.png) |
