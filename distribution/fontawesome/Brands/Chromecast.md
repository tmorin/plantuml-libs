...
```text
include('fontawesome/Brands/Chromecast')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Chromecast.png) | ![illustration for Chromecast](../../fontawesome/Brands/Chromecast.Local.png) |
