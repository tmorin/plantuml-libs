...
```text
include('fontawesome/Brands/Wpexplorer')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Wpexplorer.png) | ![illustration for Wpexplorer](../../fontawesome/Brands/Wpexplorer.Local.png) |
