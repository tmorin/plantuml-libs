...
```text
fontawesome/Brands/FontAwesomeLogoFull
```

```text
include('fontawesome/Brands/FontAwesomeLogoFull')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/FontAwesomeLogoFull.png) | ![illustration for FontAwesomeLogoFull](../../fontawesome/Brands/FontAwesomeLogoFull.Local.png) |
