...
```text
include('fontawesome/Brands/Bootstrap')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Bootstrap.png) | ![illustration for Bootstrap](../../fontawesome/Brands/Bootstrap.Local.png) |
