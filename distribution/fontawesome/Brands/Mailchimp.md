...
```text
include('fontawesome/Brands/Mailchimp')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Mailchimp.png) | ![illustration for Mailchimp](../../fontawesome/Brands/Mailchimp.Local.png) |
