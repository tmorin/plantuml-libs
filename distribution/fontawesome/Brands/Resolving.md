...
```text
include('fontawesome/Brands/Resolving')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Resolving.png) | ![illustration for Resolving](../../fontawesome/Brands/Resolving.Local.png) |
