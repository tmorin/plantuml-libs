...
```text
include('fontawesome/Brands/Whatsapp')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Whatsapp.png) | ![illustration for Whatsapp](../../fontawesome/Brands/Whatsapp.Local.png) |
