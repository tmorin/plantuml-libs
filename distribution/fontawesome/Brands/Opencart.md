...
```text
include('fontawesome/Brands/Opencart')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Opencart.png) | ![illustration for Opencart](../../fontawesome/Brands/Opencart.Local.png) |
