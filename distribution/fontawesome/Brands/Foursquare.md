...
```text
include('fontawesome/Brands/Foursquare')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Foursquare.png) | ![illustration for Foursquare](../../fontawesome/Brands/Foursquare.Local.png) |
