...
```text
fontawesome/Brands/CreativeCommonsNcJp
```

```text
include('fontawesome/Brands/CreativeCommonsNcJp')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/CreativeCommonsNcJp.png) | ![illustration for CreativeCommonsNcJp](../../fontawesome/Brands/CreativeCommonsNcJp.Local.png) |
