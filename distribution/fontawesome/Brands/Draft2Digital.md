...
```text
include('fontawesome/Brands/Draft2Digital')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Draft2Digital.png) | ![illustration for Draft2Digital](../../fontawesome/Brands/Draft2Digital.Local.png) |
