...
```text
include('fontawesome/Brands/Screenpal')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Screenpal.png) | ![illustration for Screenpal](../../fontawesome/Brands/Screenpal.Local.png) |
