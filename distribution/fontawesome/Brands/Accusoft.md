...
```text
include('fontawesome/Brands/Accusoft')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Accusoft.png) | ![illustration for Accusoft](../../fontawesome/Brands/Accusoft.Local.png) |
