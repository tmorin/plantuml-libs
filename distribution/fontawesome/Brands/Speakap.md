...
```text
include('fontawesome/Brands/Speakap')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Speakap.png) | ![illustration for Speakap](../../fontawesome/Brands/Speakap.Local.png) |
