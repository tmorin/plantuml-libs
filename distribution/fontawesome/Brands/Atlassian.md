...
```text
include('fontawesome/Brands/Atlassian')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Atlassian.png) | ![illustration for Atlassian](../../fontawesome/Brands/Atlassian.Local.png) |
