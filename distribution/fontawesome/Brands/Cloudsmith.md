...
```text
include('fontawesome/Brands/Cloudsmith')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Cloudsmith.png) | ![illustration for Cloudsmith](../../fontawesome/Brands/Cloudsmith.Local.png) |
