...
```text
include('fontawesome/Brands/Goodreads')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Goodreads.png) | ![illustration for Goodreads](../../fontawesome/Brands/Goodreads.Local.png) |
