...
```text
include('fontawesome/Brands/Freebsd')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Freebsd.png) | ![illustration for Freebsd](../../fontawesome/Brands/Freebsd.Local.png) |
