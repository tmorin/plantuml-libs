...
```text
include('fontawesome/Brands/Dashcube')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Dashcube.png) | ![illustration for Dashcube](../../fontawesome/Brands/Dashcube.Local.png) |
