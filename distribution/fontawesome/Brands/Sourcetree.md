...
```text
include('fontawesome/Brands/Sourcetree')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Sourcetree.png) | ![illustration for Sourcetree](../../fontawesome/Brands/Sourcetree.Local.png) |
