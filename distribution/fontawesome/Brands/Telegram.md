...
```text
include('fontawesome/Brands/Telegram')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Telegram.png) | ![illustration for Telegram](../../fontawesome/Brands/Telegram.Local.png) |
