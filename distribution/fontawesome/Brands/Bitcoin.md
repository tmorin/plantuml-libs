...
```text
include('fontawesome/Brands/Bitcoin')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Bitcoin.png) | ![illustration for Bitcoin](../../fontawesome/Brands/Bitcoin.Local.png) |
