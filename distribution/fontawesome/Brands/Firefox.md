...
```text
include('fontawesome/Brands/Firefox')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Firefox.png) | ![illustration for Firefox](../../fontawesome/Brands/Firefox.Local.png) |
