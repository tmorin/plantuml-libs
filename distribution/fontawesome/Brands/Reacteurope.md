...
```text
include('fontawesome/Brands/Reacteurope')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Reacteurope.png) | ![illustration for Reacteurope](../../fontawesome/Brands/Reacteurope.Local.png) |
