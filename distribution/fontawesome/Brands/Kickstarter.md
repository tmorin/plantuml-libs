...
```text
include('fontawesome/Brands/Kickstarter')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Kickstarter.png) | ![illustration for Kickstarter](../../fontawesome/Brands/Kickstarter.Local.png) |
