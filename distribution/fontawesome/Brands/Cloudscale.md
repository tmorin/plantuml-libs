...
```text
include('fontawesome/Brands/Cloudscale')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Cloudscale.png) | ![illustration for Cloudscale](../../fontawesome/Brands/Cloudscale.Local.png) |
