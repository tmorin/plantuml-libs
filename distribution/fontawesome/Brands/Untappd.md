...
```text
include('fontawesome/Brands/Untappd')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Untappd.png) | ![illustration for Untappd](../../fontawesome/Brands/Untappd.Local.png) |
