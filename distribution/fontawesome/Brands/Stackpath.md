...
```text
include('fontawesome/Brands/Stackpath')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Stackpath.png) | ![illustration for Stackpath](../../fontawesome/Brands/Stackpath.Local.png) |
