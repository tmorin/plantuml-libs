...
```text
include('fontawesome/Brands/Instagram')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Instagram.png) | ![illustration for Instagram](../../fontawesome/Brands/Instagram.Local.png) |
