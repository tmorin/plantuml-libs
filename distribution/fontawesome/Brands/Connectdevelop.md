...
```text
include('fontawesome/Brands/Connectdevelop')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Connectdevelop.png) | ![illustration for Connectdevelop](../../fontawesome/Brands/Connectdevelop.Local.png) |
