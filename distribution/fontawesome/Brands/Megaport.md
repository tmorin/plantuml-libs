...
```text
include('fontawesome/Brands/Megaport')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Megaport.png) | ![illustration for Megaport](../../fontawesome/Brands/Megaport.Local.png) |
