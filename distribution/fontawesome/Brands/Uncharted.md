...
```text
include('fontawesome/Brands/Uncharted')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../fontawesome/Brands/Uncharted.png) | ![illustration for Uncharted](../../fontawesome/Brands/Uncharted.Local.png) |
