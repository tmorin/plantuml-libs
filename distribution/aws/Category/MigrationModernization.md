...
```text
aws/Category/MigrationModernization
```

```text
include('aws/Category/MigrationModernization')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws/Category/MigrationModernization.png) | ![illustration for MigrationModernization](../../aws/Category/MigrationModernization.Local.png) | ![illustration for MigrationModernizationCard](../../aws/Category/MigrationModernizationCard.Local.png) | ![illustration for MigrationModernizationGroup](../../aws/Category/MigrationModernizationGroup.Local.png) |
