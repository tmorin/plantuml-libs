...
```text
aws/Architecture/DeveloperTools/AwsCodeBuild
```

```text
include('aws/Architecture/DeveloperTools/AwsCodeBuild')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/DeveloperTools/AwsCodeBuild.png) | ![illustration for AwsCodeBuild](../../../aws/Architecture/DeveloperTools/AwsCodeBuild.Local.png) | ![illustration for AwsCodeBuildCard](../../../aws/Architecture/DeveloperTools/AwsCodeBuildCard.Local.png) | ![illustration for AwsCodeBuildGroup](../../../aws/Architecture/DeveloperTools/AwsCodeBuildGroup.Local.png) |
