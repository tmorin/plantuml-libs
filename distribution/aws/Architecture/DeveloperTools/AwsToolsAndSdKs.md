...
```text
aws/Architecture/DeveloperTools/AwsToolsAndSdKs
```

```text
include('aws/Architecture/DeveloperTools/AwsToolsAndSdKs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/DeveloperTools/AwsToolsAndSdKs.png) | ![illustration for AwsToolsAndSdKs](../../../aws/Architecture/DeveloperTools/AwsToolsAndSdKs.Local.png) | ![illustration for AwsToolsAndSdKsCard](../../../aws/Architecture/DeveloperTools/AwsToolsAndSdKsCard.Local.png) | ![illustration for AwsToolsAndSdKsGroup](../../../aws/Architecture/DeveloperTools/AwsToolsAndSdKsGroup.Local.png) |
