...
```text
aws/Architecture/DeveloperTools/AwsCodeCommit
```

```text
include('aws/Architecture/DeveloperTools/AwsCodeCommit')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/DeveloperTools/AwsCodeCommit.png) | ![illustration for AwsCodeCommit](../../../aws/Architecture/DeveloperTools/AwsCodeCommit.Local.png) | ![illustration for AwsCodeCommitCard](../../../aws/Architecture/DeveloperTools/AwsCodeCommitCard.Local.png) | ![illustration for AwsCodeCommitGroup](../../../aws/Architecture/DeveloperTools/AwsCodeCommitGroup.Local.png) |
