...
```text
aws/Architecture/DeveloperTools/AwsCodeDeploy
```

```text
include('aws/Architecture/DeveloperTools/AwsCodeDeploy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/DeveloperTools/AwsCodeDeploy.png) | ![illustration for AwsCodeDeploy](../../../aws/Architecture/DeveloperTools/AwsCodeDeploy.Local.png) | ![illustration for AwsCodeDeployCard](../../../aws/Architecture/DeveloperTools/AwsCodeDeployCard.Local.png) | ![illustration for AwsCodeDeployGroup](../../../aws/Architecture/DeveloperTools/AwsCodeDeployGroup.Local.png) |
