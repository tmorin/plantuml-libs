...
```text
aws/Architecture/DeveloperTools/AwsCloudShell
```

```text
include('aws/Architecture/DeveloperTools/AwsCloudShell')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/DeveloperTools/AwsCloudShell.png) | ![illustration for AwsCloudShell](../../../aws/Architecture/DeveloperTools/AwsCloudShell.Local.png) | ![illustration for AwsCloudShellCard](../../../aws/Architecture/DeveloperTools/AwsCloudShellCard.Local.png) | ![illustration for AwsCloudShellGroup](../../../aws/Architecture/DeveloperTools/AwsCloudShellGroup.Local.png) |
