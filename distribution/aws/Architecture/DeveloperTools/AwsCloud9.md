...
```text
aws/Architecture/DeveloperTools/AwsCloud9
```

```text
include('aws/Architecture/DeveloperTools/AwsCloud9')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/DeveloperTools/AwsCloud9.png) | ![illustration for AwsCloud9](../../../aws/Architecture/DeveloperTools/AwsCloud9.Local.png) | ![illustration for AwsCloud9Card](../../../aws/Architecture/DeveloperTools/AwsCloud9Card.Local.png) | ![illustration for AwsCloud9Group](../../../aws/Architecture/DeveloperTools/AwsCloud9Group.Local.png) |
