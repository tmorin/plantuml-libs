...
```text
aws/Architecture/CloudFinancialManagement/AwsCostExplorer
```

```text
include('aws/Architecture/CloudFinancialManagement/AwsCostExplorer')
```
