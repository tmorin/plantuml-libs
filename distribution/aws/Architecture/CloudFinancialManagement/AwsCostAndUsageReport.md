...
```text
aws/Architecture/CloudFinancialManagement/AwsCostAndUsageReport
```

```text
include('aws/Architecture/CloudFinancialManagement/AwsCostAndUsageReport')
```
