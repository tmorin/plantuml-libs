...
```text
aws/Architecture/MediaServices/AmazonInteractiveVideoService
```

```text
include('aws/Architecture/MediaServices/AmazonInteractiveVideoService')
```
