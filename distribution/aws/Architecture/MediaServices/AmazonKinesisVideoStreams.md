...
```text
aws/Architecture/MediaServices/AmazonKinesisVideoStreams
```

```text
include('aws/Architecture/MediaServices/AmazonKinesisVideoStreams')
```
