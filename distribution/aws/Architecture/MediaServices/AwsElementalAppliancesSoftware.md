...
```text
aws/Architecture/MediaServices/AwsElementalAppliancesSoftware
```

```text
include('aws/Architecture/MediaServices/AwsElementalAppliancesSoftware')
```
