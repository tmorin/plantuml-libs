...
```text
aws/Architecture/Analytics/AmazonDataFirehose
```

```text
include('aws/Architecture/Analytics/AmazonDataFirehose')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AmazonDataFirehose.png) | ![illustration for AmazonDataFirehose](../../../aws/Architecture/Analytics/AmazonDataFirehose.Local.png) | ![illustration for AmazonDataFirehoseCard](../../../aws/Architecture/Analytics/AmazonDataFirehoseCard.Local.png) | ![illustration for AmazonDataFirehoseGroup](../../../aws/Architecture/Analytics/AmazonDataFirehoseGroup.Local.png) |
