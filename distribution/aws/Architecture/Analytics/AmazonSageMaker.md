...
```text
aws/Architecture/Analytics/AmazonSageMaker
```

```text
include('aws/Architecture/Analytics/AmazonSageMaker')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AmazonSageMaker.png) | ![illustration for AmazonSageMaker](../../../aws/Architecture/Analytics/AmazonSageMaker.Local.png) | ![illustration for AmazonSageMakerCard](../../../aws/Architecture/Analytics/AmazonSageMakerCard.Local.png) | ![illustration for AmazonSageMakerGroup](../../../aws/Architecture/Analytics/AmazonSageMakerGroup.Local.png) |
