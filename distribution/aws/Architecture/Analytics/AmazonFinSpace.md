...
```text
aws/Architecture/Analytics/AmazonFinSpace
```

```text
include('aws/Architecture/Analytics/AmazonFinSpace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AmazonFinSpace.png) | ![illustration for AmazonFinSpace](../../../aws/Architecture/Analytics/AmazonFinSpace.Local.png) | ![illustration for AmazonFinSpaceCard](../../../aws/Architecture/Analytics/AmazonFinSpaceCard.Local.png) | ![illustration for AmazonFinSpaceGroup](../../../aws/Architecture/Analytics/AmazonFinSpaceGroup.Local.png) |
