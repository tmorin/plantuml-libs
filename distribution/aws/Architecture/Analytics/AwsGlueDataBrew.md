...
```text
aws/Architecture/Analytics/AwsGlueDataBrew
```

```text
include('aws/Architecture/Analytics/AwsGlueDataBrew')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AwsGlueDataBrew.png) | ![illustration for AwsGlueDataBrew](../../../aws/Architecture/Analytics/AwsGlueDataBrew.Local.png) | ![illustration for AwsGlueDataBrewCard](../../../aws/Architecture/Analytics/AwsGlueDataBrewCard.Local.png) | ![illustration for AwsGlueDataBrewGroup](../../../aws/Architecture/Analytics/AwsGlueDataBrewGroup.Local.png) |
