...
```text
aws/Architecture/Analytics/AmazonOpenSearchService
```

```text
include('aws/Architecture/Analytics/AmazonOpenSearchService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AmazonOpenSearchService.png) | ![illustration for AmazonOpenSearchService](../../../aws/Architecture/Analytics/AmazonOpenSearchService.Local.png) | ![illustration for AmazonOpenSearchServiceCard](../../../aws/Architecture/Analytics/AmazonOpenSearchServiceCard.Local.png) | ![illustration for AmazonOpenSearchServiceGroup](../../../aws/Architecture/Analytics/AmazonOpenSearchServiceGroup.Local.png) |
