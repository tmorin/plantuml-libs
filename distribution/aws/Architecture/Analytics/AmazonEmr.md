...
```text
aws/Architecture/Analytics/AmazonEmr
```

```text
include('aws/Architecture/Analytics/AmazonEmr')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AmazonEmr.png) | ![illustration for AmazonEmr](../../../aws/Architecture/Analytics/AmazonEmr.Local.png) | ![illustration for AmazonEmrCard](../../../aws/Architecture/Analytics/AmazonEmrCard.Local.png) | ![illustration for AmazonEmrGroup](../../../aws/Architecture/Analytics/AmazonEmrGroup.Local.png) |
