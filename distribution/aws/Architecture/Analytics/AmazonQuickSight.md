...
```text
aws/Architecture/Analytics/AmazonQuickSight
```

```text
include('aws/Architecture/Analytics/AmazonQuickSight')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AmazonQuickSight.png) | ![illustration for AmazonQuickSight](../../../aws/Architecture/Analytics/AmazonQuickSight.Local.png) | ![illustration for AmazonQuickSightCard](../../../aws/Architecture/Analytics/AmazonQuickSightCard.Local.png) | ![illustration for AmazonQuickSightGroup](../../../aws/Architecture/Analytics/AmazonQuickSightGroup.Local.png) |
