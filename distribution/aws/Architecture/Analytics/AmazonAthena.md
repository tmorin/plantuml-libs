...
```text
aws/Architecture/Analytics/AmazonAthena
```

```text
include('aws/Architecture/Analytics/AmazonAthena')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AmazonAthena.png) | ![illustration for AmazonAthena](../../../aws/Architecture/Analytics/AmazonAthena.Local.png) | ![illustration for AmazonAthenaCard](../../../aws/Architecture/Analytics/AmazonAthenaCard.Local.png) | ![illustration for AmazonAthenaGroup](../../../aws/Architecture/Analytics/AmazonAthenaGroup.Local.png) |
