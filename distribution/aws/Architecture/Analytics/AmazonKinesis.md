...
```text
aws/Architecture/Analytics/AmazonKinesis
```

```text
include('aws/Architecture/Analytics/AmazonKinesis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AmazonKinesis.png) | ![illustration for AmazonKinesis](../../../aws/Architecture/Analytics/AmazonKinesis.Local.png) | ![illustration for AmazonKinesisCard](../../../aws/Architecture/Analytics/AmazonKinesisCard.Local.png) | ![illustration for AmazonKinesisGroup](../../../aws/Architecture/Analytics/AmazonKinesisGroup.Local.png) |
