...
```text
aws/Architecture/Analytics/AwsGlue
```

```text
include('aws/Architecture/Analytics/AwsGlue')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AwsGlue.png) | ![illustration for AwsGlue](../../../aws/Architecture/Analytics/AwsGlue.Local.png) | ![illustration for AwsGlueCard](../../../aws/Architecture/Analytics/AwsGlueCard.Local.png) | ![illustration for AwsGlueGroup](../../../aws/Architecture/Analytics/AwsGlueGroup.Local.png) |
