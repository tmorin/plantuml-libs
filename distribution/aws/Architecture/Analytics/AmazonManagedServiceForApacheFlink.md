...
```text
aws/Architecture/Analytics/AmazonManagedServiceForApacheFlink
```

```text
include('aws/Architecture/Analytics/AmazonManagedServiceForApacheFlink')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AmazonManagedServiceForApacheFlink.png) | ![illustration for AmazonManagedServiceForApacheFlink](../../../aws/Architecture/Analytics/AmazonManagedServiceForApacheFlink.Local.png) | ![illustration for AmazonManagedServiceForApacheFlinkCard](../../../aws/Architecture/Analytics/AmazonManagedServiceForApacheFlinkCard.Local.png) | ![illustration for AmazonManagedServiceForApacheFlinkGroup](../../../aws/Architecture/Analytics/AmazonManagedServiceForApacheFlinkGroup.Local.png) |
