...
```text
aws/Architecture/Analytics/AmazonKinesisVideoStreams
```

```text
include('aws/Architecture/Analytics/AmazonKinesisVideoStreams')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Analytics/AmazonKinesisVideoStreams.png) | ![illustration for AmazonKinesisVideoStreams](../../../aws/Architecture/Analytics/AmazonKinesisVideoStreams.Local.png) | ![illustration for AmazonKinesisVideoStreamsCard](../../../aws/Architecture/Analytics/AmazonKinesisVideoStreamsCard.Local.png) | ![illustration for AmazonKinesisVideoStreamsGroup](../../../aws/Architecture/Analytics/AmazonKinesisVideoStreamsGroup.Local.png) |
