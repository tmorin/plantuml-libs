...
```text
aws/Architecture/GeneralIcons/AwsMarketplaceLight
```

```text
include('aws/Architecture/GeneralIcons/AwsMarketplaceLight')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/GeneralIcons/AwsMarketplaceLight.png) | ![illustration for AwsMarketplaceLight](../../../aws/Architecture/GeneralIcons/AwsMarketplaceLight.Local.png) | ![illustration for AwsMarketplaceLightCard](../../../aws/Architecture/GeneralIcons/AwsMarketplaceLightCard.Local.png) | ![illustration for AwsMarketplaceLightGroup](../../../aws/Architecture/GeneralIcons/AwsMarketplaceLightGroup.Local.png) |
