...
```text
aws/Architecture/GeneralIcons/AwsMarketplaceDark
```

```text
include('aws/Architecture/GeneralIcons/AwsMarketplaceDark')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/GeneralIcons/AwsMarketplaceDark.png) | ![illustration for AwsMarketplaceDark](../../../aws/Architecture/GeneralIcons/AwsMarketplaceDark.Local.png) | ![illustration for AwsMarketplaceDarkCard](../../../aws/Architecture/GeneralIcons/AwsMarketplaceDarkCard.Local.png) | ![illustration for AwsMarketplaceDarkGroup](../../../aws/Architecture/GeneralIcons/AwsMarketplaceDarkGroup.Local.png) |
