...
```text
aws/Architecture/CustomerEnablement/AwsTrainingCertification
```

```text
include('aws/Architecture/CustomerEnablement/AwsTrainingCertification')
```
