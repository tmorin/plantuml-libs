...
```text
aws/Architecture/SecurityIdentityCompliance/AwsFirewallManager
```

```text
include('aws/Architecture/SecurityIdentityCompliance/AwsFirewallManager')
```
