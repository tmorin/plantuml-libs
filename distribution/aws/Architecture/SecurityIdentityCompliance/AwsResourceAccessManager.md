...
```text
aws/Architecture/SecurityIdentityCompliance/AwsResourceAccessManager
```

```text
include('aws/Architecture/SecurityIdentityCompliance/AwsResourceAccessManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/SecurityIdentityCompliance/AwsResourceAccessManager.png) | ![illustration for AwsResourceAccessManager](../../../aws/Architecture/SecurityIdentityCompliance/AwsResourceAccessManager.Local.png) | ![illustration for AwsResourceAccessManagerCard](../../../aws/Architecture/SecurityIdentityCompliance/AwsResourceAccessManagerCard.Local.png) | ![illustration for AwsResourceAccessManagerGroup](../../../aws/Architecture/SecurityIdentityCompliance/AwsResourceAccessManagerGroup.Local.png) |
