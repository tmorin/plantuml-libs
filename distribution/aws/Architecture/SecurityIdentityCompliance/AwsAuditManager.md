...
```text
aws/Architecture/SecurityIdentityCompliance/AwsAuditManager
```

```text
include('aws/Architecture/SecurityIdentityCompliance/AwsAuditManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/SecurityIdentityCompliance/AwsAuditManager.png) | ![illustration for AwsAuditManager](../../../aws/Architecture/SecurityIdentityCompliance/AwsAuditManager.Local.png) | ![illustration for AwsAuditManagerCard](../../../aws/Architecture/SecurityIdentityCompliance/AwsAuditManagerCard.Local.png) | ![illustration for AwsAuditManagerGroup](../../../aws/Architecture/SecurityIdentityCompliance/AwsAuditManagerGroup.Local.png) |
