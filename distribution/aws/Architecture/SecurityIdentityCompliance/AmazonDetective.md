...
```text
aws/Architecture/SecurityIdentityCompliance/AmazonDetective
```

```text
include('aws/Architecture/SecurityIdentityCompliance/AmazonDetective')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/SecurityIdentityCompliance/AmazonDetective.png) | ![illustration for AmazonDetective](../../../aws/Architecture/SecurityIdentityCompliance/AmazonDetective.Local.png) | ![illustration for AmazonDetectiveCard](../../../aws/Architecture/SecurityIdentityCompliance/AmazonDetectiveCard.Local.png) | ![illustration for AmazonDetectiveGroup](../../../aws/Architecture/SecurityIdentityCompliance/AmazonDetectiveGroup.Local.png) |
