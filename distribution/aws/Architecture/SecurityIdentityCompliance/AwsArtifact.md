...
```text
aws/Architecture/SecurityIdentityCompliance/AwsArtifact
```

```text
include('aws/Architecture/SecurityIdentityCompliance/AwsArtifact')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/SecurityIdentityCompliance/AwsArtifact.png) | ![illustration for AwsArtifact](../../../aws/Architecture/SecurityIdentityCompliance/AwsArtifact.Local.png) | ![illustration for AwsArtifactCard](../../../aws/Architecture/SecurityIdentityCompliance/AwsArtifactCard.Local.png) | ![illustration for AwsArtifactGroup](../../../aws/Architecture/SecurityIdentityCompliance/AwsArtifactGroup.Local.png) |
