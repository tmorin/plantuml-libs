...
```text
aws/Architecture/SecurityIdentityCompliance/AmazonGuardDuty
```

```text
include('aws/Architecture/SecurityIdentityCompliance/AmazonGuardDuty')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/SecurityIdentityCompliance/AmazonGuardDuty.png) | ![illustration for AmazonGuardDuty](../../../aws/Architecture/SecurityIdentityCompliance/AmazonGuardDuty.Local.png) | ![illustration for AmazonGuardDutyCard](../../../aws/Architecture/SecurityIdentityCompliance/AmazonGuardDutyCard.Local.png) | ![illustration for AmazonGuardDutyGroup](../../../aws/Architecture/SecurityIdentityCompliance/AmazonGuardDutyGroup.Local.png) |
