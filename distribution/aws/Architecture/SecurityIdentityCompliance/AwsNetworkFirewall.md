...
```text
aws/Architecture/SecurityIdentityCompliance/AwsNetworkFirewall
```

```text
include('aws/Architecture/SecurityIdentityCompliance/AwsNetworkFirewall')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/SecurityIdentityCompliance/AwsNetworkFirewall.png) | ![illustration for AwsNetworkFirewall](../../../aws/Architecture/SecurityIdentityCompliance/AwsNetworkFirewall.Local.png) | ![illustration for AwsNetworkFirewallCard](../../../aws/Architecture/SecurityIdentityCompliance/AwsNetworkFirewallCard.Local.png) | ![illustration for AwsNetworkFirewallGroup](../../../aws/Architecture/SecurityIdentityCompliance/AwsNetworkFirewallGroup.Local.png) |
