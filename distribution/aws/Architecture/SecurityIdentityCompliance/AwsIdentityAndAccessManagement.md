...
```text
aws/Architecture/SecurityIdentityCompliance/AwsIdentityAndAccessManagement
```

```text
include('aws/Architecture/SecurityIdentityCompliance/AwsIdentityAndAccessManagement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/SecurityIdentityCompliance/AwsIdentityAndAccessManagement.png) | ![illustration for AwsIdentityAndAccessManagement](../../../aws/Architecture/SecurityIdentityCompliance/AwsIdentityAndAccessManagement.Local.png) | ![illustration for AwsIdentityAndAccessManagementCard](../../../aws/Architecture/SecurityIdentityCompliance/AwsIdentityAndAccessManagementCard.Local.png) | ![illustration for AwsIdentityAndAccessManagementGroup](../../../aws/Architecture/SecurityIdentityCompliance/AwsIdentityAndAccessManagementGroup.Local.png) |
