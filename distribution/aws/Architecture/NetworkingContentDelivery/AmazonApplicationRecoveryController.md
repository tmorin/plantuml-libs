...
```text
aws/Architecture/NetworkingContentDelivery/AmazonApplicationRecoveryController
```

```text
include('aws/Architecture/NetworkingContentDelivery/AmazonApplicationRecoveryController')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/NetworkingContentDelivery/AmazonApplicationRecoveryController.png) | ![illustration for AmazonApplicationRecoveryController](../../../aws/Architecture/NetworkingContentDelivery/AmazonApplicationRecoveryController.Local.png) | ![illustration for AmazonApplicationRecoveryControllerCard](../../../aws/Architecture/NetworkingContentDelivery/AmazonApplicationRecoveryControllerCard.Local.png) | ![illustration for AmazonApplicationRecoveryControllerGroup](../../../aws/Architecture/NetworkingContentDelivery/AmazonApplicationRecoveryControllerGroup.Local.png) |
