...
```text
aws/Architecture/NetworkingContentDelivery/AwsSiteToSiteVpn
```

```text
include('aws/Architecture/NetworkingContentDelivery/AwsSiteToSiteVpn')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/NetworkingContentDelivery/AwsSiteToSiteVpn.png) | ![illustration for AwsSiteToSiteVpn](../../../aws/Architecture/NetworkingContentDelivery/AwsSiteToSiteVpn.Local.png) | ![illustration for AwsSiteToSiteVpnCard](../../../aws/Architecture/NetworkingContentDelivery/AwsSiteToSiteVpnCard.Local.png) | ![illustration for AwsSiteToSiteVpnGroup](../../../aws/Architecture/NetworkingContentDelivery/AwsSiteToSiteVpnGroup.Local.png) |
