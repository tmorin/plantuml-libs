...
```text
aws/Architecture/NetworkingContentDelivery/AwsGlobalAccelerator
```

```text
include('aws/Architecture/NetworkingContentDelivery/AwsGlobalAccelerator')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/NetworkingContentDelivery/AwsGlobalAccelerator.png) | ![illustration for AwsGlobalAccelerator](../../../aws/Architecture/NetworkingContentDelivery/AwsGlobalAccelerator.Local.png) | ![illustration for AwsGlobalAcceleratorCard](../../../aws/Architecture/NetworkingContentDelivery/AwsGlobalAcceleratorCard.Local.png) | ![illustration for AwsGlobalAcceleratorGroup](../../../aws/Architecture/NetworkingContentDelivery/AwsGlobalAcceleratorGroup.Local.png) |
