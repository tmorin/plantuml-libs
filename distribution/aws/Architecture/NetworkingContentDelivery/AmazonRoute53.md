...
```text
aws/Architecture/NetworkingContentDelivery/AmazonRoute53
```

```text
include('aws/Architecture/NetworkingContentDelivery/AmazonRoute53')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/NetworkingContentDelivery/AmazonRoute53.png) | ![illustration for AmazonRoute53](../../../aws/Architecture/NetworkingContentDelivery/AmazonRoute53.Local.png) | ![illustration for AmazonRoute53Card](../../../aws/Architecture/NetworkingContentDelivery/AmazonRoute53Card.Local.png) | ![illustration for AmazonRoute53Group](../../../aws/Architecture/NetworkingContentDelivery/AmazonRoute53Group.Local.png) |
