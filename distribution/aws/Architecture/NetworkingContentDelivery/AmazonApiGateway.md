...
```text
aws/Architecture/NetworkingContentDelivery/AmazonApiGateway
```

```text
include('aws/Architecture/NetworkingContentDelivery/AmazonApiGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/NetworkingContentDelivery/AmazonApiGateway.png) | ![illustration for AmazonApiGateway](../../../aws/Architecture/NetworkingContentDelivery/AmazonApiGateway.Local.png) | ![illustration for AmazonApiGatewayCard](../../../aws/Architecture/NetworkingContentDelivery/AmazonApiGatewayCard.Local.png) | ![illustration for AmazonApiGatewayGroup](../../../aws/Architecture/NetworkingContentDelivery/AmazonApiGatewayGroup.Local.png) |
