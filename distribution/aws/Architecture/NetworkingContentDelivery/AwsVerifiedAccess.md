...
```text
aws/Architecture/NetworkingContentDelivery/AwsVerifiedAccess
```

```text
include('aws/Architecture/NetworkingContentDelivery/AwsVerifiedAccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/NetworkingContentDelivery/AwsVerifiedAccess.png) | ![illustration for AwsVerifiedAccess](../../../aws/Architecture/NetworkingContentDelivery/AwsVerifiedAccess.Local.png) | ![illustration for AwsVerifiedAccessCard](../../../aws/Architecture/NetworkingContentDelivery/AwsVerifiedAccessCard.Local.png) | ![illustration for AwsVerifiedAccessGroup](../../../aws/Architecture/NetworkingContentDelivery/AwsVerifiedAccessGroup.Local.png) |
