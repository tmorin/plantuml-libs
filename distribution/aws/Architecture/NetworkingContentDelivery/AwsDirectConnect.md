...
```text
aws/Architecture/NetworkingContentDelivery/AwsDirectConnect
```

```text
include('aws/Architecture/NetworkingContentDelivery/AwsDirectConnect')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/NetworkingContentDelivery/AwsDirectConnect.png) | ![illustration for AwsDirectConnect](../../../aws/Architecture/NetworkingContentDelivery/AwsDirectConnect.Local.png) | ![illustration for AwsDirectConnectCard](../../../aws/Architecture/NetworkingContentDelivery/AwsDirectConnectCard.Local.png) | ![illustration for AwsDirectConnectGroup](../../../aws/Architecture/NetworkingContentDelivery/AwsDirectConnectGroup.Local.png) |
