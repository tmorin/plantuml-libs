...
```text
aws/Architecture/NetworkingContentDelivery/AwsTransitGateway
```

```text
include('aws/Architecture/NetworkingContentDelivery/AwsTransitGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/NetworkingContentDelivery/AwsTransitGateway.png) | ![illustration for AwsTransitGateway](../../../aws/Architecture/NetworkingContentDelivery/AwsTransitGateway.Local.png) | ![illustration for AwsTransitGatewayCard](../../../aws/Architecture/NetworkingContentDelivery/AwsTransitGatewayCard.Local.png) | ![illustration for AwsTransitGatewayGroup](../../../aws/Architecture/NetworkingContentDelivery/AwsTransitGatewayGroup.Local.png) |
