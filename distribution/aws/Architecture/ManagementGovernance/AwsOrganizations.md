...
```text
aws/Architecture/ManagementGovernance/AwsOrganizations
```

```text
include('aws/Architecture/ManagementGovernance/AwsOrganizations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsOrganizations.png) | ![illustration for AwsOrganizations](../../../aws/Architecture/ManagementGovernance/AwsOrganizations.Local.png) | ![illustration for AwsOrganizationsCard](../../../aws/Architecture/ManagementGovernance/AwsOrganizationsCard.Local.png) | ![illustration for AwsOrganizationsGroup](../../../aws/Architecture/ManagementGovernance/AwsOrganizationsGroup.Local.png) |
