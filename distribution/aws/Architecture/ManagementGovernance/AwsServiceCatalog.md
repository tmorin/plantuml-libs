...
```text
aws/Architecture/ManagementGovernance/AwsServiceCatalog
```

```text
include('aws/Architecture/ManagementGovernance/AwsServiceCatalog')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsServiceCatalog.png) | ![illustration for AwsServiceCatalog](../../../aws/Architecture/ManagementGovernance/AwsServiceCatalog.Local.png) | ![illustration for AwsServiceCatalogCard](../../../aws/Architecture/ManagementGovernance/AwsServiceCatalogCard.Local.png) | ![illustration for AwsServiceCatalogGroup](../../../aws/Architecture/ManagementGovernance/AwsServiceCatalogGroup.Local.png) |
