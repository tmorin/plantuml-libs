...
```text
aws/Architecture/ManagementGovernance/AwsResourceExplorer
```

```text
include('aws/Architecture/ManagementGovernance/AwsResourceExplorer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsResourceExplorer.png) | ![illustration for AwsResourceExplorer](../../../aws/Architecture/ManagementGovernance/AwsResourceExplorer.Local.png) | ![illustration for AwsResourceExplorerCard](../../../aws/Architecture/ManagementGovernance/AwsResourceExplorerCard.Local.png) | ![illustration for AwsResourceExplorerGroup](../../../aws/Architecture/ManagementGovernance/AwsResourceExplorerGroup.Local.png) |
