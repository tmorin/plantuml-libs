...
```text
aws/Architecture/ManagementGovernance/AwsTelcoNetworkBuilder
```

```text
include('aws/Architecture/ManagementGovernance/AwsTelcoNetworkBuilder')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsTelcoNetworkBuilder.png) | ![illustration for AwsTelcoNetworkBuilder](../../../aws/Architecture/ManagementGovernance/AwsTelcoNetworkBuilder.Local.png) | ![illustration for AwsTelcoNetworkBuilderCard](../../../aws/Architecture/ManagementGovernance/AwsTelcoNetworkBuilderCard.Local.png) | ![illustration for AwsTelcoNetworkBuilderGroup](../../../aws/Architecture/ManagementGovernance/AwsTelcoNetworkBuilderGroup.Local.png) |
