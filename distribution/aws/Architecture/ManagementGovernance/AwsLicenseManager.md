...
```text
aws/Architecture/ManagementGovernance/AwsLicenseManager
```

```text
include('aws/Architecture/ManagementGovernance/AwsLicenseManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsLicenseManager.png) | ![illustration for AwsLicenseManager](../../../aws/Architecture/ManagementGovernance/AwsLicenseManager.Local.png) | ![illustration for AwsLicenseManagerCard](../../../aws/Architecture/ManagementGovernance/AwsLicenseManagerCard.Local.png) | ![illustration for AwsLicenseManagerGroup](../../../aws/Architecture/ManagementGovernance/AwsLicenseManagerGroup.Local.png) |
