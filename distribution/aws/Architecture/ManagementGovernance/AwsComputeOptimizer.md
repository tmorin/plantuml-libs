...
```text
aws/Architecture/ManagementGovernance/AwsComputeOptimizer
```

```text
include('aws/Architecture/ManagementGovernance/AwsComputeOptimizer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsComputeOptimizer.png) | ![illustration for AwsComputeOptimizer](../../../aws/Architecture/ManagementGovernance/AwsComputeOptimizer.Local.png) | ![illustration for AwsComputeOptimizerCard](../../../aws/Architecture/ManagementGovernance/AwsComputeOptimizerCard.Local.png) | ![illustration for AwsComputeOptimizerGroup](../../../aws/Architecture/ManagementGovernance/AwsComputeOptimizerGroup.Local.png) |
