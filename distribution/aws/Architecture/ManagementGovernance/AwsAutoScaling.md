...
```text
aws/Architecture/ManagementGovernance/AwsAutoScaling
```

```text
include('aws/Architecture/ManagementGovernance/AwsAutoScaling')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsAutoScaling.png) | ![illustration for AwsAutoScaling](../../../aws/Architecture/ManagementGovernance/AwsAutoScaling.Local.png) | ![illustration for AwsAutoScalingCard](../../../aws/Architecture/ManagementGovernance/AwsAutoScalingCard.Local.png) | ![illustration for AwsAutoScalingGroup](../../../aws/Architecture/ManagementGovernance/AwsAutoScalingGroup.Local.png) |
