...
```text
aws/Architecture/ManagementGovernance/AwsManagementConsole
```

```text
include('aws/Architecture/ManagementGovernance/AwsManagementConsole')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsManagementConsole.png) | ![illustration for AwsManagementConsole](../../../aws/Architecture/ManagementGovernance/AwsManagementConsole.Local.png) | ![illustration for AwsManagementConsoleCard](../../../aws/Architecture/ManagementGovernance/AwsManagementConsoleCard.Local.png) | ![illustration for AwsManagementConsoleGroup](../../../aws/Architecture/ManagementGovernance/AwsManagementConsoleGroup.Local.png) |
