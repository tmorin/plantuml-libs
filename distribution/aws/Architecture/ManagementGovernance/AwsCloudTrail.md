...
```text
aws/Architecture/ManagementGovernance/AwsCloudTrail
```

```text
include('aws/Architecture/ManagementGovernance/AwsCloudTrail')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsCloudTrail.png) | ![illustration for AwsCloudTrail](../../../aws/Architecture/ManagementGovernance/AwsCloudTrail.Local.png) | ![illustration for AwsCloudTrailCard](../../../aws/Architecture/ManagementGovernance/AwsCloudTrailCard.Local.png) | ![illustration for AwsCloudTrailGroup](../../../aws/Architecture/ManagementGovernance/AwsCloudTrailGroup.Local.png) |
