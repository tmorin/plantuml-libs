...
```text
aws/Architecture/ManagementGovernance/AwsAppConfig
```

```text
include('aws/Architecture/ManagementGovernance/AwsAppConfig')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsAppConfig.png) | ![illustration for AwsAppConfig](../../../aws/Architecture/ManagementGovernance/AwsAppConfig.Local.png) | ![illustration for AwsAppConfigCard](../../../aws/Architecture/ManagementGovernance/AwsAppConfigCard.Local.png) | ![illustration for AwsAppConfigGroup](../../../aws/Architecture/ManagementGovernance/AwsAppConfigGroup.Local.png) |
