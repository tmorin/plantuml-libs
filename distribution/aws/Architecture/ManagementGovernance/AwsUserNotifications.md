...
```text
aws/Architecture/ManagementGovernance/AwsUserNotifications
```

```text
include('aws/Architecture/ManagementGovernance/AwsUserNotifications')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsUserNotifications.png) | ![illustration for AwsUserNotifications](../../../aws/Architecture/ManagementGovernance/AwsUserNotifications.Local.png) | ![illustration for AwsUserNotificationsCard](../../../aws/Architecture/ManagementGovernance/AwsUserNotificationsCard.Local.png) | ![illustration for AwsUserNotificationsGroup](../../../aws/Architecture/ManagementGovernance/AwsUserNotificationsGroup.Local.png) |
