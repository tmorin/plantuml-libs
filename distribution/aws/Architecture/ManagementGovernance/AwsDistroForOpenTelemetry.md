...
```text
aws/Architecture/ManagementGovernance/AwsDistroForOpenTelemetry
```

```text
include('aws/Architecture/ManagementGovernance/AwsDistroForOpenTelemetry')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsDistroForOpenTelemetry.png) | ![illustration for AwsDistroForOpenTelemetry](../../../aws/Architecture/ManagementGovernance/AwsDistroForOpenTelemetry.Local.png) | ![illustration for AwsDistroForOpenTelemetryCard](../../../aws/Architecture/ManagementGovernance/AwsDistroForOpenTelemetryCard.Local.png) | ![illustration for AwsDistroForOpenTelemetryGroup](../../../aws/Architecture/ManagementGovernance/AwsDistroForOpenTelemetryGroup.Local.png) |
