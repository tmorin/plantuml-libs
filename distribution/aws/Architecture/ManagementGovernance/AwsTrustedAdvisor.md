...
```text
aws/Architecture/ManagementGovernance/AwsTrustedAdvisor
```

```text
include('aws/Architecture/ManagementGovernance/AwsTrustedAdvisor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsTrustedAdvisor.png) | ![illustration for AwsTrustedAdvisor](../../../aws/Architecture/ManagementGovernance/AwsTrustedAdvisor.Local.png) | ![illustration for AwsTrustedAdvisorCard](../../../aws/Architecture/ManagementGovernance/AwsTrustedAdvisorCard.Local.png) | ![illustration for AwsTrustedAdvisorGroup](../../../aws/Architecture/ManagementGovernance/AwsTrustedAdvisorGroup.Local.png) |
