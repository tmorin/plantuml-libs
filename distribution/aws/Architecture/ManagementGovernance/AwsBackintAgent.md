...
```text
aws/Architecture/ManagementGovernance/AwsBackintAgent
```

```text
include('aws/Architecture/ManagementGovernance/AwsBackintAgent')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ManagementGovernance/AwsBackintAgent.png) | ![illustration for AwsBackintAgent](../../../aws/Architecture/ManagementGovernance/AwsBackintAgent.Local.png) | ![illustration for AwsBackintAgentCard](../../../aws/Architecture/ManagementGovernance/AwsBackintAgentCard.Local.png) | ![illustration for AwsBackintAgentGroup](../../../aws/Architecture/ManagementGovernance/AwsBackintAgentGroup.Local.png) |
