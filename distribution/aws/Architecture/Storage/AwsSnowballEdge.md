...
```text
aws/Architecture/Storage/AwsSnowballEdge
```

```text
include('aws/Architecture/Storage/AwsSnowballEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AwsSnowballEdge.png) | ![illustration for AwsSnowballEdge](../../../aws/Architecture/Storage/AwsSnowballEdge.Local.png) | ![illustration for AwsSnowballEdgeCard](../../../aws/Architecture/Storage/AwsSnowballEdgeCard.Local.png) | ![illustration for AwsSnowballEdgeGroup](../../../aws/Architecture/Storage/AwsSnowballEdgeGroup.Local.png) |
