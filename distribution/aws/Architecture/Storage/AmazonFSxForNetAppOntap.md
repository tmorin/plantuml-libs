...
```text
aws/Architecture/Storage/AmazonFSxForNetAppOntap
```

```text
include('aws/Architecture/Storage/AmazonFSxForNetAppOntap')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AmazonFSxForNetAppOntap.png) | ![illustration for AmazonFSxForNetAppOntap](../../../aws/Architecture/Storage/AmazonFSxForNetAppOntap.Local.png) | ![illustration for AmazonFSxForNetAppOntapCard](../../../aws/Architecture/Storage/AmazonFSxForNetAppOntapCard.Local.png) | ![illustration for AmazonFSxForNetAppOntapGroup](../../../aws/Architecture/Storage/AmazonFSxForNetAppOntapGroup.Local.png) |
