...
```text
aws/Architecture/Storage/AmazonFileCache
```

```text
include('aws/Architecture/Storage/AmazonFileCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AmazonFileCache.png) | ![illustration for AmazonFileCache](../../../aws/Architecture/Storage/AmazonFileCache.Local.png) | ![illustration for AmazonFileCacheCard](../../../aws/Architecture/Storage/AmazonFileCacheCard.Local.png) | ![illustration for AmazonFileCacheGroup](../../../aws/Architecture/Storage/AmazonFileCacheGroup.Local.png) |
