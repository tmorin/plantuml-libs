...
```text
aws/Architecture/Storage/AmazonElasticBlockStore
```

```text
include('aws/Architecture/Storage/AmazonElasticBlockStore')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AmazonElasticBlockStore.png) | ![illustration for AmazonElasticBlockStore](../../../aws/Architecture/Storage/AmazonElasticBlockStore.Local.png) | ![illustration for AmazonElasticBlockStoreCard](../../../aws/Architecture/Storage/AmazonElasticBlockStoreCard.Local.png) | ![illustration for AmazonElasticBlockStoreGroup](../../../aws/Architecture/Storage/AmazonElasticBlockStoreGroup.Local.png) |
