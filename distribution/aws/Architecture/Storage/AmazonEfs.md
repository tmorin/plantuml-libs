...
```text
aws/Architecture/Storage/AmazonEfs
```

```text
include('aws/Architecture/Storage/AmazonEfs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AmazonEfs.png) | ![illustration for AmazonEfs](../../../aws/Architecture/Storage/AmazonEfs.Local.png) | ![illustration for AmazonEfsCard](../../../aws/Architecture/Storage/AmazonEfsCard.Local.png) | ![illustration for AmazonEfsGroup](../../../aws/Architecture/Storage/AmazonEfsGroup.Local.png) |
