...
```text
aws/Architecture/Storage/AmazonS3OnOutposts
```

```text
include('aws/Architecture/Storage/AmazonS3OnOutposts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AmazonS3OnOutposts.png) | ![illustration for AmazonS3OnOutposts](../../../aws/Architecture/Storage/AmazonS3OnOutposts.Local.png) | ![illustration for AmazonS3OnOutpostsCard](../../../aws/Architecture/Storage/AmazonS3OnOutpostsCard.Local.png) | ![illustration for AmazonS3OnOutpostsGroup](../../../aws/Architecture/Storage/AmazonS3OnOutpostsGroup.Local.png) |
