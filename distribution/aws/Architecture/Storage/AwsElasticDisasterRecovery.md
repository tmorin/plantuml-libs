...
```text
aws/Architecture/Storage/AwsElasticDisasterRecovery
```

```text
include('aws/Architecture/Storage/AwsElasticDisasterRecovery')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AwsElasticDisasterRecovery.png) | ![illustration for AwsElasticDisasterRecovery](../../../aws/Architecture/Storage/AwsElasticDisasterRecovery.Local.png) | ![illustration for AwsElasticDisasterRecoveryCard](../../../aws/Architecture/Storage/AwsElasticDisasterRecoveryCard.Local.png) | ![illustration for AwsElasticDisasterRecoveryGroup](../../../aws/Architecture/Storage/AwsElasticDisasterRecoveryGroup.Local.png) |
