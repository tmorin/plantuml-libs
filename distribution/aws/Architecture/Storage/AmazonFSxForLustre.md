...
```text
aws/Architecture/Storage/AmazonFSxForLustre
```

```text
include('aws/Architecture/Storage/AmazonFSxForLustre')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AmazonFSxForLustre.png) | ![illustration for AmazonFSxForLustre](../../../aws/Architecture/Storage/AmazonFSxForLustre.Local.png) | ![illustration for AmazonFSxForLustreCard](../../../aws/Architecture/Storage/AmazonFSxForLustreCard.Local.png) | ![illustration for AmazonFSxForLustreGroup](../../../aws/Architecture/Storage/AmazonFSxForLustreGroup.Local.png) |
