...
```text
aws/Architecture/Storage/AmazonFSx
```

```text
include('aws/Architecture/Storage/AmazonFSx')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AmazonFSx.png) | ![illustration for AmazonFSx](../../../aws/Architecture/Storage/AmazonFSx.Local.png) | ![illustration for AmazonFSxCard](../../../aws/Architecture/Storage/AmazonFSxCard.Local.png) | ![illustration for AmazonFSxGroup](../../../aws/Architecture/Storage/AmazonFSxGroup.Local.png) |
