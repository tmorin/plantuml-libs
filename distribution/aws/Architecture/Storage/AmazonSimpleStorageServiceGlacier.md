...
```text
aws/Architecture/Storage/AmazonSimpleStorageServiceGlacier
```

```text
include('aws/Architecture/Storage/AmazonSimpleStorageServiceGlacier')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AmazonSimpleStorageServiceGlacier.png) | ![illustration for AmazonSimpleStorageServiceGlacier](../../../aws/Architecture/Storage/AmazonSimpleStorageServiceGlacier.Local.png) | ![illustration for AmazonSimpleStorageServiceGlacierCard](../../../aws/Architecture/Storage/AmazonSimpleStorageServiceGlacierCard.Local.png) | ![illustration for AmazonSimpleStorageServiceGlacierGroup](../../../aws/Architecture/Storage/AmazonSimpleStorageServiceGlacierGroup.Local.png) |
