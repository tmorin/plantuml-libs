...
```text
aws/Architecture/Storage/AmazonFSxForWfs
```

```text
include('aws/Architecture/Storage/AmazonFSxForWfs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AmazonFSxForWfs.png) | ![illustration for AmazonFSxForWfs](../../../aws/Architecture/Storage/AmazonFSxForWfs.Local.png) | ![illustration for AmazonFSxForWfsCard](../../../aws/Architecture/Storage/AmazonFSxForWfsCard.Local.png) | ![illustration for AmazonFSxForWfsGroup](../../../aws/Architecture/Storage/AmazonFSxForWfsGroup.Local.png) |
