...
```text
aws/Architecture/Storage/AwsStorageGateway
```

```text
include('aws/Architecture/Storage/AwsStorageGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Storage/AwsStorageGateway.png) | ![illustration for AwsStorageGateway](../../../aws/Architecture/Storage/AwsStorageGateway.Local.png) | ![illustration for AwsStorageGatewayCard](../../../aws/Architecture/Storage/AwsStorageGatewayCard.Local.png) | ![illustration for AwsStorageGatewayGroup](../../../aws/Architecture/Storage/AwsStorageGatewayGroup.Local.png) |
