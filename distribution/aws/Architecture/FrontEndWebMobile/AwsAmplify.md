...
```text
aws/Architecture/FrontEndWebMobile/AwsAmplify
```

```text
include('aws/Architecture/FrontEndWebMobile/AwsAmplify')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/FrontEndWebMobile/AwsAmplify.png) | ![illustration for AwsAmplify](../../../aws/Architecture/FrontEndWebMobile/AwsAmplify.Local.png) | ![illustration for AwsAmplifyCard](../../../aws/Architecture/FrontEndWebMobile/AwsAmplifyCard.Local.png) | ![illustration for AwsAmplifyGroup](../../../aws/Architecture/FrontEndWebMobile/AwsAmplifyGroup.Local.png) |
