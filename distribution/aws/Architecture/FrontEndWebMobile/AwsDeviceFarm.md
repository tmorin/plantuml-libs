...
```text
aws/Architecture/FrontEndWebMobile/AwsDeviceFarm
```

```text
include('aws/Architecture/FrontEndWebMobile/AwsDeviceFarm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/FrontEndWebMobile/AwsDeviceFarm.png) | ![illustration for AwsDeviceFarm](../../../aws/Architecture/FrontEndWebMobile/AwsDeviceFarm.Local.png) | ![illustration for AwsDeviceFarmCard](../../../aws/Architecture/FrontEndWebMobile/AwsDeviceFarmCard.Local.png) | ![illustration for AwsDeviceFarmGroup](../../../aws/Architecture/FrontEndWebMobile/AwsDeviceFarmGroup.Local.png) |
