...
```text
aws/Architecture/Satellite/AwsGroundStation
```

```text
include('aws/Architecture/Satellite/AwsGroundStation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Satellite/AwsGroundStation.png) | ![illustration for AwsGroundStation](../../../aws/Architecture/Satellite/AwsGroundStation.Local.png) | ![illustration for AwsGroundStationCard](../../../aws/Architecture/Satellite/AwsGroundStationCard.Local.png) | ![illustration for AwsGroundStationGroup](../../../aws/Architecture/Satellite/AwsGroundStationGroup.Local.png) |
