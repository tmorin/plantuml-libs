...
```text
aws/Architecture/InternetOfThings/AwsIoTButton
```

```text
include('aws/Architecture/InternetOfThings/AwsIoTButton')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/InternetOfThings/AwsIoTButton.png) | ![illustration for AwsIoTButton](../../../aws/Architecture/InternetOfThings/AwsIoTButton.Local.png) | ![illustration for AwsIoTButtonCard](../../../aws/Architecture/InternetOfThings/AwsIoTButtonCard.Local.png) | ![illustration for AwsIoTButtonGroup](../../../aws/Architecture/InternetOfThings/AwsIoTButtonGroup.Local.png) |
