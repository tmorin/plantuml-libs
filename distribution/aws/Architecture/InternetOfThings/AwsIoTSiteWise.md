...
```text
aws/Architecture/InternetOfThings/AwsIoTSiteWise
```

```text
include('aws/Architecture/InternetOfThings/AwsIoTSiteWise')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/InternetOfThings/AwsIoTSiteWise.png) | ![illustration for AwsIoTSiteWise](../../../aws/Architecture/InternetOfThings/AwsIoTSiteWise.Local.png) | ![illustration for AwsIoTSiteWiseCard](../../../aws/Architecture/InternetOfThings/AwsIoTSiteWiseCard.Local.png) | ![illustration for AwsIoTSiteWiseGroup](../../../aws/Architecture/InternetOfThings/AwsIoTSiteWiseGroup.Local.png) |
