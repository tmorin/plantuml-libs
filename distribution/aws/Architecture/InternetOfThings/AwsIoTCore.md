...
```text
aws/Architecture/InternetOfThings/AwsIoTCore
```

```text
include('aws/Architecture/InternetOfThings/AwsIoTCore')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/InternetOfThings/AwsIoTCore.png) | ![illustration for AwsIoTCore](../../../aws/Architecture/InternetOfThings/AwsIoTCore.Local.png) | ![illustration for AwsIoTCoreCard](../../../aws/Architecture/InternetOfThings/AwsIoTCoreCard.Local.png) | ![illustration for AwsIoTCoreGroup](../../../aws/Architecture/InternetOfThings/AwsIoTCoreGroup.Local.png) |
