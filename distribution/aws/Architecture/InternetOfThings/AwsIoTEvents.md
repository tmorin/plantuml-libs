...
```text
aws/Architecture/InternetOfThings/AwsIoTEvents
```

```text
include('aws/Architecture/InternetOfThings/AwsIoTEvents')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/InternetOfThings/AwsIoTEvents.png) | ![illustration for AwsIoTEvents](../../../aws/Architecture/InternetOfThings/AwsIoTEvents.Local.png) | ![illustration for AwsIoTEventsCard](../../../aws/Architecture/InternetOfThings/AwsIoTEventsCard.Local.png) | ![illustration for AwsIoTEventsGroup](../../../aws/Architecture/InternetOfThings/AwsIoTEventsGroup.Local.png) |
