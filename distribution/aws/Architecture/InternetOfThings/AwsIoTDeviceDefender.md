...
```text
aws/Architecture/InternetOfThings/AwsIoTDeviceDefender
```

```text
include('aws/Architecture/InternetOfThings/AwsIoTDeviceDefender')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/InternetOfThings/AwsIoTDeviceDefender.png) | ![illustration for AwsIoTDeviceDefender](../../../aws/Architecture/InternetOfThings/AwsIoTDeviceDefender.Local.png) | ![illustration for AwsIoTDeviceDefenderCard](../../../aws/Architecture/InternetOfThings/AwsIoTDeviceDefenderCard.Local.png) | ![illustration for AwsIoTDeviceDefenderGroup](../../../aws/Architecture/InternetOfThings/AwsIoTDeviceDefenderGroup.Local.png) |
