...
```text
aws/Architecture/InternetOfThings/AwsIoTFleetWise
```

```text
include('aws/Architecture/InternetOfThings/AwsIoTFleetWise')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/InternetOfThings/AwsIoTFleetWise.png) | ![illustration for AwsIoTFleetWise](../../../aws/Architecture/InternetOfThings/AwsIoTFleetWise.Local.png) | ![illustration for AwsIoTFleetWiseCard](../../../aws/Architecture/InternetOfThings/AwsIoTFleetWiseCard.Local.png) | ![illustration for AwsIoTFleetWiseGroup](../../../aws/Architecture/InternetOfThings/AwsIoTFleetWiseGroup.Local.png) |
