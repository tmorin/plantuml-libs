...
```text
aws/Architecture/InternetOfThings/AwsIoTExpressLink
```

```text
include('aws/Architecture/InternetOfThings/AwsIoTExpressLink')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/InternetOfThings/AwsIoTExpressLink.png) | ![illustration for AwsIoTExpressLink](../../../aws/Architecture/InternetOfThings/AwsIoTExpressLink.Local.png) | ![illustration for AwsIoTExpressLinkCard](../../../aws/Architecture/InternetOfThings/AwsIoTExpressLinkCard.Local.png) | ![illustration for AwsIoTExpressLinkGroup](../../../aws/Architecture/InternetOfThings/AwsIoTExpressLinkGroup.Local.png) |
