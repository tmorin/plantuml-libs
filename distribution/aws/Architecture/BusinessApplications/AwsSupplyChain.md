...
```text
aws/Architecture/BusinessApplications/AwsSupplyChain
```

```text
include('aws/Architecture/BusinessApplications/AwsSupplyChain')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/BusinessApplications/AwsSupplyChain.png) | ![illustration for AwsSupplyChain](../../../aws/Architecture/BusinessApplications/AwsSupplyChain.Local.png) | ![illustration for AwsSupplyChainCard](../../../aws/Architecture/BusinessApplications/AwsSupplyChainCard.Local.png) | ![illustration for AwsSupplyChainGroup](../../../aws/Architecture/BusinessApplications/AwsSupplyChainGroup.Local.png) |
