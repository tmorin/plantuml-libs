...
```text
aws/Architecture/BusinessApplications/AmazonPinpointApIs
```

```text
include('aws/Architecture/BusinessApplications/AmazonPinpointApIs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/BusinessApplications/AmazonPinpointApIs.png) | ![illustration for AmazonPinpointApIs](../../../aws/Architecture/BusinessApplications/AmazonPinpointApIs.Local.png) | ![illustration for AmazonPinpointApIsCard](../../../aws/Architecture/BusinessApplications/AmazonPinpointApIsCard.Local.png) | ![illustration for AmazonPinpointApIsGroup](../../../aws/Architecture/BusinessApplications/AmazonPinpointApIsGroup.Local.png) |
