...
```text
aws/Architecture/BusinessApplications/AwsEndUserMessaging
```

```text
include('aws/Architecture/BusinessApplications/AwsEndUserMessaging')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/BusinessApplications/AwsEndUserMessaging.png) | ![illustration for AwsEndUserMessaging](../../../aws/Architecture/BusinessApplications/AwsEndUserMessaging.Local.png) | ![illustration for AwsEndUserMessagingCard](../../../aws/Architecture/BusinessApplications/AwsEndUserMessagingCard.Local.png) | ![illustration for AwsEndUserMessagingGroup](../../../aws/Architecture/BusinessApplications/AwsEndUserMessagingGroup.Local.png) |
