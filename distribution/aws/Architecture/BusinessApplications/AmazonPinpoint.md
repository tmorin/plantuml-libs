...
```text
aws/Architecture/BusinessApplications/AmazonPinpoint
```

```text
include('aws/Architecture/BusinessApplications/AmazonPinpoint')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/BusinessApplications/AmazonPinpoint.png) | ![illustration for AmazonPinpoint](../../../aws/Architecture/BusinessApplications/AmazonPinpoint.Local.png) | ![illustration for AmazonPinpointCard](../../../aws/Architecture/BusinessApplications/AmazonPinpointCard.Local.png) | ![illustration for AmazonPinpointGroup](../../../aws/Architecture/BusinessApplications/AmazonPinpointGroup.Local.png) |
