...
```text
aws/Architecture/BusinessApplications/AmazonWorkMail
```

```text
include('aws/Architecture/BusinessApplications/AmazonWorkMail')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/BusinessApplications/AmazonWorkMail.png) | ![illustration for AmazonWorkMail](../../../aws/Architecture/BusinessApplications/AmazonWorkMail.Local.png) | ![illustration for AmazonWorkMailCard](../../../aws/Architecture/BusinessApplications/AmazonWorkMailCard.Local.png) | ![illustration for AmazonWorkMailGroup](../../../aws/Architecture/BusinessApplications/AmazonWorkMailGroup.Local.png) |
