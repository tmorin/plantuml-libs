...
```text
aws/Architecture/BusinessApplications/AmazonWorkDocsSdk
```

```text
include('aws/Architecture/BusinessApplications/AmazonWorkDocsSdk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/BusinessApplications/AmazonWorkDocsSdk.png) | ![illustration for AmazonWorkDocsSdk](../../../aws/Architecture/BusinessApplications/AmazonWorkDocsSdk.Local.png) | ![illustration for AmazonWorkDocsSdkCard](../../../aws/Architecture/BusinessApplications/AmazonWorkDocsSdkCard.Local.png) | ![illustration for AmazonWorkDocsSdkGroup](../../../aws/Architecture/BusinessApplications/AmazonWorkDocsSdkGroup.Local.png) |
