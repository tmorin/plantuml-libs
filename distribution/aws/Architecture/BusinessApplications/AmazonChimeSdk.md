...
```text
aws/Architecture/BusinessApplications/AmazonChimeSdk
```

```text
include('aws/Architecture/BusinessApplications/AmazonChimeSdk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/BusinessApplications/AmazonChimeSdk.png) | ![illustration for AmazonChimeSdk](../../../aws/Architecture/BusinessApplications/AmazonChimeSdk.Local.png) | ![illustration for AmazonChimeSdkCard](../../../aws/Architecture/BusinessApplications/AmazonChimeSdkCard.Local.png) | ![illustration for AmazonChimeSdkGroup](../../../aws/Architecture/BusinessApplications/AmazonChimeSdkGroup.Local.png) |
