...
```text
aws/Architecture/AppIntegration/AmazonSimpleQueueService
```

```text
include('aws/Architecture/AppIntegration/AmazonSimpleQueueService')
```
