...
```text
aws/Architecture/AppIntegration/AmazonSimpleNotificationService
```

```text
include('aws/Architecture/AppIntegration/AmazonSimpleNotificationService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/AppIntegration/AmazonSimpleNotificationService.png) | ![illustration for AmazonSimpleNotificationService](../../../aws/Architecture/AppIntegration/AmazonSimpleNotificationService.Local.png) | ![illustration for AmazonSimpleNotificationServiceCard](../../../aws/Architecture/AppIntegration/AmazonSimpleNotificationServiceCard.Local.png) | ![illustration for AmazonSimpleNotificationServiceGroup](../../../aws/Architecture/AppIntegration/AmazonSimpleNotificationServiceGroup.Local.png) |
