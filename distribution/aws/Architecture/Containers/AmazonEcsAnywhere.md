...
```text
aws/Architecture/Containers/AmazonEcsAnywhere
```

```text
include('aws/Architecture/Containers/AmazonEcsAnywhere')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Containers/AmazonEcsAnywhere.png) | ![illustration for AmazonEcsAnywhere](../../../aws/Architecture/Containers/AmazonEcsAnywhere.Local.png) | ![illustration for AmazonEcsAnywhereCard](../../../aws/Architecture/Containers/AmazonEcsAnywhereCard.Local.png) | ![illustration for AmazonEcsAnywhereGroup](../../../aws/Architecture/Containers/AmazonEcsAnywhereGroup.Local.png) |
