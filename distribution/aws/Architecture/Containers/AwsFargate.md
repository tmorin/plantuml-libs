...
```text
aws/Architecture/Containers/AwsFargate
```

```text
include('aws/Architecture/Containers/AwsFargate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Containers/AwsFargate.png) | ![illustration for AwsFargate](../../../aws/Architecture/Containers/AwsFargate.Local.png) | ![illustration for AwsFargateCard](../../../aws/Architecture/Containers/AwsFargateCard.Local.png) | ![illustration for AwsFargateGroup](../../../aws/Architecture/Containers/AwsFargateGroup.Local.png) |
