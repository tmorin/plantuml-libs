...
```text
aws/Architecture/Containers/AmazonElasticKubernetesService
```

```text
include('aws/Architecture/Containers/AmazonElasticKubernetesService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Containers/AmazonElasticKubernetesService.png) | ![illustration for AmazonElasticKubernetesService](../../../aws/Architecture/Containers/AmazonElasticKubernetesService.Local.png) | ![illustration for AmazonElasticKubernetesServiceCard](../../../aws/Architecture/Containers/AmazonElasticKubernetesServiceCard.Local.png) | ![illustration for AmazonElasticKubernetesServiceGroup](../../../aws/Architecture/Containers/AmazonElasticKubernetesServiceGroup.Local.png) |
