...
```text
aws/Architecture/Containers/AmazonElasticContainerRegistry
```

```text
include('aws/Architecture/Containers/AmazonElasticContainerRegistry')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Containers/AmazonElasticContainerRegistry.png) | ![illustration for AmazonElasticContainerRegistry](../../../aws/Architecture/Containers/AmazonElasticContainerRegistry.Local.png) | ![illustration for AmazonElasticContainerRegistryCard](../../../aws/Architecture/Containers/AmazonElasticContainerRegistryCard.Local.png) | ![illustration for AmazonElasticContainerRegistryGroup](../../../aws/Architecture/Containers/AmazonElasticContainerRegistryGroup.Local.png) |
