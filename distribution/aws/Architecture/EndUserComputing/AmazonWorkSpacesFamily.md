...
```text
aws/Architecture/EndUserComputing/AmazonWorkSpacesFamily
```

```text
include('aws/Architecture/EndUserComputing/AmazonWorkSpacesFamily')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/EndUserComputing/AmazonWorkSpacesFamily.png) | ![illustration for AmazonWorkSpacesFamily](../../../aws/Architecture/EndUserComputing/AmazonWorkSpacesFamily.Local.png) | ![illustration for AmazonWorkSpacesFamilyCard](../../../aws/Architecture/EndUserComputing/AmazonWorkSpacesFamilyCard.Local.png) | ![illustration for AmazonWorkSpacesFamilyGroup](../../../aws/Architecture/EndUserComputing/AmazonWorkSpacesFamilyGroup.Local.png) |
