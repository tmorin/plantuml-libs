...
```text
aws/Architecture/EndUserComputing/AmazonAppStream2
```

```text
include('aws/Architecture/EndUserComputing/AmazonAppStream2')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/EndUserComputing/AmazonAppStream2.png) | ![illustration for AmazonAppStream2](../../../aws/Architecture/EndUserComputing/AmazonAppStream2.Local.png) | ![illustration for AmazonAppStream2Card](../../../aws/Architecture/EndUserComputing/AmazonAppStream2Card.Local.png) | ![illustration for AmazonAppStream2Group](../../../aws/Architecture/EndUserComputing/AmazonAppStream2Group.Local.png) |
