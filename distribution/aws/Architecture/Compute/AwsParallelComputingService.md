...
```text
aws/Architecture/Compute/AwsParallelComputingService
```

```text
include('aws/Architecture/Compute/AwsParallelComputingService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AwsParallelComputingService.png) | ![illustration for AwsParallelComputingService](../../../aws/Architecture/Compute/AwsParallelComputingService.Local.png) | ![illustration for AwsParallelComputingServiceCard](../../../aws/Architecture/Compute/AwsParallelComputingServiceCard.Local.png) | ![illustration for AwsParallelComputingServiceGroup](../../../aws/Architecture/Compute/AwsParallelComputingServiceGroup.Local.png) |
