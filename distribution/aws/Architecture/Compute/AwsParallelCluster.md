...
```text
aws/Architecture/Compute/AwsParallelCluster
```

```text
include('aws/Architecture/Compute/AwsParallelCluster')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AwsParallelCluster.png) | ![illustration for AwsParallelCluster](../../../aws/Architecture/Compute/AwsParallelCluster.Local.png) | ![illustration for AwsParallelClusterCard](../../../aws/Architecture/Compute/AwsParallelClusterCard.Local.png) | ![illustration for AwsParallelClusterGroup](../../../aws/Architecture/Compute/AwsParallelClusterGroup.Local.png) |
