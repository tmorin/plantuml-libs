...
```text
aws/Architecture/Compute/AmazonElasticVMwareService
```

```text
include('aws/Architecture/Compute/AmazonElasticVMwareService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AmazonElasticVMwareService.png) | ![illustration for AmazonElasticVMwareService](../../../aws/Architecture/Compute/AmazonElasticVMwareService.Local.png) | ![illustration for AmazonElasticVMwareServiceCard](../../../aws/Architecture/Compute/AmazonElasticVMwareServiceCard.Local.png) | ![illustration for AmazonElasticVMwareServiceGroup](../../../aws/Architecture/Compute/AmazonElasticVMwareServiceGroup.Local.png) |
