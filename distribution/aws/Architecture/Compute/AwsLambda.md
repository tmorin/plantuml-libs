...
```text
aws/Architecture/Compute/AwsLambda
```

```text
include('aws/Architecture/Compute/AwsLambda')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AwsLambda.png) | ![illustration for AwsLambda](../../../aws/Architecture/Compute/AwsLambda.Local.png) | ![illustration for AwsLambdaCard](../../../aws/Architecture/Compute/AwsLambdaCard.Local.png) | ![illustration for AwsLambdaGroup](../../../aws/Architecture/Compute/AwsLambdaGroup.Local.png) |
