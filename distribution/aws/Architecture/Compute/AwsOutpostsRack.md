...
```text
aws/Architecture/Compute/AwsOutpostsRack
```

```text
include('aws/Architecture/Compute/AwsOutpostsRack')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AwsOutpostsRack.png) | ![illustration for AwsOutpostsRack](../../../aws/Architecture/Compute/AwsOutpostsRack.Local.png) | ![illustration for AwsOutpostsRackCard](../../../aws/Architecture/Compute/AwsOutpostsRackCard.Local.png) | ![illustration for AwsOutpostsRackGroup](../../../aws/Architecture/Compute/AwsOutpostsRackGroup.Local.png) |
