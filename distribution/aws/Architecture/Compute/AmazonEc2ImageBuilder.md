...
```text
aws/Architecture/Compute/AmazonEc2ImageBuilder
```

```text
include('aws/Architecture/Compute/AmazonEc2ImageBuilder')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AmazonEc2ImageBuilder.png) | ![illustration for AmazonEc2ImageBuilder](../../../aws/Architecture/Compute/AmazonEc2ImageBuilder.Local.png) | ![illustration for AmazonEc2ImageBuilderCard](../../../aws/Architecture/Compute/AmazonEc2ImageBuilderCard.Local.png) | ![illustration for AmazonEc2ImageBuilderGroup](../../../aws/Architecture/Compute/AmazonEc2ImageBuilderGroup.Local.png) |
