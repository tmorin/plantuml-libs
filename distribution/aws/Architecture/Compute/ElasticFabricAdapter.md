...
```text
aws/Architecture/Compute/ElasticFabricAdapter
```

```text
include('aws/Architecture/Compute/ElasticFabricAdapter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/ElasticFabricAdapter.png) | ![illustration for ElasticFabricAdapter](../../../aws/Architecture/Compute/ElasticFabricAdapter.Local.png) | ![illustration for ElasticFabricAdapterCard](../../../aws/Architecture/Compute/ElasticFabricAdapterCard.Local.png) | ![illustration for ElasticFabricAdapterGroup](../../../aws/Architecture/Compute/ElasticFabricAdapterGroup.Local.png) |
