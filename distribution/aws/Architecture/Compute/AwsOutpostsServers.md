...
```text
aws/Architecture/Compute/AwsOutpostsServers
```

```text
include('aws/Architecture/Compute/AwsOutpostsServers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AwsOutpostsServers.png) | ![illustration for AwsOutpostsServers](../../../aws/Architecture/Compute/AwsOutpostsServers.Local.png) | ![illustration for AwsOutpostsServersCard](../../../aws/Architecture/Compute/AwsOutpostsServersCard.Local.png) | ![illustration for AwsOutpostsServersGroup](../../../aws/Architecture/Compute/AwsOutpostsServersGroup.Local.png) |
