...
```text
aws/Architecture/Compute/AwsOutpostsFamily
```

```text
include('aws/Architecture/Compute/AwsOutpostsFamily')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AwsOutpostsFamily.png) | ![illustration for AwsOutpostsFamily](../../../aws/Architecture/Compute/AwsOutpostsFamily.Local.png) | ![illustration for AwsOutpostsFamilyCard](../../../aws/Architecture/Compute/AwsOutpostsFamilyCard.Local.png) | ![illustration for AwsOutpostsFamilyGroup](../../../aws/Architecture/Compute/AwsOutpostsFamilyGroup.Local.png) |
