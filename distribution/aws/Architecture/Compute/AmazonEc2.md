...
```text
aws/Architecture/Compute/AmazonEc2
```

```text
include('aws/Architecture/Compute/AmazonEc2')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AmazonEc2.png) | ![illustration for AmazonEc2](../../../aws/Architecture/Compute/AmazonEc2.Local.png) | ![illustration for AmazonEc2Card](../../../aws/Architecture/Compute/AmazonEc2Card.Local.png) | ![illustration for AmazonEc2Group](../../../aws/Architecture/Compute/AmazonEc2Group.Local.png) |
