...
```text
aws/Architecture/Compute/AwsNitroEnclaves
```

```text
include('aws/Architecture/Compute/AwsNitroEnclaves')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AwsNitroEnclaves.png) | ![illustration for AwsNitroEnclaves](../../../aws/Architecture/Compute/AwsNitroEnclaves.Local.png) | ![illustration for AwsNitroEnclavesCard](../../../aws/Architecture/Compute/AwsNitroEnclavesCard.Local.png) | ![illustration for AwsNitroEnclavesGroup](../../../aws/Architecture/Compute/AwsNitroEnclavesGroup.Local.png) |
