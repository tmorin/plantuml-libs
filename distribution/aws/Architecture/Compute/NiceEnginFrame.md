...
```text
aws/Architecture/Compute/NiceEnginFrame
```

```text
include('aws/Architecture/Compute/NiceEnginFrame')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/NiceEnginFrame.png) | ![illustration for NiceEnginFrame](../../../aws/Architecture/Compute/NiceEnginFrame.Local.png) | ![illustration for NiceEnginFrameCard](../../../aws/Architecture/Compute/NiceEnginFrameCard.Local.png) | ![illustration for NiceEnginFrameGroup](../../../aws/Architecture/Compute/NiceEnginFrameGroup.Local.png) |
