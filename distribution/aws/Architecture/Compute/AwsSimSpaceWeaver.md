...
```text
aws/Architecture/Compute/AwsSimSpaceWeaver
```

```text
include('aws/Architecture/Compute/AwsSimSpaceWeaver')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AwsSimSpaceWeaver.png) | ![illustration for AwsSimSpaceWeaver](../../../aws/Architecture/Compute/AwsSimSpaceWeaver.Local.png) | ![illustration for AwsSimSpaceWeaverCard](../../../aws/Architecture/Compute/AwsSimSpaceWeaverCard.Local.png) | ![illustration for AwsSimSpaceWeaverGroup](../../../aws/Architecture/Compute/AwsSimSpaceWeaverGroup.Local.png) |
