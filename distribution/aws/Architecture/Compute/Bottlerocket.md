...
```text
aws/Architecture/Compute/Bottlerocket
```

```text
include('aws/Architecture/Compute/Bottlerocket')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/Bottlerocket.png) | ![illustration for Bottlerocket](../../../aws/Architecture/Compute/Bottlerocket.Local.png) | ![illustration for BottlerocketCard](../../../aws/Architecture/Compute/BottlerocketCard.Local.png) | ![illustration for BottlerocketGroup](../../../aws/Architecture/Compute/BottlerocketGroup.Local.png) |
