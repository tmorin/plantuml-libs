...
```text
aws/Architecture/Compute/AwsServerlessApplicationRepository
```

```text
include('aws/Architecture/Compute/AwsServerlessApplicationRepository')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AwsServerlessApplicationRepository.png) | ![illustration for AwsServerlessApplicationRepository](../../../aws/Architecture/Compute/AwsServerlessApplicationRepository.Local.png) | ![illustration for AwsServerlessApplicationRepositoryCard](../../../aws/Architecture/Compute/AwsServerlessApplicationRepositoryCard.Local.png) | ![illustration for AwsServerlessApplicationRepositoryGroup](../../../aws/Architecture/Compute/AwsServerlessApplicationRepositoryGroup.Local.png) |
