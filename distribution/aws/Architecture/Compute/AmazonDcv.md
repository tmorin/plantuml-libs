...
```text
aws/Architecture/Compute/AmazonDcv
```

```text
include('aws/Architecture/Compute/AmazonDcv')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AmazonDcv.png) | ![illustration for AmazonDcv](../../../aws/Architecture/Compute/AmazonDcv.Local.png) | ![illustration for AmazonDcvCard](../../../aws/Architecture/Compute/AmazonDcvCard.Local.png) | ![illustration for AmazonDcvGroup](../../../aws/Architecture/Compute/AmazonDcvGroup.Local.png) |
