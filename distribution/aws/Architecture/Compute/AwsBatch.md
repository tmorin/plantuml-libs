...
```text
aws/Architecture/Compute/AwsBatch
```

```text
include('aws/Architecture/Compute/AwsBatch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AwsBatch.png) | ![illustration for AwsBatch](../../../aws/Architecture/Compute/AwsBatch.Local.png) | ![illustration for AwsBatchCard](../../../aws/Architecture/Compute/AwsBatchCard.Local.png) | ![illustration for AwsBatchGroup](../../../aws/Architecture/Compute/AwsBatchGroup.Local.png) |
