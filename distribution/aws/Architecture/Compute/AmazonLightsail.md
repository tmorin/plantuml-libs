...
```text
aws/Architecture/Compute/AmazonLightsail
```

```text
include('aws/Architecture/Compute/AmazonLightsail')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AmazonLightsail.png) | ![illustration for AmazonLightsail](../../../aws/Architecture/Compute/AmazonLightsail.Local.png) | ![illustration for AmazonLightsailCard](../../../aws/Architecture/Compute/AmazonLightsailCard.Local.png) | ![illustration for AmazonLightsailGroup](../../../aws/Architecture/Compute/AmazonLightsailGroup.Local.png) |
