...
```text
aws/Architecture/Compute/AmazonLightsailForResearch
```

```text
include('aws/Architecture/Compute/AmazonLightsailForResearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AmazonLightsailForResearch.png) | ![illustration for AmazonLightsailForResearch](../../../aws/Architecture/Compute/AmazonLightsailForResearch.Local.png) | ![illustration for AmazonLightsailForResearchCard](../../../aws/Architecture/Compute/AmazonLightsailForResearchCard.Local.png) | ![illustration for AmazonLightsailForResearchGroup](../../../aws/Architecture/Compute/AmazonLightsailForResearchGroup.Local.png) |
