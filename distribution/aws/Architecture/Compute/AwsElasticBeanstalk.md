...
```text
aws/Architecture/Compute/AwsElasticBeanstalk
```

```text
include('aws/Architecture/Compute/AwsElasticBeanstalk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Compute/AwsElasticBeanstalk.png) | ![illustration for AwsElasticBeanstalk](../../../aws/Architecture/Compute/AwsElasticBeanstalk.Local.png) | ![illustration for AwsElasticBeanstalkCard](../../../aws/Architecture/Compute/AwsElasticBeanstalkCard.Local.png) | ![illustration for AwsElasticBeanstalkGroup](../../../aws/Architecture/Compute/AwsElasticBeanstalkGroup.Local.png) |
