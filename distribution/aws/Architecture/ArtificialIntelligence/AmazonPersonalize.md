...
```text
aws/Architecture/ArtificialIntelligence/AmazonPersonalize
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonPersonalize')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonPersonalize.png) | ![illustration for AmazonPersonalize](../../../aws/Architecture/ArtificialIntelligence/AmazonPersonalize.Local.png) | ![illustration for AmazonPersonalizeCard](../../../aws/Architecture/ArtificialIntelligence/AmazonPersonalizeCard.Local.png) | ![illustration for AmazonPersonalizeGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonPersonalizeGroup.Local.png) |
