...
```text
aws/Architecture/ArtificialIntelligence/AwsHealthImaging
```

```text
include('aws/Architecture/ArtificialIntelligence/AwsHealthImaging')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AwsHealthImaging.png) | ![illustration for AwsHealthImaging](../../../aws/Architecture/ArtificialIntelligence/AwsHealthImaging.Local.png) | ![illustration for AwsHealthImagingCard](../../../aws/Architecture/ArtificialIntelligence/AwsHealthImagingCard.Local.png) | ![illustration for AwsHealthImagingGroup](../../../aws/Architecture/ArtificialIntelligence/AwsHealthImagingGroup.Local.png) |
