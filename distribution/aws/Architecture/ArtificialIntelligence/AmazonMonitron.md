...
```text
aws/Architecture/ArtificialIntelligence/AmazonMonitron
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonMonitron')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonMonitron.png) | ![illustration for AmazonMonitron](../../../aws/Architecture/ArtificialIntelligence/AmazonMonitron.Local.png) | ![illustration for AmazonMonitronCard](../../../aws/Architecture/ArtificialIntelligence/AmazonMonitronCard.Local.png) | ![illustration for AmazonMonitronGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonMonitronGroup.Local.png) |
