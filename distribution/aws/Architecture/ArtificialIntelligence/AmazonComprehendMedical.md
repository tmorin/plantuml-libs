...
```text
aws/Architecture/ArtificialIntelligence/AmazonComprehendMedical
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonComprehendMedical')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonComprehendMedical.png) | ![illustration for AmazonComprehendMedical](../../../aws/Architecture/ArtificialIntelligence/AmazonComprehendMedical.Local.png) | ![illustration for AmazonComprehendMedicalCard](../../../aws/Architecture/ArtificialIntelligence/AmazonComprehendMedicalCard.Local.png) | ![illustration for AmazonComprehendMedicalGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonComprehendMedicalGroup.Local.png) |
