...
```text
aws/Architecture/ArtificialIntelligence/AwsDeepLearningContainers
```

```text
include('aws/Architecture/ArtificialIntelligence/AwsDeepLearningContainers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AwsDeepLearningContainers.png) | ![illustration for AwsDeepLearningContainers](../../../aws/Architecture/ArtificialIntelligence/AwsDeepLearningContainers.Local.png) | ![illustration for AwsDeepLearningContainersCard](../../../aws/Architecture/ArtificialIntelligence/AwsDeepLearningContainersCard.Local.png) | ![illustration for AwsDeepLearningContainersGroup](../../../aws/Architecture/ArtificialIntelligence/AwsDeepLearningContainersGroup.Local.png) |
