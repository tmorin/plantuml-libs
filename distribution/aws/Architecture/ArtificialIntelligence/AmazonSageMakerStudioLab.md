...
```text
aws/Architecture/ArtificialIntelligence/AmazonSageMakerStudioLab
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonSageMakerStudioLab')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerStudioLab.png) | ![illustration for AmazonSageMakerStudioLab](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerStudioLab.Local.png) | ![illustration for AmazonSageMakerStudioLabCard](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerStudioLabCard.Local.png) | ![illustration for AmazonSageMakerStudioLabGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerStudioLabGroup.Local.png) |
