...
```text
aws/Architecture/ArtificialIntelligence/AmazonKendra
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonKendra')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonKendra.png) | ![illustration for AmazonKendra](../../../aws/Architecture/ArtificialIntelligence/AmazonKendra.Local.png) | ![illustration for AmazonKendraCard](../../../aws/Architecture/ArtificialIntelligence/AmazonKendraCard.Local.png) | ![illustration for AmazonKendraGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonKendraGroup.Local.png) |
