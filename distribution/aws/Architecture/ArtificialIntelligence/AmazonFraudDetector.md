...
```text
aws/Architecture/ArtificialIntelligence/AmazonFraudDetector
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonFraudDetector')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonFraudDetector.png) | ![illustration for AmazonFraudDetector](../../../aws/Architecture/ArtificialIntelligence/AmazonFraudDetector.Local.png) | ![illustration for AmazonFraudDetectorCard](../../../aws/Architecture/ArtificialIntelligence/AmazonFraudDetectorCard.Local.png) | ![illustration for AmazonFraudDetectorGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonFraudDetectorGroup.Local.png) |
