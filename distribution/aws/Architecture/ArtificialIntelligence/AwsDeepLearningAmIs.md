...
```text
aws/Architecture/ArtificialIntelligence/AwsDeepLearningAmIs
```

```text
include('aws/Architecture/ArtificialIntelligence/AwsDeepLearningAmIs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AwsDeepLearningAmIs.png) | ![illustration for AwsDeepLearningAmIs](../../../aws/Architecture/ArtificialIntelligence/AwsDeepLearningAmIs.Local.png) | ![illustration for AwsDeepLearningAmIsCard](../../../aws/Architecture/ArtificialIntelligence/AwsDeepLearningAmIsCard.Local.png) | ![illustration for AwsDeepLearningAmIsGroup](../../../aws/Architecture/ArtificialIntelligence/AwsDeepLearningAmIsGroup.Local.png) |
