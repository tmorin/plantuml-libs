...
```text
aws/Architecture/ArtificialIntelligence/AmazonLookoutForVision
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonLookoutForVision')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonLookoutForVision.png) | ![illustration for AmazonLookoutForVision](../../../aws/Architecture/ArtificialIntelligence/AmazonLookoutForVision.Local.png) | ![illustration for AmazonLookoutForVisionCard](../../../aws/Architecture/ArtificialIntelligence/AmazonLookoutForVisionCard.Local.png) | ![illustration for AmazonLookoutForVisionGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonLookoutForVisionGroup.Local.png) |
