...
```text
aws/Architecture/ArtificialIntelligence/AwsAppStudio
```

```text
include('aws/Architecture/ArtificialIntelligence/AwsAppStudio')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AwsAppStudio.png) | ![illustration for AwsAppStudio](../../../aws/Architecture/ArtificialIntelligence/AwsAppStudio.Local.png) | ![illustration for AwsAppStudioCard](../../../aws/Architecture/ArtificialIntelligence/AwsAppStudioCard.Local.png) | ![illustration for AwsAppStudioGroup](../../../aws/Architecture/ArtificialIntelligence/AwsAppStudioGroup.Local.png) |
