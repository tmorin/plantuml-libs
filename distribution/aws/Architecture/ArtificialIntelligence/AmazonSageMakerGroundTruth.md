...
```text
aws/Architecture/ArtificialIntelligence/AmazonSageMakerGroundTruth
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonSageMakerGroundTruth')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerGroundTruth.png) | ![illustration for AmazonSageMakerGroundTruth](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerGroundTruth.Local.png) | ![illustration for AmazonSageMakerGroundTruthCard](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerGroundTruthCard.Local.png) | ![illustration for AmazonSageMakerGroundTruthGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerGroundTruthGroup.Local.png) |
