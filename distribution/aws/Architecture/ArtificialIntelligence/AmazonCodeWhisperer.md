...
```text
aws/Architecture/ArtificialIntelligence/AmazonCodeWhisperer
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonCodeWhisperer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonCodeWhisperer.png) | ![illustration for AmazonCodeWhisperer](../../../aws/Architecture/ArtificialIntelligence/AmazonCodeWhisperer.Local.png) | ![illustration for AmazonCodeWhispererCard](../../../aws/Architecture/ArtificialIntelligence/AmazonCodeWhispererCard.Local.png) | ![illustration for AmazonCodeWhispererGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonCodeWhispererGroup.Local.png) |
