...
```text
aws/Architecture/ArtificialIntelligence/AmazonDevOpsGuru
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonDevOpsGuru')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonDevOpsGuru.png) | ![illustration for AmazonDevOpsGuru](../../../aws/Architecture/ArtificialIntelligence/AmazonDevOpsGuru.Local.png) | ![illustration for AmazonDevOpsGuruCard](../../../aws/Architecture/ArtificialIntelligence/AmazonDevOpsGuruCard.Local.png) | ![illustration for AmazonDevOpsGuruGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonDevOpsGuruGroup.Local.png) |
