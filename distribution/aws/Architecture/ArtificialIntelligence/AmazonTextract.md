...
```text
aws/Architecture/ArtificialIntelligence/AmazonTextract
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonTextract')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonTextract.png) | ![illustration for AmazonTextract](../../../aws/Architecture/ArtificialIntelligence/AmazonTextract.Local.png) | ![illustration for AmazonTextractCard](../../../aws/Architecture/ArtificialIntelligence/AmazonTextractCard.Local.png) | ![illustration for AmazonTextractGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonTextractGroup.Local.png) |
