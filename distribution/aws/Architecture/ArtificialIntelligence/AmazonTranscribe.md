...
```text
aws/Architecture/ArtificialIntelligence/AmazonTranscribe
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonTranscribe')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonTranscribe.png) | ![illustration for AmazonTranscribe](../../../aws/Architecture/ArtificialIntelligence/AmazonTranscribe.Local.png) | ![illustration for AmazonTranscribeCard](../../../aws/Architecture/ArtificialIntelligence/AmazonTranscribeCard.Local.png) | ![illustration for AmazonTranscribeGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonTranscribeGroup.Local.png) |
