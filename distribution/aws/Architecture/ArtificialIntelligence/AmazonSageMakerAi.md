...
```text
aws/Architecture/ArtificialIntelligence/AmazonSageMakerAi
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonSageMakerAi')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerAi.png) | ![illustration for AmazonSageMakerAi](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerAi.Local.png) | ![illustration for AmazonSageMakerAiCard](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerAiCard.Local.png) | ![illustration for AmazonSageMakerAiGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonSageMakerAiGroup.Local.png) |
