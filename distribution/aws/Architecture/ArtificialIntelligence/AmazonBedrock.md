...
```text
aws/Architecture/ArtificialIntelligence/AmazonBedrock
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonBedrock')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonBedrock.png) | ![illustration for AmazonBedrock](../../../aws/Architecture/ArtificialIntelligence/AmazonBedrock.Local.png) | ![illustration for AmazonBedrockCard](../../../aws/Architecture/ArtificialIntelligence/AmazonBedrockCard.Local.png) | ![illustration for AmazonBedrockGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonBedrockGroup.Local.png) |
