...
```text
aws/Architecture/ArtificialIntelligence/ApacheMxNetOnAws
```

```text
include('aws/Architecture/ArtificialIntelligence/ApacheMxNetOnAws')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/ApacheMxNetOnAws.png) | ![illustration for ApacheMxNetOnAws](../../../aws/Architecture/ArtificialIntelligence/ApacheMxNetOnAws.Local.png) | ![illustration for ApacheMxNetOnAwsCard](../../../aws/Architecture/ArtificialIntelligence/ApacheMxNetOnAwsCard.Local.png) | ![illustration for ApacheMxNetOnAwsGroup](../../../aws/Architecture/ArtificialIntelligence/ApacheMxNetOnAwsGroup.Local.png) |
