...
```text
aws/Architecture/ArtificialIntelligence/AmazonLookoutForEquipment
```

```text
include('aws/Architecture/ArtificialIntelligence/AmazonLookoutForEquipment')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/ArtificialIntelligence/AmazonLookoutForEquipment.png) | ![illustration for AmazonLookoutForEquipment](../../../aws/Architecture/ArtificialIntelligence/AmazonLookoutForEquipment.Local.png) | ![illustration for AmazonLookoutForEquipmentCard](../../../aws/Architecture/ArtificialIntelligence/AmazonLookoutForEquipmentCard.Local.png) | ![illustration for AmazonLookoutForEquipmentGroup](../../../aws/Architecture/ArtificialIntelligence/AmazonLookoutForEquipmentGroup.Local.png) |
