...
```text
aws/Architecture/MigrationModernization/AwsMigrationEvaluator
```

```text
include('aws/Architecture/MigrationModernization/AwsMigrationEvaluator')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/MigrationModernization/AwsMigrationEvaluator.png) | ![illustration for AwsMigrationEvaluator](../../../aws/Architecture/MigrationModernization/AwsMigrationEvaluator.Local.png) | ![illustration for AwsMigrationEvaluatorCard](../../../aws/Architecture/MigrationModernization/AwsMigrationEvaluatorCard.Local.png) | ![illustration for AwsMigrationEvaluatorGroup](../../../aws/Architecture/MigrationModernization/AwsMigrationEvaluatorGroup.Local.png) |
