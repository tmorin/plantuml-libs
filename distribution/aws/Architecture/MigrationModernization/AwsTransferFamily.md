...
```text
aws/Architecture/MigrationModernization/AwsTransferFamily
```

```text
include('aws/Architecture/MigrationModernization/AwsTransferFamily')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/MigrationModernization/AwsTransferFamily.png) | ![illustration for AwsTransferFamily](../../../aws/Architecture/MigrationModernization/AwsTransferFamily.Local.png) | ![illustration for AwsTransferFamilyCard](../../../aws/Architecture/MigrationModernization/AwsTransferFamilyCard.Local.png) | ![illustration for AwsTransferFamilyGroup](../../../aws/Architecture/MigrationModernization/AwsTransferFamilyGroup.Local.png) |
