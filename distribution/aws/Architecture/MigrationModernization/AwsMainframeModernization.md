...
```text
aws/Architecture/MigrationModernization/AwsMainframeModernization
```

```text
include('aws/Architecture/MigrationModernization/AwsMainframeModernization')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/MigrationModernization/AwsMainframeModernization.png) | ![illustration for AwsMainframeModernization](../../../aws/Architecture/MigrationModernization/AwsMainframeModernization.Local.png) | ![illustration for AwsMainframeModernizationCard](../../../aws/Architecture/MigrationModernization/AwsMainframeModernizationCard.Local.png) | ![illustration for AwsMainframeModernizationGroup](../../../aws/Architecture/MigrationModernization/AwsMainframeModernizationGroup.Local.png) |
