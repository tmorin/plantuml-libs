...
```text
aws/Architecture/MigrationModernization/AwsDataSync
```

```text
include('aws/Architecture/MigrationModernization/AwsDataSync')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/MigrationModernization/AwsDataSync.png) | ![illustration for AwsDataSync](../../../aws/Architecture/MigrationModernization/AwsDataSync.Local.png) | ![illustration for AwsDataSyncCard](../../../aws/Architecture/MigrationModernization/AwsDataSyncCard.Local.png) | ![illustration for AwsDataSyncGroup](../../../aws/Architecture/MigrationModernization/AwsDataSyncGroup.Local.png) |
