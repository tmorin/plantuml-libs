...
```text
aws/Architecture/Database/AmazonTimestream
```

```text
include('aws/Architecture/Database/AmazonTimestream')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Database/AmazonTimestream.png) | ![illustration for AmazonTimestream](../../../aws/Architecture/Database/AmazonTimestream.Local.png) | ![illustration for AmazonTimestreamCard](../../../aws/Architecture/Database/AmazonTimestreamCard.Local.png) | ![illustration for AmazonTimestreamGroup](../../../aws/Architecture/Database/AmazonTimestreamGroup.Local.png) |
