...
```text
aws/Architecture/Database/AmazonAurora
```

```text
include('aws/Architecture/Database/AmazonAurora')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Database/AmazonAurora.png) | ![illustration for AmazonAurora](../../../aws/Architecture/Database/AmazonAurora.Local.png) | ![illustration for AmazonAuroraCard](../../../aws/Architecture/Database/AmazonAuroraCard.Local.png) | ![illustration for AmazonAuroraGroup](../../../aws/Architecture/Database/AmazonAuroraGroup.Local.png) |
