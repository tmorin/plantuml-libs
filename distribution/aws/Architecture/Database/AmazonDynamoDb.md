...
```text
aws/Architecture/Database/AmazonDynamoDb
```

```text
include('aws/Architecture/Database/AmazonDynamoDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Database/AmazonDynamoDb.png) | ![illustration for AmazonDynamoDb](../../../aws/Architecture/Database/AmazonDynamoDb.Local.png) | ![illustration for AmazonDynamoDbCard](../../../aws/Architecture/Database/AmazonDynamoDbCard.Local.png) | ![illustration for AmazonDynamoDbGroup](../../../aws/Architecture/Database/AmazonDynamoDbGroup.Local.png) |
