...
```text
aws/Architecture/Database/AmazonDocumentDb
```

```text
include('aws/Architecture/Database/AmazonDocumentDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Database/AmazonDocumentDb.png) | ![illustration for AmazonDocumentDb](../../../aws/Architecture/Database/AmazonDocumentDb.Local.png) | ![illustration for AmazonDocumentDbCard](../../../aws/Architecture/Database/AmazonDocumentDbCard.Local.png) | ![illustration for AmazonDocumentDbGroup](../../../aws/Architecture/Database/AmazonDocumentDbGroup.Local.png) |
