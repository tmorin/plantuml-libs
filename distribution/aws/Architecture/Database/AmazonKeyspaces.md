...
```text
aws/Architecture/Database/AmazonKeyspaces
```

```text
include('aws/Architecture/Database/AmazonKeyspaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Architecture/Database/AmazonKeyspaces.png) | ![illustration for AmazonKeyspaces](../../../aws/Architecture/Database/AmazonKeyspaces.Local.png) | ![illustration for AmazonKeyspacesCard](../../../aws/Architecture/Database/AmazonKeyspacesCard.Local.png) | ![illustration for AmazonKeyspacesGroup](../../../aws/Architecture/Database/AmazonKeyspacesGroup.Local.png) |
