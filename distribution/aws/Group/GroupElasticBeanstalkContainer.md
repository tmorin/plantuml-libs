...
```text
aws/Group/GroupElasticBeanstalkContainer
```

```text
include('aws/Group/GroupElasticBeanstalkContainer')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../aws/Resource/GroupIcons/ElasticBeanstalkContainer.png) | ![illustration for GroupElasticBeanstalkContainer](../../aws/Group/GroupElasticBeanstalkContainer.Local.png) |
