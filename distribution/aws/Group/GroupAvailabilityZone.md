...
```text
aws/Group/GroupAvailabilityZone
```

```text
include('aws/Group/GroupAvailabilityZone')
```
...
| GroupAvailabilityZone |
| :---: |
| ![illustration for GroupAvailabilityZone](../../aws/Group/GroupAvailabilityZone.Local.png) |
