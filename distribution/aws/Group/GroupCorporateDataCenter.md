...
```text
aws/Group/GroupCorporateDataCenter
```

```text
include('aws/Group/GroupCorporateDataCenter')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../aws/Resource/GroupIcons/CorporateDataCenter.png) | ![illustration for GroupCorporateDataCenter](../../aws/Group/GroupCorporateDataCenter.Local.png) |
