...
```text
aws/Group/GroupPrivateSubnet
```

```text
include('aws/Group/GroupPrivateSubnet')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../aws/Resource/GroupIcons/PrivateSubnet.png) | ![illustration for GroupPrivateSubnet](../../aws/Group/GroupPrivateSubnet.Local.png) |
