...
```text
aws/Group/GroupEc2InstanceContents
```

```text
include('aws/Group/GroupEc2InstanceContents')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../aws/Resource/GroupIcons/Ec2InstanceContents.png) | ![illustration for GroupEc2InstanceContents](../../aws/Group/GroupEc2InstanceContents.Local.png) |
