...
```text
aws/Resource/QuantumTechnologies/AmazonBraketSimulator1
```

```text
include('aws/Resource/QuantumTechnologies/AmazonBraketSimulator1')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulator1.png) | ![illustration for AmazonBraketSimulator1](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulator1.Local.png) | ![illustration for AmazonBraketSimulator1Card](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulator1Card.Local.png) | ![illustration for AmazonBraketSimulator1Group](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulator1Group.Local.png) |
