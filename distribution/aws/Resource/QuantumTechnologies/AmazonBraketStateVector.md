...
```text
aws/Resource/QuantumTechnologies/AmazonBraketStateVector
```

```text
include('aws/Resource/QuantumTechnologies/AmazonBraketStateVector')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/QuantumTechnologies/AmazonBraketStateVector.png) | ![illustration for AmazonBraketStateVector](../../../aws/Resource/QuantumTechnologies/AmazonBraketStateVector.Local.png) | ![illustration for AmazonBraketStateVectorCard](../../../aws/Resource/QuantumTechnologies/AmazonBraketStateVectorCard.Local.png) | ![illustration for AmazonBraketStateVectorGroup](../../../aws/Resource/QuantumTechnologies/AmazonBraketStateVectorGroup.Local.png) |
