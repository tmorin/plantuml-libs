...
```text
aws/Resource/QuantumTechnologies/AmazonBraketChandelier
```

```text
include('aws/Resource/QuantumTechnologies/AmazonBraketChandelier')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/QuantumTechnologies/AmazonBraketChandelier.png) | ![illustration for AmazonBraketChandelier](../../../aws/Resource/QuantumTechnologies/AmazonBraketChandelier.Local.png) | ![illustration for AmazonBraketChandelierCard](../../../aws/Resource/QuantumTechnologies/AmazonBraketChandelierCard.Local.png) | ![illustration for AmazonBraketChandelierGroup](../../../aws/Resource/QuantumTechnologies/AmazonBraketChandelierGroup.Local.png) |
