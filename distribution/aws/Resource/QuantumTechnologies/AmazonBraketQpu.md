...
```text
aws/Resource/QuantumTechnologies/AmazonBraketQpu
```

```text
include('aws/Resource/QuantumTechnologies/AmazonBraketQpu')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/QuantumTechnologies/AmazonBraketQpu.png) | ![illustration for AmazonBraketQpu](../../../aws/Resource/QuantumTechnologies/AmazonBraketQpu.Local.png) | ![illustration for AmazonBraketQpuCard](../../../aws/Resource/QuantumTechnologies/AmazonBraketQpuCard.Local.png) | ![illustration for AmazonBraketQpuGroup](../../../aws/Resource/QuantumTechnologies/AmazonBraketQpuGroup.Local.png) |
