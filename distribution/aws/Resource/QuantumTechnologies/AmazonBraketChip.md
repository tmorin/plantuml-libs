...
```text
aws/Resource/QuantumTechnologies/AmazonBraketChip
```

```text
include('aws/Resource/QuantumTechnologies/AmazonBraketChip')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/QuantumTechnologies/AmazonBraketChip.png) | ![illustration for AmazonBraketChip](../../../aws/Resource/QuantumTechnologies/AmazonBraketChip.Local.png) | ![illustration for AmazonBraketChipCard](../../../aws/Resource/QuantumTechnologies/AmazonBraketChipCard.Local.png) | ![illustration for AmazonBraketChipGroup](../../../aws/Resource/QuantumTechnologies/AmazonBraketChipGroup.Local.png) |
