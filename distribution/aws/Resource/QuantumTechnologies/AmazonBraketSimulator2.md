...
```text
aws/Resource/QuantumTechnologies/AmazonBraketSimulator2
```

```text
include('aws/Resource/QuantumTechnologies/AmazonBraketSimulator2')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulator2.png) | ![illustration for AmazonBraketSimulator2](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulator2.Local.png) | ![illustration for AmazonBraketSimulator2Card](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulator2Card.Local.png) | ![illustration for AmazonBraketSimulator2Group](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulator2Group.Local.png) |
