...
```text
aws/Resource/QuantumTechnologies/AmazonBraketNoiseSimulator
```

```text
include('aws/Resource/QuantumTechnologies/AmazonBraketNoiseSimulator')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/QuantumTechnologies/AmazonBraketNoiseSimulator.png) | ![illustration for AmazonBraketNoiseSimulator](../../../aws/Resource/QuantumTechnologies/AmazonBraketNoiseSimulator.Local.png) | ![illustration for AmazonBraketNoiseSimulatorCard](../../../aws/Resource/QuantumTechnologies/AmazonBraketNoiseSimulatorCard.Local.png) | ![illustration for AmazonBraketNoiseSimulatorGroup](../../../aws/Resource/QuantumTechnologies/AmazonBraketNoiseSimulatorGroup.Local.png) |
