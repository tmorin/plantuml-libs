...
```text
aws/Resource/QuantumTechnologies/AmazonBraketSimulator
```

```text
include('aws/Resource/QuantumTechnologies/AmazonBraketSimulator')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulator.png) | ![illustration for AmazonBraketSimulator](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulator.Local.png) | ![illustration for AmazonBraketSimulatorCard](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulatorCard.Local.png) | ![illustration for AmazonBraketSimulatorGroup](../../../aws/Resource/QuantumTechnologies/AmazonBraketSimulatorGroup.Local.png) |
