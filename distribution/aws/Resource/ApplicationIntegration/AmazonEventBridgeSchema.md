...
```text
aws/Resource/ApplicationIntegration/AmazonEventBridgeSchema
```

```text
include('aws/Resource/ApplicationIntegration/AmazonEventBridgeSchema')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeSchema.png) | ![illustration for AmazonEventBridgeSchema](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeSchema.Local.png) | ![illustration for AmazonEventBridgeSchemaCard](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeSchemaCard.Local.png) | ![illustration for AmazonEventBridgeSchemaGroup](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeSchemaGroup.Local.png) |
