...
```text
aws/Resource/ApplicationIntegration/AmazonEventBridgeSchemaRegistry
```

```text
include('aws/Resource/ApplicationIntegration/AmazonEventBridgeSchemaRegistry')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeSchemaRegistry.png) | ![illustration for AmazonEventBridgeSchemaRegistry](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeSchemaRegistry.Local.png) | ![illustration for AmazonEventBridgeSchemaRegistryCard](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeSchemaRegistryCard.Local.png) | ![illustration for AmazonEventBridgeSchemaRegistryGroup](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeSchemaRegistryGroup.Local.png) |
