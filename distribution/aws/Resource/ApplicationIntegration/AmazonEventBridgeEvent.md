...
```text
aws/Resource/ApplicationIntegration/AmazonEventBridgeEvent
```

```text
include('aws/Resource/ApplicationIntegration/AmazonEventBridgeEvent')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeEvent.png) | ![illustration for AmazonEventBridgeEvent](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeEvent.Local.png) | ![illustration for AmazonEventBridgeEventCard](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeEventCard.Local.png) | ![illustration for AmazonEventBridgeEventGroup](../../../aws/Resource/ApplicationIntegration/AmazonEventBridgeEventGroup.Local.png) |
