...
```text
aws/Resource/ApplicationIntegration/AmazonMqBroker
```

```text
include('aws/Resource/ApplicationIntegration/AmazonMqBroker')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/ApplicationIntegration/AmazonMqBroker.png) | ![illustration for AmazonMqBroker](../../../aws/Resource/ApplicationIntegration/AmazonMqBroker.Local.png) | ![illustration for AmazonMqBrokerCard](../../../aws/Resource/ApplicationIntegration/AmazonMqBrokerCard.Local.png) | ![illustration for AmazonMqBrokerGroup](../../../aws/Resource/ApplicationIntegration/AmazonMqBrokerGroup.Local.png) |
