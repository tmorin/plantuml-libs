...
```text
aws/Resource/MigrationModernization/AwsMainframeModernizationDeveloper
```

```text
include('aws/Resource/MigrationModernization/AwsMainframeModernizationDeveloper')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/MigrationModernization/AwsMainframeModernizationDeveloper.png) | ![illustration for AwsMainframeModernizationDeveloper](../../../aws/Resource/MigrationModernization/AwsMainframeModernizationDeveloper.Local.png) | ![illustration for AwsMainframeModernizationDeveloperCard](../../../aws/Resource/MigrationModernization/AwsMainframeModernizationDeveloperCard.Local.png) | ![illustration for AwsMainframeModernizationDeveloperGroup](../../../aws/Resource/MigrationModernization/AwsMainframeModernizationDeveloperGroup.Local.png) |
