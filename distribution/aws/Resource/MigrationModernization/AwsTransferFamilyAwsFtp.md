...
```text
aws/Resource/MigrationModernization/AwsTransferFamilyAwsFtp
```

```text
include('aws/Resource/MigrationModernization/AwsTransferFamilyAwsFtp')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/MigrationModernization/AwsTransferFamilyAwsFtp.png) | ![illustration for AwsTransferFamilyAwsFtp](../../../aws/Resource/MigrationModernization/AwsTransferFamilyAwsFtp.Local.png) | ![illustration for AwsTransferFamilyAwsFtpCard](../../../aws/Resource/MigrationModernization/AwsTransferFamilyAwsFtpCard.Local.png) | ![illustration for AwsTransferFamilyAwsFtpGroup](../../../aws/Resource/MigrationModernization/AwsTransferFamilyAwsFtpGroup.Local.png) |
