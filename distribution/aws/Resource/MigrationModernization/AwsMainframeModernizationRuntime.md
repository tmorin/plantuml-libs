...
```text
aws/Resource/MigrationModernization/AwsMainframeModernizationRuntime
```

```text
include('aws/Resource/MigrationModernization/AwsMainframeModernizationRuntime')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/MigrationModernization/AwsMainframeModernizationRuntime.png) | ![illustration for AwsMainframeModernizationRuntime](../../../aws/Resource/MigrationModernization/AwsMainframeModernizationRuntime.Local.png) | ![illustration for AwsMainframeModernizationRuntimeCard](../../../aws/Resource/MigrationModernization/AwsMainframeModernizationRuntimeCard.Local.png) | ![illustration for AwsMainframeModernizationRuntimeGroup](../../../aws/Resource/MigrationModernization/AwsMainframeModernizationRuntimeGroup.Local.png) |
