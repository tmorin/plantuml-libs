...
```text
aws/Resource/Containers/AmazonElasticContainerRegistryRegistry
```

```text
include('aws/Resource/Containers/AmazonElasticContainerRegistryRegistry')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Containers/AmazonElasticContainerRegistryRegistry.png) | ![illustration for AmazonElasticContainerRegistryRegistry](../../../aws/Resource/Containers/AmazonElasticContainerRegistryRegistry.Local.png) | ![illustration for AmazonElasticContainerRegistryRegistryCard](../../../aws/Resource/Containers/AmazonElasticContainerRegistryRegistryCard.Local.png) | ![illustration for AmazonElasticContainerRegistryRegistryGroup](../../../aws/Resource/Containers/AmazonElasticContainerRegistryRegistryGroup.Local.png) |
