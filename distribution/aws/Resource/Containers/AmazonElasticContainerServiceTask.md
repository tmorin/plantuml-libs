...
```text
aws/Resource/Containers/AmazonElasticContainerServiceTask
```

```text
include('aws/Resource/Containers/AmazonElasticContainerServiceTask')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Containers/AmazonElasticContainerServiceTask.png) | ![illustration for AmazonElasticContainerServiceTask](../../../aws/Resource/Containers/AmazonElasticContainerServiceTask.Local.png) | ![illustration for AmazonElasticContainerServiceTaskCard](../../../aws/Resource/Containers/AmazonElasticContainerServiceTaskCard.Local.png) | ![illustration for AmazonElasticContainerServiceTaskGroup](../../../aws/Resource/Containers/AmazonElasticContainerServiceTaskGroup.Local.png) |
