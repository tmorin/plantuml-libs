...
```text
aws/Resource/GeneralIcons/InternetAlt1
```

```text
include('aws/Resource/GeneralIcons/InternetAlt1')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/InternetAlt1.png) | ![illustration for InternetAlt1](../../../aws/Resource/GeneralIcons/InternetAlt1.Local.png) | ![illustration for InternetAlt1Card](../../../aws/Resource/GeneralIcons/InternetAlt1Card.Local.png) | ![illustration for InternetAlt1Group](../../../aws/Resource/GeneralIcons/InternetAlt1Group.Local.png) |
