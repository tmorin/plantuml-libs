...
```text
aws/Resource/GeneralIcons/AwsManagementConsole
```

```text
include('aws/Resource/GeneralIcons/AwsManagementConsole')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/AwsManagementConsole.png) | ![illustration for AwsManagementConsole](../../../aws/Resource/GeneralIcons/AwsManagementConsole.Local.png) | ![illustration for AwsManagementConsoleCard](../../../aws/Resource/GeneralIcons/AwsManagementConsoleCard.Local.png) | ![illustration for AwsManagementConsoleGroup](../../../aws/Resource/GeneralIcons/AwsManagementConsoleGroup.Local.png) |
