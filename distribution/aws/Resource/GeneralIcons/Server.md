...
```text
aws/Resource/GeneralIcons/Server
```

```text
include('aws/Resource/GeneralIcons/Server')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Server.png) | ![illustration for Server](../../../aws/Resource/GeneralIcons/Server.Local.png) | ![illustration for ServerCard](../../../aws/Resource/GeneralIcons/ServerCard.Local.png) | ![illustration for ServerGroup](../../../aws/Resource/GeneralIcons/ServerGroup.Local.png) |
