...
```text
aws/Resource/GeneralIcons/Alert
```

```text
include('aws/Resource/GeneralIcons/Alert')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Alert.png) | ![illustration for Alert](../../../aws/Resource/GeneralIcons/Alert.Local.png) | ![illustration for AlertCard](../../../aws/Resource/GeneralIcons/AlertCard.Local.png) | ![illustration for AlertGroup](../../../aws/Resource/GeneralIcons/AlertGroup.Local.png) |
