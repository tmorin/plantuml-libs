...
```text
aws/Resource/GeneralIcons/Shield
```

```text
include('aws/Resource/GeneralIcons/Shield')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Shield.png) | ![illustration for Shield](../../../aws/Resource/GeneralIcons/Shield.Local.png) | ![illustration for ShieldCard](../../../aws/Resource/GeneralIcons/ShieldCard.Local.png) | ![illustration for ShieldGroup](../../../aws/Resource/GeneralIcons/ShieldGroup.Local.png) |
