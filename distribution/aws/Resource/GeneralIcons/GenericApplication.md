...
```text
aws/Resource/GeneralIcons/GenericApplication
```

```text
include('aws/Resource/GeneralIcons/GenericApplication')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/GenericApplication.png) | ![illustration for GenericApplication](../../../aws/Resource/GeneralIcons/GenericApplication.Local.png) | ![illustration for GenericApplicationCard](../../../aws/Resource/GeneralIcons/GenericApplicationCard.Local.png) | ![illustration for GenericApplicationGroup](../../../aws/Resource/GeneralIcons/GenericApplicationGroup.Local.png) |
