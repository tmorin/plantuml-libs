...
```text
aws/Resource/GeneralIcons/User
```

```text
include('aws/Resource/GeneralIcons/User')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/User.png) | ![illustration for User](../../../aws/Resource/GeneralIcons/User.Local.png) | ![illustration for UserCard](../../../aws/Resource/GeneralIcons/UserCard.Local.png) | ![illustration for UserGroup](../../../aws/Resource/GeneralIcons/UserGroup.Local.png) |
