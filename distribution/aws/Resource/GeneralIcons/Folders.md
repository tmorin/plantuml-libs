...
```text
aws/Resource/GeneralIcons/Folders
```

```text
include('aws/Resource/GeneralIcons/Folders')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Folders.png) | ![illustration for Folders](../../../aws/Resource/GeneralIcons/Folders.Local.png) | ![illustration for FoldersCard](../../../aws/Resource/GeneralIcons/FoldersCard.Local.png) | ![illustration for FoldersGroup](../../../aws/Resource/GeneralIcons/FoldersGroup.Local.png) |
