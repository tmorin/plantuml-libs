...
```text
aws/Resource/GeneralIcons/Metrics
```

```text
include('aws/Resource/GeneralIcons/Metrics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Metrics.png) | ![illustration for Metrics](../../../aws/Resource/GeneralIcons/Metrics.Local.png) | ![illustration for MetricsCard](../../../aws/Resource/GeneralIcons/MetricsCard.Local.png) | ![illustration for MetricsGroup](../../../aws/Resource/GeneralIcons/MetricsGroup.Local.png) |
