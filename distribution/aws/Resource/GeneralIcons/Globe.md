...
```text
aws/Resource/GeneralIcons/Globe
```

```text
include('aws/Resource/GeneralIcons/Globe')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Globe.png) | ![illustration for Globe](../../../aws/Resource/GeneralIcons/Globe.Local.png) | ![illustration for GlobeCard](../../../aws/Resource/GeneralIcons/GlobeCard.Local.png) | ![illustration for GlobeGroup](../../../aws/Resource/GeneralIcons/GlobeGroup.Local.png) |
