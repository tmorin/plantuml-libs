...
```text
aws/Resource/GeneralIcons/Document
```

```text
include('aws/Resource/GeneralIcons/Document')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Document.png) | ![illustration for Document](../../../aws/Resource/GeneralIcons/Document.Local.png) | ![illustration for DocumentCard](../../../aws/Resource/GeneralIcons/DocumentCard.Local.png) | ![illustration for DocumentGroup](../../../aws/Resource/GeneralIcons/DocumentGroup.Local.png) |
