...
```text
aws/Resource/GeneralIcons/MobileClient
```

```text
include('aws/Resource/GeneralIcons/MobileClient')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/MobileClient.png) | ![illustration for MobileClient](../../../aws/Resource/GeneralIcons/MobileClient.Local.png) | ![illustration for MobileClientCard](../../../aws/Resource/GeneralIcons/MobileClientCard.Local.png) | ![illustration for MobileClientGroup](../../../aws/Resource/GeneralIcons/MobileClientGroup.Local.png) |
