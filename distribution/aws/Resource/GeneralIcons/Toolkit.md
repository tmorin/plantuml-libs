...
```text
aws/Resource/GeneralIcons/Toolkit
```

```text
include('aws/Resource/GeneralIcons/Toolkit')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Toolkit.png) | ![illustration for Toolkit](../../../aws/Resource/GeneralIcons/Toolkit.Local.png) | ![illustration for ToolkitCard](../../../aws/Resource/GeneralIcons/ToolkitCard.Local.png) | ![illustration for ToolkitGroup](../../../aws/Resource/GeneralIcons/ToolkitGroup.Local.png) |
