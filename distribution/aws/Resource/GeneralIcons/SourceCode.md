...
```text
aws/Resource/GeneralIcons/SourceCode
```

```text
include('aws/Resource/GeneralIcons/SourceCode')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/SourceCode.png) | ![illustration for SourceCode](../../../aws/Resource/GeneralIcons/SourceCode.Local.png) | ![illustration for SourceCodeCard](../../../aws/Resource/GeneralIcons/SourceCodeCard.Local.png) | ![illustration for SourceCodeGroup](../../../aws/Resource/GeneralIcons/SourceCodeGroup.Local.png) |
