...
```text
aws/Resource/GeneralIcons/Camera
```

```text
include('aws/Resource/GeneralIcons/Camera')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Camera.png) | ![illustration for Camera](../../../aws/Resource/GeneralIcons/Camera.Local.png) | ![illustration for CameraCard](../../../aws/Resource/GeneralIcons/CameraCard.Local.png) | ![illustration for CameraGroup](../../../aws/Resource/GeneralIcons/CameraGroup.Local.png) |
