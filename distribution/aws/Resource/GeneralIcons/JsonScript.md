...
```text
aws/Resource/GeneralIcons/JsonScript
```

```text
include('aws/Resource/GeneralIcons/JsonScript')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/JsonScript.png) | ![illustration for JsonScript](../../../aws/Resource/GeneralIcons/JsonScript.Local.png) | ![illustration for JsonScriptCard](../../../aws/Resource/GeneralIcons/JsonScriptCard.Local.png) | ![illustration for JsonScriptGroup](../../../aws/Resource/GeneralIcons/JsonScriptGroup.Local.png) |
