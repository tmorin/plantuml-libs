...
```text
aws/Resource/GeneralIcons/Recover
```

```text
include('aws/Resource/GeneralIcons/Recover')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Recover.png) | ![illustration for Recover](../../../aws/Resource/GeneralIcons/Recover.Local.png) | ![illustration for RecoverCard](../../../aws/Resource/GeneralIcons/RecoverCard.Local.png) | ![illustration for RecoverGroup](../../../aws/Resource/GeneralIcons/RecoverGroup.Local.png) |
