...
```text
aws/Resource/GeneralIcons/Logs
```

```text
include('aws/Resource/GeneralIcons/Logs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Logs.png) | ![illustration for Logs](../../../aws/Resource/GeneralIcons/Logs.Local.png) | ![illustration for LogsCard](../../../aws/Resource/GeneralIcons/LogsCard.Local.png) | ![illustration for LogsGroup](../../../aws/Resource/GeneralIcons/LogsGroup.Local.png) |
