...
```text
aws/Resource/GeneralIcons/MagnifyingGlass
```

```text
include('aws/Resource/GeneralIcons/MagnifyingGlass')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/MagnifyingGlass.png) | ![illustration for MagnifyingGlass](../../../aws/Resource/GeneralIcons/MagnifyingGlass.Local.png) | ![illustration for MagnifyingGlassCard](../../../aws/Resource/GeneralIcons/MagnifyingGlassCard.Local.png) | ![illustration for MagnifyingGlassGroup](../../../aws/Resource/GeneralIcons/MagnifyingGlassGroup.Local.png) |
