...
```text
aws/Resource/GeneralIcons/ColdStorage
```

```text
include('aws/Resource/GeneralIcons/ColdStorage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/ColdStorage.png) | ![illustration for ColdStorage](../../../aws/Resource/GeneralIcons/ColdStorage.Local.png) | ![illustration for ColdStorageCard](../../../aws/Resource/GeneralIcons/ColdStorageCard.Local.png) | ![illustration for ColdStorageGroup](../../../aws/Resource/GeneralIcons/ColdStorageGroup.Local.png) |
