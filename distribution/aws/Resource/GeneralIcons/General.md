...
```text
aws/Resource/GeneralIcons/General
```

```text
include('aws/Resource/GeneralIcons/General')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/General.png) | ![illustration for General](../../../aws/Resource/GeneralIcons/General.Local.png) | ![illustration for GeneralCard](../../../aws/Resource/GeneralIcons/GeneralCard.Local.png) | ![illustration for GeneralGroup](../../../aws/Resource/GeneralIcons/GeneralGroup.Local.png) |
