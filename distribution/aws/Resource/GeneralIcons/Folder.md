...
```text
aws/Resource/GeneralIcons/Folder
```

```text
include('aws/Resource/GeneralIcons/Folder')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Folder.png) | ![illustration for Folder](../../../aws/Resource/GeneralIcons/Folder.Local.png) | ![illustration for FolderCard](../../../aws/Resource/GeneralIcons/FolderCard.Local.png) | ![illustration for FolderGroup](../../../aws/Resource/GeneralIcons/FolderGroup.Local.png) |
