...
```text
aws/Resource/GeneralIcons/Client
```

```text
include('aws/Resource/GeneralIcons/Client')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Client.png) | ![illustration for Client](../../../aws/Resource/GeneralIcons/Client.Local.png) | ![illustration for ClientCard](../../../aws/Resource/GeneralIcons/ClientCard.Local.png) | ![illustration for ClientGroup](../../../aws/Resource/GeneralIcons/ClientGroup.Local.png) |
