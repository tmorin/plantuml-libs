...
```text
aws/Resource/GeneralIcons/TapeStorage
```

```text
include('aws/Resource/GeneralIcons/TapeStorage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/TapeStorage.png) | ![illustration for TapeStorage](../../../aws/Resource/GeneralIcons/TapeStorage.Local.png) | ![illustration for TapeStorageCard](../../../aws/Resource/GeneralIcons/TapeStorageCard.Local.png) | ![illustration for TapeStorageGroup](../../../aws/Resource/GeneralIcons/TapeStorageGroup.Local.png) |
