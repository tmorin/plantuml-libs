...
```text
aws/Resource/GeneralIcons/Servers
```

```text
include('aws/Resource/GeneralIcons/Servers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GeneralIcons/Servers.png) | ![illustration for Servers](../../../aws/Resource/GeneralIcons/Servers.Local.png) | ![illustration for ServersCard](../../../aws/Resource/GeneralIcons/ServersCard.Local.png) | ![illustration for ServersGroup](../../../aws/Resource/GeneralIcons/ServersGroup.Local.png) |
