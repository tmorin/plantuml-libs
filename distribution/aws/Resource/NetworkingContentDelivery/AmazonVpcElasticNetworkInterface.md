...
```text
aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkInterface
```

```text
include('aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkInterface')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkInterface.png) | ![illustration for AmazonVpcElasticNetworkInterface](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkInterface.Local.png) | ![illustration for AmazonVpcElasticNetworkInterfaceCard](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkInterfaceCard.Local.png) | ![illustration for AmazonVpcElasticNetworkInterfaceGroup](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkInterfaceGroup.Local.png) |
