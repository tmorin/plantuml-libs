...
```text
aws/Resource/NetworkingContentDelivery/AwsCloudMapResource
```

```text
include('aws/Resource/NetworkingContentDelivery/AwsCloudMapResource')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AwsCloudMapResource.png) | ![illustration for AwsCloudMapResource](../../../aws/Resource/NetworkingContentDelivery/AwsCloudMapResource.Local.png) | ![illustration for AwsCloudMapResourceCard](../../../aws/Resource/NetworkingContentDelivery/AwsCloudMapResourceCard.Local.png) | ![illustration for AwsCloudMapResourceGroup](../../../aws/Resource/NetworkingContentDelivery/AwsCloudMapResourceGroup.Local.png) |
