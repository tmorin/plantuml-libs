...
```text
aws/Resource/NetworkingContentDelivery/AwsCloudWanSegmentNetwork
```

```text
include('aws/Resource/NetworkingContentDelivery/AwsCloudWanSegmentNetwork')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AwsCloudWanSegmentNetwork.png) | ![illustration for AwsCloudWanSegmentNetwork](../../../aws/Resource/NetworkingContentDelivery/AwsCloudWanSegmentNetwork.Local.png) | ![illustration for AwsCloudWanSegmentNetworkCard](../../../aws/Resource/NetworkingContentDelivery/AwsCloudWanSegmentNetworkCard.Local.png) | ![illustration for AwsCloudWanSegmentNetworkGroup](../../../aws/Resource/NetworkingContentDelivery/AwsCloudWanSegmentNetworkGroup.Local.png) |
