...
```text
aws/Resource/NetworkingContentDelivery/AwsDirectConnectGateway
```

```text
include('aws/Resource/NetworkingContentDelivery/AwsDirectConnectGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AwsDirectConnectGateway.png) | ![illustration for AwsDirectConnectGateway](../../../aws/Resource/NetworkingContentDelivery/AwsDirectConnectGateway.Local.png) | ![illustration for AwsDirectConnectGatewayCard](../../../aws/Resource/NetworkingContentDelivery/AwsDirectConnectGatewayCard.Local.png) | ![illustration for AwsDirectConnectGatewayGroup](../../../aws/Resource/NetworkingContentDelivery/AwsDirectConnectGatewayGroup.Local.png) |
