...
```text
aws/Resource/NetworkingContentDelivery/AwsCloudMapNamespace
```

```text
include('aws/Resource/NetworkingContentDelivery/AwsCloudMapNamespace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AwsCloudMapNamespace.png) | ![illustration for AwsCloudMapNamespace](../../../aws/Resource/NetworkingContentDelivery/AwsCloudMapNamespace.Local.png) | ![illustration for AwsCloudMapNamespaceCard](../../../aws/Resource/NetworkingContentDelivery/AwsCloudMapNamespaceCard.Local.png) | ![illustration for AwsCloudMapNamespaceGroup](../../../aws/Resource/NetworkingContentDelivery/AwsCloudMapNamespaceGroup.Local.png) |
