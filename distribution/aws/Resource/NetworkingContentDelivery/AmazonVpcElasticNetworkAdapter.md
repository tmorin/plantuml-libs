...
```text
aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkAdapter
```

```text
include('aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkAdapter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkAdapter.png) | ![illustration for AmazonVpcElasticNetworkAdapter](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkAdapter.Local.png) | ![illustration for AmazonVpcElasticNetworkAdapterCard](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkAdapterCard.Local.png) | ![illustration for AmazonVpcElasticNetworkAdapterGroup](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcElasticNetworkAdapterGroup.Local.png) |
