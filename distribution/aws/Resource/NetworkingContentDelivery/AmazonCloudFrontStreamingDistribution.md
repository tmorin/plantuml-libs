...
```text
aws/Resource/NetworkingContentDelivery/AmazonCloudFrontStreamingDistribution
```

```text
include('aws/Resource/NetworkingContentDelivery/AmazonCloudFrontStreamingDistribution')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AmazonCloudFrontStreamingDistribution.png) | ![illustration for AmazonCloudFrontStreamingDistribution](../../../aws/Resource/NetworkingContentDelivery/AmazonCloudFrontStreamingDistribution.Local.png) | ![illustration for AmazonCloudFrontStreamingDistributionCard](../../../aws/Resource/NetworkingContentDelivery/AmazonCloudFrontStreamingDistributionCard.Local.png) | ![illustration for AmazonCloudFrontStreamingDistributionGroup](../../../aws/Resource/NetworkingContentDelivery/AmazonCloudFrontStreamingDistributionGroup.Local.png) |
