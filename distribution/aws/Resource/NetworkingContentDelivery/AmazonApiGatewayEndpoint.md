...
```text
aws/Resource/NetworkingContentDelivery/AmazonApiGatewayEndpoint
```

```text
include('aws/Resource/NetworkingContentDelivery/AmazonApiGatewayEndpoint')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AmazonApiGatewayEndpoint.png) | ![illustration for AmazonApiGatewayEndpoint](../../../aws/Resource/NetworkingContentDelivery/AmazonApiGatewayEndpoint.Local.png) | ![illustration for AmazonApiGatewayEndpointCard](../../../aws/Resource/NetworkingContentDelivery/AmazonApiGatewayEndpointCard.Local.png) | ![illustration for AmazonApiGatewayEndpointGroup](../../../aws/Resource/NetworkingContentDelivery/AmazonApiGatewayEndpointGroup.Local.png) |
