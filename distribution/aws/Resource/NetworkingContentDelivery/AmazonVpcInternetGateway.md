...
```text
aws/Resource/NetworkingContentDelivery/AmazonVpcInternetGateway
```

```text
include('aws/Resource/NetworkingContentDelivery/AmazonVpcInternetGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcInternetGateway.png) | ![illustration for AmazonVpcInternetGateway](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcInternetGateway.Local.png) | ![illustration for AmazonVpcInternetGatewayCard](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcInternetGatewayCard.Local.png) | ![illustration for AmazonVpcInternetGatewayGroup](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcInternetGatewayGroup.Local.png) |
