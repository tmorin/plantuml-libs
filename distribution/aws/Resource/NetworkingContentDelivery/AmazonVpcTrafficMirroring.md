...
```text
aws/Resource/NetworkingContentDelivery/AmazonVpcTrafficMirroring
```

```text
include('aws/Resource/NetworkingContentDelivery/AmazonVpcTrafficMirroring')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcTrafficMirroring.png) | ![illustration for AmazonVpcTrafficMirroring](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcTrafficMirroring.Local.png) | ![illustration for AmazonVpcTrafficMirroringCard](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcTrafficMirroringCard.Local.png) | ![illustration for AmazonVpcTrafficMirroringGroup](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcTrafficMirroringGroup.Local.png) |
