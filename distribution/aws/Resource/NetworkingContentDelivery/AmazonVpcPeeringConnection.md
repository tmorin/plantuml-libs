...
```text
aws/Resource/NetworkingContentDelivery/AmazonVpcPeeringConnection
```

```text
include('aws/Resource/NetworkingContentDelivery/AmazonVpcPeeringConnection')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcPeeringConnection.png) | ![illustration for AmazonVpcPeeringConnection](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcPeeringConnection.Local.png) | ![illustration for AmazonVpcPeeringConnectionCard](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcPeeringConnectionCard.Local.png) | ![illustration for AmazonVpcPeeringConnectionGroup](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcPeeringConnectionGroup.Local.png) |
