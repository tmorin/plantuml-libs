...
```text
aws/Resource/NetworkingContentDelivery/AmazonVpcCarrierGateway
```

```text
include('aws/Resource/NetworkingContentDelivery/AmazonVpcCarrierGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcCarrierGateway.png) | ![illustration for AmazonVpcCarrierGateway](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcCarrierGateway.Local.png) | ![illustration for AmazonVpcCarrierGatewayCard](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcCarrierGatewayCard.Local.png) | ![illustration for AmazonVpcCarrierGatewayGroup](../../../aws/Resource/NetworkingContentDelivery/AmazonVpcCarrierGatewayGroup.Local.png) |
