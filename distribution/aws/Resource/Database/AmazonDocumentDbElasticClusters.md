...
```text
aws/Resource/Database/AmazonDocumentDbElasticClusters
```

```text
include('aws/Resource/Database/AmazonDocumentDbElasticClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonDocumentDbElasticClusters.png) | ![illustration for AmazonDocumentDbElasticClusters](../../../aws/Resource/Database/AmazonDocumentDbElasticClusters.Local.png) | ![illustration for AmazonDocumentDbElasticClustersCard](../../../aws/Resource/Database/AmazonDocumentDbElasticClustersCard.Local.png) | ![illustration for AmazonDocumentDbElasticClustersGroup](../../../aws/Resource/Database/AmazonDocumentDbElasticClustersGroup.Local.png) |
