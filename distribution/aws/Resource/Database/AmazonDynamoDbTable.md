...
```text
aws/Resource/Database/AmazonDynamoDbTable
```

```text
include('aws/Resource/Database/AmazonDynamoDbTable')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonDynamoDbTable.png) | ![illustration for AmazonDynamoDbTable](../../../aws/Resource/Database/AmazonDynamoDbTable.Local.png) | ![illustration for AmazonDynamoDbTableCard](../../../aws/Resource/Database/AmazonDynamoDbTableCard.Local.png) | ![illustration for AmazonDynamoDbTableGroup](../../../aws/Resource/Database/AmazonDynamoDbTableGroup.Local.png) |
