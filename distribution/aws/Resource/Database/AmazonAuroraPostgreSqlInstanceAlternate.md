...
```text
aws/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate
```

```text
include('aws/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate.png) | ![illustration for AmazonAuroraPostgreSqlInstanceAlternate](../../../aws/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate.Local.png) | ![illustration for AmazonAuroraPostgreSqlInstanceAlternateCard](../../../aws/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternateCard.Local.png) | ![illustration for AmazonAuroraPostgreSqlInstanceAlternateGroup](../../../aws/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternateGroup.Local.png) |
