...
```text
aws/Resource/Database/AmazonAuroraOracleInstance
```

```text
include('aws/Resource/Database/AmazonAuroraOracleInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonAuroraOracleInstance.png) | ![illustration for AmazonAuroraOracleInstance](../../../aws/Resource/Database/AmazonAuroraOracleInstance.Local.png) | ![illustration for AmazonAuroraOracleInstanceCard](../../../aws/Resource/Database/AmazonAuroraOracleInstanceCard.Local.png) | ![illustration for AmazonAuroraOracleInstanceGroup](../../../aws/Resource/Database/AmazonAuroraOracleInstanceGroup.Local.png) |
