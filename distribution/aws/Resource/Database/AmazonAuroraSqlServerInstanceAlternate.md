...
```text
aws/Resource/Database/AmazonAuroraSqlServerInstanceAlternate
```

```text
include('aws/Resource/Database/AmazonAuroraSqlServerInstanceAlternate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonAuroraSqlServerInstanceAlternate.png) | ![illustration for AmazonAuroraSqlServerInstanceAlternate](../../../aws/Resource/Database/AmazonAuroraSqlServerInstanceAlternate.Local.png) | ![illustration for AmazonAuroraSqlServerInstanceAlternateCard](../../../aws/Resource/Database/AmazonAuroraSqlServerInstanceAlternateCard.Local.png) | ![illustration for AmazonAuroraSqlServerInstanceAlternateGroup](../../../aws/Resource/Database/AmazonAuroraSqlServerInstanceAlternateGroup.Local.png) |
