...
```text
aws/Resource/Database/AmazonAuroraAmazonRdsInstance
```

```text
include('aws/Resource/Database/AmazonAuroraAmazonRdsInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonAuroraAmazonRdsInstance.png) | ![illustration for AmazonAuroraAmazonRdsInstance](../../../aws/Resource/Database/AmazonAuroraAmazonRdsInstance.Local.png) | ![illustration for AmazonAuroraAmazonRdsInstanceCard](../../../aws/Resource/Database/AmazonAuroraAmazonRdsInstanceCard.Local.png) | ![illustration for AmazonAuroraAmazonRdsInstanceGroup](../../../aws/Resource/Database/AmazonAuroraAmazonRdsInstanceGroup.Local.png) |
