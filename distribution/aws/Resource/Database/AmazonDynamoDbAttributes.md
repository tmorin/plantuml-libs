...
```text
aws/Resource/Database/AmazonDynamoDbAttributes
```

```text
include('aws/Resource/Database/AmazonDynamoDbAttributes')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonDynamoDbAttributes.png) | ![illustration for AmazonDynamoDbAttributes](../../../aws/Resource/Database/AmazonDynamoDbAttributes.Local.png) | ![illustration for AmazonDynamoDbAttributesCard](../../../aws/Resource/Database/AmazonDynamoDbAttributesCard.Local.png) | ![illustration for AmazonDynamoDbAttributesGroup](../../../aws/Resource/Database/AmazonDynamoDbAttributesGroup.Local.png) |
