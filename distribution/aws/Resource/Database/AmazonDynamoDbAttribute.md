...
```text
aws/Resource/Database/AmazonDynamoDbAttribute
```

```text
include('aws/Resource/Database/AmazonDynamoDbAttribute')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonDynamoDbAttribute.png) | ![illustration for AmazonDynamoDbAttribute](../../../aws/Resource/Database/AmazonDynamoDbAttribute.Local.png) | ![illustration for AmazonDynamoDbAttributeCard](../../../aws/Resource/Database/AmazonDynamoDbAttributeCard.Local.png) | ![illustration for AmazonDynamoDbAttributeGroup](../../../aws/Resource/Database/AmazonDynamoDbAttributeGroup.Local.png) |
