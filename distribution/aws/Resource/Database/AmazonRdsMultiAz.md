...
```text
aws/Resource/Database/AmazonRdsMultiAz
```

```text
include('aws/Resource/Database/AmazonRdsMultiAz')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonRdsMultiAz.png) | ![illustration for AmazonRdsMultiAz](../../../aws/Resource/Database/AmazonRdsMultiAz.Local.png) | ![illustration for AmazonRdsMultiAzCard](../../../aws/Resource/Database/AmazonRdsMultiAzCard.Local.png) | ![illustration for AmazonRdsMultiAzGroup](../../../aws/Resource/Database/AmazonRdsMultiAzGroup.Local.png) |
