...
```text
aws/Resource/Database/AmazonRdsOptimizedWrites
```

```text
include('aws/Resource/Database/AmazonRdsOptimizedWrites')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonRdsOptimizedWrites.png) | ![illustration for AmazonRdsOptimizedWrites](../../../aws/Resource/Database/AmazonRdsOptimizedWrites.Local.png) | ![illustration for AmazonRdsOptimizedWritesCard](../../../aws/Resource/Database/AmazonRdsOptimizedWritesCard.Local.png) | ![illustration for AmazonRdsOptimizedWritesGroup](../../../aws/Resource/Database/AmazonRdsOptimizedWritesGroup.Local.png) |
