...
```text
aws/Resource/Database/AmazonRdsBlueGreenDeployments
```

```text
include('aws/Resource/Database/AmazonRdsBlueGreenDeployments')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonRdsBlueGreenDeployments.png) | ![illustration for AmazonRdsBlueGreenDeployments](../../../aws/Resource/Database/AmazonRdsBlueGreenDeployments.Local.png) | ![illustration for AmazonRdsBlueGreenDeploymentsCard](../../../aws/Resource/Database/AmazonRdsBlueGreenDeploymentsCard.Local.png) | ![illustration for AmazonRdsBlueGreenDeploymentsGroup](../../../aws/Resource/Database/AmazonRdsBlueGreenDeploymentsGroup.Local.png) |
