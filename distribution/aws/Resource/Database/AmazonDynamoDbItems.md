...
```text
aws/Resource/Database/AmazonDynamoDbItems
```

```text
include('aws/Resource/Database/AmazonDynamoDbItems')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonDynamoDbItems.png) | ![illustration for AmazonDynamoDbItems](../../../aws/Resource/Database/AmazonDynamoDbItems.Local.png) | ![illustration for AmazonDynamoDbItemsCard](../../../aws/Resource/Database/AmazonDynamoDbItemsCard.Local.png) | ![illustration for AmazonDynamoDbItemsGroup](../../../aws/Resource/Database/AmazonDynamoDbItemsGroup.Local.png) |
