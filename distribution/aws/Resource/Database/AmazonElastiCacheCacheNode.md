...
```text
aws/Resource/Database/AmazonElastiCacheCacheNode
```

```text
include('aws/Resource/Database/AmazonElastiCacheCacheNode')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonElastiCacheCacheNode.png) | ![illustration for AmazonElastiCacheCacheNode](../../../aws/Resource/Database/AmazonElastiCacheCacheNode.Local.png) | ![illustration for AmazonElastiCacheCacheNodeCard](../../../aws/Resource/Database/AmazonElastiCacheCacheNodeCard.Local.png) | ![illustration for AmazonElastiCacheCacheNodeGroup](../../../aws/Resource/Database/AmazonElastiCacheCacheNodeGroup.Local.png) |
