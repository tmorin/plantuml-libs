...
```text
aws/Resource/Database/AmazonAuroraMariaDbInstance
```

```text
include('aws/Resource/Database/AmazonAuroraMariaDbInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonAuroraMariaDbInstance.png) | ![illustration for AmazonAuroraMariaDbInstance](../../../aws/Resource/Database/AmazonAuroraMariaDbInstance.Local.png) | ![illustration for AmazonAuroraMariaDbInstanceCard](../../../aws/Resource/Database/AmazonAuroraMariaDbInstanceCard.Local.png) | ![illustration for AmazonAuroraMariaDbInstanceGroup](../../../aws/Resource/Database/AmazonAuroraMariaDbInstanceGroup.Local.png) |
