...
```text
aws/Resource/Database/AmazonAuroraTrustedLanguageExtensionsForPostgreSql
```

```text
include('aws/Resource/Database/AmazonAuroraTrustedLanguageExtensionsForPostgreSql')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonAuroraTrustedLanguageExtensionsForPostgreSql.png) | ![illustration for AmazonAuroraTrustedLanguageExtensionsForPostgreSql](../../../aws/Resource/Database/AmazonAuroraTrustedLanguageExtensionsForPostgreSql.Local.png) | ![illustration for AmazonAuroraTrustedLanguageExtensionsForPostgreSqlCard](../../../aws/Resource/Database/AmazonAuroraTrustedLanguageExtensionsForPostgreSqlCard.Local.png) | ![illustration for AmazonAuroraTrustedLanguageExtensionsForPostgreSqlGroup](../../../aws/Resource/Database/AmazonAuroraTrustedLanguageExtensionsForPostgreSqlGroup.Local.png) |
