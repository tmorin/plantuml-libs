...
```text
aws/Resource/Database/AmazonAuroraInstance
```

```text
include('aws/Resource/Database/AmazonAuroraInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonAuroraInstance.png) | ![illustration for AmazonAuroraInstance](../../../aws/Resource/Database/AmazonAuroraInstance.Local.png) | ![illustration for AmazonAuroraInstanceCard](../../../aws/Resource/Database/AmazonAuroraInstanceCard.Local.png) | ![illustration for AmazonAuroraInstanceGroup](../../../aws/Resource/Database/AmazonAuroraInstanceGroup.Local.png) |
