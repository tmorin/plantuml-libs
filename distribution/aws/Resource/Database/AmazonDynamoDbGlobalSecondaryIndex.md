...
```text
aws/Resource/Database/AmazonDynamoDbGlobalSecondaryIndex
```

```text
include('aws/Resource/Database/AmazonDynamoDbGlobalSecondaryIndex')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonDynamoDbGlobalSecondaryIndex.png) | ![illustration for AmazonDynamoDbGlobalSecondaryIndex](../../../aws/Resource/Database/AmazonDynamoDbGlobalSecondaryIndex.Local.png) | ![illustration for AmazonDynamoDbGlobalSecondaryIndexCard](../../../aws/Resource/Database/AmazonDynamoDbGlobalSecondaryIndexCard.Local.png) | ![illustration for AmazonDynamoDbGlobalSecondaryIndexGroup](../../../aws/Resource/Database/AmazonDynamoDbGlobalSecondaryIndexGroup.Local.png) |
