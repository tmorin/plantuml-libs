...
```text
aws/Resource/Database/AmazonDynamoDbStream
```

```text
include('aws/Resource/Database/AmazonDynamoDbStream')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Database/AmazonDynamoDbStream.png) | ![illustration for AmazonDynamoDbStream](../../../aws/Resource/Database/AmazonDynamoDbStream.Local.png) | ![illustration for AmazonDynamoDbStreamCard](../../../aws/Resource/Database/AmazonDynamoDbStreamCard.Local.png) | ![illustration for AmazonDynamoDbStreamGroup](../../../aws/Resource/Database/AmazonDynamoDbStreamGroup.Local.png) |
