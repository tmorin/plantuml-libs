...
```text
aws/Resource/MediaServices/AwsCloudDigitalInterface
```

```text
include('aws/Resource/MediaServices/AwsCloudDigitalInterface')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/MediaServices/AwsCloudDigitalInterface.png) | ![illustration for AwsCloudDigitalInterface](../../../aws/Resource/MediaServices/AwsCloudDigitalInterface.Local.png) | ![illustration for AwsCloudDigitalInterfaceCard](../../../aws/Resource/MediaServices/AwsCloudDigitalInterfaceCard.Local.png) | ![illustration for AwsCloudDigitalInterfaceGroup](../../../aws/Resource/MediaServices/AwsCloudDigitalInterfaceGroup.Local.png) |
