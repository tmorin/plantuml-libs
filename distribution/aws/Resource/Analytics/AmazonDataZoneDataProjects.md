...
```text
aws/Resource/Analytics/AmazonDataZoneDataProjects
```

```text
include('aws/Resource/Analytics/AmazonDataZoneDataProjects')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonDataZoneDataProjects.png) | ![illustration for AmazonDataZoneDataProjects](../../../aws/Resource/Analytics/AmazonDataZoneDataProjects.Local.png) | ![illustration for AmazonDataZoneDataProjectsCard](../../../aws/Resource/Analytics/AmazonDataZoneDataProjectsCard.Local.png) | ![illustration for AmazonDataZoneDataProjectsGroup](../../../aws/Resource/Analytics/AmazonDataZoneDataProjectsGroup.Local.png) |
