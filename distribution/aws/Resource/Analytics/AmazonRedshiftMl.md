...
```text
aws/Resource/Analytics/AmazonRedshiftMl
```

```text
include('aws/Resource/Analytics/AmazonRedshiftMl')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonRedshiftMl.png) | ![illustration for AmazonRedshiftMl](../../../aws/Resource/Analytics/AmazonRedshiftMl.Local.png) | ![illustration for AmazonRedshiftMlCard](../../../aws/Resource/Analytics/AmazonRedshiftMlCard.Local.png) | ![illustration for AmazonRedshiftMlGroup](../../../aws/Resource/Analytics/AmazonRedshiftMlGroup.Local.png) |
