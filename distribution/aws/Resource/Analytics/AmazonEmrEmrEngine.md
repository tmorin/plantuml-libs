...
```text
aws/Resource/Analytics/AmazonEmrEmrEngine
```

```text
include('aws/Resource/Analytics/AmazonEmrEmrEngine')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonEmrEmrEngine.png) | ![illustration for AmazonEmrEmrEngine](../../../aws/Resource/Analytics/AmazonEmrEmrEngine.Local.png) | ![illustration for AmazonEmrEmrEngineCard](../../../aws/Resource/Analytics/AmazonEmrEmrEngineCard.Local.png) | ![illustration for AmazonEmrEmrEngineGroup](../../../aws/Resource/Analytics/AmazonEmrEmrEngineGroup.Local.png) |
