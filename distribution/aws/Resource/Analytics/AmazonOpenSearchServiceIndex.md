...
```text
aws/Resource/Analytics/AmazonOpenSearchServiceIndex
```

```text
include('aws/Resource/Analytics/AmazonOpenSearchServiceIndex')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonOpenSearchServiceIndex.png) | ![illustration for AmazonOpenSearchServiceIndex](../../../aws/Resource/Analytics/AmazonOpenSearchServiceIndex.Local.png) | ![illustration for AmazonOpenSearchServiceIndexCard](../../../aws/Resource/Analytics/AmazonOpenSearchServiceIndexCard.Local.png) | ![illustration for AmazonOpenSearchServiceIndexGroup](../../../aws/Resource/Analytics/AmazonOpenSearchServiceIndexGroup.Local.png) |
