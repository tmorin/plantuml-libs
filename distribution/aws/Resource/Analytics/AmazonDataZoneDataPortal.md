...
```text
aws/Resource/Analytics/AmazonDataZoneDataPortal
```

```text
include('aws/Resource/Analytics/AmazonDataZoneDataPortal')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonDataZoneDataPortal.png) | ![illustration for AmazonDataZoneDataPortal](../../../aws/Resource/Analytics/AmazonDataZoneDataPortal.Local.png) | ![illustration for AmazonDataZoneDataPortalCard](../../../aws/Resource/Analytics/AmazonDataZoneDataPortalCard.Local.png) | ![illustration for AmazonDataZoneDataPortalGroup](../../../aws/Resource/Analytics/AmazonDataZoneDataPortalGroup.Local.png) |
