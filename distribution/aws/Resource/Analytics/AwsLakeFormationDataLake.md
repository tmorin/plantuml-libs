...
```text
aws/Resource/Analytics/AwsLakeFormationDataLake
```

```text
include('aws/Resource/Analytics/AwsLakeFormationDataLake')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AwsLakeFormationDataLake.png) | ![illustration for AwsLakeFormationDataLake](../../../aws/Resource/Analytics/AwsLakeFormationDataLake.Local.png) | ![illustration for AwsLakeFormationDataLakeCard](../../../aws/Resource/Analytics/AwsLakeFormationDataLakeCard.Local.png) | ![illustration for AwsLakeFormationDataLakeGroup](../../../aws/Resource/Analytics/AwsLakeFormationDataLakeGroup.Local.png) |
