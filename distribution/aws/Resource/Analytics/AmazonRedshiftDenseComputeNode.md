...
```text
aws/Resource/Analytics/AmazonRedshiftDenseComputeNode
```

```text
include('aws/Resource/Analytics/AmazonRedshiftDenseComputeNode')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonRedshiftDenseComputeNode.png) | ![illustration for AmazonRedshiftDenseComputeNode](../../../aws/Resource/Analytics/AmazonRedshiftDenseComputeNode.Local.png) | ![illustration for AmazonRedshiftDenseComputeNodeCard](../../../aws/Resource/Analytics/AmazonRedshiftDenseComputeNodeCard.Local.png) | ![illustration for AmazonRedshiftDenseComputeNodeGroup](../../../aws/Resource/Analytics/AmazonRedshiftDenseComputeNodeGroup.Local.png) |
