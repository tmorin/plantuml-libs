...
```text
aws/Resource/Analytics/AwsGlueDataCatalog
```

```text
include('aws/Resource/Analytics/AwsGlueDataCatalog')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AwsGlueDataCatalog.png) | ![illustration for AwsGlueDataCatalog](../../../aws/Resource/Analytics/AwsGlueDataCatalog.Local.png) | ![illustration for AwsGlueDataCatalogCard](../../../aws/Resource/Analytics/AwsGlueDataCatalogCard.Local.png) | ![illustration for AwsGlueDataCatalogGroup](../../../aws/Resource/Analytics/AwsGlueDataCatalogGroup.Local.png) |
