...
```text
aws/Resource/Analytics/AmazonOpenSearchServiceOpenSearchIngestion
```

```text
include('aws/Resource/Analytics/AmazonOpenSearchServiceOpenSearchIngestion')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonOpenSearchServiceOpenSearchIngestion.png) | ![illustration for AmazonOpenSearchServiceOpenSearchIngestion](../../../aws/Resource/Analytics/AmazonOpenSearchServiceOpenSearchIngestion.Local.png) | ![illustration for AmazonOpenSearchServiceOpenSearchIngestionCard](../../../aws/Resource/Analytics/AmazonOpenSearchServiceOpenSearchIngestionCard.Local.png) | ![illustration for AmazonOpenSearchServiceOpenSearchIngestionGroup](../../../aws/Resource/Analytics/AmazonOpenSearchServiceOpenSearchIngestionGroup.Local.png) |
