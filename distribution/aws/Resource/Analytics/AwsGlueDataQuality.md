...
```text
aws/Resource/Analytics/AwsGlueDataQuality
```

```text
include('aws/Resource/Analytics/AwsGlueDataQuality')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AwsGlueDataQuality.png) | ![illustration for AwsGlueDataQuality](../../../aws/Resource/Analytics/AwsGlueDataQuality.Local.png) | ![illustration for AwsGlueDataQualityCard](../../../aws/Resource/Analytics/AwsGlueDataQualityCard.Local.png) | ![illustration for AwsGlueDataQualityGroup](../../../aws/Resource/Analytics/AwsGlueDataQualityGroup.Local.png) |
