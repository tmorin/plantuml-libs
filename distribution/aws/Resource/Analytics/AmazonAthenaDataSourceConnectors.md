...
```text
aws/Resource/Analytics/AmazonAthenaDataSourceConnectors
```

```text
include('aws/Resource/Analytics/AmazonAthenaDataSourceConnectors')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonAthenaDataSourceConnectors.png) | ![illustration for AmazonAthenaDataSourceConnectors](../../../aws/Resource/Analytics/AmazonAthenaDataSourceConnectors.Local.png) | ![illustration for AmazonAthenaDataSourceConnectorsCard](../../../aws/Resource/Analytics/AmazonAthenaDataSourceConnectorsCard.Local.png) | ![illustration for AmazonAthenaDataSourceConnectorsGroup](../../../aws/Resource/Analytics/AmazonAthenaDataSourceConnectorsGroup.Local.png) |
