...
```text
aws/Resource/Analytics/AmazonOpenSearchServiceTraces
```

```text
include('aws/Resource/Analytics/AmazonOpenSearchServiceTraces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonOpenSearchServiceTraces.png) | ![illustration for AmazonOpenSearchServiceTraces](../../../aws/Resource/Analytics/AmazonOpenSearchServiceTraces.Local.png) | ![illustration for AmazonOpenSearchServiceTracesCard](../../../aws/Resource/Analytics/AmazonOpenSearchServiceTracesCard.Local.png) | ![illustration for AmazonOpenSearchServiceTracesGroup](../../../aws/Resource/Analytics/AmazonOpenSearchServiceTracesGroup.Local.png) |
