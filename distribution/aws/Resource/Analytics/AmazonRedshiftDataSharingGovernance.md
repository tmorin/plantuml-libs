...
```text
aws/Resource/Analytics/AmazonRedshiftDataSharingGovernance
```

```text
include('aws/Resource/Analytics/AmazonRedshiftDataSharingGovernance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonRedshiftDataSharingGovernance.png) | ![illustration for AmazonRedshiftDataSharingGovernance](../../../aws/Resource/Analytics/AmazonRedshiftDataSharingGovernance.Local.png) | ![illustration for AmazonRedshiftDataSharingGovernanceCard](../../../aws/Resource/Analytics/AmazonRedshiftDataSharingGovernanceCard.Local.png) | ![illustration for AmazonRedshiftDataSharingGovernanceGroup](../../../aws/Resource/Analytics/AmazonRedshiftDataSharingGovernanceGroup.Local.png) |
