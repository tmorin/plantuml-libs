...
```text
aws/Resource/Analytics/AmazonOpenSearchServiceUltraWarmNode
```

```text
include('aws/Resource/Analytics/AmazonOpenSearchServiceUltraWarmNode')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonOpenSearchServiceUltraWarmNode.png) | ![illustration for AmazonOpenSearchServiceUltraWarmNode](../../../aws/Resource/Analytics/AmazonOpenSearchServiceUltraWarmNode.Local.png) | ![illustration for AmazonOpenSearchServiceUltraWarmNodeCard](../../../aws/Resource/Analytics/AmazonOpenSearchServiceUltraWarmNodeCard.Local.png) | ![illustration for AmazonOpenSearchServiceUltraWarmNodeGroup](../../../aws/Resource/Analytics/AmazonOpenSearchServiceUltraWarmNodeGroup.Local.png) |
