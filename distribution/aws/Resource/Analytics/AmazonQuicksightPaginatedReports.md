...
```text
aws/Resource/Analytics/AmazonQuicksightPaginatedReports
```

```text
include('aws/Resource/Analytics/AmazonQuicksightPaginatedReports')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonQuicksightPaginatedReports.png) | ![illustration for AmazonQuicksightPaginatedReports](../../../aws/Resource/Analytics/AmazonQuicksightPaginatedReports.Local.png) | ![illustration for AmazonQuicksightPaginatedReportsCard](../../../aws/Resource/Analytics/AmazonQuicksightPaginatedReportsCard.Local.png) | ![illustration for AmazonQuicksightPaginatedReportsGroup](../../../aws/Resource/Analytics/AmazonQuicksightPaginatedReportsGroup.Local.png) |
