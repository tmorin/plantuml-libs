...
```text
aws/Resource/Analytics/AmazonRedshiftStreamingIngestion
```

```text
include('aws/Resource/Analytics/AmazonRedshiftStreamingIngestion')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AmazonRedshiftStreamingIngestion.png) | ![illustration for AmazonRedshiftStreamingIngestion](../../../aws/Resource/Analytics/AmazonRedshiftStreamingIngestion.Local.png) | ![illustration for AmazonRedshiftStreamingIngestionCard](../../../aws/Resource/Analytics/AmazonRedshiftStreamingIngestionCard.Local.png) | ![illustration for AmazonRedshiftStreamingIngestionGroup](../../../aws/Resource/Analytics/AmazonRedshiftStreamingIngestionGroup.Local.png) |
