...
```text
aws/Resource/Analytics/AwsGlueAwsGlueForRay
```

```text
include('aws/Resource/Analytics/AwsGlueAwsGlueForRay')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Analytics/AwsGlueAwsGlueForRay.png) | ![illustration for AwsGlueAwsGlueForRay](../../../aws/Resource/Analytics/AwsGlueAwsGlueForRay.Local.png) | ![illustration for AwsGlueAwsGlueForRayCard](../../../aws/Resource/Analytics/AwsGlueAwsGlueForRayCard.Local.png) | ![illustration for AwsGlueAwsGlueForRayGroup](../../../aws/Resource/Analytics/AwsGlueAwsGlueForRayGroup.Local.png) |
