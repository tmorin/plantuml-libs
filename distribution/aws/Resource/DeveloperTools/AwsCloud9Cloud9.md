...
```text
aws/Resource/DeveloperTools/AwsCloud9Cloud9
```

```text
include('aws/Resource/DeveloperTools/AwsCloud9Cloud9')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/DeveloperTools/AwsCloud9Cloud9.png) | ![illustration for AwsCloud9Cloud9](../../../aws/Resource/DeveloperTools/AwsCloud9Cloud9.Local.png) | ![illustration for AwsCloud9Cloud9Card](../../../aws/Resource/DeveloperTools/AwsCloud9Cloud9Card.Local.png) | ![illustration for AwsCloud9Cloud9Group](../../../aws/Resource/DeveloperTools/AwsCloud9Cloud9Group.Local.png) |
