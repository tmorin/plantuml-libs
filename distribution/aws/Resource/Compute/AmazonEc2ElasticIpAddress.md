...
```text
aws/Resource/Compute/AmazonEc2ElasticIpAddress
```

```text
include('aws/Resource/Compute/AmazonEc2ElasticIpAddress')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Compute/AmazonEc2ElasticIpAddress.png) | ![illustration for AmazonEc2ElasticIpAddress](../../../aws/Resource/Compute/AmazonEc2ElasticIpAddress.Local.png) | ![illustration for AmazonEc2ElasticIpAddressCard](../../../aws/Resource/Compute/AmazonEc2ElasticIpAddressCard.Local.png) | ![illustration for AmazonEc2ElasticIpAddressGroup](../../../aws/Resource/Compute/AmazonEc2ElasticIpAddressGroup.Local.png) |
