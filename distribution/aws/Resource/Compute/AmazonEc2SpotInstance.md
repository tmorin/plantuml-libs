...
```text
aws/Resource/Compute/AmazonEc2SpotInstance
```

```text
include('aws/Resource/Compute/AmazonEc2SpotInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Compute/AmazonEc2SpotInstance.png) | ![illustration for AmazonEc2SpotInstance](../../../aws/Resource/Compute/AmazonEc2SpotInstance.Local.png) | ![illustration for AmazonEc2SpotInstanceCard](../../../aws/Resource/Compute/AmazonEc2SpotInstanceCard.Local.png) | ![illustration for AmazonEc2SpotInstanceGroup](../../../aws/Resource/Compute/AmazonEc2SpotInstanceGroup.Local.png) |
