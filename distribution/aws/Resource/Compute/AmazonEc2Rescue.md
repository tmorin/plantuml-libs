...
```text
aws/Resource/Compute/AmazonEc2Rescue
```

```text
include('aws/Resource/Compute/AmazonEc2Rescue')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Compute/AmazonEc2Rescue.png) | ![illustration for AmazonEc2Rescue](../../../aws/Resource/Compute/AmazonEc2Rescue.Local.png) | ![illustration for AmazonEc2RescueCard](../../../aws/Resource/Compute/AmazonEc2RescueCard.Local.png) | ![illustration for AmazonEc2RescueGroup](../../../aws/Resource/Compute/AmazonEc2RescueGroup.Local.png) |
