...
```text
aws/Resource/Compute/AmazonEc2Ami
```

```text
include('aws/Resource/Compute/AmazonEc2Ami')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Compute/AmazonEc2Ami.png) | ![illustration for AmazonEc2Ami](../../../aws/Resource/Compute/AmazonEc2Ami.Local.png) | ![illustration for AmazonEc2AmiCard](../../../aws/Resource/Compute/AmazonEc2AmiCard.Local.png) | ![illustration for AmazonEc2AmiGroup](../../../aws/Resource/Compute/AmazonEc2AmiGroup.Local.png) |
