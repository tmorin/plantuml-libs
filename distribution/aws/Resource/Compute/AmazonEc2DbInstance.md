...
```text
aws/Resource/Compute/AmazonEc2DbInstance
```

```text
include('aws/Resource/Compute/AmazonEc2DbInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Compute/AmazonEc2DbInstance.png) | ![illustration for AmazonEc2DbInstance](../../../aws/Resource/Compute/AmazonEc2DbInstance.Local.png) | ![illustration for AmazonEc2DbInstanceCard](../../../aws/Resource/Compute/AmazonEc2DbInstanceCard.Local.png) | ![illustration for AmazonEc2DbInstanceGroup](../../../aws/Resource/Compute/AmazonEc2DbInstanceGroup.Local.png) |
