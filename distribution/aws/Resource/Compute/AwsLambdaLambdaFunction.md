...
```text
aws/Resource/Compute/AwsLambdaLambdaFunction
```

```text
include('aws/Resource/Compute/AwsLambdaLambdaFunction')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Compute/AwsLambdaLambdaFunction.png) | ![illustration for AwsLambdaLambdaFunction](../../../aws/Resource/Compute/AwsLambdaLambdaFunction.Local.png) | ![illustration for AwsLambdaLambdaFunctionCard](../../../aws/Resource/Compute/AwsLambdaLambdaFunctionCard.Local.png) | ![illustration for AwsLambdaLambdaFunctionGroup](../../../aws/Resource/Compute/AwsLambdaLambdaFunctionGroup.Local.png) |
