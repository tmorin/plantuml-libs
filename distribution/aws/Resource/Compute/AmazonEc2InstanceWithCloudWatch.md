...
```text
aws/Resource/Compute/AmazonEc2InstanceWithCloudWatch
```

```text
include('aws/Resource/Compute/AmazonEc2InstanceWithCloudWatch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Compute/AmazonEc2InstanceWithCloudWatch.png) | ![illustration for AmazonEc2InstanceWithCloudWatch](../../../aws/Resource/Compute/AmazonEc2InstanceWithCloudWatch.Local.png) | ![illustration for AmazonEc2InstanceWithCloudWatchCard](../../../aws/Resource/Compute/AmazonEc2InstanceWithCloudWatchCard.Local.png) | ![illustration for AmazonEc2InstanceWithCloudWatchGroup](../../../aws/Resource/Compute/AmazonEc2InstanceWithCloudWatchGroup.Local.png) |
