...
```text
aws/Resource/GroupIcons/AwsIoTGreengrassDeployment
```

```text
include('aws/Resource/GroupIcons/AwsIoTGreengrassDeployment')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GroupIcons/AwsIoTGreengrassDeployment.png) | ![illustration for AwsIoTGreengrassDeployment](../../../aws/Resource/GroupIcons/AwsIoTGreengrassDeployment.Local.png) | ![illustration for AwsIoTGreengrassDeploymentCard](../../../aws/Resource/GroupIcons/AwsIoTGreengrassDeploymentCard.Local.png) | ![illustration for AwsIoTGreengrassDeploymentGroup](../../../aws/Resource/GroupIcons/AwsIoTGreengrassDeploymentGroup.Local.png) |
