...
```text
aws/Resource/GroupIcons/AwsCloudLogo
```

```text
include('aws/Resource/GroupIcons/AwsCloudLogo')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GroupIcons/AwsCloudLogo.png) | ![illustration for AwsCloudLogo](../../../aws/Resource/GroupIcons/AwsCloudLogo.Local.png) | ![illustration for AwsCloudLogoCard](../../../aws/Resource/GroupIcons/AwsCloudLogoCard.Local.png) | ![illustration for AwsCloudLogoGroup](../../../aws/Resource/GroupIcons/AwsCloudLogoGroup.Local.png) |
