...
```text
aws/Resource/GroupIcons/AutoScalingGroup
```

```text
include('aws/Resource/GroupIcons/AutoScalingGroup')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GroupIcons/AutoScalingGroup.png) | ![illustration for AutoScalingGroup](../../../aws/Resource/GroupIcons/AutoScalingGroup.Local.png) | ![illustration for AutoScalingGroupCard](../../../aws/Resource/GroupIcons/AutoScalingGroupCard.Local.png) | ![illustration for AutoScalingGroupGroup](../../../aws/Resource/GroupIcons/AutoScalingGroupGroup.Local.png) |
