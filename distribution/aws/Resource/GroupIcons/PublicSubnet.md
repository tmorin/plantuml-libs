...
```text
aws/Resource/GroupIcons/PublicSubnet
```

```text
include('aws/Resource/GroupIcons/PublicSubnet')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GroupIcons/PublicSubnet.png) | ![illustration for PublicSubnet](../../../aws/Resource/GroupIcons/PublicSubnet.Local.png) | ![illustration for PublicSubnetCard](../../../aws/Resource/GroupIcons/PublicSubnetCard.Local.png) | ![illustration for PublicSubnetGroup](../../../aws/Resource/GroupIcons/PublicSubnetGroup.Local.png) |
