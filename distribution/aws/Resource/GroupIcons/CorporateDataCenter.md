...
```text
aws/Resource/GroupIcons/CorporateDataCenter
```

```text
include('aws/Resource/GroupIcons/CorporateDataCenter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GroupIcons/CorporateDataCenter.png) | ![illustration for CorporateDataCenter](../../../aws/Resource/GroupIcons/CorporateDataCenter.Local.png) | ![illustration for CorporateDataCenterCard](../../../aws/Resource/GroupIcons/CorporateDataCenterCard.Local.png) | ![illustration for CorporateDataCenterGroup](../../../aws/Resource/GroupIcons/CorporateDataCenterGroup.Local.png) |
