...
```text
aws/Resource/GroupIcons/AwsAccount
```

```text
include('aws/Resource/GroupIcons/AwsAccount')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GroupIcons/AwsAccount.png) | ![illustration for AwsAccount](../../../aws/Resource/GroupIcons/AwsAccount.Local.png) | ![illustration for AwsAccountCard](../../../aws/Resource/GroupIcons/AwsAccountCard.Local.png) | ![illustration for AwsAccountGroup](../../../aws/Resource/GroupIcons/AwsAccountGroup.Local.png) |
