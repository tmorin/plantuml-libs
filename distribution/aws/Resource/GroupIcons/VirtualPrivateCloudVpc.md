...
```text
aws/Resource/GroupIcons/VirtualPrivateCloudVpc
```

```text
include('aws/Resource/GroupIcons/VirtualPrivateCloudVpc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GroupIcons/VirtualPrivateCloudVpc.png) | ![illustration for VirtualPrivateCloudVpc](../../../aws/Resource/GroupIcons/VirtualPrivateCloudVpc.Local.png) | ![illustration for VirtualPrivateCloudVpcCard](../../../aws/Resource/GroupIcons/VirtualPrivateCloudVpcCard.Local.png) | ![illustration for VirtualPrivateCloudVpcGroup](../../../aws/Resource/GroupIcons/VirtualPrivateCloudVpcGroup.Local.png) |
