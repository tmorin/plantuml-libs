...
```text
aws/Resource/GroupIcons/Cloud
```

```text
include('aws/Resource/GroupIcons/Cloud')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GroupIcons/Cloud.png) | ![illustration for Cloud](../../../aws/Resource/GroupIcons/Cloud.Local.png) | ![illustration for CloudCard](../../../aws/Resource/GroupIcons/CloudCard.Local.png) | ![illustration for CloudGroup](../../../aws/Resource/GroupIcons/CloudGroup.Local.png) |
