...
```text
aws/Resource/GroupIcons/PrivateSubnet
```

```text
include('aws/Resource/GroupIcons/PrivateSubnet')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GroupIcons/PrivateSubnet.png) | ![illustration for PrivateSubnet](../../../aws/Resource/GroupIcons/PrivateSubnet.Local.png) | ![illustration for PrivateSubnetCard](../../../aws/Resource/GroupIcons/PrivateSubnetCard.Local.png) | ![illustration for PrivateSubnetGroup](../../../aws/Resource/GroupIcons/PrivateSubnetGroup.Local.png) |
