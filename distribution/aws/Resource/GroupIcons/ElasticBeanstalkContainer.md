...
```text
aws/Resource/GroupIcons/ElasticBeanstalkContainer
```

```text
include('aws/Resource/GroupIcons/ElasticBeanstalkContainer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GroupIcons/ElasticBeanstalkContainer.png) | ![illustration for ElasticBeanstalkContainer](../../../aws/Resource/GroupIcons/ElasticBeanstalkContainer.Local.png) | ![illustration for ElasticBeanstalkContainerCard](../../../aws/Resource/GroupIcons/ElasticBeanstalkContainerCard.Local.png) | ![illustration for ElasticBeanstalkContainerGroup](../../../aws/Resource/GroupIcons/ElasticBeanstalkContainerGroup.Local.png) |
