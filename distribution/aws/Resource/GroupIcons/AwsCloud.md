...
```text
aws/Resource/GroupIcons/AwsCloud
```

```text
include('aws/Resource/GroupIcons/AwsCloud')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/GroupIcons/AwsCloud.png) | ![illustration for AwsCloud](../../../aws/Resource/GroupIcons/AwsCloud.Local.png) | ![illustration for AwsCloudCard](../../../aws/Resource/GroupIcons/AwsCloudCard.Local.png) | ![illustration for AwsCloudGroup](../../../aws/Resource/GroupIcons/AwsCloudGroup.Local.png) |
