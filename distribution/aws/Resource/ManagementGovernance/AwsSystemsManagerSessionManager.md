...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerSessionManager
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerSessionManager')
```
