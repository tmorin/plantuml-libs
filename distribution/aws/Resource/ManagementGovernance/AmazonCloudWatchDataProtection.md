...
```text
aws/Resource/ManagementGovernance/AmazonCloudWatchDataProtection
```

```text
include('aws/Resource/ManagementGovernance/AmazonCloudWatchDataProtection')
```
