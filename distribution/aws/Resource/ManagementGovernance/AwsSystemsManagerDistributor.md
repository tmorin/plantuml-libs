...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerDistributor
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerDistributor')
```
