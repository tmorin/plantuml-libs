...
```text
aws/Resource/ManagementGovernance/AwsTrustedAdvisorChecklist
```

```text
include('aws/Resource/ManagementGovernance/AwsTrustedAdvisorChecklist')
```
