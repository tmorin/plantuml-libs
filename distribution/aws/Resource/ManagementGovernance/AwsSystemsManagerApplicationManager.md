...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerApplicationManager
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerApplicationManager')
```
