...
```text
aws/Resource/ManagementGovernance/AmazonCloudWatchSynthetics
```

```text
include('aws/Resource/ManagementGovernance/AmazonCloudWatchSynthetics')
```
