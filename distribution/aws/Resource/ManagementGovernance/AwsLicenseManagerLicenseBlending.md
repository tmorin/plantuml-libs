...
```text
aws/Resource/ManagementGovernance/AwsLicenseManagerLicenseBlending
```

```text
include('aws/Resource/ManagementGovernance/AwsLicenseManagerLicenseBlending')
```
