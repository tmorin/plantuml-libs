...
```text
aws/Resource/ManagementGovernance/AmazonCloudWatchMetricsInsights
```

```text
include('aws/Resource/ManagementGovernance/AmazonCloudWatchMetricsInsights')
```
