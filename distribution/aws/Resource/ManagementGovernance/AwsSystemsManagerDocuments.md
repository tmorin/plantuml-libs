...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerDocuments
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerDocuments')
```
