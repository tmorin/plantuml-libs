...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerParameterStore
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerParameterStore')
```
