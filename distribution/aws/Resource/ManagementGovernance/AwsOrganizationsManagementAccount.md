...
```text
aws/Resource/ManagementGovernance/AwsOrganizationsManagementAccount
```

```text
include('aws/Resource/ManagementGovernance/AwsOrganizationsManagementAccount')
```
