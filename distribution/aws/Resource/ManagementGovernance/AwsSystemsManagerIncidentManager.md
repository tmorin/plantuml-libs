...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerIncidentManager
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerIncidentManager')
```
