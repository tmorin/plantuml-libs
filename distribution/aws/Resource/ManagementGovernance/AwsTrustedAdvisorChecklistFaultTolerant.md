...
```text
aws/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistFaultTolerant
```

```text
include('aws/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistFaultTolerant')
```
