...
```text
aws/Resource/ManagementGovernance/AmazonCloudWatchCrossAccountObservability
```

```text
include('aws/Resource/ManagementGovernance/AmazonCloudWatchCrossAccountObservability')
```
