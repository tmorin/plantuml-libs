...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerRunCommand
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerRunCommand')
```
