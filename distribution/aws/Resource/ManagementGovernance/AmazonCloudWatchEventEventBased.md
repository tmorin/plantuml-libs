...
```text
aws/Resource/ManagementGovernance/AmazonCloudWatchEventEventBased
```

```text
include('aws/Resource/ManagementGovernance/AmazonCloudWatchEventEventBased')
```
