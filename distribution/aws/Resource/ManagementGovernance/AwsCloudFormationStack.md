...
```text
aws/Resource/ManagementGovernance/AwsCloudFormationStack
```

```text
include('aws/Resource/ManagementGovernance/AwsCloudFormationStack')
```
