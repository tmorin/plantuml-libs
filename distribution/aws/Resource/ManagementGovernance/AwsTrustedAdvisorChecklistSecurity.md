...
```text
aws/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistSecurity
```

```text
include('aws/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistSecurity')
```
