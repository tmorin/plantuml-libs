...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerStateManager
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerStateManager')
```
