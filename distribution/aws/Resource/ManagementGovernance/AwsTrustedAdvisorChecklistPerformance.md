...
```text
aws/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistPerformance
```

```text
include('aws/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistPerformance')
```
