...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerOpsCenter
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerOpsCenter')
```
