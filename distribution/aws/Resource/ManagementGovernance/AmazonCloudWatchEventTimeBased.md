...
```text
aws/Resource/ManagementGovernance/AmazonCloudWatchEventTimeBased
```

```text
include('aws/Resource/ManagementGovernance/AmazonCloudWatchEventTimeBased')
```
