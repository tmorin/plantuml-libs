...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerPatchManager
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerPatchManager')
```
