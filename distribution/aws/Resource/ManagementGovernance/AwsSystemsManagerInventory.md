...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerInventory
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerInventory')
```
