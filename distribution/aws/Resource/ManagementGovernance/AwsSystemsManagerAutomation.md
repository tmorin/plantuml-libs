...
```text
aws/Resource/ManagementGovernance/AwsSystemsManagerAutomation
```

```text
include('aws/Resource/ManagementGovernance/AwsSystemsManagerAutomation')
```
