...
```text
aws/Resource/ManagementGovernance/AwsOrganizationsAccount
```

```text
include('aws/Resource/ManagementGovernance/AwsOrganizationsAccount')
```
