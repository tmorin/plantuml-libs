...
```text
aws/Resource/SecurityIdentityCompliance/AwsKeyManagementServiceExternalKeyStore
```

```text
include('aws/Resource/SecurityIdentityCompliance/AwsKeyManagementServiceExternalKeyStore')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/SecurityIdentityCompliance/AwsKeyManagementServiceExternalKeyStore.png) | ![illustration for AwsKeyManagementServiceExternalKeyStore](../../../aws/Resource/SecurityIdentityCompliance/AwsKeyManagementServiceExternalKeyStore.Local.png) | ![illustration for AwsKeyManagementServiceExternalKeyStoreCard](../../../aws/Resource/SecurityIdentityCompliance/AwsKeyManagementServiceExternalKeyStoreCard.Local.png) | ![illustration for AwsKeyManagementServiceExternalKeyStoreGroup](../../../aws/Resource/SecurityIdentityCompliance/AwsKeyManagementServiceExternalKeyStoreGroup.Local.png) |
