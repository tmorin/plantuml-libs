...
```text
aws/Resource/SecurityIdentityCompliance/AwsWafFilteringRule
```

```text
include('aws/Resource/SecurityIdentityCompliance/AwsWafFilteringRule')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/SecurityIdentityCompliance/AwsWafFilteringRule.png) | ![illustration for AwsWafFilteringRule](../../../aws/Resource/SecurityIdentityCompliance/AwsWafFilteringRule.Local.png) | ![illustration for AwsWafFilteringRuleCard](../../../aws/Resource/SecurityIdentityCompliance/AwsWafFilteringRuleCard.Local.png) | ![illustration for AwsWafFilteringRuleGroup](../../../aws/Resource/SecurityIdentityCompliance/AwsWafFilteringRuleGroup.Local.png) |
