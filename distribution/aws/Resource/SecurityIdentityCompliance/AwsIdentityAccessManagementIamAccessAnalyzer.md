...
```text
aws/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementIamAccessAnalyzer
```

```text
include('aws/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementIamAccessAnalyzer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementIamAccessAnalyzer.png) | ![illustration for AwsIdentityAccessManagementIamAccessAnalyzer](../../../aws/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementIamAccessAnalyzer.Local.png) | ![illustration for AwsIdentityAccessManagementIamAccessAnalyzerCard](../../../aws/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementIamAccessAnalyzerCard.Local.png) | ![illustration for AwsIdentityAccessManagementIamAccessAnalyzerGroup](../../../aws/Resource/SecurityIdentityCompliance/AwsIdentityAccessManagementIamAccessAnalyzerGroup.Local.png) |
