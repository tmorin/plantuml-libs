...
```text
aws/Resource/SecurityIdentityCompliance/AwsWafBotControl
```

```text
include('aws/Resource/SecurityIdentityCompliance/AwsWafBotControl')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/SecurityIdentityCompliance/AwsWafBotControl.png) | ![illustration for AwsWafBotControl](../../../aws/Resource/SecurityIdentityCompliance/AwsWafBotControl.Local.png) | ![illustration for AwsWafBotControlCard](../../../aws/Resource/SecurityIdentityCompliance/AwsWafBotControlCard.Local.png) | ![illustration for AwsWafBotControlGroup](../../../aws/Resource/SecurityIdentityCompliance/AwsWafBotControlGroup.Local.png) |
