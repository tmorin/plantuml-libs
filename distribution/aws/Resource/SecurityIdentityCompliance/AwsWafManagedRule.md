...
```text
aws/Resource/SecurityIdentityCompliance/AwsWafManagedRule
```

```text
include('aws/Resource/SecurityIdentityCompliance/AwsWafManagedRule')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/SecurityIdentityCompliance/AwsWafManagedRule.png) | ![illustration for AwsWafManagedRule](../../../aws/Resource/SecurityIdentityCompliance/AwsWafManagedRule.Local.png) | ![illustration for AwsWafManagedRuleCard](../../../aws/Resource/SecurityIdentityCompliance/AwsWafManagedRuleCard.Local.png) | ![illustration for AwsWafManagedRuleGroup](../../../aws/Resource/SecurityIdentityCompliance/AwsWafManagedRuleGroup.Local.png) |
