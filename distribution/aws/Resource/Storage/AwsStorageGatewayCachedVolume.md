...
```text
aws/Resource/Storage/AwsStorageGatewayCachedVolume
```

```text
include('aws/Resource/Storage/AwsStorageGatewayCachedVolume')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsStorageGatewayCachedVolume.png) | ![illustration for AwsStorageGatewayCachedVolume](../../../aws/Resource/Storage/AwsStorageGatewayCachedVolume.Local.png) | ![illustration for AwsStorageGatewayCachedVolumeCard](../../../aws/Resource/Storage/AwsStorageGatewayCachedVolumeCard.Local.png) | ![illustration for AwsStorageGatewayCachedVolumeGroup](../../../aws/Resource/Storage/AwsStorageGatewayCachedVolumeGroup.Local.png) |
