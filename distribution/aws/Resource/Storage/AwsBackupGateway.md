...
```text
aws/Resource/Storage/AwsBackupGateway
```

```text
include('aws/Resource/Storage/AwsBackupGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsBackupGateway.png) | ![illustration for AwsBackupGateway](../../../aws/Resource/Storage/AwsBackupGateway.Local.png) | ![illustration for AwsBackupGatewayCard](../../../aws/Resource/Storage/AwsBackupGatewayCard.Local.png) | ![illustration for AwsBackupGatewayGroup](../../../aws/Resource/Storage/AwsBackupGatewayGroup.Local.png) |
