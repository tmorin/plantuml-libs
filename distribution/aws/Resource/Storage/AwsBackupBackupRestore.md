...
```text
aws/Resource/Storage/AwsBackupBackupRestore
```

```text
include('aws/Resource/Storage/AwsBackupBackupRestore')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsBackupBackupRestore.png) | ![illustration for AwsBackupBackupRestore](../../../aws/Resource/Storage/AwsBackupBackupRestore.Local.png) | ![illustration for AwsBackupBackupRestoreCard](../../../aws/Resource/Storage/AwsBackupBackupRestoreCard.Local.png) | ![illustration for AwsBackupBackupRestoreGroup](../../../aws/Resource/Storage/AwsBackupBackupRestoreGroup.Local.png) |
