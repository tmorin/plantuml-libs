...
```text
aws/Resource/Storage/AwsBackupDatabase
```

```text
include('aws/Resource/Storage/AwsBackupDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsBackupDatabase.png) | ![illustration for AwsBackupDatabase](../../../aws/Resource/Storage/AwsBackupDatabase.Local.png) | ![illustration for AwsBackupDatabaseCard](../../../aws/Resource/Storage/AwsBackupDatabaseCard.Local.png) | ![illustration for AwsBackupDatabaseGroup](../../../aws/Resource/Storage/AwsBackupDatabaseGroup.Local.png) |
