...
```text
aws/Resource/Storage/AwsBackupComplianceReporting
```

```text
include('aws/Resource/Storage/AwsBackupComplianceReporting')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsBackupComplianceReporting.png) | ![illustration for AwsBackupComplianceReporting](../../../aws/Resource/Storage/AwsBackupComplianceReporting.Local.png) | ![illustration for AwsBackupComplianceReportingCard](../../../aws/Resource/Storage/AwsBackupComplianceReportingCard.Local.png) | ![illustration for AwsBackupComplianceReportingGroup](../../../aws/Resource/Storage/AwsBackupComplianceReportingGroup.Local.png) |
