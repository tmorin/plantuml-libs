...
```text
aws/Resource/Storage/AwsBackupAuditManager
```

```text
include('aws/Resource/Storage/AwsBackupAuditManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsBackupAuditManager.png) | ![illustration for AwsBackupAuditManager](../../../aws/Resource/Storage/AwsBackupAuditManager.Local.png) | ![illustration for AwsBackupAuditManagerCard](../../../aws/Resource/Storage/AwsBackupAuditManagerCard.Local.png) | ![illustration for AwsBackupAuditManagerGroup](../../../aws/Resource/Storage/AwsBackupAuditManagerGroup.Local.png) |
