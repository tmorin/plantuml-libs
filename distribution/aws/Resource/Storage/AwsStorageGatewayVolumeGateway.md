...
```text
aws/Resource/Storage/AwsStorageGatewayVolumeGateway
```

```text
include('aws/Resource/Storage/AwsStorageGatewayVolumeGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsStorageGatewayVolumeGateway.png) | ![illustration for AwsStorageGatewayVolumeGateway](../../../aws/Resource/Storage/AwsStorageGatewayVolumeGateway.Local.png) | ![illustration for AwsStorageGatewayVolumeGatewayCard](../../../aws/Resource/Storage/AwsStorageGatewayVolumeGatewayCard.Local.png) | ![illustration for AwsStorageGatewayVolumeGatewayGroup](../../../aws/Resource/Storage/AwsStorageGatewayVolumeGatewayGroup.Local.png) |
