...
```text
aws/Resource/Storage/AwsBackupVirtualMachine
```

```text
include('aws/Resource/Storage/AwsBackupVirtualMachine')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsBackupVirtualMachine.png) | ![illustration for AwsBackupVirtualMachine](../../../aws/Resource/Storage/AwsBackupVirtualMachine.Local.png) | ![illustration for AwsBackupVirtualMachineCard](../../../aws/Resource/Storage/AwsBackupVirtualMachineCard.Local.png) | ![illustration for AwsBackupVirtualMachineGroup](../../../aws/Resource/Storage/AwsBackupVirtualMachineGroup.Local.png) |
