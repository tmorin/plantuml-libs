...
```text
aws/Resource/Storage/AwsStorageGatewayTapeGateway
```

```text
include('aws/Resource/Storage/AwsStorageGatewayTapeGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsStorageGatewayTapeGateway.png) | ![illustration for AwsStorageGatewayTapeGateway](../../../aws/Resource/Storage/AwsStorageGatewayTapeGateway.Local.png) | ![illustration for AwsStorageGatewayTapeGatewayCard](../../../aws/Resource/Storage/AwsStorageGatewayTapeGatewayCard.Local.png) | ![illustration for AwsStorageGatewayTapeGatewayGroup](../../../aws/Resource/Storage/AwsStorageGatewayTapeGatewayGroup.Local.png) |
