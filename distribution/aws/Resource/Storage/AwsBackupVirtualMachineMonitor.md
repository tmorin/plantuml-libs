...
```text
aws/Resource/Storage/AwsBackupVirtualMachineMonitor
```

```text
include('aws/Resource/Storage/AwsBackupVirtualMachineMonitor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsBackupVirtualMachineMonitor.png) | ![illustration for AwsBackupVirtualMachineMonitor](../../../aws/Resource/Storage/AwsBackupVirtualMachineMonitor.Local.png) | ![illustration for AwsBackupVirtualMachineMonitorCard](../../../aws/Resource/Storage/AwsBackupVirtualMachineMonitorCard.Local.png) | ![illustration for AwsBackupVirtualMachineMonitorGroup](../../../aws/Resource/Storage/AwsBackupVirtualMachineMonitorGroup.Local.png) |
