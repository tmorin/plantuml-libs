...
```text
aws/Resource/Storage/AwsStorageGatewayVirtualTapeLibrary
```

```text
include('aws/Resource/Storage/AwsStorageGatewayVirtualTapeLibrary')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsStorageGatewayVirtualTapeLibrary.png) | ![illustration for AwsStorageGatewayVirtualTapeLibrary](../../../aws/Resource/Storage/AwsStorageGatewayVirtualTapeLibrary.Local.png) | ![illustration for AwsStorageGatewayVirtualTapeLibraryCard](../../../aws/Resource/Storage/AwsStorageGatewayVirtualTapeLibraryCard.Local.png) | ![illustration for AwsStorageGatewayVirtualTapeLibraryGroup](../../../aws/Resource/Storage/AwsStorageGatewayVirtualTapeLibraryGroup.Local.png) |
