...
```text
aws/Resource/Storage/AwsSnowballSnowballImportExport
```

```text
include('aws/Resource/Storage/AwsSnowballSnowballImportExport')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AwsSnowballSnowballImportExport.png) | ![illustration for AwsSnowballSnowballImportExport](../../../aws/Resource/Storage/AwsSnowballSnowballImportExport.Local.png) | ![illustration for AwsSnowballSnowballImportExportCard](../../../aws/Resource/Storage/AwsSnowballSnowballImportExportCard.Local.png) | ![illustration for AwsSnowballSnowballImportExportGroup](../../../aws/Resource/Storage/AwsSnowballSnowballImportExportGroup.Local.png) |
