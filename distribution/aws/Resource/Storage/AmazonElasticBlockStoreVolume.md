...
```text
aws/Resource/Storage/AmazonElasticBlockStoreVolume
```

```text
include('aws/Resource/Storage/AmazonElasticBlockStoreVolume')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/Storage/AmazonElasticBlockStoreVolume.png) | ![illustration for AmazonElasticBlockStoreVolume](../../../aws/Resource/Storage/AmazonElasticBlockStoreVolume.Local.png) | ![illustration for AmazonElasticBlockStoreVolumeCard](../../../aws/Resource/Storage/AmazonElasticBlockStoreVolumeCard.Local.png) | ![illustration for AmazonElasticBlockStoreVolumeGroup](../../../aws/Resource/Storage/AmazonElasticBlockStoreVolumeGroup.Local.png) |
