...
```text
aws/Resource/ArtificialIntelligence/AmazonDevOpsGuruInsights
```

```text
include('aws/Resource/ArtificialIntelligence/AmazonDevOpsGuruInsights')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/ArtificialIntelligence/AmazonDevOpsGuruInsights.png) | ![illustration for AmazonDevOpsGuruInsights](../../../aws/Resource/ArtificialIntelligence/AmazonDevOpsGuruInsights.Local.png) | ![illustration for AmazonDevOpsGuruInsightsCard](../../../aws/Resource/ArtificialIntelligence/AmazonDevOpsGuruInsightsCard.Local.png) | ![illustration for AmazonDevOpsGuruInsightsGroup](../../../aws/Resource/ArtificialIntelligence/AmazonDevOpsGuruInsightsGroup.Local.png) |
