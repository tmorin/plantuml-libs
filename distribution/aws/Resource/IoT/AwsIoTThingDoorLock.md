...
```text
aws/Resource/IoT/AwsIoTThingDoorLock
```

```text
include('aws/Resource/IoT/AwsIoTThingDoorLock')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingDoorLock.png) | ![illustration for AwsIoTThingDoorLock](../../../aws/Resource/IoT/AwsIoTThingDoorLock.Local.png) | ![illustration for AwsIoTThingDoorLockCard](../../../aws/Resource/IoT/AwsIoTThingDoorLockCard.Local.png) | ![illustration for AwsIoTThingDoorLockGroup](../../../aws/Resource/IoT/AwsIoTThingDoorLockGroup.Local.png) |
