...
```text
aws/Resource/IoT/AwsIoTReportedState
```

```text
include('aws/Resource/IoT/AwsIoTReportedState')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTReportedState.png) | ![illustration for AwsIoTReportedState](../../../aws/Resource/IoT/AwsIoTReportedState.Local.png) | ![illustration for AwsIoTReportedStateCard](../../../aws/Resource/IoT/AwsIoTReportedStateCard.Local.png) | ![illustration for AwsIoTReportedStateGroup](../../../aws/Resource/IoT/AwsIoTReportedStateGroup.Local.png) |
