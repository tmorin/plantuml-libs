...
```text
aws/Resource/IoT/AwsIoTSiteWiseAssetModel
```

```text
include('aws/Resource/IoT/AwsIoTSiteWiseAssetModel')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetModel.png) | ![illustration for AwsIoTSiteWiseAssetModel](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetModel.Local.png) | ![illustration for AwsIoTSiteWiseAssetModelCard](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetModelCard.Local.png) | ![illustration for AwsIoTSiteWiseAssetModelGroup](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetModelGroup.Local.png) |
