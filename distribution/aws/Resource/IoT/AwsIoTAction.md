...
```text
aws/Resource/IoT/AwsIoTAction
```

```text
include('aws/Resource/IoT/AwsIoTAction')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTAction.png) | ![illustration for AwsIoTAction](../../../aws/Resource/IoT/AwsIoTAction.Local.png) | ![illustration for AwsIoTActionCard](../../../aws/Resource/IoT/AwsIoTActionCard.Local.png) | ![illustration for AwsIoTActionGroup](../../../aws/Resource/IoT/AwsIoTActionGroup.Local.png) |
