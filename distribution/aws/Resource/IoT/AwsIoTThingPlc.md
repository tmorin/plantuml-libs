...
```text
aws/Resource/IoT/AwsIoTThingPlc
```

```text
include('aws/Resource/IoT/AwsIoTThingPlc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingPlc.png) | ![illustration for AwsIoTThingPlc](../../../aws/Resource/IoT/AwsIoTThingPlc.Local.png) | ![illustration for AwsIoTThingPlcCard](../../../aws/Resource/IoT/AwsIoTThingPlcCard.Local.png) | ![illustration for AwsIoTThingPlcGroup](../../../aws/Resource/IoT/AwsIoTThingPlcGroup.Local.png) |
