...
```text
aws/Resource/IoT/AwsIoTThingHouse
```

```text
include('aws/Resource/IoT/AwsIoTThingHouse')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingHouse.png) | ![illustration for AwsIoTThingHouse](../../../aws/Resource/IoT/AwsIoTThingHouse.Local.png) | ![illustration for AwsIoTThingHouseCard](../../../aws/Resource/IoT/AwsIoTThingHouseCard.Local.png) | ![illustration for AwsIoTThingHouseGroup](../../../aws/Resource/IoT/AwsIoTThingHouseGroup.Local.png) |
