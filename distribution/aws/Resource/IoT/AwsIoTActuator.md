...
```text
aws/Resource/IoT/AwsIoTActuator
```

```text
include('aws/Resource/IoT/AwsIoTActuator')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTActuator.png) | ![illustration for AwsIoTActuator](../../../aws/Resource/IoT/AwsIoTActuator.Local.png) | ![illustration for AwsIoTActuatorCard](../../../aws/Resource/IoT/AwsIoTActuatorCard.Local.png) | ![illustration for AwsIoTActuatorGroup](../../../aws/Resource/IoT/AwsIoTActuatorGroup.Local.png) |
