...
```text
aws/Resource/IoT/AwsIoTThingStacklight
```

```text
include('aws/Resource/IoT/AwsIoTThingStacklight')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingStacklight.png) | ![illustration for AwsIoTThingStacklight](../../../aws/Resource/IoT/AwsIoTThingStacklight.Local.png) | ![illustration for AwsIoTThingStacklightCard](../../../aws/Resource/IoT/AwsIoTThingStacklightCard.Local.png) | ![illustration for AwsIoTThingStacklightGroup](../../../aws/Resource/IoT/AwsIoTThingStacklightGroup.Local.png) |
