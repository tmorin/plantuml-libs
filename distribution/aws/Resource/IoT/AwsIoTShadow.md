...
```text
aws/Resource/IoT/AwsIoTShadow
```

```text
include('aws/Resource/IoT/AwsIoTShadow')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTShadow.png) | ![illustration for AwsIoTShadow](../../../aws/Resource/IoT/AwsIoTShadow.Local.png) | ![illustration for AwsIoTShadowCard](../../../aws/Resource/IoT/AwsIoTShadowCard.Local.png) | ![illustration for AwsIoTShadowGroup](../../../aws/Resource/IoT/AwsIoTShadowGroup.Local.png) |
