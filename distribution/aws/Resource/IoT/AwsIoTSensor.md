...
```text
aws/Resource/IoT/AwsIoTSensor
```

```text
include('aws/Resource/IoT/AwsIoTSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTSensor.png) | ![illustration for AwsIoTSensor](../../../aws/Resource/IoT/AwsIoTSensor.Local.png) | ![illustration for AwsIoTSensorCard](../../../aws/Resource/IoT/AwsIoTSensorCard.Local.png) | ![illustration for AwsIoTSensorGroup](../../../aws/Resource/IoT/AwsIoTSensorGroup.Local.png) |
