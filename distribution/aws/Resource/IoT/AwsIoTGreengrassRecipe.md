...
```text
aws/Resource/IoT/AwsIoTGreengrassRecipe
```

```text
include('aws/Resource/IoT/AwsIoTGreengrassRecipe')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTGreengrassRecipe.png) | ![illustration for AwsIoTGreengrassRecipe](../../../aws/Resource/IoT/AwsIoTGreengrassRecipe.Local.png) | ![illustration for AwsIoTGreengrassRecipeCard](../../../aws/Resource/IoT/AwsIoTGreengrassRecipeCard.Local.png) | ![illustration for AwsIoTGreengrassRecipeGroup](../../../aws/Resource/IoT/AwsIoTGreengrassRecipeGroup.Local.png) |
