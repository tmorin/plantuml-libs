...
```text
aws/Resource/IoT/AwsIoTThingWindfarm
```

```text
include('aws/Resource/IoT/AwsIoTThingWindfarm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingWindfarm.png) | ![illustration for AwsIoTThingWindfarm](../../../aws/Resource/IoT/AwsIoTThingWindfarm.Local.png) | ![illustration for AwsIoTThingWindfarmCard](../../../aws/Resource/IoT/AwsIoTThingWindfarmCard.Local.png) | ![illustration for AwsIoTThingWindfarmGroup](../../../aws/Resource/IoT/AwsIoTThingWindfarmGroup.Local.png) |
