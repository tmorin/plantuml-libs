...
```text
aws/Resource/IoT/AwsIoTHardwareBoard
```

```text
include('aws/Resource/IoT/AwsIoTHardwareBoard')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTHardwareBoard.png) | ![illustration for AwsIoTHardwareBoard](../../../aws/Resource/IoT/AwsIoTHardwareBoard.Local.png) | ![illustration for AwsIoTHardwareBoardCard](../../../aws/Resource/IoT/AwsIoTHardwareBoardCard.Local.png) | ![illustration for AwsIoTHardwareBoardGroup](../../../aws/Resource/IoT/AwsIoTHardwareBoardGroup.Local.png) |
