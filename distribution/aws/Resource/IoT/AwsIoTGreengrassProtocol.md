...
```text
aws/Resource/IoT/AwsIoTGreengrassProtocol
```

```text
include('aws/Resource/IoT/AwsIoTGreengrassProtocol')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTGreengrassProtocol.png) | ![illustration for AwsIoTGreengrassProtocol](../../../aws/Resource/IoT/AwsIoTGreengrassProtocol.Local.png) | ![illustration for AwsIoTGreengrassProtocolCard](../../../aws/Resource/IoT/AwsIoTGreengrassProtocolCard.Local.png) | ![illustration for AwsIoTGreengrassProtocolGroup](../../../aws/Resource/IoT/AwsIoTGreengrassProtocolGroup.Local.png) |
