...
```text
aws/Resource/IoT/AwsIoTThingCoffeePot
```

```text
include('aws/Resource/IoT/AwsIoTThingCoffeePot')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingCoffeePot.png) | ![illustration for AwsIoTThingCoffeePot](../../../aws/Resource/IoT/AwsIoTThingCoffeePot.Local.png) | ![illustration for AwsIoTThingCoffeePotCard](../../../aws/Resource/IoT/AwsIoTThingCoffeePotCard.Local.png) | ![illustration for AwsIoTThingCoffeePotGroup](../../../aws/Resource/IoT/AwsIoTThingCoffeePotGroup.Local.png) |
