...
```text
aws/Resource/IoT/AwsIoTThingGeneric
```

```text
include('aws/Resource/IoT/AwsIoTThingGeneric')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingGeneric.png) | ![illustration for AwsIoTThingGeneric](../../../aws/Resource/IoT/AwsIoTThingGeneric.Local.png) | ![illustration for AwsIoTThingGenericCard](../../../aws/Resource/IoT/AwsIoTThingGenericCard.Local.png) | ![illustration for AwsIoTThingGenericGroup](../../../aws/Resource/IoT/AwsIoTThingGenericGroup.Local.png) |
