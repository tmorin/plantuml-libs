...
```text
aws/Resource/IoT/AwsIoTCoreDeviceLocation
```

```text
include('aws/Resource/IoT/AwsIoTCoreDeviceLocation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTCoreDeviceLocation.png) | ![illustration for AwsIoTCoreDeviceLocation](../../../aws/Resource/IoT/AwsIoTCoreDeviceLocation.Local.png) | ![illustration for AwsIoTCoreDeviceLocationCard](../../../aws/Resource/IoT/AwsIoTCoreDeviceLocationCard.Local.png) | ![illustration for AwsIoTCoreDeviceLocationGroup](../../../aws/Resource/IoT/AwsIoTCoreDeviceLocationGroup.Local.png) |
