...
```text
aws/Resource/IoT/AwsIoTThingLightbulb
```

```text
include('aws/Resource/IoT/AwsIoTThingLightbulb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingLightbulb.png) | ![illustration for AwsIoTThingLightbulb](../../../aws/Resource/IoT/AwsIoTThingLightbulb.Local.png) | ![illustration for AwsIoTThingLightbulbCard](../../../aws/Resource/IoT/AwsIoTThingLightbulbCard.Local.png) | ![illustration for AwsIoTThingLightbulbGroup](../../../aws/Resource/IoT/AwsIoTThingLightbulbGroup.Local.png) |
