...
```text
aws/Resource/IoT/AwsIoTCertificate
```

```text
include('aws/Resource/IoT/AwsIoTCertificate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTCertificate.png) | ![illustration for AwsIoTCertificate](../../../aws/Resource/IoT/AwsIoTCertificate.Local.png) | ![illustration for AwsIoTCertificateCard](../../../aws/Resource/IoT/AwsIoTCertificateCard.Local.png) | ![illustration for AwsIoTCertificateGroup](../../../aws/Resource/IoT/AwsIoTCertificateGroup.Local.png) |
