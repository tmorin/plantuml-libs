...
```text
aws/Resource/IoT/AwsIoTGreengrassComponentPrivate
```

```text
include('aws/Resource/IoT/AwsIoTGreengrassComponentPrivate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTGreengrassComponentPrivate.png) | ![illustration for AwsIoTGreengrassComponentPrivate](../../../aws/Resource/IoT/AwsIoTGreengrassComponentPrivate.Local.png) | ![illustration for AwsIoTGreengrassComponentPrivateCard](../../../aws/Resource/IoT/AwsIoTGreengrassComponentPrivateCard.Local.png) | ![illustration for AwsIoTGreengrassComponentPrivateGroup](../../../aws/Resource/IoT/AwsIoTGreengrassComponentPrivateGroup.Local.png) |
