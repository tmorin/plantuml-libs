...
```text
aws/Resource/IoT/AwsIoTThingCar
```

```text
include('aws/Resource/IoT/AwsIoTThingCar')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingCar.png) | ![illustration for AwsIoTThingCar](../../../aws/Resource/IoT/AwsIoTThingCar.Local.png) | ![illustration for AwsIoTThingCarCard](../../../aws/Resource/IoT/AwsIoTThingCarCard.Local.png) | ![illustration for AwsIoTThingCarGroup](../../../aws/Resource/IoT/AwsIoTThingCarGroup.Local.png) |
