...
```text
aws/Resource/IoT/AwsIoTAnalyticsNotebook
```

```text
include('aws/Resource/IoT/AwsIoTAnalyticsNotebook')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTAnalyticsNotebook.png) | ![illustration for AwsIoTAnalyticsNotebook](../../../aws/Resource/IoT/AwsIoTAnalyticsNotebook.Local.png) | ![illustration for AwsIoTAnalyticsNotebookCard](../../../aws/Resource/IoT/AwsIoTAnalyticsNotebookCard.Local.png) | ![illustration for AwsIoTAnalyticsNotebookGroup](../../../aws/Resource/IoT/AwsIoTAnalyticsNotebookGroup.Local.png) |
