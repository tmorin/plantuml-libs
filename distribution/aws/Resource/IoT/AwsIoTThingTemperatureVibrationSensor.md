...
```text
aws/Resource/IoT/AwsIoTThingTemperatureVibrationSensor
```

```text
include('aws/Resource/IoT/AwsIoTThingTemperatureVibrationSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingTemperatureVibrationSensor.png) | ![illustration for AwsIoTThingTemperatureVibrationSensor](../../../aws/Resource/IoT/AwsIoTThingTemperatureVibrationSensor.Local.png) | ![illustration for AwsIoTThingTemperatureVibrationSensorCard](../../../aws/Resource/IoT/AwsIoTThingTemperatureVibrationSensorCard.Local.png) | ![illustration for AwsIoTThingTemperatureVibrationSensorGroup](../../../aws/Resource/IoT/AwsIoTThingTemperatureVibrationSensorGroup.Local.png) |
