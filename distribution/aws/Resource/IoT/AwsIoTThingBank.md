...
```text
aws/Resource/IoT/AwsIoTThingBank
```

```text
include('aws/Resource/IoT/AwsIoTThingBank')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingBank.png) | ![illustration for AwsIoTThingBank](../../../aws/Resource/IoT/AwsIoTThingBank.Local.png) | ![illustration for AwsIoTThingBankCard](../../../aws/Resource/IoT/AwsIoTThingBankCard.Local.png) | ![illustration for AwsIoTThingBankGroup](../../../aws/Resource/IoT/AwsIoTThingBankGroup.Local.png) |
