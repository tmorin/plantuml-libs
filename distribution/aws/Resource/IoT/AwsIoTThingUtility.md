...
```text
aws/Resource/IoT/AwsIoTThingUtility
```

```text
include('aws/Resource/IoT/AwsIoTThingUtility')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingUtility.png) | ![illustration for AwsIoTThingUtility](../../../aws/Resource/IoT/AwsIoTThingUtility.Local.png) | ![illustration for AwsIoTThingUtilityCard](../../../aws/Resource/IoT/AwsIoTThingUtilityCard.Local.png) | ![illustration for AwsIoTThingUtilityGroup](../../../aws/Resource/IoT/AwsIoTThingUtilityGroup.Local.png) |
