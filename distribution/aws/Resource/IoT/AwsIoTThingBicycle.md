...
```text
aws/Resource/IoT/AwsIoTThingBicycle
```

```text
include('aws/Resource/IoT/AwsIoTThingBicycle')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingBicycle.png) | ![illustration for AwsIoTThingBicycle](../../../aws/Resource/IoT/AwsIoTThingBicycle.Local.png) | ![illustration for AwsIoTThingBicycleCard](../../../aws/Resource/IoT/AwsIoTThingBicycleCard.Local.png) | ![illustration for AwsIoTThingBicycleGroup](../../../aws/Resource/IoT/AwsIoTThingBicycleGroup.Local.png) |
