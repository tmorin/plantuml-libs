...
```text
aws/Resource/IoT/AwsIoTThingCamera
```

```text
include('aws/Resource/IoT/AwsIoTThingCamera')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingCamera.png) | ![illustration for AwsIoTThingCamera](../../../aws/Resource/IoT/AwsIoTThingCamera.Local.png) | ![illustration for AwsIoTThingCameraCard](../../../aws/Resource/IoT/AwsIoTThingCameraCard.Local.png) | ![illustration for AwsIoTThingCameraGroup](../../../aws/Resource/IoT/AwsIoTThingCameraGroup.Local.png) |
