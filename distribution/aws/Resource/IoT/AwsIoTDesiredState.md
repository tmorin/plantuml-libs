...
```text
aws/Resource/IoT/AwsIoTDesiredState
```

```text
include('aws/Resource/IoT/AwsIoTDesiredState')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTDesiredState.png) | ![illustration for AwsIoTDesiredState](../../../aws/Resource/IoT/AwsIoTDesiredState.Local.png) | ![illustration for AwsIoTDesiredStateCard](../../../aws/Resource/IoT/AwsIoTDesiredStateCard.Local.png) | ![illustration for AwsIoTDesiredStateGroup](../../../aws/Resource/IoT/AwsIoTDesiredStateGroup.Local.png) |
