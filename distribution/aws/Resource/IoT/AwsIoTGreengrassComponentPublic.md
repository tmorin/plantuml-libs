...
```text
aws/Resource/IoT/AwsIoTGreengrassComponentPublic
```

```text
include('aws/Resource/IoT/AwsIoTGreengrassComponentPublic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTGreengrassComponentPublic.png) | ![illustration for AwsIoTGreengrassComponentPublic](../../../aws/Resource/IoT/AwsIoTGreengrassComponentPublic.Local.png) | ![illustration for AwsIoTGreengrassComponentPublicCard](../../../aws/Resource/IoT/AwsIoTGreengrassComponentPublicCard.Local.png) | ![illustration for AwsIoTGreengrassComponentPublicGroup](../../../aws/Resource/IoT/AwsIoTGreengrassComponentPublicGroup.Local.png) |
