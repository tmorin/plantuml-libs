...
```text
aws/Resource/IoT/AwsIoTOverAirUpdate
```

```text
include('aws/Resource/IoT/AwsIoTOverAirUpdate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTOverAirUpdate.png) | ![illustration for AwsIoTOverAirUpdate](../../../aws/Resource/IoT/AwsIoTOverAirUpdate.Local.png) | ![illustration for AwsIoTOverAirUpdateCard](../../../aws/Resource/IoT/AwsIoTOverAirUpdateCard.Local.png) | ![illustration for AwsIoTOverAirUpdateGroup](../../../aws/Resource/IoT/AwsIoTOverAirUpdateGroup.Local.png) |
