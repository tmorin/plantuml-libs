...
```text
aws/Resource/IoT/AwsIoTAnalyticsDataset
```

```text
include('aws/Resource/IoT/AwsIoTAnalyticsDataset')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTAnalyticsDataset.png) | ![illustration for AwsIoTAnalyticsDataset](../../../aws/Resource/IoT/AwsIoTAnalyticsDataset.Local.png) | ![illustration for AwsIoTAnalyticsDatasetCard](../../../aws/Resource/IoT/AwsIoTAnalyticsDatasetCard.Local.png) | ![illustration for AwsIoTAnalyticsDatasetGroup](../../../aws/Resource/IoT/AwsIoTAnalyticsDatasetGroup.Local.png) |
