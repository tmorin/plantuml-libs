...
```text
aws/Resource/IoT/AwsIoTAnalyticsChannel
```

```text
include('aws/Resource/IoT/AwsIoTAnalyticsChannel')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTAnalyticsChannel.png) | ![illustration for AwsIoTAnalyticsChannel](../../../aws/Resource/IoT/AwsIoTAnalyticsChannel.Local.png) | ![illustration for AwsIoTAnalyticsChannelCard](../../../aws/Resource/IoT/AwsIoTAnalyticsChannelCard.Local.png) | ![illustration for AwsIoTAnalyticsChannelGroup](../../../aws/Resource/IoT/AwsIoTAnalyticsChannelGroup.Local.png) |
