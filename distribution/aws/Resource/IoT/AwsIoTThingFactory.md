...
```text
aws/Resource/IoT/AwsIoTThingFactory
```

```text
include('aws/Resource/IoT/AwsIoTThingFactory')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingFactory.png) | ![illustration for AwsIoTThingFactory](../../../aws/Resource/IoT/AwsIoTThingFactory.Local.png) | ![illustration for AwsIoTThingFactoryCard](../../../aws/Resource/IoT/AwsIoTThingFactoryCard.Local.png) | ![illustration for AwsIoTThingFactoryGroup](../../../aws/Resource/IoT/AwsIoTThingFactoryGroup.Local.png) |
