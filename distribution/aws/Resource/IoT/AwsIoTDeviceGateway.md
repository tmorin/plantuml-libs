...
```text
aws/Resource/IoT/AwsIoTDeviceGateway
```

```text
include('aws/Resource/IoT/AwsIoTDeviceGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTDeviceGateway.png) | ![illustration for AwsIoTDeviceGateway](../../../aws/Resource/IoT/AwsIoTDeviceGateway.Local.png) | ![illustration for AwsIoTDeviceGatewayCard](../../../aws/Resource/IoT/AwsIoTDeviceGatewayCard.Local.png) | ![illustration for AwsIoTDeviceGatewayGroup](../../../aws/Resource/IoT/AwsIoTDeviceGatewayGroup.Local.png) |
