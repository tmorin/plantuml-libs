...
```text
aws/Resource/IoT/AwsIoTEcho
```

```text
include('aws/Resource/IoT/AwsIoTEcho')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTEcho.png) | ![illustration for AwsIoTEcho](../../../aws/Resource/IoT/AwsIoTEcho.Local.png) | ![illustration for AwsIoTEchoCard](../../../aws/Resource/IoT/AwsIoTEchoCard.Local.png) | ![illustration for AwsIoTEchoGroup](../../../aws/Resource/IoT/AwsIoTEchoGroup.Local.png) |
