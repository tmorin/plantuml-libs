...
```text
aws/Resource/IoT/AwsIoTDeviceTester
```

```text
include('aws/Resource/IoT/AwsIoTDeviceTester')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTDeviceTester.png) | ![illustration for AwsIoTDeviceTester](../../../aws/Resource/IoT/AwsIoTDeviceTester.Local.png) | ![illustration for AwsIoTDeviceTesterCard](../../../aws/Resource/IoT/AwsIoTDeviceTesterCard.Local.png) | ![illustration for AwsIoTDeviceTesterGroup](../../../aws/Resource/IoT/AwsIoTDeviceTesterGroup.Local.png) |
