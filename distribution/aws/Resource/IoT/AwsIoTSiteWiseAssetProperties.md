...
```text
aws/Resource/IoT/AwsIoTSiteWiseAssetProperties
```

```text
include('aws/Resource/IoT/AwsIoTSiteWiseAssetProperties')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetProperties.png) | ![illustration for AwsIoTSiteWiseAssetProperties](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetProperties.Local.png) | ![illustration for AwsIoTSiteWiseAssetPropertiesCard](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetPropertiesCard.Local.png) | ![illustration for AwsIoTSiteWiseAssetPropertiesGroup](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetPropertiesGroup.Local.png) |
