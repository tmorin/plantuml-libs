...
```text
aws/Resource/IoT/AwsIoTGreengrassInterprocessCommunication
```

```text
include('aws/Resource/IoT/AwsIoTGreengrassInterprocessCommunication')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTGreengrassInterprocessCommunication.png) | ![illustration for AwsIoTGreengrassInterprocessCommunication](../../../aws/Resource/IoT/AwsIoTGreengrassInterprocessCommunication.Local.png) | ![illustration for AwsIoTGreengrassInterprocessCommunicationCard](../../../aws/Resource/IoT/AwsIoTGreengrassInterprocessCommunicationCard.Local.png) | ![illustration for AwsIoTGreengrassInterprocessCommunicationGroup](../../../aws/Resource/IoT/AwsIoTGreengrassInterprocessCommunicationGroup.Local.png) |
