...
```text
aws/Resource/IoT/AwsIoTGreengrassComponentMachineLearning
```

```text
include('aws/Resource/IoT/AwsIoTGreengrassComponentMachineLearning')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTGreengrassComponentMachineLearning.png) | ![illustration for AwsIoTGreengrassComponentMachineLearning](../../../aws/Resource/IoT/AwsIoTGreengrassComponentMachineLearning.Local.png) | ![illustration for AwsIoTGreengrassComponentMachineLearningCard](../../../aws/Resource/IoT/AwsIoTGreengrassComponentMachineLearningCard.Local.png) | ![illustration for AwsIoTGreengrassComponentMachineLearningGroup](../../../aws/Resource/IoT/AwsIoTGreengrassComponentMachineLearningGroup.Local.png) |
