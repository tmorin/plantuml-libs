...
```text
aws/Resource/IoT/AwsIoTGreengrassStreamManager
```

```text
include('aws/Resource/IoT/AwsIoTGreengrassStreamManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTGreengrassStreamManager.png) | ![illustration for AwsIoTGreengrassStreamManager](../../../aws/Resource/IoT/AwsIoTGreengrassStreamManager.Local.png) | ![illustration for AwsIoTGreengrassStreamManagerCard](../../../aws/Resource/IoT/AwsIoTGreengrassStreamManagerCard.Local.png) | ![illustration for AwsIoTGreengrassStreamManagerGroup](../../../aws/Resource/IoT/AwsIoTGreengrassStreamManagerGroup.Local.png) |
