...
```text
aws/Resource/IoT/AwsIoTThingMedicalEmergency
```

```text
include('aws/Resource/IoT/AwsIoTThingMedicalEmergency')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingMedicalEmergency.png) | ![illustration for AwsIoTThingMedicalEmergency](../../../aws/Resource/IoT/AwsIoTThingMedicalEmergency.Local.png) | ![illustration for AwsIoTThingMedicalEmergencyCard](../../../aws/Resource/IoT/AwsIoTThingMedicalEmergencyCard.Local.png) | ![illustration for AwsIoTThingMedicalEmergencyGroup](../../../aws/Resource/IoT/AwsIoTThingMedicalEmergencyGroup.Local.png) |
