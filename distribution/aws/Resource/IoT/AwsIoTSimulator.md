...
```text
aws/Resource/IoT/AwsIoTSimulator
```

```text
include('aws/Resource/IoT/AwsIoTSimulator')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTSimulator.png) | ![illustration for AwsIoTSimulator](../../../aws/Resource/IoT/AwsIoTSimulator.Local.png) | ![illustration for AwsIoTSimulatorCard](../../../aws/Resource/IoT/AwsIoTSimulatorCard.Local.png) | ![illustration for AwsIoTSimulatorGroup](../../../aws/Resource/IoT/AwsIoTSimulatorGroup.Local.png) |
