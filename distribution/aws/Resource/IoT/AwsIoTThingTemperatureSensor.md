...
```text
aws/Resource/IoT/AwsIoTThingTemperatureSensor
```

```text
include('aws/Resource/IoT/AwsIoTThingTemperatureSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingTemperatureSensor.png) | ![illustration for AwsIoTThingTemperatureSensor](../../../aws/Resource/IoT/AwsIoTThingTemperatureSensor.Local.png) | ![illustration for AwsIoTThingTemperatureSensorCard](../../../aws/Resource/IoT/AwsIoTThingTemperatureSensorCard.Local.png) | ![illustration for AwsIoTThingTemperatureSensorGroup](../../../aws/Resource/IoT/AwsIoTThingTemperatureSensorGroup.Local.png) |
