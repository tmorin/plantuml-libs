...
```text
aws/Resource/IoT/AwsIoTThingTravel
```

```text
include('aws/Resource/IoT/AwsIoTThingTravel')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingTravel.png) | ![illustration for AwsIoTThingTravel](../../../aws/Resource/IoT/AwsIoTThingTravel.Local.png) | ![illustration for AwsIoTThingTravelCard](../../../aws/Resource/IoT/AwsIoTThingTravelCard.Local.png) | ![illustration for AwsIoTThingTravelGroup](../../../aws/Resource/IoT/AwsIoTThingTravelGroup.Local.png) |
