...
```text
aws/Resource/IoT/AwsIoTAnalyticsDataStore
```

```text
include('aws/Resource/IoT/AwsIoTAnalyticsDataStore')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTAnalyticsDataStore.png) | ![illustration for AwsIoTAnalyticsDataStore](../../../aws/Resource/IoT/AwsIoTAnalyticsDataStore.Local.png) | ![illustration for AwsIoTAnalyticsDataStoreCard](../../../aws/Resource/IoT/AwsIoTAnalyticsDataStoreCard.Local.png) | ![illustration for AwsIoTAnalyticsDataStoreGroup](../../../aws/Resource/IoT/AwsIoTAnalyticsDataStoreGroup.Local.png) |
