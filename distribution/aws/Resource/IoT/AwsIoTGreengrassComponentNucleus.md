...
```text
aws/Resource/IoT/AwsIoTGreengrassComponentNucleus
```

```text
include('aws/Resource/IoT/AwsIoTGreengrassComponentNucleus')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTGreengrassComponentNucleus.png) | ![illustration for AwsIoTGreengrassComponentNucleus](../../../aws/Resource/IoT/AwsIoTGreengrassComponentNucleus.Local.png) | ![illustration for AwsIoTGreengrassComponentNucleusCard](../../../aws/Resource/IoT/AwsIoTGreengrassComponentNucleusCard.Local.png) | ![illustration for AwsIoTGreengrassComponentNucleusGroup](../../../aws/Resource/IoT/AwsIoTGreengrassComponentNucleusGroup.Local.png) |
