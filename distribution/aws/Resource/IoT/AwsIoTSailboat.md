...
```text
aws/Resource/IoT/AwsIoTSailboat
```

```text
include('aws/Resource/IoT/AwsIoTSailboat')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTSailboat.png) | ![illustration for AwsIoTSailboat](../../../aws/Resource/IoT/AwsIoTSailboat.Local.png) | ![illustration for AwsIoTSailboatCard](../../../aws/Resource/IoT/AwsIoTSailboatCard.Local.png) | ![illustration for AwsIoTSailboatGroup](../../../aws/Resource/IoT/AwsIoTSailboatGroup.Local.png) |
