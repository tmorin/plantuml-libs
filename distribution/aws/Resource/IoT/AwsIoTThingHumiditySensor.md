...
```text
aws/Resource/IoT/AwsIoTThingHumiditySensor
```

```text
include('aws/Resource/IoT/AwsIoTThingHumiditySensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingHumiditySensor.png) | ![illustration for AwsIoTThingHumiditySensor](../../../aws/Resource/IoT/AwsIoTThingHumiditySensor.Local.png) | ![illustration for AwsIoTThingHumiditySensorCard](../../../aws/Resource/IoT/AwsIoTThingHumiditySensorCard.Local.png) | ![illustration for AwsIoTThingHumiditySensorGroup](../../../aws/Resource/IoT/AwsIoTThingHumiditySensorGroup.Local.png) |
