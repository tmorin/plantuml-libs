...
```text
aws/Resource/IoT/AwsIoTLambdaFunction
```

```text
include('aws/Resource/IoT/AwsIoTLambdaFunction')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTLambdaFunction.png) | ![illustration for AwsIoTLambdaFunction](../../../aws/Resource/IoT/AwsIoTLambdaFunction.Local.png) | ![illustration for AwsIoTLambdaFunctionCard](../../../aws/Resource/IoT/AwsIoTLambdaFunctionCard.Local.png) | ![illustration for AwsIoTLambdaFunctionGroup](../../../aws/Resource/IoT/AwsIoTLambdaFunctionGroup.Local.png) |
