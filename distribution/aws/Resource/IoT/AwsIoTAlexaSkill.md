...
```text
aws/Resource/IoT/AwsIoTAlexaSkill
```

```text
include('aws/Resource/IoT/AwsIoTAlexaSkill')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTAlexaSkill.png) | ![illustration for AwsIoTAlexaSkill](../../../aws/Resource/IoT/AwsIoTAlexaSkill.Local.png) | ![illustration for AwsIoTAlexaSkillCard](../../../aws/Resource/IoT/AwsIoTAlexaSkillCard.Local.png) | ![illustration for AwsIoTAlexaSkillGroup](../../../aws/Resource/IoT/AwsIoTAlexaSkillGroup.Local.png) |
