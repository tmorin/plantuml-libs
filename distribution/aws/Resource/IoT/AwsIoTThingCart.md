...
```text
aws/Resource/IoT/AwsIoTThingCart
```

```text
include('aws/Resource/IoT/AwsIoTThingCart')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingCart.png) | ![illustration for AwsIoTThingCart](../../../aws/Resource/IoT/AwsIoTThingCart.Local.png) | ![illustration for AwsIoTThingCartCard](../../../aws/Resource/IoT/AwsIoTThingCartCard.Local.png) | ![illustration for AwsIoTThingCartGroup](../../../aws/Resource/IoT/AwsIoTThingCartGroup.Local.png) |
