...
```text
aws/Resource/IoT/AwsIoTThingIndustrialPc
```

```text
include('aws/Resource/IoT/AwsIoTThingIndustrialPc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingIndustrialPc.png) | ![illustration for AwsIoTThingIndustrialPc](../../../aws/Resource/IoT/AwsIoTThingIndustrialPc.Local.png) | ![illustration for AwsIoTThingIndustrialPcCard](../../../aws/Resource/IoT/AwsIoTThingIndustrialPcCard.Local.png) | ![illustration for AwsIoTThingIndustrialPcGroup](../../../aws/Resource/IoT/AwsIoTThingIndustrialPcGroup.Local.png) |
