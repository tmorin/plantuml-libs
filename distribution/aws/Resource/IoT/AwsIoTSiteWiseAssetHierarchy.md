...
```text
aws/Resource/IoT/AwsIoTSiteWiseAssetHierarchy
```

```text
include('aws/Resource/IoT/AwsIoTSiteWiseAssetHierarchy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetHierarchy.png) | ![illustration for AwsIoTSiteWiseAssetHierarchy](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetHierarchy.Local.png) | ![illustration for AwsIoTSiteWiseAssetHierarchyCard](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetHierarchyCard.Local.png) | ![illustration for AwsIoTSiteWiseAssetHierarchyGroup](../../../aws/Resource/IoT/AwsIoTSiteWiseAssetHierarchyGroup.Local.png) |
