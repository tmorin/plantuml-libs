...
```text
aws/Resource/IoT/AwsIoTGreengrassArtifact
```

```text
include('aws/Resource/IoT/AwsIoTGreengrassArtifact')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTGreengrassArtifact.png) | ![illustration for AwsIoTGreengrassArtifact](../../../aws/Resource/IoT/AwsIoTGreengrassArtifact.Local.png) | ![illustration for AwsIoTGreengrassArtifactCard](../../../aws/Resource/IoT/AwsIoTGreengrassArtifactCard.Local.png) | ![illustration for AwsIoTGreengrassArtifactGroup](../../../aws/Resource/IoT/AwsIoTGreengrassArtifactGroup.Local.png) |
