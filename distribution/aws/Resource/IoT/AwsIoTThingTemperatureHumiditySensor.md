...
```text
aws/Resource/IoT/AwsIoTThingTemperatureHumiditySensor
```

```text
include('aws/Resource/IoT/AwsIoTThingTemperatureHumiditySensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingTemperatureHumiditySensor.png) | ![illustration for AwsIoTThingTemperatureHumiditySensor](../../../aws/Resource/IoT/AwsIoTThingTemperatureHumiditySensor.Local.png) | ![illustration for AwsIoTThingTemperatureHumiditySensorCard](../../../aws/Resource/IoT/AwsIoTThingTemperatureHumiditySensorCard.Local.png) | ![illustration for AwsIoTThingTemperatureHumiditySensorGroup](../../../aws/Resource/IoT/AwsIoTThingTemperatureHumiditySensorGroup.Local.png) |
