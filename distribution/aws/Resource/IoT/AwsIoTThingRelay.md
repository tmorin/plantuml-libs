...
```text
aws/Resource/IoT/AwsIoTThingRelay
```

```text
include('aws/Resource/IoT/AwsIoTThingRelay')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTThingRelay.png) | ![illustration for AwsIoTThingRelay](../../../aws/Resource/IoT/AwsIoTThingRelay.Local.png) | ![illustration for AwsIoTThingRelayCard](../../../aws/Resource/IoT/AwsIoTThingRelayCard.Local.png) | ![illustration for AwsIoTThingRelayGroup](../../../aws/Resource/IoT/AwsIoTThingRelayGroup.Local.png) |
