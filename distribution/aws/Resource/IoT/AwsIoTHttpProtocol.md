...
```text
aws/Resource/IoT/AwsIoTHttpProtocol
```

```text
include('aws/Resource/IoT/AwsIoTHttpProtocol')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/IoT/AwsIoTHttpProtocol.png) | ![illustration for AwsIoTHttpProtocol](../../../aws/Resource/IoT/AwsIoTHttpProtocol.Local.png) | ![illustration for AwsIoTHttpProtocolCard](../../../aws/Resource/IoT/AwsIoTHttpProtocolCard.Local.png) | ![illustration for AwsIoTHttpProtocolGroup](../../../aws/Resource/IoT/AwsIoTHttpProtocolGroup.Local.png) |
