...
```text
aws/Resource/BusinessApplications/AmazonPinpointJourney
```

```text
include('aws/Resource/BusinessApplications/AmazonPinpointJourney')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws/Resource/BusinessApplications/AmazonPinpointJourney.png) | ![illustration for AmazonPinpointJourney](../../../aws/Resource/BusinessApplications/AmazonPinpointJourney.Local.png) | ![illustration for AmazonPinpointJourneyCard](../../../aws/Resource/BusinessApplications/AmazonPinpointJourneyCard.Local.png) | ![illustration for AmazonPinpointJourneyGroup](../../../aws/Resource/BusinessApplications/AmazonPinpointJourneyGroup.Local.png) |
