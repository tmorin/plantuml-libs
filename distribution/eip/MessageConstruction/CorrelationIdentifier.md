...
```text
eip/MessageConstruction/CorrelationIdentifier
```

```text
include('eip/MessageConstruction/CorrelationIdentifier')
```
...
| :---: | :---: | :---: |
| ![illustration for Illustration](../../eip/MessageConstruction/CorrelationIdentifier.png) | ![illustration for CorrelationIdentifier](../../eip/MessageConstruction/CorrelationIdentifier.Local.png) | ![illustration for CorrelationIdentifierGroup](../../eip/MessageConstruction/CorrelationIdentifierGroup.Local.png) |
