...
```text
aws-q3-2021/Architecture/MediaServices/AwsElementalServer
```

```text
include('aws-q3-2021/Architecture/MediaServices/AwsElementalServer')
```
