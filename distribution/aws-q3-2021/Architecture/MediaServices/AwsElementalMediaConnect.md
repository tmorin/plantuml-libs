...
```text
aws-q3-2021/Architecture/MediaServices/AwsElementalMediaConnect
```

```text
include('aws-q3-2021/Architecture/MediaServices/AwsElementalMediaConnect')
```
