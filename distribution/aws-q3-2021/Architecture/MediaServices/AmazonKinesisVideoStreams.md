...
```text
aws-q3-2021/Architecture/MediaServices/AmazonKinesisVideoStreams
```

```text
include('aws-q3-2021/Architecture/MediaServices/AmazonKinesisVideoStreams')
```
