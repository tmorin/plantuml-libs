...
```text
aws-q3-2021/Architecture/MediaServices/AmazonInteractiveVideoService
```

```text
include('aws-q3-2021/Architecture/MediaServices/AmazonInteractiveVideoService')
```
