...
```text
aws-q3-2021/Architecture/MediaServices/AwsElementalMediaConvert
```

```text
include('aws-q3-2021/Architecture/MediaServices/AwsElementalMediaConvert')
```
