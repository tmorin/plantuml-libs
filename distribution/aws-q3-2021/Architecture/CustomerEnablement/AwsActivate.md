...
```text
aws-q3-2021/Architecture/CustomerEnablement/AwsActivate
```

```text
include('aws-q3-2021/Architecture/CustomerEnablement/AwsActivate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Architecture/CustomerEnablement/AwsActivate.png) | ![illustration for AwsActivate](../../../aws-q3-2021/Architecture/CustomerEnablement/AwsActivate.Local.png) | ![illustration for AwsActivateCard](../../../aws-q3-2021/Architecture/CustomerEnablement/AwsActivateCard.Local.png) | ![illustration for AwsActivateGroup](../../../aws-q3-2021/Architecture/CustomerEnablement/AwsActivateGroup.Local.png) |
