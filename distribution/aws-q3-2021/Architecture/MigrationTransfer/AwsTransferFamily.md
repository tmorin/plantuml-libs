...
```text
aws-q3-2021/Architecture/MigrationTransfer/AwsTransferFamily
```

```text
include('aws-q3-2021/Architecture/MigrationTransfer/AwsTransferFamily')
```
