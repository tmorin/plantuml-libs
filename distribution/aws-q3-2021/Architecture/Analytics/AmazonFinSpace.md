...
```text
aws-q3-2021/Architecture/Analytics/AmazonFinSpace
```

```text
include('aws-q3-2021/Architecture/Analytics/AmazonFinSpace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Architecture/Analytics/AmazonFinSpace.png) | ![illustration for AmazonFinSpace](../../../aws-q3-2021/Architecture/Analytics/AmazonFinSpace.Local.png) | ![illustration for AmazonFinSpaceCard](../../../aws-q3-2021/Architecture/Analytics/AmazonFinSpaceCard.Local.png) | ![illustration for AmazonFinSpaceGroup](../../../aws-q3-2021/Architecture/Analytics/AmazonFinSpaceGroup.Local.png) |
