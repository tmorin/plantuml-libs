...
```text
aws-q3-2021/Architecture/GeneralIcons/AwsMarketplaceLight
```

```text
include('aws-q3-2021/Architecture/GeneralIcons/AwsMarketplaceLight')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Architecture/GeneralIcons/AwsMarketplaceLight.png) | ![illustration for AwsMarketplaceLight](../../../aws-q3-2021/Architecture/GeneralIcons/AwsMarketplaceLight.Local.png) | ![illustration for AwsMarketplaceLightCard](../../../aws-q3-2021/Architecture/GeneralIcons/AwsMarketplaceLightCard.Local.png) | ![illustration for AwsMarketplaceLightGroup](../../../aws-q3-2021/Architecture/GeneralIcons/AwsMarketplaceLightGroup.Local.png) |
