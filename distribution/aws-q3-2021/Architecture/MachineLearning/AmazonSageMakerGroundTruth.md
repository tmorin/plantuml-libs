...
```text
aws-q3-2021/Architecture/MachineLearning/AmazonSageMakerGroundTruth
```

```text
include('aws-q3-2021/Architecture/MachineLearning/AmazonSageMakerGroundTruth')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Architecture/MachineLearning/AmazonSageMakerGroundTruth.png) | ![illustration for AmazonSageMakerGroundTruth](../../../aws-q3-2021/Architecture/MachineLearning/AmazonSageMakerGroundTruth.Local.png) | ![illustration for AmazonSageMakerGroundTruthCard](../../../aws-q3-2021/Architecture/MachineLearning/AmazonSageMakerGroundTruthCard.Local.png) | ![illustration for AmazonSageMakerGroundTruthGroup](../../../aws-q3-2021/Architecture/MachineLearning/AmazonSageMakerGroundTruthGroup.Local.png) |
