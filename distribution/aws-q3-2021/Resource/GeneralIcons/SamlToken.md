...
```text
aws-q3-2021/Resource/GeneralIcons/SamlToken
```

```text
include('aws-q3-2021/Resource/GeneralIcons/SamlToken')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Resource/GeneralIcons/SamlToken.png) | ![illustration for SamlToken](../../../aws-q3-2021/Resource/GeneralIcons/SamlToken.Local.png) | ![illustration for SamlTokenCard](../../../aws-q3-2021/Resource/GeneralIcons/SamlTokenCard.Local.png) | ![illustration for SamlTokenGroup](../../../aws-q3-2021/Resource/GeneralIcons/SamlTokenGroup.Local.png) |
