...
```text
aws-q3-2021/Resource/Database/AmazonDynamoDbStream
```

```text
include('aws-q3-2021/Resource/Database/AmazonDynamoDbStream')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Resource/Database/AmazonDynamoDbStream.png) | ![illustration for AmazonDynamoDbStream](../../../aws-q3-2021/Resource/Database/AmazonDynamoDbStream.Local.png) | ![illustration for AmazonDynamoDbStreamCard](../../../aws-q3-2021/Resource/Database/AmazonDynamoDbStreamCard.Local.png) | ![illustration for AmazonDynamoDbStreamGroup](../../../aws-q3-2021/Resource/Database/AmazonDynamoDbStreamGroup.Local.png) |
