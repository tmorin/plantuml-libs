...
```text
aws-q3-2021/Resource/Database/AmazonAuroraPostgreSqlInstance
```

```text
include('aws-q3-2021/Resource/Database/AmazonAuroraPostgreSqlInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Resource/Database/AmazonAuroraPostgreSqlInstance.png) | ![illustration for AmazonAuroraPostgreSqlInstance](../../../aws-q3-2021/Resource/Database/AmazonAuroraPostgreSqlInstance.Local.png) | ![illustration for AmazonAuroraPostgreSqlInstanceCard](../../../aws-q3-2021/Resource/Database/AmazonAuroraPostgreSqlInstanceCard.Local.png) | ![illustration for AmazonAuroraPostgreSqlInstanceGroup](../../../aws-q3-2021/Resource/Database/AmazonAuroraPostgreSqlInstanceGroup.Local.png) |
