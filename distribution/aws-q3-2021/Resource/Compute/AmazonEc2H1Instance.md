...
```text
aws-q3-2021/Resource/Compute/AmazonEc2H1Instance
```

```text
include('aws-q3-2021/Resource/Compute/AmazonEc2H1Instance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Resource/Compute/AmazonEc2H1Instance.png) | ![illustration for AmazonEc2H1Instance](../../../aws-q3-2021/Resource/Compute/AmazonEc2H1Instance.Local.png) | ![illustration for AmazonEc2H1InstanceCard](../../../aws-q3-2021/Resource/Compute/AmazonEc2H1InstanceCard.Local.png) | ![illustration for AmazonEc2H1InstanceGroup](../../../aws-q3-2021/Resource/Compute/AmazonEc2H1InstanceGroup.Local.png) |
