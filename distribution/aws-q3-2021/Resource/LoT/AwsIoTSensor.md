...
```text
aws-q3-2021/Resource/LoT/AwsIoTSensor
```

```text
include('aws-q3-2021/Resource/LoT/AwsIoTSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Resource/LoT/AwsIoTSensor.png) | ![illustration for AwsIoTSensor](../../../aws-q3-2021/Resource/LoT/AwsIoTSensor.Local.png) | ![illustration for AwsIoTSensorCard](../../../aws-q3-2021/Resource/LoT/AwsIoTSensorCard.Local.png) | ![illustration for AwsIoTSensorGroup](../../../aws-q3-2021/Resource/LoT/AwsIoTSensorGroup.Local.png) |
