...
```text
aws-q3-2021/Resource/LoT/AwsIoTThingCamera
```

```text
include('aws-q3-2021/Resource/LoT/AwsIoTThingCamera')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Resource/LoT/AwsIoTThingCamera.png) | ![illustration for AwsIoTThingCamera](../../../aws-q3-2021/Resource/LoT/AwsIoTThingCamera.Local.png) | ![illustration for AwsIoTThingCameraCard](../../../aws-q3-2021/Resource/LoT/AwsIoTThingCameraCard.Local.png) | ![illustration for AwsIoTThingCameraGroup](../../../aws-q3-2021/Resource/LoT/AwsIoTThingCameraGroup.Local.png) |
