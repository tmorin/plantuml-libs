...
```text
aws-q3-2021/Resource/LoT/AwsIoTThingDoorLock
```

```text
include('aws-q3-2021/Resource/LoT/AwsIoTThingDoorLock')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Resource/LoT/AwsIoTThingDoorLock.png) | ![illustration for AwsIoTThingDoorLock](../../../aws-q3-2021/Resource/LoT/AwsIoTThingDoorLock.Local.png) | ![illustration for AwsIoTThingDoorLockCard](../../../aws-q3-2021/Resource/LoT/AwsIoTThingDoorLockCard.Local.png) | ![illustration for AwsIoTThingDoorLockGroup](../../../aws-q3-2021/Resource/LoT/AwsIoTThingDoorLockGroup.Local.png) |
