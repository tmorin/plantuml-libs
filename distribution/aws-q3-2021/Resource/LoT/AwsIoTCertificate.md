...
```text
aws-q3-2021/Resource/LoT/AwsIoTCertificate
```

```text
include('aws-q3-2021/Resource/LoT/AwsIoTCertificate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Resource/LoT/AwsIoTCertificate.png) | ![illustration for AwsIoTCertificate](../../../aws-q3-2021/Resource/LoT/AwsIoTCertificate.Local.png) | ![illustration for AwsIoTCertificateCard](../../../aws-q3-2021/Resource/LoT/AwsIoTCertificateCard.Local.png) | ![illustration for AwsIoTCertificateGroup](../../../aws-q3-2021/Resource/LoT/AwsIoTCertificateGroup.Local.png) |
