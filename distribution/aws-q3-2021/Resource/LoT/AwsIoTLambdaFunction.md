...
```text
aws-q3-2021/Resource/LoT/AwsIoTLambdaFunction
```

```text
include('aws-q3-2021/Resource/LoT/AwsIoTLambdaFunction')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2021/Resource/LoT/AwsIoTLambdaFunction.png) | ![illustration for AwsIoTLambdaFunction](../../../aws-q3-2021/Resource/LoT/AwsIoTLambdaFunction.Local.png) | ![illustration for AwsIoTLambdaFunctionCard](../../../aws-q3-2021/Resource/LoT/AwsIoTLambdaFunctionCard.Local.png) | ![illustration for AwsIoTLambdaFunctionGroup](../../../aws-q3-2021/Resource/LoT/AwsIoTLambdaFunctionGroup.Local.png) |
