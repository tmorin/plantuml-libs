...
```text
aws-q3-2021/Resource/ManagementGovernance/AmazonCloudWatchSynthetics
```

```text
include('aws-q3-2021/Resource/ManagementGovernance/AmazonCloudWatchSynthetics')
```
