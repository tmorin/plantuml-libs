...
```text
aws-q2-2022/Architecture/ManagementGovernance/AwsProton
```

```text
include('aws-q2-2022/Architecture/ManagementGovernance/AwsProton')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/ManagementGovernance/AwsProton.png) | ![illustration for AwsProton](../../../aws-q2-2022/Architecture/ManagementGovernance/AwsProton.Local.png) | ![illustration for AwsProtonCard](../../../aws-q2-2022/Architecture/ManagementGovernance/AwsProtonCard.Local.png) | ![illustration for AwsProtonGroup](../../../aws-q2-2022/Architecture/ManagementGovernance/AwsProtonGroup.Local.png) |
