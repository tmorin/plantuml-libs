...
```text
aws-q2-2022/Architecture/AppIntegration/AwsStepFunctions
```

```text
include('aws-q2-2022/Architecture/AppIntegration/AwsStepFunctions')
```
