...
```text
aws-q2-2022/Architecture/AppIntegration/AmazonEventBridge
```

```text
include('aws-q2-2022/Architecture/AppIntegration/AmazonEventBridge')
```
