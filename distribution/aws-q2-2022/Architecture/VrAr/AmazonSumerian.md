...
```text
aws-q2-2022/Architecture/VrAr/AmazonSumerian
```

```text
include('aws-q2-2022/Architecture/VrAr/AmazonSumerian')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/VrAr/AmazonSumerian.png) | ![illustration for AmazonSumerian](../../../aws-q2-2022/Architecture/VrAr/AmazonSumerian.Local.png) | ![illustration for AmazonSumerianCard](../../../aws-q2-2022/Architecture/VrAr/AmazonSumerianCard.Local.png) | ![illustration for AmazonSumerianGroup](../../../aws-q2-2022/Architecture/VrAr/AmazonSumerianGroup.Local.png) |
