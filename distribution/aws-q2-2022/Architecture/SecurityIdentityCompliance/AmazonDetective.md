...
```text
aws-q2-2022/Architecture/SecurityIdentityCompliance/AmazonDetective
```

```text
include('aws-q2-2022/Architecture/SecurityIdentityCompliance/AmazonDetective')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/SecurityIdentityCompliance/AmazonDetective.png) | ![illustration for AmazonDetective](../../../aws-q2-2022/Architecture/SecurityIdentityCompliance/AmazonDetective.Local.png) | ![illustration for AmazonDetectiveCard](../../../aws-q2-2022/Architecture/SecurityIdentityCompliance/AmazonDetectiveCard.Local.png) | ![illustration for AmazonDetectiveGroup](../../../aws-q2-2022/Architecture/SecurityIdentityCompliance/AmazonDetectiveGroup.Local.png) |
