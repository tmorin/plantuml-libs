...
```text
aws-q2-2022/Architecture/Database/AmazonQuantumLedgerDatabase
```

```text
include('aws-q2-2022/Architecture/Database/AmazonQuantumLedgerDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Database/AmazonQuantumLedgerDatabase.png) | ![illustration for AmazonQuantumLedgerDatabase](../../../aws-q2-2022/Architecture/Database/AmazonQuantumLedgerDatabase.Local.png) | ![illustration for AmazonQuantumLedgerDatabaseCard](../../../aws-q2-2022/Architecture/Database/AmazonQuantumLedgerDatabaseCard.Local.png) | ![illustration for AmazonQuantumLedgerDatabaseGroup](../../../aws-q2-2022/Architecture/Database/AmazonQuantumLedgerDatabaseGroup.Local.png) |
