...
```text
aws-q2-2022/Architecture/Robotics/AwsRoboMaker
```

```text
include('aws-q2-2022/Architecture/Robotics/AwsRoboMaker')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Robotics/AwsRoboMaker.png) | ![illustration for AwsRoboMaker](../../../aws-q2-2022/Architecture/Robotics/AwsRoboMaker.Local.png) | ![illustration for AwsRoboMakerCard](../../../aws-q2-2022/Architecture/Robotics/AwsRoboMakerCard.Local.png) | ![illustration for AwsRoboMakerGroup](../../../aws-q2-2022/Architecture/Robotics/AwsRoboMakerGroup.Local.png) |
