...
```text
aws-q2-2022/Architecture/Compute/VMwareCloudOnAws
```

```text
include('aws-q2-2022/Architecture/Compute/VMwareCloudOnAws')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Compute/VMwareCloudOnAws.png) | ![illustration for VMwareCloudOnAws](../../../aws-q2-2022/Architecture/Compute/VMwareCloudOnAws.Local.png) | ![illustration for VMwareCloudOnAwsCard](../../../aws-q2-2022/Architecture/Compute/VMwareCloudOnAwsCard.Local.png) | ![illustration for VMwareCloudOnAwsGroup](../../../aws-q2-2022/Architecture/Compute/VMwareCloudOnAwsGroup.Local.png) |
