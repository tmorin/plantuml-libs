...
```text
aws-q2-2022/Architecture/Compute/AwsAppRunner
```

```text
include('aws-q2-2022/Architecture/Compute/AwsAppRunner')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Compute/AwsAppRunner.png) | ![illustration for AwsAppRunner](../../../aws-q2-2022/Architecture/Compute/AwsAppRunner.Local.png) | ![illustration for AwsAppRunnerCard](../../../aws-q2-2022/Architecture/Compute/AwsAppRunnerCard.Local.png) | ![illustration for AwsAppRunnerGroup](../../../aws-q2-2022/Architecture/Compute/AwsAppRunnerGroup.Local.png) |
