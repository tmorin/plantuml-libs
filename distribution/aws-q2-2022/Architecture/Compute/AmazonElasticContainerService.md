...
```text
aws-q2-2022/Architecture/Compute/AmazonElasticContainerService
```

```text
include('aws-q2-2022/Architecture/Compute/AmazonElasticContainerService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Compute/AmazonElasticContainerService.png) | ![illustration for AmazonElasticContainerService](../../../aws-q2-2022/Architecture/Compute/AmazonElasticContainerService.Local.png) | ![illustration for AmazonElasticContainerServiceCard](../../../aws-q2-2022/Architecture/Compute/AmazonElasticContainerServiceCard.Local.png) | ![illustration for AmazonElasticContainerServiceGroup](../../../aws-q2-2022/Architecture/Compute/AmazonElasticContainerServiceGroup.Local.png) |
