...
```text
aws-q2-2022/Architecture/Compute/AwsOutpostsServers
```

```text
include('aws-q2-2022/Architecture/Compute/AwsOutpostsServers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Compute/AwsOutpostsServers.png) | ![illustration for AwsOutpostsServers](../../../aws-q2-2022/Architecture/Compute/AwsOutpostsServers.Local.png) | ![illustration for AwsOutpostsServersCard](../../../aws-q2-2022/Architecture/Compute/AwsOutpostsServersCard.Local.png) | ![illustration for AwsOutpostsServersGroup](../../../aws-q2-2022/Architecture/Compute/AwsOutpostsServersGroup.Local.png) |
