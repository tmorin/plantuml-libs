...
```text
aws-q2-2022/Architecture/Satellite/AwsGroundStation
```

```text
include('aws-q2-2022/Architecture/Satellite/AwsGroundStation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Satellite/AwsGroundStation.png) | ![illustration for AwsGroundStation](../../../aws-q2-2022/Architecture/Satellite/AwsGroundStation.Local.png) | ![illustration for AwsGroundStationCard](../../../aws-q2-2022/Architecture/Satellite/AwsGroundStationCard.Local.png) | ![illustration for AwsGroundStationGroup](../../../aws-q2-2022/Architecture/Satellite/AwsGroundStationGroup.Local.png) |
