...
```text
aws-q2-2022/Architecture/Containers/AmazonEksCloud
```

```text
include('aws-q2-2022/Architecture/Containers/AmazonEksCloud')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Containers/AmazonEksCloud.png) | ![illustration for AmazonEksCloud](../../../aws-q2-2022/Architecture/Containers/AmazonEksCloud.Local.png) | ![illustration for AmazonEksCloudCard](../../../aws-q2-2022/Architecture/Containers/AmazonEksCloudCard.Local.png) | ![illustration for AmazonEksCloudGroup](../../../aws-q2-2022/Architecture/Containers/AmazonEksCloudGroup.Local.png) |
