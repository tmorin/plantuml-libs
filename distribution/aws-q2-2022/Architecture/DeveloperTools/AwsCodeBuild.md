...
```text
aws-q2-2022/Architecture/DeveloperTools/AwsCodeBuild
```

```text
include('aws-q2-2022/Architecture/DeveloperTools/AwsCodeBuild')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/DeveloperTools/AwsCodeBuild.png) | ![illustration for AwsCodeBuild](../../../aws-q2-2022/Architecture/DeveloperTools/AwsCodeBuild.Local.png) | ![illustration for AwsCodeBuildCard](../../../aws-q2-2022/Architecture/DeveloperTools/AwsCodeBuildCard.Local.png) | ![illustration for AwsCodeBuildGroup](../../../aws-q2-2022/Architecture/DeveloperTools/AwsCodeBuildGroup.Local.png) |
