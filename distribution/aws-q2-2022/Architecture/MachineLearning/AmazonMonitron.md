...
```text
aws-q2-2022/Architecture/MachineLearning/AmazonMonitron
```

```text
include('aws-q2-2022/Architecture/MachineLearning/AmazonMonitron')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/MachineLearning/AmazonMonitron.png) | ![illustration for AmazonMonitron](../../../aws-q2-2022/Architecture/MachineLearning/AmazonMonitron.Local.png) | ![illustration for AmazonMonitronCard](../../../aws-q2-2022/Architecture/MachineLearning/AmazonMonitronCard.Local.png) | ![illustration for AmazonMonitronGroup](../../../aws-q2-2022/Architecture/MachineLearning/AmazonMonitronGroup.Local.png) |
