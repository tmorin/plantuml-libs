...
```text
aws-q2-2022/Architecture/MachineLearning/AmazonTranscribe
```

```text
include('aws-q2-2022/Architecture/MachineLearning/AmazonTranscribe')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/MachineLearning/AmazonTranscribe.png) | ![illustration for AmazonTranscribe](../../../aws-q2-2022/Architecture/MachineLearning/AmazonTranscribe.Local.png) | ![illustration for AmazonTranscribeCard](../../../aws-q2-2022/Architecture/MachineLearning/AmazonTranscribeCard.Local.png) | ![illustration for AmazonTranscribeGroup](../../../aws-q2-2022/Architecture/MachineLearning/AmazonTranscribeGroup.Local.png) |
