...
```text
aws-q2-2022/Architecture/MachineLearning/AmazonDevOpsGuru
```

```text
include('aws-q2-2022/Architecture/MachineLearning/AmazonDevOpsGuru')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/MachineLearning/AmazonDevOpsGuru.png) | ![illustration for AmazonDevOpsGuru](../../../aws-q2-2022/Architecture/MachineLearning/AmazonDevOpsGuru.Local.png) | ![illustration for AmazonDevOpsGuruCard](../../../aws-q2-2022/Architecture/MachineLearning/AmazonDevOpsGuruCard.Local.png) | ![illustration for AmazonDevOpsGuruGroup](../../../aws-q2-2022/Architecture/MachineLearning/AmazonDevOpsGuruGroup.Local.png) |
