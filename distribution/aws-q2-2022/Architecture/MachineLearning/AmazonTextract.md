...
```text
aws-q2-2022/Architecture/MachineLearning/AmazonTextract
```

```text
include('aws-q2-2022/Architecture/MachineLearning/AmazonTextract')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/MachineLearning/AmazonTextract.png) | ![illustration for AmazonTextract](../../../aws-q2-2022/Architecture/MachineLearning/AmazonTextract.Local.png) | ![illustration for AmazonTextractCard](../../../aws-q2-2022/Architecture/MachineLearning/AmazonTextractCard.Local.png) | ![illustration for AmazonTextractGroup](../../../aws-q2-2022/Architecture/MachineLearning/AmazonTextractGroup.Local.png) |
