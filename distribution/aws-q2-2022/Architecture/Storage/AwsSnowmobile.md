...
```text
aws-q2-2022/Architecture/Storage/AwsSnowmobile
```

```text
include('aws-q2-2022/Architecture/Storage/AwsSnowmobile')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Storage/AwsSnowmobile.png) | ![illustration for AwsSnowmobile](../../../aws-q2-2022/Architecture/Storage/AwsSnowmobile.Local.png) | ![illustration for AwsSnowmobileCard](../../../aws-q2-2022/Architecture/Storage/AwsSnowmobileCard.Local.png) | ![illustration for AwsSnowmobileGroup](../../../aws-q2-2022/Architecture/Storage/AwsSnowmobileGroup.Local.png) |
