...
```text
aws-q2-2022/Architecture/Storage/AmazonFSxForLustre
```

```text
include('aws-q2-2022/Architecture/Storage/AmazonFSxForLustre')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Storage/AmazonFSxForLustre.png) | ![illustration for AmazonFSxForLustre](../../../aws-q2-2022/Architecture/Storage/AmazonFSxForLustre.Local.png) | ![illustration for AmazonFSxForLustreCard](../../../aws-q2-2022/Architecture/Storage/AmazonFSxForLustreCard.Local.png) | ![illustration for AmazonFSxForLustreGroup](../../../aws-q2-2022/Architecture/Storage/AmazonFSxForLustreGroup.Local.png) |
