...
```text
aws-q2-2022/Architecture/MigrationTransfer/AwsApplicationDiscoveryService
```

```text
include('aws-q2-2022/Architecture/MigrationTransfer/AwsApplicationDiscoveryService')
```
