...
```text
aws-q2-2022/Architecture/MediaServices/AmazonElasticTranscoder
```

```text
include('aws-q2-2022/Architecture/MediaServices/AmazonElasticTranscoder')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/MediaServices/AmazonElasticTranscoder.png) | ![illustration for AmazonElasticTranscoder](../../../aws-q2-2022/Architecture/MediaServices/AmazonElasticTranscoder.Local.png) | ![illustration for AmazonElasticTranscoderCard](../../../aws-q2-2022/Architecture/MediaServices/AmazonElasticTranscoderCard.Local.png) | ![illustration for AmazonElasticTranscoderGroup](../../../aws-q2-2022/Architecture/MediaServices/AmazonElasticTranscoderGroup.Local.png) |
