...
```text
aws-q2-2022/Architecture/MediaServices/AwsElementalMediaTailor
```

```text
include('aws-q2-2022/Architecture/MediaServices/AwsElementalMediaTailor')
```
