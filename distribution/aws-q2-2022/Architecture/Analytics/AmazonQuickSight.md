...
```text
aws-q2-2022/Architecture/Analytics/AmazonQuickSight
```

```text
include('aws-q2-2022/Architecture/Analytics/AmazonQuickSight')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Analytics/AmazonQuickSight.png) | ![illustration for AmazonQuickSight](../../../aws-q2-2022/Architecture/Analytics/AmazonQuickSight.Local.png) | ![illustration for AmazonQuickSightCard](../../../aws-q2-2022/Architecture/Analytics/AmazonQuickSightCard.Local.png) | ![illustration for AmazonQuickSightGroup](../../../aws-q2-2022/Architecture/Analytics/AmazonQuickSightGroup.Local.png) |
