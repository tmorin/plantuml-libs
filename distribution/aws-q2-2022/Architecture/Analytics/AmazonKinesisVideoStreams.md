...
```text
aws-q2-2022/Architecture/Analytics/AmazonKinesisVideoStreams
```

```text
include('aws-q2-2022/Architecture/Analytics/AmazonKinesisVideoStreams')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Analytics/AmazonKinesisVideoStreams.png) | ![illustration for AmazonKinesisVideoStreams](../../../aws-q2-2022/Architecture/Analytics/AmazonKinesisVideoStreams.Local.png) | ![illustration for AmazonKinesisVideoStreamsCard](../../../aws-q2-2022/Architecture/Analytics/AmazonKinesisVideoStreamsCard.Local.png) | ![illustration for AmazonKinesisVideoStreamsGroup](../../../aws-q2-2022/Architecture/Analytics/AmazonKinesisVideoStreamsGroup.Local.png) |
