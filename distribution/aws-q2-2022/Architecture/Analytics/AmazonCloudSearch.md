...
```text
aws-q2-2022/Architecture/Analytics/AmazonCloudSearch
```

```text
include('aws-q2-2022/Architecture/Analytics/AmazonCloudSearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Analytics/AmazonCloudSearch.png) | ![illustration for AmazonCloudSearch](../../../aws-q2-2022/Architecture/Analytics/AmazonCloudSearch.Local.png) | ![illustration for AmazonCloudSearchCard](../../../aws-q2-2022/Architecture/Analytics/AmazonCloudSearchCard.Local.png) | ![illustration for AmazonCloudSearchGroup](../../../aws-q2-2022/Architecture/Analytics/AmazonCloudSearchGroup.Local.png) |
