...
```text
aws-q2-2022/Architecture/Analytics/AmazonOpenSearchService
```

```text
include('aws-q2-2022/Architecture/Analytics/AmazonOpenSearchService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/Analytics/AmazonOpenSearchService.png) | ![illustration for AmazonOpenSearchService](../../../aws-q2-2022/Architecture/Analytics/AmazonOpenSearchService.Local.png) | ![illustration for AmazonOpenSearchServiceCard](../../../aws-q2-2022/Architecture/Analytics/AmazonOpenSearchServiceCard.Local.png) | ![illustration for AmazonOpenSearchServiceGroup](../../../aws-q2-2022/Architecture/Analytics/AmazonOpenSearchServiceGroup.Local.png) |
