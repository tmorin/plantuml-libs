...
```text
aws-q2-2022/Architecture/CustomerEnablement/AwsActivate
```

```text
include('aws-q2-2022/Architecture/CustomerEnablement/AwsActivate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/CustomerEnablement/AwsActivate.png) | ![illustration for AwsActivate](../../../aws-q2-2022/Architecture/CustomerEnablement/AwsActivate.Local.png) | ![illustration for AwsActivateCard](../../../aws-q2-2022/Architecture/CustomerEnablement/AwsActivateCard.Local.png) | ![illustration for AwsActivateGroup](../../../aws-q2-2022/Architecture/CustomerEnablement/AwsActivateGroup.Local.png) |
