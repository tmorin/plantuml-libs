...
```text
aws-q2-2022/Architecture/GameTech/AmazonGameLift
```

```text
include('aws-q2-2022/Architecture/GameTech/AmazonGameLift')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Architecture/GameTech/AmazonGameLift.png) | ![illustration for AmazonGameLift](../../../aws-q2-2022/Architecture/GameTech/AmazonGameLift.Local.png) | ![illustration for AmazonGameLiftCard](../../../aws-q2-2022/Architecture/GameTech/AmazonGameLiftCard.Local.png) | ![illustration for AmazonGameLiftGroup](../../../aws-q2-2022/Architecture/GameTech/AmazonGameLiftGroup.Local.png) |
