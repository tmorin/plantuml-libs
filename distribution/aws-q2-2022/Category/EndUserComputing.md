...
```text
aws-q2-2022/Category/EndUserComputing
```

```text
include('aws-q2-2022/Category/EndUserComputing')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q2-2022/Category/EndUserComputing.png) | ![illustration for EndUserComputing](../../aws-q2-2022/Category/EndUserComputing.Local.png) | ![illustration for EndUserComputingCard](../../aws-q2-2022/Category/EndUserComputingCard.Local.png) | ![illustration for EndUserComputingGroup](../../aws-q2-2022/Category/EndUserComputingGroup.Local.png) |
