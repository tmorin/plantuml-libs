...
```text
aws-q2-2022/Category/CustomerEnablement
```

```text
include('aws-q2-2022/Category/CustomerEnablement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q2-2022/Category/CustomerEnablement.png) | ![illustration for CustomerEnablement](../../aws-q2-2022/Category/CustomerEnablement.Local.png) | ![illustration for CustomerEnablementCard](../../aws-q2-2022/Category/CustomerEnablementCard.Local.png) | ![illustration for CustomerEnablementGroup](../../aws-q2-2022/Category/CustomerEnablementGroup.Local.png) |
