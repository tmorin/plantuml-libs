...
```text
aws-q2-2022/Category/MachineLearning
```

```text
include('aws-q2-2022/Category/MachineLearning')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q2-2022/Category/MachineLearning.png) | ![illustration for MachineLearning](../../aws-q2-2022/Category/MachineLearning.Local.png) | ![illustration for MachineLearningCard](../../aws-q2-2022/Category/MachineLearningCard.Local.png) | ![illustration for MachineLearningGroup](../../aws-q2-2022/Category/MachineLearningGroup.Local.png) |
