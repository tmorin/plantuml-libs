...
```text
aws-q2-2022/Resource/LoT/AwsIoTGreengrassArtifact
```

```text
include('aws-q2-2022/Resource/LoT/AwsIoTGreengrassArtifact')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/LoT/AwsIoTGreengrassArtifact.png) | ![illustration for AwsIoTGreengrassArtifact](../../../aws-q2-2022/Resource/LoT/AwsIoTGreengrassArtifact.Local.png) | ![illustration for AwsIoTGreengrassArtifactCard](../../../aws-q2-2022/Resource/LoT/AwsIoTGreengrassArtifactCard.Local.png) | ![illustration for AwsIoTGreengrassArtifactGroup](../../../aws-q2-2022/Resource/LoT/AwsIoTGreengrassArtifactGroup.Local.png) |
