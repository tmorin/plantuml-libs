...
```text
aws-q2-2022/Resource/LoT/AwsIoTThingPlc
```

```text
include('aws-q2-2022/Resource/LoT/AwsIoTThingPlc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/LoT/AwsIoTThingPlc.png) | ![illustration for AwsIoTThingPlc](../../../aws-q2-2022/Resource/LoT/AwsIoTThingPlc.Local.png) | ![illustration for AwsIoTThingPlcCard](../../../aws-q2-2022/Resource/LoT/AwsIoTThingPlcCard.Local.png) | ![illustration for AwsIoTThingPlcGroup](../../../aws-q2-2022/Resource/LoT/AwsIoTThingPlcGroup.Local.png) |
