...
```text
aws-q2-2022/Resource/LoT/AwsIoTSensor
```

```text
include('aws-q2-2022/Resource/LoT/AwsIoTSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/LoT/AwsIoTSensor.png) | ![illustration for AwsIoTSensor](../../../aws-q2-2022/Resource/LoT/AwsIoTSensor.Local.png) | ![illustration for AwsIoTSensorCard](../../../aws-q2-2022/Resource/LoT/AwsIoTSensorCard.Local.png) | ![illustration for AwsIoTSensorGroup](../../../aws-q2-2022/Resource/LoT/AwsIoTSensorGroup.Local.png) |
