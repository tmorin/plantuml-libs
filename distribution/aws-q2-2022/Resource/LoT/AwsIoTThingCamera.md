...
```text
aws-q2-2022/Resource/LoT/AwsIoTThingCamera
```

```text
include('aws-q2-2022/Resource/LoT/AwsIoTThingCamera')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/LoT/AwsIoTThingCamera.png) | ![illustration for AwsIoTThingCamera](../../../aws-q2-2022/Resource/LoT/AwsIoTThingCamera.Local.png) | ![illustration for AwsIoTThingCameraCard](../../../aws-q2-2022/Resource/LoT/AwsIoTThingCameraCard.Local.png) | ![illustration for AwsIoTThingCameraGroup](../../../aws-q2-2022/Resource/LoT/AwsIoTThingCameraGroup.Local.png) |
