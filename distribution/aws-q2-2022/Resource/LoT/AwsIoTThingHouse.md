...
```text
aws-q2-2022/Resource/LoT/AwsIoTThingHouse
```

```text
include('aws-q2-2022/Resource/LoT/AwsIoTThingHouse')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/LoT/AwsIoTThingHouse.png) | ![illustration for AwsIoTThingHouse](../../../aws-q2-2022/Resource/LoT/AwsIoTThingHouse.Local.png) | ![illustration for AwsIoTThingHouseCard](../../../aws-q2-2022/Resource/LoT/AwsIoTThingHouseCard.Local.png) | ![illustration for AwsIoTThingHouseGroup](../../../aws-q2-2022/Resource/LoT/AwsIoTThingHouseGroup.Local.png) |
