...
```text
aws-q2-2022/Resource/LoT/AwsIoTThingTemperatureSensor
```

```text
include('aws-q2-2022/Resource/LoT/AwsIoTThingTemperatureSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/LoT/AwsIoTThingTemperatureSensor.png) | ![illustration for AwsIoTThingTemperatureSensor](../../../aws-q2-2022/Resource/LoT/AwsIoTThingTemperatureSensor.Local.png) | ![illustration for AwsIoTThingTemperatureSensorCard](../../../aws-q2-2022/Resource/LoT/AwsIoTThingTemperatureSensorCard.Local.png) | ![illustration for AwsIoTThingTemperatureSensorGroup](../../../aws-q2-2022/Resource/LoT/AwsIoTThingTemperatureSensorGroup.Local.png) |
