...
```text
aws-q2-2022/Resource/LoT/AwsIoTThingBank
```

```text
include('aws-q2-2022/Resource/LoT/AwsIoTThingBank')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/LoT/AwsIoTThingBank.png) | ![illustration for AwsIoTThingBank](../../../aws-q2-2022/Resource/LoT/AwsIoTThingBank.Local.png) | ![illustration for AwsIoTThingBankCard](../../../aws-q2-2022/Resource/LoT/AwsIoTThingBankCard.Local.png) | ![illustration for AwsIoTThingBankGroup](../../../aws-q2-2022/Resource/LoT/AwsIoTThingBankGroup.Local.png) |
