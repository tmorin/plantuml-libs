...
```text
aws-q2-2022/Resource/LoT/AwsIoTAlexaEnabledDevice
```

```text
include('aws-q2-2022/Resource/LoT/AwsIoTAlexaEnabledDevice')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/LoT/AwsIoTAlexaEnabledDevice.png) | ![illustration for AwsIoTAlexaEnabledDevice](../../../aws-q2-2022/Resource/LoT/AwsIoTAlexaEnabledDevice.Local.png) | ![illustration for AwsIoTAlexaEnabledDeviceCard](../../../aws-q2-2022/Resource/LoT/AwsIoTAlexaEnabledDeviceCard.Local.png) | ![illustration for AwsIoTAlexaEnabledDeviceGroup](../../../aws-q2-2022/Resource/LoT/AwsIoTAlexaEnabledDeviceGroup.Local.png) |
