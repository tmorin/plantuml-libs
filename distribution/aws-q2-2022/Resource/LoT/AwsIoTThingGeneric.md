...
```text
aws-q2-2022/Resource/LoT/AwsIoTThingGeneric
```

```text
include('aws-q2-2022/Resource/LoT/AwsIoTThingGeneric')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/LoT/AwsIoTThingGeneric.png) | ![illustration for AwsIoTThingGeneric](../../../aws-q2-2022/Resource/LoT/AwsIoTThingGeneric.Local.png) | ![illustration for AwsIoTThingGenericCard](../../../aws-q2-2022/Resource/LoT/AwsIoTThingGenericCard.Local.png) | ![illustration for AwsIoTThingGenericGroup](../../../aws-q2-2022/Resource/LoT/AwsIoTThingGenericGroup.Local.png) |
