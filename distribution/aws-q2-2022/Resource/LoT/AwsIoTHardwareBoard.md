...
```text
aws-q2-2022/Resource/LoT/AwsIoTHardwareBoard
```

```text
include('aws-q2-2022/Resource/LoT/AwsIoTHardwareBoard')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/LoT/AwsIoTHardwareBoard.png) | ![illustration for AwsIoTHardwareBoard](../../../aws-q2-2022/Resource/LoT/AwsIoTHardwareBoard.Local.png) | ![illustration for AwsIoTHardwareBoardCard](../../../aws-q2-2022/Resource/LoT/AwsIoTHardwareBoardCard.Local.png) | ![illustration for AwsIoTHardwareBoardGroup](../../../aws-q2-2022/Resource/LoT/AwsIoTHardwareBoardGroup.Local.png) |
