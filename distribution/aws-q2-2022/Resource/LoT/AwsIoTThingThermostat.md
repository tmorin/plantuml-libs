...
```text
aws-q2-2022/Resource/LoT/AwsIoTThingThermostat
```

```text
include('aws-q2-2022/Resource/LoT/AwsIoTThingThermostat')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/LoT/AwsIoTThingThermostat.png) | ![illustration for AwsIoTThingThermostat](../../../aws-q2-2022/Resource/LoT/AwsIoTThingThermostat.Local.png) | ![illustration for AwsIoTThingThermostatCard](../../../aws-q2-2022/Resource/LoT/AwsIoTThingThermostatCard.Local.png) | ![illustration for AwsIoTThingThermostatGroup](../../../aws-q2-2022/Resource/LoT/AwsIoTThingThermostatGroup.Local.png) |
