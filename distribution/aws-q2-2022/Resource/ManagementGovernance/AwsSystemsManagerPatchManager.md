...
```text
aws-q2-2022/Resource/ManagementGovernance/AwsSystemsManagerPatchManager
```

```text
include('aws-q2-2022/Resource/ManagementGovernance/AwsSystemsManagerPatchManager')
```
