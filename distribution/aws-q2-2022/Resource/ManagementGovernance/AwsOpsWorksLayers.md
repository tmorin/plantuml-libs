...
```text
aws-q2-2022/Resource/ManagementGovernance/AwsOpsWorksLayers
```

```text
include('aws-q2-2022/Resource/ManagementGovernance/AwsOpsWorksLayers')
```
