...
```text
aws-q2-2022/Resource/ManagementGovernance/AmazonCloudWatchMetricsInsights
```

```text
include('aws-q2-2022/Resource/ManagementGovernance/AmazonCloudWatchMetricsInsights')
```
