...
```text
aws-q2-2022/Resource/ManagementGovernance/AwsSystemsManagerOpsCenter
```

```text
include('aws-q2-2022/Resource/ManagementGovernance/AwsSystemsManagerOpsCenter')
```
