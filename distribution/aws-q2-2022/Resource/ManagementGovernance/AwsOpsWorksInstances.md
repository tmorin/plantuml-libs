...
```text
aws-q2-2022/Resource/ManagementGovernance/AwsOpsWorksInstances
```

```text
include('aws-q2-2022/Resource/ManagementGovernance/AwsOpsWorksInstances')
```
