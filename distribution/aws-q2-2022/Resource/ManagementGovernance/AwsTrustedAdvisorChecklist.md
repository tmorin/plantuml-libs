...
```text
aws-q2-2022/Resource/ManagementGovernance/AwsTrustedAdvisorChecklist
```

```text
include('aws-q2-2022/Resource/ManagementGovernance/AwsTrustedAdvisorChecklist')
```
