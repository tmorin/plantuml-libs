...
```text
aws-q2-2022/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistSecurity
```

```text
include('aws-q2-2022/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistSecurity')
```
