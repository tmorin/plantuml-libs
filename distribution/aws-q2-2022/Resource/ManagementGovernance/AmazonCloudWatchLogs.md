...
```text
aws-q2-2022/Resource/ManagementGovernance/AmazonCloudWatchLogs
```

```text
include('aws-q2-2022/Resource/ManagementGovernance/AmazonCloudWatchLogs')
```
