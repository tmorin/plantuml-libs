...
```text
aws-q2-2022/Resource/ManagementGovernance/AmazonCloudWatchAlarm
```

```text
include('aws-q2-2022/Resource/ManagementGovernance/AmazonCloudWatchAlarm')
```
