...
```text
aws-q2-2022/Resource/ManagementGovernance/AwsOpsWorksPermissions
```

```text
include('aws-q2-2022/Resource/ManagementGovernance/AwsOpsWorksPermissions')
```
