...
```text
aws-q2-2022/Resource/GroupIcons/AutoScaling
```

```text
include('aws-q2-2022/Resource/GroupIcons/AutoScaling')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/GroupIcons/AutoScaling.png) | ![illustration for AutoScaling](../../../aws-q2-2022/Resource/GroupIcons/AutoScaling.Local.png) | ![illustration for AutoScalingCard](../../../aws-q2-2022/Resource/GroupIcons/AutoScalingCard.Local.png) | ![illustration for AutoScalingGroup](../../../aws-q2-2022/Resource/GroupIcons/AutoScalingGroup.Local.png) |
