...
```text
aws-q2-2022/Resource/GroupIcons/SpotFleet
```

```text
include('aws-q2-2022/Resource/GroupIcons/SpotFleet')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/GroupIcons/SpotFleet.png) | ![illustration for SpotFleet](../../../aws-q2-2022/Resource/GroupIcons/SpotFleet.Local.png) | ![illustration for SpotFleetCard](../../../aws-q2-2022/Resource/GroupIcons/SpotFleetCard.Local.png) | ![illustration for SpotFleetGroup](../../../aws-q2-2022/Resource/GroupIcons/SpotFleetGroup.Local.png) |
