...
```text
aws-q2-2022/Resource/Compute/AmazonEc2Instance
```

```text
include('aws-q2-2022/Resource/Compute/AmazonEc2Instance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/Compute/AmazonEc2Instance.png) | ![illustration for AmazonEc2Instance](../../../aws-q2-2022/Resource/Compute/AmazonEc2Instance.Local.png) | ![illustration for AmazonEc2InstanceCard](../../../aws-q2-2022/Resource/Compute/AmazonEc2InstanceCard.Local.png) | ![illustration for AmazonEc2InstanceGroup](../../../aws-q2-2022/Resource/Compute/AmazonEc2InstanceGroup.Local.png) |
