...
```text
aws-q2-2022/Resource/Compute/AmazonEc2P3Instance
```

```text
include('aws-q2-2022/Resource/Compute/AmazonEc2P3Instance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/Compute/AmazonEc2P3Instance.png) | ![illustration for AmazonEc2P3Instance](../../../aws-q2-2022/Resource/Compute/AmazonEc2P3Instance.Local.png) | ![illustration for AmazonEc2P3InstanceCard](../../../aws-q2-2022/Resource/Compute/AmazonEc2P3InstanceCard.Local.png) | ![illustration for AmazonEc2P3InstanceGroup](../../../aws-q2-2022/Resource/Compute/AmazonEc2P3InstanceGroup.Local.png) |
