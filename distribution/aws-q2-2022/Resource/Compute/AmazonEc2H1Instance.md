...
```text
aws-q2-2022/Resource/Compute/AmazonEc2H1Instance
```

```text
include('aws-q2-2022/Resource/Compute/AmazonEc2H1Instance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/Compute/AmazonEc2H1Instance.png) | ![illustration for AmazonEc2H1Instance](../../../aws-q2-2022/Resource/Compute/AmazonEc2H1Instance.Local.png) | ![illustration for AmazonEc2H1InstanceCard](../../../aws-q2-2022/Resource/Compute/AmazonEc2H1InstanceCard.Local.png) | ![illustration for AmazonEc2H1InstanceGroup](../../../aws-q2-2022/Resource/Compute/AmazonEc2H1InstanceGroup.Local.png) |
