...
```text
aws-q2-2022/Resource/Compute/AmazonEc2P4DInstance
```

```text
include('aws-q2-2022/Resource/Compute/AmazonEc2P4DInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/Compute/AmazonEc2P4DInstance.png) | ![illustration for AmazonEc2P4DInstance](../../../aws-q2-2022/Resource/Compute/AmazonEc2P4DInstance.Local.png) | ![illustration for AmazonEc2P4DInstanceCard](../../../aws-q2-2022/Resource/Compute/AmazonEc2P4DInstanceCard.Local.png) | ![illustration for AmazonEc2P4DInstanceGroup](../../../aws-q2-2022/Resource/Compute/AmazonEc2P4DInstanceGroup.Local.png) |
