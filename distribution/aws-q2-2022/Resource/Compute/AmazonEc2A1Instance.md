...
```text
aws-q2-2022/Resource/Compute/AmazonEc2A1Instance
```

```text
include('aws-q2-2022/Resource/Compute/AmazonEc2A1Instance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/Compute/AmazonEc2A1Instance.png) | ![illustration for AmazonEc2A1Instance](../../../aws-q2-2022/Resource/Compute/AmazonEc2A1Instance.Local.png) | ![illustration for AmazonEc2A1InstanceCard](../../../aws-q2-2022/Resource/Compute/AmazonEc2A1InstanceCard.Local.png) | ![illustration for AmazonEc2A1InstanceGroup](../../../aws-q2-2022/Resource/Compute/AmazonEc2A1InstanceGroup.Local.png) |
