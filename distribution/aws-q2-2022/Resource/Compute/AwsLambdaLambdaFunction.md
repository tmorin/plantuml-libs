...
```text
aws-q2-2022/Resource/Compute/AwsLambdaLambdaFunction
```

```text
include('aws-q2-2022/Resource/Compute/AwsLambdaLambdaFunction')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/Compute/AwsLambdaLambdaFunction.png) | ![illustration for AwsLambdaLambdaFunction](../../../aws-q2-2022/Resource/Compute/AwsLambdaLambdaFunction.Local.png) | ![illustration for AwsLambdaLambdaFunctionCard](../../../aws-q2-2022/Resource/Compute/AwsLambdaLambdaFunctionCard.Local.png) | ![illustration for AwsLambdaLambdaFunctionGroup](../../../aws-q2-2022/Resource/Compute/AwsLambdaLambdaFunctionGroup.Local.png) |
