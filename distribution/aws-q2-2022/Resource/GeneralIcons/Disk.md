...
```text
aws-q2-2022/Resource/GeneralIcons/Disk
```

```text
include('aws-q2-2022/Resource/GeneralIcons/Disk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/GeneralIcons/Disk.png) | ![illustration for Disk](../../../aws-q2-2022/Resource/GeneralIcons/Disk.Local.png) | ![illustration for DiskCard](../../../aws-q2-2022/Resource/GeneralIcons/DiskCard.Local.png) | ![illustration for DiskGroup](../../../aws-q2-2022/Resource/GeneralIcons/DiskGroup.Local.png) |
