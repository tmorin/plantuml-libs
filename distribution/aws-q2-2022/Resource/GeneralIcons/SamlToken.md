...
```text
aws-q2-2022/Resource/GeneralIcons/SamlToken
```

```text
include('aws-q2-2022/Resource/GeneralIcons/SamlToken')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/GeneralIcons/SamlToken.png) | ![illustration for SamlToken](../../../aws-q2-2022/Resource/GeneralIcons/SamlToken.Local.png) | ![illustration for SamlTokenCard](../../../aws-q2-2022/Resource/GeneralIcons/SamlTokenCard.Local.png) | ![illustration for SamlTokenGroup](../../../aws-q2-2022/Resource/GeneralIcons/SamlTokenGroup.Local.png) |
