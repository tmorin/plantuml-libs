...
```text
aws-q2-2022/Resource/GeneralIcons/GenericDatabase
```

```text
include('aws-q2-2022/Resource/GeneralIcons/GenericDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/GeneralIcons/GenericDatabase.png) | ![illustration for GenericDatabase](../../../aws-q2-2022/Resource/GeneralIcons/GenericDatabase.Local.png) | ![illustration for GenericDatabaseCard](../../../aws-q2-2022/Resource/GeneralIcons/GenericDatabaseCard.Local.png) | ![illustration for GenericDatabaseGroup](../../../aws-q2-2022/Resource/GeneralIcons/GenericDatabaseGroup.Local.png) |
