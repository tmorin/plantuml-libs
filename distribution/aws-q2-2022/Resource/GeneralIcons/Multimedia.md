...
```text
aws-q2-2022/Resource/GeneralIcons/Multimedia
```

```text
include('aws-q2-2022/Resource/GeneralIcons/Multimedia')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/GeneralIcons/Multimedia.png) | ![illustration for Multimedia](../../../aws-q2-2022/Resource/GeneralIcons/Multimedia.Local.png) | ![illustration for MultimediaCard](../../../aws-q2-2022/Resource/GeneralIcons/MultimediaCard.Local.png) | ![illustration for MultimediaGroup](../../../aws-q2-2022/Resource/GeneralIcons/MultimediaGroup.Local.png) |
