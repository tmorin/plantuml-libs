...
```text
aws-q2-2022/Resource/GeneralIcons/TapeStorage
```

```text
include('aws-q2-2022/Resource/GeneralIcons/TapeStorage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/GeneralIcons/TapeStorage.png) | ![illustration for TapeStorage](../../../aws-q2-2022/Resource/GeneralIcons/TapeStorage.Local.png) | ![illustration for TapeStorageCard](../../../aws-q2-2022/Resource/GeneralIcons/TapeStorageCard.Local.png) | ![illustration for TapeStorageGroup](../../../aws-q2-2022/Resource/GeneralIcons/TapeStorageGroup.Local.png) |
