...
```text
aws-q2-2022/Resource/GeneralIcons/SslPadlock
```

```text
include('aws-q2-2022/Resource/GeneralIcons/SslPadlock')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/GeneralIcons/SslPadlock.png) | ![illustration for SslPadlock](../../../aws-q2-2022/Resource/GeneralIcons/SslPadlock.Local.png) | ![illustration for SslPadlockCard](../../../aws-q2-2022/Resource/GeneralIcons/SslPadlockCard.Local.png) | ![illustration for SslPadlockGroup](../../../aws-q2-2022/Resource/GeneralIcons/SslPadlockGroup.Local.png) |
