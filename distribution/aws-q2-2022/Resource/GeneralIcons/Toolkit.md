...
```text
aws-q2-2022/Resource/GeneralIcons/Toolkit
```

```text
include('aws-q2-2022/Resource/GeneralIcons/Toolkit')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/GeneralIcons/Toolkit.png) | ![illustration for Toolkit](../../../aws-q2-2022/Resource/GeneralIcons/Toolkit.Local.png) | ![illustration for ToolkitCard](../../../aws-q2-2022/Resource/GeneralIcons/ToolkitCard.Local.png) | ![illustration for ToolkitGroup](../../../aws-q2-2022/Resource/GeneralIcons/ToolkitGroup.Local.png) |
