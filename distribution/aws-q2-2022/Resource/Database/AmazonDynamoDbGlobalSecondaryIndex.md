...
```text
aws-q2-2022/Resource/Database/AmazonDynamoDbGlobalSecondaryIndex
```

```text
include('aws-q2-2022/Resource/Database/AmazonDynamoDbGlobalSecondaryIndex')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/Database/AmazonDynamoDbGlobalSecondaryIndex.png) | ![illustration for AmazonDynamoDbGlobalSecondaryIndex](../../../aws-q2-2022/Resource/Database/AmazonDynamoDbGlobalSecondaryIndex.Local.png) | ![illustration for AmazonDynamoDbGlobalSecondaryIndexCard](../../../aws-q2-2022/Resource/Database/AmazonDynamoDbGlobalSecondaryIndexCard.Local.png) | ![illustration for AmazonDynamoDbGlobalSecondaryIndexGroup](../../../aws-q2-2022/Resource/Database/AmazonDynamoDbGlobalSecondaryIndexGroup.Local.png) |
