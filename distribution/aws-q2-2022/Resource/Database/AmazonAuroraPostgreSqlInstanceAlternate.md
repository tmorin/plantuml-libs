...
```text
aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate
```

```text
include('aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate.png) | ![illustration for AmazonAuroraPostgreSqlInstanceAlternate](../../../aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternate.Local.png) | ![illustration for AmazonAuroraPostgreSqlInstanceAlternateCard](../../../aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternateCard.Local.png) | ![illustration for AmazonAuroraPostgreSqlInstanceAlternateGroup](../../../aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstanceAlternateGroup.Local.png) |
