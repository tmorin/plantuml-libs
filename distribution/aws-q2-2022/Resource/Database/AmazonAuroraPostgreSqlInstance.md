...
```text
aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstance
```

```text
include('aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstance.png) | ![illustration for AmazonAuroraPostgreSqlInstance](../../../aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstance.Local.png) | ![illustration for AmazonAuroraPostgreSqlInstanceCard](../../../aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstanceCard.Local.png) | ![illustration for AmazonAuroraPostgreSqlInstanceGroup](../../../aws-q2-2022/Resource/Database/AmazonAuroraPostgreSqlInstanceGroup.Local.png) |
