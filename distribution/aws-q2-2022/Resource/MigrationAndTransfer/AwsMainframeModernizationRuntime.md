...
```text
aws-q2-2022/Resource/MigrationAndTransfer/AwsMainframeModernizationRuntime
```

```text
include('aws-q2-2022/Resource/MigrationAndTransfer/AwsMainframeModernizationRuntime')
```
