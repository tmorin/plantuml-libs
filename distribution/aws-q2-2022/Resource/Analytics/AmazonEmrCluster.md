...
```text
aws-q2-2022/Resource/Analytics/AmazonEmrCluster
```

```text
include('aws-q2-2022/Resource/Analytics/AmazonEmrCluster')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q2-2022/Resource/Analytics/AmazonEmrCluster.png) | ![illustration for AmazonEmrCluster](../../../aws-q2-2022/Resource/Analytics/AmazonEmrCluster.Local.png) | ![illustration for AmazonEmrClusterCard](../../../aws-q2-2022/Resource/Analytics/AmazonEmrClusterCard.Local.png) | ![illustration for AmazonEmrClusterGroup](../../../aws-q2-2022/Resource/Analytics/AmazonEmrClusterGroup.Local.png) |
