...
```text
aws-q1-2024/Architecture/SecurityIdentityCompliance/AwsNetworkFirewall
```

```text
include('aws-q1-2024/Architecture/SecurityIdentityCompliance/AwsNetworkFirewall')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/SecurityIdentityCompliance/AwsNetworkFirewall.png) | ![illustration for AwsNetworkFirewall](../../../aws-q1-2024/Architecture/SecurityIdentityCompliance/AwsNetworkFirewall.Local.png) | ![illustration for AwsNetworkFirewallCard](../../../aws-q1-2024/Architecture/SecurityIdentityCompliance/AwsNetworkFirewallCard.Local.png) | ![illustration for AwsNetworkFirewallGroup](../../../aws-q1-2024/Architecture/SecurityIdentityCompliance/AwsNetworkFirewallGroup.Local.png) |
