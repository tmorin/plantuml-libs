...
```text
aws-q1-2024/Architecture/SecurityIdentityCompliance/AmazonInspector
```

```text
include('aws-q1-2024/Architecture/SecurityIdentityCompliance/AmazonInspector')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/SecurityIdentityCompliance/AmazonInspector.png) | ![illustration for AmazonInspector](../../../aws-q1-2024/Architecture/SecurityIdentityCompliance/AmazonInspector.Local.png) | ![illustration for AmazonInspectorCard](../../../aws-q1-2024/Architecture/SecurityIdentityCompliance/AmazonInspectorCard.Local.png) | ![illustration for AmazonInspectorGroup](../../../aws-q1-2024/Architecture/SecurityIdentityCompliance/AmazonInspectorGroup.Local.png) |
