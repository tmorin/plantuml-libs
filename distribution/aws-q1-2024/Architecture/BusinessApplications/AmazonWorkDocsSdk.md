...
```text
aws-q1-2024/Architecture/BusinessApplications/AmazonWorkDocsSdk
```

```text
include('aws-q1-2024/Architecture/BusinessApplications/AmazonWorkDocsSdk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/BusinessApplications/AmazonWorkDocsSdk.png) | ![illustration for AmazonWorkDocsSdk](../../../aws-q1-2024/Architecture/BusinessApplications/AmazonWorkDocsSdk.Local.png) | ![illustration for AmazonWorkDocsSdkCard](../../../aws-q1-2024/Architecture/BusinessApplications/AmazonWorkDocsSdkCard.Local.png) | ![illustration for AmazonWorkDocsSdkGroup](../../../aws-q1-2024/Architecture/BusinessApplications/AmazonWorkDocsSdkGroup.Local.png) |
