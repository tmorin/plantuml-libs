...
```text
aws-q1-2024/Architecture/DeveloperTools/AwsCodeCommit
```

```text
include('aws-q1-2024/Architecture/DeveloperTools/AwsCodeCommit')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/DeveloperTools/AwsCodeCommit.png) | ![illustration for AwsCodeCommit](../../../aws-q1-2024/Architecture/DeveloperTools/AwsCodeCommit.Local.png) | ![illustration for AwsCodeCommitCard](../../../aws-q1-2024/Architecture/DeveloperTools/AwsCodeCommitCard.Local.png) | ![illustration for AwsCodeCommitGroup](../../../aws-q1-2024/Architecture/DeveloperTools/AwsCodeCommitGroup.Local.png) |
