...
```text
aws-q1-2024/Architecture/MediaServices/AwsElementalMediaPackage
```

```text
include('aws-q1-2024/Architecture/MediaServices/AwsElementalMediaPackage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/MediaServices/AwsElementalMediaPackage.png) | ![illustration for AwsElementalMediaPackage](../../../aws-q1-2024/Architecture/MediaServices/AwsElementalMediaPackage.Local.png) | ![illustration for AwsElementalMediaPackageCard](../../../aws-q1-2024/Architecture/MediaServices/AwsElementalMediaPackageCard.Local.png) | ![illustration for AwsElementalMediaPackageGroup](../../../aws-q1-2024/Architecture/MediaServices/AwsElementalMediaPackageGroup.Local.png) |
