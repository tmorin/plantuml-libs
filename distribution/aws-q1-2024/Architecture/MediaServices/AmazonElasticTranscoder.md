...
```text
aws-q1-2024/Architecture/MediaServices/AmazonElasticTranscoder
```

```text
include('aws-q1-2024/Architecture/MediaServices/AmazonElasticTranscoder')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/MediaServices/AmazonElasticTranscoder.png) | ![illustration for AmazonElasticTranscoder](../../../aws-q1-2024/Architecture/MediaServices/AmazonElasticTranscoder.Local.png) | ![illustration for AmazonElasticTranscoderCard](../../../aws-q1-2024/Architecture/MediaServices/AmazonElasticTranscoderCard.Local.png) | ![illustration for AmazonElasticTranscoderGroup](../../../aws-q1-2024/Architecture/MediaServices/AmazonElasticTranscoderGroup.Local.png) |
