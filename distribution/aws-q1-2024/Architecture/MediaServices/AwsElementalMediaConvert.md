...
```text
aws-q1-2024/Architecture/MediaServices/AwsElementalMediaConvert
```

```text
include('aws-q1-2024/Architecture/MediaServices/AwsElementalMediaConvert')
```
