...
```text
aws-q1-2024/Architecture/MediaServices/AwsElementalAppliancesSoftware
```

```text
include('aws-q1-2024/Architecture/MediaServices/AwsElementalAppliancesSoftware')
```
