...
```text
aws-q1-2024/Architecture/MediaServices/AmazonNimbleStudio
```

```text
include('aws-q1-2024/Architecture/MediaServices/AmazonNimbleStudio')
```
