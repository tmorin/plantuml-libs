...
```text
aws-q1-2024/Architecture/MediaServices/AwsElementalDelta
```

```text
include('aws-q1-2024/Architecture/MediaServices/AwsElementalDelta')
```
