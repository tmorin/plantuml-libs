...
```text
aws-q1-2024/Architecture/MediaServices/AwsElementalServer
```

```text
include('aws-q1-2024/Architecture/MediaServices/AwsElementalServer')
```
