...
```text
aws-q1-2024/Architecture/CustomerEnablement/AwsManagedServices
```

```text
include('aws-q1-2024/Architecture/CustomerEnablement/AwsManagedServices')
```
