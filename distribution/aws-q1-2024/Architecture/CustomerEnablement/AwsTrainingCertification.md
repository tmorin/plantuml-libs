...
```text
aws-q1-2024/Architecture/CustomerEnablement/AwsTrainingCertification
```

```text
include('aws-q1-2024/Architecture/CustomerEnablement/AwsTrainingCertification')
```
