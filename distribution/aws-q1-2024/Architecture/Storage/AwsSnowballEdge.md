...
```text
aws-q1-2024/Architecture/Storage/AwsSnowballEdge
```

```text
include('aws-q1-2024/Architecture/Storage/AwsSnowballEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Storage/AwsSnowballEdge.png) | ![illustration for AwsSnowballEdge](../../../aws-q1-2024/Architecture/Storage/AwsSnowballEdge.Local.png) | ![illustration for AwsSnowballEdgeCard](../../../aws-q1-2024/Architecture/Storage/AwsSnowballEdgeCard.Local.png) | ![illustration for AwsSnowballEdgeGroup](../../../aws-q1-2024/Architecture/Storage/AwsSnowballEdgeGroup.Local.png) |
