...
```text
aws-q1-2024/Architecture/Storage/AwsSnowball
```

```text
include('aws-q1-2024/Architecture/Storage/AwsSnowball')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Storage/AwsSnowball.png) | ![illustration for AwsSnowball](../../../aws-q1-2024/Architecture/Storage/AwsSnowball.Local.png) | ![illustration for AwsSnowballCard](../../../aws-q1-2024/Architecture/Storage/AwsSnowballCard.Local.png) | ![illustration for AwsSnowballGroup](../../../aws-q1-2024/Architecture/Storage/AwsSnowballGroup.Local.png) |
