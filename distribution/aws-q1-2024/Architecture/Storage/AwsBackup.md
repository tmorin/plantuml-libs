...
```text
aws-q1-2024/Architecture/Storage/AwsBackup
```

```text
include('aws-q1-2024/Architecture/Storage/AwsBackup')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Storage/AwsBackup.png) | ![illustration for AwsBackup](../../../aws-q1-2024/Architecture/Storage/AwsBackup.Local.png) | ![illustration for AwsBackupCard](../../../aws-q1-2024/Architecture/Storage/AwsBackupCard.Local.png) | ![illustration for AwsBackupGroup](../../../aws-q1-2024/Architecture/Storage/AwsBackupGroup.Local.png) |
