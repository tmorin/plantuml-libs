...
```text
aws-q1-2024/Architecture/Storage/AmazonFSxForWfs
```

```text
include('aws-q1-2024/Architecture/Storage/AmazonFSxForWfs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Storage/AmazonFSxForWfs.png) | ![illustration for AmazonFSxForWfs](../../../aws-q1-2024/Architecture/Storage/AmazonFSxForWfs.Local.png) | ![illustration for AmazonFSxForWfsCard](../../../aws-q1-2024/Architecture/Storage/AmazonFSxForWfsCard.Local.png) | ![illustration for AmazonFSxForWfsGroup](../../../aws-q1-2024/Architecture/Storage/AmazonFSxForWfsGroup.Local.png) |
