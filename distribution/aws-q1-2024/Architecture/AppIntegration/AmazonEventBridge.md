...
```text
aws-q1-2024/Architecture/AppIntegration/AmazonEventBridge
```

```text
include('aws-q1-2024/Architecture/AppIntegration/AmazonEventBridge')
```
