...
```text
aws-q1-2024/Architecture/AppIntegration/AmazonSimpleQueueService
```

```text
include('aws-q1-2024/Architecture/AppIntegration/AmazonSimpleQueueService')
```
