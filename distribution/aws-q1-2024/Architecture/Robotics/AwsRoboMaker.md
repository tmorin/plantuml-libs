...
```text
aws-q1-2024/Architecture/Robotics/AwsRoboMaker
```

```text
include('aws-q1-2024/Architecture/Robotics/AwsRoboMaker')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Robotics/AwsRoboMaker.png) | ![illustration for AwsRoboMaker](../../../aws-q1-2024/Architecture/Robotics/AwsRoboMaker.Local.png) | ![illustration for AwsRoboMakerCard](../../../aws-q1-2024/Architecture/Robotics/AwsRoboMakerCard.Local.png) | ![illustration for AwsRoboMakerGroup](../../../aws-q1-2024/Architecture/Robotics/AwsRoboMakerGroup.Local.png) |
