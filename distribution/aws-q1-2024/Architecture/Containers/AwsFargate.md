...
```text
aws-q1-2024/Architecture/Containers/AwsFargate
```

```text
include('aws-q1-2024/Architecture/Containers/AwsFargate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Containers/AwsFargate.png) | ![illustration for AwsFargate](../../../aws-q1-2024/Architecture/Containers/AwsFargate.Local.png) | ![illustration for AwsFargateCard](../../../aws-q1-2024/Architecture/Containers/AwsFargateCard.Local.png) | ![illustration for AwsFargateGroup](../../../aws-q1-2024/Architecture/Containers/AwsFargateGroup.Local.png) |
