...
```text
aws-q1-2024/Architecture/MachineLearning/AmazonPersonalize
```

```text
include('aws-q1-2024/Architecture/MachineLearning/AmazonPersonalize')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/MachineLearning/AmazonPersonalize.png) | ![illustration for AmazonPersonalize](../../../aws-q1-2024/Architecture/MachineLearning/AmazonPersonalize.Local.png) | ![illustration for AmazonPersonalizeCard](../../../aws-q1-2024/Architecture/MachineLearning/AmazonPersonalizeCard.Local.png) | ![illustration for AmazonPersonalizeGroup](../../../aws-q1-2024/Architecture/MachineLearning/AmazonPersonalizeGroup.Local.png) |
