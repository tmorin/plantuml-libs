...
```text
aws-q1-2024/Architecture/MachineLearning/AmazonTextract
```

```text
include('aws-q1-2024/Architecture/MachineLearning/AmazonTextract')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/MachineLearning/AmazonTextract.png) | ![illustration for AmazonTextract](../../../aws-q1-2024/Architecture/MachineLearning/AmazonTextract.Local.png) | ![illustration for AmazonTextractCard](../../../aws-q1-2024/Architecture/MachineLearning/AmazonTextractCard.Local.png) | ![illustration for AmazonTextractGroup](../../../aws-q1-2024/Architecture/MachineLearning/AmazonTextractGroup.Local.png) |
