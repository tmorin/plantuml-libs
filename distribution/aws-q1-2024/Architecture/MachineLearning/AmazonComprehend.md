...
```text
aws-q1-2024/Architecture/MachineLearning/AmazonComprehend
```

```text
include('aws-q1-2024/Architecture/MachineLearning/AmazonComprehend')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/MachineLearning/AmazonComprehend.png) | ![illustration for AmazonComprehend](../../../aws-q1-2024/Architecture/MachineLearning/AmazonComprehend.Local.png) | ![illustration for AmazonComprehendCard](../../../aws-q1-2024/Architecture/MachineLearning/AmazonComprehendCard.Local.png) | ![illustration for AmazonComprehendGroup](../../../aws-q1-2024/Architecture/MachineLearning/AmazonComprehendGroup.Local.png) |
