...
```text
aws-q1-2024/Architecture/MachineLearning/AmazonSageMaker
```

```text
include('aws-q1-2024/Architecture/MachineLearning/AmazonSageMaker')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/MachineLearning/AmazonSageMaker.png) | ![illustration for AmazonSageMaker](../../../aws-q1-2024/Architecture/MachineLearning/AmazonSageMaker.Local.png) | ![illustration for AmazonSageMakerCard](../../../aws-q1-2024/Architecture/MachineLearning/AmazonSageMakerCard.Local.png) | ![illustration for AmazonSageMakerGroup](../../../aws-q1-2024/Architecture/MachineLearning/AmazonSageMakerGroup.Local.png) |
