...
```text
aws-q1-2024/Architecture/MachineLearning/TensorFlowOnAws
```

```text
include('aws-q1-2024/Architecture/MachineLearning/TensorFlowOnAws')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/MachineLearning/TensorFlowOnAws.png) | ![illustration for TensorFlowOnAws](../../../aws-q1-2024/Architecture/MachineLearning/TensorFlowOnAws.Local.png) | ![illustration for TensorFlowOnAwsCard](../../../aws-q1-2024/Architecture/MachineLearning/TensorFlowOnAwsCard.Local.png) | ![illustration for TensorFlowOnAwsGroup](../../../aws-q1-2024/Architecture/MachineLearning/TensorFlowOnAwsGroup.Local.png) |
