...
```text
aws-q1-2024/Architecture/MachineLearning/AmazonForecast
```

```text
include('aws-q1-2024/Architecture/MachineLearning/AmazonForecast')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/MachineLearning/AmazonForecast.png) | ![illustration for AmazonForecast](../../../aws-q1-2024/Architecture/MachineLearning/AmazonForecast.Local.png) | ![illustration for AmazonForecastCard](../../../aws-q1-2024/Architecture/MachineLearning/AmazonForecastCard.Local.png) | ![illustration for AmazonForecastGroup](../../../aws-q1-2024/Architecture/MachineLearning/AmazonForecastGroup.Local.png) |
