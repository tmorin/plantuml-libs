...
```text
aws-q1-2024/Architecture/MachineLearning/AmazonCodeGuru
```

```text
include('aws-q1-2024/Architecture/MachineLearning/AmazonCodeGuru')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/MachineLearning/AmazonCodeGuru.png) | ![illustration for AmazonCodeGuru](../../../aws-q1-2024/Architecture/MachineLearning/AmazonCodeGuru.Local.png) | ![illustration for AmazonCodeGuruCard](../../../aws-q1-2024/Architecture/MachineLearning/AmazonCodeGuruCard.Local.png) | ![illustration for AmazonCodeGuruGroup](../../../aws-q1-2024/Architecture/MachineLearning/AmazonCodeGuruGroup.Local.png) |
