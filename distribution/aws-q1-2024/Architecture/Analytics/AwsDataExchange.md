...
```text
aws-q1-2024/Architecture/Analytics/AwsDataExchange
```

```text
include('aws-q1-2024/Architecture/Analytics/AwsDataExchange')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Analytics/AwsDataExchange.png) | ![illustration for AwsDataExchange](../../../aws-q1-2024/Architecture/Analytics/AwsDataExchange.Local.png) | ![illustration for AwsDataExchangeCard](../../../aws-q1-2024/Architecture/Analytics/AwsDataExchangeCard.Local.png) | ![illustration for AwsDataExchangeGroup](../../../aws-q1-2024/Architecture/Analytics/AwsDataExchangeGroup.Local.png) |
