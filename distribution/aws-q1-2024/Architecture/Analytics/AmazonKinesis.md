...
```text
aws-q1-2024/Architecture/Analytics/AmazonKinesis
```

```text
include('aws-q1-2024/Architecture/Analytics/AmazonKinesis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Analytics/AmazonKinesis.png) | ![illustration for AmazonKinesis](../../../aws-q1-2024/Architecture/Analytics/AmazonKinesis.Local.png) | ![illustration for AmazonKinesisCard](../../../aws-q1-2024/Architecture/Analytics/AmazonKinesisCard.Local.png) | ![illustration for AmazonKinesisGroup](../../../aws-q1-2024/Architecture/Analytics/AmazonKinesisGroup.Local.png) |
