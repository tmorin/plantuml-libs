...
```text
aws-q1-2024/Architecture/MigrationTransfer/AwsMigrationEvaluator
```

```text
include('aws-q1-2024/Architecture/MigrationTransfer/AwsMigrationEvaluator')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/MigrationTransfer/AwsMigrationEvaluator.png) | ![illustration for AwsMigrationEvaluator](../../../aws-q1-2024/Architecture/MigrationTransfer/AwsMigrationEvaluator.Local.png) | ![illustration for AwsMigrationEvaluatorCard](../../../aws-q1-2024/Architecture/MigrationTransfer/AwsMigrationEvaluatorCard.Local.png) | ![illustration for AwsMigrationEvaluatorGroup](../../../aws-q1-2024/Architecture/MigrationTransfer/AwsMigrationEvaluatorGroup.Local.png) |
