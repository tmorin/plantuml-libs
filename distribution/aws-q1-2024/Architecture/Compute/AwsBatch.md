...
```text
aws-q1-2024/Architecture/Compute/AwsBatch
```

```text
include('aws-q1-2024/Architecture/Compute/AwsBatch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Compute/AwsBatch.png) | ![illustration for AwsBatch](../../../aws-q1-2024/Architecture/Compute/AwsBatch.Local.png) | ![illustration for AwsBatchCard](../../../aws-q1-2024/Architecture/Compute/AwsBatchCard.Local.png) | ![illustration for AwsBatchGroup](../../../aws-q1-2024/Architecture/Compute/AwsBatchGroup.Local.png) |
