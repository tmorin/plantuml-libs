...
```text
aws-q1-2024/Architecture/Compute/AwsThinkboxSequoia
```

```text
include('aws-q1-2024/Architecture/Compute/AwsThinkboxSequoia')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Compute/AwsThinkboxSequoia.png) | ![illustration for AwsThinkboxSequoia](../../../aws-q1-2024/Architecture/Compute/AwsThinkboxSequoia.Local.png) | ![illustration for AwsThinkboxSequoiaCard](../../../aws-q1-2024/Architecture/Compute/AwsThinkboxSequoiaCard.Local.png) | ![illustration for AwsThinkboxSequoiaGroup](../../../aws-q1-2024/Architecture/Compute/AwsThinkboxSequoiaGroup.Local.png) |
