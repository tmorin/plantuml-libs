...
```text
aws-q1-2024/Architecture/Compute/AwsAppRunner
```

```text
include('aws-q1-2024/Architecture/Compute/AwsAppRunner')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Compute/AwsAppRunner.png) | ![illustration for AwsAppRunner](../../../aws-q1-2024/Architecture/Compute/AwsAppRunner.Local.png) | ![illustration for AwsAppRunnerCard](../../../aws-q1-2024/Architecture/Compute/AwsAppRunnerCard.Local.png) | ![illustration for AwsAppRunnerGroup](../../../aws-q1-2024/Architecture/Compute/AwsAppRunnerGroup.Local.png) |
