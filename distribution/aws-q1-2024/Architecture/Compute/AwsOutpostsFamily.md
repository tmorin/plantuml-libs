...
```text
aws-q1-2024/Architecture/Compute/AwsOutpostsFamily
```

```text
include('aws-q1-2024/Architecture/Compute/AwsOutpostsFamily')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Compute/AwsOutpostsFamily.png) | ![illustration for AwsOutpostsFamily](../../../aws-q1-2024/Architecture/Compute/AwsOutpostsFamily.Local.png) | ![illustration for AwsOutpostsFamilyCard](../../../aws-q1-2024/Architecture/Compute/AwsOutpostsFamilyCard.Local.png) | ![illustration for AwsOutpostsFamilyGroup](../../../aws-q1-2024/Architecture/Compute/AwsOutpostsFamilyGroup.Local.png) |
