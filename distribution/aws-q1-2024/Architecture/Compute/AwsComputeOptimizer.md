...
```text
aws-q1-2024/Architecture/Compute/AwsComputeOptimizer
```

```text
include('aws-q1-2024/Architecture/Compute/AwsComputeOptimizer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Compute/AwsComputeOptimizer.png) | ![illustration for AwsComputeOptimizer](../../../aws-q1-2024/Architecture/Compute/AwsComputeOptimizer.Local.png) | ![illustration for AwsComputeOptimizerCard](../../../aws-q1-2024/Architecture/Compute/AwsComputeOptimizerCard.Local.png) | ![illustration for AwsComputeOptimizerGroup](../../../aws-q1-2024/Architecture/Compute/AwsComputeOptimizerGroup.Local.png) |
