...
```text
aws-q1-2024/Architecture/Compute/Bottlerocket
```

```text
include('aws-q1-2024/Architecture/Compute/Bottlerocket')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Compute/Bottlerocket.png) | ![illustration for Bottlerocket](../../../aws-q1-2024/Architecture/Compute/Bottlerocket.Local.png) | ![illustration for BottlerocketCard](../../../aws-q1-2024/Architecture/Compute/BottlerocketCard.Local.png) | ![illustration for BottlerocketGroup](../../../aws-q1-2024/Architecture/Compute/BottlerocketGroup.Local.png) |
