...
```text
aws-q1-2024/Architecture/Compute/AwsThinkboxFrost
```

```text
include('aws-q1-2024/Architecture/Compute/AwsThinkboxFrost')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Compute/AwsThinkboxFrost.png) | ![illustration for AwsThinkboxFrost](../../../aws-q1-2024/Architecture/Compute/AwsThinkboxFrost.Local.png) | ![illustration for AwsThinkboxFrostCard](../../../aws-q1-2024/Architecture/Compute/AwsThinkboxFrostCard.Local.png) | ![illustration for AwsThinkboxFrostGroup](../../../aws-q1-2024/Architecture/Compute/AwsThinkboxFrostGroup.Local.png) |
