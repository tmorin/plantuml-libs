...
```text
aws-q1-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabase
```

```text
include('aws-q1-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabase.png) | ![illustration for AmazonQuantumLedgerDatabase](../../../aws-q1-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabase.Local.png) | ![illustration for AmazonQuantumLedgerDatabaseCard](../../../aws-q1-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabaseCard.Local.png) | ![illustration for AmazonQuantumLedgerDatabaseGroup](../../../aws-q1-2024/Architecture/Blockchain/AmazonQuantumLedgerDatabaseGroup.Local.png) |
