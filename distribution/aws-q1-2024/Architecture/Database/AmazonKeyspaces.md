...
```text
aws-q1-2024/Architecture/Database/AmazonKeyspaces
```

```text
include('aws-q1-2024/Architecture/Database/AmazonKeyspaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Database/AmazonKeyspaces.png) | ![illustration for AmazonKeyspaces](../../../aws-q1-2024/Architecture/Database/AmazonKeyspaces.Local.png) | ![illustration for AmazonKeyspacesCard](../../../aws-q1-2024/Architecture/Database/AmazonKeyspacesCard.Local.png) | ![illustration for AmazonKeyspacesGroup](../../../aws-q1-2024/Architecture/Database/AmazonKeyspacesGroup.Local.png) |
