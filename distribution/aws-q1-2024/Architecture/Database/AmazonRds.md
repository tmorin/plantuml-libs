...
```text
aws-q1-2024/Architecture/Database/AmazonRds
```

```text
include('aws-q1-2024/Architecture/Database/AmazonRds')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Database/AmazonRds.png) | ![illustration for AmazonRds](../../../aws-q1-2024/Architecture/Database/AmazonRds.Local.png) | ![illustration for AmazonRdsCard](../../../aws-q1-2024/Architecture/Database/AmazonRdsCard.Local.png) | ![illustration for AmazonRdsGroup](../../../aws-q1-2024/Architecture/Database/AmazonRdsGroup.Local.png) |
