...
```text
aws-q1-2024/Architecture/Database/AmazonMemoryDbForRedis
```

```text
include('aws-q1-2024/Architecture/Database/AmazonMemoryDbForRedis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Database/AmazonMemoryDbForRedis.png) | ![illustration for AmazonMemoryDbForRedis](../../../aws-q1-2024/Architecture/Database/AmazonMemoryDbForRedis.Local.png) | ![illustration for AmazonMemoryDbForRedisCard](../../../aws-q1-2024/Architecture/Database/AmazonMemoryDbForRedisCard.Local.png) | ![illustration for AmazonMemoryDbForRedisGroup](../../../aws-q1-2024/Architecture/Database/AmazonMemoryDbForRedisGroup.Local.png) |
