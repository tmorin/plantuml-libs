...
```text
aws-q1-2024/Architecture/Database/AmazonDocumentDb
```

```text
include('aws-q1-2024/Architecture/Database/AmazonDocumentDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Architecture/Database/AmazonDocumentDb.png) | ![illustration for AmazonDocumentDb](../../../aws-q1-2024/Architecture/Database/AmazonDocumentDb.Local.png) | ![illustration for AmazonDocumentDbCard](../../../aws-q1-2024/Architecture/Database/AmazonDocumentDbCard.Local.png) | ![illustration for AmazonDocumentDbGroup](../../../aws-q1-2024/Architecture/Database/AmazonDocumentDbGroup.Local.png) |
