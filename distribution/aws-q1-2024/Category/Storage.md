...
```text
aws-q1-2024/Category/Storage
```

```text
include('aws-q1-2024/Category/Storage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q1-2024/Category/Storage.png) | ![illustration for Storage](../../aws-q1-2024/Category/Storage.Local.png) | ![illustration for StorageCard](../../aws-q1-2024/Category/StorageCard.Local.png) | ![illustration for StorageGroup](../../aws-q1-2024/Category/StorageGroup.Local.png) |
