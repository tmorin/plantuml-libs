...
```text
aws-q1-2024/Category/ApplicationIntegration
```

```text
include('aws-q1-2024/Category/ApplicationIntegration')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q1-2024/Category/ApplicationIntegration.png) | ![illustration for ApplicationIntegration](../../aws-q1-2024/Category/ApplicationIntegration.Local.png) | ![illustration for ApplicationIntegrationCard](../../aws-q1-2024/Category/ApplicationIntegrationCard.Local.png) | ![illustration for ApplicationIntegrationGroup](../../aws-q1-2024/Category/ApplicationIntegrationGroup.Local.png) |
