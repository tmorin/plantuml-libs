...
```text
aws-q1-2024/Group/GroupElasticBeanstalkContainer
```

```text
include('aws-q1-2024/Group/GroupElasticBeanstalkContainer')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../aws-q1-2024/Resource/GroupIcons/ElasticBeanstalkContainer.png) | ![illustration for GroupElasticBeanstalkContainer](../../aws-q1-2024/Group/GroupElasticBeanstalkContainer.Local.png) |
