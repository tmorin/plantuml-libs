...
```text
aws-q1-2024/Resource/Compute/AwsLambdaLambdaFunction
```

```text
include('aws-q1-2024/Resource/Compute/AwsLambdaLambdaFunction')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Compute/AwsLambdaLambdaFunction.png) | ![illustration for AwsLambdaLambdaFunction](../../../aws-q1-2024/Resource/Compute/AwsLambdaLambdaFunction.Local.png) | ![illustration for AwsLambdaLambdaFunctionCard](../../../aws-q1-2024/Resource/Compute/AwsLambdaLambdaFunctionCard.Local.png) | ![illustration for AwsLambdaLambdaFunctionGroup](../../../aws-q1-2024/Resource/Compute/AwsLambdaLambdaFunctionGroup.Local.png) |
