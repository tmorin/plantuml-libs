...
```text
aws-q1-2024/Resource/Compute/AmazonEc2ElasticIpAddress
```

```text
include('aws-q1-2024/Resource/Compute/AmazonEc2ElasticIpAddress')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Compute/AmazonEc2ElasticIpAddress.png) | ![illustration for AmazonEc2ElasticIpAddress](../../../aws-q1-2024/Resource/Compute/AmazonEc2ElasticIpAddress.Local.png) | ![illustration for AmazonEc2ElasticIpAddressCard](../../../aws-q1-2024/Resource/Compute/AmazonEc2ElasticIpAddressCard.Local.png) | ![illustration for AmazonEc2ElasticIpAddressGroup](../../../aws-q1-2024/Resource/Compute/AmazonEc2ElasticIpAddressGroup.Local.png) |
