...
```text
aws-q1-2024/Resource/GeneralIcons/Database
```

```text
include('aws-q1-2024/Resource/GeneralIcons/Database')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/GeneralIcons/Database.png) | ![illustration for Database](../../../aws-q1-2024/Resource/GeneralIcons/Database.Local.png) | ![illustration for DatabaseCard](../../../aws-q1-2024/Resource/GeneralIcons/DatabaseCard.Local.png) | ![illustration for DatabaseGroup](../../../aws-q1-2024/Resource/GeneralIcons/DatabaseGroup.Local.png) |
