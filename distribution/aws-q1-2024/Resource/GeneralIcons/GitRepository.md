...
```text
aws-q1-2024/Resource/GeneralIcons/GitRepository
```

```text
include('aws-q1-2024/Resource/GeneralIcons/GitRepository')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/GeneralIcons/GitRepository.png) | ![illustration for GitRepository](../../../aws-q1-2024/Resource/GeneralIcons/GitRepository.Local.png) | ![illustration for GitRepositoryCard](../../../aws-q1-2024/Resource/GeneralIcons/GitRepositoryCard.Local.png) | ![illustration for GitRepositoryGroup](../../../aws-q1-2024/Resource/GeneralIcons/GitRepositoryGroup.Local.png) |
