...
```text
aws-q1-2024/Resource/Storage/AwsStorageGatewayCachedVolume
```

```text
include('aws-q1-2024/Resource/Storage/AwsStorageGatewayCachedVolume')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Storage/AwsStorageGatewayCachedVolume.png) | ![illustration for AwsStorageGatewayCachedVolume](../../../aws-q1-2024/Resource/Storage/AwsStorageGatewayCachedVolume.Local.png) | ![illustration for AwsStorageGatewayCachedVolumeCard](../../../aws-q1-2024/Resource/Storage/AwsStorageGatewayCachedVolumeCard.Local.png) | ![illustration for AwsStorageGatewayCachedVolumeGroup](../../../aws-q1-2024/Resource/Storage/AwsStorageGatewayCachedVolumeGroup.Local.png) |
