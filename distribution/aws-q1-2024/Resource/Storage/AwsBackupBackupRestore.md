...
```text
aws-q1-2024/Resource/Storage/AwsBackupBackupRestore
```

```text
include('aws-q1-2024/Resource/Storage/AwsBackupBackupRestore')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Storage/AwsBackupBackupRestore.png) | ![illustration for AwsBackupBackupRestore](../../../aws-q1-2024/Resource/Storage/AwsBackupBackupRestore.Local.png) | ![illustration for AwsBackupBackupRestoreCard](../../../aws-q1-2024/Resource/Storage/AwsBackupBackupRestoreCard.Local.png) | ![illustration for AwsBackupBackupRestoreGroup](../../../aws-q1-2024/Resource/Storage/AwsBackupBackupRestoreGroup.Local.png) |
