...
```text
aws-q1-2024/Resource/Analytics/AwsLakeFormationDataLake
```

```text
include('aws-q1-2024/Resource/Analytics/AwsLakeFormationDataLake')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Analytics/AwsLakeFormationDataLake.png) | ![illustration for AwsLakeFormationDataLake](../../../aws-q1-2024/Resource/Analytics/AwsLakeFormationDataLake.Local.png) | ![illustration for AwsLakeFormationDataLakeCard](../../../aws-q1-2024/Resource/Analytics/AwsLakeFormationDataLakeCard.Local.png) | ![illustration for AwsLakeFormationDataLakeGroup](../../../aws-q1-2024/Resource/Analytics/AwsLakeFormationDataLakeGroup.Local.png) |
