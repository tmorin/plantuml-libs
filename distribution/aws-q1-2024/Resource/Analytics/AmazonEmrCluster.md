...
```text
aws-q1-2024/Resource/Analytics/AmazonEmrCluster
```

```text
include('aws-q1-2024/Resource/Analytics/AmazonEmrCluster')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Analytics/AmazonEmrCluster.png) | ![illustration for AmazonEmrCluster](../../../aws-q1-2024/Resource/Analytics/AmazonEmrCluster.Local.png) | ![illustration for AmazonEmrClusterCard](../../../aws-q1-2024/Resource/Analytics/AmazonEmrClusterCard.Local.png) | ![illustration for AmazonEmrClusterGroup](../../../aws-q1-2024/Resource/Analytics/AmazonEmrClusterGroup.Local.png) |
