...
```text
aws-q1-2024/Resource/Analytics/AmazonRedshiftMl
```

```text
include('aws-q1-2024/Resource/Analytics/AmazonRedshiftMl')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Analytics/AmazonRedshiftMl.png) | ![illustration for AmazonRedshiftMl](../../../aws-q1-2024/Resource/Analytics/AmazonRedshiftMl.Local.png) | ![illustration for AmazonRedshiftMlCard](../../../aws-q1-2024/Resource/Analytics/AmazonRedshiftMlCard.Local.png) | ![illustration for AmazonRedshiftMlGroup](../../../aws-q1-2024/Resource/Analytics/AmazonRedshiftMlGroup.Local.png) |
