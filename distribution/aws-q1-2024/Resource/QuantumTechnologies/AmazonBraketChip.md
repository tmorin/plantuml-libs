...
```text
aws-q1-2024/Resource/QuantumTechnologies/AmazonBraketChip
```

```text
include('aws-q1-2024/Resource/QuantumTechnologies/AmazonBraketChip')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/QuantumTechnologies/AmazonBraketChip.png) | ![illustration for AmazonBraketChip](../../../aws-q1-2024/Resource/QuantumTechnologies/AmazonBraketChip.Local.png) | ![illustration for AmazonBraketChipCard](../../../aws-q1-2024/Resource/QuantumTechnologies/AmazonBraketChipCard.Local.png) | ![illustration for AmazonBraketChipGroup](../../../aws-q1-2024/Resource/QuantumTechnologies/AmazonBraketChipGroup.Local.png) |
