...
```text
aws-q1-2024/Resource/MachineLearning/AmazonSageMakerModel
```

```text
include('aws-q1-2024/Resource/MachineLearning/AmazonSageMakerModel')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/MachineLearning/AmazonSageMakerModel.png) | ![illustration for AmazonSageMakerModel](../../../aws-q1-2024/Resource/MachineLearning/AmazonSageMakerModel.Local.png) | ![illustration for AmazonSageMakerModelCard](../../../aws-q1-2024/Resource/MachineLearning/AmazonSageMakerModelCard.Local.png) | ![illustration for AmazonSageMakerModelGroup](../../../aws-q1-2024/Resource/MachineLearning/AmazonSageMakerModelGroup.Local.png) |
