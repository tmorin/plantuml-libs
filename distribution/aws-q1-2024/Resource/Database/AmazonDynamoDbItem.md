...
```text
aws-q1-2024/Resource/Database/AmazonDynamoDbItem
```

```text
include('aws-q1-2024/Resource/Database/AmazonDynamoDbItem')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbItem.png) | ![illustration for AmazonDynamoDbItem](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbItem.Local.png) | ![illustration for AmazonDynamoDbItemCard](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbItemCard.Local.png) | ![illustration for AmazonDynamoDbItemGroup](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbItemGroup.Local.png) |
