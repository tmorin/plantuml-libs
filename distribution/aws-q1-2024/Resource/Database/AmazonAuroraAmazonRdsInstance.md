...
```text
aws-q1-2024/Resource/Database/AmazonAuroraAmazonRdsInstance
```

```text
include('aws-q1-2024/Resource/Database/AmazonAuroraAmazonRdsInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Database/AmazonAuroraAmazonRdsInstance.png) | ![illustration for AmazonAuroraAmazonRdsInstance](../../../aws-q1-2024/Resource/Database/AmazonAuroraAmazonRdsInstance.Local.png) | ![illustration for AmazonAuroraAmazonRdsInstanceCard](../../../aws-q1-2024/Resource/Database/AmazonAuroraAmazonRdsInstanceCard.Local.png) | ![illustration for AmazonAuroraAmazonRdsInstanceGroup](../../../aws-q1-2024/Resource/Database/AmazonAuroraAmazonRdsInstanceGroup.Local.png) |
