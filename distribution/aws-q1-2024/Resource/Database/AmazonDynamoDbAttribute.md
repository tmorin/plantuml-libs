...
```text
aws-q1-2024/Resource/Database/AmazonDynamoDbAttribute
```

```text
include('aws-q1-2024/Resource/Database/AmazonDynamoDbAttribute')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbAttribute.png) | ![illustration for AmazonDynamoDbAttribute](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbAttribute.Local.png) | ![illustration for AmazonDynamoDbAttributeCard](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbAttributeCard.Local.png) | ![illustration for AmazonDynamoDbAttributeGroup](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbAttributeGroup.Local.png) |
