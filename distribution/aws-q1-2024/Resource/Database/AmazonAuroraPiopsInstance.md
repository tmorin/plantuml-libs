...
```text
aws-q1-2024/Resource/Database/AmazonAuroraPiopsInstance
```

```text
include('aws-q1-2024/Resource/Database/AmazonAuroraPiopsInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Database/AmazonAuroraPiopsInstance.png) | ![illustration for AmazonAuroraPiopsInstance](../../../aws-q1-2024/Resource/Database/AmazonAuroraPiopsInstance.Local.png) | ![illustration for AmazonAuroraPiopsInstanceCard](../../../aws-q1-2024/Resource/Database/AmazonAuroraPiopsInstanceCard.Local.png) | ![illustration for AmazonAuroraPiopsInstanceGroup](../../../aws-q1-2024/Resource/Database/AmazonAuroraPiopsInstanceGroup.Local.png) |
