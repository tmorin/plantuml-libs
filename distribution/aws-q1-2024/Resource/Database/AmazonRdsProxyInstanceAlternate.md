...
```text
aws-q1-2024/Resource/Database/AmazonRdsProxyInstanceAlternate
```

```text
include('aws-q1-2024/Resource/Database/AmazonRdsProxyInstanceAlternate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Database/AmazonRdsProxyInstanceAlternate.png) | ![illustration for AmazonRdsProxyInstanceAlternate](../../../aws-q1-2024/Resource/Database/AmazonRdsProxyInstanceAlternate.Local.png) | ![illustration for AmazonRdsProxyInstanceAlternateCard](../../../aws-q1-2024/Resource/Database/AmazonRdsProxyInstanceAlternateCard.Local.png) | ![illustration for AmazonRdsProxyInstanceAlternateGroup](../../../aws-q1-2024/Resource/Database/AmazonRdsProxyInstanceAlternateGroup.Local.png) |
