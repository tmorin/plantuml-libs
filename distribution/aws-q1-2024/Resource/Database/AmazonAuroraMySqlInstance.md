...
```text
aws-q1-2024/Resource/Database/AmazonAuroraMySqlInstance
```

```text
include('aws-q1-2024/Resource/Database/AmazonAuroraMySqlInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Database/AmazonAuroraMySqlInstance.png) | ![illustration for AmazonAuroraMySqlInstance](../../../aws-q1-2024/Resource/Database/AmazonAuroraMySqlInstance.Local.png) | ![illustration for AmazonAuroraMySqlInstanceCard](../../../aws-q1-2024/Resource/Database/AmazonAuroraMySqlInstanceCard.Local.png) | ![illustration for AmazonAuroraMySqlInstanceGroup](../../../aws-q1-2024/Resource/Database/AmazonAuroraMySqlInstanceGroup.Local.png) |
