...
```text
aws-q1-2024/Resource/Database/AmazonDynamoDbAttributes
```

```text
include('aws-q1-2024/Resource/Database/AmazonDynamoDbAttributes')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbAttributes.png) | ![illustration for AmazonDynamoDbAttributes](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbAttributes.Local.png) | ![illustration for AmazonDynamoDbAttributesCard](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbAttributesCard.Local.png) | ![illustration for AmazonDynamoDbAttributesGroup](../../../aws-q1-2024/Resource/Database/AmazonDynamoDbAttributesGroup.Local.png) |
