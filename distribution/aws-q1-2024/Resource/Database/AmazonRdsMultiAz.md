...
```text
aws-q1-2024/Resource/Database/AmazonRdsMultiAz
```

```text
include('aws-q1-2024/Resource/Database/AmazonRdsMultiAz')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/Database/AmazonRdsMultiAz.png) | ![illustration for AmazonRdsMultiAz](../../../aws-q1-2024/Resource/Database/AmazonRdsMultiAz.Local.png) | ![illustration for AmazonRdsMultiAzCard](../../../aws-q1-2024/Resource/Database/AmazonRdsMultiAzCard.Local.png) | ![illustration for AmazonRdsMultiAzGroup](../../../aws-q1-2024/Resource/Database/AmazonRdsMultiAzGroup.Local.png) |
