...
```text
aws-q1-2024/Resource/IoT/AwsIoTThingUtility
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTThingUtility')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTThingUtility.png) | ![illustration for AwsIoTThingUtility](../../../aws-q1-2024/Resource/IoT/AwsIoTThingUtility.Local.png) | ![illustration for AwsIoTThingUtilityCard](../../../aws-q1-2024/Resource/IoT/AwsIoTThingUtilityCard.Local.png) | ![illustration for AwsIoTThingUtilityGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTThingUtilityGroup.Local.png) |
