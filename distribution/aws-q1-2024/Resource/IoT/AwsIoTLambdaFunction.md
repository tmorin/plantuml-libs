...
```text
aws-q1-2024/Resource/IoT/AwsIoTLambdaFunction
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTLambdaFunction')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTLambdaFunction.png) | ![illustration for AwsIoTLambdaFunction](../../../aws-q1-2024/Resource/IoT/AwsIoTLambdaFunction.Local.png) | ![illustration for AwsIoTLambdaFunctionCard](../../../aws-q1-2024/Resource/IoT/AwsIoTLambdaFunctionCard.Local.png) | ![illustration for AwsIoTLambdaFunctionGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTLambdaFunctionGroup.Local.png) |
