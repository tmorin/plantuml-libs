...
```text
aws-q1-2024/Resource/IoT/AwsIoTSailboat
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTSailboat')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTSailboat.png) | ![illustration for AwsIoTSailboat](../../../aws-q1-2024/Resource/IoT/AwsIoTSailboat.Local.png) | ![illustration for AwsIoTSailboatCard](../../../aws-q1-2024/Resource/IoT/AwsIoTSailboatCard.Local.png) | ![illustration for AwsIoTSailboatGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTSailboatGroup.Local.png) |
