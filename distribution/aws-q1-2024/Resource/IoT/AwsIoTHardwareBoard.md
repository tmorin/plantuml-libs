...
```text
aws-q1-2024/Resource/IoT/AwsIoTHardwareBoard
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTHardwareBoard')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTHardwareBoard.png) | ![illustration for AwsIoTHardwareBoard](../../../aws-q1-2024/Resource/IoT/AwsIoTHardwareBoard.Local.png) | ![illustration for AwsIoTHardwareBoardCard](../../../aws-q1-2024/Resource/IoT/AwsIoTHardwareBoardCard.Local.png) | ![illustration for AwsIoTHardwareBoardGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTHardwareBoardGroup.Local.png) |
