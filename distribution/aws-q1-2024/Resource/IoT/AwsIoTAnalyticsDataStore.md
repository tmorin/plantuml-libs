...
```text
aws-q1-2024/Resource/IoT/AwsIoTAnalyticsDataStore
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTAnalyticsDataStore')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTAnalyticsDataStore.png) | ![illustration for AwsIoTAnalyticsDataStore](../../../aws-q1-2024/Resource/IoT/AwsIoTAnalyticsDataStore.Local.png) | ![illustration for AwsIoTAnalyticsDataStoreCard](../../../aws-q1-2024/Resource/IoT/AwsIoTAnalyticsDataStoreCard.Local.png) | ![illustration for AwsIoTAnalyticsDataStoreGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTAnalyticsDataStoreGroup.Local.png) |
