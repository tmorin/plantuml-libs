...
```text
aws-q1-2024/Resource/IoT/AwsIoTThingBicycle
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTThingBicycle')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTThingBicycle.png) | ![illustration for AwsIoTThingBicycle](../../../aws-q1-2024/Resource/IoT/AwsIoTThingBicycle.Local.png) | ![illustration for AwsIoTThingBicycleCard](../../../aws-q1-2024/Resource/IoT/AwsIoTThingBicycleCard.Local.png) | ![illustration for AwsIoTThingBicycleGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTThingBicycleGroup.Local.png) |
