...
```text
aws-q1-2024/Resource/IoT/AwsIoTThingCamera
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTThingCamera')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTThingCamera.png) | ![illustration for AwsIoTThingCamera](../../../aws-q1-2024/Resource/IoT/AwsIoTThingCamera.Local.png) | ![illustration for AwsIoTThingCameraCard](../../../aws-q1-2024/Resource/IoT/AwsIoTThingCameraCard.Local.png) | ![illustration for AwsIoTThingCameraGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTThingCameraGroup.Local.png) |
