...
```text
aws-q1-2024/Resource/IoT/AwsIoTCoreDeviceAdvisor
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTCoreDeviceAdvisor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTCoreDeviceAdvisor.png) | ![illustration for AwsIoTCoreDeviceAdvisor](../../../aws-q1-2024/Resource/IoT/AwsIoTCoreDeviceAdvisor.Local.png) | ![illustration for AwsIoTCoreDeviceAdvisorCard](../../../aws-q1-2024/Resource/IoT/AwsIoTCoreDeviceAdvisorCard.Local.png) | ![illustration for AwsIoTCoreDeviceAdvisorGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTCoreDeviceAdvisorGroup.Local.png) |
