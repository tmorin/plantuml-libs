...
```text
aws-q1-2024/Resource/IoT/AwsIoTThingThermostat
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTThingThermostat')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTThingThermostat.png) | ![illustration for AwsIoTThingThermostat](../../../aws-q1-2024/Resource/IoT/AwsIoTThingThermostat.Local.png) | ![illustration for AwsIoTThingThermostatCard](../../../aws-q1-2024/Resource/IoT/AwsIoTThingThermostatCard.Local.png) | ![illustration for AwsIoTThingThermostatGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTThingThermostatGroup.Local.png) |
