...
```text
aws-q1-2024/Resource/IoT/AwsIoTOverAirUpdate
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTOverAirUpdate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTOverAirUpdate.png) | ![illustration for AwsIoTOverAirUpdate](../../../aws-q1-2024/Resource/IoT/AwsIoTOverAirUpdate.Local.png) | ![illustration for AwsIoTOverAirUpdateCard](../../../aws-q1-2024/Resource/IoT/AwsIoTOverAirUpdateCard.Local.png) | ![illustration for AwsIoTOverAirUpdateGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTOverAirUpdateGroup.Local.png) |
