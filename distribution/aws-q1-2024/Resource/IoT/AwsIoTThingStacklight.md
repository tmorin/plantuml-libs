...
```text
aws-q1-2024/Resource/IoT/AwsIoTThingStacklight
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTThingStacklight')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTThingStacklight.png) | ![illustration for AwsIoTThingStacklight](../../../aws-q1-2024/Resource/IoT/AwsIoTThingStacklight.Local.png) | ![illustration for AwsIoTThingStacklightCard](../../../aws-q1-2024/Resource/IoT/AwsIoTThingStacklightCard.Local.png) | ![illustration for AwsIoTThingStacklightGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTThingStacklightGroup.Local.png) |
