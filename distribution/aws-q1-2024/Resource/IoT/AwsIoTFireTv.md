...
```text
aws-q1-2024/Resource/IoT/AwsIoTFireTv
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTFireTv')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTFireTv.png) | ![illustration for AwsIoTFireTv](../../../aws-q1-2024/Resource/IoT/AwsIoTFireTv.Local.png) | ![illustration for AwsIoTFireTvCard](../../../aws-q1-2024/Resource/IoT/AwsIoTFireTvCard.Local.png) | ![illustration for AwsIoTFireTvGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTFireTvGroup.Local.png) |
