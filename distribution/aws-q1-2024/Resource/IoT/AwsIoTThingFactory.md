...
```text
aws-q1-2024/Resource/IoT/AwsIoTThingFactory
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTThingFactory')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTThingFactory.png) | ![illustration for AwsIoTThingFactory](../../../aws-q1-2024/Resource/IoT/AwsIoTThingFactory.Local.png) | ![illustration for AwsIoTThingFactoryCard](../../../aws-q1-2024/Resource/IoT/AwsIoTThingFactoryCard.Local.png) | ![illustration for AwsIoTThingFactoryGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTThingFactoryGroup.Local.png) |
