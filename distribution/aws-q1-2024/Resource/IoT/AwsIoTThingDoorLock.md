...
```text
aws-q1-2024/Resource/IoT/AwsIoTThingDoorLock
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTThingDoorLock')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTThingDoorLock.png) | ![illustration for AwsIoTThingDoorLock](../../../aws-q1-2024/Resource/IoT/AwsIoTThingDoorLock.Local.png) | ![illustration for AwsIoTThingDoorLockCard](../../../aws-q1-2024/Resource/IoT/AwsIoTThingDoorLockCard.Local.png) | ![illustration for AwsIoTThingDoorLockGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTThingDoorLockGroup.Local.png) |
