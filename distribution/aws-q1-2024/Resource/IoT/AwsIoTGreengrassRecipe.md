...
```text
aws-q1-2024/Resource/IoT/AwsIoTGreengrassRecipe
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTGreengrassRecipe')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTGreengrassRecipe.png) | ![illustration for AwsIoTGreengrassRecipe](../../../aws-q1-2024/Resource/IoT/AwsIoTGreengrassRecipe.Local.png) | ![illustration for AwsIoTGreengrassRecipeCard](../../../aws-q1-2024/Resource/IoT/AwsIoTGreengrassRecipeCard.Local.png) | ![illustration for AwsIoTGreengrassRecipeGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTGreengrassRecipeGroup.Local.png) |
