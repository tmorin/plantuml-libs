...
```text
aws-q1-2024/Resource/IoT/AwsIoTRule
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTRule')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTRule.png) | ![illustration for AwsIoTRule](../../../aws-q1-2024/Resource/IoT/AwsIoTRule.Local.png) | ![illustration for AwsIoTRuleCard](../../../aws-q1-2024/Resource/IoT/AwsIoTRuleCard.Local.png) | ![illustration for AwsIoTRuleGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTRuleGroup.Local.png) |
