...
```text
aws-q1-2024/Resource/IoT/AwsIoTShadow
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTShadow')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTShadow.png) | ![illustration for AwsIoTShadow](../../../aws-q1-2024/Resource/IoT/AwsIoTShadow.Local.png) | ![illustration for AwsIoTShadowCard](../../../aws-q1-2024/Resource/IoT/AwsIoTShadowCard.Local.png) | ![illustration for AwsIoTShadowGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTShadowGroup.Local.png) |
