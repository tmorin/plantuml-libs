...
```text
aws-q1-2024/Resource/IoT/AwsIoTCertificate
```

```text
include('aws-q1-2024/Resource/IoT/AwsIoTCertificate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/IoT/AwsIoTCertificate.png) | ![illustration for AwsIoTCertificate](../../../aws-q1-2024/Resource/IoT/AwsIoTCertificate.Local.png) | ![illustration for AwsIoTCertificateCard](../../../aws-q1-2024/Resource/IoT/AwsIoTCertificateCard.Local.png) | ![illustration for AwsIoTCertificateGroup](../../../aws-q1-2024/Resource/IoT/AwsIoTCertificateGroup.Local.png) |
