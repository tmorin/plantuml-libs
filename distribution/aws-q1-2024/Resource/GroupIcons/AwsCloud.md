...
```text
aws-q1-2024/Resource/GroupIcons/AwsCloud
```

```text
include('aws-q1-2024/Resource/GroupIcons/AwsCloud')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q1-2024/Resource/GroupIcons/AwsCloud.png) | ![illustration for AwsCloud](../../../aws-q1-2024/Resource/GroupIcons/AwsCloud.Local.png) | ![illustration for AwsCloudCard](../../../aws-q1-2024/Resource/GroupIcons/AwsCloudCard.Local.png) | ![illustration for AwsCloudGroup](../../../aws-q1-2024/Resource/GroupIcons/AwsCloudGroup.Local.png) |
