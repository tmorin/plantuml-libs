...
```text
aws-q1-2024/Resource/ManagementGovernance/AwsOpsWorksPermissions
```

```text
include('aws-q1-2024/Resource/ManagementGovernance/AwsOpsWorksPermissions')
```
