...
```text
aws-q1-2024/Resource/ManagementGovernance/AwsOrganizationsManagementAccount
```

```text
include('aws-q1-2024/Resource/ManagementGovernance/AwsOrganizationsManagementAccount')
```
