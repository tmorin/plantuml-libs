...
```text
aws-q1-2024/Resource/ManagementGovernance/AmazonCloudWatchLogs
```

```text
include('aws-q1-2024/Resource/ManagementGovernance/AmazonCloudWatchLogs')
```
