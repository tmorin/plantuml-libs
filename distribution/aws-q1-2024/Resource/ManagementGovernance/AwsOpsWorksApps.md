...
```text
aws-q1-2024/Resource/ManagementGovernance/AwsOpsWorksApps
```

```text
include('aws-q1-2024/Resource/ManagementGovernance/AwsOpsWorksApps')
```
