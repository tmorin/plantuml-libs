...
```text
aws-q1-2024/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistCost
```

```text
include('aws-q1-2024/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistCost')
```
