...
```text
aws-q1-2024/Resource/ManagementGovernance/AwsSystemsManagerOpsCenter
```

```text
include('aws-q1-2024/Resource/ManagementGovernance/AwsSystemsManagerOpsCenter')
```
