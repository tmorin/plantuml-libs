...
```text
aws-q1-2024/Resource/ManagementGovernance/AwsSystemsManagerAutomation
```

```text
include('aws-q1-2024/Resource/ManagementGovernance/AwsSystemsManagerAutomation')
```
