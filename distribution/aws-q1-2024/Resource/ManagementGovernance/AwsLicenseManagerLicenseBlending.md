...
```text
aws-q1-2024/Resource/ManagementGovernance/AwsLicenseManagerLicenseBlending
```

```text
include('aws-q1-2024/Resource/ManagementGovernance/AwsLicenseManagerLicenseBlending')
```
