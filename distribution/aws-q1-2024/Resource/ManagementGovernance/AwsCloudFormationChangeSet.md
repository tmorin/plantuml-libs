...
```text
aws-q1-2024/Resource/ManagementGovernance/AwsCloudFormationChangeSet
```

```text
include('aws-q1-2024/Resource/ManagementGovernance/AwsCloudFormationChangeSet')
```
