...
```text
aws-q1-2024/Resource/ManagementGovernance/AwsCloudFormationTemplate
```

```text
include('aws-q1-2024/Resource/ManagementGovernance/AwsCloudFormationTemplate')
```
