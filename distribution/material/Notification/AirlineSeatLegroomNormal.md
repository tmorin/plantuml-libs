...
```text
material/Notification/AirlineSeatLegroomNormal
```

```text
include('material/Notification/AirlineSeatLegroomNormal')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Notification/AirlineSeatLegroomNormal.png) | ![illustration for AirlineSeatLegroomNormal](../../material/Notification/AirlineSeatLegroomNormal.Local.png) |
