...
```text
material/File/DriveFileRenameOutline
```

```text
include('material/File/DriveFileRenameOutline')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/File/DriveFileRenameOutline.png) | ![illustration for DriveFileRenameOutline](../../material/File/DriveFileRenameOutline.Local.png) |
