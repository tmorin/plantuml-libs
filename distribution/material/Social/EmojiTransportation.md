...
```text
material/Social/EmojiTransportation
```

```text
include('material/Social/EmojiTransportation')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Social/EmojiTransportation.png) | ![illustration for EmojiTransportation](../../material/Social/EmojiTransportation.Local.png) |
