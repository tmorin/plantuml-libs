...
```text
material/Social/SentimentDissatisfied
```

```text
include('material/Social/SentimentDissatisfied')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Social/SentimentDissatisfied.png) | ![illustration for SentimentDissatisfied](../../material/Social/SentimentDissatisfied.Local.png) |
