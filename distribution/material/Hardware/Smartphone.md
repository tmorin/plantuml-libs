...
```text
include('material/Hardware/Smartphone')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Hardware/Smartphone.png) | ![illustration for Smartphone](../../material/Hardware/Smartphone.Local.png) |
