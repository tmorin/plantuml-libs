...
```text
material/Navigation/SubdirectoryArrowLeft
```

```text
include('material/Navigation/SubdirectoryArrowLeft')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Navigation/SubdirectoryArrowLeft.png) | ![illustration for SubdirectoryArrowLeft](../../material/Navigation/SubdirectoryArrowLeft.Local.png) |
