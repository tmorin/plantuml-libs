...
```text
material/Action/LabelImportantOutline
```

```text
include('material/Action/LabelImportantOutline')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Action/LabelImportantOutline.png) | ![illustration for LabelImportantOutline](../../material/Action/LabelImportantOutline.Local.png) |
