...
```text
material/Action/SettingsApplications
```

```text
include('material/Action/SettingsApplications')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Action/SettingsApplications.png) | ![illustration for SettingsApplications](../../material/Action/SettingsApplications.Local.png) |
