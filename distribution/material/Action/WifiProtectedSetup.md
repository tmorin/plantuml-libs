...
```text
material/Action/WifiProtectedSetup
```

```text
include('material/Action/WifiProtectedSetup')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Action/WifiProtectedSetup.png) | ![illustration for WifiProtectedSetup](../../material/Action/WifiProtectedSetup.Local.png) |
