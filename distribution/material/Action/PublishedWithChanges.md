...
```text
material/Action/PublishedWithChanges
```

```text
include('material/Action/PublishedWithChanges')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Action/PublishedWithChanges.png) | ![illustration for PublishedWithChanges](../../material/Action/PublishedWithChanges.Local.png) |
