...
```text
material/Action/TextRotationAngleup
```

```text
include('material/Action/TextRotationAngleup')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Action/TextRotationAngleup.png) | ![illustration for TextRotationAngleup](../../material/Action/TextRotationAngleup.Local.png) |
