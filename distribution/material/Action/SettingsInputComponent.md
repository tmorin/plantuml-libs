...
```text
material/Action/SettingsInputComponent
```

```text
include('material/Action/SettingsInputComponent')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Action/SettingsInputComponent.png) | ![illustration for SettingsInputComponent](../../material/Action/SettingsInputComponent.Local.png) |
