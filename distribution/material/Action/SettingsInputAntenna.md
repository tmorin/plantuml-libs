...
```text
material/Action/SettingsInputAntenna
```

```text
include('material/Action/SettingsInputAntenna')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Action/SettingsInputAntenna.png) | ![illustration for SettingsInputAntenna](../../material/Action/SettingsInputAntenna.Local.png) |
