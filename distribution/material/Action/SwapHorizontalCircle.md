...
```text
material/Action/SwapHorizontalCircle
```

```text
include('material/Action/SwapHorizontalCircle')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Action/SwapHorizontalCircle.png) | ![illustration for SwapHorizontalCircle](../../material/Action/SwapHorizontalCircle.Local.png) |
