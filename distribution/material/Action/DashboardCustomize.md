...
```text
material/Action/DashboardCustomize
```

```text
include('material/Action/DashboardCustomize')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Action/DashboardCustomize.png) | ![illustration for DashboardCustomize](../../material/Action/DashboardCustomize.Local.png) |
