...
```text
include('material/Action/Fingerprint')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Action/Fingerprint.png) | ![illustration for Fingerprint](../../material/Action/Fingerprint.Local.png) |
