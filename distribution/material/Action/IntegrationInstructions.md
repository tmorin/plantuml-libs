...
```text
material/Action/IntegrationInstructions
```

```text
include('material/Action/IntegrationInstructions')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Action/IntegrationInstructions.png) | ![illustration for IntegrationInstructions](../../material/Action/IntegrationInstructions.Local.png) |
