...
```text
material/Device/ScreenSearchDesktop
```

```text
include('material/Device/ScreenSearchDesktop')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Device/ScreenSearchDesktop.png) | ![illustration for ScreenSearchDesktop](../../material/Device/ScreenSearchDesktop.Local.png) |
