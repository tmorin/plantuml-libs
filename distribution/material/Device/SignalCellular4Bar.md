...
```text
material/Device/SignalCellular4Bar
```

```text
include('material/Device/SignalCellular4Bar')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Device/SignalCellular4Bar.png) | ![illustration for SignalCellular4Bar](../../material/Device/SignalCellular4Bar.Local.png) |
