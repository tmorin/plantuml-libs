...
```text
material/Device/SignalWifi4BarLock
```

```text
include('material/Device/SignalWifi4BarLock')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Device/SignalWifi4BarLock.png) | ![illustration for SignalWifi4BarLock](../../material/Device/SignalWifi4BarLock.Local.png) |
