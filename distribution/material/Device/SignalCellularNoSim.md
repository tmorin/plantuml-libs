...
```text
material/Device/SignalCellularNoSim
```

```text
include('material/Device/SignalCellularNoSim')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Device/SignalCellularNoSim.png) | ![illustration for SignalCellularNoSim](../../material/Device/SignalCellularNoSim.Local.png) |
