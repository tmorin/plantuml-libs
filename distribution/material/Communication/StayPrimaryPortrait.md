...
```text
material/Communication/StayPrimaryPortrait
```

```text
include('material/Communication/StayPrimaryPortrait')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Communication/StayPrimaryPortrait.png) | ![illustration for StayPrimaryPortrait](../../material/Communication/StayPrimaryPortrait.Local.png) |
