...
```text
material/Maps/TransferWithinAStation
```

```text
include('material/Maps/TransferWithinAStation')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Maps/TransferWithinAStation.png) | ![illustration for TransferWithinAStation](../../material/Maps/TransferWithinAStation.Local.png) |
