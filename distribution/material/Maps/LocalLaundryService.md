...
```text
material/Maps/LocalLaundryService
```

```text
include('material/Maps/LocalLaundryService')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Maps/LocalLaundryService.png) | ![illustration for LocalLaundryService](../../material/Maps/LocalLaundryService.Local.png) |
