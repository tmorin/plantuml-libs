...
```text
material/Image/MotionPhotosPaused
```

```text
include('material/Image/MotionPhotosPaused')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Image/MotionPhotosPaused.png) | ![illustration for MotionPhotosPaused](../../material/Image/MotionPhotosPaused.Local.png) |
