...
```text
material/Image/PhotoSizeSelectActual
```

```text
include('material/Image/PhotoSizeSelectActual')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Image/PhotoSizeSelectActual.png) | ![illustration for PhotoSizeSelectActual](../../material/Image/PhotoSizeSelectActual.Local.png) |
