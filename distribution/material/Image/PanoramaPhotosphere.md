...
```text
material/Image/PanoramaPhotosphere
```

```text
include('material/Image/PanoramaPhotosphere')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Image/PanoramaPhotosphere.png) | ![illustration for PanoramaPhotosphere](../../material/Image/PanoramaPhotosphere.Local.png) |
