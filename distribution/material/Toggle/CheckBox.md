...
```text
include('material/Toggle/CheckBox')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Toggle/CheckBox.png) | ![illustration for CheckBox](../../material/Toggle/CheckBox.Local.png) |
