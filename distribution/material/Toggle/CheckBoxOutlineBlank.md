...
```text
material/Toggle/CheckBoxOutlineBlank
```

```text
include('material/Toggle/CheckBoxOutlineBlank')
```
...
| :---: | :---: |
| ![illustration for Illustration](../../material/Toggle/CheckBoxOutlineBlank.png) | ![illustration for CheckBoxOutlineBlank](../../material/Toggle/CheckBoxOutlineBlank.Local.png) |
