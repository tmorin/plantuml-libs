...
```text
aws-q3-2022/Architecture/Satellite/AwsGroundStation
```

```text
include('aws-q3-2022/Architecture/Satellite/AwsGroundStation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Satellite/AwsGroundStation.png) | ![illustration for AwsGroundStation](../../../aws-q3-2022/Architecture/Satellite/AwsGroundStation.Local.png) | ![illustration for AwsGroundStationCard](../../../aws-q3-2022/Architecture/Satellite/AwsGroundStationCard.Local.png) | ![illustration for AwsGroundStationGroup](../../../aws-q3-2022/Architecture/Satellite/AwsGroundStationGroup.Local.png) |
