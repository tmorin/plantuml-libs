...
```text
aws-q3-2022/Architecture/Storage/AwsSnowballEdge
```

```text
include('aws-q3-2022/Architecture/Storage/AwsSnowballEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Storage/AwsSnowballEdge.png) | ![illustration for AwsSnowballEdge](../../../aws-q3-2022/Architecture/Storage/AwsSnowballEdge.Local.png) | ![illustration for AwsSnowballEdgeCard](../../../aws-q3-2022/Architecture/Storage/AwsSnowballEdgeCard.Local.png) | ![illustration for AwsSnowballEdgeGroup](../../../aws-q3-2022/Architecture/Storage/AwsSnowballEdgeGroup.Local.png) |
