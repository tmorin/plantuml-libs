...
```text
aws-q3-2022/Architecture/Storage/AwsBackup
```

```text
include('aws-q3-2022/Architecture/Storage/AwsBackup')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Storage/AwsBackup.png) | ![illustration for AwsBackup](../../../aws-q3-2022/Architecture/Storage/AwsBackup.Local.png) | ![illustration for AwsBackupCard](../../../aws-q3-2022/Architecture/Storage/AwsBackupCard.Local.png) | ![illustration for AwsBackupGroup](../../../aws-q3-2022/Architecture/Storage/AwsBackupGroup.Local.png) |
