...
```text
aws-q3-2022/Architecture/Storage/AwsSnowcone
```

```text
include('aws-q3-2022/Architecture/Storage/AwsSnowcone')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Storage/AwsSnowcone.png) | ![illustration for AwsSnowcone](../../../aws-q3-2022/Architecture/Storage/AwsSnowcone.Local.png) | ![illustration for AwsSnowconeCard](../../../aws-q3-2022/Architecture/Storage/AwsSnowconeCard.Local.png) | ![illustration for AwsSnowconeGroup](../../../aws-q3-2022/Architecture/Storage/AwsSnowconeGroup.Local.png) |
