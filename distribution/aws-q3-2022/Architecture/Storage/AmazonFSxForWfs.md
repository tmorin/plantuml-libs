...
```text
aws-q3-2022/Architecture/Storage/AmazonFSxForWfs
```

```text
include('aws-q3-2022/Architecture/Storage/AmazonFSxForWfs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Storage/AmazonFSxForWfs.png) | ![illustration for AmazonFSxForWfs](../../../aws-q3-2022/Architecture/Storage/AmazonFSxForWfs.Local.png) | ![illustration for AmazonFSxForWfsCard](../../../aws-q3-2022/Architecture/Storage/AmazonFSxForWfsCard.Local.png) | ![illustration for AmazonFSxForWfsGroup](../../../aws-q3-2022/Architecture/Storage/AmazonFSxForWfsGroup.Local.png) |
