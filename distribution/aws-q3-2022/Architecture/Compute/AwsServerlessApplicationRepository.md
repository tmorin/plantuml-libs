...
```text
aws-q3-2022/Architecture/Compute/AwsServerlessApplicationRepository
```

```text
include('aws-q3-2022/Architecture/Compute/AwsServerlessApplicationRepository')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Compute/AwsServerlessApplicationRepository.png) | ![illustration for AwsServerlessApplicationRepository](../../../aws-q3-2022/Architecture/Compute/AwsServerlessApplicationRepository.Local.png) | ![illustration for AwsServerlessApplicationRepositoryCard](../../../aws-q3-2022/Architecture/Compute/AwsServerlessApplicationRepositoryCard.Local.png) | ![illustration for AwsServerlessApplicationRepositoryGroup](../../../aws-q3-2022/Architecture/Compute/AwsServerlessApplicationRepositoryGroup.Local.png) |
