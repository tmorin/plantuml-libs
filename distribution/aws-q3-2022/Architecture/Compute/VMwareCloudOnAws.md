...
```text
aws-q3-2022/Architecture/Compute/VMwareCloudOnAws
```

```text
include('aws-q3-2022/Architecture/Compute/VMwareCloudOnAws')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Compute/VMwareCloudOnAws.png) | ![illustration for VMwareCloudOnAws](../../../aws-q3-2022/Architecture/Compute/VMwareCloudOnAws.Local.png) | ![illustration for VMwareCloudOnAwsCard](../../../aws-q3-2022/Architecture/Compute/VMwareCloudOnAwsCard.Local.png) | ![illustration for VMwareCloudOnAwsGroup](../../../aws-q3-2022/Architecture/Compute/VMwareCloudOnAwsGroup.Local.png) |
