...
```text
aws-q3-2022/Architecture/Compute/AwsParallelCluster
```

```text
include('aws-q3-2022/Architecture/Compute/AwsParallelCluster')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Compute/AwsParallelCluster.png) | ![illustration for AwsParallelCluster](../../../aws-q3-2022/Architecture/Compute/AwsParallelCluster.Local.png) | ![illustration for AwsParallelClusterCard](../../../aws-q3-2022/Architecture/Compute/AwsParallelClusterCard.Local.png) | ![illustration for AwsParallelClusterGroup](../../../aws-q3-2022/Architecture/Compute/AwsParallelClusterGroup.Local.png) |
