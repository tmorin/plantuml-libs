...
```text
aws-q3-2022/Architecture/Compute/AwsOutpostsRack
```

```text
include('aws-q3-2022/Architecture/Compute/AwsOutpostsRack')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Compute/AwsOutpostsRack.png) | ![illustration for AwsOutpostsRack](../../../aws-q3-2022/Architecture/Compute/AwsOutpostsRack.Local.png) | ![illustration for AwsOutpostsRackCard](../../../aws-q3-2022/Architecture/Compute/AwsOutpostsRackCard.Local.png) | ![illustration for AwsOutpostsRackGroup](../../../aws-q3-2022/Architecture/Compute/AwsOutpostsRackGroup.Local.png) |
