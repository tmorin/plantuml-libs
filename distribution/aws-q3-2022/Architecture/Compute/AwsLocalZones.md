...
```text
aws-q3-2022/Architecture/Compute/AwsLocalZones
```

```text
include('aws-q3-2022/Architecture/Compute/AwsLocalZones')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Compute/AwsLocalZones.png) | ![illustration for AwsLocalZones](../../../aws-q3-2022/Architecture/Compute/AwsLocalZones.Local.png) | ![illustration for AwsLocalZonesCard](../../../aws-q3-2022/Architecture/Compute/AwsLocalZonesCard.Local.png) | ![illustration for AwsLocalZonesGroup](../../../aws-q3-2022/Architecture/Compute/AwsLocalZonesGroup.Local.png) |
