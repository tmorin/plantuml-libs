...
```text
aws-q3-2022/Architecture/Compute/AwsFargate
```

```text
include('aws-q3-2022/Architecture/Compute/AwsFargate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Compute/AwsFargate.png) | ![illustration for AwsFargate](../../../aws-q3-2022/Architecture/Compute/AwsFargate.Local.png) | ![illustration for AwsFargateCard](../../../aws-q3-2022/Architecture/Compute/AwsFargateCard.Local.png) | ![illustration for AwsFargateGroup](../../../aws-q3-2022/Architecture/Compute/AwsFargateGroup.Local.png) |
