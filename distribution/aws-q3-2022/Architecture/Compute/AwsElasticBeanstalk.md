...
```text
aws-q3-2022/Architecture/Compute/AwsElasticBeanstalk
```

```text
include('aws-q3-2022/Architecture/Compute/AwsElasticBeanstalk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Compute/AwsElasticBeanstalk.png) | ![illustration for AwsElasticBeanstalk](../../../aws-q3-2022/Architecture/Compute/AwsElasticBeanstalk.Local.png) | ![illustration for AwsElasticBeanstalkCard](../../../aws-q3-2022/Architecture/Compute/AwsElasticBeanstalkCard.Local.png) | ![illustration for AwsElasticBeanstalkGroup](../../../aws-q3-2022/Architecture/Compute/AwsElasticBeanstalkGroup.Local.png) |
