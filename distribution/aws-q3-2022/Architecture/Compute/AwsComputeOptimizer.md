...
```text
aws-q3-2022/Architecture/Compute/AwsComputeOptimizer
```

```text
include('aws-q3-2022/Architecture/Compute/AwsComputeOptimizer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Compute/AwsComputeOptimizer.png) | ![illustration for AwsComputeOptimizer](../../../aws-q3-2022/Architecture/Compute/AwsComputeOptimizer.Local.png) | ![illustration for AwsComputeOptimizerCard](../../../aws-q3-2022/Architecture/Compute/AwsComputeOptimizerCard.Local.png) | ![illustration for AwsComputeOptimizerGroup](../../../aws-q3-2022/Architecture/Compute/AwsComputeOptimizerGroup.Local.png) |
