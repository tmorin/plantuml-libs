...
```text
aws-q3-2022/Architecture/Compute/NiceEnginFrame
```

```text
include('aws-q3-2022/Architecture/Compute/NiceEnginFrame')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Compute/NiceEnginFrame.png) | ![illustration for NiceEnginFrame](../../../aws-q3-2022/Architecture/Compute/NiceEnginFrame.Local.png) | ![illustration for NiceEnginFrameCard](../../../aws-q3-2022/Architecture/Compute/NiceEnginFrameCard.Local.png) | ![illustration for NiceEnginFrameGroup](../../../aws-q3-2022/Architecture/Compute/NiceEnginFrameGroup.Local.png) |
