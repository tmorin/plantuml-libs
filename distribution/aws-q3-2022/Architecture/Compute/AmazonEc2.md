...
```text
aws-q3-2022/Architecture/Compute/AmazonEc2
```

```text
include('aws-q3-2022/Architecture/Compute/AmazonEc2')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Compute/AmazonEc2.png) | ![illustration for AmazonEc2](../../../aws-q3-2022/Architecture/Compute/AmazonEc2.Local.png) | ![illustration for AmazonEc2Card](../../../aws-q3-2022/Architecture/Compute/AmazonEc2Card.Local.png) | ![illustration for AmazonEc2Group](../../../aws-q3-2022/Architecture/Compute/AmazonEc2Group.Local.png) |
