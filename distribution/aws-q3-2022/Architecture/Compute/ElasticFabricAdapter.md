...
```text
aws-q3-2022/Architecture/Compute/ElasticFabricAdapter
```

```text
include('aws-q3-2022/Architecture/Compute/ElasticFabricAdapter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Compute/ElasticFabricAdapter.png) | ![illustration for ElasticFabricAdapter](../../../aws-q3-2022/Architecture/Compute/ElasticFabricAdapter.Local.png) | ![illustration for ElasticFabricAdapterCard](../../../aws-q3-2022/Architecture/Compute/ElasticFabricAdapterCard.Local.png) | ![illustration for ElasticFabricAdapterGroup](../../../aws-q3-2022/Architecture/Compute/ElasticFabricAdapterGroup.Local.png) |
