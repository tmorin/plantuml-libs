...
```text
aws-q3-2022/Architecture/InternetOfThings/AwsIoT1Click
```

```text
include('aws-q3-2022/Architecture/InternetOfThings/AwsIoT1Click')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/InternetOfThings/AwsIoT1Click.png) | ![illustration for AwsIoT1Click](../../../aws-q3-2022/Architecture/InternetOfThings/AwsIoT1Click.Local.png) | ![illustration for AwsIoT1ClickCard](../../../aws-q3-2022/Architecture/InternetOfThings/AwsIoT1ClickCard.Local.png) | ![illustration for AwsIoT1ClickGroup](../../../aws-q3-2022/Architecture/InternetOfThings/AwsIoT1ClickGroup.Local.png) |
