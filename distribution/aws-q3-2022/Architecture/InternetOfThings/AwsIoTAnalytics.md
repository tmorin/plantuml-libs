...
```text
aws-q3-2022/Architecture/InternetOfThings/AwsIoTAnalytics
```

```text
include('aws-q3-2022/Architecture/InternetOfThings/AwsIoTAnalytics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/InternetOfThings/AwsIoTAnalytics.png) | ![illustration for AwsIoTAnalytics](../../../aws-q3-2022/Architecture/InternetOfThings/AwsIoTAnalytics.Local.png) | ![illustration for AwsIoTAnalyticsCard](../../../aws-q3-2022/Architecture/InternetOfThings/AwsIoTAnalyticsCard.Local.png) | ![illustration for AwsIoTAnalyticsGroup](../../../aws-q3-2022/Architecture/InternetOfThings/AwsIoTAnalyticsGroup.Local.png) |
