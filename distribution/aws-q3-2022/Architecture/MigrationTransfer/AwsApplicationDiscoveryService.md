...
```text
aws-q3-2022/Architecture/MigrationTransfer/AwsApplicationDiscoveryService
```

```text
include('aws-q3-2022/Architecture/MigrationTransfer/AwsApplicationDiscoveryService')
```
