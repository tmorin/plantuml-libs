...
```text
aws-q3-2022/Architecture/AppIntegration/AmazonEventBridge
```

```text
include('aws-q3-2022/Architecture/AppIntegration/AmazonEventBridge')
```
