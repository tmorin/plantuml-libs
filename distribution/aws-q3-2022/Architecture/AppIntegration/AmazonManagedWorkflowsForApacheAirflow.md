...
```text
aws-q3-2022/Architecture/AppIntegration/AmazonManagedWorkflowsForApacheAirflow
```

```text
include('aws-q3-2022/Architecture/AppIntegration/AmazonManagedWorkflowsForApacheAirflow')
```
