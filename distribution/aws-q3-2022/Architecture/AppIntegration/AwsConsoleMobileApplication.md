...
```text
aws-q3-2022/Architecture/AppIntegration/AwsConsoleMobileApplication
```

```text
include('aws-q3-2022/Architecture/AppIntegration/AwsConsoleMobileApplication')
```
