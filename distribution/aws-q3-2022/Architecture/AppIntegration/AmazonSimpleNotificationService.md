...
```text
aws-q3-2022/Architecture/AppIntegration/AmazonSimpleNotificationService
```

```text
include('aws-q3-2022/Architecture/AppIntegration/AmazonSimpleNotificationService')
```
