...
```text
aws-q3-2022/Architecture/AppIntegration/AwsStepFunctions
```

```text
include('aws-q3-2022/Architecture/AppIntegration/AwsStepFunctions')
```
