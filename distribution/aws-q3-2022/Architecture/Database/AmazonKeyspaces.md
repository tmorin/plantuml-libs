...
```text
aws-q3-2022/Architecture/Database/AmazonKeyspaces
```

```text
include('aws-q3-2022/Architecture/Database/AmazonKeyspaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Database/AmazonKeyspaces.png) | ![illustration for AmazonKeyspaces](../../../aws-q3-2022/Architecture/Database/AmazonKeyspaces.Local.png) | ![illustration for AmazonKeyspacesCard](../../../aws-q3-2022/Architecture/Database/AmazonKeyspacesCard.Local.png) | ![illustration for AmazonKeyspacesGroup](../../../aws-q3-2022/Architecture/Database/AmazonKeyspacesGroup.Local.png) |
