...
```text
aws-q3-2022/Architecture/Database/AmazonTimestream
```

```text
include('aws-q3-2022/Architecture/Database/AmazonTimestream')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Database/AmazonTimestream.png) | ![illustration for AmazonTimestream](../../../aws-q3-2022/Architecture/Database/AmazonTimestream.Local.png) | ![illustration for AmazonTimestreamCard](../../../aws-q3-2022/Architecture/Database/AmazonTimestreamCard.Local.png) | ![illustration for AmazonTimestreamGroup](../../../aws-q3-2022/Architecture/Database/AmazonTimestreamGroup.Local.png) |
