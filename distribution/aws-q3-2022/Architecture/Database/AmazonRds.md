...
```text
aws-q3-2022/Architecture/Database/AmazonRds
```

```text
include('aws-q3-2022/Architecture/Database/AmazonRds')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Database/AmazonRds.png) | ![illustration for AmazonRds](../../../aws-q3-2022/Architecture/Database/AmazonRds.Local.png) | ![illustration for AmazonRdsCard](../../../aws-q3-2022/Architecture/Database/AmazonRdsCard.Local.png) | ![illustration for AmazonRdsGroup](../../../aws-q3-2022/Architecture/Database/AmazonRdsGroup.Local.png) |
