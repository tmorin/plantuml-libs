...
```text
aws-q3-2022/Architecture/Database/AmazonRdsOnVMware
```

```text
include('aws-q3-2022/Architecture/Database/AmazonRdsOnVMware')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Database/AmazonRdsOnVMware.png) | ![illustration for AmazonRdsOnVMware](../../../aws-q3-2022/Architecture/Database/AmazonRdsOnVMware.Local.png) | ![illustration for AmazonRdsOnVMwareCard](../../../aws-q3-2022/Architecture/Database/AmazonRdsOnVMwareCard.Local.png) | ![illustration for AmazonRdsOnVMwareGroup](../../../aws-q3-2022/Architecture/Database/AmazonRdsOnVMwareGroup.Local.png) |
