...
```text
aws-q3-2022/Architecture/Robotics/AwsRoboMaker
```

```text
include('aws-q3-2022/Architecture/Robotics/AwsRoboMaker')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Robotics/AwsRoboMaker.png) | ![illustration for AwsRoboMaker](../../../aws-q3-2022/Architecture/Robotics/AwsRoboMaker.Local.png) | ![illustration for AwsRoboMakerCard](../../../aws-q3-2022/Architecture/Robotics/AwsRoboMakerCard.Local.png) | ![illustration for AwsRoboMakerGroup](../../../aws-q3-2022/Architecture/Robotics/AwsRoboMakerGroup.Local.png) |
