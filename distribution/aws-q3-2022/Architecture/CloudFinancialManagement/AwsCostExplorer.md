...
```text
aws-q3-2022/Architecture/CloudFinancialManagement/AwsCostExplorer
```

```text
include('aws-q3-2022/Architecture/CloudFinancialManagement/AwsCostExplorer')
```
