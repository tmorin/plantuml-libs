...
```text
aws-q3-2022/Architecture/CloudFinancialManagement/AwsApplicationCostProfiler
```

```text
include('aws-q3-2022/Architecture/CloudFinancialManagement/AwsApplicationCostProfiler')
```
