...
```text
aws-q3-2022/Architecture/VrAr/AmazonSumerian
```

```text
include('aws-q3-2022/Architecture/VrAr/AmazonSumerian')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/VrAr/AmazonSumerian.png) | ![illustration for AmazonSumerian](../../../aws-q3-2022/Architecture/VrAr/AmazonSumerian.Local.png) | ![illustration for AmazonSumerianCard](../../../aws-q3-2022/Architecture/VrAr/AmazonSumerianCard.Local.png) | ![illustration for AmazonSumerianGroup](../../../aws-q3-2022/Architecture/VrAr/AmazonSumerianGroup.Local.png) |
