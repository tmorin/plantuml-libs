...
```text
aws-q3-2022/Architecture/Containers/RedHatOpenShift
```

```text
include('aws-q3-2022/Architecture/Containers/RedHatOpenShift')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Containers/RedHatOpenShift.png) | ![illustration for RedHatOpenShift](../../../aws-q3-2022/Architecture/Containers/RedHatOpenShift.Local.png) | ![illustration for RedHatOpenShiftCard](../../../aws-q3-2022/Architecture/Containers/RedHatOpenShiftCard.Local.png) | ![illustration for RedHatOpenShiftGroup](../../../aws-q3-2022/Architecture/Containers/RedHatOpenShiftGroup.Local.png) |
