...
```text
aws-q3-2022/Architecture/Containers/AwsFargate
```

```text
include('aws-q3-2022/Architecture/Containers/AwsFargate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Containers/AwsFargate.png) | ![illustration for AwsFargate](../../../aws-q3-2022/Architecture/Containers/AwsFargate.Local.png) | ![illustration for AwsFargateCard](../../../aws-q3-2022/Architecture/Containers/AwsFargateCard.Local.png) | ![illustration for AwsFargateGroup](../../../aws-q3-2022/Architecture/Containers/AwsFargateGroup.Local.png) |
