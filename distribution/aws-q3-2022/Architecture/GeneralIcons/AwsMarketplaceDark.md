...
```text
aws-q3-2022/Architecture/GeneralIcons/AwsMarketplaceDark
```

```text
include('aws-q3-2022/Architecture/GeneralIcons/AwsMarketplaceDark')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/GeneralIcons/AwsMarketplaceDark.png) | ![illustration for AwsMarketplaceDark](../../../aws-q3-2022/Architecture/GeneralIcons/AwsMarketplaceDark.Local.png) | ![illustration for AwsMarketplaceDarkCard](../../../aws-q3-2022/Architecture/GeneralIcons/AwsMarketplaceDarkCard.Local.png) | ![illustration for AwsMarketplaceDarkGroup](../../../aws-q3-2022/Architecture/GeneralIcons/AwsMarketplaceDarkGroup.Local.png) |
