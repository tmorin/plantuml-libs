...
```text
aws-q3-2022/Architecture/Analytics/AwsGlueDataBrew
```

```text
include('aws-q3-2022/Architecture/Analytics/AwsGlueDataBrew')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Analytics/AwsGlueDataBrew.png) | ![illustration for AwsGlueDataBrew](../../../aws-q3-2022/Architecture/Analytics/AwsGlueDataBrew.Local.png) | ![illustration for AwsGlueDataBrewCard](../../../aws-q3-2022/Architecture/Analytics/AwsGlueDataBrewCard.Local.png) | ![illustration for AwsGlueDataBrewGroup](../../../aws-q3-2022/Architecture/Analytics/AwsGlueDataBrewGroup.Local.png) |
