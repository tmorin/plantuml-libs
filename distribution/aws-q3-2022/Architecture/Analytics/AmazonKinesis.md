...
```text
aws-q3-2022/Architecture/Analytics/AmazonKinesis
```

```text
include('aws-q3-2022/Architecture/Analytics/AmazonKinesis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Analytics/AmazonKinesis.png) | ![illustration for AmazonKinesis](../../../aws-q3-2022/Architecture/Analytics/AmazonKinesis.Local.png) | ![illustration for AmazonKinesisCard](../../../aws-q3-2022/Architecture/Analytics/AmazonKinesisCard.Local.png) | ![illustration for AmazonKinesisGroup](../../../aws-q3-2022/Architecture/Analytics/AmazonKinesisGroup.Local.png) |
