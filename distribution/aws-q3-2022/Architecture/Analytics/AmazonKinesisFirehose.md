...
```text
aws-q3-2022/Architecture/Analytics/AmazonKinesisFirehose
```

```text
include('aws-q3-2022/Architecture/Analytics/AmazonKinesisFirehose')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Analytics/AmazonKinesisFirehose.png) | ![illustration for AmazonKinesisFirehose](../../../aws-q3-2022/Architecture/Analytics/AmazonKinesisFirehose.Local.png) | ![illustration for AmazonKinesisFirehoseCard](../../../aws-q3-2022/Architecture/Analytics/AmazonKinesisFirehoseCard.Local.png) | ![illustration for AmazonKinesisFirehoseGroup](../../../aws-q3-2022/Architecture/Analytics/AmazonKinesisFirehoseGroup.Local.png) |
