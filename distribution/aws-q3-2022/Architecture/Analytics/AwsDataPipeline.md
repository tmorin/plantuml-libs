...
```text
aws-q3-2022/Architecture/Analytics/AwsDataPipeline
```

```text
include('aws-q3-2022/Architecture/Analytics/AwsDataPipeline')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Analytics/AwsDataPipeline.png) | ![illustration for AwsDataPipeline](../../../aws-q3-2022/Architecture/Analytics/AwsDataPipeline.Local.png) | ![illustration for AwsDataPipelineCard](../../../aws-q3-2022/Architecture/Analytics/AwsDataPipelineCard.Local.png) | ![illustration for AwsDataPipelineGroup](../../../aws-q3-2022/Architecture/Analytics/AwsDataPipelineGroup.Local.png) |
