...
```text
aws-q3-2022/Architecture/Analytics/AwsDataExchange
```

```text
include('aws-q3-2022/Architecture/Analytics/AwsDataExchange')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Analytics/AwsDataExchange.png) | ![illustration for AwsDataExchange](../../../aws-q3-2022/Architecture/Analytics/AwsDataExchange.Local.png) | ![illustration for AwsDataExchangeCard](../../../aws-q3-2022/Architecture/Analytics/AwsDataExchangeCard.Local.png) | ![illustration for AwsDataExchangeGroup](../../../aws-q3-2022/Architecture/Analytics/AwsDataExchangeGroup.Local.png) |
