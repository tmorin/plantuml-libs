...
```text
aws-q3-2022/Architecture/Analytics/AmazonQuickSight
```

```text
include('aws-q3-2022/Architecture/Analytics/AmazonQuickSight')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/Analytics/AmazonQuickSight.png) | ![illustration for AmazonQuickSight](../../../aws-q3-2022/Architecture/Analytics/AmazonQuickSight.Local.png) | ![illustration for AmazonQuickSightCard](../../../aws-q3-2022/Architecture/Analytics/AmazonQuickSightCard.Local.png) | ![illustration for AmazonQuickSightGroup](../../../aws-q3-2022/Architecture/Analytics/AmazonQuickSightGroup.Local.png) |
