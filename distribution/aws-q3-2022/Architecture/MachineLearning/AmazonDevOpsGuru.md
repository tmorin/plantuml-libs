...
```text
aws-q3-2022/Architecture/MachineLearning/AmazonDevOpsGuru
```

```text
include('aws-q3-2022/Architecture/MachineLearning/AmazonDevOpsGuru')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/MachineLearning/AmazonDevOpsGuru.png) | ![illustration for AmazonDevOpsGuru](../../../aws-q3-2022/Architecture/MachineLearning/AmazonDevOpsGuru.Local.png) | ![illustration for AmazonDevOpsGuruCard](../../../aws-q3-2022/Architecture/MachineLearning/AmazonDevOpsGuruCard.Local.png) | ![illustration for AmazonDevOpsGuruGroup](../../../aws-q3-2022/Architecture/MachineLearning/AmazonDevOpsGuruGroup.Local.png) |
