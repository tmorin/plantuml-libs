...
```text
aws-q3-2022/Architecture/MachineLearning/AmazonMonitron
```

```text
include('aws-q3-2022/Architecture/MachineLearning/AmazonMonitron')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/MachineLearning/AmazonMonitron.png) | ![illustration for AmazonMonitron](../../../aws-q3-2022/Architecture/MachineLearning/AmazonMonitron.Local.png) | ![illustration for AmazonMonitronCard](../../../aws-q3-2022/Architecture/MachineLearning/AmazonMonitronCard.Local.png) | ![illustration for AmazonMonitronGroup](../../../aws-q3-2022/Architecture/MachineLearning/AmazonMonitronGroup.Local.png) |
