...
```text
aws-q3-2022/Architecture/MachineLearning/AmazonKendra
```

```text
include('aws-q3-2022/Architecture/MachineLearning/AmazonKendra')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/MachineLearning/AmazonKendra.png) | ![illustration for AmazonKendra](../../../aws-q3-2022/Architecture/MachineLearning/AmazonKendra.Local.png) | ![illustration for AmazonKendraCard](../../../aws-q3-2022/Architecture/MachineLearning/AmazonKendraCard.Local.png) | ![illustration for AmazonKendraGroup](../../../aws-q3-2022/Architecture/MachineLearning/AmazonKendraGroup.Local.png) |
