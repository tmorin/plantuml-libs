...
```text
aws-q3-2022/Architecture/MachineLearning/AwsDeepLens
```

```text
include('aws-q3-2022/Architecture/MachineLearning/AwsDeepLens')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/MachineLearning/AwsDeepLens.png) | ![illustration for AwsDeepLens](../../../aws-q3-2022/Architecture/MachineLearning/AwsDeepLens.Local.png) | ![illustration for AwsDeepLensCard](../../../aws-q3-2022/Architecture/MachineLearning/AwsDeepLensCard.Local.png) | ![illustration for AwsDeepLensGroup](../../../aws-q3-2022/Architecture/MachineLearning/AwsDeepLensGroup.Local.png) |
