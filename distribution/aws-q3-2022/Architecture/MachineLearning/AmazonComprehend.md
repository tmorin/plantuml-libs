...
```text
aws-q3-2022/Architecture/MachineLearning/AmazonComprehend
```

```text
include('aws-q3-2022/Architecture/MachineLearning/AmazonComprehend')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/MachineLearning/AmazonComprehend.png) | ![illustration for AmazonComprehend](../../../aws-q3-2022/Architecture/MachineLearning/AmazonComprehend.Local.png) | ![illustration for AmazonComprehendCard](../../../aws-q3-2022/Architecture/MachineLearning/AmazonComprehendCard.Local.png) | ![illustration for AmazonComprehendGroup](../../../aws-q3-2022/Architecture/MachineLearning/AmazonComprehendGroup.Local.png) |
