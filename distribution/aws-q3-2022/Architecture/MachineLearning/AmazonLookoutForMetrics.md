...
```text
aws-q3-2022/Architecture/MachineLearning/AmazonLookoutForMetrics
```

```text
include('aws-q3-2022/Architecture/MachineLearning/AmazonLookoutForMetrics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/MachineLearning/AmazonLookoutForMetrics.png) | ![illustration for AmazonLookoutForMetrics](../../../aws-q3-2022/Architecture/MachineLearning/AmazonLookoutForMetrics.Local.png) | ![illustration for AmazonLookoutForMetricsCard](../../../aws-q3-2022/Architecture/MachineLearning/AmazonLookoutForMetricsCard.Local.png) | ![illustration for AmazonLookoutForMetricsGroup](../../../aws-q3-2022/Architecture/MachineLearning/AmazonLookoutForMetricsGroup.Local.png) |
