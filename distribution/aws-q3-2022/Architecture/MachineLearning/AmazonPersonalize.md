...
```text
aws-q3-2022/Architecture/MachineLearning/AmazonPersonalize
```

```text
include('aws-q3-2022/Architecture/MachineLearning/AmazonPersonalize')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/MachineLearning/AmazonPersonalize.png) | ![illustration for AmazonPersonalize](../../../aws-q3-2022/Architecture/MachineLearning/AmazonPersonalize.Local.png) | ![illustration for AmazonPersonalizeCard](../../../aws-q3-2022/Architecture/MachineLearning/AmazonPersonalizeCard.Local.png) | ![illustration for AmazonPersonalizeGroup](../../../aws-q3-2022/Architecture/MachineLearning/AmazonPersonalizeGroup.Local.png) |
