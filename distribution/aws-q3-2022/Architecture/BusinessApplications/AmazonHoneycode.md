...
```text
aws-q3-2022/Architecture/BusinessApplications/AmazonHoneycode
```

```text
include('aws-q3-2022/Architecture/BusinessApplications/AmazonHoneycode')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/BusinessApplications/AmazonHoneycode.png) | ![illustration for AmazonHoneycode](../../../aws-q3-2022/Architecture/BusinessApplications/AmazonHoneycode.Local.png) | ![illustration for AmazonHoneycodeCard](../../../aws-q3-2022/Architecture/BusinessApplications/AmazonHoneycodeCard.Local.png) | ![illustration for AmazonHoneycodeGroup](../../../aws-q3-2022/Architecture/BusinessApplications/AmazonHoneycodeGroup.Local.png) |
