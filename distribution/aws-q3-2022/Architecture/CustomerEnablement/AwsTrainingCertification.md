...
```text
aws-q3-2022/Architecture/CustomerEnablement/AwsTrainingCertification
```

```text
include('aws-q3-2022/Architecture/CustomerEnablement/AwsTrainingCertification')
```
