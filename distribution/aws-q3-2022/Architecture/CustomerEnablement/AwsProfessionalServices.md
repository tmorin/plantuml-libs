...
```text
aws-q3-2022/Architecture/CustomerEnablement/AwsProfessionalServices
```

```text
include('aws-q3-2022/Architecture/CustomerEnablement/AwsProfessionalServices')
```
