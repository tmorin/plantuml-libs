...
```text
aws-q3-2022/Architecture/CustomerEnablement/AwsManagedServices
```

```text
include('aws-q3-2022/Architecture/CustomerEnablement/AwsManagedServices')
```
