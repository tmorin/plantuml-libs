...
```text
aws-q3-2022/Architecture/MediaServices/AwsElementalMediaConvert
```

```text
include('aws-q3-2022/Architecture/MediaServices/AwsElementalMediaConvert')
```
