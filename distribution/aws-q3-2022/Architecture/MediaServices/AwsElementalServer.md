...
```text
aws-q3-2022/Architecture/MediaServices/AwsElementalServer
```

```text
include('aws-q3-2022/Architecture/MediaServices/AwsElementalServer')
```
