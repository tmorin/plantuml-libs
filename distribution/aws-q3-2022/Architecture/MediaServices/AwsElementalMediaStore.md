...
```text
aws-q3-2022/Architecture/MediaServices/AwsElementalMediaStore
```

```text
include('aws-q3-2022/Architecture/MediaServices/AwsElementalMediaStore')
```
