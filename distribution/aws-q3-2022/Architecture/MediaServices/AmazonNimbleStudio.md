...
```text
aws-q3-2022/Architecture/MediaServices/AmazonNimbleStudio
```

```text
include('aws-q3-2022/Architecture/MediaServices/AmazonNimbleStudio')
```
