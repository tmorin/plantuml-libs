...
```text
aws-q3-2022/Architecture/MediaServices/AwsElementalConductor
```

```text
include('aws-q3-2022/Architecture/MediaServices/AwsElementalConductor')
```
