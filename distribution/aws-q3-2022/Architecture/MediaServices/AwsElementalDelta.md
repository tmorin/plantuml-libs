...
```text
aws-q3-2022/Architecture/MediaServices/AwsElementalDelta
```

```text
include('aws-q3-2022/Architecture/MediaServices/AwsElementalDelta')
```
