...
```text
aws-q3-2022/Architecture/MediaServices/AwsElementalAppliancesSoftware
```

```text
include('aws-q3-2022/Architecture/MediaServices/AwsElementalAppliancesSoftware')
```
