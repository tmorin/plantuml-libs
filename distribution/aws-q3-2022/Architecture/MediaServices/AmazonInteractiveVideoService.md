...
```text
aws-q3-2022/Architecture/MediaServices/AmazonInteractiveVideoService
```

```text
include('aws-q3-2022/Architecture/MediaServices/AmazonInteractiveVideoService')
```
