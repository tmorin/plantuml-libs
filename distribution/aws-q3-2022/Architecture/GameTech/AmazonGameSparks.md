...
```text
aws-q3-2022/Architecture/GameTech/AmazonGameSparks
```

```text
include('aws-q3-2022/Architecture/GameTech/AmazonGameSparks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Architecture/GameTech/AmazonGameSparks.png) | ![illustration for AmazonGameSparks](../../../aws-q3-2022/Architecture/GameTech/AmazonGameSparks.Local.png) | ![illustration for AmazonGameSparksCard](../../../aws-q3-2022/Architecture/GameTech/AmazonGameSparksCard.Local.png) | ![illustration for AmazonGameSparksGroup](../../../aws-q3-2022/Architecture/GameTech/AmazonGameSparksGroup.Local.png) |
