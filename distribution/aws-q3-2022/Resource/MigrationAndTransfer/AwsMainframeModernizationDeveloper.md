...
```text
aws-q3-2022/Resource/MigrationAndTransfer/AwsMainframeModernizationDeveloper
```

```text
include('aws-q3-2022/Resource/MigrationAndTransfer/AwsMainframeModernizationDeveloper')
```
