...
```text
aws-q3-2022/Resource/MigrationAndTransfer/AwsMainframeModernizationCompiler
```

```text
include('aws-q3-2022/Resource/MigrationAndTransfer/AwsMainframeModernizationCompiler')
```
