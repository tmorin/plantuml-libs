...
```text
aws-q3-2022/Resource/MigrationAndTransfer/AwsMigrationHubRefactorSpacesServices
```

```text
include('aws-q3-2022/Resource/MigrationAndTransfer/AwsMigrationHubRefactorSpacesServices')
```
