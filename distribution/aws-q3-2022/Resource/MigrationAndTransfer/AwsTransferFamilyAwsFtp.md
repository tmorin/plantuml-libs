...
```text
aws-q3-2022/Resource/MigrationAndTransfer/AwsTransferFamilyAwsFtp
```

```text
include('aws-q3-2022/Resource/MigrationAndTransfer/AwsTransferFamilyAwsFtp')
```
