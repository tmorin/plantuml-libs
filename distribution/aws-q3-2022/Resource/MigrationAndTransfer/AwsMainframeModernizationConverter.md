...
```text
aws-q3-2022/Resource/MigrationAndTransfer/AwsMainframeModernizationConverter
```

```text
include('aws-q3-2022/Resource/MigrationAndTransfer/AwsMainframeModernizationConverter')
```
