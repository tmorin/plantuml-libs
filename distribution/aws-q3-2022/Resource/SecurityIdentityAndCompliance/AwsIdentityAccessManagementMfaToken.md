...
```text
aws-q3-2022/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementMfaToken
```

```text
include('aws-q3-2022/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementMfaToken')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementMfaToken.png) | ![illustration for AwsIdentityAccessManagementMfaToken](../../../aws-q3-2022/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementMfaToken.Local.png) | ![illustration for AwsIdentityAccessManagementMfaTokenCard](../../../aws-q3-2022/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementMfaTokenCard.Local.png) | ![illustration for AwsIdentityAccessManagementMfaTokenGroup](../../../aws-q3-2022/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementMfaTokenGroup.Local.png) |
