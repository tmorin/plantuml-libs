...
```text
aws-q3-2022/Resource/Database/AmazonRdsMultiAz
```

```text
include('aws-q3-2022/Resource/Database/AmazonRdsMultiAz')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Database/AmazonRdsMultiAz.png) | ![illustration for AmazonRdsMultiAz](../../../aws-q3-2022/Resource/Database/AmazonRdsMultiAz.Local.png) | ![illustration for AmazonRdsMultiAzCard](../../../aws-q3-2022/Resource/Database/AmazonRdsMultiAzCard.Local.png) | ![illustration for AmazonRdsMultiAzGroup](../../../aws-q3-2022/Resource/Database/AmazonRdsMultiAzGroup.Local.png) |
