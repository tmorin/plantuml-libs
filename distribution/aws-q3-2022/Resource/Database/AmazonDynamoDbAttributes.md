...
```text
aws-q3-2022/Resource/Database/AmazonDynamoDbAttributes
```

```text
include('aws-q3-2022/Resource/Database/AmazonDynamoDbAttributes')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Database/AmazonDynamoDbAttributes.png) | ![illustration for AmazonDynamoDbAttributes](../../../aws-q3-2022/Resource/Database/AmazonDynamoDbAttributes.Local.png) | ![illustration for AmazonDynamoDbAttributesCard](../../../aws-q3-2022/Resource/Database/AmazonDynamoDbAttributesCard.Local.png) | ![illustration for AmazonDynamoDbAttributesGroup](../../../aws-q3-2022/Resource/Database/AmazonDynamoDbAttributesGroup.Local.png) |
