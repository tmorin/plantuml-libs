...
```text
aws-q3-2022/Resource/Database/AmazonAuroraMySqlInstance
```

```text
include('aws-q3-2022/Resource/Database/AmazonAuroraMySqlInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Database/AmazonAuroraMySqlInstance.png) | ![illustration for AmazonAuroraMySqlInstance](../../../aws-q3-2022/Resource/Database/AmazonAuroraMySqlInstance.Local.png) | ![illustration for AmazonAuroraMySqlInstanceCard](../../../aws-q3-2022/Resource/Database/AmazonAuroraMySqlInstanceCard.Local.png) | ![illustration for AmazonAuroraMySqlInstanceGroup](../../../aws-q3-2022/Resource/Database/AmazonAuroraMySqlInstanceGroup.Local.png) |
