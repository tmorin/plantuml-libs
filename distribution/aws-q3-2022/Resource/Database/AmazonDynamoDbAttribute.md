...
```text
aws-q3-2022/Resource/Database/AmazonDynamoDbAttribute
```

```text
include('aws-q3-2022/Resource/Database/AmazonDynamoDbAttribute')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Database/AmazonDynamoDbAttribute.png) | ![illustration for AmazonDynamoDbAttribute](../../../aws-q3-2022/Resource/Database/AmazonDynamoDbAttribute.Local.png) | ![illustration for AmazonDynamoDbAttributeCard](../../../aws-q3-2022/Resource/Database/AmazonDynamoDbAttributeCard.Local.png) | ![illustration for AmazonDynamoDbAttributeGroup](../../../aws-q3-2022/Resource/Database/AmazonDynamoDbAttributeGroup.Local.png) |
