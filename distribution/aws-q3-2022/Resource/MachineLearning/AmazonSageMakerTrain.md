...
```text
aws-q3-2022/Resource/MachineLearning/AmazonSageMakerTrain
```

```text
include('aws-q3-2022/Resource/MachineLearning/AmazonSageMakerTrain')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/MachineLearning/AmazonSageMakerTrain.png) | ![illustration for AmazonSageMakerTrain](../../../aws-q3-2022/Resource/MachineLearning/AmazonSageMakerTrain.Local.png) | ![illustration for AmazonSageMakerTrainCard](../../../aws-q3-2022/Resource/MachineLearning/AmazonSageMakerTrainCard.Local.png) | ![illustration for AmazonSageMakerTrainGroup](../../../aws-q3-2022/Resource/MachineLearning/AmazonSageMakerTrainGroup.Local.png) |
