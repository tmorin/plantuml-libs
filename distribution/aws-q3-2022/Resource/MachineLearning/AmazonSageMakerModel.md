...
```text
aws-q3-2022/Resource/MachineLearning/AmazonSageMakerModel
```

```text
include('aws-q3-2022/Resource/MachineLearning/AmazonSageMakerModel')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/MachineLearning/AmazonSageMakerModel.png) | ![illustration for AmazonSageMakerModel](../../../aws-q3-2022/Resource/MachineLearning/AmazonSageMakerModel.Local.png) | ![illustration for AmazonSageMakerModelCard](../../../aws-q3-2022/Resource/MachineLearning/AmazonSageMakerModelCard.Local.png) | ![illustration for AmazonSageMakerModelGroup](../../../aws-q3-2022/Resource/MachineLearning/AmazonSageMakerModelGroup.Local.png) |
