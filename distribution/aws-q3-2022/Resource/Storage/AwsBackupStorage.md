...
```text
aws-q3-2022/Resource/Storage/AwsBackupStorage
```

```text
include('aws-q3-2022/Resource/Storage/AwsBackupStorage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Storage/AwsBackupStorage.png) | ![illustration for AwsBackupStorage](../../../aws-q3-2022/Resource/Storage/AwsBackupStorage.Local.png) | ![illustration for AwsBackupStorageCard](../../../aws-q3-2022/Resource/Storage/AwsBackupStorageCard.Local.png) | ![illustration for AwsBackupStorageGroup](../../../aws-q3-2022/Resource/Storage/AwsBackupStorageGroup.Local.png) |
