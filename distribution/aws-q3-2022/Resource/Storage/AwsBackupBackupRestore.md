...
```text
aws-q3-2022/Resource/Storage/AwsBackupBackupRestore
```

```text
include('aws-q3-2022/Resource/Storage/AwsBackupBackupRestore')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Storage/AwsBackupBackupRestore.png) | ![illustration for AwsBackupBackupRestore](../../../aws-q3-2022/Resource/Storage/AwsBackupBackupRestore.Local.png) | ![illustration for AwsBackupBackupRestoreCard](../../../aws-q3-2022/Resource/Storage/AwsBackupBackupRestoreCard.Local.png) | ![illustration for AwsBackupBackupRestoreGroup](../../../aws-q3-2022/Resource/Storage/AwsBackupBackupRestoreGroup.Local.png) |
