...
```text
aws-q3-2022/Resource/Storage/AwsBackupBackupPlan
```

```text
include('aws-q3-2022/Resource/Storage/AwsBackupBackupPlan')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Storage/AwsBackupBackupPlan.png) | ![illustration for AwsBackupBackupPlan](../../../aws-q3-2022/Resource/Storage/AwsBackupBackupPlan.Local.png) | ![illustration for AwsBackupBackupPlanCard](../../../aws-q3-2022/Resource/Storage/AwsBackupBackupPlanCard.Local.png) | ![illustration for AwsBackupBackupPlanGroup](../../../aws-q3-2022/Resource/Storage/AwsBackupBackupPlanGroup.Local.png) |
