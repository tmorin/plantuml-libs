...
```text
aws-q3-2022/Resource/Storage/AwsBackupCompute
```

```text
include('aws-q3-2022/Resource/Storage/AwsBackupCompute')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Storage/AwsBackupCompute.png) | ![illustration for AwsBackupCompute](../../../aws-q3-2022/Resource/Storage/AwsBackupCompute.Local.png) | ![illustration for AwsBackupComputeCard](../../../aws-q3-2022/Resource/Storage/AwsBackupComputeCard.Local.png) | ![illustration for AwsBackupComputeGroup](../../../aws-q3-2022/Resource/Storage/AwsBackupComputeGroup.Local.png) |
