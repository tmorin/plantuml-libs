...
```text
aws-q3-2022/Resource/Storage/AwsStorageGatewayNoncachedVolume
```

```text
include('aws-q3-2022/Resource/Storage/AwsStorageGatewayNoncachedVolume')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Storage/AwsStorageGatewayNoncachedVolume.png) | ![illustration for AwsStorageGatewayNoncachedVolume](../../../aws-q3-2022/Resource/Storage/AwsStorageGatewayNoncachedVolume.Local.png) | ![illustration for AwsStorageGatewayNoncachedVolumeCard](../../../aws-q3-2022/Resource/Storage/AwsStorageGatewayNoncachedVolumeCard.Local.png) | ![illustration for AwsStorageGatewayNoncachedVolumeGroup](../../../aws-q3-2022/Resource/Storage/AwsStorageGatewayNoncachedVolumeGroup.Local.png) |
