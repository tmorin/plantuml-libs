...
```text
aws-q3-2022/Resource/Storage/AmazonElasticBlockStoreVolume
```

```text
include('aws-q3-2022/Resource/Storage/AmazonElasticBlockStoreVolume')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Storage/AmazonElasticBlockStoreVolume.png) | ![illustration for AmazonElasticBlockStoreVolume](../../../aws-q3-2022/Resource/Storage/AmazonElasticBlockStoreVolume.Local.png) | ![illustration for AmazonElasticBlockStoreVolumeCard](../../../aws-q3-2022/Resource/Storage/AmazonElasticBlockStoreVolumeCard.Local.png) | ![illustration for AmazonElasticBlockStoreVolumeGroup](../../../aws-q3-2022/Resource/Storage/AmazonElasticBlockStoreVolumeGroup.Local.png) |
