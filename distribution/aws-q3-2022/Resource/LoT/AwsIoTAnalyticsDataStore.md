...
```text
aws-q3-2022/Resource/LoT/AwsIoTAnalyticsDataStore
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTAnalyticsDataStore')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTAnalyticsDataStore.png) | ![illustration for AwsIoTAnalyticsDataStore](../../../aws-q3-2022/Resource/LoT/AwsIoTAnalyticsDataStore.Local.png) | ![illustration for AwsIoTAnalyticsDataStoreCard](../../../aws-q3-2022/Resource/LoT/AwsIoTAnalyticsDataStoreCard.Local.png) | ![illustration for AwsIoTAnalyticsDataStoreGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTAnalyticsDataStoreGroup.Local.png) |
