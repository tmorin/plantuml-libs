...
```text
aws-q3-2022/Resource/LoT/AwsIoTFireTvStick
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTFireTvStick')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTFireTvStick.png) | ![illustration for AwsIoTFireTvStick](../../../aws-q3-2022/Resource/LoT/AwsIoTFireTvStick.Local.png) | ![illustration for AwsIoTFireTvStickCard](../../../aws-q3-2022/Resource/LoT/AwsIoTFireTvStickCard.Local.png) | ![illustration for AwsIoTFireTvStickGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTFireTvStickGroup.Local.png) |
