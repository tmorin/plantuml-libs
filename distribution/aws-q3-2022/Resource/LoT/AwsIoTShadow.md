...
```text
aws-q3-2022/Resource/LoT/AwsIoTShadow
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTShadow')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTShadow.png) | ![illustration for AwsIoTShadow](../../../aws-q3-2022/Resource/LoT/AwsIoTShadow.Local.png) | ![illustration for AwsIoTShadowCard](../../../aws-q3-2022/Resource/LoT/AwsIoTShadowCard.Local.png) | ![illustration for AwsIoTShadowGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTShadowGroup.Local.png) |
