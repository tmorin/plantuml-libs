...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingWindfarm
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingWindfarm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingWindfarm.png) | ![illustration for AwsIoTThingWindfarm](../../../aws-q3-2022/Resource/LoT/AwsIoTThingWindfarm.Local.png) | ![illustration for AwsIoTThingWindfarmCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingWindfarmCard.Local.png) | ![illustration for AwsIoTThingWindfarmGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingWindfarmGroup.Local.png) |
