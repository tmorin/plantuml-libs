...
```text
aws-q3-2022/Resource/LoT/AwsIoTGreengrassStreamManager
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTGreengrassStreamManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTGreengrassStreamManager.png) | ![illustration for AwsIoTGreengrassStreamManager](../../../aws-q3-2022/Resource/LoT/AwsIoTGreengrassStreamManager.Local.png) | ![illustration for AwsIoTGreengrassStreamManagerCard](../../../aws-q3-2022/Resource/LoT/AwsIoTGreengrassStreamManagerCard.Local.png) | ![illustration for AwsIoTGreengrassStreamManagerGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTGreengrassStreamManagerGroup.Local.png) |
