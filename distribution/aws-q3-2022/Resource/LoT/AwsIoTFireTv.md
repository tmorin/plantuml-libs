...
```text
aws-q3-2022/Resource/LoT/AwsIoTFireTv
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTFireTv')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTFireTv.png) | ![illustration for AwsIoTFireTv](../../../aws-q3-2022/Resource/LoT/AwsIoTFireTv.Local.png) | ![illustration for AwsIoTFireTvCard](../../../aws-q3-2022/Resource/LoT/AwsIoTFireTvCard.Local.png) | ![illustration for AwsIoTFireTvGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTFireTvGroup.Local.png) |
