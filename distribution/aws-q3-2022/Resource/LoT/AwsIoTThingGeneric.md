...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingGeneric
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingGeneric')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingGeneric.png) | ![illustration for AwsIoTThingGeneric](../../../aws-q3-2022/Resource/LoT/AwsIoTThingGeneric.Local.png) | ![illustration for AwsIoTThingGenericCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingGenericCard.Local.png) | ![illustration for AwsIoTThingGenericGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingGenericGroup.Local.png) |
