...
```text
aws-q3-2022/Resource/LoT/AwsIoTAlexaEnabledDevice
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTAlexaEnabledDevice')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTAlexaEnabledDevice.png) | ![illustration for AwsIoTAlexaEnabledDevice](../../../aws-q3-2022/Resource/LoT/AwsIoTAlexaEnabledDevice.Local.png) | ![illustration for AwsIoTAlexaEnabledDeviceCard](../../../aws-q3-2022/Resource/LoT/AwsIoTAlexaEnabledDeviceCard.Local.png) | ![illustration for AwsIoTAlexaEnabledDeviceGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTAlexaEnabledDeviceGroup.Local.png) |
