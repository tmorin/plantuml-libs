...
```text
aws-q3-2022/Resource/LoT/AwsIoTReportedState
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTReportedState')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTReportedState.png) | ![illustration for AwsIoTReportedState](../../../aws-q3-2022/Resource/LoT/AwsIoTReportedState.Local.png) | ![illustration for AwsIoTReportedStateCard](../../../aws-q3-2022/Resource/LoT/AwsIoTReportedStateCard.Local.png) | ![illustration for AwsIoTReportedStateGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTReportedStateGroup.Local.png) |
