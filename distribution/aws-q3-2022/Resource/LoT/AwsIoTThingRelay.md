...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingRelay
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingRelay')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingRelay.png) | ![illustration for AwsIoTThingRelay](../../../aws-q3-2022/Resource/LoT/AwsIoTThingRelay.Local.png) | ![illustration for AwsIoTThingRelayCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingRelayCard.Local.png) | ![illustration for AwsIoTThingRelayGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingRelayGroup.Local.png) |
