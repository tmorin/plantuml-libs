...
```text
aws-q3-2022/Resource/LoT/AwsIoTAlexaSkill
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTAlexaSkill')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTAlexaSkill.png) | ![illustration for AwsIoTAlexaSkill](../../../aws-q3-2022/Resource/LoT/AwsIoTAlexaSkill.Local.png) | ![illustration for AwsIoTAlexaSkillCard](../../../aws-q3-2022/Resource/LoT/AwsIoTAlexaSkillCard.Local.png) | ![illustration for AwsIoTAlexaSkillGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTAlexaSkillGroup.Local.png) |
