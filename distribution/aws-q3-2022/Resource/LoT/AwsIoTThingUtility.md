...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingUtility
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingUtility')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingUtility.png) | ![illustration for AwsIoTThingUtility](../../../aws-q3-2022/Resource/LoT/AwsIoTThingUtility.Local.png) | ![illustration for AwsIoTThingUtilityCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingUtilityCard.Local.png) | ![illustration for AwsIoTThingUtilityGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingUtilityGroup.Local.png) |
