...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingTemperatureSensor
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingTemperatureSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingTemperatureSensor.png) | ![illustration for AwsIoTThingTemperatureSensor](../../../aws-q3-2022/Resource/LoT/AwsIoTThingTemperatureSensor.Local.png) | ![illustration for AwsIoTThingTemperatureSensorCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingTemperatureSensorCard.Local.png) | ![illustration for AwsIoTThingTemperatureSensorGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingTemperatureSensorGroup.Local.png) |
