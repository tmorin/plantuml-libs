...
```text
aws-q3-2022/Resource/LoT/AwsIoTDesiredState
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTDesiredState')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTDesiredState.png) | ![illustration for AwsIoTDesiredState](../../../aws-q3-2022/Resource/LoT/AwsIoTDesiredState.Local.png) | ![illustration for AwsIoTDesiredStateCard](../../../aws-q3-2022/Resource/LoT/AwsIoTDesiredStateCard.Local.png) | ![illustration for AwsIoTDesiredStateGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTDesiredStateGroup.Local.png) |
