...
```text
aws-q3-2022/Resource/LoT/AwsIoTAction
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTAction')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTAction.png) | ![illustration for AwsIoTAction](../../../aws-q3-2022/Resource/LoT/AwsIoTAction.Local.png) | ![illustration for AwsIoTActionCard](../../../aws-q3-2022/Resource/LoT/AwsIoTActionCard.Local.png) | ![illustration for AwsIoTActionGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTActionGroup.Local.png) |
