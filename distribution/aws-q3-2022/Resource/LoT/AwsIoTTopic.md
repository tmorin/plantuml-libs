...
```text
aws-q3-2022/Resource/LoT/AwsIoTTopic
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTTopic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTTopic.png) | ![illustration for AwsIoTTopic](../../../aws-q3-2022/Resource/LoT/AwsIoTTopic.Local.png) | ![illustration for AwsIoTTopicCard](../../../aws-q3-2022/Resource/LoT/AwsIoTTopicCard.Local.png) | ![illustration for AwsIoTTopicGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTTopicGroup.Local.png) |
