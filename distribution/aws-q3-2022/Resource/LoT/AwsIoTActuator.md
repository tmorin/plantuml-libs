...
```text
aws-q3-2022/Resource/LoT/AwsIoTActuator
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTActuator')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTActuator.png) | ![illustration for AwsIoTActuator](../../../aws-q3-2022/Resource/LoT/AwsIoTActuator.Local.png) | ![illustration for AwsIoTActuatorCard](../../../aws-q3-2022/Resource/LoT/AwsIoTActuatorCard.Local.png) | ![illustration for AwsIoTActuatorGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTActuatorGroup.Local.png) |
