...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingVibrationSensor
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingVibrationSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingVibrationSensor.png) | ![illustration for AwsIoTThingVibrationSensor](../../../aws-q3-2022/Resource/LoT/AwsIoTThingVibrationSensor.Local.png) | ![illustration for AwsIoTThingVibrationSensorCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingVibrationSensorCard.Local.png) | ![illustration for AwsIoTThingVibrationSensorGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingVibrationSensorGroup.Local.png) |
