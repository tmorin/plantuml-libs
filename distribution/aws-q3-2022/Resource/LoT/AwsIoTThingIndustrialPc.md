...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingIndustrialPc
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingIndustrialPc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingIndustrialPc.png) | ![illustration for AwsIoTThingIndustrialPc](../../../aws-q3-2022/Resource/LoT/AwsIoTThingIndustrialPc.Local.png) | ![illustration for AwsIoTThingIndustrialPcCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingIndustrialPcCard.Local.png) | ![illustration for AwsIoTThingIndustrialPcGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingIndustrialPcGroup.Local.png) |
