...
```text
aws-q3-2022/Resource/LoT/AwsIoTRule
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTRule')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTRule.png) | ![illustration for AwsIoTRule](../../../aws-q3-2022/Resource/LoT/AwsIoTRule.Local.png) | ![illustration for AwsIoTRuleCard](../../../aws-q3-2022/Resource/LoT/AwsIoTRuleCard.Local.png) | ![illustration for AwsIoTRuleGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTRuleGroup.Local.png) |
