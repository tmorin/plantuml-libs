...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingFreeRtosDevice
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingFreeRtosDevice')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingFreeRtosDevice.png) | ![illustration for AwsIoTThingFreeRtosDevice](../../../aws-q3-2022/Resource/LoT/AwsIoTThingFreeRtosDevice.Local.png) | ![illustration for AwsIoTThingFreeRtosDeviceCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingFreeRtosDeviceCard.Local.png) | ![illustration for AwsIoTThingFreeRtosDeviceGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingFreeRtosDeviceGroup.Local.png) |
