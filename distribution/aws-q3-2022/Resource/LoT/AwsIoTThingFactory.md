...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingFactory
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingFactory')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingFactory.png) | ![illustration for AwsIoTThingFactory](../../../aws-q3-2022/Resource/LoT/AwsIoTThingFactory.Local.png) | ![illustration for AwsIoTThingFactoryCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingFactoryCard.Local.png) | ![illustration for AwsIoTThingFactoryGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingFactoryGroup.Local.png) |
