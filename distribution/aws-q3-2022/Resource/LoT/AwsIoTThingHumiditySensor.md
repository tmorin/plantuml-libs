...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingHumiditySensor
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingHumiditySensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingHumiditySensor.png) | ![illustration for AwsIoTThingHumiditySensor](../../../aws-q3-2022/Resource/LoT/AwsIoTThingHumiditySensor.Local.png) | ![illustration for AwsIoTThingHumiditySensorCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingHumiditySensorCard.Local.png) | ![illustration for AwsIoTThingHumiditySensorGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingHumiditySensorGroup.Local.png) |
