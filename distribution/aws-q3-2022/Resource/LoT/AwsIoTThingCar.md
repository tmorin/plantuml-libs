...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingCar
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingCar')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingCar.png) | ![illustration for AwsIoTThingCar](../../../aws-q3-2022/Resource/LoT/AwsIoTThingCar.Local.png) | ![illustration for AwsIoTThingCarCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingCarCard.Local.png) | ![illustration for AwsIoTThingCarGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingCarGroup.Local.png) |
