...
```text
aws-q3-2022/Resource/LoT/AwsIoTThingCoffeePot
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTThingCoffeePot')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTThingCoffeePot.png) | ![illustration for AwsIoTThingCoffeePot](../../../aws-q3-2022/Resource/LoT/AwsIoTThingCoffeePot.Local.png) | ![illustration for AwsIoTThingCoffeePotCard](../../../aws-q3-2022/Resource/LoT/AwsIoTThingCoffeePotCard.Local.png) | ![illustration for AwsIoTThingCoffeePotGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTThingCoffeePotGroup.Local.png) |
