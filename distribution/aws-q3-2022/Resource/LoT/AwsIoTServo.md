...
```text
aws-q3-2022/Resource/LoT/AwsIoTServo
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTServo')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTServo.png) | ![illustration for AwsIoTServo](../../../aws-q3-2022/Resource/LoT/AwsIoTServo.Local.png) | ![illustration for AwsIoTServoCard](../../../aws-q3-2022/Resource/LoT/AwsIoTServoCard.Local.png) | ![illustration for AwsIoTServoGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTServoGroup.Local.png) |
