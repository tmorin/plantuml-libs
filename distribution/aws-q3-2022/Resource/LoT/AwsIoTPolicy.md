...
```text
aws-q3-2022/Resource/LoT/AwsIoTPolicy
```

```text
include('aws-q3-2022/Resource/LoT/AwsIoTPolicy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/LoT/AwsIoTPolicy.png) | ![illustration for AwsIoTPolicy](../../../aws-q3-2022/Resource/LoT/AwsIoTPolicy.Local.png) | ![illustration for AwsIoTPolicyCard](../../../aws-q3-2022/Resource/LoT/AwsIoTPolicyCard.Local.png) | ![illustration for AwsIoTPolicyGroup](../../../aws-q3-2022/Resource/LoT/AwsIoTPolicyGroup.Local.png) |
