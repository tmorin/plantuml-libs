...
```text
aws-q3-2022/Resource/GeneralIcons/SslPadlock
```

```text
include('aws-q3-2022/Resource/GeneralIcons/SslPadlock')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/GeneralIcons/SslPadlock.png) | ![illustration for SslPadlock](../../../aws-q3-2022/Resource/GeneralIcons/SslPadlock.Local.png) | ![illustration for SslPadlockCard](../../../aws-q3-2022/Resource/GeneralIcons/SslPadlockCard.Local.png) | ![illustration for SslPadlockGroup](../../../aws-q3-2022/Resource/GeneralIcons/SslPadlockGroup.Local.png) |
