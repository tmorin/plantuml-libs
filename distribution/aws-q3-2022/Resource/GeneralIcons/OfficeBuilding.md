...
```text
aws-q3-2022/Resource/GeneralIcons/OfficeBuilding
```

```text
include('aws-q3-2022/Resource/GeneralIcons/OfficeBuilding')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/GeneralIcons/OfficeBuilding.png) | ![illustration for OfficeBuilding](../../../aws-q3-2022/Resource/GeneralIcons/OfficeBuilding.Local.png) | ![illustration for OfficeBuildingCard](../../../aws-q3-2022/Resource/GeneralIcons/OfficeBuildingCard.Local.png) | ![illustration for OfficeBuildingGroup](../../../aws-q3-2022/Resource/GeneralIcons/OfficeBuildingGroup.Local.png) |
