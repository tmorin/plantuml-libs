...
```text
aws-q3-2022/Resource/GeneralIcons/TraditionalServer
```

```text
include('aws-q3-2022/Resource/GeneralIcons/TraditionalServer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/GeneralIcons/TraditionalServer.png) | ![illustration for TraditionalServer](../../../aws-q3-2022/Resource/GeneralIcons/TraditionalServer.Local.png) | ![illustration for TraditionalServerCard](../../../aws-q3-2022/Resource/GeneralIcons/TraditionalServerCard.Local.png) | ![illustration for TraditionalServerGroup](../../../aws-q3-2022/Resource/GeneralIcons/TraditionalServerGroup.Local.png) |
