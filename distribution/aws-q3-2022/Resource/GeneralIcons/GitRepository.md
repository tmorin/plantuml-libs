...
```text
aws-q3-2022/Resource/GeneralIcons/GitRepository
```

```text
include('aws-q3-2022/Resource/GeneralIcons/GitRepository')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/GeneralIcons/GitRepository.png) | ![illustration for GitRepository](../../../aws-q3-2022/Resource/GeneralIcons/GitRepository.Local.png) | ![illustration for GitRepositoryCard](../../../aws-q3-2022/Resource/GeneralIcons/GitRepositoryCard.Local.png) | ![illustration for GitRepositoryGroup](../../../aws-q3-2022/Resource/GeneralIcons/GitRepositoryGroup.Local.png) |
