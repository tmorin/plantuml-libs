...
```text
aws-q3-2022/Resource/GeneralIcons/Multimedia
```

```text
include('aws-q3-2022/Resource/GeneralIcons/Multimedia')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/GeneralIcons/Multimedia.png) | ![illustration for Multimedia](../../../aws-q3-2022/Resource/GeneralIcons/Multimedia.Local.png) | ![illustration for MultimediaCard](../../../aws-q3-2022/Resource/GeneralIcons/MultimediaCard.Local.png) | ![illustration for MultimediaGroup](../../../aws-q3-2022/Resource/GeneralIcons/MultimediaGroup.Local.png) |
