...
```text
aws-q3-2022/Resource/GeneralIcons/Camera
```

```text
include('aws-q3-2022/Resource/GeneralIcons/Camera')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/GeneralIcons/Camera.png) | ![illustration for Camera](../../../aws-q3-2022/Resource/GeneralIcons/Camera.Local.png) | ![illustration for CameraCard](../../../aws-q3-2022/Resource/GeneralIcons/CameraCard.Local.png) | ![illustration for CameraGroup](../../../aws-q3-2022/Resource/GeneralIcons/CameraGroup.Local.png) |
