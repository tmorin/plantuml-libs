...
```text
aws-q3-2022/Resource/GeneralIcons/GenericDatabase
```

```text
include('aws-q3-2022/Resource/GeneralIcons/GenericDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/GeneralIcons/GenericDatabase.png) | ![illustration for GenericDatabase](../../../aws-q3-2022/Resource/GeneralIcons/GenericDatabase.Local.png) | ![illustration for GenericDatabaseCard](../../../aws-q3-2022/Resource/GeneralIcons/GenericDatabaseCard.Local.png) | ![illustration for GenericDatabaseGroup](../../../aws-q3-2022/Resource/GeneralIcons/GenericDatabaseGroup.Local.png) |
