...
```text
aws-q3-2022/Resource/QuantumTechnologies/AmazonBraketQpu
```

```text
include('aws-q3-2022/Resource/QuantumTechnologies/AmazonBraketQpu')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/QuantumTechnologies/AmazonBraketQpu.png) | ![illustration for AmazonBraketQpu](../../../aws-q3-2022/Resource/QuantumTechnologies/AmazonBraketQpu.Local.png) | ![illustration for AmazonBraketQpuCard](../../../aws-q3-2022/Resource/QuantumTechnologies/AmazonBraketQpuCard.Local.png) | ![illustration for AmazonBraketQpuGroup](../../../aws-q3-2022/Resource/QuantumTechnologies/AmazonBraketQpuGroup.Local.png) |
