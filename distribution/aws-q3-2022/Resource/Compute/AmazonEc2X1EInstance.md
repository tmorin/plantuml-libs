...
```text
aws-q3-2022/Resource/Compute/AmazonEc2X1EInstance
```

```text
include('aws-q3-2022/Resource/Compute/AmazonEc2X1EInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Compute/AmazonEc2X1EInstance.png) | ![illustration for AmazonEc2X1EInstance](../../../aws-q3-2022/Resource/Compute/AmazonEc2X1EInstance.Local.png) | ![illustration for AmazonEc2X1EInstanceCard](../../../aws-q3-2022/Resource/Compute/AmazonEc2X1EInstanceCard.Local.png) | ![illustration for AmazonEc2X1EInstanceGroup](../../../aws-q3-2022/Resource/Compute/AmazonEc2X1EInstanceGroup.Local.png) |
