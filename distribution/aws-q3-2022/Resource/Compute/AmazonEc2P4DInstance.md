...
```text
aws-q3-2022/Resource/Compute/AmazonEc2P4DInstance
```

```text
include('aws-q3-2022/Resource/Compute/AmazonEc2P4DInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Compute/AmazonEc2P4DInstance.png) | ![illustration for AmazonEc2P4DInstance](../../../aws-q3-2022/Resource/Compute/AmazonEc2P4DInstance.Local.png) | ![illustration for AmazonEc2P4DInstanceCard](../../../aws-q3-2022/Resource/Compute/AmazonEc2P4DInstanceCard.Local.png) | ![illustration for AmazonEc2P4DInstanceGroup](../../../aws-q3-2022/Resource/Compute/AmazonEc2P4DInstanceGroup.Local.png) |
