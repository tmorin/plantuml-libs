...
```text
aws-q3-2022/Resource/Compute/AmazonEc2C5Instance
```

```text
include('aws-q3-2022/Resource/Compute/AmazonEc2C5Instance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Compute/AmazonEc2C5Instance.png) | ![illustration for AmazonEc2C5Instance](../../../aws-q3-2022/Resource/Compute/AmazonEc2C5Instance.Local.png) | ![illustration for AmazonEc2C5InstanceCard](../../../aws-q3-2022/Resource/Compute/AmazonEc2C5InstanceCard.Local.png) | ![illustration for AmazonEc2C5InstanceGroup](../../../aws-q3-2022/Resource/Compute/AmazonEc2C5InstanceGroup.Local.png) |
