...
```text
aws-q3-2022/Resource/Compute/AmazonEc2T2Instance
```

```text
include('aws-q3-2022/Resource/Compute/AmazonEc2T2Instance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Compute/AmazonEc2T2Instance.png) | ![illustration for AmazonEc2T2Instance](../../../aws-q3-2022/Resource/Compute/AmazonEc2T2Instance.Local.png) | ![illustration for AmazonEc2T2InstanceCard](../../../aws-q3-2022/Resource/Compute/AmazonEc2T2InstanceCard.Local.png) | ![illustration for AmazonEc2T2InstanceGroup](../../../aws-q3-2022/Resource/Compute/AmazonEc2T2InstanceGroup.Local.png) |
