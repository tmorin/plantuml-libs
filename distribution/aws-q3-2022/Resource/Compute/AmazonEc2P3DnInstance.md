...
```text
aws-q3-2022/Resource/Compute/AmazonEc2P3DnInstance
```

```text
include('aws-q3-2022/Resource/Compute/AmazonEc2P3DnInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Compute/AmazonEc2P3DnInstance.png) | ![illustration for AmazonEc2P3DnInstance](../../../aws-q3-2022/Resource/Compute/AmazonEc2P3DnInstance.Local.png) | ![illustration for AmazonEc2P3DnInstanceCard](../../../aws-q3-2022/Resource/Compute/AmazonEc2P3DnInstanceCard.Local.png) | ![illustration for AmazonEc2P3DnInstanceGroup](../../../aws-q3-2022/Resource/Compute/AmazonEc2P3DnInstanceGroup.Local.png) |
