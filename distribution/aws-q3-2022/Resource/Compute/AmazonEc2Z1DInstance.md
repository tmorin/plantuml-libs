...
```text
aws-q3-2022/Resource/Compute/AmazonEc2Z1DInstance
```

```text
include('aws-q3-2022/Resource/Compute/AmazonEc2Z1DInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Compute/AmazonEc2Z1DInstance.png) | ![illustration for AmazonEc2Z1DInstance](../../../aws-q3-2022/Resource/Compute/AmazonEc2Z1DInstance.Local.png) | ![illustration for AmazonEc2Z1DInstanceCard](../../../aws-q3-2022/Resource/Compute/AmazonEc2Z1DInstanceCard.Local.png) | ![illustration for AmazonEc2Z1DInstanceGroup](../../../aws-q3-2022/Resource/Compute/AmazonEc2Z1DInstanceGroup.Local.png) |
