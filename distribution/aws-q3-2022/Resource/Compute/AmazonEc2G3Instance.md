...
```text
aws-q3-2022/Resource/Compute/AmazonEc2G3Instance
```

```text
include('aws-q3-2022/Resource/Compute/AmazonEc2G3Instance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Compute/AmazonEc2G3Instance.png) | ![illustration for AmazonEc2G3Instance](../../../aws-q3-2022/Resource/Compute/AmazonEc2G3Instance.Local.png) | ![illustration for AmazonEc2G3InstanceCard](../../../aws-q3-2022/Resource/Compute/AmazonEc2G3InstanceCard.Local.png) | ![illustration for AmazonEc2G3InstanceGroup](../../../aws-q3-2022/Resource/Compute/AmazonEc2G3InstanceGroup.Local.png) |
