...
```text
aws-q3-2022/Resource/GroupIcons/AutoScaling
```

```text
include('aws-q3-2022/Resource/GroupIcons/AutoScaling')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/GroupIcons/AutoScaling.png) | ![illustration for AutoScaling](../../../aws-q3-2022/Resource/GroupIcons/AutoScaling.Local.png) | ![illustration for AutoScalingCard](../../../aws-q3-2022/Resource/GroupIcons/AutoScalingCard.Local.png) | ![illustration for AutoScalingGroup](../../../aws-q3-2022/Resource/GroupIcons/AutoScalingGroup.Local.png) |
