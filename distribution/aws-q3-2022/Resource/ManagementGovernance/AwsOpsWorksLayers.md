...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsOpsWorksLayers
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsOpsWorksLayers')
```
