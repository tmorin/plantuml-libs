...
```text
aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchRule
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchRule')
```
