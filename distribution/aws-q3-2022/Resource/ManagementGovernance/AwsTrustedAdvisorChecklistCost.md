...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistCost
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistCost')
```
