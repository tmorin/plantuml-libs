...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsSystemsManagerRunCommand
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsSystemsManagerRunCommand')
```
