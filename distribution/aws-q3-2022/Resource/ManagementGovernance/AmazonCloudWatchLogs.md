...
```text
aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchLogs
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchLogs')
```
