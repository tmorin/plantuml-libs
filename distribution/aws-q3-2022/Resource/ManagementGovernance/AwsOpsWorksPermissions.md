...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsOpsWorksPermissions
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsOpsWorksPermissions')
```
