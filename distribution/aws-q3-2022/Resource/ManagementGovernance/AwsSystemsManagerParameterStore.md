...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsSystemsManagerParameterStore
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsSystemsManagerParameterStore')
```
