...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsOpsWorksDeployments
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsOpsWorksDeployments')
```
