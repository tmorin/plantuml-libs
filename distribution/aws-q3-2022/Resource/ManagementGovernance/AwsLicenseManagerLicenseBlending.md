...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsLicenseManagerLicenseBlending
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsLicenseManagerLicenseBlending')
```
