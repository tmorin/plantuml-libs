...
```text
aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchEventEventBased
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchEventEventBased')
```
