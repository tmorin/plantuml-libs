...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsOrganizationsManagementAccount
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsOrganizationsManagementAccount')
```
