...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsCloudFormationTemplate
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsCloudFormationTemplate')
```
