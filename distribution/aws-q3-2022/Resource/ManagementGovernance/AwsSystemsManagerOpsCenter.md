...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsSystemsManagerOpsCenter
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsSystemsManagerOpsCenter')
```
