...
```text
aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchEventTimeBased
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchEventTimeBased')
```
