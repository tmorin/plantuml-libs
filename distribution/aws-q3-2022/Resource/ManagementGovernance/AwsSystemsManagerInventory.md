...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsSystemsManagerInventory
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsSystemsManagerInventory')
```
