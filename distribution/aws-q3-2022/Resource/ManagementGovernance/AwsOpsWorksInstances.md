...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsOpsWorksInstances
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsOpsWorksInstances')
```
