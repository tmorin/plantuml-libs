...
```text
aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchRum
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchRum')
```
