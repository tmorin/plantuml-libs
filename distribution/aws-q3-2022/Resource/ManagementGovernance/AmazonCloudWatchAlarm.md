...
```text
aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchAlarm
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AmazonCloudWatchAlarm')
```
