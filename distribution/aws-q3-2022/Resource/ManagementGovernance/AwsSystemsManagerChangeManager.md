...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsSystemsManagerChangeManager
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsSystemsManagerChangeManager')
```
