...
```text
aws-q3-2022/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistPerformance
```

```text
include('aws-q3-2022/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistPerformance')
```
