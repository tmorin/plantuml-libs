...
```text
aws-q3-2022/Resource/Analytics/AwsGlueDataCatalog
```

```text
include('aws-q3-2022/Resource/Analytics/AwsGlueDataCatalog')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Analytics/AwsGlueDataCatalog.png) | ![illustration for AwsGlueDataCatalog](../../../aws-q3-2022/Resource/Analytics/AwsGlueDataCatalog.Local.png) | ![illustration for AwsGlueDataCatalogCard](../../../aws-q3-2022/Resource/Analytics/AwsGlueDataCatalogCard.Local.png) | ![illustration for AwsGlueDataCatalogGroup](../../../aws-q3-2022/Resource/Analytics/AwsGlueDataCatalogGroup.Local.png) |
