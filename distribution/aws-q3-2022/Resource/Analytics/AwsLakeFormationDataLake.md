...
```text
aws-q3-2022/Resource/Analytics/AwsLakeFormationDataLake
```

```text
include('aws-q3-2022/Resource/Analytics/AwsLakeFormationDataLake')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/Analytics/AwsLakeFormationDataLake.png) | ![illustration for AwsLakeFormationDataLake](../../../aws-q3-2022/Resource/Analytics/AwsLakeFormationDataLake.Local.png) | ![illustration for AwsLakeFormationDataLakeCard](../../../aws-q3-2022/Resource/Analytics/AwsLakeFormationDataLakeCard.Local.png) | ![illustration for AwsLakeFormationDataLakeGroup](../../../aws-q3-2022/Resource/Analytics/AwsLakeFormationDataLakeGroup.Local.png) |
