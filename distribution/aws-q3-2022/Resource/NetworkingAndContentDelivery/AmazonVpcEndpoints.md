...
```text
aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcEndpoints
```

```text
include('aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcEndpoints')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcEndpoints.png) | ![illustration for AmazonVpcEndpoints](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcEndpoints.Local.png) | ![illustration for AmazonVpcEndpointsCard](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcEndpointsCard.Local.png) | ![illustration for AmazonVpcEndpointsGroup](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcEndpointsGroup.Local.png) |
