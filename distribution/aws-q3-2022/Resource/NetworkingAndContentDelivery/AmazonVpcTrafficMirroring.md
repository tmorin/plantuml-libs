...
```text
aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcTrafficMirroring
```

```text
include('aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcTrafficMirroring')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcTrafficMirroring.png) | ![illustration for AmazonVpcTrafficMirroring](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcTrafficMirroring.Local.png) | ![illustration for AmazonVpcTrafficMirroringCard](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcTrafficMirroringCard.Local.png) | ![illustration for AmazonVpcTrafficMirroringGroup](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcTrafficMirroringGroup.Local.png) |
