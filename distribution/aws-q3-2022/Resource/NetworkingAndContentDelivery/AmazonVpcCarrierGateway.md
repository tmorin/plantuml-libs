...
```text
aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcCarrierGateway
```

```text
include('aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcCarrierGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcCarrierGateway.png) | ![illustration for AmazonVpcCarrierGateway](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcCarrierGateway.Local.png) | ![illustration for AmazonVpcCarrierGatewayCard](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcCarrierGatewayCard.Local.png) | ![illustration for AmazonVpcCarrierGatewayGroup](../../../aws-q3-2022/Resource/NetworkingAndContentDelivery/AmazonVpcCarrierGatewayGroup.Local.png) |
