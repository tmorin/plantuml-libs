...
```text
aws-q3-2022/Category/Containers
```

```text
include('aws-q3-2022/Category/Containers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q3-2022/Category/Containers.png) | ![illustration for Containers](../../aws-q3-2022/Category/Containers.Local.png) | ![illustration for ContainersCard](../../aws-q3-2022/Category/ContainersCard.Local.png) | ![illustration for ContainersGroup](../../aws-q3-2022/Category/ContainersGroup.Local.png) |
