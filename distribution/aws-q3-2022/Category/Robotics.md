...
```text
aws-q3-2022/Category/Robotics
```

```text
include('aws-q3-2022/Category/Robotics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q3-2022/Category/Robotics.png) | ![illustration for Robotics](../../aws-q3-2022/Category/Robotics.Local.png) | ![illustration for RoboticsCard](../../aws-q3-2022/Category/RoboticsCard.Local.png) | ![illustration for RoboticsGroup](../../aws-q3-2022/Category/RoboticsGroup.Local.png) |
