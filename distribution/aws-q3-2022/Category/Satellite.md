...
```text
aws-q3-2022/Category/Satellite
```

```text
include('aws-q3-2022/Category/Satellite')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q3-2022/Category/Satellite.png) | ![illustration for Satellite](../../aws-q3-2022/Category/Satellite.Local.png) | ![illustration for SatelliteCard](../../aws-q3-2022/Category/SatelliteCard.Local.png) | ![illustration for SatelliteGroup](../../aws-q3-2022/Category/SatelliteGroup.Local.png) |
