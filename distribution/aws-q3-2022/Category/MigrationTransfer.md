...
```text
aws-q3-2022/Category/MigrationTransfer
```

```text
include('aws-q3-2022/Category/MigrationTransfer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q3-2022/Category/MigrationTransfer.png) | ![illustration for MigrationTransfer](../../aws-q3-2022/Category/MigrationTransfer.Local.png) | ![illustration for MigrationTransferCard](../../aws-q3-2022/Category/MigrationTransferCard.Local.png) | ![illustration for MigrationTransferGroup](../../aws-q3-2022/Category/MigrationTransferGroup.Local.png) |
