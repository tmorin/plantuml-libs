...
```text
aws-q3-2022/Category/GameTech
```

```text
include('aws-q3-2022/Category/GameTech')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q3-2022/Category/GameTech.png) | ![illustration for GameTech](../../aws-q3-2022/Category/GameTech.Local.png) | ![illustration for GameTechCard](../../aws-q3-2022/Category/GameTechCard.Local.png) | ![illustration for GameTechGroup](../../aws-q3-2022/Category/GameTechGroup.Local.png) |
