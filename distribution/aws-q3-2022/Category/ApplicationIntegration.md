...
```text
aws-q3-2022/Category/ApplicationIntegration
```

```text
include('aws-q3-2022/Category/ApplicationIntegration')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../aws-q3-2022/Category/ApplicationIntegration.png) | ![illustration for ApplicationIntegration](../../aws-q3-2022/Category/ApplicationIntegration.Local.png) | ![illustration for ApplicationIntegrationCard](../../aws-q3-2022/Category/ApplicationIntegrationCard.Local.png) | ![illustration for ApplicationIntegrationGroup](../../aws-q3-2022/Category/ApplicationIntegrationGroup.Local.png) |
