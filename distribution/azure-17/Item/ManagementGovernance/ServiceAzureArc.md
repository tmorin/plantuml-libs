...
```text
azure-17/Item/ManagementGovernance/ServiceAzureArc
```

```text
include('azure-17/Item/ManagementGovernance/ServiceAzureArc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/ManagementGovernance/ServiceAzureArc.png) | ![illustration for ServiceAzureArc](../../../azure-17/Item/ManagementGovernance/ServiceAzureArc.Local.png) | ![illustration for ServiceAzureArcCard](../../../azure-17/Item/ManagementGovernance/ServiceAzureArcCard.Local.png) | ![illustration for ServiceAzureArcGroup](../../../azure-17/Item/ManagementGovernance/ServiceAzureArcGroup.Local.png) |
