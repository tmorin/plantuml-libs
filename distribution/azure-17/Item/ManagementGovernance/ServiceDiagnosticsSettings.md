...
```text
azure-17/Item/ManagementGovernance/ServiceDiagnosticsSettings
```

```text
include('azure-17/Item/ManagementGovernance/ServiceDiagnosticsSettings')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/ManagementGovernance/ServiceDiagnosticsSettings.png) | ![illustration for ServiceDiagnosticsSettings](../../../azure-17/Item/ManagementGovernance/ServiceDiagnosticsSettings.Local.png) | ![illustration for ServiceDiagnosticsSettingsCard](../../../azure-17/Item/ManagementGovernance/ServiceDiagnosticsSettingsCard.Local.png) | ![illustration for ServiceDiagnosticsSettingsGroup](../../../azure-17/Item/ManagementGovernance/ServiceDiagnosticsSettingsGroup.Local.png) |
