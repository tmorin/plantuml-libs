...
```text
azure-17/Item/AiMachineLearning/ServiceBotServices
```

```text
include('azure-17/Item/AiMachineLearning/ServiceBotServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/AiMachineLearning/ServiceBotServices.png) | ![illustration for ServiceBotServices](../../../azure-17/Item/AiMachineLearning/ServiceBotServices.Local.png) | ![illustration for ServiceBotServicesCard](../../../azure-17/Item/AiMachineLearning/ServiceBotServicesCard.Local.png) | ![illustration for ServiceBotServicesGroup](../../../azure-17/Item/AiMachineLearning/ServiceBotServicesGroup.Local.png) |
