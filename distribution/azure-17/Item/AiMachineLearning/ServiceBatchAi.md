...
```text
azure-17/Item/AiMachineLearning/ServiceBatchAi
```

```text
include('azure-17/Item/AiMachineLearning/ServiceBatchAi')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/AiMachineLearning/ServiceBatchAi.png) | ![illustration for ServiceBatchAi](../../../azure-17/Item/AiMachineLearning/ServiceBatchAi.Local.png) | ![illustration for ServiceBatchAiCard](../../../azure-17/Item/AiMachineLearning/ServiceBatchAiCard.Local.png) | ![illustration for ServiceBatchAiGroup](../../../azure-17/Item/AiMachineLearning/ServiceBatchAiGroup.Local.png) |
