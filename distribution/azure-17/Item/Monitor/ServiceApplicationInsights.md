...
```text
azure-17/Item/Monitor/ServiceApplicationInsights
```

```text
include('azure-17/Item/Monitor/ServiceApplicationInsights')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Monitor/ServiceApplicationInsights.png) | ![illustration for ServiceApplicationInsights](../../../azure-17/Item/Monitor/ServiceApplicationInsights.Local.png) | ![illustration for ServiceApplicationInsightsCard](../../../azure-17/Item/Monitor/ServiceApplicationInsightsCard.Local.png) | ![illustration for ServiceApplicationInsightsGroup](../../../azure-17/Item/Monitor/ServiceApplicationInsightsGroup.Local.png) |
