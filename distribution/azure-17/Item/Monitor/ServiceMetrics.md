...
```text
azure-17/Item/Monitor/ServiceMetrics
```

```text
include('azure-17/Item/Monitor/ServiceMetrics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Monitor/ServiceMetrics.png) | ![illustration for ServiceMetrics](../../../azure-17/Item/Monitor/ServiceMetrics.Local.png) | ![illustration for ServiceMetricsCard](../../../azure-17/Item/Monitor/ServiceMetricsCard.Local.png) | ![illustration for ServiceMetricsGroup](../../../azure-17/Item/Monitor/ServiceMetricsGroup.Local.png) |
