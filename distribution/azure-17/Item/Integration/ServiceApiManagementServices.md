...
```text
azure-17/Item/Integration/ServiceApiManagementServices
```

```text
include('azure-17/Item/Integration/ServiceApiManagementServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Integration/ServiceApiManagementServices.png) | ![illustration for ServiceApiManagementServices](../../../azure-17/Item/Integration/ServiceApiManagementServices.Local.png) | ![illustration for ServiceApiManagementServicesCard](../../../azure-17/Item/Integration/ServiceApiManagementServicesCard.Local.png) | ![illustration for ServiceApiManagementServicesGroup](../../../azure-17/Item/Integration/ServiceApiManagementServicesGroup.Local.png) |
