...
```text
azure-17/Item/Integration/ServicePartnerRegistration
```

```text
include('azure-17/Item/Integration/ServicePartnerRegistration')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Integration/ServicePartnerRegistration.png) | ![illustration for ServicePartnerRegistration](../../../azure-17/Item/Integration/ServicePartnerRegistration.Local.png) | ![illustration for ServicePartnerRegistrationCard](../../../azure-17/Item/Integration/ServicePartnerRegistrationCard.Local.png) | ![illustration for ServicePartnerRegistrationGroup](../../../azure-17/Item/Integration/ServicePartnerRegistrationGroup.Local.png) |
