...
```text
azure-17/Item/Integration/ServiceAzureStackEdge
```

```text
include('azure-17/Item/Integration/ServiceAzureStackEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Integration/ServiceAzureStackEdge.png) | ![illustration for ServiceAzureStackEdge](../../../azure-17/Item/Integration/ServiceAzureStackEdge.Local.png) | ![illustration for ServiceAzureStackEdgeCard](../../../azure-17/Item/Integration/ServiceAzureStackEdgeCard.Local.png) | ![illustration for ServiceAzureStackEdgeGroup](../../../azure-17/Item/Integration/ServiceAzureStackEdgeGroup.Local.png) |
