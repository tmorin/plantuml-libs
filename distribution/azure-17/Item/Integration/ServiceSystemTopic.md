...
```text
azure-17/Item/Integration/ServiceSystemTopic
```

```text
include('azure-17/Item/Integration/ServiceSystemTopic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Integration/ServiceSystemTopic.png) | ![illustration for ServiceSystemTopic](../../../azure-17/Item/Integration/ServiceSystemTopic.Local.png) | ![illustration for ServiceSystemTopicCard](../../../azure-17/Item/Integration/ServiceSystemTopicCard.Local.png) | ![illustration for ServiceSystemTopicGroup](../../../azure-17/Item/Integration/ServiceSystemTopicGroup.Local.png) |
