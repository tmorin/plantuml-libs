...
```text
azure-17/Item/Other/ServiceAppRegistrations
```

```text
include('azure-17/Item/Other/ServiceAppRegistrations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Other/ServiceAppRegistrations.png) | ![illustration for ServiceAppRegistrations](../../../azure-17/Item/Other/ServiceAppRegistrations.Local.png) | ![illustration for ServiceAppRegistrationsCard](../../../azure-17/Item/Other/ServiceAppRegistrationsCard.Local.png) | ![illustration for ServiceAppRegistrationsGroup](../../../azure-17/Item/Other/ServiceAppRegistrationsGroup.Local.png) |
