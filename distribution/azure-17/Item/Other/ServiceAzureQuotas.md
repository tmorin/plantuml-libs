...
```text
azure-17/Item/Other/ServiceAzureQuotas
```

```text
include('azure-17/Item/Other/ServiceAzureQuotas')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Other/ServiceAzureQuotas.png) | ![illustration for ServiceAzureQuotas](../../../azure-17/Item/Other/ServiceAzureQuotas.Local.png) | ![illustration for ServiceAzureQuotasCard](../../../azure-17/Item/Other/ServiceAzureQuotasCard.Local.png) | ![illustration for ServiceAzureQuotasGroup](../../../azure-17/Item/Other/ServiceAzureQuotasGroup.Local.png) |
