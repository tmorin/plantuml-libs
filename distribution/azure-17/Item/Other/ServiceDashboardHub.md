...
```text
azure-17/Item/Other/ServiceDashboardHub
```

```text
include('azure-17/Item/Other/ServiceDashboardHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Other/ServiceDashboardHub.png) | ![illustration for ServiceDashboardHub](../../../azure-17/Item/Other/ServiceDashboardHub.Local.png) | ![illustration for ServiceDashboardHubCard](../../../azure-17/Item/Other/ServiceDashboardHubCard.Local.png) | ![illustration for ServiceDashboardHubGroup](../../../azure-17/Item/Other/ServiceDashboardHubGroup.Local.png) |
