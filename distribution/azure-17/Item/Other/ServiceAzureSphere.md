...
```text
azure-17/Item/Other/ServiceAzureSphere
```

```text
include('azure-17/Item/Other/ServiceAzureSphere')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Other/ServiceAzureSphere.png) | ![illustration for ServiceAzureSphere](../../../azure-17/Item/Other/ServiceAzureSphere.Local.png) | ![illustration for ServiceAzureSphereCard](../../../azure-17/Item/Other/ServiceAzureSphereCard.Local.png) | ![illustration for ServiceAzureSphereGroup](../../../azure-17/Item/Other/ServiceAzureSphereGroup.Local.png) |
