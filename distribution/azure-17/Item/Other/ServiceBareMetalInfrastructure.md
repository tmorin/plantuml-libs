...
```text
azure-17/Item/Other/ServiceBareMetalInfrastructure
```

```text
include('azure-17/Item/Other/ServiceBareMetalInfrastructure')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Other/ServiceBareMetalInfrastructure.png) | ![illustration for ServiceBareMetalInfrastructure](../../../azure-17/Item/Other/ServiceBareMetalInfrastructure.Local.png) | ![illustration for ServiceBareMetalInfrastructureCard](../../../azure-17/Item/Other/ServiceBareMetalInfrastructureCard.Local.png) | ![illustration for ServiceBareMetalInfrastructureGroup](../../../azure-17/Item/Other/ServiceBareMetalInfrastructureGroup.Local.png) |
