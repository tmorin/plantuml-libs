...
```text
azure-17/Item/Analytics/ServicePowerPlatform
```

```text
include('azure-17/Item/Analytics/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Analytics/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure-17/Item/Analytics/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure-17/Item/Analytics/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure-17/Item/Analytics/ServicePowerPlatformGroup.Local.png) |
