...
```text
azure-17/Item/Analytics/ServiceAzureDatabricks
```

```text
include('azure-17/Item/Analytics/ServiceAzureDatabricks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Analytics/ServiceAzureDatabricks.png) | ![illustration for ServiceAzureDatabricks](../../../azure-17/Item/Analytics/ServiceAzureDatabricks.Local.png) | ![illustration for ServiceAzureDatabricksCard](../../../azure-17/Item/Analytics/ServiceAzureDatabricksCard.Local.png) | ![illustration for ServiceAzureDatabricksGroup](../../../azure-17/Item/Analytics/ServiceAzureDatabricksGroup.Local.png) |
