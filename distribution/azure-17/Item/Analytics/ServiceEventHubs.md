...
```text
azure-17/Item/Analytics/ServiceEventHubs
```

```text
include('azure-17/Item/Analytics/ServiceEventHubs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Analytics/ServiceEventHubs.png) | ![illustration for ServiceEventHubs](../../../azure-17/Item/Analytics/ServiceEventHubs.Local.png) | ![illustration for ServiceEventHubsCard](../../../azure-17/Item/Analytics/ServiceEventHubsCard.Local.png) | ![illustration for ServiceEventHubsGroup](../../../azure-17/Item/Analytics/ServiceEventHubsGroup.Local.png) |
