...
```text
azure-17/Item/Analytics/ServiceAzureSynapseAnalytics
```

```text
include('azure-17/Item/Analytics/ServiceAzureSynapseAnalytics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Analytics/ServiceAzureSynapseAnalytics.png) | ![illustration for ServiceAzureSynapseAnalytics](../../../azure-17/Item/Analytics/ServiceAzureSynapseAnalytics.Local.png) | ![illustration for ServiceAzureSynapseAnalyticsCard](../../../azure-17/Item/Analytics/ServiceAzureSynapseAnalyticsCard.Local.png) | ![illustration for ServiceAzureSynapseAnalyticsGroup](../../../azure-17/Item/Analytics/ServiceAzureSynapseAnalyticsGroup.Local.png) |
