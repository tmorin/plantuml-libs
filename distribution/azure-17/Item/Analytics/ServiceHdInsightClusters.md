...
```text
azure-17/Item/Analytics/ServiceHdInsightClusters
```

```text
include('azure-17/Item/Analytics/ServiceHdInsightClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Analytics/ServiceHdInsightClusters.png) | ![illustration for ServiceHdInsightClusters](../../../azure-17/Item/Analytics/ServiceHdInsightClusters.Local.png) | ![illustration for ServiceHdInsightClustersCard](../../../azure-17/Item/Analytics/ServiceHdInsightClustersCard.Local.png) | ![illustration for ServiceHdInsightClustersGroup](../../../azure-17/Item/Analytics/ServiceHdInsightClustersGroup.Local.png) |
