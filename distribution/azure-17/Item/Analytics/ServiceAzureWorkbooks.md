...
```text
azure-17/Item/Analytics/ServiceAzureWorkbooks
```

```text
include('azure-17/Item/Analytics/ServiceAzureWorkbooks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Analytics/ServiceAzureWorkbooks.png) | ![illustration for ServiceAzureWorkbooks](../../../azure-17/Item/Analytics/ServiceAzureWorkbooks.Local.png) | ![illustration for ServiceAzureWorkbooksCard](../../../azure-17/Item/Analytics/ServiceAzureWorkbooksCard.Local.png) | ![illustration for ServiceAzureWorkbooksGroup](../../../azure-17/Item/Analytics/ServiceAzureWorkbooksGroup.Local.png) |
