...
```text
azure-17/Item/Intune/ServiceIntune
```

```text
include('azure-17/Item/Intune/ServiceIntune')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Intune/ServiceIntune.png) | ![illustration for ServiceIntune](../../../azure-17/Item/Intune/ServiceIntune.Local.png) | ![illustration for ServiceIntuneCard](../../../azure-17/Item/Intune/ServiceIntuneCard.Local.png) | ![illustration for ServiceIntuneGroup](../../../azure-17/Item/Intune/ServiceIntuneGroup.Local.png) |
