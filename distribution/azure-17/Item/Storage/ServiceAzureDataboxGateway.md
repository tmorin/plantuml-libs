...
```text
azure-17/Item/Storage/ServiceAzureDataboxGateway
```

```text
include('azure-17/Item/Storage/ServiceAzureDataboxGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Storage/ServiceAzureDataboxGateway.png) | ![illustration for ServiceAzureDataboxGateway](../../../azure-17/Item/Storage/ServiceAzureDataboxGateway.Local.png) | ![illustration for ServiceAzureDataboxGatewayCard](../../../azure-17/Item/Storage/ServiceAzureDataboxGatewayCard.Local.png) | ![illustration for ServiceAzureDataboxGatewayGroup](../../../azure-17/Item/Storage/ServiceAzureDataboxGatewayGroup.Local.png) |
