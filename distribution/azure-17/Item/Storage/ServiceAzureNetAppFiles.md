...
```text
azure-17/Item/Storage/ServiceAzureNetAppFiles
```

```text
include('azure-17/Item/Storage/ServiceAzureNetAppFiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Storage/ServiceAzureNetAppFiles.png) | ![illustration for ServiceAzureNetAppFiles](../../../azure-17/Item/Storage/ServiceAzureNetAppFiles.Local.png) | ![illustration for ServiceAzureNetAppFilesCard](../../../azure-17/Item/Storage/ServiceAzureNetAppFilesCard.Local.png) | ![illustration for ServiceAzureNetAppFilesGroup](../../../azure-17/Item/Storage/ServiceAzureNetAppFilesGroup.Local.png) |
