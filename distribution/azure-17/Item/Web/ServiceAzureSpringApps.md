...
```text
azure-17/Item/Web/ServiceAzureSpringApps
```

```text
include('azure-17/Item/Web/ServiceAzureSpringApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Web/ServiceAzureSpringApps.png) | ![illustration for ServiceAzureSpringApps](../../../azure-17/Item/Web/ServiceAzureSpringApps.Local.png) | ![illustration for ServiceAzureSpringAppsCard](../../../azure-17/Item/Web/ServiceAzureSpringAppsCard.Local.png) | ![illustration for ServiceAzureSpringAppsGroup](../../../azure-17/Item/Web/ServiceAzureSpringAppsGroup.Local.png) |
