...
```text
azure-17/Item/Web/ServiceCognitiveServices
```

```text
include('azure-17/Item/Web/ServiceCognitiveServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Web/ServiceCognitiveServices.png) | ![illustration for ServiceCognitiveServices](../../../azure-17/Item/Web/ServiceCognitiveServices.Local.png) | ![illustration for ServiceCognitiveServicesCard](../../../azure-17/Item/Web/ServiceCognitiveServicesCard.Local.png) | ![illustration for ServiceCognitiveServicesGroup](../../../azure-17/Item/Web/ServiceCognitiveServicesGroup.Local.png) |
