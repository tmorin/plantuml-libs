...
```text
azure-17/Item/Web/ServiceApiConnections
```

```text
include('azure-17/Item/Web/ServiceApiConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Web/ServiceApiConnections.png) | ![illustration for ServiceApiConnections](../../../azure-17/Item/Web/ServiceApiConnections.Local.png) | ![illustration for ServiceApiConnectionsCard](../../../azure-17/Item/Web/ServiceApiConnectionsCard.Local.png) | ![illustration for ServiceApiConnectionsGroup](../../../azure-17/Item/Web/ServiceApiConnectionsGroup.Local.png) |
