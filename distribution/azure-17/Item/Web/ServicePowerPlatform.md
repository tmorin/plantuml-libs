...
```text
azure-17/Item/Web/ServicePowerPlatform
```

```text
include('azure-17/Item/Web/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Web/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure-17/Item/Web/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure-17/Item/Web/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure-17/Item/Web/ServicePowerPlatformGroup.Local.png) |
