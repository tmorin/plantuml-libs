...
```text
azure-17/Item/Web/ServiceFrontDoorAndCdnProfiles
```

```text
include('azure-17/Item/Web/ServiceFrontDoorAndCdnProfiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Web/ServiceFrontDoorAndCdnProfiles.png) | ![illustration for ServiceFrontDoorAndCdnProfiles](../../../azure-17/Item/Web/ServiceFrontDoorAndCdnProfiles.Local.png) | ![illustration for ServiceFrontDoorAndCdnProfilesCard](../../../azure-17/Item/Web/ServiceFrontDoorAndCdnProfilesCard.Local.png) | ![illustration for ServiceFrontDoorAndCdnProfilesGroup](../../../azure-17/Item/Web/ServiceFrontDoorAndCdnProfilesGroup.Local.png) |
