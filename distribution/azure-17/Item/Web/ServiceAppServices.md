...
```text
azure-17/Item/Web/ServiceAppServices
```

```text
include('azure-17/Item/Web/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Web/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-17/Item/Web/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-17/Item/Web/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-17/Item/Web/ServiceAppServicesGroup.Local.png) |
