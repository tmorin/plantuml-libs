...
```text
azure-17/Item/Blockchain/ServiceAzureTokenService
```

```text
include('azure-17/Item/Blockchain/ServiceAzureTokenService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Blockchain/ServiceAzureTokenService.png) | ![illustration for ServiceAzureTokenService](../../../azure-17/Item/Blockchain/ServiceAzureTokenService.Local.png) | ![illustration for ServiceAzureTokenServiceCard](../../../azure-17/Item/Blockchain/ServiceAzureTokenServiceCard.Local.png) | ![illustration for ServiceAzureTokenServiceGroup](../../../azure-17/Item/Blockchain/ServiceAzureTokenServiceGroup.Local.png) |
