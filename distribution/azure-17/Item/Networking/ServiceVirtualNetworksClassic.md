...
```text
azure-17/Item/Networking/ServiceVirtualNetworksClassic
```

```text
include('azure-17/Item/Networking/ServiceVirtualNetworksClassic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Networking/ServiceVirtualNetworksClassic.png) | ![illustration for ServiceVirtualNetworksClassic](../../../azure-17/Item/Networking/ServiceVirtualNetworksClassic.Local.png) | ![illustration for ServiceVirtualNetworksClassicCard](../../../azure-17/Item/Networking/ServiceVirtualNetworksClassicCard.Local.png) | ![illustration for ServiceVirtualNetworksClassicGroup](../../../azure-17/Item/Networking/ServiceVirtualNetworksClassicGroup.Local.png) |
