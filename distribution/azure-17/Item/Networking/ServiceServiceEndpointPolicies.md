...
```text
azure-17/Item/Networking/ServiceServiceEndpointPolicies
```

```text
include('azure-17/Item/Networking/ServiceServiceEndpointPolicies')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Networking/ServiceServiceEndpointPolicies.png) | ![illustration for ServiceServiceEndpointPolicies](../../../azure-17/Item/Networking/ServiceServiceEndpointPolicies.Local.png) | ![illustration for ServiceServiceEndpointPoliciesCard](../../../azure-17/Item/Networking/ServiceServiceEndpointPoliciesCard.Local.png) | ![illustration for ServiceServiceEndpointPoliciesGroup](../../../azure-17/Item/Networking/ServiceServiceEndpointPoliciesGroup.Local.png) |
