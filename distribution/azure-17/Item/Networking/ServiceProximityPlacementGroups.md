...
```text
azure-17/Item/Networking/ServiceProximityPlacementGroups
```

```text
include('azure-17/Item/Networking/ServiceProximityPlacementGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Networking/ServiceProximityPlacementGroups.png) | ![illustration for ServiceProximityPlacementGroups](../../../azure-17/Item/Networking/ServiceProximityPlacementGroups.Local.png) | ![illustration for ServiceProximityPlacementGroupsCard](../../../azure-17/Item/Networking/ServiceProximityPlacementGroupsCard.Local.png) | ![illustration for ServiceProximityPlacementGroupsGroup](../../../azure-17/Item/Networking/ServiceProximityPlacementGroupsGroup.Local.png) |
