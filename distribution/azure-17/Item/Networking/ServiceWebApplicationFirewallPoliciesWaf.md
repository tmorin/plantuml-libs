...
```text
azure-17/Item/Networking/ServiceWebApplicationFirewallPoliciesWaf
```

```text
include('azure-17/Item/Networking/ServiceWebApplicationFirewallPoliciesWaf')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Networking/ServiceWebApplicationFirewallPoliciesWaf.png) | ![illustration for ServiceWebApplicationFirewallPoliciesWaf](../../../azure-17/Item/Networking/ServiceWebApplicationFirewallPoliciesWaf.Local.png) | ![illustration for ServiceWebApplicationFirewallPoliciesWafCard](../../../azure-17/Item/Networking/ServiceWebApplicationFirewallPoliciesWafCard.Local.png) | ![illustration for ServiceWebApplicationFirewallPoliciesWafGroup](../../../azure-17/Item/Networking/ServiceWebApplicationFirewallPoliciesWafGroup.Local.png) |
