...
```text
azure-17/Item/Compute/ServiceVirtualMachine
```

```text
include('azure-17/Item/Compute/ServiceVirtualMachine')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Compute/ServiceVirtualMachine.png) | ![illustration for ServiceVirtualMachine](../../../azure-17/Item/Compute/ServiceVirtualMachine.Local.png) | ![illustration for ServiceVirtualMachineCard](../../../azure-17/Item/Compute/ServiceVirtualMachineCard.Local.png) | ![illustration for ServiceVirtualMachineGroup](../../../azure-17/Item/Compute/ServiceVirtualMachineGroup.Local.png) |
...
- `<$ServiceVirtualMachineXs>`
- `<$ServiceVirtualMachineSm>`
- `<$ServiceVirtualMachineMd>`
- `<$ServiceVirtualMachineLg>`
