...
```text
azure-17/Item/Compute/ServiceFunctionApps
```

```text
include('azure-17/Item/Compute/ServiceFunctionApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Compute/ServiceFunctionApps.png) | ![illustration for ServiceFunctionApps](../../../azure-17/Item/Compute/ServiceFunctionApps.Local.png) | ![illustration for ServiceFunctionAppsCard](../../../azure-17/Item/Compute/ServiceFunctionAppsCard.Local.png) | ![illustration for ServiceFunctionAppsGroup](../../../azure-17/Item/Compute/ServiceFunctionAppsGroup.Local.png) |
