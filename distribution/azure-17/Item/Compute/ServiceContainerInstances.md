...
```text
azure-17/Item/Compute/ServiceContainerInstances
```

```text
include('azure-17/Item/Compute/ServiceContainerInstances')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Compute/ServiceContainerInstances.png) | ![illustration for ServiceContainerInstances](../../../azure-17/Item/Compute/ServiceContainerInstances.Local.png) | ![illustration for ServiceContainerInstancesCard](../../../azure-17/Item/Compute/ServiceContainerInstancesCard.Local.png) | ![illustration for ServiceContainerInstancesGroup](../../../azure-17/Item/Compute/ServiceContainerInstancesGroup.Local.png) |
