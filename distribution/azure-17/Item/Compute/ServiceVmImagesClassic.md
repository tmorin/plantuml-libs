...
```text
azure-17/Item/Compute/ServiceVmImagesClassic
```

```text
include('azure-17/Item/Compute/ServiceVmImagesClassic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Compute/ServiceVmImagesClassic.png) | ![illustration for ServiceVmImagesClassic](../../../azure-17/Item/Compute/ServiceVmImagesClassic.Local.png) | ![illustration for ServiceVmImagesClassicCard](../../../azure-17/Item/Compute/ServiceVmImagesClassicCard.Local.png) | ![illustration for ServiceVmImagesClassicGroup](../../../azure-17/Item/Compute/ServiceVmImagesClassicGroup.Local.png) |
