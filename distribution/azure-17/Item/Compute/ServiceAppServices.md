...
```text
azure-17/Item/Compute/ServiceAppServices
```

```text
include('azure-17/Item/Compute/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Compute/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-17/Item/Compute/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-17/Item/Compute/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-17/Item/Compute/ServiceAppServicesGroup.Local.png) |
