...
```text
azure-17/Item/Compute/ServiceCloudServicesClassic
```

```text
include('azure-17/Item/Compute/ServiceCloudServicesClassic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Compute/ServiceCloudServicesClassic.png) | ![illustration for ServiceCloudServicesClassic](../../../azure-17/Item/Compute/ServiceCloudServicesClassic.Local.png) | ![illustration for ServiceCloudServicesClassicCard](../../../azure-17/Item/Compute/ServiceCloudServicesClassicCard.Local.png) | ![illustration for ServiceCloudServicesClassicGroup](../../../azure-17/Item/Compute/ServiceCloudServicesClassicGroup.Local.png) |
