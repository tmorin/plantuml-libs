...
```text
azure-17/Item/AppServices/ServiceCdnProfiles
```

```text
include('azure-17/Item/AppServices/ServiceCdnProfiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/AppServices/ServiceCdnProfiles.png) | ![illustration for ServiceCdnProfiles](../../../azure-17/Item/AppServices/ServiceCdnProfiles.Local.png) | ![illustration for ServiceCdnProfilesCard](../../../azure-17/Item/AppServices/ServiceCdnProfilesCard.Local.png) | ![illustration for ServiceCdnProfilesGroup](../../../azure-17/Item/AppServices/ServiceCdnProfilesGroup.Local.png) |
