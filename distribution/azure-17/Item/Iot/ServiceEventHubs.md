...
```text
azure-17/Item/Iot/ServiceEventHubs
```

```text
include('azure-17/Item/Iot/ServiceEventHubs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Iot/ServiceEventHubs.png) | ![illustration for ServiceEventHubs](../../../azure-17/Item/Iot/ServiceEventHubs.Local.png) | ![illustration for ServiceEventHubsCard](../../../azure-17/Item/Iot/ServiceEventHubsCard.Local.png) | ![illustration for ServiceEventHubsGroup](../../../azure-17/Item/Iot/ServiceEventHubsGroup.Local.png) |
