...
```text
azure-17/Item/Iot/ServiceStreamAnalyticsJobs
```

```text
include('azure-17/Item/Iot/ServiceStreamAnalyticsJobs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Iot/ServiceStreamAnalyticsJobs.png) | ![illustration for ServiceStreamAnalyticsJobs](../../../azure-17/Item/Iot/ServiceStreamAnalyticsJobs.Local.png) | ![illustration for ServiceStreamAnalyticsJobsCard](../../../azure-17/Item/Iot/ServiceStreamAnalyticsJobsCard.Local.png) | ![illustration for ServiceStreamAnalyticsJobsGroup](../../../azure-17/Item/Iot/ServiceStreamAnalyticsJobsGroup.Local.png) |
