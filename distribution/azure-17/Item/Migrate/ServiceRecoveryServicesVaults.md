...
```text
azure-17/Item/Migrate/ServiceRecoveryServicesVaults
```

```text
include('azure-17/Item/Migrate/ServiceRecoveryServicesVaults')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Migrate/ServiceRecoveryServicesVaults.png) | ![illustration for ServiceRecoveryServicesVaults](../../../azure-17/Item/Migrate/ServiceRecoveryServicesVaults.Local.png) | ![illustration for ServiceRecoveryServicesVaultsCard](../../../azure-17/Item/Migrate/ServiceRecoveryServicesVaultsCard.Local.png) | ![illustration for ServiceRecoveryServicesVaultsGroup](../../../azure-17/Item/Migrate/ServiceRecoveryServicesVaultsGroup.Local.png) |
