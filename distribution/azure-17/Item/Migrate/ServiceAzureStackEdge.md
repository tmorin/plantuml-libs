...
```text
azure-17/Item/Migrate/ServiceAzureStackEdge
```

```text
include('azure-17/Item/Migrate/ServiceAzureStackEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Migrate/ServiceAzureStackEdge.png) | ![illustration for ServiceAzureStackEdge](../../../azure-17/Item/Migrate/ServiceAzureStackEdge.Local.png) | ![illustration for ServiceAzureStackEdgeCard](../../../azure-17/Item/Migrate/ServiceAzureStackEdgeCard.Local.png) | ![illustration for ServiceAzureStackEdgeGroup](../../../azure-17/Item/Migrate/ServiceAzureStackEdgeGroup.Local.png) |
