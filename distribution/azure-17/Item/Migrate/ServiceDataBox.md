...
```text
azure-17/Item/Migrate/ServiceDataBox
```

```text
include('azure-17/Item/Migrate/ServiceDataBox')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Migrate/ServiceDataBox.png) | ![illustration for ServiceDataBox](../../../azure-17/Item/Migrate/ServiceDataBox.Local.png) | ![illustration for ServiceDataBoxCard](../../../azure-17/Item/Migrate/ServiceDataBoxCard.Local.png) | ![illustration for ServiceDataBoxGroup](../../../azure-17/Item/Migrate/ServiceDataBoxGroup.Local.png) |
