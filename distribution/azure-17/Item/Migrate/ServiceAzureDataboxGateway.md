...
```text
azure-17/Item/Migrate/ServiceAzureDataboxGateway
```

```text
include('azure-17/Item/Migrate/ServiceAzureDataboxGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Migrate/ServiceAzureDataboxGateway.png) | ![illustration for ServiceAzureDataboxGateway](../../../azure-17/Item/Migrate/ServiceAzureDataboxGateway.Local.png) | ![illustration for ServiceAzureDataboxGatewayCard](../../../azure-17/Item/Migrate/ServiceAzureDataboxGatewayCard.Local.png) | ![illustration for ServiceAzureDataboxGatewayGroup](../../../azure-17/Item/Migrate/ServiceAzureDataboxGatewayGroup.Local.png) |
