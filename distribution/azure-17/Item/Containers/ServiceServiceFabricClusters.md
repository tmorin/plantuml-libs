...
```text
azure-17/Item/Containers/ServiceServiceFabricClusters
```

```text
include('azure-17/Item/Containers/ServiceServiceFabricClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Containers/ServiceServiceFabricClusters.png) | ![illustration for ServiceServiceFabricClusters](../../../azure-17/Item/Containers/ServiceServiceFabricClusters.Local.png) | ![illustration for ServiceServiceFabricClustersCard](../../../azure-17/Item/Containers/ServiceServiceFabricClustersCard.Local.png) | ![illustration for ServiceServiceFabricClustersGroup](../../../azure-17/Item/Containers/ServiceServiceFabricClustersGroup.Local.png) |
