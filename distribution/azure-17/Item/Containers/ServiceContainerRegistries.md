...
```text
azure-17/Item/Containers/ServiceContainerRegistries
```

```text
include('azure-17/Item/Containers/ServiceContainerRegistries')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Containers/ServiceContainerRegistries.png) | ![illustration for ServiceContainerRegistries](../../../azure-17/Item/Containers/ServiceContainerRegistries.Local.png) | ![illustration for ServiceContainerRegistriesCard](../../../azure-17/Item/Containers/ServiceContainerRegistriesCard.Local.png) | ![illustration for ServiceContainerRegistriesGroup](../../../azure-17/Item/Containers/ServiceContainerRegistriesGroup.Local.png) |
