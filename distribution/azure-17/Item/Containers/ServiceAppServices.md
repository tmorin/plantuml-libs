...
```text
azure-17/Item/Containers/ServiceAppServices
```

```text
include('azure-17/Item/Containers/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Containers/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-17/Item/Containers/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-17/Item/Containers/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-17/Item/Containers/ServiceAppServicesGroup.Local.png) |
