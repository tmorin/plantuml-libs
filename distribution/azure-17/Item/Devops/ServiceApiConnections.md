...
```text
azure-17/Item/Devops/ServiceApiConnections
```

```text
include('azure-17/Item/Devops/ServiceApiConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Devops/ServiceApiConnections.png) | ![illustration for ServiceApiConnections](../../../azure-17/Item/Devops/ServiceApiConnections.Local.png) | ![illustration for ServiceApiConnectionsCard](../../../azure-17/Item/Devops/ServiceApiConnectionsCard.Local.png) | ![illustration for ServiceApiConnectionsGroup](../../../azure-17/Item/Devops/ServiceApiConnectionsGroup.Local.png) |
