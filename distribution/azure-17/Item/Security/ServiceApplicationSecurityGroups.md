...
```text
azure-17/Item/Security/ServiceApplicationSecurityGroups
```

```text
include('azure-17/Item/Security/ServiceApplicationSecurityGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Security/ServiceApplicationSecurityGroups.png) | ![illustration for ServiceApplicationSecurityGroups](../../../azure-17/Item/Security/ServiceApplicationSecurityGroups.Local.png) | ![illustration for ServiceApplicationSecurityGroupsCard](../../../azure-17/Item/Security/ServiceApplicationSecurityGroupsCard.Local.png) | ![illustration for ServiceApplicationSecurityGroupsGroup](../../../azure-17/Item/Security/ServiceApplicationSecurityGroupsGroup.Local.png) |
