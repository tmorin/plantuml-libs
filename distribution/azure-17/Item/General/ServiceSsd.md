...
```text
azure-17/Item/General/ServiceSsd
```

```text
include('azure-17/Item/General/ServiceSsd')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/General/ServiceSsd.png) | ![illustration for ServiceSsd](../../../azure-17/Item/General/ServiceSsd.Local.png) | ![illustration for ServiceSsdCard](../../../azure-17/Item/General/ServiceSsdCard.Local.png) | ![illustration for ServiceSsdGroup](../../../azure-17/Item/General/ServiceSsdGroup.Local.png) |
