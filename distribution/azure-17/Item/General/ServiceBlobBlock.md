...
```text
azure-17/Item/General/ServiceBlobBlock
```

```text
include('azure-17/Item/General/ServiceBlobBlock')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/General/ServiceBlobBlock.png) | ![illustration for ServiceBlobBlock](../../../azure-17/Item/General/ServiceBlobBlock.Local.png) | ![illustration for ServiceBlobBlockCard](../../../azure-17/Item/General/ServiceBlobBlockCard.Local.png) | ![illustration for ServiceBlobBlockGroup](../../../azure-17/Item/General/ServiceBlobBlockGroup.Local.png) |
