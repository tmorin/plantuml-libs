...
```text
azure-17/Item/General/ServiceBizTalk
```

```text
include('azure-17/Item/General/ServiceBizTalk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/General/ServiceBizTalk.png) | ![illustration for ServiceBizTalk](../../../azure-17/Item/General/ServiceBizTalk.Local.png) | ![illustration for ServiceBizTalkCard](../../../azure-17/Item/General/ServiceBizTalkCard.Local.png) | ![illustration for ServiceBizTalkGroup](../../../azure-17/Item/General/ServiceBizTalkGroup.Local.png) |
