...
```text
azure-17/Item/General/ServiceFtp
```

```text
include('azure-17/Item/General/ServiceFtp')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/General/ServiceFtp.png) | ![illustration for ServiceFtp](../../../azure-17/Item/General/ServiceFtp.Local.png) | ![illustration for ServiceFtpCard](../../../azure-17/Item/General/ServiceFtpCard.Local.png) | ![illustration for ServiceFtpGroup](../../../azure-17/Item/General/ServiceFtpGroup.Local.png) |
