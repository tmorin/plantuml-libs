...
```text
azure-17/Item/General/ServiceCostManagementAndBilling
```

```text
include('azure-17/Item/General/ServiceCostManagementAndBilling')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/General/ServiceCostManagementAndBilling.png) | ![illustration for ServiceCostManagementAndBilling](../../../azure-17/Item/General/ServiceCostManagementAndBilling.Local.png) | ![illustration for ServiceCostManagementAndBillingCard](../../../azure-17/Item/General/ServiceCostManagementAndBillingCard.Local.png) | ![illustration for ServiceCostManagementAndBillingGroup](../../../azure-17/Item/General/ServiceCostManagementAndBillingGroup.Local.png) |
