...
```text
azure-17/Item/General/ServiceSearchGrid
```

```text
include('azure-17/Item/General/ServiceSearchGrid')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/General/ServiceSearchGrid.png) | ![illustration for ServiceSearchGrid](../../../azure-17/Item/General/ServiceSearchGrid.Local.png) | ![illustration for ServiceSearchGridCard](../../../azure-17/Item/General/ServiceSearchGridCard.Local.png) | ![illustration for ServiceSearchGridGroup](../../../azure-17/Item/General/ServiceSearchGridGroup.Local.png) |
