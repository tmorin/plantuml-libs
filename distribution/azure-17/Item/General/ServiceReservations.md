...
```text
azure-17/Item/General/ServiceReservations
```

```text
include('azure-17/Item/General/ServiceReservations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/General/ServiceReservations.png) | ![illustration for ServiceReservations](../../../azure-17/Item/General/ServiceReservations.Local.png) | ![illustration for ServiceReservationsCard](../../../azure-17/Item/General/ServiceReservationsCard.Local.png) | ![illustration for ServiceReservationsGroup](../../../azure-17/Item/General/ServiceReservationsGroup.Local.png) |
