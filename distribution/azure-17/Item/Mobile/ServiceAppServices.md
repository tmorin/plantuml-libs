...
```text
azure-17/Item/Mobile/ServiceAppServices
```

```text
include('azure-17/Item/Mobile/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Mobile/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-17/Item/Mobile/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-17/Item/Mobile/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-17/Item/Mobile/ServiceAppServicesGroup.Local.png) |
