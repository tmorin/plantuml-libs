...
```text
azure-17/Item/Databases/ServiceAzureSqlServerStretchDatabases
```

```text
include('azure-17/Item/Databases/ServiceAzureSqlServerStretchDatabases')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Databases/ServiceAzureSqlServerStretchDatabases.png) | ![illustration for ServiceAzureSqlServerStretchDatabases](../../../azure-17/Item/Databases/ServiceAzureSqlServerStretchDatabases.Local.png) | ![illustration for ServiceAzureSqlServerStretchDatabasesCard](../../../azure-17/Item/Databases/ServiceAzureSqlServerStretchDatabasesCard.Local.png) | ![illustration for ServiceAzureSqlServerStretchDatabasesGroup](../../../azure-17/Item/Databases/ServiceAzureSqlServerStretchDatabasesGroup.Local.png) |
