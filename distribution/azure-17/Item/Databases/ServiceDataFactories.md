...
```text
azure-17/Item/Databases/ServiceDataFactories
```

```text
include('azure-17/Item/Databases/ServiceDataFactories')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Databases/ServiceDataFactories.png) | ![illustration for ServiceDataFactories](../../../azure-17/Item/Databases/ServiceDataFactories.Local.png) | ![illustration for ServiceDataFactoriesCard](../../../azure-17/Item/Databases/ServiceDataFactoriesCard.Local.png) | ![illustration for ServiceDataFactoriesGroup](../../../azure-17/Item/Databases/ServiceDataFactoriesGroup.Local.png) |
