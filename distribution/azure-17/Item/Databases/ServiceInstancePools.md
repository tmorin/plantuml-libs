...
```text
azure-17/Item/Databases/ServiceInstancePools
```

```text
include('azure-17/Item/Databases/ServiceInstancePools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Databases/ServiceInstancePools.png) | ![illustration for ServiceInstancePools](../../../azure-17/Item/Databases/ServiceInstancePools.Local.png) | ![illustration for ServiceInstancePoolsCard](../../../azure-17/Item/Databases/ServiceInstancePoolsCard.Local.png) | ![illustration for ServiceInstancePoolsGroup](../../../azure-17/Item/Databases/ServiceInstancePoolsGroup.Local.png) |
