...
```text
azure-17/Item/Databases/ServiceSqlDataWarehouses
```

```text
include('azure-17/Item/Databases/ServiceSqlDataWarehouses')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-17/Item/Databases/ServiceSqlDataWarehouses.png) | ![illustration for ServiceSqlDataWarehouses](../../../azure-17/Item/Databases/ServiceSqlDataWarehouses.Local.png) | ![illustration for ServiceSqlDataWarehousesCard](../../../azure-17/Item/Databases/ServiceSqlDataWarehousesCard.Local.png) | ![illustration for ServiceSqlDataWarehousesGroup](../../../azure-17/Item/Databases/ServiceSqlDataWarehousesGroup.Local.png) |
