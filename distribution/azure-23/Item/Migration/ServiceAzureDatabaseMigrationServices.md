...
```text
azure-23/Item/Migration/ServiceAzureDatabaseMigrationServices
```

```text
include('azure-23/Item/Migration/ServiceAzureDatabaseMigrationServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Migration/ServiceAzureDatabaseMigrationServices.png) | ![illustration for ServiceAzureDatabaseMigrationServices](../../../azure-23/Item/Migration/ServiceAzureDatabaseMigrationServices.Local.png) | ![illustration for ServiceAzureDatabaseMigrationServicesCard](../../../azure-23/Item/Migration/ServiceAzureDatabaseMigrationServicesCard.Local.png) | ![illustration for ServiceAzureDatabaseMigrationServicesGroup](../../../azure-23/Item/Migration/ServiceAzureDatabaseMigrationServicesGroup.Local.png) |
