...
```text
azure-23/Item/Web/ServiceCognitiveServices
```

```text
include('azure-23/Item/Web/ServiceCognitiveServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceCognitiveServices.png) | ![illustration for ServiceCognitiveServices](../../../azure-23/Item/Web/ServiceCognitiveServices.Local.png) | ![illustration for ServiceCognitiveServicesCard](../../../azure-23/Item/Web/ServiceCognitiveServicesCard.Local.png) | ![illustration for ServiceCognitiveServicesGroup](../../../azure-23/Item/Web/ServiceCognitiveServicesGroup.Local.png) |
