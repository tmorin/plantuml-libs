...
```text
azure-23/Item/Web/ServiceAppSpaceComponent
```

```text
include('azure-23/Item/Web/ServiceAppSpaceComponent')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceAppSpaceComponent.png) | ![illustration for ServiceAppSpaceComponent](../../../azure-23/Item/Web/ServiceAppSpaceComponent.Local.png) | ![illustration for ServiceAppSpaceComponentCard](../../../azure-23/Item/Web/ServiceAppSpaceComponentCard.Local.png) | ![illustration for ServiceAppSpaceComponentGroup](../../../azure-23/Item/Web/ServiceAppSpaceComponentGroup.Local.png) |
