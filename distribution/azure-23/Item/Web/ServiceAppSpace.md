...
```text
azure-23/Item/Web/ServiceAppSpace
```

```text
include('azure-23/Item/Web/ServiceAppSpace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceAppSpace.png) | ![illustration for ServiceAppSpace](../../../azure-23/Item/Web/ServiceAppSpace.Local.png) | ![illustration for ServiceAppSpaceCard](../../../azure-23/Item/Web/ServiceAppSpaceCard.Local.png) | ![illustration for ServiceAppSpaceGroup](../../../azure-23/Item/Web/ServiceAppSpaceGroup.Local.png) |
