...
```text
azure-23/Item/Web/ServiceApiManagementServices
```

```text
include('azure-23/Item/Web/ServiceApiManagementServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceApiManagementServices.png) | ![illustration for ServiceApiManagementServices](../../../azure-23/Item/Web/ServiceApiManagementServices.Local.png) | ![illustration for ServiceApiManagementServicesCard](../../../azure-23/Item/Web/ServiceApiManagementServicesCard.Local.png) | ![illustration for ServiceApiManagementServicesGroup](../../../azure-23/Item/Web/ServiceApiManagementServicesGroup.Local.png) |
