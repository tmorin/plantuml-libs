...
```text
azure-23/Item/Web/ServiceNotificationHubNamespaces
```

```text
include('azure-23/Item/Web/ServiceNotificationHubNamespaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceNotificationHubNamespaces.png) | ![illustration for ServiceNotificationHubNamespaces](../../../azure-23/Item/Web/ServiceNotificationHubNamespaces.Local.png) | ![illustration for ServiceNotificationHubNamespacesCard](../../../azure-23/Item/Web/ServiceNotificationHubNamespacesCard.Local.png) | ![illustration for ServiceNotificationHubNamespacesGroup](../../../azure-23/Item/Web/ServiceNotificationHubNamespacesGroup.Local.png) |
