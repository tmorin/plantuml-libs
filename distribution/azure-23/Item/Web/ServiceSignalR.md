...
```text
azure-23/Item/Web/ServiceSignalR
```

```text
include('azure-23/Item/Web/ServiceSignalR')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceSignalR.png) | ![illustration for ServiceSignalR](../../../azure-23/Item/Web/ServiceSignalR.Local.png) | ![illustration for ServiceSignalRCard](../../../azure-23/Item/Web/ServiceSignalRCard.Local.png) | ![illustration for ServiceSignalRGroup](../../../azure-23/Item/Web/ServiceSignalRGroup.Local.png) |
