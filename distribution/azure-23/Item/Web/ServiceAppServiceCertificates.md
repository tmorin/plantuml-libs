...
```text
azure-23/Item/Web/ServiceAppServiceCertificates
```

```text
include('azure-23/Item/Web/ServiceAppServiceCertificates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceAppServiceCertificates.png) | ![illustration for ServiceAppServiceCertificates](../../../azure-23/Item/Web/ServiceAppServiceCertificates.Local.png) | ![illustration for ServiceAppServiceCertificatesCard](../../../azure-23/Item/Web/ServiceAppServiceCertificatesCard.Local.png) | ![illustration for ServiceAppServiceCertificatesGroup](../../../azure-23/Item/Web/ServiceAppServiceCertificatesGroup.Local.png) |
