...
```text
azure-23/Item/Web/ServiceStaticApps
```

```text
include('azure-23/Item/Web/ServiceStaticApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceStaticApps.png) | ![illustration for ServiceStaticApps](../../../azure-23/Item/Web/ServiceStaticApps.Local.png) | ![illustration for ServiceStaticAppsCard](../../../azure-23/Item/Web/ServiceStaticAppsCard.Local.png) | ![illustration for ServiceStaticAppsGroup](../../../azure-23/Item/Web/ServiceStaticAppsGroup.Local.png) |
