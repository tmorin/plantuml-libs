...
```text
azure-23/Item/Web/ServiceFrontDoorAndCdnProfiles
```

```text
include('azure-23/Item/Web/ServiceFrontDoorAndCdnProfiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceFrontDoorAndCdnProfiles.png) | ![illustration for ServiceFrontDoorAndCdnProfiles](../../../azure-23/Item/Web/ServiceFrontDoorAndCdnProfiles.Local.png) | ![illustration for ServiceFrontDoorAndCdnProfilesCard](../../../azure-23/Item/Web/ServiceFrontDoorAndCdnProfilesCard.Local.png) | ![illustration for ServiceFrontDoorAndCdnProfilesGroup](../../../azure-23/Item/Web/ServiceFrontDoorAndCdnProfilesGroup.Local.png) |
