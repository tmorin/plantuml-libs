...
```text
azure-23/Item/Web/ServiceAppServices
```

```text
include('azure-23/Item/Web/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-23/Item/Web/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-23/Item/Web/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-23/Item/Web/ServiceAppServicesGroup.Local.png) |
