...
```text
azure-23/Item/Web/ServiceAzureMediaService
```

```text
include('azure-23/Item/Web/ServiceAzureMediaService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceAzureMediaService.png) | ![illustration for ServiceAzureMediaService](../../../azure-23/Item/Web/ServiceAzureMediaService.Local.png) | ![illustration for ServiceAzureMediaServiceCard](../../../azure-23/Item/Web/ServiceAzureMediaServiceCard.Local.png) | ![illustration for ServiceAzureMediaServiceGroup](../../../azure-23/Item/Web/ServiceAzureMediaServiceGroup.Local.png) |
