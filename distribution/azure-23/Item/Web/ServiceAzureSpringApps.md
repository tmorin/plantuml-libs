...
```text
azure-23/Item/Web/ServiceAzureSpringApps
```

```text
include('azure-23/Item/Web/ServiceAzureSpringApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceAzureSpringApps.png) | ![illustration for ServiceAzureSpringApps](../../../azure-23/Item/Web/ServiceAzureSpringApps.Local.png) | ![illustration for ServiceAzureSpringAppsCard](../../../azure-23/Item/Web/ServiceAzureSpringAppsCard.Local.png) | ![illustration for ServiceAzureSpringAppsGroup](../../../azure-23/Item/Web/ServiceAzureSpringAppsGroup.Local.png) |
