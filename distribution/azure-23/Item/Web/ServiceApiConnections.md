...
```text
azure-23/Item/Web/ServiceApiConnections
```

```text
include('azure-23/Item/Web/ServiceApiConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceApiConnections.png) | ![illustration for ServiceApiConnections](../../../azure-23/Item/Web/ServiceApiConnections.Local.png) | ![illustration for ServiceApiConnectionsCard](../../../azure-23/Item/Web/ServiceApiConnectionsCard.Local.png) | ![illustration for ServiceApiConnectionsGroup](../../../azure-23/Item/Web/ServiceApiConnectionsGroup.Local.png) |
