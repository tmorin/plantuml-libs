...
```text
azure-23/Item/Web/ServiceAppServicePlans
```

```text
include('azure-23/Item/Web/ServiceAppServicePlans')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceAppServicePlans.png) | ![illustration for ServiceAppServicePlans](../../../azure-23/Item/Web/ServiceAppServicePlans.Local.png) | ![illustration for ServiceAppServicePlansCard](../../../azure-23/Item/Web/ServiceAppServicePlansCard.Local.png) | ![illustration for ServiceAppServicePlansGroup](../../../azure-23/Item/Web/ServiceAppServicePlansGroup.Local.png) |
