...
```text
azure-23/Item/Web/ServiceAppServiceDomains
```

```text
include('azure-23/Item/Web/ServiceAppServiceDomains')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Web/ServiceAppServiceDomains.png) | ![illustration for ServiceAppServiceDomains](../../../azure-23/Item/Web/ServiceAppServiceDomains.Local.png) | ![illustration for ServiceAppServiceDomainsCard](../../../azure-23/Item/Web/ServiceAppServiceDomainsCard.Local.png) | ![illustration for ServiceAppServiceDomainsGroup](../../../azure-23/Item/Web/ServiceAppServiceDomainsGroup.Local.png) |
