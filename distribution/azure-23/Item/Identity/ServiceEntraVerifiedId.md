...
```text
azure-23/Item/Identity/ServiceEntraVerifiedId
```

```text
include('azure-23/Item/Identity/ServiceEntraVerifiedId')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceEntraVerifiedId.png) | ![illustration for ServiceEntraVerifiedId](../../../azure-23/Item/Identity/ServiceEntraVerifiedId.Local.png) | ![illustration for ServiceEntraVerifiedIdCard](../../../azure-23/Item/Identity/ServiceEntraVerifiedIdCard.Local.png) | ![illustration for ServiceEntraVerifiedIdGroup](../../../azure-23/Item/Identity/ServiceEntraVerifiedIdGroup.Local.png) |
