...
```text
azure-23/Item/Identity/ServiceManagedIdentities
```

```text
include('azure-23/Item/Identity/ServiceManagedIdentities')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceManagedIdentities.png) | ![illustration for ServiceManagedIdentities](../../../azure-23/Item/Identity/ServiceManagedIdentities.Local.png) | ![illustration for ServiceManagedIdentitiesCard](../../../azure-23/Item/Identity/ServiceManagedIdentitiesCard.Local.png) | ![illustration for ServiceManagedIdentitiesGroup](../../../azure-23/Item/Identity/ServiceManagedIdentitiesGroup.Local.png) |
