...
```text
azure-23/Item/Identity/ServiceMultiFactorAuthentication
```

```text
include('azure-23/Item/Identity/ServiceMultiFactorAuthentication')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceMultiFactorAuthentication.png) | ![illustration for ServiceMultiFactorAuthentication](../../../azure-23/Item/Identity/ServiceMultiFactorAuthentication.Local.png) | ![illustration for ServiceMultiFactorAuthenticationCard](../../../azure-23/Item/Identity/ServiceMultiFactorAuthenticationCard.Local.png) | ![illustration for ServiceMultiFactorAuthenticationGroup](../../../azure-23/Item/Identity/ServiceMultiFactorAuthenticationGroup.Local.png) |
