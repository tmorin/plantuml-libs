...
```text
azure-23/Item/Identity/ServiceActiveDirectoryConnectHealth
```

```text
include('azure-23/Item/Identity/ServiceActiveDirectoryConnectHealth')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceActiveDirectoryConnectHealth.png) | ![illustration for ServiceActiveDirectoryConnectHealth](../../../azure-23/Item/Identity/ServiceActiveDirectoryConnectHealth.Local.png) | ![illustration for ServiceActiveDirectoryConnectHealthCard](../../../azure-23/Item/Identity/ServiceActiveDirectoryConnectHealthCard.Local.png) | ![illustration for ServiceActiveDirectoryConnectHealthGroup](../../../azure-23/Item/Identity/ServiceActiveDirectoryConnectHealthGroup.Local.png) |
