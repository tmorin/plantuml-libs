...
```text
azure-23/Item/Identity/ServiceEntraPrivateAccess
```

```text
include('azure-23/Item/Identity/ServiceEntraPrivateAccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceEntraPrivateAccess.png) | ![illustration for ServiceEntraPrivateAccess](../../../azure-23/Item/Identity/ServiceEntraPrivateAccess.Local.png) | ![illustration for ServiceEntraPrivateAccessCard](../../../azure-23/Item/Identity/ServiceEntraPrivateAccessCard.Local.png) | ![illustration for ServiceEntraPrivateAccessGroup](../../../azure-23/Item/Identity/ServiceEntraPrivateAccessGroup.Local.png) |
