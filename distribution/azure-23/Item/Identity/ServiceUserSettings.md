...
```text
azure-23/Item/Identity/ServiceUserSettings
```

```text
include('azure-23/Item/Identity/ServiceUserSettings')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceUserSettings.png) | ![illustration for ServiceUserSettings](../../../azure-23/Item/Identity/ServiceUserSettings.Local.png) | ![illustration for ServiceUserSettingsCard](../../../azure-23/Item/Identity/ServiceUserSettingsCard.Local.png) | ![illustration for ServiceUserSettingsGroup](../../../azure-23/Item/Identity/ServiceUserSettingsGroup.Local.png) |
