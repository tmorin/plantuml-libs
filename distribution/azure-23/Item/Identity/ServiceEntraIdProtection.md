...
```text
azure-23/Item/Identity/ServiceEntraIdProtection
```

```text
include('azure-23/Item/Identity/ServiceEntraIdProtection')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceEntraIdProtection.png) | ![illustration for ServiceEntraIdProtection](../../../azure-23/Item/Identity/ServiceEntraIdProtection.Local.png) | ![illustration for ServiceEntraIdProtectionCard](../../../azure-23/Item/Identity/ServiceEntraIdProtectionCard.Local.png) | ![illustration for ServiceEntraIdProtectionGroup](../../../azure-23/Item/Identity/ServiceEntraIdProtectionGroup.Local.png) |
