...
```text
azure-23/Item/Identity/ServiceEnterpriseApplications
```

```text
include('azure-23/Item/Identity/ServiceEnterpriseApplications')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceEnterpriseApplications.png) | ![illustration for ServiceEnterpriseApplications](../../../azure-23/Item/Identity/ServiceEnterpriseApplications.Local.png) | ![illustration for ServiceEnterpriseApplicationsCard](../../../azure-23/Item/Identity/ServiceEnterpriseApplicationsCard.Local.png) | ![illustration for ServiceEnterpriseApplicationsGroup](../../../azure-23/Item/Identity/ServiceEnterpriseApplicationsGroup.Local.png) |
