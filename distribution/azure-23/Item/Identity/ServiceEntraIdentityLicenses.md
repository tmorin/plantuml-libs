...
```text
azure-23/Item/Identity/ServiceEntraIdentityLicenses
```

```text
include('azure-23/Item/Identity/ServiceEntraIdentityLicenses')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceEntraIdentityLicenses.png) | ![illustration for ServiceEntraIdentityLicenses](../../../azure-23/Item/Identity/ServiceEntraIdentityLicenses.Local.png) | ![illustration for ServiceEntraIdentityLicensesCard](../../../azure-23/Item/Identity/ServiceEntraIdentityLicensesCard.Local.png) | ![illustration for ServiceEntraIdentityLicensesGroup](../../../azure-23/Item/Identity/ServiceEntraIdentityLicensesGroup.Local.png) |
