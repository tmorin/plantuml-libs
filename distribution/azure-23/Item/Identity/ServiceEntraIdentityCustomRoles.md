...
```text
azure-23/Item/Identity/ServiceEntraIdentityCustomRoles
```

```text
include('azure-23/Item/Identity/ServiceEntraIdentityCustomRoles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceEntraIdentityCustomRoles.png) | ![illustration for ServiceEntraIdentityCustomRoles](../../../azure-23/Item/Identity/ServiceEntraIdentityCustomRoles.Local.png) | ![illustration for ServiceEntraIdentityCustomRolesCard](../../../azure-23/Item/Identity/ServiceEntraIdentityCustomRolesCard.Local.png) | ![illustration for ServiceEntraIdentityCustomRolesGroup](../../../azure-23/Item/Identity/ServiceEntraIdentityCustomRolesGroup.Local.png) |
