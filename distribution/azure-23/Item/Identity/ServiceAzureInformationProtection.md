...
```text
azure-23/Item/Identity/ServiceAzureInformationProtection
```

```text
include('azure-23/Item/Identity/ServiceAzureInformationProtection')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceAzureInformationProtection.png) | ![illustration for ServiceAzureInformationProtection](../../../azure-23/Item/Identity/ServiceAzureInformationProtection.Local.png) | ![illustration for ServiceAzureInformationProtectionCard](../../../azure-23/Item/Identity/ServiceAzureInformationProtectionCard.Local.png) | ![illustration for ServiceAzureInformationProtectionGroup](../../../azure-23/Item/Identity/ServiceAzureInformationProtectionGroup.Local.png) |
