...
```text
azure-23/Item/Identity/ServiceEntraConnectHealth
```

```text
include('azure-23/Item/Identity/ServiceEntraConnectHealth')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceEntraConnectHealth.png) | ![illustration for ServiceEntraConnectHealth](../../../azure-23/Item/Identity/ServiceEntraConnectHealth.Local.png) | ![illustration for ServiceEntraConnectHealthCard](../../../azure-23/Item/Identity/ServiceEntraConnectHealthCard.Local.png) | ![illustration for ServiceEntraConnectHealthGroup](../../../azure-23/Item/Identity/ServiceEntraConnectHealthGroup.Local.png) |
