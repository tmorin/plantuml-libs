...
```text
azure-23/Item/Identity/ServiceApiProxy
```

```text
include('azure-23/Item/Identity/ServiceApiProxy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceApiProxy.png) | ![illustration for ServiceApiProxy](../../../azure-23/Item/Identity/ServiceApiProxy.Local.png) | ![illustration for ServiceApiProxyCard](../../../azure-23/Item/Identity/ServiceApiProxyCard.Local.png) | ![illustration for ServiceApiProxyGroup](../../../azure-23/Item/Identity/ServiceApiProxyGroup.Local.png) |
