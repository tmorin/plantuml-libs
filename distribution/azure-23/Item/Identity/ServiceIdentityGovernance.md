...
```text
azure-23/Item/Identity/ServiceIdentityGovernance
```

```text
include('azure-23/Item/Identity/ServiceIdentityGovernance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceIdentityGovernance.png) | ![illustration for ServiceIdentityGovernance](../../../azure-23/Item/Identity/ServiceIdentityGovernance.Local.png) | ![illustration for ServiceIdentityGovernanceCard](../../../azure-23/Item/Identity/ServiceIdentityGovernanceCard.Local.png) | ![illustration for ServiceIdentityGovernanceGroup](../../../azure-23/Item/Identity/ServiceIdentityGovernanceGroup.Local.png) |
