...
```text
azure-23/Item/Identity/ServiceGroups
```

```text
include('azure-23/Item/Identity/ServiceGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceGroups.png) | ![illustration for ServiceGroups](../../../azure-23/Item/Identity/ServiceGroups.Local.png) | ![illustration for ServiceGroupsCard](../../../azure-23/Item/Identity/ServiceGroupsCard.Local.png) | ![illustration for ServiceGroupsGroup](../../../azure-23/Item/Identity/ServiceGroupsGroup.Local.png) |
