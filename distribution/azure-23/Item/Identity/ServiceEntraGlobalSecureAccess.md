...
```text
azure-23/Item/Identity/ServiceEntraGlobalSecureAccess
```

```text
include('azure-23/Item/Identity/ServiceEntraGlobalSecureAccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceEntraGlobalSecureAccess.png) | ![illustration for ServiceEntraGlobalSecureAccess](../../../azure-23/Item/Identity/ServiceEntraGlobalSecureAccess.Local.png) | ![illustration for ServiceEntraGlobalSecureAccessCard](../../../azure-23/Item/Identity/ServiceEntraGlobalSecureAccessCard.Local.png) | ![illustration for ServiceEntraGlobalSecureAccessGroup](../../../azure-23/Item/Identity/ServiceEntraGlobalSecureAccessGroup.Local.png) |
