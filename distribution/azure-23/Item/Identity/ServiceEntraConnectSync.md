...
```text
azure-23/Item/Identity/ServiceEntraConnectSync
```

```text
include('azure-23/Item/Identity/ServiceEntraConnectSync')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceEntraConnectSync.png) | ![illustration for ServiceEntraConnectSync](../../../azure-23/Item/Identity/ServiceEntraConnectSync.Local.png) | ![illustration for ServiceEntraConnectSyncCard](../../../azure-23/Item/Identity/ServiceEntraConnectSyncCard.Local.png) | ![illustration for ServiceEntraConnectSyncGroup](../../../azure-23/Item/Identity/ServiceEntraConnectSyncGroup.Local.png) |
