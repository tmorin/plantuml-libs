...
```text
azure-23/Item/Identity/ServiceVerifiableCredentials
```

```text
include('azure-23/Item/Identity/ServiceVerifiableCredentials')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceVerifiableCredentials.png) | ![illustration for ServiceVerifiableCredentials](../../../azure-23/Item/Identity/ServiceVerifiableCredentials.Local.png) | ![illustration for ServiceVerifiableCredentialsCard](../../../azure-23/Item/Identity/ServiceVerifiableCredentialsCard.Local.png) | ![illustration for ServiceVerifiableCredentialsGroup](../../../azure-23/Item/Identity/ServiceVerifiableCredentialsGroup.Local.png) |
