...
```text
azure-23/Item/Identity/ServiceAdministrativeUnits
```

```text
include('azure-23/Item/Identity/ServiceAdministrativeUnits')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceAdministrativeUnits.png) | ![illustration for ServiceAdministrativeUnits](../../../azure-23/Item/Identity/ServiceAdministrativeUnits.Local.png) | ![illustration for ServiceAdministrativeUnitsCard](../../../azure-23/Item/Identity/ServiceAdministrativeUnitsCard.Local.png) | ![illustration for ServiceAdministrativeUnitsGroup](../../../azure-23/Item/Identity/ServiceAdministrativeUnitsGroup.Local.png) |
