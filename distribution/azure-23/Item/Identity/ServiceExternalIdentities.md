...
```text
azure-23/Item/Identity/ServiceExternalIdentities
```

```text
include('azure-23/Item/Identity/ServiceExternalIdentities')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceExternalIdentities.png) | ![illustration for ServiceExternalIdentities](../../../azure-23/Item/Identity/ServiceExternalIdentities.Local.png) | ![illustration for ServiceExternalIdentitiesCard](../../../azure-23/Item/Identity/ServiceExternalIdentitiesCard.Local.png) | ![illustration for ServiceExternalIdentitiesGroup](../../../azure-23/Item/Identity/ServiceExternalIdentitiesGroup.Local.png) |
