...
```text
azure-23/Item/Identity/ServiceTenantProperties
```

```text
include('azure-23/Item/Identity/ServiceTenantProperties')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceTenantProperties.png) | ![illustration for ServiceTenantProperties](../../../azure-23/Item/Identity/ServiceTenantProperties.Local.png) | ![illustration for ServiceTenantPropertiesCard](../../../azure-23/Item/Identity/ServiceTenantPropertiesCard.Local.png) | ![illustration for ServiceTenantPropertiesGroup](../../../azure-23/Item/Identity/ServiceTenantPropertiesGroup.Local.png) |
