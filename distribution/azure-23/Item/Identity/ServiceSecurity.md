...
```text
azure-23/Item/Identity/ServiceSecurity
```

```text
include('azure-23/Item/Identity/ServiceSecurity')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceSecurity.png) | ![illustration for ServiceSecurity](../../../azure-23/Item/Identity/ServiceSecurity.Local.png) | ![illustration for ServiceSecurityCard](../../../azure-23/Item/Identity/ServiceSecurityCard.Local.png) | ![illustration for ServiceSecurityGroup](../../../azure-23/Item/Identity/ServiceSecurityGroup.Local.png) |
