...
```text
azure-23/Item/Identity/ServiceUsers
```

```text
include('azure-23/Item/Identity/ServiceUsers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceUsers.png) | ![illustration for ServiceUsers](../../../azure-23/Item/Identity/ServiceUsers.Local.png) | ![illustration for ServiceUsersCard](../../../azure-23/Item/Identity/ServiceUsersCard.Local.png) | ![illustration for ServiceUsersGroup](../../../azure-23/Item/Identity/ServiceUsersGroup.Local.png) |
