...
```text
azure-23/Item/Identity/ServiceAzureAdB2C
```

```text
include('azure-23/Item/Identity/ServiceAzureAdB2C')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceAzureAdB2C.png) | ![illustration for ServiceAzureAdB2C](../../../azure-23/Item/Identity/ServiceAzureAdB2C.Local.png) | ![illustration for ServiceAzureAdB2CCard](../../../azure-23/Item/Identity/ServiceAzureAdB2CCard.Local.png) | ![illustration for ServiceAzureAdB2CGroup](../../../azure-23/Item/Identity/ServiceAzureAdB2CGroup.Local.png) |
