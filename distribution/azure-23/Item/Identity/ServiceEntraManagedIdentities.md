...
```text
azure-23/Item/Identity/ServiceEntraManagedIdentities
```

```text
include('azure-23/Item/Identity/ServiceEntraManagedIdentities')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Identity/ServiceEntraManagedIdentities.png) | ![illustration for ServiceEntraManagedIdentities](../../../azure-23/Item/Identity/ServiceEntraManagedIdentities.Local.png) | ![illustration for ServiceEntraManagedIdentitiesCard](../../../azure-23/Item/Identity/ServiceEntraManagedIdentitiesCard.Local.png) | ![illustration for ServiceEntraManagedIdentitiesGroup](../../../azure-23/Item/Identity/ServiceEntraManagedIdentitiesGroup.Local.png) |
