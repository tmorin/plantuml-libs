...
```text
azure-23/Item/Compute/ServiceAppServices
```

```text
include('azure-23/Item/Compute/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-23/Item/Compute/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-23/Item/Compute/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-23/Item/Compute/ServiceAppServicesGroup.Local.png) |
