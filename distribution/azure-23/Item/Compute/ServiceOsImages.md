...
```text
azure-23/Item/Compute/ServiceOsImages
```

```text
include('azure-23/Item/Compute/ServiceOsImages')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceOsImages.png) | ![illustration for ServiceOsImages](../../../azure-23/Item/Compute/ServiceOsImages.Local.png) | ![illustration for ServiceOsImagesCard](../../../azure-23/Item/Compute/ServiceOsImagesCard.Local.png) | ![illustration for ServiceOsImagesGroup](../../../azure-23/Item/Compute/ServiceOsImagesGroup.Local.png) |
