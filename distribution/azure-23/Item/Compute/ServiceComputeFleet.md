...
```text
azure-23/Item/Compute/ServiceComputeFleet
```

```text
include('azure-23/Item/Compute/ServiceComputeFleet')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceComputeFleet.png) | ![illustration for ServiceComputeFleet](../../../azure-23/Item/Compute/ServiceComputeFleet.Local.png) | ![illustration for ServiceComputeFleetCard](../../../azure-23/Item/Compute/ServiceComputeFleetCard.Local.png) | ![illustration for ServiceComputeFleetGroup](../../../azure-23/Item/Compute/ServiceComputeFleetGroup.Local.png) |
