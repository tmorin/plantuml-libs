...
```text
azure-23/Item/Compute/ServiceImages
```

```text
include('azure-23/Item/Compute/ServiceImages')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceImages.png) | ![illustration for ServiceImages](../../../azure-23/Item/Compute/ServiceImages.Local.png) | ![illustration for ServiceImagesCard](../../../azure-23/Item/Compute/ServiceImagesCard.Local.png) | ![illustration for ServiceImagesGroup](../../../azure-23/Item/Compute/ServiceImagesGroup.Local.png) |
