...
```text
azure-23/Item/Compute/ServiceDisksSnapshots
```

```text
include('azure-23/Item/Compute/ServiceDisksSnapshots')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceDisksSnapshots.png) | ![illustration for ServiceDisksSnapshots](../../../azure-23/Item/Compute/ServiceDisksSnapshots.Local.png) | ![illustration for ServiceDisksSnapshotsCard](../../../azure-23/Item/Compute/ServiceDisksSnapshotsCard.Local.png) | ![illustration for ServiceDisksSnapshotsGroup](../../../azure-23/Item/Compute/ServiceDisksSnapshotsGroup.Local.png) |
