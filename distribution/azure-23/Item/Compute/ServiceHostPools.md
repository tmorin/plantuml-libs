...
```text
azure-23/Item/Compute/ServiceHostPools
```

```text
include('azure-23/Item/Compute/ServiceHostPools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceHostPools.png) | ![illustration for ServiceHostPools](../../../azure-23/Item/Compute/ServiceHostPools.Local.png) | ![illustration for ServiceHostPoolsCard](../../../azure-23/Item/Compute/ServiceHostPoolsCard.Local.png) | ![illustration for ServiceHostPoolsGroup](../../../azure-23/Item/Compute/ServiceHostPoolsGroup.Local.png) |
