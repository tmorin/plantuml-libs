...
```text
azure-23/Item/Compute/ServiceDisks
```

```text
include('azure-23/Item/Compute/ServiceDisks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceDisks.png) | ![illustration for ServiceDisks](../../../azure-23/Item/Compute/ServiceDisks.Local.png) | ![illustration for ServiceDisksCard](../../../azure-23/Item/Compute/ServiceDisksCard.Local.png) | ![illustration for ServiceDisksGroup](../../../azure-23/Item/Compute/ServiceDisksGroup.Local.png) |
