...
```text
azure-23/Item/Compute/ServiceHostGroups
```

```text
include('azure-23/Item/Compute/ServiceHostGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceHostGroups.png) | ![illustration for ServiceHostGroups](../../../azure-23/Item/Compute/ServiceHostGroups.Local.png) | ![illustration for ServiceHostGroupsCard](../../../azure-23/Item/Compute/ServiceHostGroupsCard.Local.png) | ![illustration for ServiceHostGroupsGroup](../../../azure-23/Item/Compute/ServiceHostGroupsGroup.Local.png) |
