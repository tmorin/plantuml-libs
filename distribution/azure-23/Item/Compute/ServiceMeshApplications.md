...
```text
azure-23/Item/Compute/ServiceMeshApplications
```

```text
include('azure-23/Item/Compute/ServiceMeshApplications')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceMeshApplications.png) | ![illustration for ServiceMeshApplications](../../../azure-23/Item/Compute/ServiceMeshApplications.Local.png) | ![illustration for ServiceMeshApplicationsCard](../../../azure-23/Item/Compute/ServiceMeshApplicationsCard.Local.png) | ![illustration for ServiceMeshApplicationsGroup](../../../azure-23/Item/Compute/ServiceMeshApplicationsGroup.Local.png) |
