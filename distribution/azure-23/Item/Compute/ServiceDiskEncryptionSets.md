...
```text
azure-23/Item/Compute/ServiceDiskEncryptionSets
```

```text
include('azure-23/Item/Compute/ServiceDiskEncryptionSets')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceDiskEncryptionSets.png) | ![illustration for ServiceDiskEncryptionSets](../../../azure-23/Item/Compute/ServiceDiskEncryptionSets.Local.png) | ![illustration for ServiceDiskEncryptionSetsCard](../../../azure-23/Item/Compute/ServiceDiskEncryptionSetsCard.Local.png) | ![illustration for ServiceDiskEncryptionSetsGroup](../../../azure-23/Item/Compute/ServiceDiskEncryptionSetsGroup.Local.png) |
