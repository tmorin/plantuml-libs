...
```text
azure-23/Item/Compute/ServiceImageVersions
```

```text
include('azure-23/Item/Compute/ServiceImageVersions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceImageVersions.png) | ![illustration for ServiceImageVersions](../../../azure-23/Item/Compute/ServiceImageVersions.Local.png) | ![illustration for ServiceImageVersionsCard](../../../azure-23/Item/Compute/ServiceImageVersionsCard.Local.png) | ![illustration for ServiceImageVersionsGroup](../../../azure-23/Item/Compute/ServiceImageVersionsGroup.Local.png) |
