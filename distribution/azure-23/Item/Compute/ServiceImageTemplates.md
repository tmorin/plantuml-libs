...
```text
azure-23/Item/Compute/ServiceImageTemplates
```

```text
include('azure-23/Item/Compute/ServiceImageTemplates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceImageTemplates.png) | ![illustration for ServiceImageTemplates](../../../azure-23/Item/Compute/ServiceImageTemplates.Local.png) | ![illustration for ServiceImageTemplatesCard](../../../azure-23/Item/Compute/ServiceImageTemplatesCard.Local.png) | ![illustration for ServiceImageTemplatesGroup](../../../azure-23/Item/Compute/ServiceImageTemplatesGroup.Local.png) |
