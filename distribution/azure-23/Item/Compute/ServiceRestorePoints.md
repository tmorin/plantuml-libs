...
```text
azure-23/Item/Compute/ServiceRestorePoints
```

```text
include('azure-23/Item/Compute/ServiceRestorePoints')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceRestorePoints.png) | ![illustration for ServiceRestorePoints](../../../azure-23/Item/Compute/ServiceRestorePoints.Local.png) | ![illustration for ServiceRestorePointsCard](../../../azure-23/Item/Compute/ServiceRestorePointsCard.Local.png) | ![illustration for ServiceRestorePointsGroup](../../../azure-23/Item/Compute/ServiceRestorePointsGroup.Local.png) |
