...
```text
azure-23/Item/Compute/ServiceAzureComputeGalleries
```

```text
include('azure-23/Item/Compute/ServiceAzureComputeGalleries')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceAzureComputeGalleries.png) | ![illustration for ServiceAzureComputeGalleries](../../../azure-23/Item/Compute/ServiceAzureComputeGalleries.Local.png) | ![illustration for ServiceAzureComputeGalleriesCard](../../../azure-23/Item/Compute/ServiceAzureComputeGalleriesCard.Local.png) | ![illustration for ServiceAzureComputeGalleriesGroup](../../../azure-23/Item/Compute/ServiceAzureComputeGalleriesGroup.Local.png) |
