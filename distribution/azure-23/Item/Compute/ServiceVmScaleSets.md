...
```text
azure-23/Item/Compute/ServiceVmScaleSets
```

```text
include('azure-23/Item/Compute/ServiceVmScaleSets')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceVmScaleSets.png) | ![illustration for ServiceVmScaleSets](../../../azure-23/Item/Compute/ServiceVmScaleSets.Local.png) | ![illustration for ServiceVmScaleSetsCard](../../../azure-23/Item/Compute/ServiceVmScaleSetsCard.Local.png) | ![illustration for ServiceVmScaleSetsGroup](../../../azure-23/Item/Compute/ServiceVmScaleSetsGroup.Local.png) |
