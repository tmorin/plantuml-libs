...
```text
azure-23/Item/Compute/ServiceAksAutomatic
```

```text
include('azure-23/Item/Compute/ServiceAksAutomatic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceAksAutomatic.png) | ![illustration for ServiceAksAutomatic](../../../azure-23/Item/Compute/ServiceAksAutomatic.Local.png) | ![illustration for ServiceAksAutomaticCard](../../../azure-23/Item/Compute/ServiceAksAutomaticCard.Local.png) | ![illustration for ServiceAksAutomaticGroup](../../../azure-23/Item/Compute/ServiceAksAutomaticGroup.Local.png) |
