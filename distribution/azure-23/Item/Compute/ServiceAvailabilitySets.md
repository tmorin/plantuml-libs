...
```text
azure-23/Item/Compute/ServiceAvailabilitySets
```

```text
include('azure-23/Item/Compute/ServiceAvailabilitySets')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceAvailabilitySets.png) | ![illustration for ServiceAvailabilitySets](../../../azure-23/Item/Compute/ServiceAvailabilitySets.Local.png) | ![illustration for ServiceAvailabilitySetsCard](../../../azure-23/Item/Compute/ServiceAvailabilitySetsCard.Local.png) | ![illustration for ServiceAvailabilitySetsGroup](../../../azure-23/Item/Compute/ServiceAvailabilitySetsGroup.Local.png) |
