...
```text
azure-23/Item/Compute/ServiceServiceFabricClusters
```

```text
include('azure-23/Item/Compute/ServiceServiceFabricClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceServiceFabricClusters.png) | ![illustration for ServiceServiceFabricClusters](../../../azure-23/Item/Compute/ServiceServiceFabricClusters.Local.png) | ![illustration for ServiceServiceFabricClustersCard](../../../azure-23/Item/Compute/ServiceServiceFabricClustersCard.Local.png) | ![illustration for ServiceServiceFabricClustersGroup](../../../azure-23/Item/Compute/ServiceServiceFabricClustersGroup.Local.png) |
