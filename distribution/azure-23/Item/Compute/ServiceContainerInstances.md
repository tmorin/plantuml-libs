...
```text
azure-23/Item/Compute/ServiceContainerInstances
```

```text
include('azure-23/Item/Compute/ServiceContainerInstances')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceContainerInstances.png) | ![illustration for ServiceContainerInstances](../../../azure-23/Item/Compute/ServiceContainerInstances.Local.png) | ![illustration for ServiceContainerInstancesCard](../../../azure-23/Item/Compute/ServiceContainerInstancesCard.Local.png) | ![illustration for ServiceContainerInstancesGroup](../../../azure-23/Item/Compute/ServiceContainerInstancesGroup.Local.png) |
