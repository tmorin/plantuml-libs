...
```text
azure-23/Item/Compute/ServiceAutomanagedVm
```

```text
include('azure-23/Item/Compute/ServiceAutomanagedVm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceAutomanagedVm.png) | ![illustration for ServiceAutomanagedVm](../../../azure-23/Item/Compute/ServiceAutomanagedVm.Local.png) | ![illustration for ServiceAutomanagedVmCard](../../../azure-23/Item/Compute/ServiceAutomanagedVmCard.Local.png) | ![illustration for ServiceAutomanagedVmGroup](../../../azure-23/Item/Compute/ServiceAutomanagedVmGroup.Local.png) |
