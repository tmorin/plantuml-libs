...
```text
azure-23/Item/Compute/ServiceImageDefinitions
```

```text
include('azure-23/Item/Compute/ServiceImageDefinitions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceImageDefinitions.png) | ![illustration for ServiceImageDefinitions](../../../azure-23/Item/Compute/ServiceImageDefinitions.Local.png) | ![illustration for ServiceImageDefinitionsCard](../../../azure-23/Item/Compute/ServiceImageDefinitionsCard.Local.png) | ![illustration for ServiceImageDefinitionsGroup](../../../azure-23/Item/Compute/ServiceImageDefinitionsGroup.Local.png) |
