...
```text
azure-23/Item/Compute/ServiceApplicationGroup
```

```text
include('azure-23/Item/Compute/ServiceApplicationGroup')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceApplicationGroup.png) | ![illustration for ServiceApplicationGroup](../../../azure-23/Item/Compute/ServiceApplicationGroup.Local.png) | ![illustration for ServiceApplicationGroupCard](../../../azure-23/Item/Compute/ServiceApplicationGroupCard.Local.png) | ![illustration for ServiceApplicationGroupGroup](../../../azure-23/Item/Compute/ServiceApplicationGroupGroup.Local.png) |
