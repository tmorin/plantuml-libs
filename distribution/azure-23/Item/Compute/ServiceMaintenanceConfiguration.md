...
```text
azure-23/Item/Compute/ServiceMaintenanceConfiguration
```

```text
include('azure-23/Item/Compute/ServiceMaintenanceConfiguration')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceMaintenanceConfiguration.png) | ![illustration for ServiceMaintenanceConfiguration](../../../azure-23/Item/Compute/ServiceMaintenanceConfiguration.Local.png) | ![illustration for ServiceMaintenanceConfigurationCard](../../../azure-23/Item/Compute/ServiceMaintenanceConfigurationCard.Local.png) | ![illustration for ServiceMaintenanceConfigurationGroup](../../../azure-23/Item/Compute/ServiceMaintenanceConfigurationGroup.Local.png) |
