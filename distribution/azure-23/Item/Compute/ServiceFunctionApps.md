...
```text
azure-23/Item/Compute/ServiceFunctionApps
```

```text
include('azure-23/Item/Compute/ServiceFunctionApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceFunctionApps.png) | ![illustration for ServiceFunctionApps](../../../azure-23/Item/Compute/ServiceFunctionApps.Local.png) | ![illustration for ServiceFunctionAppsCard](../../../azure-23/Item/Compute/ServiceFunctionAppsCard.Local.png) | ![illustration for ServiceFunctionAppsGroup](../../../azure-23/Item/Compute/ServiceFunctionAppsGroup.Local.png) |
