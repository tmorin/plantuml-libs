...
```text
azure-23/Item/Compute/ServiceHosts
```

```text
include('azure-23/Item/Compute/ServiceHosts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Compute/ServiceHosts.png) | ![illustration for ServiceHosts](../../../azure-23/Item/Compute/ServiceHosts.Local.png) | ![illustration for ServiceHostsCard](../../../azure-23/Item/Compute/ServiceHostsCard.Local.png) | ![illustration for ServiceHostsGroup](../../../azure-23/Item/Compute/ServiceHostsGroup.Local.png) |
