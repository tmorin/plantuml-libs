...
```text
azure-23/Item/Blockchain/ServiceAzureTokenService
```

```text
include('azure-23/Item/Blockchain/ServiceAzureTokenService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Blockchain/ServiceAzureTokenService.png) | ![illustration for ServiceAzureTokenService](../../../azure-23/Item/Blockchain/ServiceAzureTokenService.Local.png) | ![illustration for ServiceAzureTokenServiceCard](../../../azure-23/Item/Blockchain/ServiceAzureTokenServiceCard.Local.png) | ![illustration for ServiceAzureTokenServiceGroup](../../../azure-23/Item/Blockchain/ServiceAzureTokenServiceGroup.Local.png) |
