...
```text
azure-23/Item/Blockchain/ServiceBlockchainApplications
```

```text
include('azure-23/Item/Blockchain/ServiceBlockchainApplications')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Blockchain/ServiceBlockchainApplications.png) | ![illustration for ServiceBlockchainApplications](../../../azure-23/Item/Blockchain/ServiceBlockchainApplications.Local.png) | ![illustration for ServiceBlockchainApplicationsCard](../../../azure-23/Item/Blockchain/ServiceBlockchainApplicationsCard.Local.png) | ![illustration for ServiceBlockchainApplicationsGroup](../../../azure-23/Item/Blockchain/ServiceBlockchainApplicationsGroup.Local.png) |
