...
```text
azure-23/Item/Blockchain/ServiceAbsMember
```

```text
include('azure-23/Item/Blockchain/ServiceAbsMember')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Blockchain/ServiceAbsMember.png) | ![illustration for ServiceAbsMember](../../../azure-23/Item/Blockchain/ServiceAbsMember.Local.png) | ![illustration for ServiceAbsMemberCard](../../../azure-23/Item/Blockchain/ServiceAbsMemberCard.Local.png) | ![illustration for ServiceAbsMemberGroup](../../../azure-23/Item/Blockchain/ServiceAbsMemberGroup.Local.png) |
