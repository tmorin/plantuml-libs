...
```text
azure-23/Item/Blockchain/ServiceConsortium
```

```text
include('azure-23/Item/Blockchain/ServiceConsortium')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Blockchain/ServiceConsortium.png) | ![illustration for ServiceConsortium](../../../azure-23/Item/Blockchain/ServiceConsortium.Local.png) | ![illustration for ServiceConsortiumCard](../../../azure-23/Item/Blockchain/ServiceConsortiumCard.Local.png) | ![illustration for ServiceConsortiumGroup](../../../azure-23/Item/Blockchain/ServiceConsortiumGroup.Local.png) |
