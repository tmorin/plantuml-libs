...
```text
azure-23/Item/Iot/ServiceEventHubs
```

```text
include('azure-23/Item/Iot/ServiceEventHubs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceEventHubs.png) | ![illustration for ServiceEventHubs](../../../azure-23/Item/Iot/ServiceEventHubs.Local.png) | ![illustration for ServiceEventHubsCard](../../../azure-23/Item/Iot/ServiceEventHubsCard.Local.png) | ![illustration for ServiceEventHubsGroup](../../../azure-23/Item/Iot/ServiceEventHubsGroup.Local.png) |
