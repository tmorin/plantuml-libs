...
```text
azure-23/Item/Iot/ServiceEventHubClusters
```

```text
include('azure-23/Item/Iot/ServiceEventHubClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceEventHubClusters.png) | ![illustration for ServiceEventHubClusters](../../../azure-23/Item/Iot/ServiceEventHubClusters.Local.png) | ![illustration for ServiceEventHubClustersCard](../../../azure-23/Item/Iot/ServiceEventHubClustersCard.Local.png) | ![illustration for ServiceEventHubClustersGroup](../../../azure-23/Item/Iot/ServiceEventHubClustersGroup.Local.png) |
