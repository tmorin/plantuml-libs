...
```text
azure-23/Item/Iot/ServiceIoTEdge
```

```text
include('azure-23/Item/Iot/ServiceIoTEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceIoTEdge.png) | ![illustration for ServiceIoTEdge](../../../azure-23/Item/Iot/ServiceIoTEdge.Local.png) | ![illustration for ServiceIoTEdgeCard](../../../azure-23/Item/Iot/ServiceIoTEdgeCard.Local.png) | ![illustration for ServiceIoTEdgeGroup](../../../azure-23/Item/Iot/ServiceIoTEdgeGroup.Local.png) |
