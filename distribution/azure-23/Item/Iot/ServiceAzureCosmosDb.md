...
```text
azure-23/Item/Iot/ServiceAzureCosmosDb
```

```text
include('azure-23/Item/Iot/ServiceAzureCosmosDb')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceAzureCosmosDb.png) | ![illustration for ServiceAzureCosmosDb](../../../azure-23/Item/Iot/ServiceAzureCosmosDb.Local.png) | ![illustration for ServiceAzureCosmosDbCard](../../../azure-23/Item/Iot/ServiceAzureCosmosDbCard.Local.png) | ![illustration for ServiceAzureCosmosDbGroup](../../../azure-23/Item/Iot/ServiceAzureCosmosDbGroup.Local.png) |
