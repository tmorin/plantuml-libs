...
```text
azure-23/Item/Iot/ServiceTimeSeriesInsightsEnvironments
```

```text
include('azure-23/Item/Iot/ServiceTimeSeriesInsightsEnvironments')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceTimeSeriesInsightsEnvironments.png) | ![illustration for ServiceTimeSeriesInsightsEnvironments](../../../azure-23/Item/Iot/ServiceTimeSeriesInsightsEnvironments.Local.png) | ![illustration for ServiceTimeSeriesInsightsEnvironmentsCard](../../../azure-23/Item/Iot/ServiceTimeSeriesInsightsEnvironmentsCard.Local.png) | ![illustration for ServiceTimeSeriesInsightsEnvironmentsGroup](../../../azure-23/Item/Iot/ServiceTimeSeriesInsightsEnvironmentsGroup.Local.png) |
