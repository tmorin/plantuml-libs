...
```text
azure-23/Item/Iot/ServiceLogicApps
```

```text
include('azure-23/Item/Iot/ServiceLogicApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceLogicApps.png) | ![illustration for ServiceLogicApps](../../../azure-23/Item/Iot/ServiceLogicApps.Local.png) | ![illustration for ServiceLogicAppsCard](../../../azure-23/Item/Iot/ServiceLogicAppsCard.Local.png) | ![illustration for ServiceLogicAppsGroup](../../../azure-23/Item/Iot/ServiceLogicAppsGroup.Local.png) |
