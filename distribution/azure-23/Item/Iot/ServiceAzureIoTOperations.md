...
```text
azure-23/Item/Iot/ServiceAzureIoTOperations
```

```text
include('azure-23/Item/Iot/ServiceAzureIoTOperations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceAzureIoTOperations.png) | ![illustration for ServiceAzureIoTOperations](../../../azure-23/Item/Iot/ServiceAzureIoTOperations.Local.png) | ![illustration for ServiceAzureIoTOperationsCard](../../../azure-23/Item/Iot/ServiceAzureIoTOperationsCard.Local.png) | ![illustration for ServiceAzureIoTOperationsGroup](../../../azure-23/Item/Iot/ServiceAzureIoTOperationsGroup.Local.png) |
