...
```text
azure-23/Item/Iot/ServiceNotificationHubNamespaces
```

```text
include('azure-23/Item/Iot/ServiceNotificationHubNamespaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceNotificationHubNamespaces.png) | ![illustration for ServiceNotificationHubNamespaces](../../../azure-23/Item/Iot/ServiceNotificationHubNamespaces.Local.png) | ![illustration for ServiceNotificationHubNamespacesCard](../../../azure-23/Item/Iot/ServiceNotificationHubNamespacesCard.Local.png) | ![illustration for ServiceNotificationHubNamespacesGroup](../../../azure-23/Item/Iot/ServiceNotificationHubNamespacesGroup.Local.png) |
