...
```text
azure-23/Item/Iot/ServiceAzureStackHciSizer
```

```text
include('azure-23/Item/Iot/ServiceAzureStackHciSizer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceAzureStackHciSizer.png) | ![illustration for ServiceAzureStackHciSizer](../../../azure-23/Item/Iot/ServiceAzureStackHciSizer.Local.png) | ![illustration for ServiceAzureStackHciSizerCard](../../../azure-23/Item/Iot/ServiceAzureStackHciSizerCard.Local.png) | ![illustration for ServiceAzureStackHciSizerGroup](../../../azure-23/Item/Iot/ServiceAzureStackHciSizerGroup.Local.png) |
