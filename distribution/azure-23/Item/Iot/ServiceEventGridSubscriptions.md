...
```text
azure-23/Item/Iot/ServiceEventGridSubscriptions
```

```text
include('azure-23/Item/Iot/ServiceEventGridSubscriptions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceEventGridSubscriptions.png) | ![illustration for ServiceEventGridSubscriptions](../../../azure-23/Item/Iot/ServiceEventGridSubscriptions.Local.png) | ![illustration for ServiceEventGridSubscriptionsCard](../../../azure-23/Item/Iot/ServiceEventGridSubscriptionsCard.Local.png) | ![illustration for ServiceEventGridSubscriptionsGroup](../../../azure-23/Item/Iot/ServiceEventGridSubscriptionsGroup.Local.png) |
