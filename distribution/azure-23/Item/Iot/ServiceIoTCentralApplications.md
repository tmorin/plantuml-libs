...
```text
azure-23/Item/Iot/ServiceIoTCentralApplications
```

```text
include('azure-23/Item/Iot/ServiceIoTCentralApplications')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceIoTCentralApplications.png) | ![illustration for ServiceIoTCentralApplications](../../../azure-23/Item/Iot/ServiceIoTCentralApplications.Local.png) | ![illustration for ServiceIoTCentralApplicationsCard](../../../azure-23/Item/Iot/ServiceIoTCentralApplicationsCard.Local.png) | ![illustration for ServiceIoTCentralApplicationsGroup](../../../azure-23/Item/Iot/ServiceIoTCentralApplicationsGroup.Local.png) |
