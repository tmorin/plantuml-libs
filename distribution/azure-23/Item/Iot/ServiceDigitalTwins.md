...
```text
azure-23/Item/Iot/ServiceDigitalTwins
```

```text
include('azure-23/Item/Iot/ServiceDigitalTwins')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceDigitalTwins.png) | ![illustration for ServiceDigitalTwins](../../../azure-23/Item/Iot/ServiceDigitalTwins.Local.png) | ![illustration for ServiceDigitalTwinsCard](../../../azure-23/Item/Iot/ServiceDigitalTwinsCard.Local.png) | ![illustration for ServiceDigitalTwinsGroup](../../../azure-23/Item/Iot/ServiceDigitalTwinsGroup.Local.png) |
