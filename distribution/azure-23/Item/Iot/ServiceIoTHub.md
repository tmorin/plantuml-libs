...
```text
azure-23/Item/Iot/ServiceIoTHub
```

```text
include('azure-23/Item/Iot/ServiceIoTHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceIoTHub.png) | ![illustration for ServiceIoTHub](../../../azure-23/Item/Iot/ServiceIoTHub.Local.png) | ![illustration for ServiceIoTHubCard](../../../azure-23/Item/Iot/ServiceIoTHubCard.Local.png) | ![illustration for ServiceIoTHubGroup](../../../azure-23/Item/Iot/ServiceIoTHubGroup.Local.png) |
