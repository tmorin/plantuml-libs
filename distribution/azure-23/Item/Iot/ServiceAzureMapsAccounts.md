...
```text
azure-23/Item/Iot/ServiceAzureMapsAccounts
```

```text
include('azure-23/Item/Iot/ServiceAzureMapsAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceAzureMapsAccounts.png) | ![illustration for ServiceAzureMapsAccounts](../../../azure-23/Item/Iot/ServiceAzureMapsAccounts.Local.png) | ![illustration for ServiceAzureMapsAccountsCard](../../../azure-23/Item/Iot/ServiceAzureMapsAccountsCard.Local.png) | ![illustration for ServiceAzureMapsAccountsGroup](../../../azure-23/Item/Iot/ServiceAzureMapsAccountsGroup.Local.png) |
