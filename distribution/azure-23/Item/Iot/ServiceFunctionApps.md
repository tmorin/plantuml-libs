...
```text
azure-23/Item/Iot/ServiceFunctionApps
```

```text
include('azure-23/Item/Iot/ServiceFunctionApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceFunctionApps.png) | ![illustration for ServiceFunctionApps](../../../azure-23/Item/Iot/ServiceFunctionApps.Local.png) | ![illustration for ServiceFunctionAppsCard](../../../azure-23/Item/Iot/ServiceFunctionAppsCard.Local.png) | ![illustration for ServiceFunctionAppsGroup](../../../azure-23/Item/Iot/ServiceFunctionAppsGroup.Local.png) |
