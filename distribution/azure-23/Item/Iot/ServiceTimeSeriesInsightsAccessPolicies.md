...
```text
azure-23/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies
```

```text
include('azure-23/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies.png) | ![illustration for ServiceTimeSeriesInsightsAccessPolicies](../../../azure-23/Item/Iot/ServiceTimeSeriesInsightsAccessPolicies.Local.png) | ![illustration for ServiceTimeSeriesInsightsAccessPoliciesCard](../../../azure-23/Item/Iot/ServiceTimeSeriesInsightsAccessPoliciesCard.Local.png) | ![illustration for ServiceTimeSeriesInsightsAccessPoliciesGroup](../../../azure-23/Item/Iot/ServiceTimeSeriesInsightsAccessPoliciesGroup.Local.png) |
