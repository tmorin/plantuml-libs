...
```text
azure-23/Item/Iot/ServiceStreamAnalyticsJobs
```

```text
include('azure-23/Item/Iot/ServiceStreamAnalyticsJobs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceStreamAnalyticsJobs.png) | ![illustration for ServiceStreamAnalyticsJobs](../../../azure-23/Item/Iot/ServiceStreamAnalyticsJobs.Local.png) | ![illustration for ServiceStreamAnalyticsJobsCard](../../../azure-23/Item/Iot/ServiceStreamAnalyticsJobsCard.Local.png) | ![illustration for ServiceStreamAnalyticsJobsGroup](../../../azure-23/Item/Iot/ServiceStreamAnalyticsJobsGroup.Local.png) |
