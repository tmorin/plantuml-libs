...
```text
azure-23/Item/Iot/ServiceAzureStack
```

```text
include('azure-23/Item/Iot/ServiceAzureStack')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Iot/ServiceAzureStack.png) | ![illustration for ServiceAzureStack](../../../azure-23/Item/Iot/ServiceAzureStack.Local.png) | ![illustration for ServiceAzureStackCard](../../../azure-23/Item/Iot/ServiceAzureStackCard.Local.png) | ![illustration for ServiceAzureStackGroup](../../../azure-23/Item/Iot/ServiceAzureStackGroup.Local.png) |
