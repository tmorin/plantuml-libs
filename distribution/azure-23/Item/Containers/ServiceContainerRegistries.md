...
```text
azure-23/Item/Containers/ServiceContainerRegistries
```

```text
include('azure-23/Item/Containers/ServiceContainerRegistries')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Containers/ServiceContainerRegistries.png) | ![illustration for ServiceContainerRegistries](../../../azure-23/Item/Containers/ServiceContainerRegistries.Local.png) | ![illustration for ServiceContainerRegistriesCard](../../../azure-23/Item/Containers/ServiceContainerRegistriesCard.Local.png) | ![illustration for ServiceContainerRegistriesGroup](../../../azure-23/Item/Containers/ServiceContainerRegistriesGroup.Local.png) |
