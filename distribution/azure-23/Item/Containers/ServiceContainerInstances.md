...
```text
azure-23/Item/Containers/ServiceContainerInstances
```

```text
include('azure-23/Item/Containers/ServiceContainerInstances')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Containers/ServiceContainerInstances.png) | ![illustration for ServiceContainerInstances](../../../azure-23/Item/Containers/ServiceContainerInstances.Local.png) | ![illustration for ServiceContainerInstancesCard](../../../azure-23/Item/Containers/ServiceContainerInstancesCard.Local.png) | ![illustration for ServiceContainerInstancesGroup](../../../azure-23/Item/Containers/ServiceContainerInstancesGroup.Local.png) |
