...
```text
azure-23/Item/Containers/ServiceAzureRedHatOpenShift
```

```text
include('azure-23/Item/Containers/ServiceAzureRedHatOpenShift')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Containers/ServiceAzureRedHatOpenShift.png) | ![illustration for ServiceAzureRedHatOpenShift](../../../azure-23/Item/Containers/ServiceAzureRedHatOpenShift.Local.png) | ![illustration for ServiceAzureRedHatOpenShiftCard](../../../azure-23/Item/Containers/ServiceAzureRedHatOpenShiftCard.Local.png) | ![illustration for ServiceAzureRedHatOpenShiftGroup](../../../azure-23/Item/Containers/ServiceAzureRedHatOpenShiftGroup.Local.png) |
