...
```text
azure-23/Item/Containers/ServiceServiceFabricClusters
```

```text
include('azure-23/Item/Containers/ServiceServiceFabricClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Containers/ServiceServiceFabricClusters.png) | ![illustration for ServiceServiceFabricClusters](../../../azure-23/Item/Containers/ServiceServiceFabricClusters.Local.png) | ![illustration for ServiceServiceFabricClustersCard](../../../azure-23/Item/Containers/ServiceServiceFabricClustersCard.Local.png) | ![illustration for ServiceServiceFabricClustersGroup](../../../azure-23/Item/Containers/ServiceServiceFabricClustersGroup.Local.png) |
