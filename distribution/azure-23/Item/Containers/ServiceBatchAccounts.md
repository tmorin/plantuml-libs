...
```text
azure-23/Item/Containers/ServiceBatchAccounts
```

```text
include('azure-23/Item/Containers/ServiceBatchAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Containers/ServiceBatchAccounts.png) | ![illustration for ServiceBatchAccounts](../../../azure-23/Item/Containers/ServiceBatchAccounts.Local.png) | ![illustration for ServiceBatchAccountsCard](../../../azure-23/Item/Containers/ServiceBatchAccountsCard.Local.png) | ![illustration for ServiceBatchAccountsGroup](../../../azure-23/Item/Containers/ServiceBatchAccountsGroup.Local.png) |
