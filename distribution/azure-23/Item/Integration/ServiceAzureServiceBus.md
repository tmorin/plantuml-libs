...
```text
azure-23/Item/Integration/ServiceAzureServiceBus
```

```text
include('azure-23/Item/Integration/ServiceAzureServiceBus')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceAzureServiceBus.png) | ![illustration for ServiceAzureServiceBus](../../../azure-23/Item/Integration/ServiceAzureServiceBus.Local.png) | ![illustration for ServiceAzureServiceBusCard](../../../azure-23/Item/Integration/ServiceAzureServiceBusCard.Local.png) | ![illustration for ServiceAzureServiceBusGroup](../../../azure-23/Item/Integration/ServiceAzureServiceBusGroup.Local.png) |
