...
```text
azure-23/Item/Integration/ServiceLogicApps
```

```text
include('azure-23/Item/Integration/ServiceLogicApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceLogicApps.png) | ![illustration for ServiceLogicApps](../../../azure-23/Item/Integration/ServiceLogicApps.Local.png) | ![illustration for ServiceLogicAppsCard](../../../azure-23/Item/Integration/ServiceLogicAppsCard.Local.png) | ![illustration for ServiceLogicAppsGroup](../../../azure-23/Item/Integration/ServiceLogicAppsGroup.Local.png) |
