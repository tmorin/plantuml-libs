...
```text
azure-23/Item/Integration/ServicePartnerNamespace
```

```text
include('azure-23/Item/Integration/ServicePartnerNamespace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServicePartnerNamespace.png) | ![illustration for ServicePartnerNamespace](../../../azure-23/Item/Integration/ServicePartnerNamespace.Local.png) | ![illustration for ServicePartnerNamespaceCard](../../../azure-23/Item/Integration/ServicePartnerNamespaceCard.Local.png) | ![illustration for ServicePartnerNamespaceGroup](../../../azure-23/Item/Integration/ServicePartnerNamespaceGroup.Local.png) |
