...
```text
azure-23/Item/Integration/ServiceApiConnections
```

```text
include('azure-23/Item/Integration/ServiceApiConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceApiConnections.png) | ![illustration for ServiceApiConnections](../../../azure-23/Item/Integration/ServiceApiConnections.Local.png) | ![illustration for ServiceApiConnectionsCard](../../../azure-23/Item/Integration/ServiceApiConnectionsCard.Local.png) | ![illustration for ServiceApiConnectionsGroup](../../../azure-23/Item/Integration/ServiceApiConnectionsGroup.Local.png) |
