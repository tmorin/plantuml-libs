...
```text
azure-23/Item/Integration/ServiceIntegrationAccounts
```

```text
include('azure-23/Item/Integration/ServiceIntegrationAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceIntegrationAccounts.png) | ![illustration for ServiceIntegrationAccounts](../../../azure-23/Item/Integration/ServiceIntegrationAccounts.Local.png) | ![illustration for ServiceIntegrationAccountsCard](../../../azure-23/Item/Integration/ServiceIntegrationAccountsCard.Local.png) | ![illustration for ServiceIntegrationAccountsGroup](../../../azure-23/Item/Integration/ServiceIntegrationAccountsGroup.Local.png) |
