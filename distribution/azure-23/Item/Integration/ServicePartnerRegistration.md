...
```text
azure-23/Item/Integration/ServicePartnerRegistration
```

```text
include('azure-23/Item/Integration/ServicePartnerRegistration')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServicePartnerRegistration.png) | ![illustration for ServicePartnerRegistration](../../../azure-23/Item/Integration/ServicePartnerRegistration.Local.png) | ![illustration for ServicePartnerRegistrationCard](../../../azure-23/Item/Integration/ServicePartnerRegistrationCard.Local.png) | ![illustration for ServicePartnerRegistrationGroup](../../../azure-23/Item/Integration/ServicePartnerRegistrationGroup.Local.png) |
