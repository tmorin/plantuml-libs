...
```text
azure-23/Item/Integration/ServiceSoftwareAsAService
```

```text
include('azure-23/Item/Integration/ServiceSoftwareAsAService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceSoftwareAsAService.png) | ![illustration for ServiceSoftwareAsAService](../../../azure-23/Item/Integration/ServiceSoftwareAsAService.Local.png) | ![illustration for ServiceSoftwareAsAServiceCard](../../../azure-23/Item/Integration/ServiceSoftwareAsAServiceCard.Local.png) | ![illustration for ServiceSoftwareAsAServiceGroup](../../../azure-23/Item/Integration/ServiceSoftwareAsAServiceGroup.Local.png) |
