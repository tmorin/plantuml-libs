...
```text
azure-23/Item/Integration/ServiceStorSimpleDeviceManagers
```

```text
include('azure-23/Item/Integration/ServiceStorSimpleDeviceManagers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceStorSimpleDeviceManagers.png) | ![illustration for ServiceStorSimpleDeviceManagers](../../../azure-23/Item/Integration/ServiceStorSimpleDeviceManagers.Local.png) | ![illustration for ServiceStorSimpleDeviceManagersCard](../../../azure-23/Item/Integration/ServiceStorSimpleDeviceManagersCard.Local.png) | ![illustration for ServiceStorSimpleDeviceManagersGroup](../../../azure-23/Item/Integration/ServiceStorSimpleDeviceManagersGroup.Local.png) |
