...
```text
azure-23/Item/Integration/ServiceLogicAppsCustomConnector
```

```text
include('azure-23/Item/Integration/ServiceLogicAppsCustomConnector')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceLogicAppsCustomConnector.png) | ![illustration for ServiceLogicAppsCustomConnector](../../../azure-23/Item/Integration/ServiceLogicAppsCustomConnector.Local.png) | ![illustration for ServiceLogicAppsCustomConnectorCard](../../../azure-23/Item/Integration/ServiceLogicAppsCustomConnectorCard.Local.png) | ![illustration for ServiceLogicAppsCustomConnectorGroup](../../../azure-23/Item/Integration/ServiceLogicAppsCustomConnectorGroup.Local.png) |
