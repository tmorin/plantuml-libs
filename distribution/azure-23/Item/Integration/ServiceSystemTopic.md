...
```text
azure-23/Item/Integration/ServiceSystemTopic
```

```text
include('azure-23/Item/Integration/ServiceSystemTopic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceSystemTopic.png) | ![illustration for ServiceSystemTopic](../../../azure-23/Item/Integration/ServiceSystemTopic.Local.png) | ![illustration for ServiceSystemTopicCard](../../../azure-23/Item/Integration/ServiceSystemTopicCard.Local.png) | ![illustration for ServiceSystemTopicGroup](../../../azure-23/Item/Integration/ServiceSystemTopicGroup.Local.png) |
