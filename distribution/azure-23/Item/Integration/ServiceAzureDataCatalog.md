...
```text
azure-23/Item/Integration/ServiceAzureDataCatalog
```

```text
include('azure-23/Item/Integration/ServiceAzureDataCatalog')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceAzureDataCatalog.png) | ![illustration for ServiceAzureDataCatalog](../../../azure-23/Item/Integration/ServiceAzureDataCatalog.Local.png) | ![illustration for ServiceAzureDataCatalogCard](../../../azure-23/Item/Integration/ServiceAzureDataCatalogCard.Local.png) | ![illustration for ServiceAzureDataCatalogGroup](../../../azure-23/Item/Integration/ServiceAzureDataCatalogGroup.Local.png) |
