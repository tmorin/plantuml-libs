...
```text
azure-23/Item/Integration/ServiceAzureStackEdge
```

```text
include('azure-23/Item/Integration/ServiceAzureStackEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceAzureStackEdge.png) | ![illustration for ServiceAzureStackEdge](../../../azure-23/Item/Integration/ServiceAzureStackEdge.Local.png) | ![illustration for ServiceAzureStackEdgeCard](../../../azure-23/Item/Integration/ServiceAzureStackEdgeCard.Local.png) | ![illustration for ServiceAzureStackEdgeGroup](../../../azure-23/Item/Integration/ServiceAzureStackEdgeGroup.Local.png) |
