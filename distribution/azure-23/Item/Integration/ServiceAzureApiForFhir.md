...
```text
azure-23/Item/Integration/ServiceAzureApiForFhir
```

```text
include('azure-23/Item/Integration/ServiceAzureApiForFhir')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceAzureApiForFhir.png) | ![illustration for ServiceAzureApiForFhir](../../../azure-23/Item/Integration/ServiceAzureApiForFhir.Local.png) | ![illustration for ServiceAzureApiForFhirCard](../../../azure-23/Item/Integration/ServiceAzureApiForFhirCard.Local.png) | ![illustration for ServiceAzureApiForFhirGroup](../../../azure-23/Item/Integration/ServiceAzureApiForFhirGroup.Local.png) |
