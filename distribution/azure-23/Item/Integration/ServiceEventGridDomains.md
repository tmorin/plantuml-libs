...
```text
azure-23/Item/Integration/ServiceEventGridDomains
```

```text
include('azure-23/Item/Integration/ServiceEventGridDomains')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceEventGridDomains.png) | ![illustration for ServiceEventGridDomains](../../../azure-23/Item/Integration/ServiceEventGridDomains.Local.png) | ![illustration for ServiceEventGridDomainsCard](../../../azure-23/Item/Integration/ServiceEventGridDomainsCard.Local.png) | ![illustration for ServiceEventGridDomainsGroup](../../../azure-23/Item/Integration/ServiceEventGridDomainsGroup.Local.png) |
