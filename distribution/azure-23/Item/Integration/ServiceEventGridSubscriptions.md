...
```text
azure-23/Item/Integration/ServiceEventGridSubscriptions
```

```text
include('azure-23/Item/Integration/ServiceEventGridSubscriptions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceEventGridSubscriptions.png) | ![illustration for ServiceEventGridSubscriptions](../../../azure-23/Item/Integration/ServiceEventGridSubscriptions.Local.png) | ![illustration for ServiceEventGridSubscriptionsCard](../../../azure-23/Item/Integration/ServiceEventGridSubscriptionsCard.Local.png) | ![illustration for ServiceEventGridSubscriptionsGroup](../../../azure-23/Item/Integration/ServiceEventGridSubscriptionsGroup.Local.png) |
