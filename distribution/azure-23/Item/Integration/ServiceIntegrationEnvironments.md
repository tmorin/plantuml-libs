...
```text
azure-23/Item/Integration/ServiceIntegrationEnvironments
```

```text
include('azure-23/Item/Integration/ServiceIntegrationEnvironments')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceIntegrationEnvironments.png) | ![illustration for ServiceIntegrationEnvironments](../../../azure-23/Item/Integration/ServiceIntegrationEnvironments.Local.png) | ![illustration for ServiceIntegrationEnvironmentsCard](../../../azure-23/Item/Integration/ServiceIntegrationEnvironmentsCard.Local.png) | ![illustration for ServiceIntegrationEnvironmentsGroup](../../../azure-23/Item/Integration/ServiceIntegrationEnvironmentsGroup.Local.png) |
