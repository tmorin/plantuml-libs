...
```text
azure-23/Item/Integration/ServiceDataFactories
```

```text
include('azure-23/Item/Integration/ServiceDataFactories')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceDataFactories.png) | ![illustration for ServiceDataFactories](../../../azure-23/Item/Integration/ServiceDataFactories.Local.png) | ![illustration for ServiceDataFactoriesCard](../../../azure-23/Item/Integration/ServiceDataFactoriesCard.Local.png) | ![illustration for ServiceDataFactoriesGroup](../../../azure-23/Item/Integration/ServiceDataFactoriesGroup.Local.png) |
