...
```text
azure-23/Item/Integration/ServicePartnerTopic
```

```text
include('azure-23/Item/Integration/ServicePartnerTopic')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServicePartnerTopic.png) | ![illustration for ServicePartnerTopic](../../../azure-23/Item/Integration/ServicePartnerTopic.Local.png) | ![illustration for ServicePartnerTopicCard](../../../azure-23/Item/Integration/ServicePartnerTopicCard.Local.png) | ![illustration for ServicePartnerTopicGroup](../../../azure-23/Item/Integration/ServicePartnerTopicGroup.Local.png) |
