...
```text
azure-23/Item/Integration/ServiceSendGridAccounts
```

```text
include('azure-23/Item/Integration/ServiceSendGridAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceSendGridAccounts.png) | ![illustration for ServiceSendGridAccounts](../../../azure-23/Item/Integration/ServiceSendGridAccounts.Local.png) | ![illustration for ServiceSendGridAccountsCard](../../../azure-23/Item/Integration/ServiceSendGridAccountsCard.Local.png) | ![illustration for ServiceSendGridAccountsGroup](../../../azure-23/Item/Integration/ServiceSendGridAccountsGroup.Local.png) |
