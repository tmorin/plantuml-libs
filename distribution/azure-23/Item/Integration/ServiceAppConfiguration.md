...
```text
azure-23/Item/Integration/ServiceAppConfiguration
```

```text
include('azure-23/Item/Integration/ServiceAppConfiguration')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceAppConfiguration.png) | ![illustration for ServiceAppConfiguration](../../../azure-23/Item/Integration/ServiceAppConfiguration.Local.png) | ![illustration for ServiceAppConfigurationCard](../../../azure-23/Item/Integration/ServiceAppConfigurationCard.Local.png) | ![illustration for ServiceAppConfigurationGroup](../../../azure-23/Item/Integration/ServiceAppConfigurationGroup.Local.png) |
