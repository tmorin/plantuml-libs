...
```text
azure-23/Item/Integration/ServiceApiManagementServices
```

```text
include('azure-23/Item/Integration/ServiceApiManagementServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceApiManagementServices.png) | ![illustration for ServiceApiManagementServices](../../../azure-23/Item/Integration/ServiceApiManagementServices.Local.png) | ![illustration for ServiceApiManagementServicesCard](../../../azure-23/Item/Integration/ServiceApiManagementServicesCard.Local.png) | ![illustration for ServiceApiManagementServicesGroup](../../../azure-23/Item/Integration/ServiceApiManagementServicesGroup.Local.png) |
