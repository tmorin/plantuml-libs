...
```text
azure-23/Item/Integration/ServicePowerPlatform
```

```text
include('azure-23/Item/Integration/ServicePowerPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServicePowerPlatform.png) | ![illustration for ServicePowerPlatform](../../../azure-23/Item/Integration/ServicePowerPlatform.Local.png) | ![illustration for ServicePowerPlatformCard](../../../azure-23/Item/Integration/ServicePowerPlatformCard.Local.png) | ![illustration for ServicePowerPlatformGroup](../../../azure-23/Item/Integration/ServicePowerPlatformGroup.Local.png) |
