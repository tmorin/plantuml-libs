...
```text
azure-23/Item/Integration/ServiceRelays
```

```text
include('azure-23/Item/Integration/ServiceRelays')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceRelays.png) | ![illustration for ServiceRelays](../../../azure-23/Item/Integration/ServiceRelays.Local.png) | ![illustration for ServiceRelaysCard](../../../azure-23/Item/Integration/ServiceRelaysCard.Local.png) | ![illustration for ServiceRelaysGroup](../../../azure-23/Item/Integration/ServiceRelaysGroup.Local.png) |
