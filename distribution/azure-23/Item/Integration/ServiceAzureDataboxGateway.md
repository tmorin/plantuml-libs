...
```text
azure-23/Item/Integration/ServiceAzureDataboxGateway
```

```text
include('azure-23/Item/Integration/ServiceAzureDataboxGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceAzureDataboxGateway.png) | ![illustration for ServiceAzureDataboxGateway](../../../azure-23/Item/Integration/ServiceAzureDataboxGateway.Local.png) | ![illustration for ServiceAzureDataboxGatewayCard](../../../azure-23/Item/Integration/ServiceAzureDataboxGatewayCard.Local.png) | ![illustration for ServiceAzureDataboxGatewayGroup](../../../azure-23/Item/Integration/ServiceAzureDataboxGatewayGroup.Local.png) |
