...
```text
azure-23/Item/Integration/ServiceSqlDataWarehouses
```

```text
include('azure-23/Item/Integration/ServiceSqlDataWarehouses')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Integration/ServiceSqlDataWarehouses.png) | ![illustration for ServiceSqlDataWarehouses](../../../azure-23/Item/Integration/ServiceSqlDataWarehouses.Local.png) | ![illustration for ServiceSqlDataWarehousesCard](../../../azure-23/Item/Integration/ServiceSqlDataWarehousesCard.Local.png) | ![illustration for ServiceSqlDataWarehousesGroup](../../../azure-23/Item/Integration/ServiceSqlDataWarehousesGroup.Local.png) |
