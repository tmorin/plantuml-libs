...
```text
azure-23/Item/AiMachineLearning/ServiceLanguage
```

```text
include('azure-23/Item/AiMachineLearning/ServiceLanguage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceLanguage.png) | ![illustration for ServiceLanguage](../../../azure-23/Item/AiMachineLearning/ServiceLanguage.Local.png) | ![illustration for ServiceLanguageCard](../../../azure-23/Item/AiMachineLearning/ServiceLanguageCard.Local.png) | ![illustration for ServiceLanguageGroup](../../../azure-23/Item/AiMachineLearning/ServiceLanguageGroup.Local.png) |
