...
```text
azure-23/Item/AiMachineLearning/ServiceMetricsAdvisor
```

```text
include('azure-23/Item/AiMachineLearning/ServiceMetricsAdvisor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceMetricsAdvisor.png) | ![illustration for ServiceMetricsAdvisor](../../../azure-23/Item/AiMachineLearning/ServiceMetricsAdvisor.Local.png) | ![illustration for ServiceMetricsAdvisorCard](../../../azure-23/Item/AiMachineLearning/ServiceMetricsAdvisorCard.Local.png) | ![illustration for ServiceMetricsAdvisorGroup](../../../azure-23/Item/AiMachineLearning/ServiceMetricsAdvisorGroup.Local.png) |
