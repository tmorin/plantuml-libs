...
```text
azure-23/Item/AiMachineLearning/ServiceBonsai
```

```text
include('azure-23/Item/AiMachineLearning/ServiceBonsai')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceBonsai.png) | ![illustration for ServiceBonsai](../../../azure-23/Item/AiMachineLearning/ServiceBonsai.Local.png) | ![illustration for ServiceBonsaiCard](../../../azure-23/Item/AiMachineLearning/ServiceBonsaiCard.Local.png) | ![illustration for ServiceBonsaiGroup](../../../azure-23/Item/AiMachineLearning/ServiceBonsaiGroup.Local.png) |
