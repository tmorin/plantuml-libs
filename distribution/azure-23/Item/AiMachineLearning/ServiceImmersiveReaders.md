...
```text
azure-23/Item/AiMachineLearning/ServiceImmersiveReaders
```

```text
include('azure-23/Item/AiMachineLearning/ServiceImmersiveReaders')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceImmersiveReaders.png) | ![illustration for ServiceImmersiveReaders](../../../azure-23/Item/AiMachineLearning/ServiceImmersiveReaders.Local.png) | ![illustration for ServiceImmersiveReadersCard](../../../azure-23/Item/AiMachineLearning/ServiceImmersiveReadersCard.Local.png) | ![illustration for ServiceImmersiveReadersGroup](../../../azure-23/Item/AiMachineLearning/ServiceImmersiveReadersGroup.Local.png) |
