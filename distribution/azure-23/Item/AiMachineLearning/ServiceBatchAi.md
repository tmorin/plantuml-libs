...
```text
azure-23/Item/AiMachineLearning/ServiceBatchAi
```

```text
include('azure-23/Item/AiMachineLearning/ServiceBatchAi')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceBatchAi.png) | ![illustration for ServiceBatchAi](../../../azure-23/Item/AiMachineLearning/ServiceBatchAi.Local.png) | ![illustration for ServiceBatchAiCard](../../../azure-23/Item/AiMachineLearning/ServiceBatchAiCard.Local.png) | ![illustration for ServiceBatchAiGroup](../../../azure-23/Item/AiMachineLearning/ServiceBatchAiGroup.Local.png) |
