...
```text
azure-23/Item/AiMachineLearning/ServiceTranslatorText
```

```text
include('azure-23/Item/AiMachineLearning/ServiceTranslatorText')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceTranslatorText.png) | ![illustration for ServiceTranslatorText](../../../azure-23/Item/AiMachineLearning/ServiceTranslatorText.Local.png) | ![illustration for ServiceTranslatorTextCard](../../../azure-23/Item/AiMachineLearning/ServiceTranslatorTextCard.Local.png) | ![illustration for ServiceTranslatorTextGroup](../../../azure-23/Item/AiMachineLearning/ServiceTranslatorTextGroup.Local.png) |
