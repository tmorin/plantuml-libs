...
```text
azure-23/Item/AiMachineLearning/ServiceCognitiveSearch
```

```text
include('azure-23/Item/AiMachineLearning/ServiceCognitiveSearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveSearch.png) | ![illustration for ServiceCognitiveSearch](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveSearch.Local.png) | ![illustration for ServiceCognitiveSearchCard](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveSearchCard.Local.png) | ![illustration for ServiceCognitiveSearchGroup](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveSearchGroup.Local.png) |
