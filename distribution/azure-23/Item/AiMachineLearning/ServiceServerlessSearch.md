...
```text
azure-23/Item/AiMachineLearning/ServiceServerlessSearch
```

```text
include('azure-23/Item/AiMachineLearning/ServiceServerlessSearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceServerlessSearch.png) | ![illustration for ServiceServerlessSearch](../../../azure-23/Item/AiMachineLearning/ServiceServerlessSearch.Local.png) | ![illustration for ServiceServerlessSearchCard](../../../azure-23/Item/AiMachineLearning/ServiceServerlessSearchCard.Local.png) | ![illustration for ServiceServerlessSearchGroup](../../../azure-23/Item/AiMachineLearning/ServiceServerlessSearchGroup.Local.png) |
