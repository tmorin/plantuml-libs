...
```text
azure-23/Item/AiMachineLearning/ServiceFormRecognizers
```

```text
include('azure-23/Item/AiMachineLearning/ServiceFormRecognizers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceFormRecognizers.png) | ![illustration for ServiceFormRecognizers](../../../azure-23/Item/AiMachineLearning/ServiceFormRecognizers.Local.png) | ![illustration for ServiceFormRecognizersCard](../../../azure-23/Item/AiMachineLearning/ServiceFormRecognizersCard.Local.png) | ![illustration for ServiceFormRecognizersGroup](../../../azure-23/Item/AiMachineLearning/ServiceFormRecognizersGroup.Local.png) |
