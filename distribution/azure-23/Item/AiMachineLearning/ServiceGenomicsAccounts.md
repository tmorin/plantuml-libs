...
```text
azure-23/Item/AiMachineLearning/ServiceGenomicsAccounts
```

```text
include('azure-23/Item/AiMachineLearning/ServiceGenomicsAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceGenomicsAccounts.png) | ![illustration for ServiceGenomicsAccounts](../../../azure-23/Item/AiMachineLearning/ServiceGenomicsAccounts.Local.png) | ![illustration for ServiceGenomicsAccountsCard](../../../azure-23/Item/AiMachineLearning/ServiceGenomicsAccountsCard.Local.png) | ![illustration for ServiceGenomicsAccountsGroup](../../../azure-23/Item/AiMachineLearning/ServiceGenomicsAccountsGroup.Local.png) |
