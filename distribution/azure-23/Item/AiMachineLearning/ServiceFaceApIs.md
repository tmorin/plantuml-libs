...
```text
azure-23/Item/AiMachineLearning/ServiceFaceApIs
```

```text
include('azure-23/Item/AiMachineLearning/ServiceFaceApIs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceFaceApIs.png) | ![illustration for ServiceFaceApIs](../../../azure-23/Item/AiMachineLearning/ServiceFaceApIs.Local.png) | ![illustration for ServiceFaceApIsCard](../../../azure-23/Item/AiMachineLearning/ServiceFaceApIsCard.Local.png) | ![illustration for ServiceFaceApIsGroup](../../../azure-23/Item/AiMachineLearning/ServiceFaceApIsGroup.Local.png) |
