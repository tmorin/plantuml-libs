...
```text
azure-23/Item/AiMachineLearning/ServiceSpeechServices
```

```text
include('azure-23/Item/AiMachineLearning/ServiceSpeechServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceSpeechServices.png) | ![illustration for ServiceSpeechServices](../../../azure-23/Item/AiMachineLearning/ServiceSpeechServices.Local.png) | ![illustration for ServiceSpeechServicesCard](../../../azure-23/Item/AiMachineLearning/ServiceSpeechServicesCard.Local.png) | ![illustration for ServiceSpeechServicesGroup](../../../azure-23/Item/AiMachineLearning/ServiceSpeechServicesGroup.Local.png) |
