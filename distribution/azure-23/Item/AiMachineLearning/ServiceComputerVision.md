...
```text
azure-23/Item/AiMachineLearning/ServiceComputerVision
```

```text
include('azure-23/Item/AiMachineLearning/ServiceComputerVision')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceComputerVision.png) | ![illustration for ServiceComputerVision](../../../azure-23/Item/AiMachineLearning/ServiceComputerVision.Local.png) | ![illustration for ServiceComputerVisionCard](../../../azure-23/Item/AiMachineLearning/ServiceComputerVisionCard.Local.png) | ![illustration for ServiceComputerVisionGroup](../../../azure-23/Item/AiMachineLearning/ServiceComputerVisionGroup.Local.png) |
