...
```text
azure-23/Item/AiMachineLearning/ServiceContentModerators
```

```text
include('azure-23/Item/AiMachineLearning/ServiceContentModerators')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceContentModerators.png) | ![illustration for ServiceContentModerators](../../../azure-23/Item/AiMachineLearning/ServiceContentModerators.Local.png) | ![illustration for ServiceContentModeratorsCard](../../../azure-23/Item/AiMachineLearning/ServiceContentModeratorsCard.Local.png) | ![illustration for ServiceContentModeratorsGroup](../../../azure-23/Item/AiMachineLearning/ServiceContentModeratorsGroup.Local.png) |
