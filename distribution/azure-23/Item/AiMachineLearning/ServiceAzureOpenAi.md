...
```text
azure-23/Item/AiMachineLearning/ServiceAzureOpenAi
```

```text
include('azure-23/Item/AiMachineLearning/ServiceAzureOpenAi')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceAzureOpenAi.png) | ![illustration for ServiceAzureOpenAi](../../../azure-23/Item/AiMachineLearning/ServiceAzureOpenAi.Local.png) | ![illustration for ServiceAzureOpenAiCard](../../../azure-23/Item/AiMachineLearning/ServiceAzureOpenAiCard.Local.png) | ![illustration for ServiceAzureOpenAiGroup](../../../azure-23/Item/AiMachineLearning/ServiceAzureOpenAiGroup.Local.png) |
