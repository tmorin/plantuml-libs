...
```text
azure-23/Item/AiMachineLearning/ServiceCognitiveServices
```

```text
include('azure-23/Item/AiMachineLearning/ServiceCognitiveServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveServices.png) | ![illustration for ServiceCognitiveServices](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveServices.Local.png) | ![illustration for ServiceCognitiveServicesCard](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveServicesCard.Local.png) | ![illustration for ServiceCognitiveServicesGroup](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveServicesGroup.Local.png) |
