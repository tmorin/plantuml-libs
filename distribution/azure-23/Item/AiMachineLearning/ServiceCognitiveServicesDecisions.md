...
```text
azure-23/Item/AiMachineLearning/ServiceCognitiveServicesDecisions
```

```text
include('azure-23/Item/AiMachineLearning/ServiceCognitiveServicesDecisions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveServicesDecisions.png) | ![illustration for ServiceCognitiveServicesDecisions](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveServicesDecisions.Local.png) | ![illustration for ServiceCognitiveServicesDecisionsCard](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveServicesDecisionsCard.Local.png) | ![illustration for ServiceCognitiveServicesDecisionsGroup](../../../azure-23/Item/AiMachineLearning/ServiceCognitiveServicesDecisionsGroup.Local.png) |
