...
```text
azure-23/Item/AiMachineLearning/ServiceAiStudio
```

```text
include('azure-23/Item/AiMachineLearning/ServiceAiStudio')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceAiStudio.png) | ![illustration for ServiceAiStudio](../../../azure-23/Item/AiMachineLearning/ServiceAiStudio.Local.png) | ![illustration for ServiceAiStudioCard](../../../azure-23/Item/AiMachineLearning/ServiceAiStudioCard.Local.png) | ![illustration for ServiceAiStudioGroup](../../../azure-23/Item/AiMachineLearning/ServiceAiStudioGroup.Local.png) |
