...
```text
azure-23/Item/AiMachineLearning/ServiceGenomics
```

```text
include('azure-23/Item/AiMachineLearning/ServiceGenomics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceGenomics.png) | ![illustration for ServiceGenomics](../../../azure-23/Item/AiMachineLearning/ServiceGenomics.Local.png) | ![illustration for ServiceGenomicsCard](../../../azure-23/Item/AiMachineLearning/ServiceGenomicsCard.Local.png) | ![illustration for ServiceGenomicsGroup](../../../azure-23/Item/AiMachineLearning/ServiceGenomicsGroup.Local.png) |
