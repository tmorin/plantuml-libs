...
```text
azure-23/Item/AiMachineLearning/ServiceBotServices
```

```text
include('azure-23/Item/AiMachineLearning/ServiceBotServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AiMachineLearning/ServiceBotServices.png) | ![illustration for ServiceBotServices](../../../azure-23/Item/AiMachineLearning/ServiceBotServices.Local.png) | ![illustration for ServiceBotServicesCard](../../../azure-23/Item/AiMachineLearning/ServiceBotServicesCard.Local.png) | ![illustration for ServiceBotServicesGroup](../../../azure-23/Item/AiMachineLearning/ServiceBotServicesGroup.Local.png) |
