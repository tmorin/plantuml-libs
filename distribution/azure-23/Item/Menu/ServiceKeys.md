...
```text
azure-23/Item/Menu/ServiceKeys
```

```text
include('azure-23/Item/Menu/ServiceKeys')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Menu/ServiceKeys.png) | ![illustration for ServiceKeys](../../../azure-23/Item/Menu/ServiceKeys.Local.png) | ![illustration for ServiceKeysCard](../../../azure-23/Item/Menu/ServiceKeysCard.Local.png) | ![illustration for ServiceKeysGroup](../../../azure-23/Item/Menu/ServiceKeysGroup.Local.png) |
