...
```text
azure-23/Item/ManagementGovernance/ServiceArcMachines
```

```text
include('azure-23/Item/ManagementGovernance/ServiceArcMachines')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceArcMachines.png) | ![illustration for ServiceArcMachines](../../../azure-23/Item/ManagementGovernance/ServiceArcMachines.Local.png) | ![illustration for ServiceArcMachinesCard](../../../azure-23/Item/ManagementGovernance/ServiceArcMachinesCard.Local.png) | ![illustration for ServiceArcMachinesGroup](../../../azure-23/Item/ManagementGovernance/ServiceArcMachinesGroup.Local.png) |
