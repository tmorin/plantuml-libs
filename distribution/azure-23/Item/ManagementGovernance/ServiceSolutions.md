...
```text
azure-23/Item/ManagementGovernance/ServiceSolutions
```

```text
include('azure-23/Item/ManagementGovernance/ServiceSolutions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceSolutions.png) | ![illustration for ServiceSolutions](../../../azure-23/Item/ManagementGovernance/ServiceSolutions.Local.png) | ![illustration for ServiceSolutionsCard](../../../azure-23/Item/ManagementGovernance/ServiceSolutionsCard.Local.png) | ![illustration for ServiceSolutionsGroup](../../../azure-23/Item/ManagementGovernance/ServiceSolutionsGroup.Local.png) |
