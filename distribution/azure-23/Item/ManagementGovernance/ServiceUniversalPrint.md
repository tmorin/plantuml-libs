...
```text
azure-23/Item/ManagementGovernance/ServiceUniversalPrint
```

```text
include('azure-23/Item/ManagementGovernance/ServiceUniversalPrint')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceUniversalPrint.png) | ![illustration for ServiceUniversalPrint](../../../azure-23/Item/ManagementGovernance/ServiceUniversalPrint.Local.png) | ![illustration for ServiceUniversalPrintCard](../../../azure-23/Item/ManagementGovernance/ServiceUniversalPrintCard.Local.png) | ![illustration for ServiceUniversalPrintGroup](../../../azure-23/Item/ManagementGovernance/ServiceUniversalPrintGroup.Local.png) |
