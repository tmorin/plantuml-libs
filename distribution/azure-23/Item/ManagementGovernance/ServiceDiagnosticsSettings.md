...
```text
azure-23/Item/ManagementGovernance/ServiceDiagnosticsSettings
```

```text
include('azure-23/Item/ManagementGovernance/ServiceDiagnosticsSettings')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceDiagnosticsSettings.png) | ![illustration for ServiceDiagnosticsSettings](../../../azure-23/Item/ManagementGovernance/ServiceDiagnosticsSettings.Local.png) | ![illustration for ServiceDiagnosticsSettingsCard](../../../azure-23/Item/ManagementGovernance/ServiceDiagnosticsSettingsCard.Local.png) | ![illustration for ServiceDiagnosticsSettingsGroup](../../../azure-23/Item/ManagementGovernance/ServiceDiagnosticsSettingsGroup.Local.png) |
