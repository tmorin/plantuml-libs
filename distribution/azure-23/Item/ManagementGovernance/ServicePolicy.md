...
```text
azure-23/Item/ManagementGovernance/ServicePolicy
```

```text
include('azure-23/Item/ManagementGovernance/ServicePolicy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServicePolicy.png) | ![illustration for ServicePolicy](../../../azure-23/Item/ManagementGovernance/ServicePolicy.Local.png) | ![illustration for ServicePolicyCard](../../../azure-23/Item/ManagementGovernance/ServicePolicyCard.Local.png) | ![illustration for ServicePolicyGroup](../../../azure-23/Item/ManagementGovernance/ServicePolicyGroup.Local.png) |
