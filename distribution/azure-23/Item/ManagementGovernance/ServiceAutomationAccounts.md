...
```text
azure-23/Item/ManagementGovernance/ServiceAutomationAccounts
```

```text
include('azure-23/Item/ManagementGovernance/ServiceAutomationAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceAutomationAccounts.png) | ![illustration for ServiceAutomationAccounts](../../../azure-23/Item/ManagementGovernance/ServiceAutomationAccounts.Local.png) | ![illustration for ServiceAutomationAccountsCard](../../../azure-23/Item/ManagementGovernance/ServiceAutomationAccountsCard.Local.png) | ![illustration for ServiceAutomationAccountsGroup](../../../azure-23/Item/ManagementGovernance/ServiceAutomationAccountsGroup.Local.png) |
