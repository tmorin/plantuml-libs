...
```text
azure-23/Item/ManagementGovernance/ServiceUserPrivacy
```

```text
include('azure-23/Item/ManagementGovernance/ServiceUserPrivacy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceUserPrivacy.png) | ![illustration for ServiceUserPrivacy](../../../azure-23/Item/ManagementGovernance/ServiceUserPrivacy.Local.png) | ![illustration for ServiceUserPrivacyCard](../../../azure-23/Item/ManagementGovernance/ServiceUserPrivacyCard.Local.png) | ![illustration for ServiceUserPrivacyGroup](../../../azure-23/Item/ManagementGovernance/ServiceUserPrivacyGroup.Local.png) |
