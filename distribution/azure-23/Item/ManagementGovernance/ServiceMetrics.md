...
```text
azure-23/Item/ManagementGovernance/ServiceMetrics
```

```text
include('azure-23/Item/ManagementGovernance/ServiceMetrics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceMetrics.png) | ![illustration for ServiceMetrics](../../../azure-23/Item/ManagementGovernance/ServiceMetrics.Local.png) | ![illustration for ServiceMetricsCard](../../../azure-23/Item/ManagementGovernance/ServiceMetricsCard.Local.png) | ![illustration for ServiceMetricsGroup](../../../azure-23/Item/ManagementGovernance/ServiceMetricsGroup.Local.png) |
