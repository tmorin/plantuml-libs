...
```text
azure-23/Item/ManagementGovernance/ServiceManagedDesktop
```

```text
include('azure-23/Item/ManagementGovernance/ServiceManagedDesktop')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceManagedDesktop.png) | ![illustration for ServiceManagedDesktop](../../../azure-23/Item/ManagementGovernance/ServiceManagedDesktop.Local.png) | ![illustration for ServiceManagedDesktopCard](../../../azure-23/Item/ManagementGovernance/ServiceManagedDesktopCard.Local.png) | ![illustration for ServiceManagedDesktopGroup](../../../azure-23/Item/ManagementGovernance/ServiceManagedDesktopGroup.Local.png) |
