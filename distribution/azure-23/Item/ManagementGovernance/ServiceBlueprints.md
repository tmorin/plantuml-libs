...
```text
azure-23/Item/ManagementGovernance/ServiceBlueprints
```

```text
include('azure-23/Item/ManagementGovernance/ServiceBlueprints')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceBlueprints.png) | ![illustration for ServiceBlueprints](../../../azure-23/Item/ManagementGovernance/ServiceBlueprints.Local.png) | ![illustration for ServiceBlueprintsCard](../../../azure-23/Item/ManagementGovernance/ServiceBlueprintsCard.Local.png) | ![illustration for ServiceBlueprintsGroup](../../../azure-23/Item/ManagementGovernance/ServiceBlueprintsGroup.Local.png) |
