...
```text
azure-23/Item/ManagementGovernance/ServiceAlerts
```

```text
include('azure-23/Item/ManagementGovernance/ServiceAlerts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceAlerts.png) | ![illustration for ServiceAlerts](../../../azure-23/Item/ManagementGovernance/ServiceAlerts.Local.png) | ![illustration for ServiceAlertsCard](../../../azure-23/Item/ManagementGovernance/ServiceAlertsCard.Local.png) | ![illustration for ServiceAlertsGroup](../../../azure-23/Item/ManagementGovernance/ServiceAlertsGroup.Local.png) |
