...
```text
azure-23/Item/ManagementGovernance/ServiceResourcesProvider
```

```text
include('azure-23/Item/ManagementGovernance/ServiceResourcesProvider')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceResourcesProvider.png) | ![illustration for ServiceResourcesProvider](../../../azure-23/Item/ManagementGovernance/ServiceResourcesProvider.Local.png) | ![illustration for ServiceResourcesProviderCard](../../../azure-23/Item/ManagementGovernance/ServiceResourcesProviderCard.Local.png) | ![illustration for ServiceResourcesProviderGroup](../../../azure-23/Item/ManagementGovernance/ServiceResourcesProviderGroup.Local.png) |
