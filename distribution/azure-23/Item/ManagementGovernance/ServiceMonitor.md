...
```text
azure-23/Item/ManagementGovernance/ServiceMonitor
```

```text
include('azure-23/Item/ManagementGovernance/ServiceMonitor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceMonitor.png) | ![illustration for ServiceMonitor](../../../azure-23/Item/ManagementGovernance/ServiceMonitor.Local.png) | ![illustration for ServiceMonitorCard](../../../azure-23/Item/ManagementGovernance/ServiceMonitorCard.Local.png) | ![illustration for ServiceMonitorGroup](../../../azure-23/Item/ManagementGovernance/ServiceMonitorGroup.Local.png) |
