...
```text
azure-23/Item/ManagementGovernance/ServiceAzureArc
```

```text
include('azure-23/Item/ManagementGovernance/ServiceAzureArc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceAzureArc.png) | ![illustration for ServiceAzureArc](../../../azure-23/Item/ManagementGovernance/ServiceAzureArc.Local.png) | ![illustration for ServiceAzureArcCard](../../../azure-23/Item/ManagementGovernance/ServiceAzureArcCard.Local.png) | ![illustration for ServiceAzureArcGroup](../../../azure-23/Item/ManagementGovernance/ServiceAzureArcGroup.Local.png) |
