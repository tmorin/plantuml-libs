...
```text
azure-23/Item/ManagementGovernance/ServiceResourceGraphExplorer
```

```text
include('azure-23/Item/ManagementGovernance/ServiceResourceGraphExplorer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceResourceGraphExplorer.png) | ![illustration for ServiceResourceGraphExplorer](../../../azure-23/Item/ManagementGovernance/ServiceResourceGraphExplorer.Local.png) | ![illustration for ServiceResourceGraphExplorerCard](../../../azure-23/Item/ManagementGovernance/ServiceResourceGraphExplorerCard.Local.png) | ![illustration for ServiceResourceGraphExplorerGroup](../../../azure-23/Item/ManagementGovernance/ServiceResourceGraphExplorerGroup.Local.png) |
