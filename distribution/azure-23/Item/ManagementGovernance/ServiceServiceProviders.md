...
```text
azure-23/Item/ManagementGovernance/ServiceServiceProviders
```

```text
include('azure-23/Item/ManagementGovernance/ServiceServiceProviders')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceServiceProviders.png) | ![illustration for ServiceServiceProviders](../../../azure-23/Item/ManagementGovernance/ServiceServiceProviders.Local.png) | ![illustration for ServiceServiceProvidersCard](../../../azure-23/Item/ManagementGovernance/ServiceServiceProvidersCard.Local.png) | ![illustration for ServiceServiceProvidersGroup](../../../azure-23/Item/ManagementGovernance/ServiceServiceProvidersGroup.Local.png) |
