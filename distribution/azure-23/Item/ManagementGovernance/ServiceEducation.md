...
```text
azure-23/Item/ManagementGovernance/ServiceEducation
```

```text
include('azure-23/Item/ManagementGovernance/ServiceEducation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/ManagementGovernance/ServiceEducation.png) | ![illustration for ServiceEducation](../../../azure-23/Item/ManagementGovernance/ServiceEducation.Local.png) | ![illustration for ServiceEducationCard](../../../azure-23/Item/ManagementGovernance/ServiceEducationCard.Local.png) | ![illustration for ServiceEducationGroup](../../../azure-23/Item/ManagementGovernance/ServiceEducationGroup.Local.png) |
