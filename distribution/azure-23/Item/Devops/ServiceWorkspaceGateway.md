...
```text
azure-23/Item/Devops/ServiceWorkspaceGateway
```

```text
include('azure-23/Item/Devops/ServiceWorkspaceGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Devops/ServiceWorkspaceGateway.png) | ![illustration for ServiceWorkspaceGateway](../../../azure-23/Item/Devops/ServiceWorkspaceGateway.Local.png) | ![illustration for ServiceWorkspaceGatewayCard](../../../azure-23/Item/Devops/ServiceWorkspaceGatewayCard.Local.png) | ![illustration for ServiceWorkspaceGatewayGroup](../../../azure-23/Item/Devops/ServiceWorkspaceGatewayGroup.Local.png) |
