...
```text
azure-23/Item/Devops/ServiceDevOpsStarter
```

```text
include('azure-23/Item/Devops/ServiceDevOpsStarter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Devops/ServiceDevOpsStarter.png) | ![illustration for ServiceDevOpsStarter](../../../azure-23/Item/Devops/ServiceDevOpsStarter.Local.png) | ![illustration for ServiceDevOpsStarterCard](../../../azure-23/Item/Devops/ServiceDevOpsStarterCard.Local.png) | ![illustration for ServiceDevOpsStarterGroup](../../../azure-23/Item/Devops/ServiceDevOpsStarterGroup.Local.png) |
