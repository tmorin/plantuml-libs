...
```text
azure-23/Item/Devops/ServiceManagedDevOpsPools
```

```text
include('azure-23/Item/Devops/ServiceManagedDevOpsPools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Devops/ServiceManagedDevOpsPools.png) | ![illustration for ServiceManagedDevOpsPools](../../../azure-23/Item/Devops/ServiceManagedDevOpsPools.Local.png) | ![illustration for ServiceManagedDevOpsPoolsCard](../../../azure-23/Item/Devops/ServiceManagedDevOpsPoolsCard.Local.png) | ![illustration for ServiceManagedDevOpsPoolsGroup](../../../azure-23/Item/Devops/ServiceManagedDevOpsPoolsGroup.Local.png) |
