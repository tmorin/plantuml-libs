...
```text
azure-23/Item/Devops/ServiceCodeOptimization
```

```text
include('azure-23/Item/Devops/ServiceCodeOptimization')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Devops/ServiceCodeOptimization.png) | ![illustration for ServiceCodeOptimization](../../../azure-23/Item/Devops/ServiceCodeOptimization.Local.png) | ![illustration for ServiceCodeOptimizationCard](../../../azure-23/Item/Devops/ServiceCodeOptimizationCard.Local.png) | ![illustration for ServiceCodeOptimizationGroup](../../../azure-23/Item/Devops/ServiceCodeOptimizationGroup.Local.png) |
