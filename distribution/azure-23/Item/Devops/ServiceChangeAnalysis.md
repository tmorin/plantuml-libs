...
```text
azure-23/Item/Devops/ServiceChangeAnalysis
```

```text
include('azure-23/Item/Devops/ServiceChangeAnalysis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Devops/ServiceChangeAnalysis.png) | ![illustration for ServiceChangeAnalysis](../../../azure-23/Item/Devops/ServiceChangeAnalysis.Local.png) | ![illustration for ServiceChangeAnalysisCard](../../../azure-23/Item/Devops/ServiceChangeAnalysisCard.Local.png) | ![illustration for ServiceChangeAnalysisGroup](../../../azure-23/Item/Devops/ServiceChangeAnalysisGroup.Local.png) |
