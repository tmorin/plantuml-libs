...
```text
azure-23/Item/Devops/ServiceCloudTest
```

```text
include('azure-23/Item/Devops/ServiceCloudTest')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Devops/ServiceCloudTest.png) | ![illustration for ServiceCloudTest](../../../azure-23/Item/Devops/ServiceCloudTest.Local.png) | ![illustration for ServiceCloudTestCard](../../../azure-23/Item/Devops/ServiceCloudTestCard.Local.png) | ![illustration for ServiceCloudTestGroup](../../../azure-23/Item/Devops/ServiceCloudTestGroup.Local.png) |
