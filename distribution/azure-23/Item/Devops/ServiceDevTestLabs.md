...
```text
azure-23/Item/Devops/ServiceDevTestLabs
```

```text
include('azure-23/Item/Devops/ServiceDevTestLabs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Devops/ServiceDevTestLabs.png) | ![illustration for ServiceDevTestLabs](../../../azure-23/Item/Devops/ServiceDevTestLabs.Local.png) | ![illustration for ServiceDevTestLabsCard](../../../azure-23/Item/Devops/ServiceDevTestLabsCard.Local.png) | ![illustration for ServiceDevTestLabsGroup](../../../azure-23/Item/Devops/ServiceDevTestLabsGroup.Local.png) |
