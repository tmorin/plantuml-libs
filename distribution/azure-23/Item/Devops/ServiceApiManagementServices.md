...
```text
azure-23/Item/Devops/ServiceApiManagementServices
```

```text
include('azure-23/Item/Devops/ServiceApiManagementServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Devops/ServiceApiManagementServices.png) | ![illustration for ServiceApiManagementServices](../../../azure-23/Item/Devops/ServiceApiManagementServices.Local.png) | ![illustration for ServiceApiManagementServicesCard](../../../azure-23/Item/Devops/ServiceApiManagementServicesCard.Local.png) | ![illustration for ServiceApiManagementServicesGroup](../../../azure-23/Item/Devops/ServiceApiManagementServicesGroup.Local.png) |
