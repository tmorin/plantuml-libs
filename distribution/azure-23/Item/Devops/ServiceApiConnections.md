...
```text
azure-23/Item/Devops/ServiceApiConnections
```

```text
include('azure-23/Item/Devops/ServiceApiConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Devops/ServiceApiConnections.png) | ![illustration for ServiceApiConnections](../../../azure-23/Item/Devops/ServiceApiConnections.Local.png) | ![illustration for ServiceApiConnectionsCard](../../../azure-23/Item/Devops/ServiceApiConnectionsCard.Local.png) | ![illustration for ServiceApiConnectionsGroup](../../../azure-23/Item/Devops/ServiceApiConnectionsGroup.Local.png) |
