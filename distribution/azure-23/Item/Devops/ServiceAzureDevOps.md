...
```text
azure-23/Item/Devops/ServiceAzureDevOps
```

```text
include('azure-23/Item/Devops/ServiceAzureDevOps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Devops/ServiceAzureDevOps.png) | ![illustration for ServiceAzureDevOps](../../../azure-23/Item/Devops/ServiceAzureDevOps.Local.png) | ![illustration for ServiceAzureDevOpsCard](../../../azure-23/Item/Devops/ServiceAzureDevOpsCard.Local.png) | ![illustration for ServiceAzureDevOpsGroup](../../../azure-23/Item/Devops/ServiceAzureDevOpsGroup.Local.png) |
