...
```text
azure-23/Item/NewIcons/ServiceVpnClientWindows
```

```text
include('azure-23/Item/NewIcons/ServiceVpnClientWindows')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServiceVpnClientWindows.png) | ![illustration for ServiceVpnClientWindows](../../../azure-23/Item/NewIcons/ServiceVpnClientWindows.Local.png) | ![illustration for ServiceVpnClientWindowsCard](../../../azure-23/Item/NewIcons/ServiceVpnClientWindowsCard.Local.png) | ![illustration for ServiceVpnClientWindowsGroup](../../../azure-23/Item/NewIcons/ServiceVpnClientWindowsGroup.Local.png) |
