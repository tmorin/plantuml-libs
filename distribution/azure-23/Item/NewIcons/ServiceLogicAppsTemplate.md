...
```text
azure-23/Item/NewIcons/ServiceLogicAppsTemplate
```

```text
include('azure-23/Item/NewIcons/ServiceLogicAppsTemplate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServiceLogicAppsTemplate.png) | ![illustration for ServiceLogicAppsTemplate](../../../azure-23/Item/NewIcons/ServiceLogicAppsTemplate.Local.png) | ![illustration for ServiceLogicAppsTemplateCard](../../../azure-23/Item/NewIcons/ServiceLogicAppsTemplateCard.Local.png) | ![illustration for ServiceLogicAppsTemplateGroup](../../../azure-23/Item/NewIcons/ServiceLogicAppsTemplateGroup.Local.png) |
