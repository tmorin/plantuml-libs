...
```text
azure-23/Item/NewIcons/ServiceEdgeActions
```

```text
include('azure-23/Item/NewIcons/ServiceEdgeActions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServiceEdgeActions.png) | ![illustration for ServiceEdgeActions](../../../azure-23/Item/NewIcons/ServiceEdgeActions.Local.png) | ![illustration for ServiceEdgeActionsCard](../../../azure-23/Item/NewIcons/ServiceEdgeActionsCard.Local.png) | ![illustration for ServiceEdgeActionsGroup](../../../azure-23/Item/NewIcons/ServiceEdgeActionsGroup.Local.png) |
