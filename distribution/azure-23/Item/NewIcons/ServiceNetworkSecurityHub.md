...
```text
azure-23/Item/NewIcons/ServiceNetworkSecurityHub
```

```text
include('azure-23/Item/NewIcons/ServiceNetworkSecurityHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServiceNetworkSecurityHub.png) | ![illustration for ServiceNetworkSecurityHub](../../../azure-23/Item/NewIcons/ServiceNetworkSecurityHub.Local.png) | ![illustration for ServiceNetworkSecurityHubCard](../../../azure-23/Item/NewIcons/ServiceNetworkSecurityHubCard.Local.png) | ![illustration for ServiceNetworkSecurityHubGroup](../../../azure-23/Item/NewIcons/ServiceNetworkSecurityHubGroup.Local.png) |
