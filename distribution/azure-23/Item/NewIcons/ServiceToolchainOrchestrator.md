...
```text
azure-23/Item/NewIcons/ServiceToolchainOrchestrator
```

```text
include('azure-23/Item/NewIcons/ServiceToolchainOrchestrator')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServiceToolchainOrchestrator.png) | ![illustration for ServiceToolchainOrchestrator](../../../azure-23/Item/NewIcons/ServiceToolchainOrchestrator.Local.png) | ![illustration for ServiceToolchainOrchestratorCard](../../../azure-23/Item/NewIcons/ServiceToolchainOrchestratorCard.Local.png) | ![illustration for ServiceToolchainOrchestratorGroup](../../../azure-23/Item/NewIcons/ServiceToolchainOrchestratorGroup.Local.png) |
