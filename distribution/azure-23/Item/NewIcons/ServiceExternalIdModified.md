...
```text
azure-23/Item/NewIcons/ServiceExternalIdModified
```

```text
include('azure-23/Item/NewIcons/ServiceExternalIdModified')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServiceExternalIdModified.png) | ![illustration for ServiceExternalIdModified](../../../azure-23/Item/NewIcons/ServiceExternalIdModified.Local.png) | ![illustration for ServiceExternalIdModifiedCard](../../../azure-23/Item/NewIcons/ServiceExternalIdModifiedCard.Local.png) | ![illustration for ServiceExternalIdModifiedGroup](../../../azure-23/Item/NewIcons/ServiceExternalIdModifiedGroup.Local.png) |
