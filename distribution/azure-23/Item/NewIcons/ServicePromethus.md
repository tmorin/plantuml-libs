...
```text
azure-23/Item/NewIcons/ServicePromethus
```

```text
include('azure-23/Item/NewIcons/ServicePromethus')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServicePromethus.png) | ![illustration for ServicePromethus](../../../azure-23/Item/NewIcons/ServicePromethus.Local.png) | ![illustration for ServicePromethusCard](../../../azure-23/Item/NewIcons/ServicePromethusCard.Local.png) | ![illustration for ServicePromethusGroup](../../../azure-23/Item/NewIcons/ServicePromethusGroup.Local.png) |
