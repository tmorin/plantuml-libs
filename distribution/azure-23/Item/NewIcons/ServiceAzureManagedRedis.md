...
```text
azure-23/Item/NewIcons/ServiceAzureManagedRedis
```

```text
include('azure-23/Item/NewIcons/ServiceAzureManagedRedis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServiceAzureManagedRedis.png) | ![illustration for ServiceAzureManagedRedis](../../../azure-23/Item/NewIcons/ServiceAzureManagedRedis.Local.png) | ![illustration for ServiceAzureManagedRedisCard](../../../azure-23/Item/NewIcons/ServiceAzureManagedRedisCard.Local.png) | ![illustration for ServiceAzureManagedRedisGroup](../../../azure-23/Item/NewIcons/ServiceAzureManagedRedisGroup.Local.png) |
