...
```text
azure-23/Item/NewIcons/ServiceLandingZone
```

```text
include('azure-23/Item/NewIcons/ServiceLandingZone')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServiceLandingZone.png) | ![illustration for ServiceLandingZone](../../../azure-23/Item/NewIcons/ServiceLandingZone.Local.png) | ![illustration for ServiceLandingZoneCard](../../../azure-23/Item/NewIcons/ServiceLandingZoneCard.Local.png) | ![illustration for ServiceLandingZoneGroup](../../../azure-23/Item/NewIcons/ServiceLandingZoneGroup.Local.png) |
