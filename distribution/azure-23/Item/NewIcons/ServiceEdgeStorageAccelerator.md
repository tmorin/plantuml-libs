...
```text
azure-23/Item/NewIcons/ServiceEdgeStorageAccelerator
```

```text
include('azure-23/Item/NewIcons/ServiceEdgeStorageAccelerator')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServiceEdgeStorageAccelerator.png) | ![illustration for ServiceEdgeStorageAccelerator](../../../azure-23/Item/NewIcons/ServiceEdgeStorageAccelerator.Local.png) | ![illustration for ServiceEdgeStorageAcceleratorCard](../../../azure-23/Item/NewIcons/ServiceEdgeStorageAcceleratorCard.Local.png) | ![illustration for ServiceEdgeStorageAcceleratorGroup](../../../azure-23/Item/NewIcons/ServiceEdgeStorageAcceleratorGroup.Local.png) |
