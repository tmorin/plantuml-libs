...
```text
azure-23/Item/NewIcons/ServiceBreeze
```

```text
include('azure-23/Item/NewIcons/ServiceBreeze')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServiceBreeze.png) | ![illustration for ServiceBreeze](../../../azure-23/Item/NewIcons/ServiceBreeze.Local.png) | ![illustration for ServiceBreezeCard](../../../azure-23/Item/NewIcons/ServiceBreezeCard.Local.png) | ![illustration for ServiceBreezeGroup](../../../azure-23/Item/NewIcons/ServiceBreezeGroup.Local.png) |
