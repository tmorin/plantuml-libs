...
```text
azure-23/Item/NewIcons/ServicePubsub
```

```text
include('azure-23/Item/NewIcons/ServicePubsub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServicePubsub.png) | ![illustration for ServicePubsub](../../../azure-23/Item/NewIcons/ServicePubsub.Local.png) | ![illustration for ServicePubsubCard](../../../azure-23/Item/NewIcons/ServicePubsubCard.Local.png) | ![illustration for ServicePubsubGroup](../../../azure-23/Item/NewIcons/ServicePubsubGroup.Local.png) |
