...
```text
azure-23/Item/NewIcons/ServiceAiAtEdge
```

```text
include('azure-23/Item/NewIcons/ServiceAiAtEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/NewIcons/ServiceAiAtEdge.png) | ![illustration for ServiceAiAtEdge](../../../azure-23/Item/NewIcons/ServiceAiAtEdge.Local.png) | ![illustration for ServiceAiAtEdgeCard](../../../azure-23/Item/NewIcons/ServiceAiAtEdgeCard.Local.png) | ![illustration for ServiceAiAtEdgeGroup](../../../azure-23/Item/NewIcons/ServiceAiAtEdgeGroup.Local.png) |
