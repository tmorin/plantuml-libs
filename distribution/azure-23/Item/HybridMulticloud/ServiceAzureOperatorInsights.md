...
```text
azure-23/Item/HybridMulticloud/ServiceAzureOperatorInsights
```

```text
include('azure-23/Item/HybridMulticloud/ServiceAzureOperatorInsights')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/HybridMulticloud/ServiceAzureOperatorInsights.png) | ![illustration for ServiceAzureOperatorInsights](../../../azure-23/Item/HybridMulticloud/ServiceAzureOperatorInsights.Local.png) | ![illustration for ServiceAzureOperatorInsightsCard](../../../azure-23/Item/HybridMulticloud/ServiceAzureOperatorInsightsCard.Local.png) | ![illustration for ServiceAzureOperatorInsightsGroup](../../../azure-23/Item/HybridMulticloud/ServiceAzureOperatorInsightsGroup.Local.png) |
