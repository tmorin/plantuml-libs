...
```text
azure-23/Item/HybridMulticloud/ServiceAzureOperatorServiceManager
```

```text
include('azure-23/Item/HybridMulticloud/ServiceAzureOperatorServiceManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/HybridMulticloud/ServiceAzureOperatorServiceManager.png) | ![illustration for ServiceAzureOperatorServiceManager](../../../azure-23/Item/HybridMulticloud/ServiceAzureOperatorServiceManager.Local.png) | ![illustration for ServiceAzureOperatorServiceManagerCard](../../../azure-23/Item/HybridMulticloud/ServiceAzureOperatorServiceManagerCard.Local.png) | ![illustration for ServiceAzureOperatorServiceManagerGroup](../../../azure-23/Item/HybridMulticloud/ServiceAzureOperatorServiceManagerGroup.Local.png) |
