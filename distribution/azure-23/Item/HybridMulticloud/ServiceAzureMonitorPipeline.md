...
```text
azure-23/Item/HybridMulticloud/ServiceAzureMonitorPipeline
```

```text
include('azure-23/Item/HybridMulticloud/ServiceAzureMonitorPipeline')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/HybridMulticloud/ServiceAzureMonitorPipeline.png) | ![illustration for ServiceAzureMonitorPipeline](../../../azure-23/Item/HybridMulticloud/ServiceAzureMonitorPipeline.Local.png) | ![illustration for ServiceAzureMonitorPipelineCard](../../../azure-23/Item/HybridMulticloud/ServiceAzureMonitorPipelineCard.Local.png) | ![illustration for ServiceAzureMonitorPipelineGroup](../../../azure-23/Item/HybridMulticloud/ServiceAzureMonitorPipelineGroup.Local.png) |
