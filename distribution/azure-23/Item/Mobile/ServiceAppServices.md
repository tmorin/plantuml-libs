...
```text
azure-23/Item/Mobile/ServiceAppServices
```

```text
include('azure-23/Item/Mobile/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Mobile/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-23/Item/Mobile/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-23/Item/Mobile/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-23/Item/Mobile/ServiceAppServicesGroup.Local.png) |
