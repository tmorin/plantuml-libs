...
```text
azure-23/Item/Security/ServiceMultifactorAuthentication
```

```text
include('azure-23/Item/Security/ServiceMultifactorAuthentication')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceMultifactorAuthentication.png) | ![illustration for ServiceMultifactorAuthentication](../../../azure-23/Item/Security/ServiceMultifactorAuthentication.Local.png) | ![illustration for ServiceMultifactorAuthenticationCard](../../../azure-23/Item/Security/ServiceMultifactorAuthenticationCard.Local.png) | ![illustration for ServiceMultifactorAuthenticationGroup](../../../azure-23/Item/Security/ServiceMultifactorAuthenticationGroup.Local.png) |
