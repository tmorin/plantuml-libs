...
```text
azure-23/Item/Security/ServiceMicrosoftDefenderForIoT
```

```text
include('azure-23/Item/Security/ServiceMicrosoftDefenderForIoT')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceMicrosoftDefenderForIoT.png) | ![illustration for ServiceMicrosoftDefenderForIoT](../../../azure-23/Item/Security/ServiceMicrosoftDefenderForIoT.Local.png) | ![illustration for ServiceMicrosoftDefenderForIoTCard](../../../azure-23/Item/Security/ServiceMicrosoftDefenderForIoTCard.Local.png) | ![illustration for ServiceMicrosoftDefenderForIoTGroup](../../../azure-23/Item/Security/ServiceMicrosoftDefenderForIoTGroup.Local.png) |
