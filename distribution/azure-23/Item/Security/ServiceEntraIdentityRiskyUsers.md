...
```text
azure-23/Item/Security/ServiceEntraIdentityRiskyUsers
```

```text
include('azure-23/Item/Security/ServiceEntraIdentityRiskyUsers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceEntraIdentityRiskyUsers.png) | ![illustration for ServiceEntraIdentityRiskyUsers](../../../azure-23/Item/Security/ServiceEntraIdentityRiskyUsers.Local.png) | ![illustration for ServiceEntraIdentityRiskyUsersCard](../../../azure-23/Item/Security/ServiceEntraIdentityRiskyUsersCard.Local.png) | ![illustration for ServiceEntraIdentityRiskyUsersGroup](../../../azure-23/Item/Security/ServiceEntraIdentityRiskyUsersGroup.Local.png) |
