...
```text
azure-23/Item/Security/ServiceUserSettings
```

```text
include('azure-23/Item/Security/ServiceUserSettings')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceUserSettings.png) | ![illustration for ServiceUserSettings](../../../azure-23/Item/Security/ServiceUserSettings.Local.png) | ![illustration for ServiceUserSettingsCard](../../../azure-23/Item/Security/ServiceUserSettingsCard.Local.png) | ![illustration for ServiceUserSettingsGroup](../../../azure-23/Item/Security/ServiceUserSettingsGroup.Local.png) |
