...
```text
azure-23/Item/Security/ServiceAzureSentinel
```

```text
include('azure-23/Item/Security/ServiceAzureSentinel')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceAzureSentinel.png) | ![illustration for ServiceAzureSentinel](../../../azure-23/Item/Security/ServiceAzureSentinel.Local.png) | ![illustration for ServiceAzureSentinelCard](../../../azure-23/Item/Security/ServiceAzureSentinelCard.Local.png) | ![illustration for ServiceAzureSentinelGroup](../../../azure-23/Item/Security/ServiceAzureSentinelGroup.Local.png) |
