...
```text
azure-23/Item/Security/ServiceApplicationSecurityGroups
```

```text
include('azure-23/Item/Security/ServiceApplicationSecurityGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceApplicationSecurityGroups.png) | ![illustration for ServiceApplicationSecurityGroups](../../../azure-23/Item/Security/ServiceApplicationSecurityGroups.Local.png) | ![illustration for ServiceApplicationSecurityGroupsCard](../../../azure-23/Item/Security/ServiceApplicationSecurityGroupsCard.Local.png) | ![illustration for ServiceApplicationSecurityGroupsGroup](../../../azure-23/Item/Security/ServiceApplicationSecurityGroupsGroup.Local.png) |
