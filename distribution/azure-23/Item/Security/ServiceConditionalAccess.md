...
```text
azure-23/Item/Security/ServiceConditionalAccess
```

```text
include('azure-23/Item/Security/ServiceConditionalAccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceConditionalAccess.png) | ![illustration for ServiceConditionalAccess](../../../azure-23/Item/Security/ServiceConditionalAccess.Local.png) | ![illustration for ServiceConditionalAccessCard](../../../azure-23/Item/Security/ServiceConditionalAccessCard.Local.png) | ![illustration for ServiceConditionalAccessGroup](../../../azure-23/Item/Security/ServiceConditionalAccessGroup.Local.png) |
