...
```text
azure-23/Item/Security/ServiceEntraIdentityRiskySignins
```

```text
include('azure-23/Item/Security/ServiceEntraIdentityRiskySignins')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceEntraIdentityRiskySignins.png) | ![illustration for ServiceEntraIdentityRiskySignins](../../../azure-23/Item/Security/ServiceEntraIdentityRiskySignins.Local.png) | ![illustration for ServiceEntraIdentityRiskySigninsCard](../../../azure-23/Item/Security/ServiceEntraIdentityRiskySigninsCard.Local.png) | ![illustration for ServiceEntraIdentityRiskySigninsGroup](../../../azure-23/Item/Security/ServiceEntraIdentityRiskySigninsGroup.Local.png) |
