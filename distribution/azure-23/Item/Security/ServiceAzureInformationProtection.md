...
```text
azure-23/Item/Security/ServiceAzureInformationProtection
```

```text
include('azure-23/Item/Security/ServiceAzureInformationProtection')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceAzureInformationProtection.png) | ![illustration for ServiceAzureInformationProtection](../../../azure-23/Item/Security/ServiceAzureInformationProtection.Local.png) | ![illustration for ServiceAzureInformationProtectionCard](../../../azure-23/Item/Security/ServiceAzureInformationProtectionCard.Local.png) | ![illustration for ServiceAzureInformationProtectionGroup](../../../azure-23/Item/Security/ServiceAzureInformationProtectionGroup.Local.png) |
