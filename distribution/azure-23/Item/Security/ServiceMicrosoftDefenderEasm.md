...
```text
azure-23/Item/Security/ServiceMicrosoftDefenderEasm
```

```text
include('azure-23/Item/Security/ServiceMicrosoftDefenderEasm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceMicrosoftDefenderEasm.png) | ![illustration for ServiceMicrosoftDefenderEasm](../../../azure-23/Item/Security/ServiceMicrosoftDefenderEasm.Local.png) | ![illustration for ServiceMicrosoftDefenderEasmCard](../../../azure-23/Item/Security/ServiceMicrosoftDefenderEasmCard.Local.png) | ![illustration for ServiceMicrosoftDefenderEasmGroup](../../../azure-23/Item/Security/ServiceMicrosoftDefenderEasmGroup.Local.png) |
