...
```text
azure-23/Item/Security/ServiceKeyVaults
```

```text
include('azure-23/Item/Security/ServiceKeyVaults')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceKeyVaults.png) | ![illustration for ServiceKeyVaults](../../../azure-23/Item/Security/ServiceKeyVaults.Local.png) | ![illustration for ServiceKeyVaultsCard](../../../azure-23/Item/Security/ServiceKeyVaultsCard.Local.png) | ![illustration for ServiceKeyVaultsGroup](../../../azure-23/Item/Security/ServiceKeyVaultsGroup.Local.png) |
