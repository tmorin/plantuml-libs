...
```text
azure-23/Item/Security/ServiceExtendedSecurityUpdates
```

```text
include('azure-23/Item/Security/ServiceExtendedSecurityUpdates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Security/ServiceExtendedSecurityUpdates.png) | ![illustration for ServiceExtendedSecurityUpdates](../../../azure-23/Item/Security/ServiceExtendedSecurityUpdates.Local.png) | ![illustration for ServiceExtendedSecurityUpdatesCard](../../../azure-23/Item/Security/ServiceExtendedSecurityUpdatesCard.Local.png) | ![illustration for ServiceExtendedSecurityUpdatesGroup](../../../azure-23/Item/Security/ServiceExtendedSecurityUpdatesGroup.Local.png) |
