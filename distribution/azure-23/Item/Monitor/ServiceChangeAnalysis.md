...
```text
azure-23/Item/Monitor/ServiceChangeAnalysis
```

```text
include('azure-23/Item/Monitor/ServiceChangeAnalysis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Monitor/ServiceChangeAnalysis.png) | ![illustration for ServiceChangeAnalysis](../../../azure-23/Item/Monitor/ServiceChangeAnalysis.Local.png) | ![illustration for ServiceChangeAnalysisCard](../../../azure-23/Item/Monitor/ServiceChangeAnalysisCard.Local.png) | ![illustration for ServiceChangeAnalysisGroup](../../../azure-23/Item/Monitor/ServiceChangeAnalysisGroup.Local.png) |
