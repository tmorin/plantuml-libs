...
```text
azure-23/Item/Monitor/ServiceMonitor
```

```text
include('azure-23/Item/Monitor/ServiceMonitor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Monitor/ServiceMonitor.png) | ![illustration for ServiceMonitor](../../../azure-23/Item/Monitor/ServiceMonitor.Local.png) | ![illustration for ServiceMonitorCard](../../../azure-23/Item/Monitor/ServiceMonitorCard.Local.png) | ![illustration for ServiceMonitorGroup](../../../azure-23/Item/Monitor/ServiceMonitorGroup.Local.png) |
