...
```text
azure-23/Item/Monitor/ServiceAutoScale
```

```text
include('azure-23/Item/Monitor/ServiceAutoScale')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Monitor/ServiceAutoScale.png) | ![illustration for ServiceAutoScale](../../../azure-23/Item/Monitor/ServiceAutoScale.Local.png) | ![illustration for ServiceAutoScaleCard](../../../azure-23/Item/Monitor/ServiceAutoScaleCard.Local.png) | ![illustration for ServiceAutoScaleGroup](../../../azure-23/Item/Monitor/ServiceAutoScaleGroup.Local.png) |
