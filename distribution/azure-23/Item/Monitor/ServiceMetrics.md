...
```text
azure-23/Item/Monitor/ServiceMetrics
```

```text
include('azure-23/Item/Monitor/ServiceMetrics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Monitor/ServiceMetrics.png) | ![illustration for ServiceMetrics](../../../azure-23/Item/Monitor/ServiceMetrics.Local.png) | ![illustration for ServiceMetricsCard](../../../azure-23/Item/Monitor/ServiceMetricsCard.Local.png) | ![illustration for ServiceMetricsGroup](../../../azure-23/Item/Monitor/ServiceMetricsGroup.Local.png) |
