...
```text
azure-23/Item/Monitor/ServiceActivityLog
```

```text
include('azure-23/Item/Monitor/ServiceActivityLog')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Monitor/ServiceActivityLog.png) | ![illustration for ServiceActivityLog](../../../azure-23/Item/Monitor/ServiceActivityLog.Local.png) | ![illustration for ServiceActivityLogCard](../../../azure-23/Item/Monitor/ServiceActivityLogCard.Local.png) | ![illustration for ServiceActivityLogGroup](../../../azure-23/Item/Monitor/ServiceActivityLogGroup.Local.png) |
