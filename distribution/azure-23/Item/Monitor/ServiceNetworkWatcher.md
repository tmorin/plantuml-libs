...
```text
azure-23/Item/Monitor/ServiceNetworkWatcher
```

```text
include('azure-23/Item/Monitor/ServiceNetworkWatcher')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Monitor/ServiceNetworkWatcher.png) | ![illustration for ServiceNetworkWatcher](../../../azure-23/Item/Monitor/ServiceNetworkWatcher.Local.png) | ![illustration for ServiceNetworkWatcherCard](../../../azure-23/Item/Monitor/ServiceNetworkWatcherCard.Local.png) | ![illustration for ServiceNetworkWatcherGroup](../../../azure-23/Item/Monitor/ServiceNetworkWatcherGroup.Local.png) |
