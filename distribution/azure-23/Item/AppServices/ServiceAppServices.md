...
```text
azure-23/Item/AppServices/ServiceAppServices
```

```text
include('azure-23/Item/AppServices/ServiceAppServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AppServices/ServiceAppServices.png) | ![illustration for ServiceAppServices](../../../azure-23/Item/AppServices/ServiceAppServices.Local.png) | ![illustration for ServiceAppServicesCard](../../../azure-23/Item/AppServices/ServiceAppServicesCard.Local.png) | ![illustration for ServiceAppServicesGroup](../../../azure-23/Item/AppServices/ServiceAppServicesGroup.Local.png) |
