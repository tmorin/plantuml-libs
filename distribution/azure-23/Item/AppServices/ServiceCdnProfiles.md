...
```text
azure-23/Item/AppServices/ServiceCdnProfiles
```

```text
include('azure-23/Item/AppServices/ServiceCdnProfiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AppServices/ServiceCdnProfiles.png) | ![illustration for ServiceCdnProfiles](../../../azure-23/Item/AppServices/ServiceCdnProfiles.Local.png) | ![illustration for ServiceCdnProfilesCard](../../../azure-23/Item/AppServices/ServiceCdnProfilesCard.Local.png) | ![illustration for ServiceCdnProfilesGroup](../../../azure-23/Item/AppServices/ServiceCdnProfilesGroup.Local.png) |
