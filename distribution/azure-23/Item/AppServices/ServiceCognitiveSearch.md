...
```text
azure-23/Item/AppServices/ServiceCognitiveSearch
```

```text
include('azure-23/Item/AppServices/ServiceCognitiveSearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AppServices/ServiceCognitiveSearch.png) | ![illustration for ServiceCognitiveSearch](../../../azure-23/Item/AppServices/ServiceCognitiveSearch.Local.png) | ![illustration for ServiceCognitiveSearchCard](../../../azure-23/Item/AppServices/ServiceCognitiveSearchCard.Local.png) | ![illustration for ServiceCognitiveSearchGroup](../../../azure-23/Item/AppServices/ServiceCognitiveSearchGroup.Local.png) |
