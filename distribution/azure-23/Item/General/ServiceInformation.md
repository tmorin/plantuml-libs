...
```text
azure-23/Item/General/ServiceInformation
```

```text
include('azure-23/Item/General/ServiceInformation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceInformation.png) | ![illustration for ServiceInformation](../../../azure-23/Item/General/ServiceInformation.Local.png) | ![illustration for ServiceInformationCard](../../../azure-23/Item/General/ServiceInformationCard.Local.png) | ![illustration for ServiceInformationGroup](../../../azure-23/Item/General/ServiceInformationGroup.Local.png) |
