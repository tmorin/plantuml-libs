...
```text
azure-23/Item/General/ServiceManagementPortal
```

```text
include('azure-23/Item/General/ServiceManagementPortal')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceManagementPortal.png) | ![illustration for ServiceManagementPortal](../../../azure-23/Item/General/ServiceManagementPortal.Local.png) | ![illustration for ServiceManagementPortalCard](../../../azure-23/Item/General/ServiceManagementPortalCard.Local.png) | ![illustration for ServiceManagementPortalGroup](../../../azure-23/Item/General/ServiceManagementPortalGroup.Local.png) |
