...
```text
azure-23/Item/General/ServiceDownload
```

```text
include('azure-23/Item/General/ServiceDownload')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceDownload.png) | ![illustration for ServiceDownload](../../../azure-23/Item/General/ServiceDownload.Local.png) | ![illustration for ServiceDownloadCard](../../../azure-23/Item/General/ServiceDownloadCard.Local.png) | ![illustration for ServiceDownloadGroup](../../../azure-23/Item/General/ServiceDownloadGroup.Local.png) |
