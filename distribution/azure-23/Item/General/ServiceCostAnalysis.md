...
```text
azure-23/Item/General/ServiceCostAnalysis
```

```text
include('azure-23/Item/General/ServiceCostAnalysis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceCostAnalysis.png) | ![illustration for ServiceCostAnalysis](../../../azure-23/Item/General/ServiceCostAnalysis.Local.png) | ![illustration for ServiceCostAnalysisCard](../../../azure-23/Item/General/ServiceCostAnalysisCard.Local.png) | ![illustration for ServiceCostAnalysisGroup](../../../azure-23/Item/General/ServiceCostAnalysisGroup.Local.png) |
