...
```text
azure-23/Item/General/ServiceFolderBlank
```

```text
include('azure-23/Item/General/ServiceFolderBlank')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceFolderBlank.png) | ![illustration for ServiceFolderBlank](../../../azure-23/Item/General/ServiceFolderBlank.Local.png) | ![illustration for ServiceFolderBlankCard](../../../azure-23/Item/General/ServiceFolderBlankCard.Local.png) | ![illustration for ServiceFolderBlankGroup](../../../azure-23/Item/General/ServiceFolderBlankGroup.Local.png) |
