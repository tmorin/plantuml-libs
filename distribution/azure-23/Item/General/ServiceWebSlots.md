...
```text
azure-23/Item/General/ServiceWebSlots
```

```text
include('azure-23/Item/General/ServiceWebSlots')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceWebSlots.png) | ![illustration for ServiceWebSlots](../../../azure-23/Item/General/ServiceWebSlots.Local.png) | ![illustration for ServiceWebSlotsCard](../../../azure-23/Item/General/ServiceWebSlotsCard.Local.png) | ![illustration for ServiceWebSlotsGroup](../../../azure-23/Item/General/ServiceWebSlotsGroup.Local.png) |
