...
```text
azure-23/Item/General/ServiceServerFarm
```

```text
include('azure-23/Item/General/ServiceServerFarm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceServerFarm.png) | ![illustration for ServiceServerFarm](../../../azure-23/Item/General/ServiceServerFarm.Local.png) | ![illustration for ServiceServerFarmCard](../../../azure-23/Item/General/ServiceServerFarmCard.Local.png) | ![illustration for ServiceServerFarmGroup](../../../azure-23/Item/General/ServiceServerFarmGroup.Local.png) |
