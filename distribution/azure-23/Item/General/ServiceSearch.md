...
```text
azure-23/Item/General/ServiceSearch
```

```text
include('azure-23/Item/General/ServiceSearch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceSearch.png) | ![illustration for ServiceSearch](../../../azure-23/Item/General/ServiceSearch.Local.png) | ![illustration for ServiceSearchCard](../../../azure-23/Item/General/ServiceSearchCard.Local.png) | ![illustration for ServiceSearchGroup](../../../azure-23/Item/General/ServiceSearchGroup.Local.png) |
