...
```text
azure-23/Item/General/ServiceCache
```

```text
include('azure-23/Item/General/ServiceCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceCache.png) | ![illustration for ServiceCache](../../../azure-23/Item/General/ServiceCache.Local.png) | ![illustration for ServiceCacheCard](../../../azure-23/Item/General/ServiceCacheCard.Local.png) | ![illustration for ServiceCacheGroup](../../../azure-23/Item/General/ServiceCacheGroup.Local.png) |
