...
```text
azure-23/Item/General/ServiceGlobeSuccess
```

```text
include('azure-23/Item/General/ServiceGlobeSuccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceGlobeSuccess.png) | ![illustration for ServiceGlobeSuccess](../../../azure-23/Item/General/ServiceGlobeSuccess.Local.png) | ![illustration for ServiceGlobeSuccessCard](../../../azure-23/Item/General/ServiceGlobeSuccessCard.Local.png) | ![illustration for ServiceGlobeSuccessGroup](../../../azure-23/Item/General/ServiceGlobeSuccessGroup.Local.png) |
