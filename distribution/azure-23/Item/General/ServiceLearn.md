...
```text
azure-23/Item/General/ServiceLearn
```

```text
include('azure-23/Item/General/ServiceLearn')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceLearn.png) | ![illustration for ServiceLearn](../../../azure-23/Item/General/ServiceLearn.Local.png) | ![illustration for ServiceLearnCard](../../../azure-23/Item/General/ServiceLearnCard.Local.png) | ![illustration for ServiceLearnGroup](../../../azure-23/Item/General/ServiceLearnGroup.Local.png) |
