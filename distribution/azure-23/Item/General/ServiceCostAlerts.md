...
```text
azure-23/Item/General/ServiceCostAlerts
```

```text
include('azure-23/Item/General/ServiceCostAlerts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceCostAlerts.png) | ![illustration for ServiceCostAlerts](../../../azure-23/Item/General/ServiceCostAlerts.Local.png) | ![illustration for ServiceCostAlertsCard](../../../azure-23/Item/General/ServiceCostAlertsCard.Local.png) | ![illustration for ServiceCostAlertsGroup](../../../azure-23/Item/General/ServiceCostAlertsGroup.Local.png) |
