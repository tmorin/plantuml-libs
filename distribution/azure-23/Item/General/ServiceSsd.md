...
```text
azure-23/Item/General/ServiceSsd
```

```text
include('azure-23/Item/General/ServiceSsd')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceSsd.png) | ![illustration for ServiceSsd](../../../azure-23/Item/General/ServiceSsd.Local.png) | ![illustration for ServiceSsdCard](../../../azure-23/Item/General/ServiceSsdCard.Local.png) | ![illustration for ServiceSsdGroup](../../../azure-23/Item/General/ServiceSsdGroup.Local.png) |
