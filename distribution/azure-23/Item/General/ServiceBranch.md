...
```text
azure-23/Item/General/ServiceBranch
```

```text
include('azure-23/Item/General/ServiceBranch')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceBranch.png) | ![illustration for ServiceBranch](../../../azure-23/Item/General/ServiceBranch.Local.png) | ![illustration for ServiceBranchCard](../../../azure-23/Item/General/ServiceBranchCard.Local.png) | ![illustration for ServiceBranchGroup](../../../azure-23/Item/General/ServiceBranchGroup.Local.png) |
