...
```text
azure-23/Item/General/ServiceRegionManagement
```

```text
include('azure-23/Item/General/ServiceRegionManagement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceRegionManagement.png) | ![illustration for ServiceRegionManagement](../../../azure-23/Item/General/ServiceRegionManagement.Local.png) | ![illustration for ServiceRegionManagementCard](../../../azure-23/Item/General/ServiceRegionManagementCard.Local.png) | ![illustration for ServiceRegionManagementGroup](../../../azure-23/Item/General/ServiceRegionManagementGroup.Local.png) |
