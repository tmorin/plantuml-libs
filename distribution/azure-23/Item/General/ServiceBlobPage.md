...
```text
azure-23/Item/General/ServiceBlobPage
```

```text
include('azure-23/Item/General/ServiceBlobPage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceBlobPage.png) | ![illustration for ServiceBlobPage](../../../azure-23/Item/General/ServiceBlobPage.Local.png) | ![illustration for ServiceBlobPageCard](../../../azure-23/Item/General/ServiceBlobPageCard.Local.png) | ![illustration for ServiceBlobPageGroup](../../../azure-23/Item/General/ServiceBlobPageGroup.Local.png) |
