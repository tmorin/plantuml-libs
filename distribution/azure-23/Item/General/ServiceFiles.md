...
```text
azure-23/Item/General/ServiceFiles
```

```text
include('azure-23/Item/General/ServiceFiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceFiles.png) | ![illustration for ServiceFiles](../../../azure-23/Item/General/ServiceFiles.Local.png) | ![illustration for ServiceFilesCard](../../../azure-23/Item/General/ServiceFilesCard.Local.png) | ![illustration for ServiceFilesGroup](../../../azure-23/Item/General/ServiceFilesGroup.Local.png) |
