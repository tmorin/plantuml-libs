...
```text
azure-23/Item/General/ServiceCostManagementAndBilling
```

```text
include('azure-23/Item/General/ServiceCostManagementAndBilling')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceCostManagementAndBilling.png) | ![illustration for ServiceCostManagementAndBilling](../../../azure-23/Item/General/ServiceCostManagementAndBilling.Local.png) | ![illustration for ServiceCostManagementAndBillingCard](../../../azure-23/Item/General/ServiceCostManagementAndBillingCard.Local.png) | ![illustration for ServiceCostManagementAndBillingGroup](../../../azure-23/Item/General/ServiceCostManagementAndBillingGroup.Local.png) |
