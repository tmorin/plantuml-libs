...
```text
azure-23/Item/General/ServiceGuide
```

```text
include('azure-23/Item/General/ServiceGuide')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceGuide.png) | ![illustration for ServiceGuide](../../../azure-23/Item/General/ServiceGuide.Local.png) | ![illustration for ServiceGuideCard](../../../azure-23/Item/General/ServiceGuideCard.Local.png) | ![illustration for ServiceGuideGroup](../../../azure-23/Item/General/ServiceGuideGroup.Local.png) |
