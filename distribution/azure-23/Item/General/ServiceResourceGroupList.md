...
```text
azure-23/Item/General/ServiceResourceGroupList
```

```text
include('azure-23/Item/General/ServiceResourceGroupList')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceResourceGroupList.png) | ![illustration for ServiceResourceGroupList](../../../azure-23/Item/General/ServiceResourceGroupList.Local.png) | ![illustration for ServiceResourceGroupListCard](../../../azure-23/Item/General/ServiceResourceGroupListCard.Local.png) | ![illustration for ServiceResourceGroupListGroup](../../../azure-23/Item/General/ServiceResourceGroupListGroup.Local.png) |
