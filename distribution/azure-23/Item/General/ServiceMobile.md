...
```text
azure-23/Item/General/ServiceMobile
```

```text
include('azure-23/Item/General/ServiceMobile')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceMobile.png) | ![illustration for ServiceMobile](../../../azure-23/Item/General/ServiceMobile.Local.png) | ![illustration for ServiceMobileCard](../../../azure-23/Item/General/ServiceMobileCard.Local.png) | ![illustration for ServiceMobileGroup](../../../azure-23/Item/General/ServiceMobileGroup.Local.png) |
