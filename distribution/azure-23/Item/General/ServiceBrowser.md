...
```text
azure-23/Item/General/ServiceBrowser
```

```text
include('azure-23/Item/General/ServiceBrowser')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceBrowser.png) | ![illustration for ServiceBrowser](../../../azure-23/Item/General/ServiceBrowser.Local.png) | ![illustration for ServiceBrowserCard](../../../azure-23/Item/General/ServiceBrowserCard.Local.png) | ![illustration for ServiceBrowserGroup](../../../azure-23/Item/General/ServiceBrowserGroup.Local.png) |
