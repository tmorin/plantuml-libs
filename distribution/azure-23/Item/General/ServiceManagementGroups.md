...
```text
azure-23/Item/General/ServiceManagementGroups
```

```text
include('azure-23/Item/General/ServiceManagementGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceManagementGroups.png) | ![illustration for ServiceManagementGroups](../../../azure-23/Item/General/ServiceManagementGroups.Local.png) | ![illustration for ServiceManagementGroupsCard](../../../azure-23/Item/General/ServiceManagementGroupsCard.Local.png) | ![illustration for ServiceManagementGroupsGroup](../../../azure-23/Item/General/ServiceManagementGroupsGroup.Local.png) |
