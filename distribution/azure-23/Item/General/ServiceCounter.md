...
```text
azure-23/Item/General/ServiceCounter
```

```text
include('azure-23/Item/General/ServiceCounter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceCounter.png) | ![illustration for ServiceCounter](../../../azure-23/Item/General/ServiceCounter.Local.png) | ![illustration for ServiceCounterCard](../../../azure-23/Item/General/ServiceCounterCard.Local.png) | ![illustration for ServiceCounterGroup](../../../azure-23/Item/General/ServiceCounterGroup.Local.png) |
