...
```text
azure-23/Item/General/ServiceLocation
```

```text
include('azure-23/Item/General/ServiceLocation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceLocation.png) | ![illustration for ServiceLocation](../../../azure-23/Item/General/ServiceLocation.Local.png) | ![illustration for ServiceLocationCard](../../../azure-23/Item/General/ServiceLocationCard.Local.png) | ![illustration for ServiceLocationGroup](../../../azure-23/Item/General/ServiceLocationGroup.Local.png) |
