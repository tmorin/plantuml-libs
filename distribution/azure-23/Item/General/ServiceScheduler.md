...
```text
azure-23/Item/General/ServiceScheduler
```

```text
include('azure-23/Item/General/ServiceScheduler')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceScheduler.png) | ![illustration for ServiceScheduler](../../../azure-23/Item/General/ServiceScheduler.Local.png) | ![illustration for ServiceSchedulerCard](../../../azure-23/Item/General/ServiceSchedulerCard.Local.png) | ![illustration for ServiceSchedulerGroup](../../../azure-23/Item/General/ServiceSchedulerGroup.Local.png) |
