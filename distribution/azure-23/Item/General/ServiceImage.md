...
```text
azure-23/Item/General/ServiceImage
```

```text
include('azure-23/Item/General/ServiceImage')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceImage.png) | ![illustration for ServiceImage](../../../azure-23/Item/General/ServiceImage.Local.png) | ![illustration for ServiceImageCard](../../../azure-23/Item/General/ServiceImageCard.Local.png) | ![illustration for ServiceImageGroup](../../../azure-23/Item/General/ServiceImageGroup.Local.png) |
