...
```text
azure-23/Item/General/ServiceQuickstartCenter
```

```text
include('azure-23/Item/General/ServiceQuickstartCenter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceQuickstartCenter.png) | ![illustration for ServiceQuickstartCenter](../../../azure-23/Item/General/ServiceQuickstartCenter.Local.png) | ![illustration for ServiceQuickstartCenterCard](../../../azure-23/Item/General/ServiceQuickstartCenterCard.Local.png) | ![illustration for ServiceQuickstartCenterGroup](../../../azure-23/Item/General/ServiceQuickstartCenterGroup.Local.png) |
