...
```text
azure-23/Item/General/ServiceExtensions
```

```text
include('azure-23/Item/General/ServiceExtensions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceExtensions.png) | ![illustration for ServiceExtensions](../../../azure-23/Item/General/ServiceExtensions.Local.png) | ![illustration for ServiceExtensionsCard](../../../azure-23/Item/General/ServiceExtensionsCard.Local.png) | ![illustration for ServiceExtensionsGroup](../../../azure-23/Item/General/ServiceExtensionsGroup.Local.png) |
