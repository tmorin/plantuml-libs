...
```text
azure-23/Item/General/ServicePowershell
```

```text
include('azure-23/Item/General/ServicePowershell')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServicePowershell.png) | ![illustration for ServicePowershell](../../../azure-23/Item/General/ServicePowershell.Local.png) | ![illustration for ServicePowershellCard](../../../azure-23/Item/General/ServicePowershellCard.Local.png) | ![illustration for ServicePowershellGroup](../../../azure-23/Item/General/ServicePowershellGroup.Local.png) |
