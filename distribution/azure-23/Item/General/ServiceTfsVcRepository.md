...
```text
azure-23/Item/General/ServiceTfsVcRepository
```

```text
include('azure-23/Item/General/ServiceTfsVcRepository')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceTfsVcRepository.png) | ![illustration for ServiceTfsVcRepository](../../../azure-23/Item/General/ServiceTfsVcRepository.Local.png) | ![illustration for ServiceTfsVcRepositoryCard](../../../azure-23/Item/General/ServiceTfsVcRepositoryCard.Local.png) | ![illustration for ServiceTfsVcRepositoryGroup](../../../azure-23/Item/General/ServiceTfsVcRepositoryGroup.Local.png) |
