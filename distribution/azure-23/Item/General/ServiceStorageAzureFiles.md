...
```text
azure-23/Item/General/ServiceStorageAzureFiles
```

```text
include('azure-23/Item/General/ServiceStorageAzureFiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceStorageAzureFiles.png) | ![illustration for ServiceStorageAzureFiles](../../../azure-23/Item/General/ServiceStorageAzureFiles.Local.png) | ![illustration for ServiceStorageAzureFilesCard](../../../azure-23/Item/General/ServiceStorageAzureFilesCard.Local.png) | ![illustration for ServiceStorageAzureFilesGroup](../../../azure-23/Item/General/ServiceStorageAzureFilesGroup.Local.png) |
