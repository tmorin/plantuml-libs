...
```text
azure-23/Item/General/ServiceSearchGrid
```

```text
include('azure-23/Item/General/ServiceSearchGrid')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceSearchGrid.png) | ![illustration for ServiceSearchGrid](../../../azure-23/Item/General/ServiceSearchGrid.Local.png) | ![illustration for ServiceSearchGridCard](../../../azure-23/Item/General/ServiceSearchGridCard.Local.png) | ![illustration for ServiceSearchGridGroup](../../../azure-23/Item/General/ServiceSearchGridGroup.Local.png) |
