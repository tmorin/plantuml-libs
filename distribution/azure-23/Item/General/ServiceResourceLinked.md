...
```text
azure-23/Item/General/ServiceResourceLinked
```

```text
include('azure-23/Item/General/ServiceResourceLinked')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceResourceLinked.png) | ![illustration for ServiceResourceLinked](../../../azure-23/Item/General/ServiceResourceLinked.Local.png) | ![illustration for ServiceResourceLinkedCard](../../../azure-23/Item/General/ServiceResourceLinkedCard.Local.png) | ![illustration for ServiceResourceLinkedGroup](../../../azure-23/Item/General/ServiceResourceLinkedGroup.Local.png) |
