...
```text
azure-23/Item/General/ServiceStorageQueue
```

```text
include('azure-23/Item/General/ServiceStorageQueue')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceStorageQueue.png) | ![illustration for ServiceStorageQueue](../../../azure-23/Item/General/ServiceStorageQueue.Local.png) | ![illustration for ServiceStorageQueueCard](../../../azure-23/Item/General/ServiceStorageQueueCard.Local.png) | ![illustration for ServiceStorageQueueGroup](../../../azure-23/Item/General/ServiceStorageQueueGroup.Local.png) |
