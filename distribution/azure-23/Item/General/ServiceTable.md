...
```text
azure-23/Item/General/ServiceTable
```

```text
include('azure-23/Item/General/ServiceTable')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceTable.png) | ![illustration for ServiceTable](../../../azure-23/Item/General/ServiceTable.Local.png) | ![illustration for ServiceTableCard](../../../azure-23/Item/General/ServiceTableCard.Local.png) | ![illustration for ServiceTableGroup](../../../azure-23/Item/General/ServiceTableGroup.Local.png) |
