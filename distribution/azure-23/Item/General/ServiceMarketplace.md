...
```text
azure-23/Item/General/ServiceMarketplace
```

```text
include('azure-23/Item/General/ServiceMarketplace')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceMarketplace.png) | ![illustration for ServiceMarketplace](../../../azure-23/Item/General/ServiceMarketplace.Local.png) | ![illustration for ServiceMarketplaceCard](../../../azure-23/Item/General/ServiceMarketplaceCard.Local.png) | ![illustration for ServiceMarketplaceGroup](../../../azure-23/Item/General/ServiceMarketplaceGroup.Local.png) |
