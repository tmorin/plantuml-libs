...
```text
azure-23/Item/General/ServiceBacklog
```

```text
include('azure-23/Item/General/ServiceBacklog')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceBacklog.png) | ![illustration for ServiceBacklog](../../../azure-23/Item/General/ServiceBacklog.Local.png) | ![illustration for ServiceBacklogCard](../../../azure-23/Item/General/ServiceBacklogCard.Local.png) | ![illustration for ServiceBacklogGroup](../../../azure-23/Item/General/ServiceBacklogGroup.Local.png) |
