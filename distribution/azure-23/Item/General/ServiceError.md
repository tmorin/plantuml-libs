...
```text
azure-23/Item/General/ServiceError
```

```text
include('azure-23/Item/General/ServiceError')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceError.png) | ![illustration for ServiceError](../../../azure-23/Item/General/ServiceError.Local.png) | ![illustration for ServiceErrorCard](../../../azure-23/Item/General/ServiceErrorCard.Local.png) | ![illustration for ServiceErrorGroup](../../../azure-23/Item/General/ServiceErrorGroup.Local.png) |
