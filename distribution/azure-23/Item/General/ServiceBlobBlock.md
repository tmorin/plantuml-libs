...
```text
azure-23/Item/General/ServiceBlobBlock
```

```text
include('azure-23/Item/General/ServiceBlobBlock')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceBlobBlock.png) | ![illustration for ServiceBlobBlock](../../../azure-23/Item/General/ServiceBlobBlock.Local.png) | ![illustration for ServiceBlobBlockCard](../../../azure-23/Item/General/ServiceBlobBlockCard.Local.png) | ![illustration for ServiceBlobBlockGroup](../../../azure-23/Item/General/ServiceBlobBlockGroup.Local.png) |
