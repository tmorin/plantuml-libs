...
```text
azure-23/Item/General/ServiceMobileEngagement
```

```text
include('azure-23/Item/General/ServiceMobileEngagement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceMobileEngagement.png) | ![illustration for ServiceMobileEngagement](../../../azure-23/Item/General/ServiceMobileEngagement.Local.png) | ![illustration for ServiceMobileEngagementCard](../../../azure-23/Item/General/ServiceMobileEngagementCard.Local.png) | ![illustration for ServiceMobileEngagementGroup](../../../azure-23/Item/General/ServiceMobileEngagementGroup.Local.png) |
