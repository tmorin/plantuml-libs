...
```text
azure-23/Item/General/ServiceRecent
```

```text
include('azure-23/Item/General/ServiceRecent')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceRecent.png) | ![illustration for ServiceRecent](../../../azure-23/Item/General/ServiceRecent.Local.png) | ![illustration for ServiceRecentCard](../../../azure-23/Item/General/ServiceRecentCard.Local.png) | ![illustration for ServiceRecentGroup](../../../azure-23/Item/General/ServiceRecentGroup.Local.png) |
