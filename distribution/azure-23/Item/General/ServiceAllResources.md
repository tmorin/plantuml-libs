...
```text
azure-23/Item/General/ServiceAllResources
```

```text
include('azure-23/Item/General/ServiceAllResources')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceAllResources.png) | ![illustration for ServiceAllResources](../../../azure-23/Item/General/ServiceAllResources.Local.png) | ![illustration for ServiceAllResourcesCard](../../../azure-23/Item/General/ServiceAllResourcesCard.Local.png) | ![illustration for ServiceAllResourcesGroup](../../../azure-23/Item/General/ServiceAllResourcesGroup.Local.png) |
