...
```text
azure-23/Item/General/ServiceHeart
```

```text
include('azure-23/Item/General/ServiceHeart')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceHeart.png) | ![illustration for ServiceHeart](../../../azure-23/Item/General/ServiceHeart.Local.png) | ![illustration for ServiceHeartCard](../../../azure-23/Item/General/ServiceHeartCard.Local.png) | ![illustration for ServiceHeartGroup](../../../azure-23/Item/General/ServiceHeartGroup.Local.png) |
