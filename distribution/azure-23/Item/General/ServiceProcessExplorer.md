...
```text
azure-23/Item/General/ServiceProcessExplorer
```

```text
include('azure-23/Item/General/ServiceProcessExplorer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceProcessExplorer.png) | ![illustration for ServiceProcessExplorer](../../../azure-23/Item/General/ServiceProcessExplorer.Local.png) | ![illustration for ServiceProcessExplorerCard](../../../azure-23/Item/General/ServiceProcessExplorerCard.Local.png) | ![illustration for ServiceProcessExplorerGroup](../../../azure-23/Item/General/ServiceProcessExplorerGroup.Local.png) |
