...
```text
azure-23/Item/General/ServiceWebsitePower
```

```text
include('azure-23/Item/General/ServiceWebsitePower')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceWebsitePower.png) | ![illustration for ServiceWebsitePower](../../../azure-23/Item/General/ServiceWebsitePower.Local.png) | ![illustration for ServiceWebsitePowerCard](../../../azure-23/Item/General/ServiceWebsitePowerCard.Local.png) | ![illustration for ServiceWebsitePowerGroup](../../../azure-23/Item/General/ServiceWebsitePowerGroup.Local.png) |
