...
```text
azure-23/Item/General/ServiceStorageContainer
```

```text
include('azure-23/Item/General/ServiceStorageContainer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceStorageContainer.png) | ![illustration for ServiceStorageContainer](../../../azure-23/Item/General/ServiceStorageContainer.Local.png) | ![illustration for ServiceStorageContainerCard](../../../azure-23/Item/General/ServiceStorageContainerCard.Local.png) | ![illustration for ServiceStorageContainerGroup](../../../azure-23/Item/General/ServiceStorageContainerGroup.Local.png) |
