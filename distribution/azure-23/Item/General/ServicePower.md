...
```text
azure-23/Item/General/ServicePower
```

```text
include('azure-23/Item/General/ServicePower')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServicePower.png) | ![illustration for ServicePower](../../../azure-23/Item/General/ServicePower.Local.png) | ![illustration for ServicePowerCard](../../../azure-23/Item/General/ServicePowerCard.Local.png) | ![illustration for ServicePowerGroup](../../../azure-23/Item/General/ServicePowerGroup.Local.png) |
