...
```text
azure-23/Item/General/ServiceVersions
```

```text
include('azure-23/Item/General/ServiceVersions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceVersions.png) | ![illustration for ServiceVersions](../../../azure-23/Item/General/ServiceVersions.Local.png) | ![illustration for ServiceVersionsCard](../../../azure-23/Item/General/ServiceVersionsCard.Local.png) | ![illustration for ServiceVersionsGroup](../../../azure-23/Item/General/ServiceVersionsGroup.Local.png) |
