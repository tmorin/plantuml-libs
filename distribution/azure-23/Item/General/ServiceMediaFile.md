...
```text
azure-23/Item/General/ServiceMediaFile
```

```text
include('azure-23/Item/General/ServiceMediaFile')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceMediaFile.png) | ![illustration for ServiceMediaFile](../../../azure-23/Item/General/ServiceMediaFile.Local.png) | ![illustration for ServiceMediaFileCard](../../../azure-23/Item/General/ServiceMediaFileCard.Local.png) | ![illustration for ServiceMediaFileGroup](../../../azure-23/Item/General/ServiceMediaFileGroup.Local.png) |
