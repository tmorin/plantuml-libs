...
```text
azure-23/Item/General/ServiceLoadTest
```

```text
include('azure-23/Item/General/ServiceLoadTest')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceLoadTest.png) | ![illustration for ServiceLoadTest](../../../azure-23/Item/General/ServiceLoadTest.Local.png) | ![illustration for ServiceLoadTestCard](../../../azure-23/Item/General/ServiceLoadTestCard.Local.png) | ![illustration for ServiceLoadTestGroup](../../../azure-23/Item/General/ServiceLoadTestGroup.Local.png) |
