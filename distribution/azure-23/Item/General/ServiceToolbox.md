...
```text
azure-23/Item/General/ServiceToolbox
```

```text
include('azure-23/Item/General/ServiceToolbox')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceToolbox.png) | ![illustration for ServiceToolbox](../../../azure-23/Item/General/ServiceToolbox.Local.png) | ![illustration for ServiceToolboxCard](../../../azure-23/Item/General/ServiceToolboxCard.Local.png) | ![illustration for ServiceToolboxGroup](../../../azure-23/Item/General/ServiceToolboxGroup.Local.png) |
