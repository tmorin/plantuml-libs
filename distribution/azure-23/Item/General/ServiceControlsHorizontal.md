...
```text
azure-23/Item/General/ServiceControlsHorizontal
```

```text
include('azure-23/Item/General/ServiceControlsHorizontal')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceControlsHorizontal.png) | ![illustration for ServiceControlsHorizontal](../../../azure-23/Item/General/ServiceControlsHorizontal.Local.png) | ![illustration for ServiceControlsHorizontalCard](../../../azure-23/Item/General/ServiceControlsHorizontalCard.Local.png) | ![illustration for ServiceControlsHorizontalGroup](../../../azure-23/Item/General/ServiceControlsHorizontalGroup.Local.png) |
