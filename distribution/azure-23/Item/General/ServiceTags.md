...
```text
azure-23/Item/General/ServiceTags
```

```text
include('azure-23/Item/General/ServiceTags')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceTags.png) | ![illustration for ServiceTags](../../../azure-23/Item/General/ServiceTags.Local.png) | ![illustration for ServiceTagsCard](../../../azure-23/Item/General/ServiceTagsCard.Local.png) | ![illustration for ServiceTagsGroup](../../../azure-23/Item/General/ServiceTagsGroup.Local.png) |
