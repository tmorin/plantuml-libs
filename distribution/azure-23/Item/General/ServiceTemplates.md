...
```text
azure-23/Item/General/ServiceTemplates
```

```text
include('azure-23/Item/General/ServiceTemplates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceTemplates.png) | ![illustration for ServiceTemplates](../../../azure-23/Item/General/ServiceTemplates.Local.png) | ![illustration for ServiceTemplatesCard](../../../azure-23/Item/General/ServiceTemplatesCard.Local.png) | ![illustration for ServiceTemplatesGroup](../../../azure-23/Item/General/ServiceTemplatesGroup.Local.png) |
