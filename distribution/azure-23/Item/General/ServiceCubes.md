...
```text
azure-23/Item/General/ServiceCubes
```

```text
include('azure-23/Item/General/ServiceCubes')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceCubes.png) | ![illustration for ServiceCubes](../../../azure-23/Item/General/ServiceCubes.Local.png) | ![illustration for ServiceCubesCard](../../../azure-23/Item/General/ServiceCubesCard.Local.png) | ![illustration for ServiceCubesGroup](../../../azure-23/Item/General/ServiceCubesGroup.Local.png) |
