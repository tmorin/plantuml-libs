...
```text
azure-23/Item/General/ServiceDevConsole
```

```text
include('azure-23/Item/General/ServiceDevConsole')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceDevConsole.png) | ![illustration for ServiceDevConsole](../../../azure-23/Item/General/ServiceDevConsole.Local.png) | ![illustration for ServiceDevConsoleCard](../../../azure-23/Item/General/ServiceDevConsoleCard.Local.png) | ![illustration for ServiceDevConsoleGroup](../../../azure-23/Item/General/ServiceDevConsoleGroup.Local.png) |
