...
```text
azure-23/Item/General/ServiceMedia
```

```text
include('azure-23/Item/General/ServiceMedia')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceMedia.png) | ![illustration for ServiceMedia](../../../azure-23/Item/General/ServiceMedia.Local.png) | ![illustration for ServiceMediaCard](../../../azure-23/Item/General/ServiceMediaCard.Local.png) | ![illustration for ServiceMediaGroup](../../../azure-23/Item/General/ServiceMediaGroup.Local.png) |
