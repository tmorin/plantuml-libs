...
```text
azure-23/Item/General/ServiceMarketplaceManagement
```

```text
include('azure-23/Item/General/ServiceMarketplaceManagement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceMarketplaceManagement.png) | ![illustration for ServiceMarketplaceManagement](../../../azure-23/Item/General/ServiceMarketplaceManagement.Local.png) | ![illustration for ServiceMarketplaceManagementCard](../../../azure-23/Item/General/ServiceMarketplaceManagementCard.Local.png) | ![illustration for ServiceMarketplaceManagementGroup](../../../azure-23/Item/General/ServiceMarketplaceManagementGroup.Local.png) |
