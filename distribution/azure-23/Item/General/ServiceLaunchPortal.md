...
```text
azure-23/Item/General/ServiceLaunchPortal
```

```text
include('azure-23/Item/General/ServiceLaunchPortal')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceLaunchPortal.png) | ![illustration for ServiceLaunchPortal](../../../azure-23/Item/General/ServiceLaunchPortal.Local.png) | ![illustration for ServiceLaunchPortalCard](../../../azure-23/Item/General/ServiceLaunchPortalCard.Local.png) | ![illustration for ServiceLaunchPortalGroup](../../../azure-23/Item/General/ServiceLaunchPortalGroup.Local.png) |
