...
```text
azure-23/Item/General/ServiceBug
```

```text
include('azure-23/Item/General/ServiceBug')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceBug.png) | ![illustration for ServiceBug](../../../azure-23/Item/General/ServiceBug.Local.png) | ![illustration for ServiceBugCard](../../../azure-23/Item/General/ServiceBugCard.Local.png) | ![illustration for ServiceBugGroup](../../../azure-23/Item/General/ServiceBugGroup.Local.png) |
