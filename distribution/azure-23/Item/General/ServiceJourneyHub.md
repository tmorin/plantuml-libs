...
```text
azure-23/Item/General/ServiceJourneyHub
```

```text
include('azure-23/Item/General/ServiceJourneyHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceJourneyHub.png) | ![illustration for ServiceJourneyHub](../../../azure-23/Item/General/ServiceJourneyHub.Local.png) | ![illustration for ServiceJourneyHubCard](../../../azure-23/Item/General/ServiceJourneyHubCard.Local.png) | ![illustration for ServiceJourneyHubGroup](../../../azure-23/Item/General/ServiceJourneyHubGroup.Local.png) |
