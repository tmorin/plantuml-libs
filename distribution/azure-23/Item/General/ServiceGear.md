...
```text
azure-23/Item/General/ServiceGear
```

```text
include('azure-23/Item/General/ServiceGear')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceGear.png) | ![illustration for ServiceGear](../../../azure-23/Item/General/ServiceGear.Local.png) | ![illustration for ServiceGearCard](../../../azure-23/Item/General/ServiceGearCard.Local.png) | ![illustration for ServiceGearGroup](../../../azure-23/Item/General/ServiceGearGroup.Local.png) |
