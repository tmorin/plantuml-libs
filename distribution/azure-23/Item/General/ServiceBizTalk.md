...
```text
azure-23/Item/General/ServiceBizTalk
```

```text
include('azure-23/Item/General/ServiceBizTalk')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceBizTalk.png) | ![illustration for ServiceBizTalk](../../../azure-23/Item/General/ServiceBizTalk.Local.png) | ![illustration for ServiceBizTalkCard](../../../azure-23/Item/General/ServiceBizTalkCard.Local.png) | ![illustration for ServiceBizTalkGroup](../../../azure-23/Item/General/ServiceBizTalkGroup.Local.png) |
