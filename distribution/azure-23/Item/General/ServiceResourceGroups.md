...
```text
azure-23/Item/General/ServiceResourceGroups
```

```text
include('azure-23/Item/General/ServiceResourceGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceResourceGroups.png) | ![illustration for ServiceResourceGroups](../../../azure-23/Item/General/ServiceResourceGroups.Local.png) | ![illustration for ServiceResourceGroupsCard](../../../azure-23/Item/General/ServiceResourceGroupsCard.Local.png) | ![illustration for ServiceResourceGroupsGroup](../../../azure-23/Item/General/ServiceResourceGroupsGroup.Local.png) |
