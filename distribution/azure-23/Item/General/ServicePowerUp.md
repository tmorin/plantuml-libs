...
```text
azure-23/Item/General/ServicePowerUp
```

```text
include('azure-23/Item/General/ServicePowerUp')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServicePowerUp.png) | ![illustration for ServicePowerUp](../../../azure-23/Item/General/ServicePowerUp.Local.png) | ![illustration for ServicePowerUpCard](../../../azure-23/Item/General/ServicePowerUpCard.Local.png) | ![illustration for ServicePowerUpGroup](../../../azure-23/Item/General/ServicePowerUpGroup.Local.png) |
