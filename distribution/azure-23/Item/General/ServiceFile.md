...
```text
azure-23/Item/General/ServiceFile
```

```text
include('azure-23/Item/General/ServiceFile')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceFile.png) | ![illustration for ServiceFile](../../../azure-23/Item/General/ServiceFile.Local.png) | ![illustration for ServiceFileCard](../../../azure-23/Item/General/ServiceFileCard.Local.png) | ![illustration for ServiceFileGroup](../../../azure-23/Item/General/ServiceFileGroup.Local.png) |
