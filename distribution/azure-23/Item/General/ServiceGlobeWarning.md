...
```text
azure-23/Item/General/ServiceGlobeWarning
```

```text
include('azure-23/Item/General/ServiceGlobeWarning')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceGlobeWarning.png) | ![illustration for ServiceGlobeWarning](../../../azure-23/Item/General/ServiceGlobeWarning.Local.png) | ![illustration for ServiceGlobeWarningCard](../../../azure-23/Item/General/ServiceGlobeWarningCard.Local.png) | ![illustration for ServiceGlobeWarningGroup](../../../azure-23/Item/General/ServiceGlobeWarningGroup.Local.png) |
