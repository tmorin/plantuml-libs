...
```text
azure-23/Item/General/ServiceTag
```

```text
include('azure-23/Item/General/ServiceTag')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceTag.png) | ![illustration for ServiceTag](../../../azure-23/Item/General/ServiceTag.Local.png) | ![illustration for ServiceTagCard](../../../azure-23/Item/General/ServiceTagCard.Local.png) | ![illustration for ServiceTagGroup](../../../azure-23/Item/General/ServiceTagGroup.Local.png) |
