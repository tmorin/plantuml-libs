...
```text
azure-23/Item/General/ServiceModule
```

```text
include('azure-23/Item/General/ServiceModule')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceModule.png) | ![illustration for ServiceModule](../../../azure-23/Item/General/ServiceModule.Local.png) | ![illustration for ServiceModuleCard](../../../azure-23/Item/General/ServiceModuleCard.Local.png) | ![illustration for ServiceModuleGroup](../../../azure-23/Item/General/ServiceModuleGroup.Local.png) |
