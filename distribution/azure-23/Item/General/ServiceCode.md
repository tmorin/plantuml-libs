...
```text
azure-23/Item/General/ServiceCode
```

```text
include('azure-23/Item/General/ServiceCode')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceCode.png) | ![illustration for ServiceCode](../../../azure-23/Item/General/ServiceCode.Local.png) | ![illustration for ServiceCodeCard](../../../azure-23/Item/General/ServiceCodeCard.Local.png) | ![illustration for ServiceCodeGroup](../../../azure-23/Item/General/ServiceCodeGroup.Local.png) |
