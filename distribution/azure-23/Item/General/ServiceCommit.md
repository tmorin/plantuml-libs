...
```text
azure-23/Item/General/ServiceCommit
```

```text
include('azure-23/Item/General/ServiceCommit')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceCommit.png) | ![illustration for ServiceCommit](../../../azure-23/Item/General/ServiceCommit.Local.png) | ![illustration for ServiceCommitCard](../../../azure-23/Item/General/ServiceCommitCard.Local.png) | ![illustration for ServiceCommitGroup](../../../azure-23/Item/General/ServiceCommitGroup.Local.png) |
