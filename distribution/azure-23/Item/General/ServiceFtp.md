...
```text
azure-23/Item/General/ServiceFtp
```

```text
include('azure-23/Item/General/ServiceFtp')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceFtp.png) | ![illustration for ServiceFtp](../../../azure-23/Item/General/ServiceFtp.Local.png) | ![illustration for ServiceFtpCard](../../../azure-23/Item/General/ServiceFtpCard.Local.png) | ![illustration for ServiceFtpGroup](../../../azure-23/Item/General/ServiceFtpGroup.Local.png) |
