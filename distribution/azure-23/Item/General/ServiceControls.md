...
```text
azure-23/Item/General/ServiceControls
```

```text
include('azure-23/Item/General/ServiceControls')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceControls.png) | ![illustration for ServiceControls](../../../azure-23/Item/General/ServiceControls.Local.png) | ![illustration for ServiceControlsCard](../../../azure-23/Item/General/ServiceControlsCard.Local.png) | ![illustration for ServiceControlsGroup](../../../azure-23/Item/General/ServiceControlsGroup.Local.png) |
