...
```text
azure-23/Item/General/ServiceReservations
```

```text
include('azure-23/Item/General/ServiceReservations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceReservations.png) | ![illustration for ServiceReservations](../../../azure-23/Item/General/ServiceReservations.Local.png) | ![illustration for ServiceReservationsCard](../../../azure-23/Item/General/ServiceReservationsCard.Local.png) | ![illustration for ServiceReservationsGroup](../../../azure-23/Item/General/ServiceReservationsGroup.Local.png) |
