...
```text
azure-23/Item/General/ServiceCostManagement
```

```text
include('azure-23/Item/General/ServiceCostManagement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/General/ServiceCostManagement.png) | ![illustration for ServiceCostManagement](../../../azure-23/Item/General/ServiceCostManagement.Local.png) | ![illustration for ServiceCostManagementCard](../../../azure-23/Item/General/ServiceCostManagementCard.Local.png) | ![illustration for ServiceCostManagementGroup](../../../azure-23/Item/General/ServiceCostManagementGroup.Local.png) |
