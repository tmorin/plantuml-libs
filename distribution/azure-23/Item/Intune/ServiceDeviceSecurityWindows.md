...
```text
azure-23/Item/Intune/ServiceDeviceSecurityWindows
```

```text
include('azure-23/Item/Intune/ServiceDeviceSecurityWindows')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceDeviceSecurityWindows.png) | ![illustration for ServiceDeviceSecurityWindows](../../../azure-23/Item/Intune/ServiceDeviceSecurityWindows.Local.png) | ![illustration for ServiceDeviceSecurityWindowsCard](../../../azure-23/Item/Intune/ServiceDeviceSecurityWindowsCard.Local.png) | ![illustration for ServiceDeviceSecurityWindowsGroup](../../../azure-23/Item/Intune/ServiceDeviceSecurityWindowsGroup.Local.png) |
