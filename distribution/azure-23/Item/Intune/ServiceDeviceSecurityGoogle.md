...
```text
azure-23/Item/Intune/ServiceDeviceSecurityGoogle
```

```text
include('azure-23/Item/Intune/ServiceDeviceSecurityGoogle')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceDeviceSecurityGoogle.png) | ![illustration for ServiceDeviceSecurityGoogle](../../../azure-23/Item/Intune/ServiceDeviceSecurityGoogle.Local.png) | ![illustration for ServiceDeviceSecurityGoogleCard](../../../azure-23/Item/Intune/ServiceDeviceSecurityGoogleCard.Local.png) | ![illustration for ServiceDeviceSecurityGoogleGroup](../../../azure-23/Item/Intune/ServiceDeviceSecurityGoogleGroup.Local.png) |
