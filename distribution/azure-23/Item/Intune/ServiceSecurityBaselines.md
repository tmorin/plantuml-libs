...
```text
azure-23/Item/Intune/ServiceSecurityBaselines
```

```text
include('azure-23/Item/Intune/ServiceSecurityBaselines')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceSecurityBaselines.png) | ![illustration for ServiceSecurityBaselines](../../../azure-23/Item/Intune/ServiceSecurityBaselines.Local.png) | ![illustration for ServiceSecurityBaselinesCard](../../../azure-23/Item/Intune/ServiceSecurityBaselinesCard.Local.png) | ![illustration for ServiceSecurityBaselinesGroup](../../../azure-23/Item/Intune/ServiceSecurityBaselinesGroup.Local.png) |
