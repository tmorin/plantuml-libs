...
```text
azure-23/Item/Intune/ServiceClientApps
```

```text
include('azure-23/Item/Intune/ServiceClientApps')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceClientApps.png) | ![illustration for ServiceClientApps](../../../azure-23/Item/Intune/ServiceClientApps.Local.png) | ![illustration for ServiceClientAppsCard](../../../azure-23/Item/Intune/ServiceClientAppsCard.Local.png) | ![illustration for ServiceClientAppsGroup](../../../azure-23/Item/Intune/ServiceClientAppsGroup.Local.png) |
