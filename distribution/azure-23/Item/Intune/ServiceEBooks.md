...
```text
azure-23/Item/Intune/ServiceEBooks
```

```text
include('azure-23/Item/Intune/ServiceEBooks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceEBooks.png) | ![illustration for ServiceEBooks](../../../azure-23/Item/Intune/ServiceEBooks.Local.png) | ![illustration for ServiceEBooksCard](../../../azure-23/Item/Intune/ServiceEBooksCard.Local.png) | ![illustration for ServiceEBooksGroup](../../../azure-23/Item/Intune/ServiceEBooksGroup.Local.png) |
