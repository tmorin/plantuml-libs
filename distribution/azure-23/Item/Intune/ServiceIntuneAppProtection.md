...
```text
azure-23/Item/Intune/ServiceIntuneAppProtection
```

```text
include('azure-23/Item/Intune/ServiceIntuneAppProtection')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceIntuneAppProtection.png) | ![illustration for ServiceIntuneAppProtection](../../../azure-23/Item/Intune/ServiceIntuneAppProtection.Local.png) | ![illustration for ServiceIntuneAppProtectionCard](../../../azure-23/Item/Intune/ServiceIntuneAppProtectionCard.Local.png) | ![illustration for ServiceIntuneAppProtectionGroup](../../../azure-23/Item/Intune/ServiceIntuneAppProtectionGroup.Local.png) |
