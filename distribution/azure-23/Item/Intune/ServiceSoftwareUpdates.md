...
```text
azure-23/Item/Intune/ServiceSoftwareUpdates
```

```text
include('azure-23/Item/Intune/ServiceSoftwareUpdates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceSoftwareUpdates.png) | ![illustration for ServiceSoftwareUpdates](../../../azure-23/Item/Intune/ServiceSoftwareUpdates.Local.png) | ![illustration for ServiceSoftwareUpdatesCard](../../../azure-23/Item/Intune/ServiceSoftwareUpdatesCard.Local.png) | ![illustration for ServiceSoftwareUpdatesGroup](../../../azure-23/Item/Intune/ServiceSoftwareUpdatesGroup.Local.png) |
