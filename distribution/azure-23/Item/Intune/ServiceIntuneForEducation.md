...
```text
azure-23/Item/Intune/ServiceIntuneForEducation
```

```text
include('azure-23/Item/Intune/ServiceIntuneForEducation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceIntuneForEducation.png) | ![illustration for ServiceIntuneForEducation](../../../azure-23/Item/Intune/ServiceIntuneForEducation.Local.png) | ![illustration for ServiceIntuneForEducationCard](../../../azure-23/Item/Intune/ServiceIntuneForEducationCard.Local.png) | ![illustration for ServiceIntuneForEducationGroup](../../../azure-23/Item/Intune/ServiceIntuneForEducationGroup.Local.png) |
