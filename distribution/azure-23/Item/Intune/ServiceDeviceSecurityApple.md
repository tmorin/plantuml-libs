...
```text
azure-23/Item/Intune/ServiceDeviceSecurityApple
```

```text
include('azure-23/Item/Intune/ServiceDeviceSecurityApple')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceDeviceSecurityApple.png) | ![illustration for ServiceDeviceSecurityApple](../../../azure-23/Item/Intune/ServiceDeviceSecurityApple.Local.png) | ![illustration for ServiceDeviceSecurityAppleCard](../../../azure-23/Item/Intune/ServiceDeviceSecurityAppleCard.Local.png) | ![illustration for ServiceDeviceSecurityAppleGroup](../../../azure-23/Item/Intune/ServiceDeviceSecurityAppleGroup.Local.png) |
