...
```text
azure-23/Item/Intune/ServiceDeviceEnrollment
```

```text
include('azure-23/Item/Intune/ServiceDeviceEnrollment')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceDeviceEnrollment.png) | ![illustration for ServiceDeviceEnrollment](../../../azure-23/Item/Intune/ServiceDeviceEnrollment.Local.png) | ![illustration for ServiceDeviceEnrollmentCard](../../../azure-23/Item/Intune/ServiceDeviceEnrollmentCard.Local.png) | ![illustration for ServiceDeviceEnrollmentGroup](../../../azure-23/Item/Intune/ServiceDeviceEnrollmentGroup.Local.png) |
