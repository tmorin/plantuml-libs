...
```text
azure-23/Item/Intune/ServiceMindaro
```

```text
include('azure-23/Item/Intune/ServiceMindaro')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceMindaro.png) | ![illustration for ServiceMindaro](../../../azure-23/Item/Intune/ServiceMindaro.Local.png) | ![illustration for ServiceMindaroCard](../../../azure-23/Item/Intune/ServiceMindaroCard.Local.png) | ![illustration for ServiceMindaroGroup](../../../azure-23/Item/Intune/ServiceMindaroGroup.Local.png) |
