...
```text
azure-23/Item/Intune/ServiceExchangeAccess
```

```text
include('azure-23/Item/Intune/ServiceExchangeAccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceExchangeAccess.png) | ![illustration for ServiceExchangeAccess](../../../azure-23/Item/Intune/ServiceExchangeAccess.Local.png) | ![illustration for ServiceExchangeAccessCard](../../../azure-23/Item/Intune/ServiceExchangeAccessCard.Local.png) | ![illustration for ServiceExchangeAccessGroup](../../../azure-23/Item/Intune/ServiceExchangeAccessGroup.Local.png) |
