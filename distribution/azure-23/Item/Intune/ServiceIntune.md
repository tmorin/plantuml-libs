...
```text
azure-23/Item/Intune/ServiceIntune
```

```text
include('azure-23/Item/Intune/ServiceIntune')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceIntune.png) | ![illustration for ServiceIntune](../../../azure-23/Item/Intune/ServiceIntune.Local.png) | ![illustration for ServiceIntuneCard](../../../azure-23/Item/Intune/ServiceIntuneCard.Local.png) | ![illustration for ServiceIntuneGroup](../../../azure-23/Item/Intune/ServiceIntuneGroup.Local.png) |
