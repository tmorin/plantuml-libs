...
```text
azure-23/Item/Intune/ServiceTenantStatus
```

```text
include('azure-23/Item/Intune/ServiceTenantStatus')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Intune/ServiceTenantStatus.png) | ![illustration for ServiceTenantStatus](../../../azure-23/Item/Intune/ServiceTenantStatus.Local.png) | ![illustration for ServiceTenantStatusCard](../../../azure-23/Item/Intune/ServiceTenantStatusCard.Local.png) | ![illustration for ServiceTenantStatusGroup](../../../azure-23/Item/Intune/ServiceTenantStatusGroup.Local.png) |
