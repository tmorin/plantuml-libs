...
```text
azure-23/Item/Migrate/ServiceAzureDataboxGateway
```

```text
include('azure-23/Item/Migrate/ServiceAzureDataboxGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Migrate/ServiceAzureDataboxGateway.png) | ![illustration for ServiceAzureDataboxGateway](../../../azure-23/Item/Migrate/ServiceAzureDataboxGateway.Local.png) | ![illustration for ServiceAzureDataboxGatewayCard](../../../azure-23/Item/Migrate/ServiceAzureDataboxGatewayCard.Local.png) | ![illustration for ServiceAzureDataboxGatewayGroup](../../../azure-23/Item/Migrate/ServiceAzureDataboxGatewayGroup.Local.png) |
