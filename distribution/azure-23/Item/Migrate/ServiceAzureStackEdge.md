...
```text
azure-23/Item/Migrate/ServiceAzureStackEdge
```

```text
include('azure-23/Item/Migrate/ServiceAzureStackEdge')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Migrate/ServiceAzureStackEdge.png) | ![illustration for ServiceAzureStackEdge](../../../azure-23/Item/Migrate/ServiceAzureStackEdge.Local.png) | ![illustration for ServiceAzureStackEdgeCard](../../../azure-23/Item/Migrate/ServiceAzureStackEdgeCard.Local.png) | ![illustration for ServiceAzureStackEdgeGroup](../../../azure-23/Item/Migrate/ServiceAzureStackEdgeGroup.Local.png) |
