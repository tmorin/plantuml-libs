...
```text
azure-23/Item/Migrate/ServiceAzureMigrate
```

```text
include('azure-23/Item/Migrate/ServiceAzureMigrate')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Migrate/ServiceAzureMigrate.png) | ![illustration for ServiceAzureMigrate](../../../azure-23/Item/Migrate/ServiceAzureMigrate.Local.png) | ![illustration for ServiceAzureMigrateCard](../../../azure-23/Item/Migrate/ServiceAzureMigrateCard.Local.png) | ![illustration for ServiceAzureMigrateGroup](../../../azure-23/Item/Migrate/ServiceAzureMigrateGroup.Local.png) |
