...
```text
azure-23/Item/Migrate/ServiceDataBox
```

```text
include('azure-23/Item/Migrate/ServiceDataBox')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Migrate/ServiceDataBox.png) | ![illustration for ServiceDataBox](../../../azure-23/Item/Migrate/ServiceDataBox.Local.png) | ![illustration for ServiceDataBoxCard](../../../azure-23/Item/Migrate/ServiceDataBoxCard.Local.png) | ![illustration for ServiceDataBoxGroup](../../../azure-23/Item/Migrate/ServiceDataBoxGroup.Local.png) |
