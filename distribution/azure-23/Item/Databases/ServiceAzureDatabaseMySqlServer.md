...
```text
azure-23/Item/Databases/ServiceAzureDatabaseMySqlServer
```

```text
include('azure-23/Item/Databases/ServiceAzureDatabaseMySqlServer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceAzureDatabaseMySqlServer.png) | ![illustration for ServiceAzureDatabaseMySqlServer](../../../azure-23/Item/Databases/ServiceAzureDatabaseMySqlServer.Local.png) | ![illustration for ServiceAzureDatabaseMySqlServerCard](../../../azure-23/Item/Databases/ServiceAzureDatabaseMySqlServerCard.Local.png) | ![illustration for ServiceAzureDatabaseMySqlServerGroup](../../../azure-23/Item/Databases/ServiceAzureDatabaseMySqlServerGroup.Local.png) |
