...
```text
azure-23/Item/Databases/ServiceSqlDatabase
```

```text
include('azure-23/Item/Databases/ServiceSqlDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceSqlDatabase.png) | ![illustration for ServiceSqlDatabase](../../../azure-23/Item/Databases/ServiceSqlDatabase.Local.png) | ![illustration for ServiceSqlDatabaseCard](../../../azure-23/Item/Databases/ServiceSqlDatabaseCard.Local.png) | ![illustration for ServiceSqlDatabaseGroup](../../../azure-23/Item/Databases/ServiceSqlDatabaseGroup.Local.png) |
