...
```text
azure-23/Item/Databases/ServiceAzureDatabasePostgreSqlServer
```

```text
include('azure-23/Item/Databases/ServiceAzureDatabasePostgreSqlServer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceAzureDatabasePostgreSqlServer.png) | ![illustration for ServiceAzureDatabasePostgreSqlServer](../../../azure-23/Item/Databases/ServiceAzureDatabasePostgreSqlServer.Local.png) | ![illustration for ServiceAzureDatabasePostgreSqlServerCard](../../../azure-23/Item/Databases/ServiceAzureDatabasePostgreSqlServerCard.Local.png) | ![illustration for ServiceAzureDatabasePostgreSqlServerGroup](../../../azure-23/Item/Databases/ServiceAzureDatabasePostgreSqlServerGroup.Local.png) |
...
include('azure-23/Item/Databases/ServiceAzureDatabasePostgreSqlServerGroup')
