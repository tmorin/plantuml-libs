...
```text
azure-23/Item/Databases/ServiceAzureSqlServerStretchDatabases
```

```text
include('azure-23/Item/Databases/ServiceAzureSqlServerStretchDatabases')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceAzureSqlServerStretchDatabases.png) | ![illustration for ServiceAzureSqlServerStretchDatabases](../../../azure-23/Item/Databases/ServiceAzureSqlServerStretchDatabases.Local.png) | ![illustration for ServiceAzureSqlServerStretchDatabasesCard](../../../azure-23/Item/Databases/ServiceAzureSqlServerStretchDatabasesCard.Local.png) | ![illustration for ServiceAzureSqlServerStretchDatabasesGroup](../../../azure-23/Item/Databases/ServiceAzureSqlServerStretchDatabasesGroup.Local.png) |
