...
```text
azure-23/Item/Databases/ServiceSqlElasticPools
```

```text
include('azure-23/Item/Databases/ServiceSqlElasticPools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceSqlElasticPools.png) | ![illustration for ServiceSqlElasticPools](../../../azure-23/Item/Databases/ServiceSqlElasticPools.Local.png) | ![illustration for ServiceSqlElasticPoolsCard](../../../azure-23/Item/Databases/ServiceSqlElasticPoolsCard.Local.png) | ![illustration for ServiceSqlElasticPoolsGroup](../../../azure-23/Item/Databases/ServiceSqlElasticPoolsGroup.Local.png) |
