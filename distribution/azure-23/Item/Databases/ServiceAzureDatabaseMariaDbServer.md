...
```text
azure-23/Item/Databases/ServiceAzureDatabaseMariaDbServer
```

```text
include('azure-23/Item/Databases/ServiceAzureDatabaseMariaDbServer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceAzureDatabaseMariaDbServer.png) | ![illustration for ServiceAzureDatabaseMariaDbServer](../../../azure-23/Item/Databases/ServiceAzureDatabaseMariaDbServer.Local.png) | ![illustration for ServiceAzureDatabaseMariaDbServerCard](../../../azure-23/Item/Databases/ServiceAzureDatabaseMariaDbServerCard.Local.png) | ![illustration for ServiceAzureDatabaseMariaDbServerGroup](../../../azure-23/Item/Databases/ServiceAzureDatabaseMariaDbServerGroup.Local.png) |
