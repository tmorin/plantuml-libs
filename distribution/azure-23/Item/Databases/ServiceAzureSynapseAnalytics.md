...
```text
azure-23/Item/Databases/ServiceAzureSynapseAnalytics
```

```text
include('azure-23/Item/Databases/ServiceAzureSynapseAnalytics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceAzureSynapseAnalytics.png) | ![illustration for ServiceAzureSynapseAnalytics](../../../azure-23/Item/Databases/ServiceAzureSynapseAnalytics.Local.png) | ![illustration for ServiceAzureSynapseAnalyticsCard](../../../azure-23/Item/Databases/ServiceAzureSynapseAnalyticsCard.Local.png) | ![illustration for ServiceAzureSynapseAnalyticsGroup](../../../azure-23/Item/Databases/ServiceAzureSynapseAnalyticsGroup.Local.png) |
