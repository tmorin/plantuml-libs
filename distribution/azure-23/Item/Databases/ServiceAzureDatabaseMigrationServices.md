...
```text
azure-23/Item/Databases/ServiceAzureDatabaseMigrationServices
```

```text
include('azure-23/Item/Databases/ServiceAzureDatabaseMigrationServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceAzureDatabaseMigrationServices.png) | ![illustration for ServiceAzureDatabaseMigrationServices](../../../azure-23/Item/Databases/ServiceAzureDatabaseMigrationServices.Local.png) | ![illustration for ServiceAzureDatabaseMigrationServicesCard](../../../azure-23/Item/Databases/ServiceAzureDatabaseMigrationServicesCard.Local.png) | ![illustration for ServiceAzureDatabaseMigrationServicesGroup](../../../azure-23/Item/Databases/ServiceAzureDatabaseMigrationServicesGroup.Local.png) |
