...
```text
azure-23/Item/Databases/ServiceSqlServer
```

```text
include('azure-23/Item/Databases/ServiceSqlServer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceSqlServer.png) | ![illustration for ServiceSqlServer](../../../azure-23/Item/Databases/ServiceSqlServer.Local.png) | ![illustration for ServiceSqlServerCard](../../../azure-23/Item/Databases/ServiceSqlServerCard.Local.png) | ![illustration for ServiceSqlServerGroup](../../../azure-23/Item/Databases/ServiceSqlServerGroup.Local.png) |
