...
```text
azure-23/Item/Databases/ServiceAzureSql
```

```text
include('azure-23/Item/Databases/ServiceAzureSql')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceAzureSql.png) | ![illustration for ServiceAzureSql](../../../azure-23/Item/Databases/ServiceAzureSql.Local.png) | ![illustration for ServiceAzureSqlCard](../../../azure-23/Item/Databases/ServiceAzureSqlCard.Local.png) | ![illustration for ServiceAzureSqlGroup](../../../azure-23/Item/Databases/ServiceAzureSqlGroup.Local.png) |
