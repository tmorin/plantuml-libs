...
```text
azure-23/Item/Databases/ServiceOracleDatabase
```

```text
include('azure-23/Item/Databases/ServiceOracleDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceOracleDatabase.png) | ![illustration for ServiceOracleDatabase](../../../azure-23/Item/Databases/ServiceOracleDatabase.Local.png) | ![illustration for ServiceOracleDatabaseCard](../../../azure-23/Item/Databases/ServiceOracleDatabaseCard.Local.png) | ![illustration for ServiceOracleDatabaseGroup](../../../azure-23/Item/Databases/ServiceOracleDatabaseGroup.Local.png) |
