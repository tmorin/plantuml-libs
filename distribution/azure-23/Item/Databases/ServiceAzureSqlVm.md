...
```text
azure-23/Item/Databases/ServiceAzureSqlVm
```

```text
include('azure-23/Item/Databases/ServiceAzureSqlVm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceAzureSqlVm.png) | ![illustration for ServiceAzureSqlVm](../../../azure-23/Item/Databases/ServiceAzureSqlVm.Local.png) | ![illustration for ServiceAzureSqlVmCard](../../../azure-23/Item/Databases/ServiceAzureSqlVmCard.Local.png) | ![illustration for ServiceAzureSqlVmGroup](../../../azure-23/Item/Databases/ServiceAzureSqlVmGroup.Local.png) |
