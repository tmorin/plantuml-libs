...
```text
azure-23/Item/Databases/ServiceSqlManagedInstance
```

```text
include('azure-23/Item/Databases/ServiceSqlManagedInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceSqlManagedInstance.png) | ![illustration for ServiceSqlManagedInstance](../../../azure-23/Item/Databases/ServiceSqlManagedInstance.Local.png) | ![illustration for ServiceSqlManagedInstanceCard](../../../azure-23/Item/Databases/ServiceSqlManagedInstanceCard.Local.png) | ![illustration for ServiceSqlManagedInstanceGroup](../../../azure-23/Item/Databases/ServiceSqlManagedInstanceGroup.Local.png) |
