...
```text
azure-23/Item/Databases/ServiceDataFactories
```

```text
include('azure-23/Item/Databases/ServiceDataFactories')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceDataFactories.png) | ![illustration for ServiceDataFactories](../../../azure-23/Item/Databases/ServiceDataFactories.Local.png) | ![illustration for ServiceDataFactoriesCard](../../../azure-23/Item/Databases/ServiceDataFactoriesCard.Local.png) | ![illustration for ServiceDataFactoriesGroup](../../../azure-23/Item/Databases/ServiceDataFactoriesGroup.Local.png) |
