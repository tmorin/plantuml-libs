...
```text
azure-23/Item/Databases/ServiceSqlServerRegistries
```

```text
include('azure-23/Item/Databases/ServiceSqlServerRegistries')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceSqlServerRegistries.png) | ![illustration for ServiceSqlServerRegistries](../../../azure-23/Item/Databases/ServiceSqlServerRegistries.Local.png) | ![illustration for ServiceSqlServerRegistriesCard](../../../azure-23/Item/Databases/ServiceSqlServerRegistriesCard.Local.png) | ![illustration for ServiceSqlServerRegistriesGroup](../../../azure-23/Item/Databases/ServiceSqlServerRegistriesGroup.Local.png) |
