...
```text
azure-23/Item/Databases/ServiceInstancePools
```

```text
include('azure-23/Item/Databases/ServiceInstancePools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceInstancePools.png) | ![illustration for ServiceInstancePools](../../../azure-23/Item/Databases/ServiceInstancePools.Local.png) | ![illustration for ServiceInstancePoolsCard](../../../azure-23/Item/Databases/ServiceInstancePoolsCard.Local.png) | ![illustration for ServiceInstancePoolsGroup](../../../azure-23/Item/Databases/ServiceInstancePoolsGroup.Local.png) |
