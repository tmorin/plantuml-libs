...
```text
azure-23/Item/Databases/ServiceElasticJobAgents
```

```text
include('azure-23/Item/Databases/ServiceElasticJobAgents')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceElasticJobAgents.png) | ![illustration for ServiceElasticJobAgents](../../../azure-23/Item/Databases/ServiceElasticJobAgents.Local.png) | ![illustration for ServiceElasticJobAgentsCard](../../../azure-23/Item/Databases/ServiceElasticJobAgentsCard.Local.png) | ![illustration for ServiceElasticJobAgentsGroup](../../../azure-23/Item/Databases/ServiceElasticJobAgentsGroup.Local.png) |
