...
```text
azure-23/Item/Databases/ServiceManagedDatabase
```

```text
include('azure-23/Item/Databases/ServiceManagedDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceManagedDatabase.png) | ![illustration for ServiceManagedDatabase](../../../azure-23/Item/Databases/ServiceManagedDatabase.Local.png) | ![illustration for ServiceManagedDatabaseCard](../../../azure-23/Item/Databases/ServiceManagedDatabaseCard.Local.png) | ![illustration for ServiceManagedDatabaseGroup](../../../azure-23/Item/Databases/ServiceManagedDatabaseGroup.Local.png) |
