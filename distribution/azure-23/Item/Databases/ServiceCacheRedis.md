...
```text
azure-23/Item/Databases/ServiceCacheRedis
```

```text
include('azure-23/Item/Databases/ServiceCacheRedis')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Databases/ServiceCacheRedis.png) | ![illustration for ServiceCacheRedis](../../../azure-23/Item/Databases/ServiceCacheRedis.Local.png) | ![illustration for ServiceCacheRedisCard](../../../azure-23/Item/Databases/ServiceCacheRedisCard.Local.png) | ![illustration for ServiceCacheRedisGroup](../../../azure-23/Item/Databases/ServiceCacheRedisGroup.Local.png) |
