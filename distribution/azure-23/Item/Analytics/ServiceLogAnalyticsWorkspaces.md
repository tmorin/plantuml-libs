...
```text
azure-23/Item/Analytics/ServiceLogAnalyticsWorkspaces
```

```text
include('azure-23/Item/Analytics/ServiceLogAnalyticsWorkspaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Analytics/ServiceLogAnalyticsWorkspaces.png) | ![illustration for ServiceLogAnalyticsWorkspaces](../../../azure-23/Item/Analytics/ServiceLogAnalyticsWorkspaces.Local.png) | ![illustration for ServiceLogAnalyticsWorkspacesCard](../../../azure-23/Item/Analytics/ServiceLogAnalyticsWorkspacesCard.Local.png) | ![illustration for ServiceLogAnalyticsWorkspacesGroup](../../../azure-23/Item/Analytics/ServiceLogAnalyticsWorkspacesGroup.Local.png) |
