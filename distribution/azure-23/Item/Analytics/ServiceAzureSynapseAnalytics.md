...
```text
azure-23/Item/Analytics/ServiceAzureSynapseAnalytics
```

```text
include('azure-23/Item/Analytics/ServiceAzureSynapseAnalytics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Analytics/ServiceAzureSynapseAnalytics.png) | ![illustration for ServiceAzureSynapseAnalytics](../../../azure-23/Item/Analytics/ServiceAzureSynapseAnalytics.Local.png) | ![illustration for ServiceAzureSynapseAnalyticsCard](../../../azure-23/Item/Analytics/ServiceAzureSynapseAnalyticsCard.Local.png) | ![illustration for ServiceAzureSynapseAnalyticsGroup](../../../azure-23/Item/Analytics/ServiceAzureSynapseAnalyticsGroup.Local.png) |
