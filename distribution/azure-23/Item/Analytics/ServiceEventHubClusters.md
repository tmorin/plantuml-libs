...
```text
azure-23/Item/Analytics/ServiceEventHubClusters
```

```text
include('azure-23/Item/Analytics/ServiceEventHubClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Analytics/ServiceEventHubClusters.png) | ![illustration for ServiceEventHubClusters](../../../azure-23/Item/Analytics/ServiceEventHubClusters.Local.png) | ![illustration for ServiceEventHubClustersCard](../../../azure-23/Item/Analytics/ServiceEventHubClustersCard.Local.png) | ![illustration for ServiceEventHubClustersGroup](../../../azure-23/Item/Analytics/ServiceEventHubClustersGroup.Local.png) |
