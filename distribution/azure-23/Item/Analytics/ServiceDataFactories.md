...
```text
azure-23/Item/Analytics/ServiceDataFactories
```

```text
include('azure-23/Item/Analytics/ServiceDataFactories')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Analytics/ServiceDataFactories.png) | ![illustration for ServiceDataFactories](../../../azure-23/Item/Analytics/ServiceDataFactories.Local.png) | ![illustration for ServiceDataFactoriesCard](../../../azure-23/Item/Analytics/ServiceDataFactoriesCard.Local.png) | ![illustration for ServiceDataFactoriesGroup](../../../azure-23/Item/Analytics/ServiceDataFactoriesGroup.Local.png) |
