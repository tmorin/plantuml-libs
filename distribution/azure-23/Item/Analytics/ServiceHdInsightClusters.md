...
```text
azure-23/Item/Analytics/ServiceHdInsightClusters
```

```text
include('azure-23/Item/Analytics/ServiceHdInsightClusters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Analytics/ServiceHdInsightClusters.png) | ![illustration for ServiceHdInsightClusters](../../../azure-23/Item/Analytics/ServiceHdInsightClusters.Local.png) | ![illustration for ServiceHdInsightClustersCard](../../../azure-23/Item/Analytics/ServiceHdInsightClustersCard.Local.png) | ![illustration for ServiceHdInsightClustersGroup](../../../azure-23/Item/Analytics/ServiceHdInsightClustersGroup.Local.png) |
