...
```text
azure-23/Item/Analytics/ServiceAzureDatabricks
```

```text
include('azure-23/Item/Analytics/ServiceAzureDatabricks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Analytics/ServiceAzureDatabricks.png) | ![illustration for ServiceAzureDatabricks](../../../azure-23/Item/Analytics/ServiceAzureDatabricks.Local.png) | ![illustration for ServiceAzureDatabricksCard](../../../azure-23/Item/Analytics/ServiceAzureDatabricksCard.Local.png) | ![illustration for ServiceAzureDatabricksGroup](../../../azure-23/Item/Analytics/ServiceAzureDatabricksGroup.Local.png) |
