...
```text
azure-23/Item/Analytics/ServiceEventHubs
```

```text
include('azure-23/Item/Analytics/ServiceEventHubs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Analytics/ServiceEventHubs.png) | ![illustration for ServiceEventHubs](../../../azure-23/Item/Analytics/ServiceEventHubs.Local.png) | ![illustration for ServiceEventHubsCard](../../../azure-23/Item/Analytics/ServiceEventHubsCard.Local.png) | ![illustration for ServiceEventHubsGroup](../../../azure-23/Item/Analytics/ServiceEventHubsGroup.Local.png) |
