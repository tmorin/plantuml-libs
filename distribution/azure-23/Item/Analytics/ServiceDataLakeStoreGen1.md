...
```text
azure-23/Item/Analytics/ServiceDataLakeStoreGen1
```

```text
include('azure-23/Item/Analytics/ServiceDataLakeStoreGen1')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Analytics/ServiceDataLakeStoreGen1.png) | ![illustration for ServiceDataLakeStoreGen1](../../../azure-23/Item/Analytics/ServiceDataLakeStoreGen1.Local.png) | ![illustration for ServiceDataLakeStoreGen1Card](../../../azure-23/Item/Analytics/ServiceDataLakeStoreGen1Card.Local.png) | ![illustration for ServiceDataLakeStoreGen1Group](../../../azure-23/Item/Analytics/ServiceDataLakeStoreGen1Group.Local.png) |
