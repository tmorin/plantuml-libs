...
```text
azure-23/Item/Analytics/ServiceEndpointAnalytics
```

```text
include('azure-23/Item/Analytics/ServiceEndpointAnalytics')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Analytics/ServiceEndpointAnalytics.png) | ![illustration for ServiceEndpointAnalytics](../../../azure-23/Item/Analytics/ServiceEndpointAnalytics.Local.png) | ![illustration for ServiceEndpointAnalyticsCard](../../../azure-23/Item/Analytics/ServiceEndpointAnalyticsCard.Local.png) | ![illustration for ServiceEndpointAnalyticsGroup](../../../azure-23/Item/Analytics/ServiceEndpointAnalyticsGroup.Local.png) |
