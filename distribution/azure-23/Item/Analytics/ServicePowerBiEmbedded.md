...
```text
azure-23/Item/Analytics/ServicePowerBiEmbedded
```

```text
include('azure-23/Item/Analytics/ServicePowerBiEmbedded')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Analytics/ServicePowerBiEmbedded.png) | ![illustration for ServicePowerBiEmbedded](../../../azure-23/Item/Analytics/ServicePowerBiEmbedded.Local.png) | ![illustration for ServicePowerBiEmbeddedCard](../../../azure-23/Item/Analytics/ServicePowerBiEmbeddedCard.Local.png) | ![illustration for ServicePowerBiEmbeddedGroup](../../../azure-23/Item/Analytics/ServicePowerBiEmbeddedGroup.Local.png) |
