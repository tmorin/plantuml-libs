...
```text
azure-23/Item/Networking/ServiceRouteTables
```

```text
include('azure-23/Item/Networking/ServiceRouteTables')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceRouteTables.png) | ![illustration for ServiceRouteTables](../../../azure-23/Item/Networking/ServiceRouteTables.Local.png) | ![illustration for ServiceRouteTablesCard](../../../azure-23/Item/Networking/ServiceRouteTablesCard.Local.png) | ![illustration for ServiceRouteTablesGroup](../../../azure-23/Item/Networking/ServiceRouteTablesGroup.Local.png) |
