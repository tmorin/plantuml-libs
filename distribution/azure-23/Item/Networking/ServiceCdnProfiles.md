...
```text
azure-23/Item/Networking/ServiceCdnProfiles
```

```text
include('azure-23/Item/Networking/ServiceCdnProfiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceCdnProfiles.png) | ![illustration for ServiceCdnProfiles](../../../azure-23/Item/Networking/ServiceCdnProfiles.Local.png) | ![illustration for ServiceCdnProfilesCard](../../../azure-23/Item/Networking/ServiceCdnProfilesCard.Local.png) | ![illustration for ServiceCdnProfilesGroup](../../../azure-23/Item/Networking/ServiceCdnProfilesGroup.Local.png) |
