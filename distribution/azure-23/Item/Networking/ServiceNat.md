...
```text
azure-23/Item/Networking/ServiceNat
```

```text
include('azure-23/Item/Networking/ServiceNat')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceNat.png) | ![illustration for ServiceNat](../../../azure-23/Item/Networking/ServiceNat.Local.png) | ![illustration for ServiceNatCard](../../../azure-23/Item/Networking/ServiceNatCard.Local.png) | ![illustration for ServiceNatGroup](../../../azure-23/Item/Networking/ServiceNatGroup.Local.png) |
