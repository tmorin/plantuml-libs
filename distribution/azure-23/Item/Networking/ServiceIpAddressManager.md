...
```text
azure-23/Item/Networking/ServiceIpAddressManager
```

```text
include('azure-23/Item/Networking/ServiceIpAddressManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceIpAddressManager.png) | ![illustration for ServiceIpAddressManager](../../../azure-23/Item/Networking/ServiceIpAddressManager.Local.png) | ![illustration for ServiceIpAddressManagerCard](../../../azure-23/Item/Networking/ServiceIpAddressManagerCard.Local.png) | ![illustration for ServiceIpAddressManagerGroup](../../../azure-23/Item/Networking/ServiceIpAddressManagerGroup.Local.png) |
