...
```text
azure-23/Item/Networking/ServicePublicIpAddresses
```

```text
include('azure-23/Item/Networking/ServicePublicIpAddresses')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServicePublicIpAddresses.png) | ![illustration for ServicePublicIpAddresses](../../../azure-23/Item/Networking/ServicePublicIpAddresses.Local.png) | ![illustration for ServicePublicIpAddressesCard](../../../azure-23/Item/Networking/ServicePublicIpAddressesCard.Local.png) | ![illustration for ServicePublicIpAddressesGroup](../../../azure-23/Item/Networking/ServicePublicIpAddressesGroup.Local.png) |
