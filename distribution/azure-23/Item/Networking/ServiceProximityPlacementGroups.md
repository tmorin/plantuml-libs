...
```text
azure-23/Item/Networking/ServiceProximityPlacementGroups
```

```text
include('azure-23/Item/Networking/ServiceProximityPlacementGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceProximityPlacementGroups.png) | ![illustration for ServiceProximityPlacementGroups](../../../azure-23/Item/Networking/ServiceProximityPlacementGroups.Local.png) | ![illustration for ServiceProximityPlacementGroupsCard](../../../azure-23/Item/Networking/ServiceProximityPlacementGroupsCard.Local.png) | ![illustration for ServiceProximityPlacementGroupsGroup](../../../azure-23/Item/Networking/ServiceProximityPlacementGroupsGroup.Local.png) |
