...
```text
azure-23/Item/Networking/ServiceNetworkInterfaces
```

```text
include('azure-23/Item/Networking/ServiceNetworkInterfaces')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceNetworkInterfaces.png) | ![illustration for ServiceNetworkInterfaces](../../../azure-23/Item/Networking/ServiceNetworkInterfaces.Local.png) | ![illustration for ServiceNetworkInterfacesCard](../../../azure-23/Item/Networking/ServiceNetworkInterfacesCard.Local.png) | ![illustration for ServiceNetworkInterfacesGroup](../../../azure-23/Item/Networking/ServiceNetworkInterfacesGroup.Local.png) |
