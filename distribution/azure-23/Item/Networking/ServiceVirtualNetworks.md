...
```text
azure-23/Item/Networking/ServiceVirtualNetworks
```

```text
include('azure-23/Item/Networking/ServiceVirtualNetworks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceVirtualNetworks.png) | ![illustration for ServiceVirtualNetworks](../../../azure-23/Item/Networking/ServiceVirtualNetworks.Local.png) | ![illustration for ServiceVirtualNetworksCard](../../../azure-23/Item/Networking/ServiceVirtualNetworksCard.Local.png) | ![illustration for ServiceVirtualNetworksGroup](../../../azure-23/Item/Networking/ServiceVirtualNetworksGroup.Local.png) |
