...
```text
azure-23/Item/Networking/ServiceDnsMultistack
```

```text
include('azure-23/Item/Networking/ServiceDnsMultistack')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceDnsMultistack.png) | ![illustration for ServiceDnsMultistack](../../../azure-23/Item/Networking/ServiceDnsMultistack.Local.png) | ![illustration for ServiceDnsMultistackCard](../../../azure-23/Item/Networking/ServiceDnsMultistackCard.Local.png) | ![illustration for ServiceDnsMultistackGroup](../../../azure-23/Item/Networking/ServiceDnsMultistackGroup.Local.png) |
