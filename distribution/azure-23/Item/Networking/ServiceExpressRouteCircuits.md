...
```text
azure-23/Item/Networking/ServiceExpressRouteCircuits
```

```text
include('azure-23/Item/Networking/ServiceExpressRouteCircuits')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceExpressRouteCircuits.png) | ![illustration for ServiceExpressRouteCircuits](../../../azure-23/Item/Networking/ServiceExpressRouteCircuits.Local.png) | ![illustration for ServiceExpressRouteCircuitsCard](../../../azure-23/Item/Networking/ServiceExpressRouteCircuitsCard.Local.png) | ![illustration for ServiceExpressRouteCircuitsGroup](../../../azure-23/Item/Networking/ServiceExpressRouteCircuitsGroup.Local.png) |
