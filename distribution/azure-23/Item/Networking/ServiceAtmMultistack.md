...
```text
azure-23/Item/Networking/ServiceAtmMultistack
```

```text
include('azure-23/Item/Networking/ServiceAtmMultistack')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceAtmMultistack.png) | ![illustration for ServiceAtmMultistack](../../../azure-23/Item/Networking/ServiceAtmMultistack.Local.png) | ![illustration for ServiceAtmMultistackCard](../../../azure-23/Item/Networking/ServiceAtmMultistackCard.Local.png) | ![illustration for ServiceAtmMultistackGroup](../../../azure-23/Item/Networking/ServiceAtmMultistackGroup.Local.png) |
