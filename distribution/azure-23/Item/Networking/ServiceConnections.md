...
```text
azure-23/Item/Networking/ServiceConnections
```

```text
include('azure-23/Item/Networking/ServiceConnections')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceConnections.png) | ![illustration for ServiceConnections](../../../azure-23/Item/Networking/ServiceConnections.Local.png) | ![illustration for ServiceConnectionsCard](../../../azure-23/Item/Networking/ServiceConnectionsCard.Local.png) | ![illustration for ServiceConnectionsGroup](../../../azure-23/Item/Networking/ServiceConnectionsGroup.Local.png) |
