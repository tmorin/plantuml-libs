...
```text
azure-23/Item/Networking/ServiceApplicationGateways
```

```text
include('azure-23/Item/Networking/ServiceApplicationGateways')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceApplicationGateways.png) | ![illustration for ServiceApplicationGateways](../../../azure-23/Item/Networking/ServiceApplicationGateways.Local.png) | ![illustration for ServiceApplicationGatewaysCard](../../../azure-23/Item/Networking/ServiceApplicationGatewaysCard.Local.png) | ![illustration for ServiceApplicationGatewaysGroup](../../../azure-23/Item/Networking/ServiceApplicationGatewaysGroup.Local.png) |
