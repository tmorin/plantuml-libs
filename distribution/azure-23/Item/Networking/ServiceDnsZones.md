...
```text
azure-23/Item/Networking/ServiceDnsZones
```

```text
include('azure-23/Item/Networking/ServiceDnsZones')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceDnsZones.png) | ![illustration for ServiceDnsZones](../../../azure-23/Item/Networking/ServiceDnsZones.Local.png) | ![illustration for ServiceDnsZonesCard](../../../azure-23/Item/Networking/ServiceDnsZonesCard.Local.png) | ![illustration for ServiceDnsZonesGroup](../../../azure-23/Item/Networking/ServiceDnsZonesGroup.Local.png) |
