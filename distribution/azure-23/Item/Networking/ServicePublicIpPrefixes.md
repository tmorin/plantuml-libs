...
```text
azure-23/Item/Networking/ServicePublicIpPrefixes
```

```text
include('azure-23/Item/Networking/ServicePublicIpPrefixes')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServicePublicIpPrefixes.png) | ![illustration for ServicePublicIpPrefixes](../../../azure-23/Item/Networking/ServicePublicIpPrefixes.Local.png) | ![illustration for ServicePublicIpPrefixesCard](../../../azure-23/Item/Networking/ServicePublicIpPrefixesCard.Local.png) | ![illustration for ServicePublicIpPrefixesGroup](../../../azure-23/Item/Networking/ServicePublicIpPrefixesGroup.Local.png) |
