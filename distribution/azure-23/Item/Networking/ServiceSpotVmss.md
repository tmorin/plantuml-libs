...
```text
azure-23/Item/Networking/ServiceSpotVmss
```

```text
include('azure-23/Item/Networking/ServiceSpotVmss')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceSpotVmss.png) | ![illustration for ServiceSpotVmss](../../../azure-23/Item/Networking/ServiceSpotVmss.Local.png) | ![illustration for ServiceSpotVmssCard](../../../azure-23/Item/Networking/ServiceSpotVmssCard.Local.png) | ![illustration for ServiceSpotVmssGroup](../../../azure-23/Item/Networking/ServiceSpotVmssGroup.Local.png) |
