...
```text
azure-23/Item/Networking/ServiceVirtualNetworkGateways
```

```text
include('azure-23/Item/Networking/ServiceVirtualNetworkGateways')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceVirtualNetworkGateways.png) | ![illustration for ServiceVirtualNetworkGateways](../../../azure-23/Item/Networking/ServiceVirtualNetworkGateways.Local.png) | ![illustration for ServiceVirtualNetworkGatewaysCard](../../../azure-23/Item/Networking/ServiceVirtualNetworkGatewaysCard.Local.png) | ![illustration for ServiceVirtualNetworkGatewaysGroup](../../../azure-23/Item/Networking/ServiceVirtualNetworkGatewaysGroup.Local.png) |
