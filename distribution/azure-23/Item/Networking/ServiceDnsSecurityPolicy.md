...
```text
azure-23/Item/Networking/ServiceDnsSecurityPolicy
```

```text
include('azure-23/Item/Networking/ServiceDnsSecurityPolicy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceDnsSecurityPolicy.png) | ![illustration for ServiceDnsSecurityPolicy](../../../azure-23/Item/Networking/ServiceDnsSecurityPolicy.Local.png) | ![illustration for ServiceDnsSecurityPolicyCard](../../../azure-23/Item/Networking/ServiceDnsSecurityPolicyCard.Local.png) | ![illustration for ServiceDnsSecurityPolicyGroup](../../../azure-23/Item/Networking/ServiceDnsSecurityPolicyGroup.Local.png) |
