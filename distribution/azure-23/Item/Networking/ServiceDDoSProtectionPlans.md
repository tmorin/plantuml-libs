...
```text
azure-23/Item/Networking/ServiceDDoSProtectionPlans
```

```text
include('azure-23/Item/Networking/ServiceDDoSProtectionPlans')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceDDoSProtectionPlans.png) | ![illustration for ServiceDDoSProtectionPlans](../../../azure-23/Item/Networking/ServiceDDoSProtectionPlans.Local.png) | ![illustration for ServiceDDoSProtectionPlansCard](../../../azure-23/Item/Networking/ServiceDDoSProtectionPlansCard.Local.png) | ![illustration for ServiceDDoSProtectionPlansGroup](../../../azure-23/Item/Networking/ServiceDDoSProtectionPlansGroup.Local.png) |
