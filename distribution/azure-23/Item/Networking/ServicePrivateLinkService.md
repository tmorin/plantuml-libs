...
```text
azure-23/Item/Networking/ServicePrivateLinkService
```

```text
include('azure-23/Item/Networking/ServicePrivateLinkService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServicePrivateLinkService.png) | ![illustration for ServicePrivateLinkService](../../../azure-23/Item/Networking/ServicePrivateLinkService.Local.png) | ![illustration for ServicePrivateLinkServiceCard](../../../azure-23/Item/Networking/ServicePrivateLinkServiceCard.Local.png) | ![illustration for ServicePrivateLinkServiceGroup](../../../azure-23/Item/Networking/ServicePrivateLinkServiceGroup.Local.png) |
