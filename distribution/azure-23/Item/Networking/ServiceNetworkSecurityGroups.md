...
```text
azure-23/Item/Networking/ServiceNetworkSecurityGroups
```

```text
include('azure-23/Item/Networking/ServiceNetworkSecurityGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceNetworkSecurityGroups.png) | ![illustration for ServiceNetworkSecurityGroups](../../../azure-23/Item/Networking/ServiceNetworkSecurityGroups.Local.png) | ![illustration for ServiceNetworkSecurityGroupsCard](../../../azure-23/Item/Networking/ServiceNetworkSecurityGroupsCard.Local.png) | ![illustration for ServiceNetworkSecurityGroupsGroup](../../../azure-23/Item/Networking/ServiceNetworkSecurityGroupsGroup.Local.png) |
