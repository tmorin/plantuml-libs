...
```text
azure-23/Item/Networking/ServiceVirtualWaNs
```

```text
include('azure-23/Item/Networking/ServiceVirtualWaNs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceVirtualWaNs.png) | ![illustration for ServiceVirtualWaNs](../../../azure-23/Item/Networking/ServiceVirtualWaNs.Local.png) | ![illustration for ServiceVirtualWaNsCard](../../../azure-23/Item/Networking/ServiceVirtualWaNsCard.Local.png) | ![illustration for ServiceVirtualWaNsGroup](../../../azure-23/Item/Networking/ServiceVirtualWaNsGroup.Local.png) |
