...
```text
azure-23/Item/Networking/ServiceFirewalls
```

```text
include('azure-23/Item/Networking/ServiceFirewalls')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceFirewalls.png) | ![illustration for ServiceFirewalls](../../../azure-23/Item/Networking/ServiceFirewalls.Local.png) | ![illustration for ServiceFirewallsCard](../../../azure-23/Item/Networking/ServiceFirewallsCard.Local.png) | ![illustration for ServiceFirewallsGroup](../../../azure-23/Item/Networking/ServiceFirewallsGroup.Local.png) |
