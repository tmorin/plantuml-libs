...
```text
azure-23/Item/Networking/ServiceConnectedCache
```

```text
include('azure-23/Item/Networking/ServiceConnectedCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceConnectedCache.png) | ![illustration for ServiceConnectedCache](../../../azure-23/Item/Networking/ServiceConnectedCache.Local.png) | ![illustration for ServiceConnectedCacheCard](../../../azure-23/Item/Networking/ServiceConnectedCacheCard.Local.png) | ![illustration for ServiceConnectedCacheGroup](../../../azure-23/Item/Networking/ServiceConnectedCacheGroup.Local.png) |
