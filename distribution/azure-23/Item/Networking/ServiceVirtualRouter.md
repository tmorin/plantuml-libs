...
```text
azure-23/Item/Networking/ServiceVirtualRouter
```

```text
include('azure-23/Item/Networking/ServiceVirtualRouter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceVirtualRouter.png) | ![illustration for ServiceVirtualRouter](../../../azure-23/Item/Networking/ServiceVirtualRouter.Local.png) | ![illustration for ServiceVirtualRouterCard](../../../azure-23/Item/Networking/ServiceVirtualRouterCard.Local.png) | ![illustration for ServiceVirtualRouterGroup](../../../azure-23/Item/Networking/ServiceVirtualRouterGroup.Local.png) |
