...
```text
azure-23/Item/Networking/ServiceBastions
```

```text
include('azure-23/Item/Networking/ServiceBastions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceBastions.png) | ![illustration for ServiceBastions](../../../azure-23/Item/Networking/ServiceBastions.Local.png) | ![illustration for ServiceBastionsCard](../../../azure-23/Item/Networking/ServiceBastionsCard.Local.png) | ![illustration for ServiceBastionsGroup](../../../azure-23/Item/Networking/ServiceBastionsGroup.Local.png) |
