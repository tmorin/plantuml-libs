...
```text
azure-23/Item/Networking/ServiceAzureFirewallManager
```

```text
include('azure-23/Item/Networking/ServiceAzureFirewallManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceAzureFirewallManager.png) | ![illustration for ServiceAzureFirewallManager](../../../azure-23/Item/Networking/ServiceAzureFirewallManager.Local.png) | ![illustration for ServiceAzureFirewallManagerCard](../../../azure-23/Item/Networking/ServiceAzureFirewallManagerCard.Local.png) | ![illustration for ServiceAzureFirewallManagerGroup](../../../azure-23/Item/Networking/ServiceAzureFirewallManagerGroup.Local.png) |
