...
```text
azure-23/Item/Networking/ServiceAzureFirewallPolicy
```

```text
include('azure-23/Item/Networking/ServiceAzureFirewallPolicy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceAzureFirewallPolicy.png) | ![illustration for ServiceAzureFirewallPolicy](../../../azure-23/Item/Networking/ServiceAzureFirewallPolicy.Local.png) | ![illustration for ServiceAzureFirewallPolicyCard](../../../azure-23/Item/Networking/ServiceAzureFirewallPolicyCard.Local.png) | ![illustration for ServiceAzureFirewallPolicyGroup](../../../azure-23/Item/Networking/ServiceAzureFirewallPolicyGroup.Local.png) |
