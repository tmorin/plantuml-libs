...
```text
azure-23/Item/Networking/ServiceTrafficManagerProfiles
```

```text
include('azure-23/Item/Networking/ServiceTrafficManagerProfiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceTrafficManagerProfiles.png) | ![illustration for ServiceTrafficManagerProfiles](../../../azure-23/Item/Networking/ServiceTrafficManagerProfiles.Local.png) | ![illustration for ServiceTrafficManagerProfilesCard](../../../azure-23/Item/Networking/ServiceTrafficManagerProfilesCard.Local.png) | ![illustration for ServiceTrafficManagerProfilesGroup](../../../azure-23/Item/Networking/ServiceTrafficManagerProfilesGroup.Local.png) |
