...
```text
azure-23/Item/Networking/ServiceLocalNetworkGateways
```

```text
include('azure-23/Item/Networking/ServiceLocalNetworkGateways')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceLocalNetworkGateways.png) | ![illustration for ServiceLocalNetworkGateways](../../../azure-23/Item/Networking/ServiceLocalNetworkGateways.Local.png) | ![illustration for ServiceLocalNetworkGatewaysCard](../../../azure-23/Item/Networking/ServiceLocalNetworkGatewaysCard.Local.png) | ![illustration for ServiceLocalNetworkGatewaysGroup](../../../azure-23/Item/Networking/ServiceLocalNetworkGatewaysGroup.Local.png) |
