...
```text
azure-23/Item/Networking/ServiceSubnet
```

```text
include('azure-23/Item/Networking/ServiceSubnet')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceSubnet.png) | ![illustration for ServiceSubnet](../../../azure-23/Item/Networking/ServiceSubnet.Local.png) | ![illustration for ServiceSubnetCard](../../../azure-23/Item/Networking/ServiceSubnetCard.Local.png) | ![illustration for ServiceSubnetGroup](../../../azure-23/Item/Networking/ServiceSubnetGroup.Local.png) |
