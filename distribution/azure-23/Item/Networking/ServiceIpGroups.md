...
```text
azure-23/Item/Networking/ServiceIpGroups
```

```text
include('azure-23/Item/Networking/ServiceIpGroups')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceIpGroups.png) | ![illustration for ServiceIpGroups](../../../azure-23/Item/Networking/ServiceIpGroups.Local.png) | ![illustration for ServiceIpGroupsCard](../../../azure-23/Item/Networking/ServiceIpGroupsCard.Local.png) | ![illustration for ServiceIpGroupsGroup](../../../azure-23/Item/Networking/ServiceIpGroupsGroup.Local.png) |
