...
```text
azure-23/Item/Networking/ServicePrivateLink
```

```text
include('azure-23/Item/Networking/ServicePrivateLink')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServicePrivateLink.png) | ![illustration for ServicePrivateLink](../../../azure-23/Item/Networking/ServicePrivateLink.Local.png) | ![illustration for ServicePrivateLinkCard](../../../azure-23/Item/Networking/ServicePrivateLinkCard.Local.png) | ![illustration for ServicePrivateLinkGroup](../../../azure-23/Item/Networking/ServicePrivateLinkGroup.Local.png) |
