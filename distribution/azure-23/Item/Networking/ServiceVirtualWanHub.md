...
```text
azure-23/Item/Networking/ServiceVirtualWanHub
```

```text
include('azure-23/Item/Networking/ServiceVirtualWanHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceVirtualWanHub.png) | ![illustration for ServiceVirtualWanHub](../../../azure-23/Item/Networking/ServiceVirtualWanHub.Local.png) | ![illustration for ServiceVirtualWanHubCard](../../../azure-23/Item/Networking/ServiceVirtualWanHubCard.Local.png) | ![illustration for ServiceVirtualWanHubGroup](../../../azure-23/Item/Networking/ServiceVirtualWanHubGroup.Local.png) |
