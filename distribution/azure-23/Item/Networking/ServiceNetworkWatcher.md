...
```text
azure-23/Item/Networking/ServiceNetworkWatcher
```

```text
include('azure-23/Item/Networking/ServiceNetworkWatcher')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceNetworkWatcher.png) | ![illustration for ServiceNetworkWatcher](../../../azure-23/Item/Networking/ServiceNetworkWatcher.Local.png) | ![illustration for ServiceNetworkWatcherCard](../../../azure-23/Item/Networking/ServiceNetworkWatcherCard.Local.png) | ![illustration for ServiceNetworkWatcherGroup](../../../azure-23/Item/Networking/ServiceNetworkWatcherGroup.Local.png) |
