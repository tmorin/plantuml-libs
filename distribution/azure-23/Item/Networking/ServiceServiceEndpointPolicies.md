...
```text
azure-23/Item/Networking/ServiceServiceEndpointPolicies
```

```text
include('azure-23/Item/Networking/ServiceServiceEndpointPolicies')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Networking/ServiceServiceEndpointPolicies.png) | ![illustration for ServiceServiceEndpointPolicies](../../../azure-23/Item/Networking/ServiceServiceEndpointPolicies.Local.png) | ![illustration for ServiceServiceEndpointPoliciesCard](../../../azure-23/Item/Networking/ServiceServiceEndpointPoliciesCard.Local.png) | ![illustration for ServiceServiceEndpointPoliciesGroup](../../../azure-23/Item/Networking/ServiceServiceEndpointPoliciesGroup.Local.png) |
