...
```text
azure-23/Item/AzureEcosystem/ServiceApplens
```

```text
include('azure-23/Item/AzureEcosystem/ServiceApplens')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AzureEcosystem/ServiceApplens.png) | ![illustration for ServiceApplens](../../../azure-23/Item/AzureEcosystem/ServiceApplens.Local.png) | ![illustration for ServiceApplensCard](../../../azure-23/Item/AzureEcosystem/ServiceApplensCard.Local.png) | ![illustration for ServiceApplensGroup](../../../azure-23/Item/AzureEcosystem/ServiceApplensGroup.Local.png) |
