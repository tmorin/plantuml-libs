...
```text
azure-23/Item/AzureEcosystem/ServiceCollaborativeService
```

```text
include('azure-23/Item/AzureEcosystem/ServiceCollaborativeService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AzureEcosystem/ServiceCollaborativeService.png) | ![illustration for ServiceCollaborativeService](../../../azure-23/Item/AzureEcosystem/ServiceCollaborativeService.Local.png) | ![illustration for ServiceCollaborativeServiceCard](../../../azure-23/Item/AzureEcosystem/ServiceCollaborativeServiceCard.Local.png) | ![illustration for ServiceCollaborativeServiceGroup](../../../azure-23/Item/AzureEcosystem/ServiceCollaborativeServiceGroup.Local.png) |
