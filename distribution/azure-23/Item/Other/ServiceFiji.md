...
```text
azure-23/Item/Other/ServiceFiji
```

```text
include('azure-23/Item/Other/ServiceFiji')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceFiji.png) | ![illustration for ServiceFiji](../../../azure-23/Item/Other/ServiceFiji.Local.png) | ![illustration for ServiceFijiCard](../../../azure-23/Item/Other/ServiceFijiCard.Local.png) | ![illustration for ServiceFijiGroup](../../../azure-23/Item/Other/ServiceFijiGroup.Local.png) |
