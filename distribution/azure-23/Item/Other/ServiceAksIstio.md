...
```text
azure-23/Item/Other/ServiceAksIstio
```

```text
include('azure-23/Item/Other/ServiceAksIstio')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAksIstio.png) | ![illustration for ServiceAksIstio](../../../azure-23/Item/Other/ServiceAksIstio.Local.png) | ![illustration for ServiceAksIstioCard](../../../azure-23/Item/Other/ServiceAksIstioCard.Local.png) | ![illustration for ServiceAksIstioGroup](../../../azure-23/Item/Other/ServiceAksIstioGroup.Local.png) |
