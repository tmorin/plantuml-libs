...
```text
azure-23/Item/Other/ServiceResourceMover
```

```text
include('azure-23/Item/Other/ServiceResourceMover')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceResourceMover.png) | ![illustration for ServiceResourceMover](../../../azure-23/Item/Other/ServiceResourceMover.Local.png) | ![illustration for ServiceResourceMoverCard](../../../azure-23/Item/Other/ServiceResourceMoverCard.Local.png) | ![illustration for ServiceResourceMoverGroup](../../../azure-23/Item/Other/ServiceResourceMoverGroup.Local.png) |
