...
```text
azure-23/Item/Other/ServiceAzureVideoIndexer
```

```text
include('azure-23/Item/Other/ServiceAzureVideoIndexer')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureVideoIndexer.png) | ![illustration for ServiceAzureVideoIndexer](../../../azure-23/Item/Other/ServiceAzureVideoIndexer.Local.png) | ![illustration for ServiceAzureVideoIndexerCard](../../../azure-23/Item/Other/ServiceAzureVideoIndexerCard.Local.png) | ![illustration for ServiceAzureVideoIndexerGroup](../../../azure-23/Item/Other/ServiceAzureVideoIndexerGroup.Local.png) |
