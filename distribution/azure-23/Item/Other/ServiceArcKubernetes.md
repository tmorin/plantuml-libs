...
```text
azure-23/Item/Other/ServiceArcKubernetes
```

```text
include('azure-23/Item/Other/ServiceArcKubernetes')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceArcKubernetes.png) | ![illustration for ServiceArcKubernetes](../../../azure-23/Item/Other/ServiceArcKubernetes.Local.png) | ![illustration for ServiceArcKubernetesCard](../../../azure-23/Item/Other/ServiceArcKubernetesCard.Local.png) | ![illustration for ServiceArcKubernetesGroup](../../../azure-23/Item/Other/ServiceArcKubernetesGroup.Local.png) |
