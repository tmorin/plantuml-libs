...
```text
azure-23/Item/Other/ServiceAquila
```

```text
include('azure-23/Item/Other/ServiceAquila')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAquila.png) | ![illustration for ServiceAquila](../../../azure-23/Item/Other/ServiceAquila.Local.png) | ![illustration for ServiceAquilaCard](../../../azure-23/Item/Other/ServiceAquilaCard.Local.png) | ![illustration for ServiceAquilaGroup](../../../azure-23/Item/Other/ServiceAquilaGroup.Local.png) |
