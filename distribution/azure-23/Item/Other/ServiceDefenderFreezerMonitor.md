...
```text
azure-23/Item/Other/ServiceDefenderFreezerMonitor
```

```text
include('azure-23/Item/Other/ServiceDefenderFreezerMonitor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderFreezerMonitor.png) | ![illustration for ServiceDefenderFreezerMonitor](../../../azure-23/Item/Other/ServiceDefenderFreezerMonitor.Local.png) | ![illustration for ServiceDefenderFreezerMonitorCard](../../../azure-23/Item/Other/ServiceDefenderFreezerMonitorCard.Local.png) | ![illustration for ServiceDefenderFreezerMonitorGroup](../../../azure-23/Item/Other/ServiceDefenderFreezerMonitorGroup.Local.png) |
