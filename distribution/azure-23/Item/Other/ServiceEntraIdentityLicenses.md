...
```text
azure-23/Item/Other/ServiceEntraIdentityLicenses
```

```text
include('azure-23/Item/Other/ServiceEntraIdentityLicenses')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceEntraIdentityLicenses.png) | ![illustration for ServiceEntraIdentityLicenses](../../../azure-23/Item/Other/ServiceEntraIdentityLicenses.Local.png) | ![illustration for ServiceEntraIdentityLicensesCard](../../../azure-23/Item/Other/ServiceEntraIdentityLicensesCard.Local.png) | ![illustration for ServiceEntraIdentityLicensesGroup](../../../azure-23/Item/Other/ServiceEntraIdentityLicensesGroup.Local.png) |
