...
```text
azure-23/Item/Other/ServiceHdiAksCluster
```

```text
include('azure-23/Item/Other/ServiceHdiAksCluster')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceHdiAksCluster.png) | ![illustration for ServiceHdiAksCluster](../../../azure-23/Item/Other/ServiceHdiAksCluster.Local.png) | ![illustration for ServiceHdiAksClusterCard](../../../azure-23/Item/Other/ServiceHdiAksClusterCard.Local.png) | ![illustration for ServiceHdiAksClusterGroup](../../../azure-23/Item/Other/ServiceHdiAksClusterGroup.Local.png) |
