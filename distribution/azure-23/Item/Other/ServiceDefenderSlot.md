...
```text
azure-23/Item/Other/ServiceDefenderSlot
```

```text
include('azure-23/Item/Other/ServiceDefenderSlot')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderSlot.png) | ![illustration for ServiceDefenderSlot](../../../azure-23/Item/Other/ServiceDefenderSlot.Local.png) | ![illustration for ServiceDefenderSlotCard](../../../azure-23/Item/Other/ServiceDefenderSlotCard.Local.png) | ![illustration for ServiceDefenderSlotGroup](../../../azure-23/Item/Other/ServiceDefenderSlotGroup.Local.png) |
