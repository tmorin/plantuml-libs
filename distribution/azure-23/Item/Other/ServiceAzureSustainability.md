...
```text
azure-23/Item/Other/ServiceAzureSustainability
```

```text
include('azure-23/Item/Other/ServiceAzureSustainability')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureSustainability.png) | ![illustration for ServiceAzureSustainability](../../../azure-23/Item/Other/ServiceAzureSustainability.Local.png) | ![illustration for ServiceAzureSustainabilityCard](../../../azure-23/Item/Other/ServiceAzureSustainabilityCard.Local.png) | ![illustration for ServiceAzureSustainabilityGroup](../../../azure-23/Item/Other/ServiceAzureSustainabilityGroup.Local.png) |
