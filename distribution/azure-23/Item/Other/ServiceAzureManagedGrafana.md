...
```text
azure-23/Item/Other/ServiceAzureManagedGrafana
```

```text
include('azure-23/Item/Other/ServiceAzureManagedGrafana')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureManagedGrafana.png) | ![illustration for ServiceAzureManagedGrafana](../../../azure-23/Item/Other/ServiceAzureManagedGrafana.Local.png) | ![illustration for ServiceAzureManagedGrafanaCard](../../../azure-23/Item/Other/ServiceAzureManagedGrafanaCard.Local.png) | ![illustration for ServiceAzureManagedGrafanaGroup](../../../azure-23/Item/Other/ServiceAzureManagedGrafanaGroup.Local.png) |
