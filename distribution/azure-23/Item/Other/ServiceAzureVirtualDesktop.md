...
```text
azure-23/Item/Other/ServiceAzureVirtualDesktop
```

```text
include('azure-23/Item/Other/ServiceAzureVirtualDesktop')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureVirtualDesktop.png) | ![illustration for ServiceAzureVirtualDesktop](../../../azure-23/Item/Other/ServiceAzureVirtualDesktop.Local.png) | ![illustration for ServiceAzureVirtualDesktopCard](../../../azure-23/Item/Other/ServiceAzureVirtualDesktopCard.Local.png) | ![illustration for ServiceAzureVirtualDesktopGroup](../../../azure-23/Item/Other/ServiceAzureVirtualDesktopGroup.Local.png) |
