...
```text
azure-23/Item/Other/ServiceContainerAppsEnvironments
```

```text
include('azure-23/Item/Other/ServiceContainerAppsEnvironments')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceContainerAppsEnvironments.png) | ![illustration for ServiceContainerAppsEnvironments](../../../azure-23/Item/Other/ServiceContainerAppsEnvironments.Local.png) | ![illustration for ServiceContainerAppsEnvironmentsCard](../../../azure-23/Item/Other/ServiceContainerAppsEnvironmentsCard.Local.png) | ![illustration for ServiceContainerAppsEnvironmentsGroup](../../../azure-23/Item/Other/ServiceContainerAppsEnvironmentsGroup.Local.png) |
