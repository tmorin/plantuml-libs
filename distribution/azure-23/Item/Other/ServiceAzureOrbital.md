...
```text
azure-23/Item/Other/ServiceAzureOrbital
```

```text
include('azure-23/Item/Other/ServiceAzureOrbital')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureOrbital.png) | ![illustration for ServiceAzureOrbital](../../../azure-23/Item/Other/ServiceAzureOrbital.Local.png) | ![illustration for ServiceAzureOrbitalCard](../../../azure-23/Item/Other/ServiceAzureOrbitalCard.Local.png) | ![illustration for ServiceAzureOrbitalGroup](../../../azure-23/Item/Other/ServiceAzureOrbitalGroup.Local.png) |
