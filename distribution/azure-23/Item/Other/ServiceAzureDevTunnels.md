...
```text
azure-23/Item/Other/ServiceAzureDevTunnels
```

```text
include('azure-23/Item/Other/ServiceAzureDevTunnels')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureDevTunnels.png) | ![illustration for ServiceAzureDevTunnels](../../../azure-23/Item/Other/ServiceAzureDevTunnels.Local.png) | ![illustration for ServiceAzureDevTunnelsCard](../../../azure-23/Item/Other/ServiceAzureDevTunnelsCard.Local.png) | ![illustration for ServiceAzureDevTunnelsGroup](../../../azure-23/Item/Other/ServiceAzureDevTunnelsGroup.Local.png) |
