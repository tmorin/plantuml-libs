...
```text
azure-23/Item/Other/ServiceDeviceUpdateIoTHub
```

```text
include('azure-23/Item/Other/ServiceDeviceUpdateIoTHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDeviceUpdateIoTHub.png) | ![illustration for ServiceDeviceUpdateIoTHub](../../../azure-23/Item/Other/ServiceDeviceUpdateIoTHub.Local.png) | ![illustration for ServiceDeviceUpdateIoTHubCard](../../../azure-23/Item/Other/ServiceDeviceUpdateIoTHubCard.Local.png) | ![illustration for ServiceDeviceUpdateIoTHubGroup](../../../azure-23/Item/Other/ServiceDeviceUpdateIoTHubGroup.Local.png) |
