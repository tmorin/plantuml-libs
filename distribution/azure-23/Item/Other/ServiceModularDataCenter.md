...
```text
azure-23/Item/Other/ServiceModularDataCenter
```

```text
include('azure-23/Item/Other/ServiceModularDataCenter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceModularDataCenter.png) | ![illustration for ServiceModularDataCenter](../../../azure-23/Item/Other/ServiceModularDataCenter.Local.png) | ![illustration for ServiceModularDataCenterCard](../../../azure-23/Item/Other/ServiceModularDataCenterCard.Local.png) | ![illustration for ServiceModularDataCenterGroup](../../../azure-23/Item/Other/ServiceModularDataCenterGroup.Local.png) |
