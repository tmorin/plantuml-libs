...
```text
azure-23/Item/Other/ServiceDefenderSensor
```

```text
include('azure-23/Item/Other/ServiceDefenderSensor')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderSensor.png) | ![illustration for ServiceDefenderSensor](../../../azure-23/Item/Other/ServiceDefenderSensor.Local.png) | ![illustration for ServiceDefenderSensorCard](../../../azure-23/Item/Other/ServiceDefenderSensorCard.Local.png) | ![illustration for ServiceDefenderSensorGroup](../../../azure-23/Item/Other/ServiceDefenderSensorGroup.Local.png) |
