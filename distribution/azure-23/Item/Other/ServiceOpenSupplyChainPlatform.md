...
```text
azure-23/Item/Other/ServiceOpenSupplyChainPlatform
```

```text
include('azure-23/Item/Other/ServiceOpenSupplyChainPlatform')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceOpenSupplyChainPlatform.png) | ![illustration for ServiceOpenSupplyChainPlatform](../../../azure-23/Item/Other/ServiceOpenSupplyChainPlatform.Local.png) | ![illustration for ServiceOpenSupplyChainPlatformCard](../../../azure-23/Item/Other/ServiceOpenSupplyChainPlatformCard.Local.png) | ![illustration for ServiceOpenSupplyChainPlatformGroup](../../../azure-23/Item/Other/ServiceOpenSupplyChainPlatformGroup.Local.png) |
