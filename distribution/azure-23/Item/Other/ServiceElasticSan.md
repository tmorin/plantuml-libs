...
```text
azure-23/Item/Other/ServiceElasticSan
```

```text
include('azure-23/Item/Other/ServiceElasticSan')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceElasticSan.png) | ![illustration for ServiceElasticSan](../../../azure-23/Item/Other/ServiceElasticSan.Local.png) | ![illustration for ServiceElasticSanCard](../../../azure-23/Item/Other/ServiceElasticSanCard.Local.png) | ![illustration for ServiceElasticSanGroup](../../../azure-23/Item/Other/ServiceElasticSanGroup.Local.png) |
