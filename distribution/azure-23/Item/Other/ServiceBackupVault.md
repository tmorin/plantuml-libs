...
```text
azure-23/Item/Other/ServiceBackupVault
```

```text
include('azure-23/Item/Other/ServiceBackupVault')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceBackupVault.png) | ![illustration for ServiceBackupVault](../../../azure-23/Item/Other/ServiceBackupVault.Local.png) | ![illustration for ServiceBackupVaultCard](../../../azure-23/Item/Other/ServiceBackupVaultCard.Local.png) | ![illustration for ServiceBackupVaultGroup](../../../azure-23/Item/Other/ServiceBackupVaultGroup.Local.png) |
