...
```text
azure-23/Item/Other/ServiceExchangeOnPremisesAccess
```

```text
include('azure-23/Item/Other/ServiceExchangeOnPremisesAccess')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceExchangeOnPremisesAccess.png) | ![illustration for ServiceExchangeOnPremisesAccess](../../../azure-23/Item/Other/ServiceExchangeOnPremisesAccess.Local.png) | ![illustration for ServiceExchangeOnPremisesAccessCard](../../../azure-23/Item/Other/ServiceExchangeOnPremisesAccessCard.Local.png) | ![illustration for ServiceExchangeOnPremisesAccessGroup](../../../azure-23/Item/Other/ServiceExchangeOnPremisesAccessGroup.Local.png) |
