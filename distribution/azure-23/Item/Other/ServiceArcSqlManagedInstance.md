...
```text
azure-23/Item/Other/ServiceArcSqlManagedInstance
```

```text
include('azure-23/Item/Other/ServiceArcSqlManagedInstance')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceArcSqlManagedInstance.png) | ![illustration for ServiceArcSqlManagedInstance](../../../azure-23/Item/Other/ServiceArcSqlManagedInstance.Local.png) | ![illustration for ServiceArcSqlManagedInstanceCard](../../../azure-23/Item/Other/ServiceArcSqlManagedInstanceCard.Local.png) | ![illustration for ServiceArcSqlManagedInstanceGroup](../../../azure-23/Item/Other/ServiceArcSqlManagedInstanceGroup.Local.png) |
