...
```text
azure-23/Item/Other/ServiceAzureComputeGalleries
```

```text
include('azure-23/Item/Other/ServiceAzureComputeGalleries')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureComputeGalleries.png) | ![illustration for ServiceAzureComputeGalleries](../../../azure-23/Item/Other/ServiceAzureComputeGalleries.Local.png) | ![illustration for ServiceAzureComputeGalleriesCard](../../../azure-23/Item/Other/ServiceAzureComputeGalleriesCard.Local.png) | ![illustration for ServiceAzureComputeGalleriesGroup](../../../azure-23/Item/Other/ServiceAzureComputeGalleriesGroup.Local.png) |
