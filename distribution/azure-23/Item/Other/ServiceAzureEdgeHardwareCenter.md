...
```text
azure-23/Item/Other/ServiceAzureEdgeHardwareCenter
```

```text
include('azure-23/Item/Other/ServiceAzureEdgeHardwareCenter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureEdgeHardwareCenter.png) | ![illustration for ServiceAzureEdgeHardwareCenter](../../../azure-23/Item/Other/ServiceAzureEdgeHardwareCenter.Local.png) | ![illustration for ServiceAzureEdgeHardwareCenterCard](../../../azure-23/Item/Other/ServiceAzureEdgeHardwareCenterCard.Local.png) | ![illustration for ServiceAzureEdgeHardwareCenterGroup](../../../azure-23/Item/Other/ServiceAzureEdgeHardwareCenterGroup.Local.png) |
