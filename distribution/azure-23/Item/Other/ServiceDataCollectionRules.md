...
```text
azure-23/Item/Other/ServiceDataCollectionRules
```

```text
include('azure-23/Item/Other/ServiceDataCollectionRules')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDataCollectionRules.png) | ![illustration for ServiceDataCollectionRules](../../../azure-23/Item/Other/ServiceDataCollectionRules.Local.png) | ![illustration for ServiceDataCollectionRulesCard](../../../azure-23/Item/Other/ServiceDataCollectionRulesCard.Local.png) | ![illustration for ServiceDataCollectionRulesGroup](../../../azure-23/Item/Other/ServiceDataCollectionRulesGroup.Local.png) |
