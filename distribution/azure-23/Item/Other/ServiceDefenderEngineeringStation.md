...
```text
azure-23/Item/Other/ServiceDefenderEngineeringStation
```

```text
include('azure-23/Item/Other/ServiceDefenderEngineeringStation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderEngineeringStation.png) | ![illustration for ServiceDefenderEngineeringStation](../../../azure-23/Item/Other/ServiceDefenderEngineeringStation.Local.png) | ![illustration for ServiceDefenderEngineeringStationCard](../../../azure-23/Item/Other/ServiceDefenderEngineeringStationCard.Local.png) | ![illustration for ServiceDefenderEngineeringStationGroup](../../../azure-23/Item/Other/ServiceDefenderEngineeringStationGroup.Local.png) |
