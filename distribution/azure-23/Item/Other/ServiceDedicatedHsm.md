...
```text
azure-23/Item/Other/ServiceDedicatedHsm
```

```text
include('azure-23/Item/Other/ServiceDedicatedHsm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDedicatedHsm.png) | ![illustration for ServiceDedicatedHsm](../../../azure-23/Item/Other/ServiceDedicatedHsm.Local.png) | ![illustration for ServiceDedicatedHsmCard](../../../azure-23/Item/Other/ServiceDedicatedHsmCard.Local.png) | ![illustration for ServiceDedicatedHsmGroup](../../../azure-23/Item/Other/ServiceDedicatedHsmGroup.Local.png) |
