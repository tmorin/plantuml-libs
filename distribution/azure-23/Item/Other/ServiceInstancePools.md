...
```text
azure-23/Item/Other/ServiceInstancePools
```

```text
include('azure-23/Item/Other/ServiceInstancePools')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceInstancePools.png) | ![illustration for ServiceInstancePools](../../../azure-23/Item/Other/ServiceInstancePools.Local.png) | ![illustration for ServiceInstancePoolsCard](../../../azure-23/Item/Other/ServiceInstancePoolsCard.Local.png) | ![illustration for ServiceInstancePoolsGroup](../../../azure-23/Item/Other/ServiceInstancePoolsGroup.Local.png) |
