...
```text
azure-23/Item/Other/ServiceBareMetalInfrastructure
```

```text
include('azure-23/Item/Other/ServiceBareMetalInfrastructure')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceBareMetalInfrastructure.png) | ![illustration for ServiceBareMetalInfrastructure](../../../azure-23/Item/Other/ServiceBareMetalInfrastructure.Local.png) | ![illustration for ServiceBareMetalInfrastructureCard](../../../azure-23/Item/Other/ServiceBareMetalInfrastructureCard.Local.png) | ![illustration for ServiceBareMetalInfrastructureGroup](../../../azure-23/Item/Other/ServiceBareMetalInfrastructureGroup.Local.png) |
