...
```text
azure-23/Item/Other/ServiceResourceGuard
```

```text
include('azure-23/Item/Other/ServiceResourceGuard')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceResourceGuard.png) | ![illustration for ServiceResourceGuard](../../../azure-23/Item/Other/ServiceResourceGuard.Local.png) | ![illustration for ServiceResourceGuardCard](../../../azure-23/Item/Other/ServiceResourceGuardCard.Local.png) | ![illustration for ServiceResourceGuardGroup](../../../azure-23/Item/Other/ServiceResourceGuardGroup.Local.png) |
