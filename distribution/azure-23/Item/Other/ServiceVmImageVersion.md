...
```text
azure-23/Item/Other/ServiceVmImageVersion
```

```text
include('azure-23/Item/Other/ServiceVmImageVersion')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceVmImageVersion.png) | ![illustration for ServiceVmImageVersion](../../../azure-23/Item/Other/ServiceVmImageVersion.Local.png) | ![illustration for ServiceVmImageVersionCard](../../../azure-23/Item/Other/ServiceVmImageVersionCard.Local.png) | ![illustration for ServiceVmImageVersionGroup](../../../azure-23/Item/Other/ServiceVmImageVersionGroup.Local.png) |
