...
```text
azure-23/Item/Other/ServiceConfidentialLedgers
```

```text
include('azure-23/Item/Other/ServiceConfidentialLedgers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceConfidentialLedgers.png) | ![illustration for ServiceConfidentialLedgers](../../../azure-23/Item/Other/ServiceConfidentialLedgers.Local.png) | ![illustration for ServiceConfidentialLedgersCard](../../../azure-23/Item/Other/ServiceConfidentialLedgersCard.Local.png) | ![illustration for ServiceConfidentialLedgersGroup](../../../azure-23/Item/Other/ServiceConfidentialLedgersGroup.Local.png) |
