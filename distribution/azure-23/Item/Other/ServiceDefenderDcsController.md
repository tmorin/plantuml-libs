...
```text
azure-23/Item/Other/ServiceDefenderDcsController
```

```text
include('azure-23/Item/Other/ServiceDefenderDcsController')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderDcsController.png) | ![illustration for ServiceDefenderDcsController](../../../azure-23/Item/Other/ServiceDefenderDcsController.Local.png) | ![illustration for ServiceDefenderDcsControllerCard](../../../azure-23/Item/Other/ServiceDefenderDcsControllerCard.Local.png) | ![illustration for ServiceDefenderDcsControllerGroup](../../../azure-23/Item/Other/ServiceDefenderDcsControllerGroup.Local.png) |
