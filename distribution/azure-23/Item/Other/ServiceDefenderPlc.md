...
```text
azure-23/Item/Other/ServiceDefenderPlc
```

```text
include('azure-23/Item/Other/ServiceDefenderPlc')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderPlc.png) | ![illustration for ServiceDefenderPlc](../../../azure-23/Item/Other/ServiceDefenderPlc.Local.png) | ![illustration for ServiceDefenderPlcCard](../../../azure-23/Item/Other/ServiceDefenderPlcCard.Local.png) | ![illustration for ServiceDefenderPlcGroup](../../../azure-23/Item/Other/ServiceDefenderPlcGroup.Local.png) |
