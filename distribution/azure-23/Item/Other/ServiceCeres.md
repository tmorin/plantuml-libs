...
```text
azure-23/Item/Other/ServiceCeres
```

```text
include('azure-23/Item/Other/ServiceCeres')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceCeres.png) | ![illustration for ServiceCeres](../../../azure-23/Item/Other/ServiceCeres.Local.png) | ![illustration for ServiceCeresCard](../../../azure-23/Item/Other/ServiceCeresCard.Local.png) | ![illustration for ServiceCeresGroup](../../../azure-23/Item/Other/ServiceCeresGroup.Local.png) |
