...
```text
azure-23/Item/Other/ServiceStorageFunctions
```

```text
include('azure-23/Item/Other/ServiceStorageFunctions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceStorageFunctions.png) | ![illustration for ServiceStorageFunctions](../../../azure-23/Item/Other/ServiceStorageFunctions.Local.png) | ![illustration for ServiceStorageFunctionsCard](../../../azure-23/Item/Other/ServiceStorageFunctionsCard.Local.png) | ![illustration for ServiceStorageFunctionsGroup](../../../azure-23/Item/Other/ServiceStorageFunctionsGroup.Local.png) |
