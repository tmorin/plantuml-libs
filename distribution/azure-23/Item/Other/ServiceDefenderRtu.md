...
```text
azure-23/Item/Other/ServiceDefenderRtu
```

```text
include('azure-23/Item/Other/ServiceDefenderRtu')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderRtu.png) | ![illustration for ServiceDefenderRtu](../../../azure-23/Item/Other/ServiceDefenderRtu.Local.png) | ![illustration for ServiceDefenderRtuCard](../../../azure-23/Item/Other/ServiceDefenderRtuCard.Local.png) | ![illustration for ServiceDefenderRtuGroup](../../../azure-23/Item/Other/ServiceDefenderRtuGroup.Local.png) |
