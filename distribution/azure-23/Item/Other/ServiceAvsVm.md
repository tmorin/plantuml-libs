...
```text
azure-23/Item/Other/ServiceAvsVm
```

```text
include('azure-23/Item/Other/ServiceAvsVm')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAvsVm.png) | ![illustration for ServiceAvsVm](../../../azure-23/Item/Other/ServiceAvsVm.Local.png) | ![illustration for ServiceAvsVmCard](../../../azure-23/Item/Other/ServiceAvsVmCard.Local.png) | ![illustration for ServiceAvsVmGroup](../../../azure-23/Item/Other/ServiceAvsVmGroup.Local.png) |
