...
```text
azure-23/Item/Other/ServiceWacInstaller
```

```text
include('azure-23/Item/Other/ServiceWacInstaller')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceWacInstaller.png) | ![illustration for ServiceWacInstaller](../../../azure-23/Item/Other/ServiceWacInstaller.Local.png) | ![illustration for ServiceWacInstallerCard](../../../azure-23/Item/Other/ServiceWacInstallerCard.Local.png) | ![illustration for ServiceWacInstallerGroup](../../../azure-23/Item/Other/ServiceWacInstallerGroup.Local.png) |
