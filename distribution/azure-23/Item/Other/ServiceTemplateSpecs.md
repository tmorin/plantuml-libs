...
```text
azure-23/Item/Other/ServiceTemplateSpecs
```

```text
include('azure-23/Item/Other/ServiceTemplateSpecs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceTemplateSpecs.png) | ![illustration for ServiceTemplateSpecs](../../../azure-23/Item/Other/ServiceTemplateSpecs.Local.png) | ![illustration for ServiceTemplateSpecsCard](../../../azure-23/Item/Other/ServiceTemplateSpecsCard.Local.png) | ![illustration for ServiceTemplateSpecsGroup](../../../azure-23/Item/Other/ServiceTemplateSpecsGroup.Local.png) |
