...
```text
azure-23/Item/Other/ServiceDefenderHmi
```

```text
include('azure-23/Item/Other/ServiceDefenderHmi')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderHmi.png) | ![illustration for ServiceDefenderHmi](../../../azure-23/Item/Other/ServiceDefenderHmi.Local.png) | ![illustration for ServiceDefenderHmiCard](../../../azure-23/Item/Other/ServiceDefenderHmiCard.Local.png) | ![illustration for ServiceDefenderHmiGroup](../../../azure-23/Item/Other/ServiceDefenderHmiGroup.Local.png) |
