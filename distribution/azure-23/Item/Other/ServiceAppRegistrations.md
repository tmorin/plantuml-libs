...
```text
azure-23/Item/Other/ServiceAppRegistrations
```

```text
include('azure-23/Item/Other/ServiceAppRegistrations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAppRegistrations.png) | ![illustration for ServiceAppRegistrations](../../../azure-23/Item/Other/ServiceAppRegistrations.Local.png) | ![illustration for ServiceAppRegistrationsCard](../../../azure-23/Item/Other/ServiceAppRegistrationsCard.Local.png) | ![illustration for ServiceAppRegistrationsGroup](../../../azure-23/Item/Other/ServiceAppRegistrationsGroup.Local.png) |
