...
```text
azure-23/Item/Other/ServiceDatabaseInstanceForSap
```

```text
include('azure-23/Item/Other/ServiceDatabaseInstanceForSap')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDatabaseInstanceForSap.png) | ![illustration for ServiceDatabaseInstanceForSap](../../../azure-23/Item/Other/ServiceDatabaseInstanceForSap.Local.png) | ![illustration for ServiceDatabaseInstanceForSapCard](../../../azure-23/Item/Other/ServiceDatabaseInstanceForSapCard.Local.png) | ![illustration for ServiceDatabaseInstanceForSapGroup](../../../azure-23/Item/Other/ServiceDatabaseInstanceForSapGroup.Local.png) |
