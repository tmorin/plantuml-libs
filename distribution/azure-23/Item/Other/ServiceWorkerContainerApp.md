...
```text
azure-23/Item/Other/ServiceWorkerContainerApp
```

```text
include('azure-23/Item/Other/ServiceWorkerContainerApp')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceWorkerContainerApp.png) | ![illustration for ServiceWorkerContainerApp](../../../azure-23/Item/Other/ServiceWorkerContainerApp.Local.png) | ![illustration for ServiceWorkerContainerAppCard](../../../azure-23/Item/Other/ServiceWorkerContainerAppCard.Local.png) | ![illustration for ServiceWorkerContainerAppGroup](../../../azure-23/Item/Other/ServiceWorkerContainerAppGroup.Local.png) |
