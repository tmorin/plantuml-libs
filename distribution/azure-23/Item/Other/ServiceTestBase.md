...
```text
azure-23/Item/Other/ServiceTestBase
```

```text
include('azure-23/Item/Other/ServiceTestBase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceTestBase.png) | ![illustration for ServiceTestBase](../../../azure-23/Item/Other/ServiceTestBase.Local.png) | ![illustration for ServiceTestBaseCard](../../../azure-23/Item/Other/ServiceTestBaseCard.Local.png) | ![illustration for ServiceTestBaseGroup](../../../azure-23/Item/Other/ServiceTestBaseGroup.Local.png) |
