...
```text
azure-23/Item/Other/ServiceVirtualEnclaves
```

```text
include('azure-23/Item/Other/ServiceVirtualEnclaves')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceVirtualEnclaves.png) | ![illustration for ServiceVirtualEnclaves](../../../azure-23/Item/Other/ServiceVirtualEnclaves.Local.png) | ![illustration for ServiceVirtualEnclavesCard](../../../azure-23/Item/Other/ServiceVirtualEnclavesCard.Local.png) | ![illustration for ServiceVirtualEnclavesGroup](../../../azure-23/Item/Other/ServiceVirtualEnclavesGroup.Local.png) |
