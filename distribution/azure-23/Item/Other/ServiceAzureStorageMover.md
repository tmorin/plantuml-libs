...
```text
azure-23/Item/Other/ServiceAzureStorageMover
```

```text
include('azure-23/Item/Other/ServiceAzureStorageMover')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureStorageMover.png) | ![illustration for ServiceAzureStorageMover](../../../azure-23/Item/Other/ServiceAzureStorageMover.Local.png) | ![illustration for ServiceAzureStorageMoverCard](../../../azure-23/Item/Other/ServiceAzureStorageMoverCard.Local.png) | ![illustration for ServiceAzureStorageMoverGroup](../../../azure-23/Item/Other/ServiceAzureStorageMoverGroup.Local.png) |
