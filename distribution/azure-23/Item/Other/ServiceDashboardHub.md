...
```text
azure-23/Item/Other/ServiceDashboardHub
```

```text
include('azure-23/Item/Other/ServiceDashboardHub')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDashboardHub.png) | ![illustration for ServiceDashboardHub](../../../azure-23/Item/Other/ServiceDashboardHub.Local.png) | ![illustration for ServiceDashboardHubCard](../../../azure-23/Item/Other/ServiceDashboardHubCard.Local.png) | ![illustration for ServiceDashboardHubGroup](../../../azure-23/Item/Other/ServiceDashboardHubGroup.Local.png) |
