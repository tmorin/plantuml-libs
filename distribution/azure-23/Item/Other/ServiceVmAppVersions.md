...
```text
azure-23/Item/Other/ServiceVmAppVersions
```

```text
include('azure-23/Item/Other/ServiceVmAppVersions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceVmAppVersions.png) | ![illustration for ServiceVmAppVersions](../../../azure-23/Item/Other/ServiceVmAppVersions.Local.png) | ![illustration for ServiceVmAppVersionsCard](../../../azure-23/Item/Other/ServiceVmAppVersionsCard.Local.png) | ![illustration for ServiceVmAppVersionsGroup](../../../azure-23/Item/Other/ServiceVmAppVersionsGroup.Local.png) |
