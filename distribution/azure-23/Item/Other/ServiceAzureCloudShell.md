...
```text
azure-23/Item/Other/ServiceAzureCloudShell
```

```text
include('azure-23/Item/Other/ServiceAzureCloudShell')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureCloudShell.png) | ![illustration for ServiceAzureCloudShell](../../../azure-23/Item/Other/ServiceAzureCloudShell.Local.png) | ![illustration for ServiceAzureCloudShellCard](../../../azure-23/Item/Other/ServiceAzureCloudShellCard.Local.png) | ![illustration for ServiceAzureCloudShellGroup](../../../azure-23/Item/Other/ServiceAzureCloudShellGroup.Local.png) |
