...
```text
azure-23/Item/Other/ServiceScvmmManagementServers
```

```text
include('azure-23/Item/Other/ServiceScvmmManagementServers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceScvmmManagementServers.png) | ![illustration for ServiceScvmmManagementServers](../../../azure-23/Item/Other/ServiceScvmmManagementServers.Local.png) | ![illustration for ServiceScvmmManagementServersCard](../../../azure-23/Item/Other/ServiceScvmmManagementServersCard.Local.png) | ![illustration for ServiceScvmmManagementServersGroup](../../../azure-23/Item/Other/ServiceScvmmManagementServersGroup.Local.png) |
