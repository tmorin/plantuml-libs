...
```text
azure-23/Item/Other/ServiceWebJobs
```

```text
include('azure-23/Item/Other/ServiceWebJobs')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceWebJobs.png) | ![illustration for ServiceWebJobs](../../../azure-23/Item/Other/ServiceWebJobs.Local.png) | ![illustration for ServiceWebJobsCard](../../../azure-23/Item/Other/ServiceWebJobsCard.Local.png) | ![illustration for ServiceWebJobsGroup](../../../azure-23/Item/Other/ServiceWebJobsGroup.Local.png) |
