...
```text
azure-23/Item/Other/ServiceCustomIpPrefix
```

```text
include('azure-23/Item/Other/ServiceCustomIpPrefix')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceCustomIpPrefix.png) | ![illustration for ServiceCustomIpPrefix](../../../azure-23/Item/Other/ServiceCustomIpPrefix.Local.png) | ![illustration for ServiceCustomIpPrefixCard](../../../azure-23/Item/Other/ServiceCustomIpPrefixCard.Local.png) | ![illustration for ServiceCustomIpPrefixGroup](../../../azure-23/Item/Other/ServiceCustomIpPrefixGroup.Local.png) |
