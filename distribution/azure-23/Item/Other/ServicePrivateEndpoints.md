...
```text
azure-23/Item/Other/ServicePrivateEndpoints
```

```text
include('azure-23/Item/Other/ServicePrivateEndpoints')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServicePrivateEndpoints.png) | ![illustration for ServicePrivateEndpoints](../../../azure-23/Item/Other/ServicePrivateEndpoints.Local.png) | ![illustration for ServicePrivateEndpointsCard](../../../azure-23/Item/Other/ServicePrivateEndpointsCard.Local.png) | ![illustration for ServicePrivateEndpointsGroup](../../../azure-23/Item/Other/ServicePrivateEndpointsGroup.Local.png) |
