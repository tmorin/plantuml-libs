...
```text
azure-23/Item/Other/ServiceVirtualVisitsBuilder
```

```text
include('azure-23/Item/Other/ServiceVirtualVisitsBuilder')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceVirtualVisitsBuilder.png) | ![illustration for ServiceVirtualVisitsBuilder](../../../azure-23/Item/Other/ServiceVirtualVisitsBuilder.Local.png) | ![illustration for ServiceVirtualVisitsBuilderCard](../../../azure-23/Item/Other/ServiceVirtualVisitsBuilderCard.Local.png) | ![illustration for ServiceVirtualVisitsBuilderGroup](../../../azure-23/Item/Other/ServiceVirtualVisitsBuilderGroup.Local.png) |
