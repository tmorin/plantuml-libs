...
```text
azure-23/Item/Other/ServiceOsConfig
```

```text
include('azure-23/Item/Other/ServiceOsConfig')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceOsConfig.png) | ![illustration for ServiceOsConfig](../../../azure-23/Item/Other/ServiceOsConfig.Local.png) | ![illustration for ServiceOsConfigCard](../../../azure-23/Item/Other/ServiceOsConfigCard.Local.png) | ![illustration for ServiceOsConfigGroup](../../../azure-23/Item/Other/ServiceOsConfigGroup.Local.png) |
