...
```text
azure-23/Item/Other/ServiceFhirService
```

```text
include('azure-23/Item/Other/ServiceFhirService')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceFhirService.png) | ![illustration for ServiceFhirService](../../../azure-23/Item/Other/ServiceFhirService.Local.png) | ![illustration for ServiceFhirServiceCard](../../../azure-23/Item/Other/ServiceFhirServiceCard.Local.png) | ![illustration for ServiceFhirServiceGroup](../../../azure-23/Item/Other/ServiceFhirServiceGroup.Local.png) |
