...
```text
azure-23/Item/Other/ServiceAzureQuotas
```

```text
include('azure-23/Item/Other/ServiceAzureQuotas')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureQuotas.png) | ![illustration for ServiceAzureQuotas](../../../azure-23/Item/Other/ServiceAzureQuotas.Local.png) | ![illustration for ServiceAzureQuotasCard](../../../azure-23/Item/Other/ServiceAzureQuotasCard.Local.png) | ![illustration for ServiceAzureQuotasGroup](../../../azure-23/Item/Other/ServiceAzureQuotasGroup.Local.png) |
