...
```text
azure-23/Item/Other/ServiceDefenderCmLocalManager
```

```text
include('azure-23/Item/Other/ServiceDefenderCmLocalManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderCmLocalManager.png) | ![illustration for ServiceDefenderCmLocalManager](../../../azure-23/Item/Other/ServiceDefenderCmLocalManager.Local.png) | ![illustration for ServiceDefenderCmLocalManagerCard](../../../azure-23/Item/Other/ServiceDefenderCmLocalManagerCard.Local.png) | ![illustration for ServiceDefenderCmLocalManagerGroup](../../../azure-23/Item/Other/ServiceDefenderCmLocalManagerGroup.Local.png) |
