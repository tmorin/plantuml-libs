...
```text
azure-23/Item/Other/ServiceCostExport
```

```text
include('azure-23/Item/Other/ServiceCostExport')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceCostExport.png) | ![illustration for ServiceCostExport](../../../azure-23/Item/Other/ServiceCostExport.Local.png) | ![illustration for ServiceCostExportCard](../../../azure-23/Item/Other/ServiceCostExportCard.Local.png) | ![illustration for ServiceCostExportGroup](../../../azure-23/Item/Other/ServiceCostExportGroup.Local.png) |
