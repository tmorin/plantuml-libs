...
```text
azure-23/Item/Other/ServiceArcDataServices
```

```text
include('azure-23/Item/Other/ServiceArcDataServices')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceArcDataServices.png) | ![illustration for ServiceArcDataServices](../../../azure-23/Item/Other/ServiceArcDataServices.Local.png) | ![illustration for ServiceArcDataServicesCard](../../../azure-23/Item/Other/ServiceArcDataServicesCard.Local.png) | ![illustration for ServiceArcDataServicesGroup](../../../azure-23/Item/Other/ServiceArcDataServicesGroup.Local.png) |
