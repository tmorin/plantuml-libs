...
```text
azure-23/Item/Other/ServiceExpressRouteDirect
```

```text
include('azure-23/Item/Other/ServiceExpressRouteDirect')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceExpressRouteDirect.png) | ![illustration for ServiceExpressRouteDirect](../../../azure-23/Item/Other/ServiceExpressRouteDirect.Local.png) | ![illustration for ServiceExpressRouteDirectCard](../../../azure-23/Item/Other/ServiceExpressRouteDirectCard.Local.png) | ![illustration for ServiceExpressRouteDirectGroup](../../../azure-23/Item/Other/ServiceExpressRouteDirectGroup.Local.png) |
