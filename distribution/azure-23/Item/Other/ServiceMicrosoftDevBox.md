...
```text
azure-23/Item/Other/ServiceMicrosoftDevBox
```

```text
include('azure-23/Item/Other/ServiceMicrosoftDevBox')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceMicrosoftDevBox.png) | ![illustration for ServiceMicrosoftDevBox](../../../azure-23/Item/Other/ServiceMicrosoftDevBox.Local.png) | ![illustration for ServiceMicrosoftDevBoxCard](../../../azure-23/Item/Other/ServiceMicrosoftDevBoxCard.Local.png) | ![illustration for ServiceMicrosoftDevBoxGroup](../../../azure-23/Item/Other/ServiceMicrosoftDevBoxGroup.Local.png) |
