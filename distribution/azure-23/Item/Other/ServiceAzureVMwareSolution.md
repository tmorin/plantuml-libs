...
```text
azure-23/Item/Other/ServiceAzureVMwareSolution
```

```text
include('azure-23/Item/Other/ServiceAzureVMwareSolution')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureVMwareSolution.png) | ![illustration for ServiceAzureVMwareSolution](../../../azure-23/Item/Other/ServiceAzureVMwareSolution.Local.png) | ![illustration for ServiceAzureVMwareSolutionCard](../../../azure-23/Item/Other/ServiceAzureVMwareSolutionCard.Local.png) | ![illustration for ServiceAzureVMwareSolutionGroup](../../../azure-23/Item/Other/ServiceAzureVMwareSolutionGroup.Local.png) |
