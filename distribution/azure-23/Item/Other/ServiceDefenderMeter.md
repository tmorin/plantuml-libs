...
```text
azure-23/Item/Other/ServiceDefenderMeter
```

```text
include('azure-23/Item/Other/ServiceDefenderMeter')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderMeter.png) | ![illustration for ServiceDefenderMeter](../../../azure-23/Item/Other/ServiceDefenderMeter.Local.png) | ![illustration for ServiceDefenderMeterCard](../../../azure-23/Item/Other/ServiceDefenderMeterCard.Local.png) | ![illustration for ServiceDefenderMeterGroup](../../../azure-23/Item/Other/ServiceDefenderMeterGroup.Local.png) |
