...
```text
azure-23/Item/Other/ServiceAzureCenterForSap
```

```text
include('azure-23/Item/Other/ServiceAzureCenterForSap')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureCenterForSap.png) | ![illustration for ServiceAzureCenterForSap](../../../azure-23/Item/Other/ServiceAzureCenterForSap.Local.png) | ![illustration for ServiceAzureCenterForSapCard](../../../azure-23/Item/Other/ServiceAzureCenterForSapCard.Local.png) | ![illustration for ServiceAzureCenterForSapGroup](../../../azure-23/Item/Other/ServiceAzureCenterForSapGroup.Local.png) |
