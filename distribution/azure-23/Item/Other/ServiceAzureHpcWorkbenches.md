...
```text
azure-23/Item/Other/ServiceAzureHpcWorkbenches
```

```text
include('azure-23/Item/Other/ServiceAzureHpcWorkbenches')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureHpcWorkbenches.png) | ![illustration for ServiceAzureHpcWorkbenches](../../../azure-23/Item/Other/ServiceAzureHpcWorkbenches.Local.png) | ![illustration for ServiceAzureHpcWorkbenchesCard](../../../azure-23/Item/Other/ServiceAzureHpcWorkbenchesCard.Local.png) | ![illustration for ServiceAzureHpcWorkbenchesGroup](../../../azure-23/Item/Other/ServiceAzureHpcWorkbenchesGroup.Local.png) |
