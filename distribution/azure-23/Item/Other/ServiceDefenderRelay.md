...
```text
azure-23/Item/Other/ServiceDefenderRelay
```

```text
include('azure-23/Item/Other/ServiceDefenderRelay')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderRelay.png) | ![illustration for ServiceDefenderRelay](../../../azure-23/Item/Other/ServiceDefenderRelay.Local.png) | ![illustration for ServiceDefenderRelayCard](../../../azure-23/Item/Other/ServiceDefenderRelayCard.Local.png) | ![illustration for ServiceDefenderRelayGroup](../../../azure-23/Item/Other/ServiceDefenderRelayGroup.Local.png) |
