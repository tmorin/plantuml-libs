...
```text
azure-23/Item/Other/ServiceAzureMonitorDashboard
```

```text
include('azure-23/Item/Other/ServiceAzureMonitorDashboard')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureMonitorDashboard.png) | ![illustration for ServiceAzureMonitorDashboard](../../../azure-23/Item/Other/ServiceAzureMonitorDashboard.Local.png) | ![illustration for ServiceAzureMonitorDashboardCard](../../../azure-23/Item/Other/ServiceAzureMonitorDashboardCard.Local.png) | ![illustration for ServiceAzureMonitorDashboardGroup](../../../azure-23/Item/Other/ServiceAzureMonitorDashboardGroup.Local.png) |
