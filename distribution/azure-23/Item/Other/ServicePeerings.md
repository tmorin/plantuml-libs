...
```text
azure-23/Item/Other/ServicePeerings
```

```text
include('azure-23/Item/Other/ServicePeerings')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServicePeerings.png) | ![illustration for ServicePeerings](../../../azure-23/Item/Other/ServicePeerings.Local.png) | ![illustration for ServicePeeringsCard](../../../azure-23/Item/Other/ServicePeeringsCard.Local.png) | ![illustration for ServicePeeringsGroup](../../../azure-23/Item/Other/ServicePeeringsGroup.Local.png) |
