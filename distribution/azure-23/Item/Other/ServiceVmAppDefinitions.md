...
```text
azure-23/Item/Other/ServiceVmAppDefinitions
```

```text
include('azure-23/Item/Other/ServiceVmAppDefinitions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceVmAppDefinitions.png) | ![illustration for ServiceVmAppDefinitions](../../../azure-23/Item/Other/ServiceVmAppDefinitions.Local.png) | ![illustration for ServiceVmAppDefinitionsCard](../../../azure-23/Item/Other/ServiceVmAppDefinitionsCard.Local.png) | ![illustration for ServiceVmAppDefinitionsGroup](../../../azure-23/Item/Other/ServiceVmAppDefinitionsGroup.Local.png) |
