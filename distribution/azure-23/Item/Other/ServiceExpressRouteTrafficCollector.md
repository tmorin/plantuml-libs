...
```text
azure-23/Item/Other/ServiceExpressRouteTrafficCollector
```

```text
include('azure-23/Item/Other/ServiceExpressRouteTrafficCollector')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceExpressRouteTrafficCollector.png) | ![illustration for ServiceExpressRouteTrafficCollector](../../../azure-23/Item/Other/ServiceExpressRouteTrafficCollector.Local.png) | ![illustration for ServiceExpressRouteTrafficCollectorCard](../../../azure-23/Item/Other/ServiceExpressRouteTrafficCollectorCard.Local.png) | ![illustration for ServiceExpressRouteTrafficCollectorGroup](../../../azure-23/Item/Other/ServiceExpressRouteTrafficCollectorGroup.Local.png) |
