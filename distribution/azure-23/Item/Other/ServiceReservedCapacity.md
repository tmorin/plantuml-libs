...
```text
azure-23/Item/Other/ServiceReservedCapacity
```

```text
include('azure-23/Item/Other/ServiceReservedCapacity')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceReservedCapacity.png) | ![illustration for ServiceReservedCapacity](../../../azure-23/Item/Other/ServiceReservedCapacity.Local.png) | ![illustration for ServiceReservedCapacityCard](../../../azure-23/Item/Other/ServiceReservedCapacityCard.Local.png) | ![illustration for ServiceReservedCapacityGroup](../../../azure-23/Item/Other/ServiceReservedCapacityGroup.Local.png) |
