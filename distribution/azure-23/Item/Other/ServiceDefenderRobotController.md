...
```text
azure-23/Item/Other/ServiceDefenderRobotController
```

```text
include('azure-23/Item/Other/ServiceDefenderRobotController')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderRobotController.png) | ![illustration for ServiceDefenderRobotController](../../../azure-23/Item/Other/ServiceDefenderRobotController.Local.png) | ![illustration for ServiceDefenderRobotControllerCard](../../../azure-23/Item/Other/ServiceDefenderRobotControllerCard.Local.png) | ![illustration for ServiceDefenderRobotControllerGroup](../../../azure-23/Item/Other/ServiceDefenderRobotControllerGroup.Local.png) |
