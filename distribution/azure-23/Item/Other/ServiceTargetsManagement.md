...
```text
azure-23/Item/Other/ServiceTargetsManagement
```

```text
include('azure-23/Item/Other/ServiceTargetsManagement')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceTargetsManagement.png) | ![illustration for ServiceTargetsManagement](../../../azure-23/Item/Other/ServiceTargetsManagement.Local.png) | ![illustration for ServiceTargetsManagementCard](../../../azure-23/Item/Other/ServiceTargetsManagementCard.Local.png) | ![illustration for ServiceTargetsManagementGroup](../../../azure-23/Item/Other/ServiceTargetsManagementGroup.Local.png) |
