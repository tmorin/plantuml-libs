...
```text
azure-23/Item/Other/ServiceDefenderMarquee
```

```text
include('azure-23/Item/Other/ServiceDefenderMarquee')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceDefenderMarquee.png) | ![illustration for ServiceDefenderMarquee](../../../azure-23/Item/Other/ServiceDefenderMarquee.Local.png) | ![illustration for ServiceDefenderMarqueeCard](../../../azure-23/Item/Other/ServiceDefenderMarqueeCard.Local.png) | ![illustration for ServiceDefenderMarqueeGroup](../../../azure-23/Item/Other/ServiceDefenderMarqueeGroup.Local.png) |
