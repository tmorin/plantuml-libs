...
```text
azure-23/Item/Other/ServiceAzureA
```

```text
include('azure-23/Item/Other/ServiceAzureA')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureA.png) | ![illustration for ServiceAzureA](../../../azure-23/Item/Other/ServiceAzureA.Local.png) | ![illustration for ServiceAzureACard](../../../azure-23/Item/Other/ServiceAzureACard.Local.png) | ![illustration for ServiceAzureAGroup](../../../azure-23/Item/Other/ServiceAzureAGroup.Local.png) |
