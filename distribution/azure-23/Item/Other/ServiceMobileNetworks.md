...
```text
azure-23/Item/Other/ServiceMobileNetworks
```

```text
include('azure-23/Item/Other/ServiceMobileNetworks')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceMobileNetworks.png) | ![illustration for ServiceMobileNetworks](../../../azure-23/Item/Other/ServiceMobileNetworks.Local.png) | ![illustration for ServiceMobileNetworksCard](../../../azure-23/Item/Other/ServiceMobileNetworksCard.Local.png) | ![illustration for ServiceMobileNetworksGroup](../../../azure-23/Item/Other/ServiceMobileNetworksGroup.Local.png) |
