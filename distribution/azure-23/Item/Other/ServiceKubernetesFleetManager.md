...
```text
azure-23/Item/Other/ServiceKubernetesFleetManager
```

```text
include('azure-23/Item/Other/ServiceKubernetesFleetManager')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceKubernetesFleetManager.png) | ![illustration for ServiceKubernetesFleetManager](../../../azure-23/Item/Other/ServiceKubernetesFleetManager.Local.png) | ![illustration for ServiceKubernetesFleetManagerCard](../../../azure-23/Item/Other/ServiceKubernetesFleetManagerCard.Local.png) | ![illustration for ServiceKubernetesFleetManagerGroup](../../../azure-23/Item/Other/ServiceKubernetesFleetManagerGroup.Local.png) |
