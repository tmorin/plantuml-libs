...
```text
azure-23/Item/Other/ServiceNetworkSecurityPerimeters
```

```text
include('azure-23/Item/Other/ServiceNetworkSecurityPerimeters')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceNetworkSecurityPerimeters.png) | ![illustration for ServiceNetworkSecurityPerimeters](../../../azure-23/Item/Other/ServiceNetworkSecurityPerimeters.Local.png) | ![illustration for ServiceNetworkSecurityPerimetersCard](../../../azure-23/Item/Other/ServiceNetworkSecurityPerimetersCard.Local.png) | ![illustration for ServiceNetworkSecurityPerimetersGroup](../../../azure-23/Item/Other/ServiceNetworkSecurityPerimetersGroup.Local.png) |
