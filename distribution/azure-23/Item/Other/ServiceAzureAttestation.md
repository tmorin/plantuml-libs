...
```text
azure-23/Item/Other/ServiceAzureAttestation
```

```text
include('azure-23/Item/Other/ServiceAzureAttestation')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzureAttestation.png) | ![illustration for ServiceAzureAttestation](../../../azure-23/Item/Other/ServiceAzureAttestation.Local.png) | ![illustration for ServiceAzureAttestationCard](../../../azure-23/Item/Other/ServiceAzureAttestationCard.Local.png) | ![illustration for ServiceAzureAttestationGroup](../../../azure-23/Item/Other/ServiceAzureAttestationGroup.Local.png) |
