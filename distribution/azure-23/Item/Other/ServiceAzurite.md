...
```text
azure-23/Item/Other/ServiceAzurite
```

```text
include('azure-23/Item/Other/ServiceAzurite')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceAzurite.png) | ![illustration for ServiceAzurite](../../../azure-23/Item/Other/ServiceAzurite.Local.png) | ![illustration for ServiceAzuriteCard](../../../azure-23/Item/Other/ServiceAzuriteCard.Local.png) | ![illustration for ServiceAzuriteGroup](../../../azure-23/Item/Other/ServiceAzuriteGroup.Local.png) |
