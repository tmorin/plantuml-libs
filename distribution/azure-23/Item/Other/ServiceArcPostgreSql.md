...
```text
azure-23/Item/Other/ServiceArcPostgreSql
```

```text
include('azure-23/Item/Other/ServiceArcPostgreSql')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceArcPostgreSql.png) | ![illustration for ServiceArcPostgreSql](../../../azure-23/Item/Other/ServiceArcPostgreSql.Local.png) | ![illustration for ServiceArcPostgreSqlCard](../../../azure-23/Item/Other/ServiceArcPostgreSqlCard.Local.png) | ![illustration for ServiceArcPostgreSqlGroup](../../../azure-23/Item/Other/ServiceArcPostgreSqlGroup.Local.png) |
