...
```text
azure-23/Item/Other/ServiceWebAppDatabase
```

```text
include('azure-23/Item/Other/ServiceWebAppDatabase')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Other/ServiceWebAppDatabase.png) | ![illustration for ServiceWebAppDatabase](../../../azure-23/Item/Other/ServiceWebAppDatabase.Local.png) | ![illustration for ServiceWebAppDatabaseCard](../../../azure-23/Item/Other/ServiceWebAppDatabaseCard.Local.png) | ![illustration for ServiceWebAppDatabaseGroup](../../../azure-23/Item/Other/ServiceWebAppDatabaseGroup.Local.png) |
