...
```text
azure-23/Item/AzureStack/ServiceUserSubscriptions
```

```text
include('azure-23/Item/AzureStack/ServiceUserSubscriptions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AzureStack/ServiceUserSubscriptions.png) | ![illustration for ServiceUserSubscriptions](../../../azure-23/Item/AzureStack/ServiceUserSubscriptions.Local.png) | ![illustration for ServiceUserSubscriptionsCard](../../../azure-23/Item/AzureStack/ServiceUserSubscriptionsCard.Local.png) | ![illustration for ServiceUserSubscriptionsGroup](../../../azure-23/Item/AzureStack/ServiceUserSubscriptionsGroup.Local.png) |
