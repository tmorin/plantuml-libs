...
```text
azure-23/Item/AzureStack/ServiceMultiTenancy
```

```text
include('azure-23/Item/AzureStack/ServiceMultiTenancy')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AzureStack/ServiceMultiTenancy.png) | ![illustration for ServiceMultiTenancy](../../../azure-23/Item/AzureStack/ServiceMultiTenancy.Local.png) | ![illustration for ServiceMultiTenancyCard](../../../azure-23/Item/AzureStack/ServiceMultiTenancyCard.Local.png) | ![illustration for ServiceMultiTenancyGroup](../../../azure-23/Item/AzureStack/ServiceMultiTenancyGroup.Local.png) |
