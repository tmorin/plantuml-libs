...
```text
azure-23/Item/AzureStack/ServiceInfrastructureBackup
```

```text
include('azure-23/Item/AzureStack/ServiceInfrastructureBackup')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AzureStack/ServiceInfrastructureBackup.png) | ![illustration for ServiceInfrastructureBackup](../../../azure-23/Item/AzureStack/ServiceInfrastructureBackup.Local.png) | ![illustration for ServiceInfrastructureBackupCard](../../../azure-23/Item/AzureStack/ServiceInfrastructureBackupCard.Local.png) | ![illustration for ServiceInfrastructureBackupGroup](../../../azure-23/Item/AzureStack/ServiceInfrastructureBackupGroup.Local.png) |
