...
```text
azure-23/Item/AzureStack/ServicePlans
```

```text
include('azure-23/Item/AzureStack/ServicePlans')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AzureStack/ServicePlans.png) | ![illustration for ServicePlans](../../../azure-23/Item/AzureStack/ServicePlans.Local.png) | ![illustration for ServicePlansCard](../../../azure-23/Item/AzureStack/ServicePlansCard.Local.png) | ![illustration for ServicePlansGroup](../../../azure-23/Item/AzureStack/ServicePlansGroup.Local.png) |
