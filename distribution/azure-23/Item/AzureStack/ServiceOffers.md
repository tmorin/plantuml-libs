...
```text
azure-23/Item/AzureStack/ServiceOffers
```

```text
include('azure-23/Item/AzureStack/ServiceOffers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AzureStack/ServiceOffers.png) | ![illustration for ServiceOffers](../../../azure-23/Item/AzureStack/ServiceOffers.Local.png) | ![illustration for ServiceOffersCard](../../../azure-23/Item/AzureStack/ServiceOffersCard.Local.png) | ![illustration for ServiceOffersGroup](../../../azure-23/Item/AzureStack/ServiceOffersGroup.Local.png) |
