...
```text
azure-23/Item/AzureStack/ServiceUpdates
```

```text
include('azure-23/Item/AzureStack/ServiceUpdates')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AzureStack/ServiceUpdates.png) | ![illustration for ServiceUpdates](../../../azure-23/Item/AzureStack/ServiceUpdates.Local.png) | ![illustration for ServiceUpdatesCard](../../../azure-23/Item/AzureStack/ServiceUpdatesCard.Local.png) | ![illustration for ServiceUpdatesGroup](../../../azure-23/Item/AzureStack/ServiceUpdatesGroup.Local.png) |
