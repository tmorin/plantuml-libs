...
```text
azure-23/Item/AzureStack/ServiceCapacity
```

```text
include('azure-23/Item/AzureStack/ServiceCapacity')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/AzureStack/ServiceCapacity.png) | ![illustration for ServiceCapacity](../../../azure-23/Item/AzureStack/ServiceCapacity.Local.png) | ![illustration for ServiceCapacityCard](../../../azure-23/Item/AzureStack/ServiceCapacityCard.Local.png) | ![illustration for ServiceCapacityGroup](../../../azure-23/Item/AzureStack/ServiceCapacityGroup.Local.png) |
