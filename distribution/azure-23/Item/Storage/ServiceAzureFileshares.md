...
```text
azure-23/Item/Storage/ServiceAzureFileshares
```

```text
include('azure-23/Item/Storage/ServiceAzureFileshares')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceAzureFileshares.png) | ![illustration for ServiceAzureFileshares](../../../azure-23/Item/Storage/ServiceAzureFileshares.Local.png) | ![illustration for ServiceAzureFilesharesCard](../../../azure-23/Item/Storage/ServiceAzureFilesharesCard.Local.png) | ![illustration for ServiceAzureFilesharesGroup](../../../azure-23/Item/Storage/ServiceAzureFilesharesGroup.Local.png) |
