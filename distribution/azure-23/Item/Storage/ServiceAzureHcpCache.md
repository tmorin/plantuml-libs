...
```text
azure-23/Item/Storage/ServiceAzureHcpCache
```

```text
include('azure-23/Item/Storage/ServiceAzureHcpCache')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceAzureHcpCache.png) | ![illustration for ServiceAzureHcpCache](../../../azure-23/Item/Storage/ServiceAzureHcpCache.Local.png) | ![illustration for ServiceAzureHcpCacheCard](../../../azure-23/Item/Storage/ServiceAzureHcpCacheCard.Local.png) | ![illustration for ServiceAzureHcpCacheGroup](../../../azure-23/Item/Storage/ServiceAzureHcpCacheGroup.Local.png) |
