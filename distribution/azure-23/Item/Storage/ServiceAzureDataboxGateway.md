...
```text
azure-23/Item/Storage/ServiceAzureDataboxGateway
```

```text
include('azure-23/Item/Storage/ServiceAzureDataboxGateway')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceAzureDataboxGateway.png) | ![illustration for ServiceAzureDataboxGateway](../../../azure-23/Item/Storage/ServiceAzureDataboxGateway.Local.png) | ![illustration for ServiceAzureDataboxGatewayCard](../../../azure-23/Item/Storage/ServiceAzureDataboxGatewayCard.Local.png) | ![illustration for ServiceAzureDataboxGatewayGroup](../../../azure-23/Item/Storage/ServiceAzureDataboxGatewayGroup.Local.png) |
