...
```text
azure-23/Item/Storage/ServiceDataShareInvitations
```

```text
include('azure-23/Item/Storage/ServiceDataShareInvitations')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceDataShareInvitations.png) | ![illustration for ServiceDataShareInvitations](../../../azure-23/Item/Storage/ServiceDataShareInvitations.Local.png) | ![illustration for ServiceDataShareInvitationsCard](../../../azure-23/Item/Storage/ServiceDataShareInvitationsCard.Local.png) | ![illustration for ServiceDataShareInvitationsGroup](../../../azure-23/Item/Storage/ServiceDataShareInvitationsGroup.Local.png) |
