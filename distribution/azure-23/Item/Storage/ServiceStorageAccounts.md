...
```text
azure-23/Item/Storage/ServiceStorageAccounts
```

```text
include('azure-23/Item/Storage/ServiceStorageAccounts')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceStorageAccounts.png) | ![illustration for ServiceStorageAccounts](../../../azure-23/Item/Storage/ServiceStorageAccounts.Local.png) | ![illustration for ServiceStorageAccountsCard](../../../azure-23/Item/Storage/ServiceStorageAccountsCard.Local.png) | ![illustration for ServiceStorageAccountsGroup](../../../azure-23/Item/Storage/ServiceStorageAccountsGroup.Local.png) |
