...
```text
azure-23/Item/Storage/ServiceManagedFileShares
```

```text
include('azure-23/Item/Storage/ServiceManagedFileShares')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceManagedFileShares.png) | ![illustration for ServiceManagedFileShares](../../../azure-23/Item/Storage/ServiceManagedFileShares.Local.png) | ![illustration for ServiceManagedFileSharesCard](../../../azure-23/Item/Storage/ServiceManagedFileSharesCard.Local.png) | ![illustration for ServiceManagedFileSharesGroup](../../../azure-23/Item/Storage/ServiceManagedFileSharesGroup.Local.png) |
