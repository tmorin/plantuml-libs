...
```text
azure-23/Item/Storage/ServiceDataShares
```

```text
include('azure-23/Item/Storage/ServiceDataShares')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceDataShares.png) | ![illustration for ServiceDataShares](../../../azure-23/Item/Storage/ServiceDataShares.Local.png) | ![illustration for ServiceDataSharesCard](../../../azure-23/Item/Storage/ServiceDataSharesCard.Local.png) | ![illustration for ServiceDataSharesGroup](../../../azure-23/Item/Storage/ServiceDataSharesGroup.Local.png) |
