...
```text
azure-23/Item/Storage/ServiceDataBox
```

```text
include('azure-23/Item/Storage/ServiceDataBox')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceDataBox.png) | ![illustration for ServiceDataBox](../../../azure-23/Item/Storage/ServiceDataBox.Local.png) | ![illustration for ServiceDataBoxCard](../../../azure-23/Item/Storage/ServiceDataBoxCard.Local.png) | ![illustration for ServiceDataBoxGroup](../../../azure-23/Item/Storage/ServiceDataBoxGroup.Local.png) |
