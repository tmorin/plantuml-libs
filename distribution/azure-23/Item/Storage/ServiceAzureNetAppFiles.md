...
```text
azure-23/Item/Storage/ServiceAzureNetAppFiles
```

```text
include('azure-23/Item/Storage/ServiceAzureNetAppFiles')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceAzureNetAppFiles.png) | ![illustration for ServiceAzureNetAppFiles](../../../azure-23/Item/Storage/ServiceAzureNetAppFiles.Local.png) | ![illustration for ServiceAzureNetAppFilesCard](../../../azure-23/Item/Storage/ServiceAzureNetAppFilesCard.Local.png) | ![illustration for ServiceAzureNetAppFilesGroup](../../../azure-23/Item/Storage/ServiceAzureNetAppFilesGroup.Local.png) |
