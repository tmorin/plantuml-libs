...
```text
azure-23/Item/Storage/ServiceStorSimpleDeviceManagers
```

```text
include('azure-23/Item/Storage/ServiceStorSimpleDeviceManagers')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceStorSimpleDeviceManagers.png) | ![illustration for ServiceStorSimpleDeviceManagers](../../../azure-23/Item/Storage/ServiceStorSimpleDeviceManagers.Local.png) | ![illustration for ServiceStorSimpleDeviceManagersCard](../../../azure-23/Item/Storage/ServiceStorSimpleDeviceManagersCard.Local.png) | ![illustration for ServiceStorSimpleDeviceManagersGroup](../../../azure-23/Item/Storage/ServiceStorSimpleDeviceManagersGroup.Local.png) |
