...
```text
azure-23/Item/Storage/ServiceStorageActions
```

```text
include('azure-23/Item/Storage/ServiceStorageActions')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceStorageActions.png) | ![illustration for ServiceStorageActions](../../../azure-23/Item/Storage/ServiceStorageActions.Local.png) | ![illustration for ServiceStorageActionsCard](../../../azure-23/Item/Storage/ServiceStorageActionsCard.Local.png) | ![illustration for ServiceStorageActionsGroup](../../../azure-23/Item/Storage/ServiceStorageActionsGroup.Local.png) |
