...
```text
azure-23/Item/Storage/ServiceDataLakeStorageGen1
```

```text
include('azure-23/Item/Storage/ServiceDataLakeStorageGen1')
```
...
| :---: | :---: | :---: | :---: |
| ![illustration for Illustration](../../../azure-23/Item/Storage/ServiceDataLakeStorageGen1.png) | ![illustration for ServiceDataLakeStorageGen1](../../../azure-23/Item/Storage/ServiceDataLakeStorageGen1.Local.png) | ![illustration for ServiceDataLakeStorageGen1Card](../../../azure-23/Item/Storage/ServiceDataLakeStorageGen1Card.Local.png) | ![illustration for ServiceDataLakeStorageGen1Group](../../../azure-23/Item/Storage/ServiceDataLakeStorageGen1Group.Local.png) |
