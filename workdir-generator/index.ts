...
import create, {PACKAGES} from "../source/library";
import {FactoryContext} from "./factories";
import {copyTemplates, getAbsoluteDstYamlDirPath, getDstYamlPath, getTmpDirPath, getTplDirPath} from "./paths";
...
copyTemplates(workDirPath)
    .then(() => create(context))
    .then(library => promisify(F.writeFile)(context.dstYamlPath, stringify(library)))
