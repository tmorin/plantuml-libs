...
const FOLDER_DATE = "01302026"
const ICONS_URL = `https://d1.awsstatic.com/onedam/marketing-channels/website/aws/en_US/architecture/approved/architecture-icons/Icon-package_01302026.31b40d126ed27079b708594940ad577a86150582.zip`
...
export class AwsQ12026Factory implements PackageFactory {
  getUrn(): string {
    return "aws-q1-2026"
  }
