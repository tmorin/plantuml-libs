...
const FOLDER_DATE = "01312023"
const ICONS_URL = `https://d1.awsstatic.com/webteam/architecture-icons/q1-2023/Asset-Package_${FOLDER_DATE}.d59bb3e1bf7860fb55d4d737779e7c6fce1e35ae.zip`
...
export class AwsQ12023Factory implements PackageFactory {
  getUrn(): string {
    return "aws-q1-2023"
  }
