...
const iconsUrl = "https://github.com/FortAwesome/Font-Awesome/releases/download/5.15.1/fontawesome-free-5.15.1-web.zip"
...
async function createInventory() {
    ...
    const cwd = P.join(iconsZipDst, 'fontawesome-free-5.15.1-web');
