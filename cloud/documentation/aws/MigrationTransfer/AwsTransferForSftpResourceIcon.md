...
| Icon | Element | Card |
| :-: | :-: | --- |
| ![AwsTransferForSftpResourceIcon icon](../../../icons/aws/MigrationTransfer/AwsTransferForSftpResourceIcon.png) | ![AwsTransferForSftpResourceIcon element](AwsTransferForSftpResourceIcon.element.png) | ![AwsTransferForSftpResourceIcon card](AwsTransferForSftpResourceIcon.card.png) |
## Element
### Load remotely
```plantuml
@startuml
