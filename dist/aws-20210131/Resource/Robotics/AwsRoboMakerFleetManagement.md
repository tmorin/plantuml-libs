...
```text
aws-20210131/Resource/Robotics/AwsRoboMakerFleetManagement
```

```text
include('aws-20210131/Resource/Robotics/AwsRoboMakerFleetManagement')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsRoboMakerFleetManagement.png)|![](AwsRoboMakerFleetManagement.card.png)|![](AwsRoboMakerFleetManagement.element.png)|![](AwsRoboMakerFleetManagement.group.png)|
