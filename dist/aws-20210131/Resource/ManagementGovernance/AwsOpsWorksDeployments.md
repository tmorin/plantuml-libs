...
```text
aws-20210131/Resource/ManagementGovernance/AwsOpsWorksDeployments
```

```text
include('aws-20210131/Resource/ManagementGovernance/AwsOpsWorksDeployments')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsOpsWorksDeployments.png)|![](AwsOpsWorksDeployments.card.png)|![](AwsOpsWorksDeployments.element.png)|![](AwsOpsWorksDeployments.group.png)|
