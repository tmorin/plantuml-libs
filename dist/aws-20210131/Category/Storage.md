...
|---|---|---|---|
|![](Storage.png)|![](Storage.card.png)|![](Storage.element.png)|![](Storage.group.png)|
...
include('aws-20210131/Category/Storage')
StorageCard('storage', 'Storage', 'Molestiae praesentium aut natus dolorem. Aut consequatur fugiat a consequatur ut.')
@enduml
```
### Load locally
```plantuml
