...
```text
azure-v2/Item/Storage/ServiceDataBoxEdge
```

```text
include('azure-v2/Item/Storage/ServiceDataBoxEdge')
```

|icon|card|element|group|
|---|---|---|---|
|![](ServiceDataBoxEdge.png)|![](ServiceDataBoxEdge.card.png)|![](ServiceDataBoxEdge.element.png)|![](ServiceDataBoxEdge.group.png)|
