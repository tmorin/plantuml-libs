...
```text
azure-v2/Item/Storage/ServiceRecoveryServicesVaults
```

```text
include('azure-v2/Item/Storage/ServiceRecoveryServicesVaults')
```

|icon|card|element|group|
|---|---|---|---|
|![](ServiceRecoveryServicesVaults.png)|![](ServiceRecoveryServicesVaults.card.png)|![](ServiceRecoveryServicesVaults.element.png)|![](ServiceRecoveryServicesVaults.group.png)|
