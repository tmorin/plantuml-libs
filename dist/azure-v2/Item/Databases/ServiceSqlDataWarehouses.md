...
```text
azure-v2/Item/Databases/ServiceSqlDataWarehouses
```

```text
include('azure-v2/Item/Databases/ServiceSqlDataWarehouses')
```

|icon|card|element|group|
|---|---|---|---|
|![](ServiceSqlDataWarehouses.png)|![](ServiceSqlDataWarehouses.card.png)|![](ServiceSqlDataWarehouses.element.png)|![](ServiceSqlDataWarehouses.group.png)|
