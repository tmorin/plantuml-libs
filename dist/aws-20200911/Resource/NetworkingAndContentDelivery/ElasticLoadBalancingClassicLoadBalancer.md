...
```text
aws-20200911/Resource/NetworkingAndContentDelivery/ElasticLoadBalancingClassicLoadBalancer
```

```text
include('aws-20200911/Resource/NetworkingAndContentDelivery/ElasticLoadBalancingClassicLoadBalancer')
```

|icon|card|element|group|
|---|---|---|---|
|![](ElasticLoadBalancingClassicLoadBalancer.png)|![](ElasticLoadBalancingClassicLoadBalancer.card.png)|![](ElasticLoadBalancingClassicLoadBalancer.element.png)|![](ElasticLoadBalancingClassicLoadBalancer.group.png)|
