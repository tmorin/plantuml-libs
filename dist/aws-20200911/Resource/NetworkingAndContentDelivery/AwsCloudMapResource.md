...
```text
aws-20200911/Resource/NetworkingAndContentDelivery/AwsCloudMapResource
```

```text
include('aws-20200911/Resource/NetworkingAndContentDelivery/AwsCloudMapResource')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsCloudMapResource.png)|![](AwsCloudMapResource.card.png)|![](AwsCloudMapResource.element.png)|![](AwsCloudMapResource.group.png)|
