...
```text
aws-20200911/Resource/NetworkingAndContentDelivery/ElasticLoadBalancingApplicationLoadBalancer
```

```text
include('aws-20200911/Resource/NetworkingAndContentDelivery/ElasticLoadBalancingApplicationLoadBalancer')
```

|icon|card|element|group|
|---|---|---|---|
|![](ElasticLoadBalancingApplicationLoadBalancer.png)|![](ElasticLoadBalancingApplicationLoadBalancer.card.png)|![](ElasticLoadBalancingApplicationLoadBalancer.element.png)|![](ElasticLoadBalancingApplicationLoadBalancer.group.png)|
