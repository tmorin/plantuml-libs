...
```text
aws-20200911/Resource/NetworkingAndContentDelivery/AwsCloudMapNamespace
```

```text
include('aws-20200911/Resource/NetworkingAndContentDelivery/AwsCloudMapNamespace')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsCloudMapNamespace.png)|![](AwsCloudMapNamespace.card.png)|![](AwsCloudMapNamespace.element.png)|![](AwsCloudMapNamespace.group.png)|
