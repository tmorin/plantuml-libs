...
```text
aws-20200911/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistCost
```

```text
include('aws-20200911/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistCost')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsTrustedAdvisorChecklistCost.png)|![](AwsTrustedAdvisorChecklistCost.card.png)|![](AwsTrustedAdvisorChecklistCost.element.png)|![](AwsTrustedAdvisorChecklistCost.group.png)|
