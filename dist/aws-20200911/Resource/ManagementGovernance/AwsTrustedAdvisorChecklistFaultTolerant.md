...
```text
aws-20200911/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistFaultTolerant
```

```text
include('aws-20200911/Resource/ManagementGovernance/AwsTrustedAdvisorChecklistFaultTolerant')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsTrustedAdvisorChecklistFaultTolerant.png)|![](AwsTrustedAdvisorChecklistFaultTolerant.card.png)|![](AwsTrustedAdvisorChecklistFaultTolerant.element.png)|![](AwsTrustedAdvisorChecklistFaultTolerant.group.png)|
