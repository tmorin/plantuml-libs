...
```text
aws-20200911/Resource/ManagementGovernance/AwsCloudFormationChangeSet
```

```text
include('aws-20200911/Resource/ManagementGovernance/AwsCloudFormationChangeSet')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsCloudFormationChangeSet.png)|![](AwsCloudFormationChangeSet.card.png)|![](AwsCloudFormationChangeSet.element.png)|![](AwsCloudFormationChangeSet.group.png)|
