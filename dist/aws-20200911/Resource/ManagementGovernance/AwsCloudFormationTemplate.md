...
```text
aws-20200911/Resource/ManagementGovernance/AwsCloudFormationTemplate
```

```text
include('aws-20200911/Resource/ManagementGovernance/AwsCloudFormationTemplate')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsCloudFormationTemplate.png)|![](AwsCloudFormationTemplate.card.png)|![](AwsCloudFormationTemplate.element.png)|![](AwsCloudFormationTemplate.group.png)|
