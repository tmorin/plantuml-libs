...
```text
aws-20200911/Resource/Storage/AwsStorageGatewayFileGateway
```

```text
include('aws-20200911/Resource/Storage/AwsStorageGatewayFileGateway')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsStorageGatewayFileGateway.png)|![](AwsStorageGatewayFileGateway.card.png)|![](AwsStorageGatewayFileGateway.element.png)|![](AwsStorageGatewayFileGateway.group.png)|
