...
```text
aws-20200911/Resource/Storage/AwsStorageGatewayNonCachedVolume
```

```text
include('aws-20200911/Resource/Storage/AwsStorageGatewayNonCachedVolume')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsStorageGatewayNonCachedVolume.png)|![](AwsStorageGatewayNonCachedVolume.card.png)|![](AwsStorageGatewayNonCachedVolume.element.png)|![](AwsStorageGatewayNonCachedVolume.group.png)|
