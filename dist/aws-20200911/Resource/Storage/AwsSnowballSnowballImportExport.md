...
```text
aws-20200911/Resource/Storage/AwsSnowballSnowballImportExport
```

```text
include('aws-20200911/Resource/Storage/AwsSnowballSnowballImportExport')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsSnowballSnowballImportExport.png)|![](AwsSnowballSnowballImportExport.card.png)|![](AwsSnowballSnowballImportExport.element.png)|![](AwsSnowballSnowballImportExport.group.png)|
