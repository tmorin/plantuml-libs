...
```text
aws-20200911/Resource/Storage/AwsStorageGatewayVirtualTapeLibrary
```

```text
include('aws-20200911/Resource/Storage/AwsStorageGatewayVirtualTapeLibrary')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsStorageGatewayVirtualTapeLibrary.png)|![](AwsStorageGatewayVirtualTapeLibrary.card.png)|![](AwsStorageGatewayVirtualTapeLibrary.element.png)|![](AwsStorageGatewayVirtualTapeLibrary.group.png)|
