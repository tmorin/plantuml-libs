...
```text
aws-20200911/Resource/Storage/AwsStorageGatewayVolumeGateway
```

```text
include('aws-20200911/Resource/Storage/AwsStorageGatewayVolumeGateway')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsStorageGatewayVolumeGateway.png)|![](AwsStorageGatewayVolumeGateway.card.png)|![](AwsStorageGatewayVolumeGateway.element.png)|![](AwsStorageGatewayVolumeGateway.group.png)|
