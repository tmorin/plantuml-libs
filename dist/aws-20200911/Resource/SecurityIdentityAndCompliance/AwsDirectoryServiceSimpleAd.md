...
```text
aws-20200911/Resource/SecurityIdentityAndCompliance/AwsDirectoryServiceSimpleAd
```

```text
include('aws-20200911/Resource/SecurityIdentityAndCompliance/AwsDirectoryServiceSimpleAd')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsDirectoryServiceSimpleAd.png)|![](AwsDirectoryServiceSimpleAd.card.png)|![](AwsDirectoryServiceSimpleAd.element.png)|![](AwsDirectoryServiceSimpleAd.group.png)|
