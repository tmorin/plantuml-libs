...
```text
aws-20200911/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementRole
```

```text
include('aws-20200911/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementRole')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsIdentityAccessManagementRole.png)|![](AwsIdentityAccessManagementRole.card.png)|![](AwsIdentityAccessManagementRole.element.png)|![](AwsIdentityAccessManagementRole.group.png)|
