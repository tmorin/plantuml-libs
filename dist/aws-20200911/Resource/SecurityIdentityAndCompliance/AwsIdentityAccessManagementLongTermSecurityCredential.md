...
```text
aws-20200911/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementLongTermSecurityCredential
```

```text
include('aws-20200911/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementLongTermSecurityCredential')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsIdentityAccessManagementLongTermSecurityCredential.png)|![](AwsIdentityAccessManagementLongTermSecurityCredential.card.png)|![](AwsIdentityAccessManagementLongTermSecurityCredential.element.png)|![](AwsIdentityAccessManagementLongTermSecurityCredential.group.png)|
