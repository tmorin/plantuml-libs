...
```text
aws-20200911/Resource/SecurityIdentityAndCompliance/AwsCertificateManagerCertificateAuthority
```

```text
include('aws-20200911/Resource/SecurityIdentityAndCompliance/AwsCertificateManagerCertificateAuthority')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsCertificateManagerCertificateAuthority.png)|![](AwsCertificateManagerCertificateAuthority.card.png)|![](AwsCertificateManagerCertificateAuthority.element.png)|![](AwsCertificateManagerCertificateAuthority.group.png)|
