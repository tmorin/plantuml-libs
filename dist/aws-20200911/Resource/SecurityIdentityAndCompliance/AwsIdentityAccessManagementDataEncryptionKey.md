...
```text
aws-20200911/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementDataEncryptionKey
```

```text
include('aws-20200911/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementDataEncryptionKey')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsIdentityAccessManagementDataEncryptionKey.png)|![](AwsIdentityAccessManagementDataEncryptionKey.card.png)|![](AwsIdentityAccessManagementDataEncryptionKey.element.png)|![](AwsIdentityAccessManagementDataEncryptionKey.group.png)|
