...
```text
aws-20200911/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementMfaToken
```

```text
include('aws-20200911/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementMfaToken')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsIdentityAccessManagementMfaToken.png)|![](AwsIdentityAccessManagementMfaToken.card.png)|![](AwsIdentityAccessManagementMfaToken.element.png)|![](AwsIdentityAccessManagementMfaToken.group.png)|
