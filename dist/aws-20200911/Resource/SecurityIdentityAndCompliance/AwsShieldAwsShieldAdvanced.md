...
```text
aws-20200911/Resource/SecurityIdentityAndCompliance/AwsShieldAwsShieldAdvanced
```

```text
include('aws-20200911/Resource/SecurityIdentityAndCompliance/AwsShieldAwsShieldAdvanced')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsShieldAwsShieldAdvanced.png)|![](AwsShieldAwsShieldAdvanced.card.png)|![](AwsShieldAwsShieldAdvanced.element.png)|![](AwsShieldAwsShieldAdvanced.group.png)|
