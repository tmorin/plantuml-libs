...
```text
aws-20200911/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementAwsIamAccessAnalyzer
```

```text
include('aws-20200911/Resource/SecurityIdentityAndCompliance/AwsIdentityAccessManagementAwsIamAccessAnalyzer')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsIdentityAccessManagementAwsIamAccessAnalyzer.png)|![](AwsIdentityAccessManagementAwsIamAccessAnalyzer.card.png)|![](AwsIdentityAccessManagementAwsIamAccessAnalyzer.element.png)|![](AwsIdentityAccessManagementAwsIamAccessAnalyzer.group.png)|
