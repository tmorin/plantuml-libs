...
```text
aws-20200911/Resource/LoT/IoTThingCamera
```

```text
include('aws-20200911/Resource/LoT/IoTThingCamera')
```

|icon|card|element|group|
|---|---|---|---|
|![](IoTThingCamera.png)|![](IoTThingCamera.card.png)|![](IoTThingCamera.element.png)|![](IoTThingCamera.group.png)|
