...
```text
aws-20200911/Resource/LoT/IoTThingTravel
```

```text
include('aws-20200911/Resource/LoT/IoTThingTravel')
```

|icon|card|element|group|
|---|---|---|---|
|![](IoTThingTravel.png)|![](IoTThingTravel.card.png)|![](IoTThingTravel.element.png)|![](IoTThingTravel.group.png)|
