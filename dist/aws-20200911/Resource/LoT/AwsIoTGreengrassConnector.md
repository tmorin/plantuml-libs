...
```text
aws-20200911/Resource/LoT/AwsIoTGreengrassConnector
```

```text
include('aws-20200911/Resource/LoT/AwsIoTGreengrassConnector')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsIoTGreengrassConnector.png)|![](AwsIoTGreengrassConnector.card.png)|![](AwsIoTGreengrassConnector.element.png)|![](AwsIoTGreengrassConnector.group.png)|
