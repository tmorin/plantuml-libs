...
```text
aws-20200911/Resource/LoT/IoTOverAirUpdate
```

```text
include('aws-20200911/Resource/LoT/IoTOverAirUpdate')
```

|icon|card|element|group|
|---|---|---|---|
|![](IoTOverAirUpdate.png)|![](IoTOverAirUpdate.card.png)|![](IoTOverAirUpdate.element.png)|![](IoTOverAirUpdate.group.png)|
