...
```text
aws-20200911/Resource/LoT/AwsLoTDeviceDefenderIoTDeviceJobs
```

```text
include('aws-20200911/Resource/LoT/AwsLoTDeviceDefenderIoTDeviceJobs')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsLoTDeviceDefenderIoTDeviceJobs.png)|![](AwsLoTDeviceDefenderIoTDeviceJobs.card.png)|![](AwsLoTDeviceDefenderIoTDeviceJobs.element.png)|![](AwsLoTDeviceDefenderIoTDeviceJobs.group.png)|
