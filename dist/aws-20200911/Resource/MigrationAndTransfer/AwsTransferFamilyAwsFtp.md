...
```text
aws-20200911/Resource/MigrationAndTransfer/AwsTransferFamilyAwsFtp
```

```text
include('aws-20200911/Resource/MigrationAndTransfer/AwsTransferFamilyAwsFtp')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsTransferFamilyAwsFtp.png)|![](AwsTransferFamilyAwsFtp.card.png)|![](AwsTransferFamilyAwsFtp.element.png)|![](AwsTransferFamilyAwsFtp.group.png)|
