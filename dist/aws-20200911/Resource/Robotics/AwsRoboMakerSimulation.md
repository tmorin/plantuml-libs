...
```text
aws-20200911/Resource/Robotics/AwsRoboMakerSimulation
```

```text
include('aws-20200911/Resource/Robotics/AwsRoboMakerSimulation')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsRoboMakerSimulation.png)|![](AwsRoboMakerSimulation.card.png)|![](AwsRoboMakerSimulation.element.png)|![](AwsRoboMakerSimulation.group.png)|
