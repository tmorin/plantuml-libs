...
```text
aws-20200911/Resource/Analytics/AwsLakeFormationDataLake
```

```text
include('aws-20200911/Resource/Analytics/AwsLakeFormationDataLake')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsLakeFormationDataLake.png)|![](AwsLakeFormationDataLake.card.png)|![](AwsLakeFormationDataLake.element.png)|![](AwsLakeFormationDataLake.group.png)|
