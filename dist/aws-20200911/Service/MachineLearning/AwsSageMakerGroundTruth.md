...
```text
aws-20200911/Service/MachineLearning/AwsSageMakerGroundTruth
```

```text
include('aws-20200911/Service/MachineLearning/AwsSageMakerGroundTruth')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsSageMakerGroundTruth.png)|![](AwsSageMakerGroundTruth.card.png)|![](AwsSageMakerGroundTruth.element.png)|![](AwsSageMakerGroundTruth.group.png)|
