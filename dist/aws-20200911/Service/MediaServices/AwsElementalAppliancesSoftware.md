...
```text
aws-20200911/Service/MediaServices/AwsElementalAppliancesSoftware
```

```text
include('aws-20200911/Service/MediaServices/AwsElementalAppliancesSoftware')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsElementalAppliancesSoftware.png)|![](AwsElementalAppliancesSoftware.card.png)|![](AwsElementalAppliancesSoftware.element.png)|![](AwsElementalAppliancesSoftware.group.png)|
