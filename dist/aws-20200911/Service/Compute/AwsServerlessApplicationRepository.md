...
```text
aws-20200911/Service/Compute/AwsServerlessApplicationRepository
```

```text
include('aws-20200911/Service/Compute/AwsServerlessApplicationRepository')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsServerlessApplicationRepository.png)|![](AwsServerlessApplicationRepository.card.png)|![](AwsServerlessApplicationRepository.element.png)|![](AwsServerlessApplicationRepository.group.png)|
