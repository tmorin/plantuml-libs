...
```text
aws-20200911/Service/InternetOfThings/AwsIoTSiteWise
```

```text
include('aws-20200911/Service/InternetOfThings/AwsIoTSiteWise')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsIoTSiteWise.png)|![](AwsIoTSiteWise.card.png)|![](AwsIoTSiteWise.element.png)|![](AwsIoTSiteWise.group.png)|
