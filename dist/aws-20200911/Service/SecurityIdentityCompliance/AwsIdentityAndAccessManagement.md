...
```text
aws-20200911/Service/SecurityIdentityCompliance/AwsIdentityAndAccessManagement
```

```text
include('aws-20200911/Service/SecurityIdentityCompliance/AwsIdentityAndAccessManagement')
```
