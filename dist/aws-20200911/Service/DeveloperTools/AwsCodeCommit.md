...
```text
aws-20200911/Service/DeveloperTools/AwsCodeCommit
```

```text
include('aws-20200911/Service/DeveloperTools/AwsCodeCommit')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsCodeCommit.png)|![](AwsCodeCommit.card.png)|![](AwsCodeCommit.element.png)|![](AwsCodeCommit.group.png)|
