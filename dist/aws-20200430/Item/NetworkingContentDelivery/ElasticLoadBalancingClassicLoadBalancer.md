...
```text
aws-20200430/Item/NetworkingContentDelivery/ElasticLoadBalancingClassicLoadBalancer
```

```text
include('aws-20200430/Item/NetworkingContentDelivery/ElasticLoadBalancingClassicLoadBalancer')
```
