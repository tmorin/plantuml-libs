...
```text
aws-20200430/Item/QuantumTechnologies/AwsBraket
```

```text
include('aws-20200430/Item/QuantumTechnologies/AwsBraket')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsBraket.png)|![](AwsBraket.card.png)|![](AwsBraket.element.png)|![](AwsBraket.group.png)|
