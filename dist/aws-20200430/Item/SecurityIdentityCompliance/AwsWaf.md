...
```text
aws-20200430/Item/SecurityIdentityCompliance/AwsWaf
```

```text
include('aws-20200430/Item/SecurityIdentityCompliance/AwsWaf')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsWaf.png)|![](AwsWaf.card.png)|![](AwsWaf.element.png)|![](AwsWaf.group.png)|
