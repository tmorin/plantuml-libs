...
```text
aws-20200430/Item/MediaServices/AwsElementalMediaStore
```

```text
include('aws-20200430/Item/MediaServices/AwsElementalMediaStore')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsElementalMediaStore.png)|![](AwsElementalMediaStore.card.png)|![](AwsElementalMediaStore.element.png)|![](AwsElementalMediaStore.group.png)|
