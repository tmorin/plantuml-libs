...
```text
aws-20200430/Item/ManagementGovernance/AwsSystemsManagerPatchManager
```

```text
include('aws-20200430/Item/ManagementGovernance/AwsSystemsManagerPatchManager')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsSystemsManagerPatchManager.png)|![](AwsSystemsManagerPatchManager.card.png)|![](AwsSystemsManagerPatchManager.element.png)|![](AwsSystemsManagerPatchManager.group.png)|
