...
```text
aws-20200430/Item/ManagementGovernance/AwsSystemsManagerParameterStore
```

```text
include('aws-20200430/Item/ManagementGovernance/AwsSystemsManagerParameterStore')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsSystemsManagerParameterStore.png)|![](AwsSystemsManagerParameterStore.card.png)|![](AwsSystemsManagerParameterStore.element.png)|![](AwsSystemsManagerParameterStore.group.png)|
