...
```text
aws-20200430/Item/ManagementGovernance/AwsSystemsManagerDocuments
```

```text
include('aws-20200430/Item/ManagementGovernance/AwsSystemsManagerDocuments')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsSystemsManagerDocuments.png)|![](AwsSystemsManagerDocuments.card.png)|![](AwsSystemsManagerDocuments.element.png)|![](AwsSystemsManagerDocuments.group.png)|
