...
```text
aws-20200430/Item/ManagementGovernance/AwsSystemsManagerInventory
```

```text
include('aws-20200430/Item/ManagementGovernance/AwsSystemsManagerInventory')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsSystemsManagerInventory.png)|![](AwsSystemsManagerInventory.card.png)|![](AwsSystemsManagerInventory.element.png)|![](AwsSystemsManagerInventory.group.png)|
