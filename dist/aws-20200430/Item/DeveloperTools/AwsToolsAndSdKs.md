...
```text
aws-20200430/Item/DeveloperTools/AwsToolsAndSdKs
```

```text
include('aws-20200430/Item/DeveloperTools/AwsToolsAndSdKs')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsToolsAndSdKs.png)|![](AwsToolsAndSdKs.card.png)|![](AwsToolsAndSdKs.element.png)|![](AwsToolsAndSdKs.group.png)|
