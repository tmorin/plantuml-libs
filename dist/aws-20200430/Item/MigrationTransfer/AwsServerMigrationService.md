...
```text
aws-20200430/Item/MigrationTransfer/AwsServerMigrationService
```

```text
include('aws-20200430/Item/MigrationTransfer/AwsServerMigrationService')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsServerMigrationService.png)|![](AwsServerMigrationService.card.png)|![](AwsServerMigrationService.element.png)|![](AwsServerMigrationService.group.png)|
