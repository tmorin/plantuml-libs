...
```text
aws-20200430/Item/MigrationTransfer/AwsDatabaseMigrationService
```

```text
include('aws-20200430/Item/MigrationTransfer/AwsDatabaseMigrationService')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsDatabaseMigrationService.png)|![](AwsDatabaseMigrationService.card.png)|![](AwsDatabaseMigrationService.element.png)|![](AwsDatabaseMigrationService.group.png)|
