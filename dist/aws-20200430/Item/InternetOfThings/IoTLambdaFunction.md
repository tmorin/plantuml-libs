...
```text
aws-20200430/Item/InternetOfThings/IoTLambdaFunction
```

```text
include('aws-20200430/Item/InternetOfThings/IoTLambdaFunction')
```

|icon|card|element|group|
|---|---|---|---|
|![](IoTLambdaFunction.png)|![](IoTLambdaFunction.card.png)|![](IoTLambdaFunction.element.png)|![](IoTLambdaFunction.group.png)|
