...
```text
aws-20200430/Item/InternetOfThings/IoTHardwareBoard
```

```text
include('aws-20200430/Item/InternetOfThings/IoTHardwareBoard')
```

|icon|card|element|group|
|---|---|---|---|
|![](IoTHardwareBoard.png)|![](IoTHardwareBoard.card.png)|![](IoTHardwareBoard.element.png)|![](IoTHardwareBoard.group.png)|
