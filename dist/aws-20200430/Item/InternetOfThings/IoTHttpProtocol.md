...
```text
aws-20200430/Item/InternetOfThings/IoTHttpProtocol
```

```text
include('aws-20200430/Item/InternetOfThings/IoTHttpProtocol')
```

|icon|card|element|group|
|---|---|---|---|
|![](IoTHttpProtocol.png)|![](IoTHttpProtocol.card.png)|![](IoTHttpProtocol.element.png)|![](IoTHttpProtocol.group.png)|
