...
```text
aws-20200430/Item/InternetOfThings/AwsIoTAnalyticsNotebook
```

```text
include('aws-20200430/Item/InternetOfThings/AwsIoTAnalyticsNotebook')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsIoTAnalyticsNotebook.png)|![](AwsIoTAnalyticsNotebook.card.png)|![](AwsIoTAnalyticsNotebook.element.png)|![](AwsIoTAnalyticsNotebook.group.png)|
