...
```text
aws-20200430/Item/InternetOfThings/AwsIoTAnalyticsChannel
```

```text
include('aws-20200430/Item/InternetOfThings/AwsIoTAnalyticsChannel')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsIoTAnalyticsChannel.png)|![](AwsIoTAnalyticsChannel.card.png)|![](AwsIoTAnalyticsChannel.element.png)|![](AwsIoTAnalyticsChannel.group.png)|
