...
```text
aws-20200430/Item/InternetOfThings/IoTMqttProtocol
```

```text
include('aws-20200430/Item/InternetOfThings/IoTMqttProtocol')
```

|icon|card|element|group|
|---|---|---|---|
|![](IoTMqttProtocol.png)|![](IoTMqttProtocol.card.png)|![](IoTMqttProtocol.element.png)|![](IoTMqttProtocol.group.png)|
