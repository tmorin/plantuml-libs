...
```text
aws-20200430/Item/InternetOfThings/AwsIoTAnalyticsDataSet
```

```text
include('aws-20200430/Item/InternetOfThings/AwsIoTAnalyticsDataSet')
```

|icon|card|element|group|
|---|---|---|---|
|![](AwsIoTAnalyticsDataSet.png)|![](AwsIoTAnalyticsDataSet.card.png)|![](AwsIoTAnalyticsDataSet.element.png)|![](AwsIoTAnalyticsDataSet.group.png)|
