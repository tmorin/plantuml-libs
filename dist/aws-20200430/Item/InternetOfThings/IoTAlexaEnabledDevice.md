...
```text
aws-20200430/Item/InternetOfThings/IoTAlexaEnabledDevice
```

```text
include('aws-20200430/Item/InternetOfThings/IoTAlexaEnabledDevice')
```

|icon|card|element|group|
|---|---|---|---|
|![](IoTAlexaEnabledDevice.png)|![](IoTAlexaEnabledDevice.card.png)|![](IoTAlexaEnabledDevice.element.png)|![](IoTAlexaEnabledDevice.group.png)|
